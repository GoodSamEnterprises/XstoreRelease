...
VALUES ('OrganizationId', 'DEFAULT', '$(OrgID)', 'DEFAULT', 'Organization $(OrgID)', 0, null, null, null);
END
...
BEGIN
  ...
  INSERT INTO cfg_user_password (organization_id, user_name, password, effective_date) VALUES ($(OrgID), '$(OrgID)-1', 'tZxnvxlqR1gZHkL3ZnDOug==', getDate());
END
