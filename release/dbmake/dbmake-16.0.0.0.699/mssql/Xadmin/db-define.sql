...
CREATE TABLE [dbo].[cfg_menu_config](
    ...
    [menu_type]                 varchar(30)     NULL,
    [sort_order]                int             NULL,
    [view_id]                   varchar(200)    NULL,
    [action_expression]         varchar(200)    NULL,
    [active_flag]               bit             NULL,
    [propagation]               varchar(30)     NULL,
    [security_privilege]        varchar(30)     NULL,
    [custom_datasource_class]   varchar(200)    NULL,
    [custom_datasource_method]  varchar(30)     NULL,
...
CREATE TABLE [dbo].[dpl_deployment](
    ...
    [cancel_user_id]           varchar(30)       NULL,
