...
--     e.g. ALTER TABLE some_table ADD some_col varchar(30);      -- [278754]
--
...
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE name = 'safe_bag_id' AND object_id = OBJECT_ID('tsn_tndr_control_trans'))
  ALTER TABLE tsn_tndr_control_trans ADD safe_bag_id varchar(60) null;
GO
--[/RXPS-16239, RXPS-16539]

--[RXPS-15284]
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE name = 'ext_invoice_id' AND object_id = OBJECT_ID('civc_invoice'))
  ALTER TABLE civc_invoice ADD ext_invoice_id varchar(60) null;
GO
...
BEGIN
  ...
  ALTER TABLE itm_item_restriction ADD sale_lineitm_typecode varchar(30) NOT NULL DEFAULT 'ANY';
  ALTER TABLE itm_item_restriction ADD property_name varchar(30) NOT NULL DEFAULT 'DEFAULT';
...
BEGIN
  ...
  ALTER TABLE itm_item_restriction_p ADD sale_lineitm_typecode varchar(30) NOT NULL DEFAULT 'ANY';
  ALTER TABLE itm_item_restriction_p ADD property_name varchar(30) NOT NULL DEFAULT 'DEFAULT';
...
BEGIN
  ...
  ALTER TABLE itm_item_restrict_calendar ADD sale_lineitm_typecode varchar(30) NOT NULL DEFAULT 'ANY';
...
BEGIN
  ...
  ALTER TABLE itm_item_restrict_calendar_p ADD sale_lineitm_typecode varchar(30) NOT NULL DEFAULT 'ANY';
...
BEGIN
  ALTER TABLE trl_rtrans_flight_info ADD first_flight_number varchar(30) null;
...
BEGIN
  ALTER TABLE trl_rtrans_flight_info ADD first_destination_airport varchar(3) null;
...
BEGIN
  ALTER TABLE trl_rtrans_flight_info ADD first_origin_airport varchar(3) null;
...
BEGIN
  ALTER TABLE trl_rtrans_flight_info ADD first_flight_seat_number varchar(4) null;
...
BEGIN
  ALTER TABLE COM_FLIGHT_INFO ADD ORIGIN_AIRPORT VARCHAR(3) DEFAULT '' NOT NULL
...
BEGIN
  ALTER TABLE COM_FLIGHT_INFO_P ADD ORIGIN_AIRPORT VARCHAR(3) DEFAULT '' NOT NULL
...
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE name = 'tare_unit_of_measure_code' AND object_id = OBJECT_ID('itm_item_options'))
  ALTER TABLE itm_item_options ADD tare_unit_of_measure_code varchar(30) null;
GO
--[/RXPS-18272]
...
BEGIN
  ALTER TABLE trl_kit_component_mod ADD serial_nbr varchar(60) NULL;
...
BEGIN
  ALTER TABLE cpaf_card_network ADD network_id varchar(30) NULL;
...
BEGIN
  ALTER TABLE cpaf_card_network ADD tax_id varchar(30) NULL;
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'destination_airport' AND object_id = OBJECT_ID('com_flight_info') AND max_length>3 ) AND NOT EXISTS (SELECT 1 FROM com_flight_info WHERE LEN(destination_airport)>3)
  ALTER TABLE com_flight_info ALTER COLUMN destination_airport varchar(3) NULL;
GO
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'via_1_airport' AND object_id = OBJECT_ID('com_flight_info') AND max_length>3 ) AND NOT EXISTS (SELECT 1 FROM com_flight_info WHERE LEN(via_1_airport)>3)
  ALTER TABLE com_flight_info ALTER COLUMN via_1_airport varchar(3) NULL;
GO
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'via_2_airport' AND object_id = OBJECT_ID('com_flight_info') AND max_length>3 ) AND NOT EXISTS (SELECT 1 FROM com_flight_info WHERE LEN(via_2_airport)>3)
  ALTER TABLE com_flight_info ALTER COLUMN via_2_airport varchar(3) NULL;
GO
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'via_3_airport' AND object_id = OBJECT_ID('com_flight_info') AND max_length>3 ) AND NOT EXISTS (SELECT 1 FROM com_flight_info WHERE LEN(via_3_airport)>3)
  ALTER TABLE com_flight_info ALTER COLUMN via_3_airport varchar(3) NULL;
GO
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'destination_airport' AND object_id = OBJECT_ID('trl_rtrans_flight_info') AND max_length>3 ) AND NOT EXISTS (SELECT 1 FROM trl_rtrans_flight_info WHERE LEN(destination_airport)>3)
  ALTER TABLE trl_rtrans_flight_info ALTER COLUMN destination_airport varchar(3) NULL;
GO
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'origin_airport' AND object_id = OBJECT_ID('trl_rtrans_flight_info') AND max_length>3 ) AND NOT EXISTS (SELECT 1 FROM trl_rtrans_flight_info WHERE LEN(origin_airport)>3)
  ALTER TABLE trl_rtrans_flight_info ALTER COLUMN origin_airport varchar(3) NULL;
GO
...
BEGIN
  ALTER TABLE loc_rtl_loc ADD airport_code VARCHAR(3) null;
...
BEGIN
  ALTER TABLE civc_invoice ADD ext_invoice_barcode VARCHAR(60) NULL;
...
BEGIN
  ALTER TABLE tsn_session ADD cash_drawer_id varchar(60);
...
BEGIN
  ALTER TABLE trl_sale_tax_lineitm ADD tax_override_comment varchar(255);
...
BEGIN
  ALTER TABLE cpaf_nfe ADD iss_service_date varchar(10) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_item ADD iis_city_code varchar(7) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_item ADD iis_service_code varchar(5) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_item ADD iis_eligible_indicator varchar(2) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_item ADD iis_incentive_indicator varchar(1) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_item ADD ref_nfe varchar(88) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_queue ADD iss_service_date varchar(10) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_queue_item ADD iis_city_code varchar(7) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_queue_item ADD iis_service_code varchar(5) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_queue_item ADD iis_eligible_indicator varchar(2) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_queue_item ADD iis_incentive_indicator varchar(1) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfe_queue_item ADD ref_nfe varchar(88) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_queue_tender ADD card_network_id varchar(30) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_queue_tender ADD card_tax_id varchar(30) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_queue_tender ADD card_auth_number varchar(254) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_queue_tender ADD card_type varchar(254) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_queue_tender ADD card_trace_number varchar(254) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_queue_tender ADD card_integration_mode varchar(30) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_tender ADD card_network_id varchar(30) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_tender ADD card_tax_id varchar(30) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_tender ADD card_auth_number varchar(254) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_tender ADD card_type varchar(254) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_tender ADD card_trace_number varchar(254) NULL;
...
BEGIN
  ALTER TABLE cpaf_nfce_tender ADD card_integration_mode varchar(30) NULL;
...
BEGIN
  ALTER TABLE xom_item_mod ADD image_url varchar(254) NULL;
...
BEGIN
  ALTER TABLE trl_sale_tax_lineitm ADD orig_tax_group_id varchar(60);
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'orig_stan' AND object_id = OBJECT_ID('trl_voucher_sale_lineitm') AND max_length=12)
  ALTER TABLE trl_voucher_sale_lineitm ALTER COLUMN orig_stan varchar(30) NULL;
GO
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'orig_stan' AND object_id = OBJECT_ID('ttr_credit_debit_tndr_lineitm') AND max_length=12)
  ALTER TABLE ttr_credit_debit_tndr_lineitm ALTER COLUMN orig_stan varchar(30) NULL;
GO
...
IF EXISTS (SELECT 1 FROM sys.columns WHERE name = 'orig_stan' AND object_id = OBJECT_ID('ttr_voucher_tndr_lineitm') AND max_length=12)
  ALTER TABLE ttr_voucher_tndr_lineitm ALTER COLUMN orig_stan varchar(30) NULL;
GO
--[/RXPS-24193]