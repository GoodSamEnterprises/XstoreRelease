...
CREATE TABLE [dbo].[cat_authorizations](
    ...
    [authorization_type]  nvarchar(30)    NULL,
    [create_date]         datetime       NULL,
    [create_user_id]      nvarchar(30)    NULL,
    [update_date]         datetime       NULL,
    [update_user_id]      nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[cat_charge_acct_history](
    ...
    [activity_enum]       nvarchar(30)       NULL,
    [amt]                 decimal(17, 6)    NULL,
    [party_id]            bigint            NULL,
    [acct_user_name]      nvarchar(254)      NULL,
...
CREATE TABLE [dbo].[cat_charge_acct_users](
    ...
    [acct_user_first_name]  nvarchar(60)	    NULL,
    [acct_user_last_name]   nvarchar(60)	    NULL,
    [create_date]           datetime        NULL,
    [create_user_id]        nvarchar(30)     NULL,
    [update_date]           datetime        NULL,
    [update_user_id]        nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[cat_cust_acct](
    ...
    [cust_identity_typcode]   nvarchar(30)       NULL,
    [party_id]                bigint            NULL,
    [acct_po_nbr]             nvarchar(60)       NULL,
    [dtv_class_name]          nvarchar(254)      NULL,
    [cust_acct_statcode]      nvarchar(30)       NULL,
    [last_activity_date]      datetime          NULL,
...
CREATE TABLE [dbo].[cat_cust_acct_plan](
    ...
    [plan_description]  nvarchar(255)    NULL,
    [effective_date]    datetime        NULL,
    [expiration_date]   datetime        NULL,
...
CREATE TABLE [dbo].[cat_cust_item_acct_activity](
    ...
    [item_acct_activity_code]         nvarchar(30)       NULL,
    [item_acct_lineitm_statcode]      nvarchar(30)       NULL,
    [rtl_loc_id]                      int               NULL,
    [wkstn_id]                        bigint            NULL,
    [business_date]                   datetime          NULL,
    [trans_seq]                       bigint            NULL,
...
CREATE TABLE [dbo].[cat_cust_item_acct_detail](
    ...
    [delivery_type_id]                nvarchar(20)       NULL,
...
CREATE TABLE [dbo].[cat_cust_loyalty_acct](
    ...
    [loyalty_program_id]          nvarchar(60)       NULL,
    [loyalty_program_level_id]    nvarchar(60)       NULL,
    [loyalty_program_name]        nvarchar(60)       NULL,
    [loyalty_program_level_name]  nvarchar(60)       NULL,
    [create_date]                 datetime          NULL,
    [create_user_id]              nvarchar(30)       NULL,
    [update_date]                 datetime          NULL,
    [update_user_id]              nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[cat_delivery_modifier](
    ...
    [cust_acct_code]       nvarchar(30)     NOT NULL,
    [cust_acct_id]         nvarchar(60)     NOT NULL,
    [delivery_enum]        nvarchar(30)     NULL,
    ...
    [first_name]           nvarchar(254)    NULL,
    [middle_name]          nvarchar(254)    NULL,
    [last_name]            nvarchar(254)    NULL,
    [shipping_method]      nvarchar(254)    NULL,
    [tracking_number]      nvarchar(254)    NULL,
...
CREATE TABLE [dbo].[cat_escrow_acct_activity](
    ...
    [rtl_loc_id]             int               NULL,
    [wkstn_id]               bigint            NULL,
    [source_cust_acct_id]    nvarchar(60)       NULL,
    [source_cust_acct_code]  nvarchar(30)       NULL,
    [create_date]            datetime          NULL,
    [create_user_id]         nvarchar(30)       NULL,
    [update_date]            datetime          NULL,
    [update_user_id]         nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[cat_payment_schedule](
    ...
    [interval_type_enum]  nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[civc_invoice](
    ...
    [ext_invoice_id]      nvarchar(60)     NULL,
    [gross_amt]           decimal(17, 6)  NULL,
    [refund_amt]          decimal(17, 6)  NULL,
    [invoice_date]        datetime        NULL,
    [ext_invoice_barcode] nvarchar(60)     NULL,
    [create_date]         datetime        NULL,
    [create_user_id]      nvarchar(30)     NULL,
    [update_date]         datetime        NULL,
    [update_user_id]      nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[com_address_country](
    ...
    [country_name]       nvarchar(254)   NULL,
...
CREATE TABLE [dbo].[com_button_grid](
    ...
    [image_x]          int			   NULL,
    [image_y]          int			   NULL,
    [visibility_rule]  nvarchar(255)    NULL,
    [height_span]      int             NULL,
    [width_span]       int             NULL,
    [background_rgb]   nvarchar(7)      NULL,
    [foreground_rgb]   nvarchar(7)      NULL,
    [button_style]     nvarchar(50)     NULL,
    [action_idx]       int             NULL,
...
CREATE TABLE [dbo].[com_flight_info](
    ...
    [via_1_airport]             nvarchar(3)     NULL,
    [via_2_airport]             nvarchar(3)     NULL,
    [via_3_airport]             nvarchar(3)     NULL,
    [create_date]               datetime       NULL,
    [create_user_id]            nvarchar(30)    NULL,
    [update_date]               datetime       NULL,
    [update_user_id]            nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[com_report_lookup](
    ...
    [org_code]              nvarchar(30) DEFAULT('*')     NOT NULL,
    [org_value]             nvarchar(60) DEFAULT('*')     NOT NULL,
    [report_url]            nvarchar(254)    NULL,
    [description]           nvarchar(254)    NULL,
    [record_type_enum]      nvarchar(30)     NULL,
    [record_creation_date]  datetime        NULL,
    [record_level_enum]     nvarchar(30)     NULL,
    [parent_report_id]      nvarchar(60)     NULL,
...
CREATE TABLE [dbo].[com_shipping_fee](
    ...
    [org_value]		 nvarchar(60) DEFAULT('*')    NOT NULL,
    [priority]          int            NULL,
    [ship_item_id]      nvarchar(60)    NULL,
    [aggregation_type]  nvarchar(30)    NULL,
    [rule_type]         nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[com_trans_prompt_properties](
    ...
    [org_value]					 nvarchar(60)	   DEFAULT '*' NOT NULL,
    [expiration_date]				datetime       NULL,
    [code_category]				 nvarchar(30)    NULL,
    [prompt_title_key]			 nvarchar(60)    NULL,
    [prompt_msg_key]			 nvarchar(60)    NULL,
    [required_flag]					bit            DEFAULT 0 NULL,
    [sort_order]					int            NULL,
    [prompt_mthd_code]			 nvarchar(30)    NULL,
    [prompt_edit_pattern]		 nvarchar(30)    NULL,
    [validation_rule_key]		 nvarchar(30)    NULL,
    [transaction_state]			 nvarchar(30)    NULL,
    [prompt_key]				 nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[com_translations](
	...
	[EXTERNAL_SYSTEM]  nvarchar(60)	   null,
    [create_date]      datetime        NULL,
    [create_user_id]   nvarchar(30)     NULL,
    [update_date]      datetime        NULL,
    [update_user_id]   nvarchar(30)     NULL,
...
CREATE TABLE crm_gift_registry_journal(
    ...
    registry_status        nvarchar(30)    NULL,
    trans_rtl_loc_id       int            NULL,
    trans_wkstn_id         bigint         NULL,
    trans_business_date    datetime       NULL,
    trans_trans_seq        bigint         NULL,
...
CREATE TABLE [dbo].[crm_party](
    [organization_id]           int             NOT NULL,
    [party_id]                  bigint          NOT NULL,
    [party_typcode]             nvarchar(30)     NULL,
    [cust_id]                   nvarchar(60)     NULL,
    ...
    [first_name2]               nvarchar(60)     NULL,
    [last_name2]                nvarchar(60)     NULL,
    [suffix]                    nvarchar(30)     NULL,
    [gender]                    nvarchar(30)     NULL,
    [preferred_locale]          nvarchar(30)     NULL,
    [birth_date]                datetime        NULL,
    [social_security_nbr]       nvarchar(255)    NULL,
    [national_tax_id]           nvarchar(30)     NULL,
    [personal_tax_id]           nvarchar(30)     NULL,
    [prospect_flag]             bit             DEFAULT ((0)) NULL,
    [rent_flag]                 bit             DEFAULT ((0)) NULL,
    [privacy_card_flag]         bit             DEFAULT ((0)) NULL,
    [contact_pref]              nvarchar(30)     NULL,
    [sign_up_rtl_loc_id]        int             NULL,
    [allegiance_rtl_loc_id]     int             NULL,
    [anniversary_date]          datetime        NULL,
    [organization_typcode]      nvarchar(30)     NULL,
    [organization_name]         nvarchar(60)     NULL,
    [commercial_customer_flag]  bit             DEFAULT ((0)) NULL,
    [picture_uri]               nvarchar(254)    NULL,
    [void_flag]                 bit             DEFAULT ((0)) NULL,
...
CREATE TABLE [dbo].[crm_party_email](
    ...
    [email_type]       nvarchar(20)     NULL,
    [email_format]     nvarchar(20)     NULL,
...
CREATE TABLE [dbo].[crpt_daily_detail](
    ...
    [count01]          bigint            NULL,
    [count02]          bigint            NULL,
    [txt01]            nvarchar(2000)     NULL,
    [txt02]            nvarchar(2000)     NULL,
    [txt03]            nvarchar(2000)     NULL,
    [txt04]            nvarchar(2000)     NULL,
    [txt05]            nvarchar(2000)	 NULL,    
    [txt06]            nvarchar(2000)     NULL,
...
CREATE TABLE [dbo].[ctl_app_version](
    ...
    [version_number]    nvarchar(255)    NULL,
    [version_priority]  nvarchar(255)    NULL,
    [effective_date]    datetime        NULL,
    [update_url]        nvarchar(255)    NULL,
    [create_date]       datetime        NULL,
    [create_user_id]    nvarchar(30)     NULL,
    [update_date]       datetime        NULL,
    [update_user_id]    nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[ctl_event_log](
    ...
    [thread_name]          nvarchar(254)    NULL,
    [critical_to_deliver]  bit             DEFAULT ((0)) NULL,
    [logger_category]      nvarchar(254)    NULL,
...
CREATE TABLE [dbo].[cwo_category_service_loc](
    ...
    [lead_time_unit_enum]   nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[cwo_invoice_lineitm](
    ...
    [lineitm_typcode]      nvarchar(30)       NULL,
    [amt]                  decimal(17, 6)    NULL,
    [gl_account]           nvarchar(60)       NULL,
    [cust_acct_id]         nvarchar(60)       NULL,
    [create_date]          datetime          NULL,
    [create_user_id]       nvarchar(30)       NULL,
    [update_date]          datetime          NULL,
    [update_user_id]       nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[cwo_task](
    ...
    [category_id]      nvarchar(60)    NULL,
    [price_type_enum]  nvarchar(30)    NULL,
    [create_date]      datetime       NULL,
    [create_user_id]   nvarchar(30)    NULL,
    [update_date]      datetime       NULL,
    [update_user_id]   nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[cwo_work_item](
    ...
    [warranty_number]       nvarchar(254)      NULL,
    [work_item_serial_nbr]  nvarchar(254)      NULL,
    [void_flag]             bit               DEFAULT ((0)) NULL,
    [create_date]           datetime          NULL,
    [create_user_id]        nvarchar(30)       NULL,
    [update_date]           datetime          NULL,
...
CREATE TABLE [dbo].[cwo_work_order_acct](
    ...
    [price_code]                 nvarchar(30)       NULL,
    [contact_method_code]        nvarchar(30)       NULL,
    [last_cust_notice]           datetime          NULL,
    [cost]                       decimal(17, 6)    NULL,
    [invoice_number]             nvarchar(60)       NULL,
    [create_date]                datetime          NULL,
    [create_user_id]             nvarchar(30)       NULL,
    [update_date]                datetime          NULL,
    [update_user_id]             nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[cwo_work_order_acct_journal](
    ...
    [last_cust_notice]           datetime          NULL,
    [service_loc_id]             nvarchar(60)       NULL,
    [create_date]                datetime          NULL,
    [create_user_id]             nvarchar(30)       NULL,
    [update_date]                datetime          NULL,
    [update_user_id]             nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[cwo_work_order_line_item](
    ...
    [trans_seq]           bigint          NOT NULL,
    [rtrans_lineitm_seq]  int             NOT NULL,
    [price_status_enum]   nvarchar(30)     NULL,
    [instructions]        nvarchar(254)    NULL,
    [create_date]         datetime        NULL,
    [create_user_id]      nvarchar(30)     NULL,
    [update_date]         datetime        NULL,
...
CREATE TABLE [dbo].[doc_document](
    ...
    [org_code]         nvarchar(30) DEFAULT('*')     NOT NULL,
    [org_value]        nvarchar(60) DEFAULT('*')     NOT NULL,
    [document_status]  nvarchar(30)       NULL,
    [issue_date]       datetime          NULL,
    [effective_date]   datetime          NULL,
    [expiration_date]  datetime          NULL,
    [amount]           decimal(17, 6)    NULL,
...
CREATE TABLE [dbo].[doc_document_def_properties](
    ...
    [org_code]         nvarchar(30) DEFAULT('*')     NOT NULL,
    [org_value]        nvarchar(60) DEFAULT('*')     NOT NULL,
    [property_code]    nvarchar(30)       NULL,
    [type]             nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[doc_document_definition](
    ...
    [text_code_value]    nvarchar(30)     NULL,
    [file_name]          nvarchar(254)    NULL,
    [vendor_id]          nvarchar(60)     NULL,
    [description]        nvarchar(254)    NULL,
    [create_date]        datetime        NULL,
    [create_user_id]     nvarchar(30)     NULL,
    [update_date]        datetime        NULL,
...
CREATE TABLE [dbo].[doc_document_lineitm](
    ...
    [trans_seq]           bigint         NOT NULL,
    [rtrans_lineitm_seq]  int            NOT NULL,
    [document_id]         nvarchar(60)    NULL,
    [document_type]       nvarchar(30)    NULL,
    [series_id]           nvarchar(60)    NULL,
...
CREATE TABLE [dbo].[dsc_coupon_xref](
    ...
    [org_code]			 nvarchar(30) DEFAULT('*')     NOT NULL,
    [org_value]          nvarchar(60) DEFAULT('*')     NOT NULL,
    [discount_code]      nvarchar(60)     NULL,
    [tndr_id]            nvarchar(60)     NULL,
    [coupon_type]        nvarchar(60)     NULL,
...
CREATE TABLE [dbo].[dsc_discount](
    ...
    [prompt]                    nvarchar(254)      NULL,
    [sound]                     nvarchar(254)      NULL,
    ...
    [taxability_code]           nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[hrs_employee](
    ...
    [employee_group_id]        nvarchar(60)       NULL,
    [employee_work_status]     nvarchar(30)       NULL,
...
CREATE TABLE [hrs_employee_answers](
    ...
    [challenge_answer]  nvarchar(max)    NULL,
    [create_date]       datetime        NULL,
    [create_user_id]    nvarchar(30)     NULL,
    [update_date]       datetime        NULL,
    [update_user_id]    nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[hrs_employee_fingerprint](
    ...
    [fingerprint_storage]  nvarchar(max)    NULL,
    [create_date]          datetime        NULL,
    [create_user_id]       nvarchar(30)     NULL,
    [update_date]          datetime        NULL,
    [update_user_id]       nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[hrs_work_codes](
    ...
    [payroll_category]        nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[inv_bucket](
    ...
    [adjustment_action]    nvarchar(30)     NULL,
    [default_location_id]  nvarchar(60)     NULL,
...
CREATE TABLE [dbo].[inv_carton](
    ...
    [carton_statcode]       nvarchar(30)     NULL,
    [record_creation_type]  nvarchar(30)     NULL,
    [control_number]        nvarchar(254)    NULL,
    [create_date]           datetime        NULL,
    [create_user_id]        nvarchar(30)     NULL,
    [update_date]           datetime        NULL,
    [update_user_id]        nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[inv_count_bucket](
    ...
    [bucket_status]    nvarchar(60)    NULL,
    [inv_bucket_name]  nvarchar(60)    NULL,
    [create_date]      datetime       NULL,
    [create_user_id]   nvarchar(30)    NULL,
    [update_date]      datetime       NULL,
    [update_user_id]   nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[inv_count_section_detail](
    ...
    [merch_hierarchy_level]  nvarchar(60)     NULL,
    [merch_hierarchy_id]     nvarchar(60)     NULL,
    [description]            nvarchar(254)    NULL,
    [create_date]            datetime        NULL,
    [create_user_id]         nvarchar(30)     NULL,
    [update_date]            datetime        NULL,
...
CREATE TABLE [dbo].[inv_count_sheet](
    ...
    [inv_bucket_id]     nvarchar(60)    NULL,
    [section_nbr]       int            NULL,
    [section_id]        nvarchar(60)    NULL,
    [count_cycle]       int            NULL,
    [sheet_status]      nvarchar(60)    NULL,
...
CREATE TABLE [dbo].[inv_document_lineitm_note](
    ...
    [note_timestamp]            datetime       NULL,
    [note_type]                 nvarchar(60)    NULL,
    [note_text]                 text           NULL,
    [record_creation_type]      nvarchar(60)    NULL,
    [creator_party_id]          bigint         NULL,
    [create_date]               datetime       NULL,
    [create_user_id]            nvarchar(30)    NULL,
    [update_date]               datetime       NULL,
...
CREATE TABLE [dbo].[inv_invctl_document](
    ...
    [status_code]              nvarchar(30)     NULL,
    [originator_id]            nvarchar(60)     NULL,
    [document_subtypcode]      nvarchar(30)     NULL,
    [originator_name]          nvarchar(254)    NULL,
    [last_activity_date]       datetime        NULL,
    [po_ref_nbr]               nvarchar(254)    NULL,
    [record_creation_type]     nvarchar(30)     NULL,
    [description]              nvarchar(254)    NULL,
    [control_number]           nvarchar(254)    NULL,
    [originator_address_id]    nvarchar(60)     NULL,
...
CREATE TABLE [dbo].[inv_invctl_document_lineitm](
    ...
    [document_typcode]            nvarchar(30)       NOT NULL,
    [invctl_document_line_nbr]    int               NOT NULL,
    [carton_id]                   nvarchar(60)       NULL,
    [inventory_item_id]           nvarchar(60)       NULL,
    [lineitm_typcode]             nvarchar(30)       NULL,
    ...
    [status_code]                 nvarchar(30)       NULL,
    [original_loc_id]             nvarchar(60)       NULL,
    [original_bucket_id]          nvarchar(60)       NULL,
    [expected_count]              decimal(14, 4)    NULL,
    [posted_count]                decimal(14, 4)    NULL,
    [record_creation_type]        nvarchar(30)       NULL,
    [entered_item_id]             nvarchar(60)       NULL,
    [entered_item_description]    nvarchar(254)      NULL,
    [serial_number]               nvarchar(254)      NULL,
    [retail]                      decimal(17, 6)    NULL,
    [model_nbr]                   nvarchar(254)      NULL,
    [control_number]              nvarchar(254)      NULL,
...
CREATE TABLE [dbo].[inv_invctl_document_xref](
    ...
    [cross_ref_document_id]       nvarchar(60)    NULL,
    [cross_ref_line_number]       int            NULL,
    [cross_ref_document_typcode]  nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[inv_invctl_trans](
    ...
    [rtl_loc_id]                  int            NOT NULL,
    [trans_seq]                   bigint         NOT NULL,
    [document_typcode]            nvarchar(30)    NULL,
    [document_date]               datetime       NULL,
    [old_status_code]             nvarchar(30)    NULL,
    [new_status_code]             nvarchar(30)    NULL,
    [invctl_document_id]          nvarchar(60)    NULL,
    [invctl_document_rtl_loc_id]  int            NULL,
    [invctl_trans_reascode]       nvarchar(30)    NULL,
    [create_date]                 datetime       NULL,
    [create_user_id]              nvarchar(30)    NULL,
    [update_date]                 datetime       NULL,
    [update_user_id]              nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[inv_inventory_journal](
    ...
    [journal_seq]         bigint            NOT NULL,
    [inventory_item_id]   nvarchar(60)       NULL,
    [item_serial_nbr]     nvarchar(254)      NULL,
    [action_code]         nvarchar(30)       NULL,
    [quantity]            decimal(11, 4)    NULL,
    [source_location_id]  nvarchar(60)       NULL,
    [source_bucket_id]    nvarchar(60)       NULL,
    [dest_location_id]    nvarchar(60)       NULL,
    [dest_bucket_id]      nvarchar(60)       NULL,
    [create_date]         datetime          NULL,
    [create_user_id]      nvarchar(30)       NULL,
    [update_date]         datetime          NULL,
    [update_user_id]      nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[inv_location_bucket](
    ...
    [location_id]      nvarchar(60)    NOT NULL,
    [bucket_id]        nvarchar(60)    NOT NULL,
    [tracking_method]  nvarchar(30)    NULL,
    [create_date]      datetime       NULL,
    [create_user_id]   nvarchar(30)    NULL,
    [update_date]      datetime       NULL,
    [update_user_id]   nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[inv_shipment](
    ...
    [shipping_carrier]			 nvarchar(254)    NULL,
    [actual_ship_date]				datetime        NULL,
    [tracking_nbr]				 nvarchar(254)    NULL,
    [shipment_statcode]			 nvarchar(30)     NULL,
    [record_creation_type]		 nvarchar(30)     NULL,
    [destination_rtl_loc_id]		int             NULL,
    [destination_name]			 nvarchar(254)    NULL,
    [shipping_method]			 nvarchar(254)    NULL,
    [shipping_label]			 nvarchar(max)    NULL,
	[destination_type]			 nvarchar(30)	  NULL,
	[destination_service_loc_id] nvarchar(60)	  NULL,
    [create_date]					datetime        NULL,
    [create_user_id]			 nvarchar(30)     NULL,
    [update_date]					datetime        NULL,
    [update_user_id]			 nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[inv_shipper_method](
    ...
    [org_code]			     nvarchar(30) DEFAULT('*')	 NOT NULL,
    [org_value]		         nvarchar(60) DEFAULT('*')	 NOT NULL,
    [shipper_method_desc]    nvarchar(254)	NULL,
    [shipper_id]             nvarchar(60)	NULL,
    [domestic_service_code]  nvarchar(60)	NULL,
	[intl_service_code]		 nvarchar(60)	NULL,
    [display_order]          int			NULL,
	[priority]				 int			NULL,
    [create_date]            datetime		NULL,
    [create_user_id]         nvarchar(30)	NULL,
...
CREATE TABLE [dbo].[itm_item_label_properties](
    ...
    [org_code]              nvarchar(30)     DEFAULT '*' NOT NULL,
    [org_value]             nvarchar(60)     DEFAULT '*' NOT NULL,
    [stock_label]           nvarchar(30)     NULL,
    [logo_url]              nvarchar(254)    NULL,
    [create_date]           datetime        NULL,
    [create_user_id]        nvarchar(30)     NULL,
    [update_date]           datetime        NULL,
    [update_user_id]        nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[itm_item_options] (
    ...
    [TARE_UNIT_OF_MEASURE_CODE]    nvarchar(30)       NULL,
    [CREATE_DATE]                  datetime          NULL,
    [CREATE_USER_ID]               nvarchar(30)       NULL,
    [UPDATE_DATE]                  datetime          NULL,
    [UPDATE_USER_ID]               nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[itm_item_options_p](
    ...
    [LEVEL_VALUE]      nvarchar(60)       NOT NULL,
    [PROPERTY_CODE]    nvarchar(30)       NOT NULL,
    [TYPE]             nvarchar(30)       NULL,
    [STRING_VALUE]     nvarchar(max)      NULL,
    [DATE_VALUE]       datetime          NULL,
...
CREATE TABLE [dbo].[itm_item_restrict_calendar](
    ...
    [restriction_code]      nvarchar(60)    NOT NULL,
    [day_code]              nvarchar(3)     NOT NULL,
    [effective_date]        datetime       NOT NULL,
    [start_time]            datetime       NOT NULL,
    [sale_lineitm_typecode] nvarchar(30)    DEFAULT 'ANY' NOT NULL,
    [org_code]			 nvarchar(30)	   DEFAULT '*' NOT NULL,
    [org_value]			 nvarchar(60)	   DEFAULT '*' NOT NULL,
    [expiration_date]       datetime       NULL,
...
CREATE TABLE [dbo].[itm_item_restriction](
    ...
    [effective_date]        datetime          NOT NULL,
    [sale_lineitm_typecode] nvarchar(30)       DEFAULT('ANY') NOT NULL,
    [property_name]         nvarchar(30)       DEFAULT('DEFAULT') NOT NULL,
    [org_code]			 nvarchar(30) DEFAULT('*')		  NOT NULL,
    [org_value]			 nvarchar(60) DEFAULT('*')		  NOT NULL,
    [expiration_date]       datetime          NULL,
...
CREATE TABLE [dbo].[itm_warranty](
    ...
    [warranty_plan_id]                nvarchar(60)       NULL,
    ...
    [cust_id]                         nvarchar(60)       NULL,
    [party_id]                        bigint            NULL,
    [certificate_nbr]                 nvarchar(60)       NULL,
    [certificate_company_name]        nvarchar(254)      NULL,
    [warranty_item_id]                nvarchar(60)       NULL,
    ...
    [covered_item_id]                 nvarchar(60)       NULL,
    ...
    [covered_item_purchase_location]  nvarchar(254)      NULL,
    [create_date]                     datetime          NULL,
    [create_user_id]                  nvarchar(30)       NULL,
    [update_date]                     datetime          NULL,
    [update_user_id]                  nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[itm_warranty_item](
    [organization_id]            int               NOT NULL,
    [item_id]                    nvarchar(60)       NOT NULL,
    [pricing_mthd_code]          nvarchar(60)       NULL,
...
CREATE TABLE [dbo].[loc_closing_message](
    [organization_id]  int             NOT NULL,
    [rtl_loc_id]       int             NOT NULL,
    [closing_message]  nvarchar(254)    NULL,
    [create_date]      datetime        NULL,
    [create_user_id]   nvarchar(30)     NULL,
    [update_date]      datetime        NULL,
    [update_user_id]   nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[loc_cycle_question_choices](
    ...
    [question_id]      nvarchar(60)     NOT NULL,
    [answer_id]        nvarchar(60)     NOT NULL,
    [answer_text_key]  nvarchar(max)    NULL,
    [sort_order]       int             NULL,
    [create_date]      datetime        NULL,
    [create_user_id]   nvarchar(30)     NULL,
    [update_date]      datetime        NULL,
...
CREATE TABLE [dbo].[loc_cycle_questions](
    [organization_id]         int             NOT NULL,
    [question_id]             nvarchar(60)     NOT NULL,
    [question_text_key]       nvarchar(254)    NULL,
    [sort_order]              int             NULL,
    ...
    [question_typcode]        nvarchar(30)     NULL,
    [create_date]             datetime        NULL,
    [create_user_id]          nvarchar(30)     NULL,
    [update_date]             datetime        NULL,
    [update_user_id]          nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[loc_org_hierarchy](
    ...
    [org_value]        nvarchar(60)     NOT NULL,
    [parent_code]      nvarchar(30)     NULL,
    [parent_value]     nvarchar(60)     NULL,
    [description]      nvarchar(254)    NULL,
    [level_mgr]        nvarchar(254)    NULL,
...
CREATE TABLE [dbo].[prc_deal](
    ...
    [trwide_action]                nvarchar(30)       NULL,
    [trwide_amount]                decimal(17, 6)    NULL,
    [taxability_code]              nvarchar(30)       NULL,
    [promotion_id]                 nvarchar(60)       NULL,
...
CREATE TABLE [dbo].[rms_diff_ids](
    [organization_id]  int             NOT NULL,
    [diff_id]          nvarchar(10)     NOT NULL,
    [diff_desc]        nvarchar(120)    NULL,
    [diff_type]        nvarchar(6)      NOT NULL,
    [diff_type_desc]   nvarchar(120)    NULL,
    [create_date]      datetime        NULL,
    [update_date]      datetime        NULL,
...
CREATE TABLE [dbo].[rpt_fifo](
    ...
    [item_id]				 nvarchar(60)       NOT NULL,
    [description]			 nvarchar(254)      NULL,
    [style_id]				 nvarchar(60)       NULL,
    [style_desc]         	 nvarchar(254)      NULL,
    [rtl_loc_id]				int               NOT NULL,
    [store_name]			 nvarchar(254)      NULL,
    [unit_count]				decimal(14, 4)    NULL,
    [unit_cost]				decimal(17, 6)    NULL,
...
CREATE TABLE [dbo].[rpt_sale_line](
    ...
    [currency_id]           nvarchar(3)        NULL,
    [item_id]               nvarchar(60)       NULL,
    [item_desc]             nvarchar(254)      NULL,
    [merch_level_1]         nvarchar(60)       NULL,
    [serial_nbr]            nvarchar(60)       NULL,
    ...
    [last_name]             nvarchar(254)      NULL,
    [first_name]            nvarchar(254)      NULL,
    [trans_statcode]        nvarchar(60)       NULL,
    [sale_lineitm_typcode]  nvarchar(60)       NULL,
...
CREATE TABLE [dbo].[sch_emp_time_off](
    ...
    [void_flag]         bit            DEFAULT ((0)) NULL,
    [time_off_typcode]  nvarchar(30)    NULL,
    [create_date]       datetime       NULL,
    [create_user_id]    nvarchar(30)    NULL,
    [update_date]       datetime       NULL,
    [update_user_id]    nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[sec_activity_log](
    ...
    [employee_id]             nvarchar(60)   NULL,
    [overriding_employee_id]  nvarchar(60)   NULL,
    [privilege_type]          nvarchar(255)  NULL,
...
CREATE TABLE [dbo].[tax_tax_code](
    [organization_id]  int             NOT NULL,
    [tax_code_id]      nvarchar(30)     NOT NULL,
...
CREATE TABLE [dbo].[tax_tax_exemption](
    ...
    [party_id]                bigint          NULL,
    [cert_nbr]                nvarchar(30)     NULL,
    [reascode]                nvarchar(30)     NULL,
    [cert_holder_name]        nvarchar(254)    NULL,
    [cert_country]            nvarchar(2)      NULL,
    [expiration_date]         datetime        NULL,
    [cert_state]              nvarchar(30)     NULL,
    [notes]                   nvarchar(254)    NULL,
    [address_id]              nvarchar(60)     NULL,
    [phone_number]            nvarchar(32)     NULL,
    [region]                  nvarchar(30)     NULL,
    [diplomatic_title]        nvarchar(60)     NULL,
    [cert_holder_first_name]  nvarchar(60)     NULL,
    [cert_holder_last_name]   nvarchar(60)     NULL,
    [create_date]             datetime        NULL,
    [create_user_id]          nvarchar(30)     NULL,
    [update_date]             datetime        NULL,
    [update_user_id]          nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[tax_tax_group_mapping](
    ...
    [priority]           int            NULL,
    [new_tax_group_id]   nvarchar(60)    NULL,
    [create_date]        datetime       NULL,
    [create_user_id]     nvarchar(30)    NULL,
    [update_date]        datetime       NULL,
    [update_user_id]     nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[thr_payroll](
    ...
    [posted_flag]       bit               DEFAULT ((0)) NULL,
    [posted_date]       datetime          NULL,
    [payroll_status]    nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[thr_timecard_entry](
    ...
    [entry_type_enum]          nvarchar(30)    NULL,
    [delete_flag]              bit            DEFAULT ((0)) NULL,
...
CREATE TABLE [dbo].[thr_timeclk_trans](
    ...
    [work_code]                     nvarchar(30)    NULL,
    [timeclk_entry_code]            nvarchar(30)    NULL,
    [party_id]                      bigint         NULL,
    [timecard_entry_id]             int            NULL,
...
CREATE TABLE [dbo].[trl_ar_sale_lineitm](
    ...
    [trans_seq]           bigint          NOT NULL,
    [rtrans_lineitm_seq]  int             NOT NULL,
    [acct_nbr]            nvarchar(60)     NULL,
    [auth_mthd_code]      nvarchar(30)     NULL,
    [adjudication_code]   nvarchar(30)     NULL,
    [entry_mthd_code]     nvarchar(30)     NULL,
    [auth_code]           nvarchar(30)     NULL,
    [activity_code]       nvarchar(30)     NULL,
    [reference_nbr]       nvarchar(254)    NULL,
    [acct_user_id]	      nvarchar(30)	  null,
    [acct_user_name]      nvarchar(254)	  null,
    [create_date]         datetime        NULL,
    [create_user_id]      nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[trl_commission_mod](
    ...
    [unverifiable_emp_id]     nvarchar(60)       NULL,
    [create_date]             datetime          NULL,
    [create_user_id]          nvarchar(30)       NULL,
    [update_date]             datetime          NULL,
    [update_user_id]          nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_coupon_lineitm](
    ...
    [wkstn_id]                  bigint            NOT NULL,
    [trans_seq]                 bigint            NOT NULL,
    [coupon_id]                 nvarchar(254)      NULL,
    [typcode]                   nvarchar(30)       NULL,
    [serialized_flag]           bit               DEFAULT ((0)) NULL,
    [expr_date]                 datetime          NULL,
    [entry_mthd_code]           nvarchar(30)       NULL,
    [manufacturer_id]           nvarchar(254)      NULL,
    [value_code]                nvarchar(30)       NULL,
    [manufacturer_family_code]  nvarchar(254)      NULL,
    [amt_entered]               decimal(17, 6)    NULL,
    [authorized_flag]           bit               DEFAULT ((0)) NULL,
    [redemption_trans_id]       nvarchar(60)       NULL,
    [create_date]               datetime          NULL,
    [create_user_id]            nvarchar(30)       NULL,
    [update_date]               datetime          NULL,
    [update_user_id]            nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_cust_item_acct_mod](
    ...
    [rtrans_lineitm_seq]        int               NOT NULL,
    [cust_acct_id]              nvarchar(60)       NULL,
    [cust_acct_code]            nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_discount_lineitm](
    ...
    [taxability_code]     nvarchar(30)       NULL,
    [award_trans_id]      nvarchar(60)       NULL,
    [create_date]         datetime          NULL,
    [create_user_id]      nvarchar(30)       NULL,
    [update_date]         datetime          NULL,
    [update_user_id]      nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_kit_component_mod](
    ...
    [component_item_desc]  nvarchar(254)    NULL,
    [display_order]        int             NULL,
    [quantity]             int             NULL,
    [kit_item_id]          nvarchar(60)     NULL,
    [serial_nbr]           nvarchar(60)     NULL,
    [create_date]          datetime        NULL,
    [create_user_id]       nvarchar(30)     NULL,
    [update_date]          datetime        NULL,
...
CREATE TABLE [dbo].[trl_rtl_price_mod](
    ...
    [notes]                    nvarchar(254)      NULL,
    [rtl_price_mod_reascode]   nvarchar(30)       NULL,
    [void_flag]                bit               DEFAULT ((0)) NULL,
    ...
    [discount_code]            nvarchar(60)       NULL,
    [price_change_reascode]    nvarchar(30)       NULL,
    [deal_id]                  nvarchar(60)       NULL,
    [deal_amt]                 decimal(17, 6)    NULL,
    [serial_number]            nvarchar(254)      NULL,
    [discount_group_id]        int               NULL,
    [description]              nvarchar(254)      NULL,
    [discount_reascode]        nvarchar(30)       NULL,
    [extended_amt]             decimal(17, 6)    NULL,
    [taxability_code]          nvarchar(30)       NULL,
    [create_date]              datetime          NULL,
    [create_user_id]           nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_rtrans](
    ...
    [loyalty_card_number]  nvarchar(60)       NULL,
    [tax_exemption_id]     nvarchar(60)       NULL,
    [create_date]          datetime          NULL,
    [create_user_id]       nvarchar(30)       NULL,
    [update_date]          datetime          NULL,
    [update_user_id]       nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_rtrans_flight_info](
    ...
    [trans_seq]                 bigint          NOT NULL,
    [flight_number]             nvarchar(30)     NOT NULL,
    [destination_airport]       nvarchar(3)      NULL,
    [destination_country]       nvarchar(2)      NULL,
    [destination_zone]          nvarchar(30)     NULL,
    [destination_airport_name]  nvarchar(254)    NULL,
    [origin_airport]            nvarchar(3)      NULL,
    [tax_calculation_mode]      nvarchar(30)     NULL,
    [first_flight_number]       nvarchar(30)     NULL,
    [first_destination_airport] nvarchar(3)      NULL,
    [first_origin_airport]      nvarchar(3)      NULL,
    [first_flight_seat_number]  nvarchar(4)      NULL,
...
CREATE TABLE [dbo].[trl_rtrans_lineitm](
    ...
    [notes]                    nvarchar(254)    NULL,
    [rtrans_lineitm_typcode]   nvarchar(30)     NULL,
    [rtrans_lineitm_statcode]  nvarchar(30)     NULL,
    [void_flag]                bit             DEFAULT ((0)) NULL,
    [dtv_class_name]           nvarchar(254)    NULL,
    [void_lineitm_reascode]    nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[trl_sale_lineitm](
    ...
    [return_flag]                   bit               DEFAULT 0 NULL,
    [item_id_entry_mthd_code]       nvarchar(30)       NULL,
    [price_entry_mthd_code]         nvarchar(30)       NULL,
    [price_derivtn_mthd_code]       nvarchar(30)       NULL,
    [price_property_code]           nvarchar(60)       NULL,
    [net_amt]                       decimal(17, 6)    NULL,
    [gross_amt]                     decimal(17, 6)    NULL,
    [serial_nbr]                    nvarchar(60)       NULL,
    [returned_quantity]             decimal(11, 4)    NULL,
    [scanned_item_id]               nvarchar(60)       NULL,
    [sale_lineitm_typcode]          nvarchar(30)       NULL,
    [tax_group_id]                  nvarchar(60)       NULL,
    [inventory_action_code]         nvarchar(30)       NULL,
    [original_rtrans_lineitm_seq]   int               NULL,
    [original_rtl_loc_id]           int	              NULL,
    [original_wkstn_id]             bigint            NULL,
    [original_business_date]        datetime          NULL,
    [original_trans_seq]            bigint            NULL,
    [return_comment]                nvarchar(254)      NULL,
    [return_reascode]               nvarchar(30)       NULL,
    [return_typcode]                nvarchar(30)       NULL,
    [rcpt_count]                    int               NULL,
    [base_unit_price]               decimal(17, 6)    NULL,
    [base_extended_price]           decimal(17, 6)    NULL,
    [force_zero_extended_amt_flag]  bit               DEFAULT 0 NULL,
    [entered_description]           nvarchar(254)      NULL,
    ...
    [exclude_from_net_sales_flag]   bit               DEFAULT 0 NULL,
	[measure_req_flag]				bit				  DEFAULT 0 NULL,
	[weight_entry_mthd_code]	 nvarchar(30)		  NULL,
	[tare_value]					decimal(11, 4)	  NULL,
	[tare_type]					 nvarchar(30)		  NULL,
	[tare_unit_of_measure_code]	 nvarchar(30)		  NULL,
    [create_date]                   datetime          NULL,
    [create_user_id]                nvarchar(30)       NULL,
    [update_date]                   datetime          NULL,
...
CREATE TABLE [dbo].[trl_sale_tax_lineitm](
    ...
    [tax_override_bracket_id]  nvarchar(60)       NULL,
    [tax_override_flag]        bit               DEFAULT ((0)) NULL,
    [tax_override_reascode]    nvarchar(30)       NULL,
    [void_flag]                bit               DEFAULT ((0)) NULL,
    ...
    [authority_id]             nvarchar(60)       NULL,
    [authority_name]           nvarchar(254)      NULL,
    [authority_type_code]      nvarchar(60)       NULL,
    [tax_override_comment]     nvarchar(255)	     NULL,
    [orig_taxable_amount]      decimal(17, 6)    NULL,
    [orig_tax_group_id]        nvarchar(60)       NULL,
    [create_date]              datetime          NULL,
    [create_user_id]           nvarchar(30)       NULL,
    [update_date]              datetime          NULL,
    [update_user_id]           nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_voucher_discount_lineitm](
    ...
    [trans_seq]            bigint            NOT NULL,
    [rtrans_lineitm_seq]   int               NOT NULL,
    [voucher_typcode]      nvarchar(30)       NULL,
    [auth_mthd_code]       nvarchar(30)       NULL,
    [track1]               nvarchar(254)      NULL,
    [track2]               nvarchar(254)      NULL,
    [track3]               nvarchar(254)      NULL,
    [adjudication_code]    nvarchar(30)       NULL,
    [entry_mthd_code]      nvarchar(30)       NULL,
    [auth_code]            nvarchar(30)       NULL,
    [activity_code]        nvarchar(30)       NULL,
    ...
    [issue_typcode]        nvarchar(30)       NULL,
    [unspent_balance_amt]  decimal(17, 6)    NULL,
    [voucher_status_code]  nvarchar(30)       NULL,
    [serial_nbr]           nvarchar(30)       NULL,
    [trace_number]         nvarchar(60)       NULL,
    [create_date]          datetime          NULL,
    [create_user_id]       nvarchar(30)       NULL,
    [update_date]          datetime          NULL,
    [update_user_id]       nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_voucher_sale_lineitm](
    ...
    [track2]               nvarchar(254)      NULL,
    [track3]               nvarchar(254)      NULL,
    [adjudication_code]    nvarchar(100)      NULL,
    [entry_mthd_code]      nvarchar(30)       NULL,
    [auth_code]            nvarchar(30)       NULL,
    [activity_code]        nvarchar(30)       NULL,
    [reference_nbr]        nvarchar(254)      NULL,
    ...
    [voucher_status_code]  nvarchar(30)       NULL,
    [trace_number]         nvarchar(60)       NULL,
    [orig_local_date_time] nvarchar(20)        NULL,
    [orig_transmission_date_time] nvarchar(20) NULL,
    [orig_STAN]            nvarchar(30)       NULL,
    [merchant_cat_code]    nvarchar(4)        NULL,
    [create_date]          datetime          NULL,
    [create_user_id]       nvarchar(30)       NULL,
    [update_date]          datetime          NULL,
    [update_user_id]       nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[trl_warranty_modifier](
    ...
    [warranty_nbr]           nvarchar(30)    NULL,
    [warranty_typcode]       nvarchar(60)    NULL,
    [create_date]            datetime       NULL,
    [create_user_id]         nvarchar(30)    NULL,
    [update_date]            datetime       NULL,
    [update_user_id]         nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[trn_generic_lineitm_storage](
    ...
    [trans_seq]           bigint          NOT NULL,
    [rtrans_lineitm_seq]  int             NOT NULL,
    [form_key]            nvarchar(50)     NULL,
    [data_storage]        nvarchar(max)    NULL,
    [create_date]         datetime        NULL,
    [create_user_id]      nvarchar(30)     NULL,
    [update_date]         datetime        NULL,
    [update_user_id]      nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[trn_no_sale_trans](
    ...
    [wkstn_id]          bigint         NOT NULL,
    [trans_seq]         bigint         NOT NULL,
    [no_sale_reascode]  nvarchar(30)    NULL,
    [create_date]       datetime       NULL,
    [create_user_id]    nvarchar(30)    NULL,
    [update_date]       datetime       NULL,
    [update_user_id]    nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[trn_post_void_trans](
    ...
    [post_void_reascode]       nvarchar(30)    NULL,
    [voided_trans_entry_code]  nvarchar(30)    NULL,
    [create_date]              datetime       NULL,
    [create_user_id]           nvarchar(30)    NULL,
    [update_date]              datetime       NULL,
    [update_user_id]           nvarchar(30)    NULL,
...
CREATE TABLE [dbo].[trn_trans](
    ...
    [subtotal]               decimal(17, 6)    NULL,
    [trans_cancel_reascode]  nvarchar(30)       NULL,
    [trans_typcode]          nvarchar(30)       NULL,
    [trans_statcode]         nvarchar(30)       NULL,
    [post_void_flag]         bit               DEFAULT ((0)) NULL,
    [generic_storage_flag]   bit               DEFAULT ((0)) NULL,
    [begin_time_int]         int               NULL,
    [cash_drawer_id]         nvarchar(60)       NULL,
    [flash_sales_flag]       bit               DEFAULT ((0)) NULL,
	[fiscal_number]			 nvarchar(10)	   NULL,
	[trans_date]			 datetime		   NULL,
    [create_date]            datetime          NULL,
    [create_user_id]         nvarchar(30)       NULL,
    [update_date]            datetime          NULL,
...
CREATE TABLE [dbo].[trn_trans_version](
    ...
    [business_date]            datetime       NOT NULL,
    [trans_seq]                bigint         NOT NULL,
    [base_app_version]         nvarchar(30)    NULL,
    [base_app_date]            datetime       NULL,
    [base_schema_version]      nvarchar(30)    NULL,
    [base_schema_date]         datetime       NULL,
    [customer_app_version]     nvarchar(30)    NULL,
    [customer_app_date]        datetime       NULL,
    [customer_schema_version]  nvarchar(30)    NULL,
    [customer_schema_date]     datetime       NULL,
    [create_date]              datetime       NULL,
    [create_user_id]           nvarchar(30)    NULL,
    [update_date]              datetime       NULL,
...
CREATE TABLE [dbo].[tsn_serialized_tndr_count](
    ...
    [tndr_id]                    nvarchar(60)       NULL,
    [serial_number]              nvarchar(60)       NULL,
    [amt]                        decimal(17, 6)    NULL,
...
CREATE TABLE [dbo].[tsn_session](
    ...
    [tndr_repository_id]  nvarchar(60)    NULL,
    [employee_party_id]   bigint         NULL,
    [begin_datetime]      datetime       NULL,
    [end_datetime]        datetime       NULL,
    [business_date]       datetime       NULL,
...
CREATE TABLE [dbo].[tsn_till_ctrl_trans_detail](
    ...
    [trans_seq]                    bigint            NOT NULL,
    [trans_lineitm_seq]            int               NOT NULL,
    [affected_tndr_repository_id]  nvarchar(60)       NULL,
...
CREATE TABLE [dbo].[tsn_tndr_control_trans](
    ...
    [outbound_tndr_repository_id]  nvarchar(60)       NULL,
    [inbound_tndr_repository_id]   nvarchar(60)       NULL,
    [deposit_date]                 datetime          NULL,
    [safe_bag_id]                  nvarchar(60)       NULL,
    [create_date]                  datetime          NULL,
    [create_user_id]               nvarchar(30)       NULL,
    [update_date]                  datetime          NULL,
    [update_user_id]               nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[ttr_check_tndr_lineitm](
    ...
    [trans_seq]           bigint          NOT NULL,
    [rtrans_lineitm_seq]  int             NOT NULL,
    [bank_id]             nvarchar(254)    NULL,
    [check_acct_nbr]      nvarchar(254)    NULL,
    [check_seq_nbr]       nvarchar(254)    NULL,
    [adjudication_code]   nvarchar(30)     NULL,
    [cust_birth_date]     datetime        NULL,
    [auth_nbr]            nvarchar(254)    NULL,
    [entry_mthd_code]     nvarchar(30)     NULL,
    [auth_mthd_code]      nvarchar(30)     NULL,
    [micr]                nvarchar(254)    NULL,
    [create_date]         datetime        NULL,
    [create_user_id]      nvarchar(30)     NULL,
    [update_date]         datetime        NULL,
    [update_user_id]      nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[ttr_coupon_tndr_lineitm](
    ...
    [manufacturer_family_code]  nvarchar(254)    NULL,
    [typcode]                   nvarchar(30)     NULL,
    [scan_code]                 nvarchar(30)     NULL,
    [expr_date]                 datetime        NULL,
    [promotion_code]            nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[ttr_credit_debit_tndr_lineitm](
    ...
    [rtrans_lineitm_seq]          int               NOT NULL,
    [trans_seq]                   bigint            NOT NULL,
    [mediaissuer_id]              nvarchar(254)      NULL,
    [acct_nbr]                    nvarchar(254)      NULL,
    [personal_id_req_typcode]     nvarchar(30)       NULL,
    [personal_id_ref_nbr]         nvarchar(254)      NULL,
    [auth_mthd_code]              nvarchar(30)       NULL,
    [track2]                      nvarchar(254)      NULL,
    [track1]                      nvarchar(254)      NULL,
    [track3]                      nvarchar(254)      NULL,
    [adjudication_code]           nvarchar(30)       NULL,
    [entry_mthd_code]             nvarchar(30)       NULL,
    [expr_date]                   nvarchar(64)       NULL,
    [auth_nbr]                    nvarchar(254)      NULL,
    [ps2000]                      nvarchar(254)      NULL,
    [bank_reference_number]       nvarchar(254)      NULL,
    [customer_name]               nvarchar(254)      NULL,
    [cashback_amt]                decimal(17, 6)    NULL,
    [card_level_indicator]        nvarchar(30)       NULL,
    [acct_nbr_hash]               nvarchar(60)       NULL,
    [AUTHORIZATION_TOKEN]         nvarchar(60)       NULL,
    [transaction_reference_data]  nvarchar(254)      NULL,
    [trace_number]                nvarchar(60)       NULL,
    [tax_amt]                     decimal(17, 6)    NULL,
    [discount_amt]                decimal(17, 6)    NULL,
    ...
    [CCV_error_code]              nvarchar(10)       NULL,
    [POS_entry_mode_change]       nvarchar(10)       NULL,
    [processing_code]             nvarchar(10)       NULL,
    [POS_entry_mode]              nvarchar(10)       NULL,
    [POS_addl_data]               nvarchar(20)       NULL,
    [network_result_indicator]    nvarchar(20)       NULL,
    [merchant_cat_code]           nvarchar(4)        NULL,
    [create_date]                 datetime          NULL,
    [create_user_id]              nvarchar(30)       NULL,
    [update_date]                 datetime          NULL,
...
CREATE TABLE [dbo].[ttr_identity_verification](
    ...
    [id_typcode]                 nvarchar(30)     NULL,
    [id_nbr]                     nvarchar(254)    NULL,
    [issuing_authority]          nvarchar(254)    NULL,
    [create_date]                datetime        NULL,
    [create_user_id]             nvarchar(30)     NULL,
    [update_date]                datetime        NULL,
    [update_user_id]             nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[ttr_send_check_tndr_lineitm](
    ...
    [trans_seq]               bigint          NOT NULL,
    [rtrans_lineitm_seq]      int             NOT NULL,
    [payable_to_name]         nvarchar(254)    NULL,
    [payable_to_address]      nvarchar(254)    NULL,
    [payable_to_city]         nvarchar(254)    NULL,
    [payable_to_state]        nvarchar(254)    NULL,
    [payable_to_postal_code]  nvarchar(254)    NULL,
    [reascode]                nvarchar(30)     NULL,
    [payable_to_address2]     nvarchar(254)    NULL,
    [payable_to_address3]     nvarchar(254)    NULL,
    [payable_to_address4]     nvarchar(254)    NULL,
    [payable_to_apt]          nvarchar(30)     NULL,
    [payable_to_country]      nvarchar(2)	  NULL,
	[payable_to_neighborhood] nvarchar(254)	  null,
	[payable_to_county]		  nvarchar(254)	  null,
    [create_date]             datetime        NULL,
    [create_user_id]          nvarchar(30)     NULL,
    [update_date]             datetime        NULL,
    [update_user_id]          nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[ttr_tndr_auth_log](
    ...
    [response_code]       nvarchar(254)    NULL,
    [reference_nbr]       nvarchar(254)    NULL,
    [error_code]          nvarchar(254)    NULL,
    [error_text]          nvarchar(254)    NULL,
    [start_timestamp]     datetime        NULL,
    [end_timestamp]       datetime        NULL,
    [approval_code]       nvarchar(254)    NULL,
    [auth_type]           nvarchar(30)     NULL,
    [customer_name]       nvarchar(254)    NULL,
    [create_date]         datetime        NULL,
    [create_user_id]      nvarchar(30)     NULL,
    [update_date]         datetime        NULL,
...
CREATE TABLE [dbo].[ttr_tndr_lineitm](
    ...
    [tndr_id]               nvarchar(60)       NULL,
    [serial_nbr]            nvarchar(254)      NULL,
    [tndr_statcode]         nvarchar(30)       NULL,
    [party_id]              bigint            NULL,
    [acct_user_name]        nvarchar(254)      NULL,
    [approval_code]         nvarchar(30)       NULL,
    [foreign_amt]           decimal(17, 6)    NULL,
...
CREATE TABLE [dbo].[xom_customization_mod](
    ...
    [detail_seq]             int             NOT NULL,
    [mod_seq]                int             NOT NULL,
    [customization_code]     nvarchar(30)     NULL,
    [customization_message]  nvarchar(max)    NULL,
    [create_date]            datetime        NULL,
    [create_user_id]         nvarchar(30)     NULL,
    [update_date]            datetime        NULL,
    [update_user_id]         nvarchar(30)     NULL,
...
CREATE TABLE [dbo].[xom_fulfillment_mod](
    ...
    [order_id]           nvarchar(60)     NOT NULL,
    [detail_seq]         int             NOT NULL,
    [loc_id]             nvarchar(60)     NULL,
    [loc_name1]          nvarchar(254)    NULL,
    [loc_name2]          nvarchar(254)    NULL,
    [telephone]          nvarchar(32)     NULL,
    [email_address]      nvarchar(254)    NULL,
    [address_seq]        bigint          NULL,
    [ORGANIZATION_NAME]  nvarchar(60)     NULL,
...
CREATE TABLE [dbo].[xom_order](
	...
	[status_code_reason] nvarchar(30)	 NULL,
	[status_code_reason_note] nvarchar(max) NULL,
    [create_date]      datetime          NULL,
    [create_user_id]   nvarchar(30)       NULL,
    [update_date]      datetime          NULL,
    [update_user_id]   nvarchar(30)       NULL,
...
CREATE TABLE [dbo].[xom_order_line](
    ...
    [order_id]              nvarchar(60)       NOT NULL,
    [detail_seq]            int               NOT NULL,
    [external_order_id]     nvarchar(60)       NULL,
    [item_id]               nvarchar(60)       NULL,
    [quantity]              decimal(11, 4)    NULL,
    [fulfillment_type]      nvarchar(20)       NULL,
    [status_code]           nvarchar(30)       NULL,
    [unit_price]            decimal(17, 6)    NULL,
    [extended_price]        decimal(17, 6)    NULL,
    [tax_amount]            decimal(17, 6)    NULL,
    [notes]                 nvarchar(max)      NULL,
    [SELECTED_SHIP_METHOD]  nvarchar(60)       NULL,
    [tracking_nbr]          nvarchar(60)       NULL,
    [void_flag]             bit               DEFAULT 0 NOT NULL,
    [ACTUAL_SHIP_METHOD]    nvarchar(60)       NULL,
    [drop_ship_flag]        bit               DEFAULT 0 NOT NULL,
    [status_code_reason] nvarchar(30)		  NULL,
    [line_no]			    int				  NULL,
	[status_code_reason_note] nvarchar(max)	  NULL,
	[item_upc_code]		 nvarchar(60)		  NULL,
	[item_ean_code]		 nvarchar(60)		  NULL,
	...
	[line_message]		 nvarchar(max)	  NULL,
    [create_date]           datetime          NULL,
    [create_user_id]        nvarchar(30)       NULL,
    [update_date]           datetime          NULL,
    [update_user_id]        nvarchar(30)       NULL,
