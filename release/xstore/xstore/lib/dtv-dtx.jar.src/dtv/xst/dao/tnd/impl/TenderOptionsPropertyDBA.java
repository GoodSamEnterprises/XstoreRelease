...
/*     */ 
/*     */ 
/*     */ public class TenderOptionsPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.tndr_id, t.config_element, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tnd_tndr_options_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND tndr_id = ?  AND config_element = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.tndr_id, t.config_element, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tnd_tndr_options_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND tndr_id = ?  AND config_element = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO tnd_tndr_options_p(organization_id, tndr_id, config_element, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._tenderId, ObjectUtils.coalesce((Object[])new String[] { this._configElement, "*" }), this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE tnd_tndr_options_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM tnd_tndr_options_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND tndr_id = ?  AND config_element = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND tndr_id = ?  AND config_element = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._tenderId, ObjectUtils.coalesce((Object[])new String[] { this._configElement, "*" }), this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new TenderOptionsPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TenderOptionsPropertyFiller
/*     */     implements IFiller {
/*     */     private TenderOptionsPropertyDBA _parent;
/*     */     
/*     */     public TenderOptionsPropertyFiller(TenderOptionsPropertyDBA argParent) {
...
/* 136 */       this._parent._configElement = argResultSet.getString(3);
...
/* 175 */     TenderOptionsPropertyDAO dao = (TenderOptionsPropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setTenderId(this._tenderId);
/* 178 */     dao.setConfigElement(this._configElement);
...
/* 193 */     return loadDAO((IDataAccessObject)new TenderOptionsPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     TenderOptionsPropertyDAO dao = (TenderOptionsPropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._tenderId = dao.getTenderId();
/* 200 */     this._configElement = dao.getConfigElement();
...
/* 213 */     TenderOptionsPropertyId id = (TenderOptionsPropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getTenderId());
/* 216 */     argStatement.setString(3, id.getConfigElement());
/* 217 */     argStatement.setString(4, id.getPropertyCode());
/* 218 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 222 */     TenderOptionsPropertyId id = new TenderOptionsPropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setTenderId(this._tenderId);
/* 225 */     id.setConfigElement(this._configElement);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderOptionsPropertyDBA.class
