...
/*     */ 
/*     */ 
/*     */ public class ItemOptionsPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1189635808L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemOptionsPropertyDAO.class);
/*     */   
...
/*  60 */     return this._levelCode;
/*     */   }
/*     */   
/*     */   public void setLevelCode(String argLevelCode) {
/*  64 */     if (changed(argLevelCode, this._levelCode, "levelCode")) {
/*  65 */       this._levelCode = (argLevelCode != null && MANAGE_CASE) ? argLevelCode.toUpperCase() : argLevelCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getLevelValue() {
/*  70 */     return this._levelValue;
/*     */   }
/*     */   
/*     */   public void setLevelValue(String argLevelValue) {
/*  74 */     if (changed(argLevelValue, this._levelValue, "levelValue")) {
/*  75 */       this._levelValue = (argLevelValue != null && MANAGE_CASE) ? argLevelValue.toUpperCase() : argLevelValue;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 183 */     if (getLevelCode() != null) {
/* 184 */       buf.append("levelCode").append("=").append(getLevelCode()).append(" ");
/*     */     }
/* 186 */     if (getLevelValue() != null) {
/* 187 */       buf.append("levelValue").append("=").append(getLevelValue()).append(" ");
/*     */     }
...
/* 221 */     ItemOptionsPropertyId id = new ItemOptionsPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setItemId(getItemId());
/* 224 */     id.setLevelCode(getLevelCode());
/* 225 */     id.setLevelValue(getLevelValue());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((ItemOptionsPropertyId)argObjectId).getOrganizationId());
/* 232 */     setItemId(((ItemOptionsPropertyId)argObjectId).getItemId());
/* 233 */     setLevelCode(((ItemOptionsPropertyId)argObjectId).getLevelCode());
/* 234 */     setLevelValue(((ItemOptionsPropertyId)argObjectId).getLevelValue());
/* 235 */     setPropertyCode(((ItemOptionsPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"ItemOptionsProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._levelCode != null) values.put("LevelCode", DaoUtils.getXmlSafeFieldValue(12, this._levelCode)); 
/* 256 */     if (this._levelValue != null) values.put("LevelValue", DaoUtils.getXmlSafeFieldValue(12, this._levelValue)); 
...
/* 299 */             setLevelCode((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setLevelCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "LevelValue":
...
/* 308 */             setLevelValue((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setLevelValue() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemOptionsPropertyDAO.class
