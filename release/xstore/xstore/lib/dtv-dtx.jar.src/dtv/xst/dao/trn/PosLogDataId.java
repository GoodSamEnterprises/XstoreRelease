...
/*     */   public PosLogDataId() {}
/*     */   
/*     */   public PosLogDataId(String argObjectIdValue) {
...
/*  42 */     return this._workstationId;
/*     */   }
/*     */   
/*     */   public void setWorkstationId(Long argWorkstationId) {
/*  46 */     this._workstationId = argWorkstationId;
/*     */   }
/*     */   
...
/*  79 */       str = tokens[2];
/*     */       
/*  81 */       setWorkstationId(Long.valueOf(str));
/*  82 */       str = tokens[3];
/*     */       
...
/* 103 */       return true;
/*     */     }
/* 105 */     if (!(ob instanceof PosLogDataId)) {
/* 106 */       return false;
/*     */     }
/* 108 */     PosLogDataId other = (PosLogDataId)ob;
...
/*     */ 
/*     */       
/* 115 */       .equals(other._retailLocationId))) && ((this._workstationId == null && other._workstationId == null) || (this._workstationId != null && this._workstationId
/*     */ 
/*     */       
/* 118 */       .equals(other._workstationId))) && ((this._businessDate == null && other._businessDate == null) || (this._businessDate != null && this._businessDate
/*     */ 
/*     */       
/* 121 */       .equals(other._businessDate))) && ((this._transactionSequence == null && other._transactionSequence == null) || (this._transactionSequence != null && this._transactionSequence
/*     */ 
/*     */       
...
/* 132 */       .hashCode()) + ((this._workstationId == null) ? 0 : this._workstationId
/* 133 */       .hashCode()) + ((this._businessDate == null) ? 0 : this._businessDate
...
/* 150 */       .append("::").append(String.valueOf(this._workstationId))
/* 151 */       .append("::").append((this._businessDate == null) ? "null" : String.valueOf(this._businessDate.getTimeSerializable()))
...
/* 158 */       return false;
/*     */     }
/* 160 */     if (this._workstationId == null) {
/* 161 */       return false;
/*     */     }
/* 163 */     if (this._businessDate == null) {
/* 164 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\PosLogDataId.class
