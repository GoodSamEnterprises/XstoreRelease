...
/*     */ 
/*     */ 
/*     */ public class RainCheckPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1152175191L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RainCheckPropertyDAO.class);
/*     */   
...
/* 193 */     RainCheckPropertyId id = new RainCheckPropertyId();
...
/* 201 */     setOrganizationId(((RainCheckPropertyId)argObjectId).getOrganizationId());
/* 202 */     setRainCheckId(((RainCheckPropertyId)argObjectId).getRainCheckId());
/* 203 */     setPropertyCode(((RainCheckPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"RainCheckProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._rainCheckId != null) values.put("RainCheckId", DaoUtils.getXmlSafeFieldValue(12, this._rainCheckId)); 
...
/* 256 */             setRainCheckId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setRainCheckId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\RainCheckPropertyDAO.class
