...
/*     */ 
/*     */ 
/*     */ public class DealWeekPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 276168853L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DealWeekPropertyDAO.class);
/*     */   
...
/*  60 */     return this._dayCode;
/*     */   }
/*     */   
/*     */   public void setDayCode(String argDayCode) {
/*  64 */     if (changed(argDayCode, this._dayCode, "dayCode")) {
/*  65 */       this._dayCode = (argDayCode != null && MANAGE_CASE) ? argDayCode.toUpperCase() : argDayCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public Date getStartTime() {
/*  70 */     return (Date)this._startTime;
/*     */   }
/*     */   
/*     */   public void setStartTime(Date argStartTime) {
/*  74 */     if (changed(argStartTime, this._startTime, "startTime")) {
...
/*     */     }
/* 181 */     if (getDealId() != null) {
/* 182 */       buf.append("dealId").append("=").append(getDealId()).append(" ");
/*     */     }
/* 184 */     if (getDayCode() != null) {
/* 185 */       buf.append("dayCode").append("=").append(getDayCode()).append(" ");
/*     */     }
/* 187 */     if (getStartTime() != null) {
/* 188 */       buf.append("startTime").append("=").append(getStartTime()).append(" ");
/*     */     }
...
/* 222 */     DealWeekPropertyId id = new DealWeekPropertyId();
/* 223 */     id.setOrganizationId(getOrganizationId());
/* 224 */     id.setDealId(getDealId());
/* 225 */     id.setDayCode(getDayCode());
/* 226 */     id.setStartTime(getStartTime());
/* 227 */     id.setPropertyCode(getPropertyCode());
/* 228 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 232 */     setOrganizationId(((DealWeekPropertyId)argObjectId).getOrganizationId());
/* 233 */     setDealId(((DealWeekPropertyId)argObjectId).getDealId());
/* 234 */     setDayCode(((DealWeekPropertyId)argObjectId).getDayCode());
/* 235 */     setStartTime(((DealWeekPropertyId)argObjectId).getStartTime());
/* 236 */     setPropertyCode(((DealWeekPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 245 */     buf.append("<").append("dao").append(" name=\"DealWeekProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._dealId != null) values.put("DealId", DaoUtils.getXmlSafeFieldValue(12, this._dealId)); 
/* 256 */     if (this._dayCode != null) values.put("DayCode", DaoUtils.getXmlSafeFieldValue(12, this._dayCode)); 
/* 257 */     if (this._startTime != null) values.put("StartTime", DaoUtils.getXmlSafeFieldValue(91, this._startTime)); 
...
/* 291 */             setDealId((String)value);
/* 292 */           } catch (Exception ee) {
/* 293 */             throw new DtxException("An exception occurred while calling setDealId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "DayCode":
...
/* 300 */             setDayCode((String)value);
/* 301 */           } catch (Exception ee) {
/* 302 */             throw new DtxException("An exception occurred while calling setDayCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "StartTime":
...
/* 309 */             setStartTime((Date)value);
/* 310 */           } catch (Exception ee) {
/* 311 */             throw new DtxException("An exception occurred while calling setStartTime() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealWeekPropertyDAO.class
