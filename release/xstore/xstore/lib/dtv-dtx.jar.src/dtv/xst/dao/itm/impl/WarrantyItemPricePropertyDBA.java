...
/*     */ 
/*     */ 
/*     */ public class WarrantyItemPricePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.item_id, t.warranty_price_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_warranty_item_price_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND warranty_price_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.item_id, t.warranty_price_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_warranty_item_price_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND item_id = ?  AND warranty_price_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_warranty_item_price_p(organization_id, item_id, warranty_price_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._itemId, this._warrantyPriceSeq, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_warranty_item_price_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_warranty_item_price_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND warranty_price_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND item_id = ?  AND warranty_price_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._itemId, this._warrantyPriceSeq, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "itm_warranty_item_price_p";
/*     */   }
/*     */   
...
/* 116 */     return new WarrantyItemPricePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class WarrantyItemPricePropertyFiller
/*     */     implements IFiller {
/*     */     private WarrantyItemPricePropertyDBA _parent;
/*     */     
/*     */     public WarrantyItemPricePropertyFiller(WarrantyItemPricePropertyDBA argParent) {
...
/* 140 */         this._parent._warrantyPriceSeq = Long.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 182 */     WarrantyItemPricePropertyDAO dao = (WarrantyItemPricePropertyDAO)argDAO;
/* 183 */     dao.setOrganizationId(this._organizationId);
/* 184 */     dao.setItemId(this._itemId);
/* 185 */     dao.setWarrantyPriceSeq(this._warrantyPriceSeq);
...
/* 200 */     return loadDAO((IDataAccessObject)new WarrantyItemPricePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     WarrantyItemPricePropertyDAO dao = (WarrantyItemPricePropertyDAO)argDAO;
/* 205 */     this._organizationId = dao.getOrganizationId();
/* 206 */     this._itemId = dao.getItemId();
/* 207 */     this._warrantyPriceSeq = dao.getWarrantyPriceSeq();
...
/* 220 */     WarrantyItemPricePropertyId id = (WarrantyItemPricePropertyId)argId;
/* 221 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 222 */     argStatement.setString(2, id.getItemId());
/* 223 */     argStatement.setLong(3, id.getWarrantyPriceSeq().longValue());
/* 224 */     argStatement.setString(4, id.getPropertyCode());
/* 225 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 229 */     WarrantyItemPricePropertyId id = new WarrantyItemPricePropertyId();
/* 230 */     id.setOrganizationId(this._organizationId);
/* 231 */     id.setItemId(this._itemId);
/* 232 */     id.setWarrantyPriceSeq(this._warrantyPriceSeq);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyItemPricePropertyDBA.class
