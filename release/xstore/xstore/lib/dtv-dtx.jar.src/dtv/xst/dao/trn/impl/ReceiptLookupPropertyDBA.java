...
/*     */ 
/*     */ 
/*     */ public class ReceiptLookupPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.trans_seq, t.receipt_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_receipt_lookup_p t";
...
/*  48 */     return "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.trans_seq, t.receipt_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_receipt_lookup_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  57 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trn_receipt_lookup_p(organization_id, rtl_loc_id, wkstn_id, business_date, trans_seq, receipt_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  74 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trn_receipt_lookup_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  90 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trn_receipt_lookup_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND receipt_id = ?  AND property_code = ?  ";
/*     */   
...
/* 111 */     return "trn_receipt_lookup_p";
/*     */   }
/*     */   
...
/* 119 */     return new ReceiptLookupPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ReceiptLookupPropertyFiller
/*     */     implements IFiller {
/*     */     private ReceiptLookupPropertyDBA _parent;
/*     */     
/*     */     public ReceiptLookupPropertyFiller(ReceiptLookupPropertyDBA argParent) {
...
/* 210 */     ReceiptLookupPropertyDAO dao = (ReceiptLookupPropertyDAO)argDAO;
...
/* 231 */     return loadDAO((IDataAccessObject)new ReceiptLookupPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 235 */     ReceiptLookupPropertyDAO dao = (ReceiptLookupPropertyDAO)argDAO;
...
/* 254 */     ReceiptLookupPropertyId id = (ReceiptLookupPropertyId)argId;
...
/* 266 */     ReceiptLookupPropertyId id = new ReceiptLookupPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\ReceiptLookupPropertyDBA.class
