...
/*     */ 
/*     */ 
/*     */ public class TransactionNotesPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITransactionNotesProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TransactionNotesPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TransactionNotesPropertyDAO getDAO_() {
/*  44 */     return (TransactionNotesPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(ITransactionNotesProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  86 */     if (getDAO_().getNoteSequence() != null) {
/*  87 */       return getDAO_().getNoteSequence().intValue();
/*     */     }
/*     */     
/*  90 */     return 0;
/*     */   }
...
/*  99 */     if (setNoteSequence_noev(argNoteSequence) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ITransactionNotesProperty.SET_NOTESEQUENCE, Integer.valueOf(argNoteSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getNoteSequence() == null && Integer.valueOf(argNoteSequence) != null) || (
/* 112 */       getDAO_().getNoteSequence() != null && !getDAO_().getNoteSequence().equals(Integer.valueOf(argNoteSequence)))) {
/* 113 */       getDAO_().setNoteSequence(Integer.valueOf(argNoteSequence));
...
/* 141 */       this._events.post(ITransactionNotesProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(ITransactionNotesProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(ITransactionNotesProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(ITransactionNotesProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 292 */       this._events.post(ITransactionNotesProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 326 */       this._events.post(ITransactionNotesProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 360 */       this._events.post(ITransactionNotesProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 394 */       this._events.post(ITransactionNotesProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 428 */       this._events.post(ITransactionNotesProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 462 */       this._events.post(ITransactionNotesProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 496 */       this._events.post(ITransactionNotesProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 530 */       this._events.post(ITransactionNotesProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 564 */       this._events.post(ITransactionNotesProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 585 */     if ("TransactionNotesPropertyExtension".equals(argFieldId)) {
...
/* 595 */     if ("TransactionNotesPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\TransactionNotesPropertyModel.class
