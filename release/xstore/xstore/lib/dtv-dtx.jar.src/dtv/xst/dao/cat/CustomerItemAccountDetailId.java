...
/*     */ 
/*     */ 
/*     */ public class CustomerItemAccountDetailId
...
/*     */   
/*     */   public CustomerItemAccountDetailId() {}
/*     */   
/*     */   public CustomerItemAccountDetailId(String argObjectIdValue) {
...
/*  47 */     return this._custAccountDetailNum;
/*     */   }
/*     */   
/*     */   public void setCustAccountDetailNum(Long argCustAccountDetailNum) {
/*  51 */     this._custAccountDetailNum = argCustAccountDetailNum;
/*     */   }
/*     */   
...
/*  80 */       str = tokens[3];
/*     */       
/*  82 */       setCustAccountDetailNum(Long.valueOf(str));
/*     */     }
...
/*  92 */       return true;
/*     */     }
/*  94 */     if (!(ob instanceof CustomerItemAccountDetailId)) {
/*  95 */       return false;
/*     */     }
/*  97 */     CustomerItemAccountDetailId other = (CustomerItemAccountDetailId)ob;
...
/*     */ 
/*     */       
/* 107 */       .equals(other._custAccountCode))) && ((this._custAccountDetailNum == null && other._custAccountDetailNum == null) || (this._custAccountDetailNum != null && this._custAccountDetailNum
/*     */ 
/*     */       
/* 110 */       .equals(other._custAccountDetailNum))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 119 */       .hashCode()) + ((this._custAccountDetailNum == null) ? 0 : this._custAccountDetailNum
/* 120 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getDtxTypeName() {
/* 125 */     return "CustomerItemAccountDetail";
/*     */   }
/*     */ 
/*     */   
...
/* 136 */       .append("::").append(String.valueOf(this._custAccountDetailNum))
/* 137 */       .toString();
/*     */   }
/*     */   
...
/* 145 */       return false;
/*     */     }
/* 147 */     if (this._custAccountDetailNum == null) {
/* 148 */       return false;
/*     */     }
/* 150 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\CustomerItemAccountDetailId.class
