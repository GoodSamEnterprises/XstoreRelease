...
/*     */ 
/*     */ 
/*     */ public class InventoryDocumentModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 820012643L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryDocumentModifierPropertyDAO.class);
/*     */   
...
/*  46 */     if (changed(argBusinessDate, this._businessDate, "businessDate")) {
...
/*  53 */     return this._documentModifierSequence;
/*     */   }
/*     */   
/*     */   public void setDocumentModifierSequence(Integer argDocumentModifierSequence) {
/*  57 */     if (changed(argDocumentModifierSequence, this._documentModifierSequence, "documentModifierSequence")) {
/*  58 */       this._documentModifierSequence = argDocumentModifierSequence;
/*     */     }
/*     */   }
/*     */   
...
/*  73 */     return this._retailLocationId;
/*     */   }
/*     */   
/*     */   public void setRetailLocationId(Long argRetailLocationId) {
/*  77 */     if (changed(argRetailLocationId, this._retailLocationId, "retailLocationId")) {
/*  78 */       this._retailLocationId = argRetailLocationId;
/*     */     }
/*     */   }
/*     */   
...
/* 200 */     if (getBusinessDate() != null) {
/* 201 */       buf.append("businessDate").append("=").append(getBusinessDate()).append(" ");
/*     */     }
/* 203 */     if (getDocumentModifierSequence() != null) {
/* 204 */       buf.append("documentModifierSequence").append("=").append(getDocumentModifierSequence()).append(" ");
/*     */     }
/* 206 */     if (getOrganizationId() != null) {
/* 207 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 209 */     if (getRetailLocationId() != null) {
/* 210 */       buf.append("retailLocationId").append("=").append(getRetailLocationId()).append(" ");
/*     */     }
...
/* 250 */     InventoryDocumentModifierPropertyId id = new InventoryDocumentModifierPropertyId();
/* 251 */     id.setBusinessDate(getBusinessDate());
/* 252 */     id.setDocumentModifierSequence(getDocumentModifierSequence());
...
/* 262 */     setBusinessDate(((InventoryDocumentModifierPropertyId)argObjectId).getBusinessDate());
/* 263 */     setDocumentModifierSequence(((InventoryDocumentModifierPropertyId)argObjectId).getDocumentModifierSequence());
/* 264 */     setOrganizationId(((InventoryDocumentModifierPropertyId)argObjectId).getOrganizationId());
/* 265 */     setRetailLocationId(((InventoryDocumentModifierPropertyId)argObjectId).getRetailLocationId());
/* 266 */     setTransactionSequence(((InventoryDocumentModifierPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setWorkstationId(((InventoryDocumentModifierPropertyId)argObjectId).getWorkstationId());
/* 268 */     setPropertyCode(((InventoryDocumentModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"InventoryDocumentModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 287 */     if (this._documentModifierSequence != null) values.put("DocumentModifierSequence", DaoUtils.getXmlSafeFieldValue(4, this._documentModifierSequence)); 
...
/* 316 */             setBusinessDate((Date)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setBusinessDate() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 325 */             setDocumentModifierSequence((Integer)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setDocumentModifierSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 343 */             setRetailLocationId((Long)value);
/* 344 */           } catch (Exception ee) {
/* 345 */             throw new DtxException("An exception occurred while calling setRetailLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\InventoryDocumentModifierPropertyDAO.class
