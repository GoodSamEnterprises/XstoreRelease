...
/*     */ 
/*     */ 
/*     */ public class AddressPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2109644343L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AddressPropertyDAO.class);
/*     */   
...
/*  48 */     return this._addressId;
/*     */   }
/*     */   
/*     */   public void setAddressId(String argAddressId) {
/*  52 */     if (changed(argAddressId, this._addressId, "addressId")) {
/*  53 */       this._addressId = (argAddressId != null && MANAGE_CASE) ? argAddressId.toUpperCase() : argAddressId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getAddressId() != null) {
/* 159 */       buf.append("addressId").append("=").append(getAddressId()).append(" ");
/*     */     }
...
/* 193 */     AddressPropertyId id = new AddressPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setAddressId(getAddressId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((AddressPropertyId)argObjectId).getOrganizationId());
/* 202 */     setAddressId(((AddressPropertyId)argObjectId).getAddressId());
/* 203 */     setPropertyCode(((AddressPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"AddressProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._addressId != null) values.put("AddressId", DaoUtils.getXmlSafeFieldValue(12, this._addressId)); 
...
/* 256 */             setAddressId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setAddressId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AddressPropertyDAO.class
