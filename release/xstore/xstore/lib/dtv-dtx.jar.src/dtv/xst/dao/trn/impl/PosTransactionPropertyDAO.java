...
/*     */ 
/*     */ 
/*     */ public class PosTransactionPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 926101503L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PosTransactionPropertyDAO.class);
/*     */   
...
/* 236 */     PosTransactionPropertyId id = new PosTransactionPropertyId();
...
/* 247 */     setOrganizationId(((PosTransactionPropertyId)argObjectId).getOrganizationId());
/* 248 */     setRetailLocationId(((PosTransactionPropertyId)argObjectId).getRetailLocationId());
/* 249 */     setBusinessDate(((PosTransactionPropertyId)argObjectId).getBusinessDate());
/* 250 */     setWorkstationId(((PosTransactionPropertyId)argObjectId).getWorkstationId());
/* 251 */     setTransactionSequence(((PosTransactionPropertyId)argObjectId).getTransactionSequence());
/* 252 */     setPropertyCode(((PosTransactionPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 261 */     buf.append("<").append("dao").append(" name=\"PosTransactionProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\PosTransactionPropertyDAO.class
