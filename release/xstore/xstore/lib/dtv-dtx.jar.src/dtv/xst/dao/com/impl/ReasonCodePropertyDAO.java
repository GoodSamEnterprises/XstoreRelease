...
/*     */ 
/*     */ 
/*     */ public class ReasonCodePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1376522086L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ReasonCodePropertyDAO.class);
/*     */   
...
/*  49 */     return this._reasonTypeCode;
/*     */   }
/*     */   
/*     */   public void setReasonTypeCode(String argReasonTypeCode) {
/*  53 */     if (changed(argReasonTypeCode, this._reasonTypeCode, "reasonTypeCode")) {
/*  54 */       this._reasonTypeCode = (argReasonTypeCode != null && MANAGE_CASE) ? argReasonTypeCode.toUpperCase() : argReasonTypeCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getReasonCode() {
/*  59 */     return this._reasonCode;
/*     */   }
/*     */   
/*     */   public void setReasonCode(String argReasonCode) {
/*  63 */     if (changed(argReasonCode, this._reasonCode, "reasonCode")) {
/*  64 */       this._reasonCode = (argReasonCode != null && MANAGE_CASE) ? argReasonCode.toUpperCase() : argReasonCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getReasonTypeCode() != null) {
/* 170 */       buf.append("reasonTypeCode").append("=").append(getReasonTypeCode()).append(" ");
/*     */     }
/* 172 */     if (getReasonCode() != null) {
/* 173 */       buf.append("reasonCode").append("=").append(getReasonCode()).append(" ");
/*     */     }
...
/* 207 */     ReasonCodePropertyId id = new ReasonCodePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setReasonTypeCode(getReasonTypeCode());
/* 210 */     id.setReasonCode(getReasonCode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((ReasonCodePropertyId)argObjectId).getOrganizationId());
/* 217 */     setReasonTypeCode(((ReasonCodePropertyId)argObjectId).getReasonTypeCode());
/* 218 */     setReasonCode(((ReasonCodePropertyId)argObjectId).getReasonCode());
/* 219 */     setPropertyCode(((ReasonCodePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"ReasonCodeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._reasonTypeCode != null) values.put("ReasonTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._reasonTypeCode)); 
/* 239 */     if (this._reasonCode != null) values.put("ReasonCode", DaoUtils.getXmlSafeFieldValue(12, this._reasonCode)); 
...
/* 273 */             setReasonTypeCode((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setReasonTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ReasonCode":
...
/* 282 */             setReasonCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setReasonCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ReasonCodePropertyDAO.class
