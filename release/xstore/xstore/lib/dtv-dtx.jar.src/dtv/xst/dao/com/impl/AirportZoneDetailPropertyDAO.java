...
/*     */ 
/*     */ 
/*     */ public class AirportZoneDetailPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1683060707L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AirportZoneDetailPropertyDAO.class);
/*     */   
...
/*  49 */     return this._zoneId;
/*     */   }
/*     */   
/*     */   public void setZoneId(String argZoneId) {
/*  53 */     if (changed(argZoneId, this._zoneId, "zoneId")) {
/*  54 */       this._zoneId = (argZoneId != null && MANAGE_CASE) ? argZoneId.toUpperCase() : argZoneId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getDestinationZoneId() {
/*  59 */     return this._destinationZoneId;
/*     */   }
/*     */   
/*     */   public void setDestinationZoneId(String argDestinationZoneId) {
/*  63 */     if (changed(argDestinationZoneId, this._destinationZoneId, "destinationZoneId")) {
/*  64 */       this._destinationZoneId = (argDestinationZoneId != null && MANAGE_CASE) ? argDestinationZoneId.toUpperCase() : argDestinationZoneId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getZoneId() != null) {
/* 170 */       buf.append("zoneId").append("=").append(getZoneId()).append(" ");
/*     */     }
/* 172 */     if (getDestinationZoneId() != null) {
/* 173 */       buf.append("destinationZoneId").append("=").append(getDestinationZoneId()).append(" ");
/*     */     }
...
/* 207 */     AirportZoneDetailPropertyId id = new AirportZoneDetailPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setZoneId(getZoneId());
/* 210 */     id.setDestinationZoneId(getDestinationZoneId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((AirportZoneDetailPropertyId)argObjectId).getOrganizationId());
/* 217 */     setZoneId(((AirportZoneDetailPropertyId)argObjectId).getZoneId());
/* 218 */     setDestinationZoneId(((AirportZoneDetailPropertyId)argObjectId).getDestinationZoneId());
/* 219 */     setPropertyCode(((AirportZoneDetailPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"AirportZoneDetailProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._zoneId != null) values.put("ZoneId", DaoUtils.getXmlSafeFieldValue(12, this._zoneId)); 
/* 239 */     if (this._destinationZoneId != null) values.put("DestinationZoneId", DaoUtils.getXmlSafeFieldValue(12, this._destinationZoneId)); 
...
/* 273 */             setZoneId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setZoneId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 282 */             setDestinationZoneId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setDestinationZoneId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AirportZoneDetailPropertyDAO.class
