...
/*     */ 
/*     */ 
/*     */ public class ReportLookupPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IReportLookupProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ReportLookupPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ReportLookupPropertyDAO getDAO_() {
/*  44 */     return (ReportLookupPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IReportLookupProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  99 */     if (setOwnerId_noev(argOwnerId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IReportLookupProperty.SET_OWNERID, argOwnerId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getOwnerId() == null && argOwnerId != null) || (
/* 112 */       getDAO_().getOwnerId() != null && !getDAO_().getOwnerId().equals(argOwnerId))) {
/* 113 */       getDAO_().setOwnerId(argOwnerId);
...
/* 125 */     return getDAO_().getOwnerType();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setOwnerType_noev(argOwnerType) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IReportLookupProperty.SET_OWNERTYPE, argOwnerType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getOwnerType() == null && argOwnerType != null) || (
/* 146 */       getDAO_().getOwnerType() != null && !getDAO_().getOwnerType().equals(argOwnerType))) {
/* 147 */       getDAO_().setOwnerType(argOwnerType);
...
/* 159 */     return getDAO_().getReportId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setReportId_noev(argReportId) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IReportLookupProperty.SET_REPORTID, argReportId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getReportId() == null && argReportId != null) || (
/* 180 */       getDAO_().getReportId() != null && !getDAO_().getReportId().equals(argReportId))) {
/* 181 */       getDAO_().setReportId(argReportId);
...
/* 204 */       this._events.post(IReportLookupProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IReportLookupProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IReportLookupProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IReportLookupProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IReportLookupProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IReportLookupProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IReportLookupProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IReportLookupProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IReportLookupProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("ReportLookupPropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("ReportLookupPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ReportLookupPropertyModel.class
