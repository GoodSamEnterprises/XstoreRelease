...
/*     */ 
/*     */ 
/*     */ public class DealCustomerGroupsPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1159585037L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DealCustomerGroupsPropertyDAO.class);
/*     */   
...
/*  39 */     return this._dealId;
/*     */   }
/*     */   
/*     */   public void setDealId(String argDealId) {
/*  43 */     if (changed(argDealId, this._dealId, "dealId")) {
/*  44 */       this._dealId = (argDealId != null && MANAGE_CASE) ? argDealId.toUpperCase() : argDealId;
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     return this._customerGroupId;
/*     */   }
/*     */   
/*     */   public void setCustomerGroupId(String argCustomerGroupId) {
/*  63 */     if (changed(argCustomerGroupId, this._customerGroupId, "customerGroupId")) {
/*  64 */       this._customerGroupId = (argCustomerGroupId != null && MANAGE_CASE) ? argCustomerGroupId.toUpperCase() : argCustomerGroupId;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getDealId() != null) {
/* 167 */       buf.append("dealId").append("=").append(getDealId()).append(" ");
/*     */     }
/* 169 */     if (getOrganizationId() != null) {
/* 170 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 172 */     if (getCustomerGroupId() != null) {
/* 173 */       buf.append("customerGroupId").append("=").append(getCustomerGroupId()).append(" ");
/*     */     }
...
/* 207 */     DealCustomerGroupsPropertyId id = new DealCustomerGroupsPropertyId();
/* 208 */     id.setDealId(getDealId());
/* 209 */     id.setOrganizationId(getOrganizationId());
/* 210 */     id.setCustomerGroupId(getCustomerGroupId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setDealId(((DealCustomerGroupsPropertyId)argObjectId).getDealId());
/* 217 */     setOrganizationId(((DealCustomerGroupsPropertyId)argObjectId).getOrganizationId());
/* 218 */     setCustomerGroupId(((DealCustomerGroupsPropertyId)argObjectId).getCustomerGroupId());
/* 219 */     setPropertyCode(((DealCustomerGroupsPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DealCustomerGroupsProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._dealId != null) values.put("DealId", DaoUtils.getXmlSafeFieldValue(12, this._dealId)); 
/* 238 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 239 */     if (this._customerGroupId != null) values.put("CustomerGroupId", DaoUtils.getXmlSafeFieldValue(12, this._customerGroupId)); 
...
/* 264 */             setDealId((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setDealId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 282 */             setCustomerGroupId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setCustomerGroupId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealCustomerGroupsPropertyDAO.class
