...
/*     */ 
/*     */ 
/*     */ public class OrderPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1627114275L;
/*  23 */   private static final Logger _logger = Logger.getLogger(OrderPropertyDAO.class);
/*     */   
...
/* 193 */     OrderPropertyId id = new OrderPropertyId();
...
/* 201 */     setOrganizationId(((OrderPropertyId)argObjectId).getOrganizationId());
/* 202 */     setOrderId(((OrderPropertyId)argObjectId).getOrderId());
/* 203 */     setPropertyCode(((OrderPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"OrderProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderPropertyDAO.class
