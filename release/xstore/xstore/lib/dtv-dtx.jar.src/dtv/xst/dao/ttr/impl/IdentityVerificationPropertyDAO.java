...
/*     */ 
/*     */ 
/*     */ public class IdentityVerificationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 497728270L;
/*  23 */   private static final Logger _logger = Logger.getLogger(IdentityVerificationPropertyDAO.class);
/*     */   
...
/*  54 */     return this._identityVerificationSequence;
/*     */   }
/*     */   
/*     */   public void setIdentityVerificationSequence(Integer argIdentityVerificationSequence) {
/*  58 */     if (changed(argIdentityVerificationSequence, this._identityVerificationSequence, "identityVerificationSequence")) {
/*  59 */       this._identityVerificationSequence = argIdentityVerificationSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 214 */     if (getIdentityVerificationSequence() != null) {
/* 215 */       buf.append("identityVerificationSequence").append("=").append(getIdentityVerificationSequence()).append(" ");
/*     */     }
...
/* 264 */     IdentityVerificationPropertyId id = new IdentityVerificationPropertyId();
/* 265 */     id.setBusinessDate(getBusinessDate());
/* 266 */     id.setIdentityVerificationSequence(getIdentityVerificationSequence());
...
/* 277 */     setBusinessDate(((IdentityVerificationPropertyId)argObjectId).getBusinessDate());
/* 278 */     setIdentityVerificationSequence(((IdentityVerificationPropertyId)argObjectId).getIdentityVerificationSequence());
/* 279 */     setOrganizationId(((IdentityVerificationPropertyId)argObjectId).getOrganizationId());
/* 280 */     setRetailLocationId(((IdentityVerificationPropertyId)argObjectId).getRetailLocationId());
/* 281 */     setRetailTransactionLineItemSequence(((IdentityVerificationPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 282 */     setTransactionSequence(((IdentityVerificationPropertyId)argObjectId).getTransactionSequence());
/* 283 */     setWorkstationId(((IdentityVerificationPropertyId)argObjectId).getWorkstationId());
/* 284 */     setPropertyCode(((IdentityVerificationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"IdentityVerificationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 303 */     if (this._identityVerificationSequence != null) values.put("IdentityVerificationSequence", DaoUtils.getXmlSafeFieldValue(4, this._identityVerificationSequence)); 
...
/* 342 */             setIdentityVerificationSequence((Integer)value);
/* 343 */           } catch (Exception ee) {
/* 344 */             throw new DtxException("An exception occurred while calling setIdentityVerificationSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\IdentityVerificationPropertyDAO.class
