...
/*     */ 
/*     */ 
/*     */ public class TenderSignatureDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1418685476L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderSignatureDAO.class);
/*     */   
...
/*  58 */     return (Date)this._businessDate;
/*     */   }
/*     */   
/*     */   public void setBusinessDate(Date argBusinessDate) {
/*  62 */     if (changed(argBusinessDate, this._businessDate, "businessDate")) {
...
/*  73 */     if (changed(argWorkstationId, this._workstationId, "workstationId")) {
...
/*  89 */     return this._retailTransactionLineItemSequence;
/*     */   }
/*     */   
/*     */   public void setRetailTransactionLineItemSequence(Integer argRetailTransactionLineItemSequence) {
/*  93 */     if (changed(argRetailTransactionLineItemSequence, this._retailTransactionLineItemSequence, "retailTransactionLineItemSequence")) {
/*  94 */       this._retailTransactionLineItemSequence = argRetailTransactionLineItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/* 141 */     return this._signature;
/*     */   }
/*     */   
/*     */   public void setSignature(String argSignature) {
/* 145 */     if (changed(argSignature, this._signature, "signature")) {
/* 146 */       this._signature = argSignature;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 161 */     if (getBusinessDate() != null) {
/* 162 */       buf.append("businessDate").append("=").append(getBusinessDate()).append(" ");
/*     */     }
/* 164 */     if (getWorkstationId() != null) {
/* 165 */       buf.append("workstationId").append("=").append(getWorkstationId()).append(" ");
/*     */     }
/* 167 */     if (getTransactionSequence() != null) {
/* 168 */       buf.append("transactionSequence").append("=").append(getTransactionSequence()).append(" ");
/*     */     }
/* 170 */     if (getRetailTransactionLineItemSequence() != null) {
/* 171 */       buf.append("retailTransactionLineItemSequence").append("=").append(getRetailTransactionLineItemSequence()).append(" ");
/*     */     }
...
/*     */     }
/* 185 */     if (getSignature() != null) {
/* 186 */       buf.append("signature").append("=").append(getSignature()).append(" ");
/*     */     }
/*     */     
...
/* 193 */     TenderSignatureId id = new TenderSignatureId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setRetailLocationId(getRetailLocationId());
/* 196 */     id.setBusinessDate(getBusinessDate());
/* 197 */     id.setWorkstationId(getWorkstationId());
/* 198 */     id.setTransactionSequence(getTransactionSequence());
/* 199 */     id.setRetailTransactionLineItemSequence(getRetailTransactionLineItemSequence());
/* 200 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 204 */     setOrganizationId(((TenderSignatureId)argObjectId).getOrganizationId());
/* 205 */     setRetailLocationId(((TenderSignatureId)argObjectId).getRetailLocationId());
/* 206 */     setBusinessDate(((TenderSignatureId)argObjectId).getBusinessDate());
/* 207 */     setWorkstationId(((TenderSignatureId)argObjectId).getWorkstationId());
/* 208 */     setTransactionSequence(((TenderSignatureId)argObjectId).getTransactionSequence());
/* 209 */     setRetailTransactionLineItemSequence(((TenderSignatureId)argObjectId).getRetailTransactionLineItemSequence());
/*     */   }
/*     */   
...
/* 218 */     buf.append("<").append("dao").append(" name=\"TenderSignature\" cmd=\"" + getObjectStateString() + "\">");
...
/* 229 */     if (this._businessDate != null) values.put("BusinessDate", DaoUtils.getXmlSafeFieldValue(91, this._businessDate)); 
/* 230 */     if (this._workstationId != null) values.put("WorkstationId", DaoUtils.getXmlSafeFieldValue(-5, this._workstationId)); 
...
/* 232 */     if (this._retailTransactionLineItemSequence != null) values.put("RetailTransactionLineItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._retailTransactionLineItemSequence)); 
...
/* 237 */     if (this._signature != null) values.put("Signature", DaoUtils.getXmlSafeFieldValue(2005, this._signature)); 
/* 238 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/*     */         case "BusinessDate":
/*     */           try {
/* 270 */             Object value = DaoUtils.getFieldValueForXmlString(91, fieldValue);
/* 271 */             setBusinessDate((Date)value);
/* 272 */           } catch (Exception ee) {
/* 273 */             throw new DtxException("An exception occurred while calling setBusinessDate() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "WorkstationId":
...
/* 280 */             setWorkstationId((Long)value);
/* 281 */           } catch (Exception ee) {
/* 282 */             throw new DtxException("An exception occurred while calling setWorkstationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/*     */           try {
/* 297 */             Object value = DaoUtils.getFieldValueForXmlString(4, fieldValue);
/* 298 */             setRetailTransactionLineItemSequence((Integer)value);
/* 299 */           } catch (Exception ee) {
/* 300 */             throw new DtxException("An exception occurred while calling setRetailTransactionLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CreateDate":
...
/* 343 */             setSignature((String)value);
/* 344 */           } catch (Exception ee) {
/* 345 */             throw new DtxException("An exception occurred while calling setSignature() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\TenderSignatureDAO.class
