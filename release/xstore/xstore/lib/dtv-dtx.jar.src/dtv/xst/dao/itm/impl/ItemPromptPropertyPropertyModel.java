...
/*     */ 
/*     */ 
/*     */ public class ItemPromptPropertyPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IItemPromptPropertyProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ItemPromptPropertyPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ItemPromptPropertyPropertyDAO getDAO_() {
/*  44 */     return (ItemPromptPropertyPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IItemPromptPropertyProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IItemPromptPropertyProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getPromptPropertyCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setPromptPropertyCode_noev(argPromptPropertyCode) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IItemPromptPropertyProperty.SET_PROMPTPROPERTYCODE, argPromptPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getPromptPropertyCode() == null && argPromptPropertyCode != null) || (
/* 146 */       getDAO_().getPromptPropertyCode() != null && !getDAO_().getPromptPropertyCode().equals(argPromptPropertyCode))) {
/* 147 */       getDAO_().setPromptPropertyCode(argPromptPropertyCode);
...
/* 170 */       this._events.post(IItemPromptPropertyProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IItemPromptPropertyProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IItemPromptPropertyProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IItemPromptPropertyProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IItemPromptPropertyProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IItemPromptPropertyProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IItemPromptPropertyProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IItemPromptPropertyProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IItemPromptPropertyProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("ItemPromptPropertyPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("ItemPromptPropertyPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemPromptPropertyPropertyModel.class
