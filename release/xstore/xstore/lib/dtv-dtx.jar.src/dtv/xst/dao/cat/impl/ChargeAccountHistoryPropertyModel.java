...
/*     */ 
/*     */ 
/*     */ public class ChargeAccountHistoryPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IChargeAccountHistoryProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ChargeAccountHistoryPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ChargeAccountHistoryPropertyDAO getDAO_() {
/*  44 */     return (ChargeAccountHistoryPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IChargeAccountHistoryProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IChargeAccountHistoryProperty.SET_CUSTACCOUNTID, argCustAccountId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 136 */       this._events.post(IChargeAccountHistoryProperty.SET_CUSTACCOUNTCODE, argCustAccountCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 159 */     if (getDAO_().getHistorySeq() != null) {
/* 160 */       return getDAO_().getHistorySeq().longValue();
/*     */     }
/*     */     
/* 163 */     return 0L;
/*     */   }
...
/* 172 */     if (setHistorySeq_noev(argHistorySeq) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IChargeAccountHistoryProperty.SET_HISTORYSEQ, Long.valueOf(argHistorySeq));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getHistorySeq() == null && Long.valueOf(argHistorySeq) != null) || (
/* 185 */       getDAO_().getHistorySeq() != null && !getDAO_().getHistorySeq().equals(Long.valueOf(argHistorySeq)))) {
/* 186 */       getDAO_().setHistorySeq(Long.valueOf(argHistorySeq));
...
/* 209 */       this._events.post(IChargeAccountHistoryProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IChargeAccountHistoryProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IChargeAccountHistoryProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IChargeAccountHistoryProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IChargeAccountHistoryProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IChargeAccountHistoryProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IChargeAccountHistoryProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IChargeAccountHistoryProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(IChargeAccountHistoryProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 502 */     if ("ChargeAccountHistoryPropertyExtension".equals(argFieldId)) {
...
/* 512 */     if ("ChargeAccountHistoryPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\ChargeAccountHistoryPropertyModel.class
