...
/*     */ 
/*     */ 
/*     */ public class InventoryCostItemYearEndPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IInventoryCostItemYearEndProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new InventoryCostItemYearEndPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private InventoryCostItemYearEndPropertyDAO getDAO_() {
/*  44 */     return (InventoryCostItemYearEndPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IInventoryCostItemYearEndProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     if (getDAO_().getFiscalYear() != null) {
/*  92 */       return getDAO_().getFiscalYear().intValue();
/*     */     }
/*     */     
/*  95 */     return 0;
/*     */   }
...
/* 104 */     if (setFiscalYear_noev(argFiscalYear) && 
/* 105 */       this._events != null && 
/* 106 */       postEventsForChanges()) {
/* 107 */       this._events.post(IInventoryCostItemYearEndProperty.SET_FISCALYEAR, Integer.valueOf(argFiscalYear));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 116 */     if ((getDAO_().getFiscalYear() == null && Integer.valueOf(argFiscalYear) != null) || (
/* 117 */       getDAO_().getFiscalYear() != null && !getDAO_().getFiscalYear().equals(Integer.valueOf(argFiscalYear)))) {
/* 118 */       getDAO_().setFiscalYear(Integer.valueOf(argFiscalYear));
...
/* 146 */       this._events.post(IInventoryCostItemYearEndProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 177 */     if (setItemId_noev(argItemId) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(IInventoryCostItemYearEndProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getItemId() == null && argItemId != null) || (
/* 190 */       getDAO_().getItemId() != null && !getDAO_().getItemId().equals(argItemId))) {
/* 191 */       getDAO_().setItemId(argItemId);
...
/* 214 */       this._events.post(IInventoryCostItemYearEndProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 248 */       this._events.post(IInventoryCostItemYearEndProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(IInventoryCostItemYearEndProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(IInventoryCostItemYearEndProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(IInventoryCostItemYearEndProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(IInventoryCostItemYearEndProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(IInventoryCostItemYearEndProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(IInventoryCostItemYearEndProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(IInventoryCostItemYearEndProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 507 */     if ("InventoryCostItemYearEndPropertyExtension".equals(argFieldId)) {
...
/* 517 */     if ("InventoryCostItemYearEndPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCostItemYearEndPropertyModel.class
