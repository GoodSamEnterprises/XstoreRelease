...
/*     */ 
/*     */ 
/*     */ public class PaymentSchedulePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 113168274L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PaymentSchedulePropertyDAO.class);
/*     */   
...
/* 207 */     PaymentSchedulePropertyId id = new PaymentSchedulePropertyId();
...
/* 216 */     setOrganizationId(((PaymentSchedulePropertyId)argObjectId).getOrganizationId());
/* 217 */     setCustAccountId(((PaymentSchedulePropertyId)argObjectId).getCustAccountId());
/* 218 */     setCustAccountCode(((PaymentSchedulePropertyId)argObjectId).getCustAccountCode());
/* 219 */     setPropertyCode(((PaymentSchedulePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"PaymentScheduleProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\PaymentSchedulePropertyDAO.class
