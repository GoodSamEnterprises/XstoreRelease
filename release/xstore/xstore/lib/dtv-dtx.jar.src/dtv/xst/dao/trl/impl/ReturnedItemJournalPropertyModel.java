...
/*     */ 
/*     */ 
/*     */ public class ReturnedItemJournalPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IReturnedItemJournalProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ReturnedItemJournalPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ReturnedItemJournalPropertyDAO getDAO_() {
/*  44 */     return (ReturnedItemJournalPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IReturnedItemJournalProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IReturnedItemJournalProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 146 */       this._events.post(IReturnedItemJournalProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(IReturnedItemJournalProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(IReturnedItemJournalProperty.SET_RETAILTRANSACTIONLINEITEMSEQUENCE, Integer.valueOf(argRetailTransactionLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(IReturnedItemJournalProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 281 */     if (getDAO_().getJournalSequence() != null) {
/* 282 */       return getDAO_().getJournalSequence().longValue();
/*     */     }
/*     */     
/* 285 */     return 0L;
/*     */   }
...
/* 294 */     if (setJournalSequence_noev(argJournalSequence) && 
/* 295 */       this._events != null && 
/* 296 */       postEventsForChanges()) {
/* 297 */       this._events.post(IReturnedItemJournalProperty.SET_JOURNALSEQUENCE, Long.valueOf(argJournalSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 306 */     if ((getDAO_().getJournalSequence() == null && Long.valueOf(argJournalSequence) != null) || (
/* 307 */       getDAO_().getJournalSequence() != null && !getDAO_().getJournalSequence().equals(Long.valueOf(argJournalSequence)))) {
/* 308 */       getDAO_().setJournalSequence(Long.valueOf(argJournalSequence));
...
/* 331 */       this._events.post(IReturnedItemJournalProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(IReturnedItemJournalProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(IReturnedItemJournalProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(IReturnedItemJournalProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(IReturnedItemJournalProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(IReturnedItemJournalProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(IReturnedItemJournalProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(IReturnedItemJournalProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(IReturnedItemJournalProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("ReturnedItemJournalPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("ReturnedItemJournalPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\ReturnedItemJournalPropertyModel.class
