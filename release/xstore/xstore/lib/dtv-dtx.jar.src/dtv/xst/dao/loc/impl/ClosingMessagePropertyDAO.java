...
/*     */ 
/*     */ 
/*     */ public class ClosingMessagePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 465940903L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ClosingMessagePropertyDAO.class);
/*     */   
...
/* 193 */     ClosingMessagePropertyId id = new ClosingMessagePropertyId();
...
/* 201 */     setOrganizationId(((ClosingMessagePropertyId)argObjectId).getOrganizationId());
/* 202 */     setRetailLocationId(((ClosingMessagePropertyId)argObjectId).getRetailLocationId());
/* 203 */     setPropertyCode(((ClosingMessagePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ClosingMessageProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\ClosingMessagePropertyDAO.class
