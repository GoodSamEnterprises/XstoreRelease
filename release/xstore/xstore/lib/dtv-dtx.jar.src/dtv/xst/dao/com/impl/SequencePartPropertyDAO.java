...
/*     */ 
/*     */ 
/*     */ public class SequencePartPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 2139973993L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SequencePartPropertyDAO.class);
/*     */   
...
/*  52 */     if (changed(argSequenceId, this._sequenceId, "sequenceId")) {
...
/*     */     }
/* 158 */     if (getSequenceId() != null) {
/* 159 */       buf.append("sequenceId").append("=").append(getSequenceId()).append(" ");
/*     */     }
...
/* 193 */     SequencePartPropertyId id = new SequencePartPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setSequenceId(getSequenceId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((SequencePartPropertyId)argObjectId).getOrganizationId());
/* 202 */     setSequenceId(((SequencePartPropertyId)argObjectId).getSequenceId());
/* 203 */     setPropertyCode(((SequencePartPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"SequencePartProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._sequenceId != null) values.put("SequenceId", DaoUtils.getXmlSafeFieldValue(12, this._sequenceId)); 
...
/* 256 */             setSequenceId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setSequenceId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\SequencePartPropertyDAO.class
