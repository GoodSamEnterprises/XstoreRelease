...
/*     */ 
/*     */ 
/*     */ public class CustomerItemAccountDetailPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -982785758L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerItemAccountDetailPropertyDAO.class);
/*     */   
...
/*  70 */     return this._custAccountDetailNum;
/*     */   }
/*     */   
/*     */   public void setCustAccountDetailNum(Long argCustAccountDetailNum) {
/*  74 */     if (changed(argCustAccountDetailNum, this._custAccountDetailNum, "custAccountDetailNum")) {
/*  75 */       this._custAccountDetailNum = argCustAccountDetailNum;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 186 */     if (getCustAccountDetailNum() != null) {
/* 187 */       buf.append("custAccountDetailNum").append("=").append(getCustAccountDetailNum()).append(" ");
/*     */     }
...
/* 221 */     CustomerItemAccountDetailPropertyId id = new CustomerItemAccountDetailPropertyId();
...
/* 225 */     id.setCustAccountDetailNum(getCustAccountDetailNum());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((CustomerItemAccountDetailPropertyId)argObjectId).getOrganizationId());
/* 232 */     setCustAccountId(((CustomerItemAccountDetailPropertyId)argObjectId).getCustAccountId());
/* 233 */     setCustAccountCode(((CustomerItemAccountDetailPropertyId)argObjectId).getCustAccountCode());
/* 234 */     setCustAccountDetailNum(((CustomerItemAccountDetailPropertyId)argObjectId).getCustAccountDetailNum());
/* 235 */     setPropertyCode(((CustomerItemAccountDetailPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"CustomerItemAccountDetailProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 256 */     if (this._custAccountDetailNum != null) values.put("CustAccountDetailNum", DaoUtils.getXmlSafeFieldValue(-5, this._custAccountDetailNum)); 
...
/* 308 */             setCustAccountDetailNum((Long)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setCustAccountDetailNum() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerItemAccountDetailPropertyDAO.class
