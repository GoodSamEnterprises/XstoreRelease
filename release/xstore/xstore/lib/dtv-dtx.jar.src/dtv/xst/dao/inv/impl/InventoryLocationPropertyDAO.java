...
/*     */ 
/*     */ 
/*     */ public class InventoryLocationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 324002310L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryLocationPropertyDAO.class);
/*     */   
...
/*  59 */     return this._locationId;
/*     */   }
/*     */   
/*     */   public void setLocationId(String argLocationId) {
/*  63 */     if (changed(argLocationId, this._locationId, "locationId")) {
/*  64 */       this._locationId = (argLocationId != null && MANAGE_CASE) ? argLocationId.toUpperCase() : argLocationId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getLocationId() != null) {
/* 173 */       buf.append("locationId").append("=").append(getLocationId()).append(" ");
/*     */     }
...
/* 207 */     InventoryLocationPropertyId id = new InventoryLocationPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setLocationId(getLocationId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((InventoryLocationPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((InventoryLocationPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setLocationId(((InventoryLocationPropertyId)argObjectId).getLocationId());
/* 219 */     setPropertyCode(((InventoryLocationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"InventoryLocationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._locationId != null) values.put("LocationId", DaoUtils.getXmlSafeFieldValue(12, this._locationId)); 
...
/* 282 */             setLocationId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryLocationPropertyDAO.class
