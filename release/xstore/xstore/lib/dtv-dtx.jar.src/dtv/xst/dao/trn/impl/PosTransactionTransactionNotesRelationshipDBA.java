...
/*    */ 
/*    */ 
/*    */ public class PosTransactionTransactionNotesRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(5);
/*    */   
/*    */   public String getSelect() {
/* 22 */     return "SELECT business_date, note_seq, organization_id, rtl_loc_id, trans_seq, wkstn_id, create_date, create_user_id, update_date, update_user_id, note, note_datetime, posted_flag FROM trn_trans_notes WHERE organization_id = ? AND rtl_loc_id = ? AND business_date = ? AND wkstn_id = ? AND trans_seq = ?";
/*    */   }
/*    */ 
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\PosTransactionTransactionNotesRelationshipDBA.class
