...
/*     */ 
/*     */ 
/*     */ public class SessionWorkstationPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ISessionWorkstationProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new SessionWorkstationPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private SessionWorkstationPropertyDAO getDAO_() {
/*  44 */     return (SessionWorkstationPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ISessionWorkstationProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(ISessionWorkstationProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     if (getDAO_().getSessionId() != null) {
/* 131 */       return getDAO_().getSessionId().longValue();
/*     */     }
/*     */     
/* 134 */     return 0L;
/*     */   }
...
/* 143 */     if (setSessionId_noev(argSessionId) && 
/* 144 */       this._events != null && 
/* 145 */       postEventsForChanges()) {
/* 146 */       this._events.post(ISessionWorkstationProperty.SET_SESSIONID, Long.valueOf(argSessionId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 155 */     if ((getDAO_().getSessionId() == null && Long.valueOf(argSessionId) != null) || (
/* 156 */       getDAO_().getSessionId() != null && !getDAO_().getSessionId().equals(Long.valueOf(argSessionId)))) {
/* 157 */       getDAO_().setSessionId(Long.valueOf(argSessionId));
...
/* 169 */     if (getDAO_().getSessionWorkstationSequenceNbr() != null) {
/* 170 */       return getDAO_().getSessionWorkstationSequenceNbr().intValue();
/*     */     }
/*     */     
/* 173 */     return 0;
/*     */   }
...
/* 182 */     if (setSessionWorkstationSequenceNbr_noev(argSessionWorkstationSequenceNbr) && 
/* 183 */       this._events != null && 
/* 184 */       postEventsForChanges()) {
/* 185 */       this._events.post(ISessionWorkstationProperty.SET_SESSIONWORKSTATIONSEQUENCENBR, Integer.valueOf(argSessionWorkstationSequenceNbr));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 194 */     if ((getDAO_().getSessionWorkstationSequenceNbr() == null && Integer.valueOf(argSessionWorkstationSequenceNbr) != null) || (
/* 195 */       getDAO_().getSessionWorkstationSequenceNbr() != null && !getDAO_().getSessionWorkstationSequenceNbr().equals(Integer.valueOf(argSessionWorkstationSequenceNbr)))) {
/* 196 */       getDAO_().setSessionWorkstationSequenceNbr(Integer.valueOf(argSessionWorkstationSequenceNbr));
...
/* 219 */       this._events.post(ISessionWorkstationProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 253 */       this._events.post(ISessionWorkstationProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 287 */       this._events.post(ISessionWorkstationProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 321 */       this._events.post(ISessionWorkstationProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 355 */       this._events.post(ISessionWorkstationProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 389 */       this._events.post(ISessionWorkstationProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 423 */       this._events.post(ISessionWorkstationProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 457 */       this._events.post(ISessionWorkstationProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 491 */       this._events.post(ISessionWorkstationProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 512 */     if ("SessionWorkstationPropertyExtension".equals(argFieldId)) {
...
/* 522 */     if ("SessionWorkstationPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\SessionWorkstationPropertyModel.class
