...
/*     */ 
/*     */ 
/*     */ public class ServiceLocationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1374565727L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ServiceLocationPropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getServiceLocationId() != null) {
/* 159 */       buf.append("serviceLocationId").append("=").append(getServiceLocationId()).append(" ");
/*     */     }
...
/* 193 */     ServiceLocationPropertyId id = new ServiceLocationPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setServiceLocationId(getServiceLocationId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((ServiceLocationPropertyId)argObjectId).getOrganizationId());
/* 202 */     setServiceLocationId(((ServiceLocationPropertyId)argObjectId).getServiceLocationId());
/* 203 */     setPropertyCode(((ServiceLocationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ServiceLocationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._serviceLocationId != null) values.put("ServiceLocationId", DaoUtils.getXmlSafeFieldValue(12, this._serviceLocationId)); 
...
/* 256 */             setServiceLocationId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setServiceLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\ServiceLocationPropertyDAO.class
