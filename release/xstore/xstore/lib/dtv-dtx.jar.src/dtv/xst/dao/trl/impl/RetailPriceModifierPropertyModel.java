...
/*     */ 
/*     */ 
/*     */ public class RetailPriceModifierPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IRetailPriceModifierProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new RetailPriceModifierPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private RetailPriceModifierPropertyDAO getDAO_() {
/*  44 */     return (RetailPriceModifierPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(IRetailPriceModifierProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IRetailPriceModifierProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 141 */       this._events.post(IRetailPriceModifierProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 164 */     if (getDAO_().getRetailPriceModifierSequenceNbr() != null) {
/* 165 */       return getDAO_().getRetailPriceModifierSequenceNbr().intValue();
/*     */     }
/*     */     
/* 168 */     return 0;
/*     */   }
...
/* 177 */     if (setRetailPriceModifierSequenceNbr_noev(argRetailPriceModifierSequenceNbr) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(IRetailPriceModifierProperty.SET_RETAILPRICEMODIFIERSEQUENCENBR, Integer.valueOf(argRetailPriceModifierSequenceNbr));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getRetailPriceModifierSequenceNbr() == null && Integer.valueOf(argRetailPriceModifierSequenceNbr) != null) || (
/* 190 */       getDAO_().getRetailPriceModifierSequenceNbr() != null && !getDAO_().getRetailPriceModifierSequenceNbr().equals(Integer.valueOf(argRetailPriceModifierSequenceNbr)))) {
/* 191 */       getDAO_().setRetailPriceModifierSequenceNbr(Integer.valueOf(argRetailPriceModifierSequenceNbr));
...
/* 219 */       this._events.post(IRetailPriceModifierProperty.SET_RETAILTRANSACTIONLINEITEMSEQUENCE, Integer.valueOf(argRetailTransactionLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(IRetailPriceModifierProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 297 */       this._events.post(IRetailPriceModifierProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 331 */       this._events.post(IRetailPriceModifierProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(IRetailPriceModifierProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(IRetailPriceModifierProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(IRetailPriceModifierProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(IRetailPriceModifierProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(IRetailPriceModifierProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(IRetailPriceModifierProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(IRetailPriceModifierProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(IRetailPriceModifierProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("RetailPriceModifierPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("RetailPriceModifierPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailPriceModifierPropertyModel.class
