...
/*     */ 
/*     */ 
/*     */ public class XunitResultPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1764812302L;
/*  23 */   private static final Logger _logger = Logger.getLogger(XunitResultPropertyDAO.class);
/*     */   
...
/*  49 */     return this._hostname;
/*     */   }
/*     */   
/*     */   public void setHostname(String argHostname) {
/*  53 */     if (changed(argHostname, this._hostname, "hostname")) {
/*  54 */       this._hostname = (argHostname != null && MANAGE_CASE) ? argHostname.toUpperCase() : argHostname;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getResultTimestamp() {
/*  59 */     return this._resultTimestamp;
/*     */   }
/*     */   
/*     */   public void setResultTimestamp(Long argResultTimestamp) {
/*  63 */     if (changed(argResultTimestamp, this._resultTimestamp, "resultTimestamp")) {
/*  64 */       this._resultTimestamp = argResultTimestamp;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getHostname() != null) {
/* 170 */       buf.append("hostname").append("=").append(getHostname()).append(" ");
/*     */     }
/* 172 */     if (getResultTimestamp() != null) {
/* 173 */       buf.append("resultTimestamp").append("=").append(getResultTimestamp()).append(" ");
/*     */     }
...
/* 207 */     XunitResultPropertyId id = new XunitResultPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setHostname(getHostname());
/* 210 */     id.setResultTimestamp(getResultTimestamp());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((XunitResultPropertyId)argObjectId).getOrganizationId());
/* 217 */     setHostname(((XunitResultPropertyId)argObjectId).getHostname());
/* 218 */     setResultTimestamp(((XunitResultPropertyId)argObjectId).getResultTimestamp());
/* 219 */     setPropertyCode(((XunitResultPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"XunitResultProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._hostname != null) values.put("Hostname", DaoUtils.getXmlSafeFieldValue(12, this._hostname)); 
/* 239 */     if (this._resultTimestamp != null) values.put("ResultTimestamp", DaoUtils.getXmlSafeFieldValue(-5, this._resultTimestamp)); 
...
/* 273 */             setHostname((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setHostname() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 282 */             setResultTimestamp((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setResultTimestamp() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\_test\impl\XunitResultPropertyDAO.class
