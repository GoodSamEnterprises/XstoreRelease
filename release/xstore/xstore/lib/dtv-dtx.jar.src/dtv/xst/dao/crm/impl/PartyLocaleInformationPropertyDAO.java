...
/*     */ 
/*     */ 
/*     */ public class PartyLocaleInformationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1748230721L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PartyLocaleInformationPropertyDAO.class);
/*     */   
...
/* 207 */     PartyLocaleInformationPropertyId id = new PartyLocaleInformationPropertyId();
...
/* 216 */     setOrganizationId(((PartyLocaleInformationPropertyId)argObjectId).getOrganizationId());
/* 217 */     setPartyId(((PartyLocaleInformationPropertyId)argObjectId).getPartyId());
/* 218 */     setSequence(((PartyLocaleInformationPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((PartyLocaleInformationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"PartyLocaleInformationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\PartyLocaleInformationPropertyDAO.class
