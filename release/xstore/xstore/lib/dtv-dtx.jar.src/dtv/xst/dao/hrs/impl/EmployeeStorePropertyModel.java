...
/*     */ 
/*     */ 
/*     */ public class EmployeeStorePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IEmployeeStoreProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new EmployeeStorePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private EmployeeStorePropertyDAO getDAO_() {
/*  44 */     return (EmployeeStorePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IEmployeeStoreProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getEmployeeId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setEmployeeId_noev(argEmployeeId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IEmployeeStoreProperty.SET_EMPLOYEEID, argEmployeeId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getEmployeeId() == null && argEmployeeId != null) || (
/* 112 */       getDAO_().getEmployeeId() != null && !getDAO_().getEmployeeId().equals(argEmployeeId))) {
/* 113 */       getDAO_().setEmployeeId(argEmployeeId);
...
/* 141 */       this._events.post(IEmployeeStoreProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 164 */     if (getDAO_().getEmployeeStoreSequence() != null) {
/* 165 */       return getDAO_().getEmployeeStoreSequence().intValue();
/*     */     }
/*     */     
/* 168 */     return 0;
/*     */   }
...
/* 177 */     if (setEmployeeStoreSequence_noev(argEmployeeStoreSequence) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(IEmployeeStoreProperty.SET_EMPLOYEESTORESEQUENCE, Integer.valueOf(argEmployeeStoreSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getEmployeeStoreSequence() == null && Integer.valueOf(argEmployeeStoreSequence) != null) || (
/* 190 */       getDAO_().getEmployeeStoreSequence() != null && !getDAO_().getEmployeeStoreSequence().equals(Integer.valueOf(argEmployeeStoreSequence)))) {
/* 191 */       getDAO_().setEmployeeStoreSequence(Integer.valueOf(argEmployeeStoreSequence));
...
/* 214 */       this._events.post(IEmployeeStoreProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 248 */       this._events.post(IEmployeeStoreProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(IEmployeeStoreProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(IEmployeeStoreProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(IEmployeeStoreProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(IEmployeeStoreProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(IEmployeeStoreProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(IEmployeeStoreProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(IEmployeeStoreProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 507 */     if ("EmployeeStorePropertyExtension".equals(argFieldId)) {
...
/* 517 */     if ("EmployeeStorePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeStorePropertyModel.class
