...
/*     */ 
/*     */ 
/*     */ public class TransactionPropertyPromptPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.trans_prompt_property_code, t.effective_date, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_trans_prompt_properties_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND trans_prompt_property_code = ?  AND effective_date = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.trans_prompt_property_code, t.effective_date, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_trans_prompt_properties_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND trans_prompt_property_code = ?  AND effective_date = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO com_trans_prompt_properties_p(organization_id, trans_prompt_property_code, effective_date, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._promptPropertyCode, this._effectiveDate, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE com_trans_prompt_properties_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM com_trans_prompt_properties_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND trans_prompt_property_code = ?  AND effective_date = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND trans_prompt_property_code = ?  AND effective_date = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._promptPropertyCode, this._effectiveDate, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "com_trans_prompt_properties_p";
/*     */   }
/*     */   
...
/* 116 */     return new TransactionPropertyPromptPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TransactionPropertyPromptPropertyFiller
/*     */     implements IFiller {
/*     */     private TransactionPropertyPromptPropertyDBA _parent;
/*     */     
/*     */     public TransactionPropertyPromptPropertyFiller(TransactionPropertyPromptPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._promptPropertyCode = argResultSet.getString(2);
/*     */       
...
/* 183 */     TransactionPropertyPromptPropertyDAO dao = (TransactionPropertyPromptPropertyDAO)argDAO;
/* 184 */     dao.setOrganizationId(this._organizationId);
/* 185 */     dao.setPromptPropertyCode(this._promptPropertyCode);
...
/* 201 */     return loadDAO((IDataAccessObject)new TransactionPropertyPromptPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 205 */     TransactionPropertyPromptPropertyDAO dao = (TransactionPropertyPromptPropertyDAO)argDAO;
/* 206 */     this._organizationId = dao.getOrganizationId();
/* 207 */     this._promptPropertyCode = dao.getPromptPropertyCode();
...
/* 221 */     TransactionPropertyPromptPropertyId id = (TransactionPropertyPromptPropertyId)argId;
/* 222 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 223 */     argStatement.setString(2, id.getPromptPropertyCode());
...
/* 230 */     TransactionPropertyPromptPropertyId id = new TransactionPropertyPromptPropertyId();
/* 231 */     id.setOrganizationId(this._organizationId);
/* 232 */     id.setPromptPropertyCode(this._promptPropertyCode);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\TransactionPropertyPromptPropertyDBA.class
