...
/*     */ 
/*     */ 
/*     */ public class RetailLocationTaxMappingDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 866442939L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RetailLocationTaxMappingDAO.class);
/*     */   
...
/*  96 */     return this._taxLocationId;
/*     */   }
/*     */   
/*     */   public void setTaxLocationId(String argTaxLocationId) {
/* 100 */     if (changed(argTaxLocationId, this._taxLocationId, "taxLocationId")) {
/* 101 */       this._taxLocationId = argTaxLocationId;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 128 */     if (getTaxLocationId() != null) {
/* 129 */       buf.append("taxLocationId").append("=").append(getTaxLocationId()).append(" ");
/*     */     }
/*     */     
...
/* 136 */     RetailLocationTaxMappingId id = new RetailLocationTaxMappingId();
...
/* 143 */     setOrganizationId(((RetailLocationTaxMappingId)argObjectId).getOrganizationId());
/* 144 */     setRetailLocationId(((RetailLocationTaxMappingId)argObjectId).getRetailLocationId());
/*     */   }
/*     */   
...
/* 153 */     buf.append("<").append("dao").append(" name=\"RetailLocationTaxMapping\" cmd=\"" + getObjectStateString() + "\">");
...
/* 168 */     if (this._taxLocationId != null) values.put("TaxLocationId", DaoUtils.getXmlSafeFieldValue(12, this._taxLocationId)); 
/* 169 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/* 238 */             setTaxLocationId((String)value);
/* 239 */           } catch (Exception ee) {
/* 240 */             throw new DtxException("An exception occurred while calling setTaxLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\RetailLocationTaxMappingDAO.class
