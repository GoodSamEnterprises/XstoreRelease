...
/*     */ 
/*     */ 
/*     */ public class RetailTransactionLineItemNotesPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1408101076L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RetailTransactionLineItemNotesPropertyDAO.class);
/*     */   
...
/* 104 */     return this._noteSeq;
/*     */   }
/*     */   
/*     */   public void setNoteSeq(Long argNoteSeq) {
/* 108 */     if (changed(argNoteSeq, this._noteSeq, "noteSeq")) {
/* 109 */       this._noteSeq = argNoteSeq;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 229 */     if (getNoteSeq() != null) {
/* 230 */       buf.append("noteSeq").append("=").append(getNoteSeq()).append(" ");
/*     */     }
...
/* 264 */     RetailTransactionLineItemNotesPropertyId id = new RetailTransactionLineItemNotesPropertyId();
...
/* 271 */     id.setNoteSeq(getNoteSeq());
/* 272 */     id.setPropertyCode(getPropertyCode());
/* 273 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 277 */     setBusinessDate(((RetailTransactionLineItemNotesPropertyId)argObjectId).getBusinessDate());
/* 278 */     setOrganizationId(((RetailTransactionLineItemNotesPropertyId)argObjectId).getOrganizationId());
/* 279 */     setRetailLocationId(((RetailTransactionLineItemNotesPropertyId)argObjectId).getRetailLocationId());
/* 280 */     setRetailTransactionLineItemSequence(((RetailTransactionLineItemNotesPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 281 */     setTransactionSequence(((RetailTransactionLineItemNotesPropertyId)argObjectId).getTransactionSequence());
/* 282 */     setWorkstationId(((RetailTransactionLineItemNotesPropertyId)argObjectId).getWorkstationId());
/* 283 */     setNoteSeq(((RetailTransactionLineItemNotesPropertyId)argObjectId).getNoteSeq());
/* 284 */     setPropertyCode(((RetailTransactionLineItemNotesPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"RetailTransactionLineItemNotesProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 308 */     if (this._noteSeq != null) values.put("NoteSeq", DaoUtils.getXmlSafeFieldValue(-5, this._noteSeq)); 
...
/* 387 */             setNoteSeq((Long)value);
/* 388 */           } catch (Exception ee) {
/* 389 */             throw new DtxException("An exception occurred while calling setNoteSeq() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailTransactionLineItemNotesPropertyDAO.class
