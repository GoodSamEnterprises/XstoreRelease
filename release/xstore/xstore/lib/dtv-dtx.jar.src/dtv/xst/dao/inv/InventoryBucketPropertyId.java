...
/*     */ 
/*     */ 
/*     */ public class InventoryBucketPropertyId
...
/*     */   
/*     */   public InventoryBucketPropertyId() {}
/*     */   
/*     */   public InventoryBucketPropertyId(String argObjectIdValue) {
...
/*  39 */     return this._bucketId;
/*     */   }
/*     */   
/*     */   public void setBucketId(String argBucketId) {
/*  43 */     this._bucketId = (argBucketId != null && MANAGE_CASE) ? argBucketId.toUpperCase() : argBucketId;
/*     */   }
/*     */   
...
/*  92 */       return true;
/*     */     }
/*  94 */     if (!(ob instanceof InventoryBucketPropertyId)) {
/*  95 */       return false;
/*     */     }
/*  97 */     InventoryBucketPropertyId other = (InventoryBucketPropertyId)ob;
...
/*     */ 
/*     */       
/* 104 */       .equals(other._retailLocationId))) && ((this._bucketId == null && other._bucketId == null) || (this._bucketId != null && this._bucketId
/*     */ 
/*     */       
/* 107 */       .equals(other._bucketId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 118 */       .hashCode()) + ((this._bucketId == null) ? 0 : this._bucketId
...
/* 125 */     return "InventoryBucketProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 135 */       .append("::").append(this._bucketId)
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\InventoryBucketPropertyId.class
