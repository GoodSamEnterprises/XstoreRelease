...
/*     */ 
/*     */ 
/*     */ public class RetailTransactionLineItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1656670217L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RetailTransactionLineItemPropertyDAO.class);
/*     */   
...
/*     */     }
/* 215 */     if (getRetailTransactionLineItemSequence() != null) {
/* 216 */       buf.append("retailTransactionLineItemSequence").append("=").append(getRetailTransactionLineItemSequence()).append(" ");
/*     */     }
...
/* 250 */     RetailTransactionLineItemPropertyId id = new RetailTransactionLineItemPropertyId();
...
/* 256 */     id.setRetailTransactionLineItemSequence(getRetailTransactionLineItemSequence());
/* 257 */     id.setPropertyCode(getPropertyCode());
/* 258 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 262 */     setOrganizationId(((RetailTransactionLineItemPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((RetailTransactionLineItemPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setBusinessDate(((RetailTransactionLineItemPropertyId)argObjectId).getBusinessDate());
/* 265 */     setWorkstationId(((RetailTransactionLineItemPropertyId)argObjectId).getWorkstationId());
/* 266 */     setTransactionSequence(((RetailTransactionLineItemPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setRetailTransactionLineItemSequence(((RetailTransactionLineItemPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 268 */     setPropertyCode(((RetailTransactionLineItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"RetailTransactionLineItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 291 */     if (this._retailTransactionLineItemSequence != null) values.put("RetailTransactionLineItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._retailTransactionLineItemSequence)); 
...
/* 361 */             setRetailTransactionLineItemSequence((Integer)value);
/* 362 */           } catch (Exception ee) {
/* 363 */             throw new DtxException("An exception occurred while calling setRetailTransactionLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailTransactionLineItemPropertyDAO.class
