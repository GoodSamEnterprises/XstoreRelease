...
/*     */ 
/*     */ 
/*     */ public class MerchandiseHierarchyPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -547099193L;
/*  23 */   private static final Logger _logger = Logger.getLogger(MerchandiseHierarchyPropertyDAO.class);
/*     */   
...
/*  38 */     return this._hierarchyId;
/*     */   }
/*     */   
/*     */   public void setHierarchyId(String argHierarchyId) {
/*  42 */     if (changed(argHierarchyId, this._hierarchyId, "hierarchyId")) {
/*  43 */       this._hierarchyId = (argHierarchyId != null && MANAGE_CASE) ? argHierarchyId.toUpperCase() : argHierarchyId;
/*     */     }
/*     */   }
/*     */   
...
/* 155 */     if (getHierarchyId() != null) {
/* 156 */       buf.append("hierarchyId").append("=").append(getHierarchyId()).append(" ");
/*     */     }
...
/* 193 */     MerchandiseHierarchyPropertyId id = new MerchandiseHierarchyPropertyId();
/* 194 */     id.setHierarchyId(getHierarchyId());
...
/* 201 */     setHierarchyId(((MerchandiseHierarchyPropertyId)argObjectId).getHierarchyId());
/* 202 */     setOrganizationId(((MerchandiseHierarchyPropertyId)argObjectId).getOrganizationId());
/* 203 */     setPropertyCode(((MerchandiseHierarchyPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"MerchandiseHierarchyProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 221 */     if (this._hierarchyId != null) values.put("HierarchyId", DaoUtils.getXmlSafeFieldValue(12, this._hierarchyId)); 
...
/* 247 */             setHierarchyId((String)value);
/* 248 */           } catch (Exception ee) {
/* 249 */             throw new DtxException("An exception occurred while calling setHierarchyId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\MerchandiseHierarchyPropertyDAO.class
