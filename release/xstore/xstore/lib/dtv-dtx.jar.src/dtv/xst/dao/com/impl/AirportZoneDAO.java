...
/*     */ 
/*     */ 
/*     */ public class AirportZoneDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 840384247L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AirportZoneDAO.class);
/*     */   
...
/*  44 */     return this._zoneId;
/*     */   }
/*     */   
/*     */   public void setZoneId(String argZoneId) {
/*  48 */     if (changed(argZoneId, this._zoneId, "zoneId")) {
/*  49 */       this._zoneId = (argZoneId != null && MANAGE_CASE) ? argZoneId.toUpperCase() : argZoneId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 113 */     if (getZoneId() != null) {
/* 114 */       buf.append("zoneId").append("=").append(getZoneId()).append(" ");
/*     */     }
...
/* 136 */     AirportZoneId id = new AirportZoneId();
/* 137 */     id.setOrganizationId(getOrganizationId());
/* 138 */     id.setZoneId(getZoneId());
/* 139 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 143 */     setOrganizationId(((AirportZoneId)argObjectId).getOrganizationId());
/* 144 */     setZoneId(((AirportZoneId)argObjectId).getZoneId());
/*     */   }
/*     */   
...
/* 153 */     buf.append("<").append("dao").append(" name=\"AirportZone\" cmd=\"" + getObjectStateString() + "\">");
...
/* 163 */     if (this._zoneId != null) values.put("ZoneId", DaoUtils.getXmlSafeFieldValue(12, this._zoneId)); 
...
/* 193 */             setZoneId((String)value);
/* 194 */           } catch (Exception ee) {
/* 195 */             throw new DtxException("An exception occurred while calling setZoneId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CreateDate":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AirportZoneDAO.class
