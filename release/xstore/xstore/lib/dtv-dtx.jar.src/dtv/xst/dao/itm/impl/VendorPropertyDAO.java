...
/*     */ 
/*     */ 
/*     */ public class VendorPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 752347997L;
/*  23 */   private static final Logger _logger = Logger.getLogger(VendorPropertyDAO.class);
/*     */   
...
/*  48 */     return this._vendorId;
/*     */   }
/*     */   
/*     */   public void setVendorId(String argVendorId) {
/*  52 */     if (changed(argVendorId, this._vendorId, "vendorId")) {
/*  53 */       this._vendorId = (argVendorId != null && MANAGE_CASE) ? argVendorId.toUpperCase() : argVendorId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getVendorId() != null) {
/* 159 */       buf.append("vendorId").append("=").append(getVendorId()).append(" ");
/*     */     }
...
/* 193 */     VendorPropertyId id = new VendorPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setVendorId(getVendorId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((VendorPropertyId)argObjectId).getOrganizationId());
/* 202 */     setVendorId(((VendorPropertyId)argObjectId).getVendorId());
/* 203 */     setPropertyCode(((VendorPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"VendorProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._vendorId != null) values.put("VendorId", DaoUtils.getXmlSafeFieldValue(12, this._vendorId)); 
...
/* 256 */             setVendorId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setVendorId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\VendorPropertyDAO.class
