...
/*     */   public AddressId() {}
/*     */   
/*     */   public AddressId(String argObjectIdValue) {
...
/*  29 */     return this._addressId;
/*     */   }
/*     */   
/*     */   public void setAddressId(String argAddressId) {
/*  33 */     this._addressId = (argAddressId != null && MANAGE_CASE) ? argAddressId.toUpperCase() : argAddressId;
/*     */   }
/*     */   
...
/*  63 */       return true;
/*     */     }
/*  65 */     if (!(ob instanceof AddressId)) {
/*  66 */       return false;
/*     */     }
/*  68 */     AddressId other = (AddressId)ob;
/*  69 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  72 */       .equals(other._organizationId))) && ((this._addressId == null && other._addressId == null) || (this._addressId != null && this._addressId
/*     */ 
/*     */       
/*  75 */       .equals(other._addressId))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  82 */       .hashCode()) + ((this._addressId == null) ? 0 : this._addressId
/*  83 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
...
/*  97 */       .append("::").append(this._addressId)
/*  98 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 102 */     if (this._addressId == null) {
/* 103 */       return false;
/*     */     }
/* 105 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\AddressId.class
