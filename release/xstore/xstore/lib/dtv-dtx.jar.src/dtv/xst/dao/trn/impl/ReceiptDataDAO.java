...
/*  23 */   private static final Logger _logger = Logger.getLogger(ReceiptDataDAO.class);
/*     */   
...
/* 141 */     return this._receiptData;
/*     */   }
/*     */   
/*     */   public void setReceiptData(Object argReceiptData) {
/* 145 */     if (changed(argReceiptData, this._receiptData, "receiptData")) {
/* 146 */       this._receiptData = argReceiptData;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 185 */     if (getReceiptData() != null) {
/* 186 */       buf.append("receiptData").append("=").append(getReceiptData()).append(" ");
/*     */     }
/*     */     
...
/* 193 */     ReceiptDataId id = new ReceiptDataId();
...
/* 204 */     setOrganizationId(((ReceiptDataId)argObjectId).getOrganizationId());
/* 205 */     setRetailLocationId(((ReceiptDataId)argObjectId).getRetailLocationId());
/* 206 */     setWorkstationId(((ReceiptDataId)argObjectId).getWorkstationId());
/* 207 */     setBusinessDate(((ReceiptDataId)argObjectId).getBusinessDate());
/* 208 */     setTransactionSequence(((ReceiptDataId)argObjectId).getTransactionSequence());
/* 209 */     setReceiptId(((ReceiptDataId)argObjectId).getReceiptId());
/*     */   }
/*     */   
...
/* 218 */     buf.append("<").append("dao").append(" name=\"ReceiptData\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._receiptData != null) values.put("ReceiptData", DaoUtils.getXmlSafeFieldValue(-4, this._receiptData)); 
/* 238 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/* 343 */             setReceiptData(value);
/* 344 */           } catch (Exception ee) {
/* 345 */             throw new DtxException("An exception occurred while calling setReceiptData() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\ReceiptDataDAO.class
