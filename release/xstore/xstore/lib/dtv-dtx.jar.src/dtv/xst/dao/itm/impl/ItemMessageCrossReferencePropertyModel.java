...
/*     */ 
/*     */ 
/*     */ public class ItemMessageCrossReferencePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IItemMessageCrossReferenceProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ItemMessageCrossReferencePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ItemMessageCrossReferencePropertyDAO getDAO_() {
/*  44 */     return (ItemMessageCrossReferencePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  52 */     return getDAO_().getMessageId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     if (setMessageId_noev(argMessageId) && 
/*  61 */       this._events != null && 
/*  62 */       postEventsForChanges()) {
/*  63 */       this._events.post(IItemMessageCrossReferenceProperty.SET_MESSAGEID, argMessageId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*  72 */     if ((getDAO_().getMessageId() == null && argMessageId != null) || (
/*  73 */       getDAO_().getMessageId() != null && !getDAO_().getMessageId().equals(argMessageId))) {
/*  74 */       getDAO_().setMessageId(argMessageId);
/*  75 */       ev_postable = true;
/*     */     } 
/*     */     
...
/* 102 */       this._events.post(IItemMessageCrossReferenceProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 133 */     if (setItemId_noev(argItemId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IItemMessageCrossReferenceProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getItemId() == null && argItemId != null) || (
/* 146 */       getDAO_().getItemId() != null && !getDAO_().getItemId().equals(argItemId))) {
/* 147 */       getDAO_().setItemId(argItemId);
...
/* 170 */       this._events.post(IItemMessageCrossReferenceProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IItemMessageCrossReferenceProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IItemMessageCrossReferenceProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IItemMessageCrossReferenceProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IItemMessageCrossReferenceProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IItemMessageCrossReferenceProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IItemMessageCrossReferenceProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IItemMessageCrossReferenceProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IItemMessageCrossReferenceProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("ItemMessageCrossReferencePropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("ItemMessageCrossReferencePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemMessageCrossReferencePropertyModel.class
