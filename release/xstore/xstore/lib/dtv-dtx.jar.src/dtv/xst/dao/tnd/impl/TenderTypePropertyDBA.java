...
/*     */ 
/*     */ 
/*     */ public class TenderTypePropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -1169466301L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.tndr_typcode, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tnd_tndr_typcode_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND tndr_typcode = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.tndr_typcode, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tnd_tndr_typcode_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND tndr_typcode = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO tnd_tndr_typcode_p(organization_id, tndr_typcode, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._tenderTypecode, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE tnd_tndr_typcode_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM tnd_tndr_typcode_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND tndr_typcode = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND tndr_typcode = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._tenderTypecode, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new TenderTypePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TenderTypePropertyFiller
/*     */     implements IFiller {
/*     */     private TenderTypePropertyDBA _parent;
/*     */     
/*     */     public TenderTypePropertyFiller(TenderTypePropertyDBA argParent) {
...
/* 173 */     TenderTypePropertyDAO dao = (TenderTypePropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setTenderTypecode(this._tenderTypecode);
...
/* 190 */     return loadDAO((IDataAccessObject)new TenderTypePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     TenderTypePropertyDAO dao = (TenderTypePropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._tenderTypecode = dao.getTenderTypecode();
...
/* 209 */     TenderTypePropertyId id = (TenderTypePropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getTenderTypecode());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     TenderTypePropertyId id = new TenderTypePropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setTenderTypecode(this._tenderTypecode);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderTypePropertyDBA.class
