...
/*     */ 
/*     */ 
/*     */ public class TenderCountPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1781313168L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderCountPropertyDAO.class);
/*     */   
...
/*  74 */     return this._tenderId;
/*     */   }
/*     */   
/*     */   public void setTenderId(String argTenderId) {
/*  78 */     if (changed(argTenderId, this._tenderId, "tenderId")) {
/*  79 */       this._tenderId = (argTenderId != null && MANAGE_CASE) ? argTenderId.toUpperCase() : argTenderId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 220 */     if (getTenderId() != null) {
/* 221 */       buf.append("tenderId").append("=").append(getTenderId()).append(" ");
/*     */     }
...
/* 264 */     TenderCountPropertyId id = new TenderCountPropertyId();
...
/* 277 */     setBusinessDayDate(((TenderCountPropertyId)argObjectId).getBusinessDayDate());
/* 278 */     setOrganizationId(((TenderCountPropertyId)argObjectId).getOrganizationId());
/* 279 */     setRetailLocationId(((TenderCountPropertyId)argObjectId).getRetailLocationId());
/* 280 */     setTenderId(((TenderCountPropertyId)argObjectId).getTenderId());
/* 281 */     setTenderTypeCode(((TenderCountPropertyId)argObjectId).getTenderTypeCode());
/* 282 */     setTransactionSequence(((TenderCountPropertyId)argObjectId).getTransactionSequence());
/* 283 */     setWorkstationId(((TenderCountPropertyId)argObjectId).getWorkstationId());
/* 284 */     setPropertyCode(((TenderCountPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"TenderCountProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 360 */             setTenderId((String)value);
/* 361 */           } catch (Exception ee) {
/* 362 */             throw new DtxException("An exception occurred while calling setTenderId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "TenderTypeCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TenderCountPropertyDAO.class
