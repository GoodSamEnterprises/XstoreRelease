...
/*     */ 
/*     */ 
/*     */ public class OrderPaymentPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 2036739309L;
/*  23 */   private static final Logger _logger = Logger.getLogger(OrderPaymentPropertyDAO.class);
/*     */   
...
/* 207 */     OrderPaymentPropertyId id = new OrderPaymentPropertyId();
...
/* 216 */     setOrganizationId(((OrderPaymentPropertyId)argObjectId).getOrganizationId());
/* 217 */     setOrderId(((OrderPaymentPropertyId)argObjectId).getOrderId());
/* 218 */     setSequence(((OrderPaymentPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((OrderPaymentPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"OrderPaymentProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderPaymentPropertyDAO.class
