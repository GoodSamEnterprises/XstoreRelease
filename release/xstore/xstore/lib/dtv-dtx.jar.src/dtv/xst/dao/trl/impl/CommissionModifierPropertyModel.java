...
/*     */ 
/*     */ 
/*     */ public class CommissionModifierPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ICommissionModifierProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new CommissionModifierPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private CommissionModifierPropertyDAO getDAO_() {
/*  44 */     return (CommissionModifierPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(ICommissionModifierProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  86 */     if (getDAO_().getCommissionModifierSequenceNbr() != null) {
/*  87 */       return getDAO_().getCommissionModifierSequenceNbr().intValue();
/*     */     }
/*     */     
/*  90 */     return 0;
/*     */   }
...
/*  99 */     if (setCommissionModifierSequenceNbr_noev(argCommissionModifierSequenceNbr) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ICommissionModifierProperty.SET_COMMISSIONMODIFIERSEQUENCENBR, Integer.valueOf(argCommissionModifierSequenceNbr));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getCommissionModifierSequenceNbr() == null && Integer.valueOf(argCommissionModifierSequenceNbr) != null) || (
/* 112 */       getDAO_().getCommissionModifierSequenceNbr() != null && !getDAO_().getCommissionModifierSequenceNbr().equals(Integer.valueOf(argCommissionModifierSequenceNbr)))) {
/* 113 */       getDAO_().setCommissionModifierSequenceNbr(Integer.valueOf(argCommissionModifierSequenceNbr));
...
/* 141 */       this._events.post(ICommissionModifierProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(ICommissionModifierProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(ICommissionModifierProperty.SET_RETAILTRANSACTIONLINEITEMSEQUENCE, Integer.valueOf(argRetailTransactionLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(ICommissionModifierProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 297 */       this._events.post(ICommissionModifierProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 331 */       this._events.post(ICommissionModifierProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(ICommissionModifierProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(ICommissionModifierProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(ICommissionModifierProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(ICommissionModifierProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(ICommissionModifierProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(ICommissionModifierProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(ICommissionModifierProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(ICommissionModifierProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("CommissionModifierPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("CommissionModifierPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\CommissionModifierPropertyModel.class
