...
/*     */ 
/*     */ 
/*     */ public class DealItemActionPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1513310774L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DealItemActionPropertyDAO.class);
/*     */   
...
/*  59 */     return this._ordinal;
/*     */   }
/*     */   
/*     */   public void setOrdinal(Integer argOrdinal) {
/*  63 */     if (changed(argOrdinal, this._ordinal, "ordinal")) {
/*  64 */       this._ordinal = argOrdinal;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getOrdinal() != null) {
/* 173 */       buf.append("ordinal").append("=").append(getOrdinal()).append(" ");
/*     */     }
...
/* 207 */     DealItemActionPropertyId id = new DealItemActionPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setDealId(getDealId());
/* 210 */     id.setOrdinal(getOrdinal());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((DealItemActionPropertyId)argObjectId).getOrganizationId());
/* 217 */     setDealId(((DealItemActionPropertyId)argObjectId).getDealId());
/* 218 */     setOrdinal(((DealItemActionPropertyId)argObjectId).getOrdinal());
/* 219 */     setPropertyCode(((DealItemActionPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DealItemActionProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._ordinal != null) values.put("Ordinal", DaoUtils.getXmlSafeFieldValue(4, this._ordinal)); 
...
/* 282 */             setOrdinal((Integer)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setOrdinal() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealItemActionPropertyDAO.class
