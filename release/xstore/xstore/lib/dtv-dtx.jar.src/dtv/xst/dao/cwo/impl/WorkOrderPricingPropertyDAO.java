...
/*     */ 
/*     */ 
/*     */ public class WorkOrderPricingPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 194876254L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WorkOrderPricingPropertyDAO.class);
/*     */   
...
/*  49 */     return this._priceCode;
/*     */   }
/*     */   
/*     */   public void setPriceCode(String argPriceCode) {
/*  53 */     if (changed(argPriceCode, this._priceCode, "priceCode")) {
/*  54 */       this._priceCode = (argPriceCode != null && MANAGE_CASE) ? argPriceCode.toUpperCase() : argPriceCode;
/*     */     }
/*     */   }
/*     */   
...
/*  63 */     if (changed(argItemId, this._itemId, "itemId")) {
/*  64 */       this._itemId = (argItemId != null && MANAGE_CASE) ? argItemId.toUpperCase() : argItemId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getPriceCode() != null) {
/* 170 */       buf.append("priceCode").append("=").append(getPriceCode()).append(" ");
/*     */     }
/* 172 */     if (getItemId() != null) {
/* 173 */       buf.append("itemId").append("=").append(getItemId()).append(" ");
/*     */     }
...
/* 207 */     WorkOrderPricingPropertyId id = new WorkOrderPricingPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setPriceCode(getPriceCode());
...
/* 216 */     setOrganizationId(((WorkOrderPricingPropertyId)argObjectId).getOrganizationId());
/* 217 */     setPriceCode(((WorkOrderPricingPropertyId)argObjectId).getPriceCode());
/* 218 */     setItemId(((WorkOrderPricingPropertyId)argObjectId).getItemId());
/* 219 */     setPropertyCode(((WorkOrderPricingPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"WorkOrderPricingProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._priceCode != null) values.put("PriceCode", DaoUtils.getXmlSafeFieldValue(12, this._priceCode)); 
...
/* 273 */             setPriceCode((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setPriceCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ItemId":
...
/* 282 */             setItemId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkOrderPricingPropertyDAO.class
