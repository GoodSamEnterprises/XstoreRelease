...
/*     */ 
/*     */ 
/*     */ public class TenderRepositoryPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 326334803L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.tndr_repository_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tsn_tndr_repository_p t";
...
/*  45 */     return "SELECT t.organization_id, t.rtl_loc_id, t.tndr_repository_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tsn_tndr_repository_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO tsn_tndr_repository_p(organization_id, rtl_loc_id, tndr_repository_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE tsn_tndr_repository_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM tsn_tndr_repository_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND tndr_repository_id = ?  AND property_code = ?  ";
/*     */   
...
/* 108 */     return "tsn_tndr_repository_p";
/*     */   }
/*     */   
...
/* 116 */     return new TenderRepositoryPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TenderRepositoryPropertyFiller
/*     */     implements IFiller {
/*     */     private TenderRepositoryPropertyDBA _parent;
/*     */     
/*     */     public TenderRepositoryPropertyFiller(TenderRepositoryPropertyDBA argParent) {
...
/* 182 */     TenderRepositoryPropertyDAO dao = (TenderRepositoryPropertyDAO)argDAO;
...
/* 200 */     return loadDAO((IDataAccessObject)new TenderRepositoryPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     TenderRepositoryPropertyDAO dao = (TenderRepositoryPropertyDAO)argDAO;
...
/* 220 */     TenderRepositoryPropertyId id = (TenderRepositoryPropertyId)argId;
...
/* 229 */     TenderRepositoryPropertyId id = new TenderRepositoryPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TenderRepositoryPropertyDBA.class
