...
/*     */ import dtv.xst.dao.trl.impl.SaleReturnLineItemDBA;
...
/*     */ 
/*     */ 
/*     */ public class WorkOrderLineItemDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.rtrans_lineitm_seq, t.create_date, t.create_user_id, t.update_date, t.update_user_id, t.price_status_enum, t.instructions FROM cwo_work_order_line_item t";
...
/*  46 */     return "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.rtrans_lineitm_seq, t.create_date, t.create_user_id, t.update_date, t.update_user_id, t.price_status_enum, t.instructions FROM cwo_work_order_line_item t";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/*  56 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cwo_work_order_line_item(organization_id, rtl_loc_id, business_date, wkstn_id, trans_seq, rtrans_lineitm_seq, create_date, create_user_id, update_date, update_user_id, price_status_enum, instructions) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */ 
/*     */   
...
/*  65 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._businessDate, this._workstationId, this._transactionSequence, this._retailTransactionLineItemSequence, this._createDate, this._createUserId, this._updateDate, this._updateUserId, this._priceStatus, this._instructions } };
...
/*     */   }
/*     */   
/*  76 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cwo_work_order_line_item SET update_date = ?, update_user_id = ?, price_status_enum = ?, instructions = ?" };
/*     */ 
/*     */   
...
/*  85 */     Object[][] updateParameterObject = { { this._updateDate, this._updateUserId, this._priceStatus, this._instructions } };
...
/*     */   }
/*     */   
/*  95 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cwo_work_order_line_item" };
...
/* 121 */     return "cwo_work_order_line_item";
/*     */   }
/*     */ 
/*     */   
...
/* 130 */     return new WorkOrderLineItemFiller(this);
/*     */   }
/*     */   
/*     */   private static class WorkOrderLineItemFiller
/*     */     implements IFiller {
/*     */     private WorkOrderLineItemDBA _parent;
/*     */     
/*     */     public WorkOrderLineItemFiller(WorkOrderLineItemDBA argParent) {
...
/* 210 */       this._parent._priceStatus = argResultSet.getString(11);
/* 211 */       this._parent._instructions = argResultSet.getString(12);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 219 */     WorkOrderLineItemDAO dao = (WorkOrderLineItemDAO)argDAO;
...
/* 230 */     dao.setPriceStatus(this._priceStatus);
/* 231 */     dao.setInstructions(this._instructions);
...
/* 238 */     return loadDAO((IDataAccessObject)new WorkOrderLineItemDAO());
/*     */   }
/*     */ 
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 243 */     WorkOrderLineItemDAO dao = (WorkOrderLineItemDAO)argDAO;
...
/* 255 */     this._priceStatus = dao.getPriceStatus();
/* 256 */     this._instructions = dao.getInstructions();
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkOrderLineItemDBA.class
