...
/*     */ 
/*     */ 
/*     */ public class CustomerAffiliationPropertyId
...
/*     */   
/*     */   public CustomerAffiliationPropertyId() {}
/*     */   
/*     */   public CustomerAffiliationPropertyId(String argObjectIdValue) {
...
/*  70 */         setCustomerGroupId((String)null);
/*     */       } else {
/*     */         
/*  73 */         setCustomerGroupId(str);
/*     */       } 
/*  75 */       str = tokens[3];
/*     */       
...
/*  92 */       return true;
/*     */     }
/*  94 */     if (!(ob instanceof CustomerAffiliationPropertyId)) {
/*  95 */       return false;
/*     */     }
/*  97 */     CustomerAffiliationPropertyId other = (CustomerAffiliationPropertyId)ob;
...
/*     */ 
/*     */       
/* 104 */       .equals(other._partyId))) && ((this._customerGroupId == null && other._customerGroupId == null) || (this._customerGroupId != null && this._customerGroupId
/*     */ 
/*     */       
/* 107 */       .equals(other._customerGroupId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 118 */       .hashCode()) + ((this._customerGroupId == null) ? 0 : this._customerGroupId
...
/* 125 */     return "CustomerAffiliationProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 135 */       .append("::").append(this._customerGroupId)
...
/* 142 */       return false;
/*     */     }
/* 144 */     if (this._customerGroupId == null) {
/* 145 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\CustomerAffiliationPropertyId.class
