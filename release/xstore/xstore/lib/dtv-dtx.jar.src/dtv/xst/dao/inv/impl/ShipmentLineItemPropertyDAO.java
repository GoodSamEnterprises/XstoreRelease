...
/*     */ 
/*     */ 
/*     */ public class ShipmentLineItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1032721910L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ShipmentLineItemPropertyDAO.class);
/*     */   
...
/*  82 */     return this._shipmentSequence;
/*     */   }
/*     */   
/*     */   public void setShipmentSequence(Integer argShipmentSequence) {
/*  86 */     if (changed(argShipmentSequence, this._shipmentSequence, "shipmentSequence")) {
/*  87 */       this._shipmentSequence = argShipmentSequence;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getLineItemSequence() {
/*  92 */     return this._lineItemSequence;
/*     */   }
/*     */   
/*     */   public void setLineItemSequence(Integer argLineItemSequence) {
/*  96 */     if (changed(argLineItemSequence, this._lineItemSequence, "lineItemSequence")) {
/*  97 */       this._lineItemSequence = argLineItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 211 */     if (getShipmentSequence() != null) {
/* 212 */       buf.append("shipmentSequence").append("=").append(getShipmentSequence()).append(" ");
/*     */     }
...
/* 249 */     ShipmentLineItemPropertyId id = new ShipmentLineItemPropertyId();
...
/* 254 */     id.setShipmentSequence(getShipmentSequence());
...
/* 261 */     setOrganizationId(((ShipmentLineItemPropertyId)argObjectId).getOrganizationId());
/* 262 */     setRetailLocationId(((ShipmentLineItemPropertyId)argObjectId).getRetailLocationId());
/* 263 */     setDocumentId(((ShipmentLineItemPropertyId)argObjectId).getDocumentId());
/* 264 */     setDocumentTypeCode(((ShipmentLineItemPropertyId)argObjectId).getDocumentTypeCode());
/* 265 */     setShipmentSequence(((ShipmentLineItemPropertyId)argObjectId).getShipmentSequence());
/* 266 */     setLineItemSequence(((ShipmentLineItemPropertyId)argObjectId).getLineItemSequence());
/* 267 */     setPropertyCode(((ShipmentLineItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 276 */     buf.append("<").append("dao").append(" name=\"ShipmentLineItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 289 */     if (this._shipmentSequence != null) values.put("ShipmentSequence", DaoUtils.getXmlSafeFieldValue(4, this._shipmentSequence)); 
/* 290 */     if (this._lineItemSequence != null) values.put("LineItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._lineItemSequence)); 
...
/* 351 */             setShipmentSequence((Integer)value);
/* 352 */           } catch (Exception ee) {
/* 353 */             throw new DtxException("An exception occurred while calling setShipmentSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 360 */             setLineItemSequence((Integer)value);
/* 361 */           } catch (Exception ee) {
/* 362 */             throw new DtxException("An exception occurred while calling setLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\ShipmentLineItemPropertyDAO.class
