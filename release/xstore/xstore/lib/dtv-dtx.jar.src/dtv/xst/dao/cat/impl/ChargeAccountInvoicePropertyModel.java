...
/*     */ 
/*     */ 
/*     */ public class ChargeAccountInvoicePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IChargeAccountInvoiceProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ChargeAccountInvoicePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ChargeAccountInvoicePropertyDAO getDAO_() {
/*  44 */     return (ChargeAccountInvoicePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IChargeAccountInvoiceProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IChargeAccountInvoiceProperty.SET_CUSTACCOUNTID, argCustAccountId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 136 */       this._events.post(IChargeAccountInvoiceProperty.SET_CUSTACCOUNTCODE, argCustAccountCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 159 */     return getDAO_().getInvoiceNumber();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setInvoiceNumber_noev(argInvoiceNumber) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IChargeAccountInvoiceProperty.SET_INVOICENUMBER, argInvoiceNumber);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getInvoiceNumber() == null && argInvoiceNumber != null) || (
/* 180 */       getDAO_().getInvoiceNumber() != null && !getDAO_().getInvoiceNumber().equals(argInvoiceNumber))) {
/* 181 */       getDAO_().setInvoiceNumber(argInvoiceNumber);
...
/* 204 */       this._events.post(IChargeAccountInvoiceProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IChargeAccountInvoiceProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IChargeAccountInvoiceProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IChargeAccountInvoiceProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IChargeAccountInvoiceProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IChargeAccountInvoiceProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IChargeAccountInvoiceProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IChargeAccountInvoiceProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IChargeAccountInvoiceProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("ChargeAccountInvoicePropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("ChargeAccountInvoicePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\ChargeAccountInvoicePropertyModel.class
