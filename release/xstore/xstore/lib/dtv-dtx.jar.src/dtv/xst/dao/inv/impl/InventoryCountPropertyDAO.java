...
/*     */ 
/*     */ 
/*     */ public class InventoryCountPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 70118440L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryCountPropertyDAO.class);
/*     */   
...
/*  59 */     return this._inventoryCountId;
/*     */   }
/*     */   
/*     */   public void setInventoryCountId(String argInventoryCountId) {
/*  63 */     if (changed(argInventoryCountId, this._inventoryCountId, "inventoryCountId")) {
/*  64 */       this._inventoryCountId = (argInventoryCountId != null && MANAGE_CASE) ? argInventoryCountId.toUpperCase() : argInventoryCountId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getRetailLocationId() != null) {
/* 170 */       buf.append("retailLocationId").append("=").append(getRetailLocationId()).append(" ");
/*     */     }
/* 172 */     if (getInventoryCountId() != null) {
/* 173 */       buf.append("inventoryCountId").append("=").append(getInventoryCountId()).append(" ");
/*     */     }
...
/* 207 */     InventoryCountPropertyId id = new InventoryCountPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setInventoryCountId(getInventoryCountId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((InventoryCountPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((InventoryCountPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setInventoryCountId(((InventoryCountPropertyId)argObjectId).getInventoryCountId());
/* 219 */     setPropertyCode(((InventoryCountPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"InventoryCountProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._inventoryCountId != null) values.put("InventoryCountId", DaoUtils.getXmlSafeFieldValue(12, this._inventoryCountId)); 
...
/* 273 */             setRetailLocationId((Long)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setRetailLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 282 */             setInventoryCountId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setInventoryCountId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountPropertyDAO.class
