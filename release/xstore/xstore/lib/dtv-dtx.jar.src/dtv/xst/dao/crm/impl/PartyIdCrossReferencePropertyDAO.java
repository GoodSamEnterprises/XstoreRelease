...
/*     */ 
/*     */ 
/*     */ public class PartyIdCrossReferencePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2124073535L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PartyIdCrossReferencePropertyDAO.class);
/*     */   
...
/*  59 */     return this._alternateIdOwner;
/*     */   }
/*     */   
/*     */   public void setAlternateIdOwner(String argAlternateIdOwner) {
/*  63 */     if (changed(argAlternateIdOwner, this._alternateIdOwner, "alternateIdOwner")) {
/*  64 */       this._alternateIdOwner = (argAlternateIdOwner != null && MANAGE_CASE) ? argAlternateIdOwner.toUpperCase() : argAlternateIdOwner;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getAlternateIdOwner() != null) {
/* 173 */       buf.append("alternateIdOwner").append("=").append(getAlternateIdOwner()).append(" ");
/*     */     }
...
/* 207 */     PartyIdCrossReferencePropertyId id = new PartyIdCrossReferencePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setPartyId(getPartyId());
/* 210 */     id.setAlternateIdOwner(getAlternateIdOwner());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((PartyIdCrossReferencePropertyId)argObjectId).getOrganizationId());
/* 217 */     setPartyId(((PartyIdCrossReferencePropertyId)argObjectId).getPartyId());
/* 218 */     setAlternateIdOwner(((PartyIdCrossReferencePropertyId)argObjectId).getAlternateIdOwner());
/* 219 */     setPropertyCode(((PartyIdCrossReferencePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"PartyIdCrossReferenceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._alternateIdOwner != null) values.put("AlternateIdOwner", DaoUtils.getXmlSafeFieldValue(12, this._alternateIdOwner)); 
...
/* 282 */             setAlternateIdOwner((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setAlternateIdOwner() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\PartyIdCrossReferencePropertyDAO.class
