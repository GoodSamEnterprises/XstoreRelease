...
/*     */ 
/*     */ 
/*     */ public class DatabaseTranslationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 997716491L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DatabaseTranslationPropertyDAO.class);
/*     */   
...
/*  53 */     if (changed(argLocale, this._locale, "locale")) {
/*  54 */       this._locale = (argLocale != null && MANAGE_CASE) ? argLocale.toUpperCase() : argLocale;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getTranslationKey() {
/*  59 */     return this._translationKey;
/*     */   }
/*     */   
/*     */   public void setTranslationKey(String argTranslationKey) {
/*  63 */     if (changed(argTranslationKey, this._translationKey, "translationKey")) {
/*  64 */       this._translationKey = (argTranslationKey != null && MANAGE_CASE) ? argTranslationKey.toUpperCase() : argTranslationKey;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getLocale() != null) {
/* 170 */       buf.append("locale").append("=").append(getLocale()).append(" ");
/*     */     }
/* 172 */     if (getTranslationKey() != null) {
/* 173 */       buf.append("translationKey").append("=").append(getTranslationKey()).append(" ");
/*     */     }
...
/* 207 */     DatabaseTranslationPropertyId id = new DatabaseTranslationPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setLocale(getLocale());
/* 210 */     id.setTranslationKey(getTranslationKey());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((DatabaseTranslationPropertyId)argObjectId).getOrganizationId());
/* 217 */     setLocale(((DatabaseTranslationPropertyId)argObjectId).getLocale());
/* 218 */     setTranslationKey(((DatabaseTranslationPropertyId)argObjectId).getTranslationKey());
/* 219 */     setPropertyCode(((DatabaseTranslationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DatabaseTranslationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._translationKey != null) values.put("TranslationKey", DaoUtils.getXmlSafeFieldValue(12, this._translationKey)); 
...
/* 273 */             setLocale((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setLocale() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "TranslationKey":
...
/* 282 */             setTranslationKey((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setTranslationKey() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\DatabaseTranslationPropertyDAO.class
