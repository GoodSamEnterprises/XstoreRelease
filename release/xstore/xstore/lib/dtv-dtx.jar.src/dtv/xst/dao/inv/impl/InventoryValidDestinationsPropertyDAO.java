...
/*     */ 
/*     */ 
/*     */ public class InventoryValidDestinationsPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 87833434L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryValidDestinationsPropertyDAO.class);
/*     */   
...
/*  62 */     return this._documentTypeCode;
/*     */   }
/*     */   
/*     */   public void setDocumentTypeCode(String argDocumentTypeCode) {
/*  66 */     if (changed(argDocumentTypeCode, this._documentTypeCode, "documentTypeCode")) {
/*  67 */       this._documentTypeCode = (argDocumentTypeCode != null && MANAGE_CASE) ? argDocumentTypeCode.toUpperCase() : argDocumentTypeCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getDocumentSubtypeCode() {
/*  72 */     return this._documentSubtypeCode;
/*     */   }
/*     */   
/*     */   public void setDocumentSubtypeCode(String argDocumentSubtypeCode) {
/*  76 */     if (changed(argDocumentSubtypeCode, this._documentSubtypeCode, "documentSubtypeCode")) {
/*  77 */       this._documentSubtypeCode = (argDocumentSubtypeCode != null && MANAGE_CASE) ? argDocumentSubtypeCode.toUpperCase() : argDocumentSubtypeCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getDestinationTypeEnum() {
/*  82 */     return this._destinationTypeEnum;
/*     */   }
/*     */   
/*     */   public void setDestinationTypeEnum(String argDestinationTypeEnum) {
/*  86 */     if (changed(argDestinationTypeEnum, this._destinationTypeEnum, "destinationTypeEnum")) {
/*  87 */       this._destinationTypeEnum = (argDestinationTypeEnum != null && MANAGE_CASE) ? argDestinationTypeEnum.toUpperCase() : argDestinationTypeEnum;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getDestinationId() {
/*  92 */     return this._destinationId;
/*     */   }
/*     */   
/*     */   public void setDestinationId(String argDestinationId) {
/*  96 */     if (changed(argDestinationId, this._destinationId, "destinationId")) {
/*  97 */       this._destinationId = (argDestinationId != null && MANAGE_CASE) ? argDestinationId.toUpperCase() : argDestinationId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 205 */     if (getDocumentTypeCode() != null) {
/* 206 */       buf.append("documentTypeCode").append("=").append(getDocumentTypeCode()).append(" ");
/*     */     }
/* 208 */     if (getDocumentSubtypeCode() != null) {
/* 209 */       buf.append("documentSubtypeCode").append("=").append(getDocumentSubtypeCode()).append(" ");
/*     */     }
/* 211 */     if (getDestinationTypeEnum() != null) {
/* 212 */       buf.append("destinationTypeEnum").append("=").append(getDestinationTypeEnum()).append(" ");
/*     */     }
/* 214 */     if (getDestinationId() != null) {
/* 215 */       buf.append("destinationId").append("=").append(getDestinationId()).append(" ");
/*     */     }
...
/* 249 */     InventoryValidDestinationsPropertyId id = new InventoryValidDestinationsPropertyId();
/* 250 */     id.setOrganizationId(getOrganizationId());
/* 251 */     id.setRetailLocationId(getRetailLocationId());
/* 252 */     id.setDocumentTypeCode(getDocumentTypeCode());
/* 253 */     id.setDocumentSubtypeCode(getDocumentSubtypeCode());
/* 254 */     id.setDestinationTypeEnum(getDestinationTypeEnum());
/* 255 */     id.setDestinationId(getDestinationId());
/* 256 */     id.setPropertyCode(getPropertyCode());
/* 257 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 261 */     setOrganizationId(((InventoryValidDestinationsPropertyId)argObjectId).getOrganizationId());
/* 262 */     setRetailLocationId(((InventoryValidDestinationsPropertyId)argObjectId).getRetailLocationId());
/* 263 */     setDocumentTypeCode(((InventoryValidDestinationsPropertyId)argObjectId).getDocumentTypeCode());
/* 264 */     setDocumentSubtypeCode(((InventoryValidDestinationsPropertyId)argObjectId).getDocumentSubtypeCode());
/* 265 */     setDestinationTypeEnum(((InventoryValidDestinationsPropertyId)argObjectId).getDestinationTypeEnum());
/* 266 */     setDestinationId(((InventoryValidDestinationsPropertyId)argObjectId).getDestinationId());
/* 267 */     setPropertyCode(((InventoryValidDestinationsPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 276 */     buf.append("<").append("dao").append(" name=\"InventoryValidDestinationsProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 287 */     if (this._documentTypeCode != null) values.put("DocumentTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._documentTypeCode)); 
/* 288 */     if (this._documentSubtypeCode != null) values.put("DocumentSubtypeCode", DaoUtils.getXmlSafeFieldValue(12, this._documentSubtypeCode)); 
/* 289 */     if (this._destinationTypeEnum != null) values.put("DestinationTypeEnum", DaoUtils.getXmlSafeFieldValue(12, this._destinationTypeEnum)); 
/* 290 */     if (this._destinationId != null) values.put("DestinationId", DaoUtils.getXmlSafeFieldValue(12, this._destinationId)); 
...
/* 333 */             setDocumentTypeCode((String)value);
/* 334 */           } catch (Exception ee) {
/* 335 */             throw new DtxException("An exception occurred while calling setDocumentTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 342 */             setDocumentSubtypeCode((String)value);
/* 343 */           } catch (Exception ee) {
/* 344 */             throw new DtxException("An exception occurred while calling setDocumentSubtypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 351 */             setDestinationTypeEnum((String)value);
/* 352 */           } catch (Exception ee) {
/* 353 */             throw new DtxException("An exception occurred while calling setDestinationTypeEnum() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "DestinationId":
...
/* 360 */             setDestinationId((String)value);
/* 361 */           } catch (Exception ee) {
/* 362 */             throw new DtxException("An exception occurred while calling setDestinationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryValidDestinationsPropertyDAO.class
