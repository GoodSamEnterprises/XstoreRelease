...
/*     */ 
/*     */ 
/*     */ public class CustomerModifierPropertyId
...
/*     */   
/*     */   public CustomerModifierPropertyId() {}
/*     */   
/*     */   public CustomerModifierPropertyId(String argObjectIdValue) {
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof CustomerModifierPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     CustomerModifierPropertyId other = (CustomerModifierPropertyId)ob;
/*  86 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  89 */       .equals(other._organizationId))) && ((this._orderId == null && other._orderId == null) || (this._orderId != null && this._orderId
/*     */ 
/*     */       
/*  92 */       .equals(other._orderId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 102 */       .hashCode()) + ((this._orderId == null) ? 0 : this._orderId
...
/* 109 */     return "CustomerModifierProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 118 */       .append("::").append(this._orderId)
/* 119 */       .append("::").append(this._propertyCode)
/* 120 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 124 */     if (this._orderId == null) {
/* 125 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\CustomerModifierPropertyId.class
