...
/*     */ 
/*     */ 
/*     */ public class RefundSchedulePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1947282756L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RefundSchedulePropertyDAO.class);
/*     */   
...
/* 208 */     RefundSchedulePropertyId id = new RefundSchedulePropertyId();
...
/* 217 */     setOrganizationId(((RefundSchedulePropertyId)argObjectId).getOrganizationId());
/* 218 */     setItemId(((RefundSchedulePropertyId)argObjectId).getItemId());
/* 219 */     setEffectiveDate(((RefundSchedulePropertyId)argObjectId).getEffectiveDate());
/* 220 */     setPropertyCode(((RefundSchedulePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 229 */     buf.append("<").append("dao").append(" name=\"RefundScheduleProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 274 */             setItemId((String)value);
/* 275 */           } catch (Exception ee) {
/* 276 */             throw new DtxException("An exception occurred while calling setItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "EffectiveDate":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\RefundSchedulePropertyDAO.class
