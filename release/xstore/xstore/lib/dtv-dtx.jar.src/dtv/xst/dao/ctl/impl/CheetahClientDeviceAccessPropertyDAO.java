...
/*     */ 
/*     */ 
/*     */ public class CheetahClientDeviceAccessPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -436248080L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CheetahClientDeviceAccessPropertyDAO.class);
/*     */   
...
/*  59 */     return this._token;
/*     */   }
/*     */   
/*     */   public void setToken(String argToken) {
/*  63 */     if (changed(argToken, this._token, "token")) {
/*  64 */       this._token = (argToken != null && MANAGE_CASE) ? argToken.toUpperCase() : argToken;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getToken() != null) {
/* 173 */       buf.append("token").append("=").append(getToken()).append(" ");
/*     */     }
...
/* 207 */     CheetahClientDeviceAccessPropertyId id = new CheetahClientDeviceAccessPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setToken(getToken());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((CheetahClientDeviceAccessPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((CheetahClientDeviceAccessPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setToken(((CheetahClientDeviceAccessPropertyId)argObjectId).getToken());
/* 219 */     setPropertyCode(((CheetahClientDeviceAccessPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CheetahClientDeviceAccessProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._token != null) values.put("Token", DaoUtils.getXmlSafeFieldValue(12, this._token)); 
...
/* 282 */             setToken((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setToken() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\CheetahClientDeviceAccessPropertyDAO.class
