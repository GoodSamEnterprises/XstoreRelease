...
/*     */ 
/*     */ 
/*     */ public class WorkCodesPropertyId
...
/*     */   
/*     */   public WorkCodesPropertyId() {}
/*     */   
/*     */   public WorkCodesPropertyId(String argObjectIdValue) {
...
/*  30 */     return this._workCode;
/*     */   }
/*     */   
/*     */   public void setWorkCode(String argWorkCode) {
/*  34 */     this._workCode = (argWorkCode != null && MANAGE_CASE) ? argWorkCode.toUpperCase() : argWorkCode;
/*     */   }
/*     */   
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof WorkCodesPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     WorkCodesPropertyId other = (WorkCodesPropertyId)ob;
/*  86 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  89 */       .equals(other._organizationId))) && ((this._workCode == null && other._workCode == null) || (this._workCode != null && this._workCode
/*     */ 
/*     */       
/*  92 */       .equals(other._workCode))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 102 */       .hashCode()) + ((this._workCode == null) ? 0 : this._workCode
...
/* 118 */       .append("::").append(this._workCode)
/* 119 */       .append("::").append(this._propertyCode)
/* 120 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 124 */     if (this._workCode == null) {
/* 125 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\WorkCodesPropertyId.class
