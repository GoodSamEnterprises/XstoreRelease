...
/*     */ 
/*     */ 
/*     */ public class TenderSignaturePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -693417447L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderSignaturePropertyDAO.class);
/*     */   
...
/* 250 */     TenderSignaturePropertyId id = new TenderSignaturePropertyId();
...
/* 262 */     setOrganizationId(((TenderSignaturePropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((TenderSignaturePropertyId)argObjectId).getRetailLocationId());
/* 264 */     setBusinessDate(((TenderSignaturePropertyId)argObjectId).getBusinessDate());
/* 265 */     setWorkstationId(((TenderSignaturePropertyId)argObjectId).getWorkstationId());
/* 266 */     setTransactionSequence(((TenderSignaturePropertyId)argObjectId).getTransactionSequence());
/* 267 */     setRetailTransactionLineItemSequence(((TenderSignaturePropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 268 */     setPropertyCode(((TenderSignaturePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"TenderSignatureProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\TenderSignaturePropertyDAO.class
