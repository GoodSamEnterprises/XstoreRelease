...
/*     */ 
/*     */ 
/*     */ public class WorkOrderPriceCodePropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -1316909650L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.price_code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_price_code_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND price_code = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.price_code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_price_code_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND price_code = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cwo_price_code_p(organization_id, price_code, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._priceCode, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cwo_price_code_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cwo_price_code_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND price_code = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND price_code = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._priceCode, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new WorkOrderPriceCodePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class WorkOrderPriceCodePropertyFiller
/*     */     implements IFiller {
/*     */     private WorkOrderPriceCodePropertyDBA _parent;
/*     */     
/*     */     public WorkOrderPriceCodePropertyFiller(WorkOrderPriceCodePropertyDBA argParent) {
...
/* 173 */     WorkOrderPriceCodePropertyDAO dao = (WorkOrderPriceCodePropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setPriceCode(this._priceCode);
...
/* 190 */     return loadDAO((IDataAccessObject)new WorkOrderPriceCodePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     WorkOrderPriceCodePropertyDAO dao = (WorkOrderPriceCodePropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._priceCode = dao.getPriceCode();
...
/* 209 */     WorkOrderPriceCodePropertyId id = (WorkOrderPriceCodePropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getPriceCode());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     WorkOrderPriceCodePropertyId id = new WorkOrderPriceCodePropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setPriceCode(this._priceCode);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkOrderPriceCodePropertyDBA.class
