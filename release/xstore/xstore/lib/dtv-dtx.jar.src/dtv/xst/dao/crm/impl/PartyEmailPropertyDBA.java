...
/*     */ 
/*     */ 
/*     */ public class PartyEmailPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.party_id, t.email_sequence, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM crm_party_email_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND party_id = ?  AND email_sequence = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.party_id, t.email_sequence, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM crm_party_email_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND party_id = ?  AND email_sequence = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO crm_party_email_p(organization_id, party_id, email_sequence, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE crm_party_email_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM crm_party_email_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND party_id = ?  AND email_sequence = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND party_id = ?  AND email_sequence = ?  AND property_code = ?  ";
/*     */   }
...
/* 116 */     return new PartyEmailPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class PartyEmailPropertyFiller
/*     */     implements IFiller {
/*     */     private PartyEmailPropertyDBA _parent;
/*     */     
/*     */     public PartyEmailPropertyFiller(PartyEmailPropertyDBA argParent) {
...
/* 189 */     PartyEmailPropertyDAO dao = (PartyEmailPropertyDAO)argDAO;
...
/* 207 */     return loadDAO((IDataAccessObject)new PartyEmailPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 211 */     PartyEmailPropertyDAO dao = (PartyEmailPropertyDAO)argDAO;
...
/* 227 */     PartyEmailPropertyId id = (PartyEmailPropertyId)argId;
...
/* 236 */     PartyEmailPropertyId id = new PartyEmailPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\PartyEmailPropertyDBA.class
