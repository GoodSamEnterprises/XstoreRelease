...
/*     */ 
/*     */ 
/*     */ public class InventoryCountSheetLineItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 119325736L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryCountSheetLineItemPropertyDAO.class);
/*     */   
...
/*  71 */     return this._countSheetNumber;
/*     */   }
/*     */   
/*     */   public void setCountSheetNumber(Integer argCountSheetNumber) {
/*  75 */     if (changed(argCountSheetNumber, this._countSheetNumber, "countSheetNumber")) {
/*  76 */       this._countSheetNumber = argCountSheetNumber;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getLineItemNumber() {
/*  81 */     return this._lineItemNumber;
/*     */   }
/*     */   
/*     */   public void setLineItemNumber(Integer argLineItemNumber) {
/*  85 */     if (changed(argLineItemNumber, this._lineItemNumber, "lineItemNumber")) {
/*  86 */       this._lineItemNumber = argLineItemNumber;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 194 */     if (getInventoryCountId() != null) {
/* 195 */       buf.append("inventoryCountId").append("=").append(getInventoryCountId()).append(" ");
/*     */     }
/* 197 */     if (getCountSheetNumber() != null) {
/* 198 */       buf.append("countSheetNumber").append("=").append(getCountSheetNumber()).append(" ");
/*     */     }
/* 200 */     if (getLineItemNumber() != null) {
/* 201 */       buf.append("lineItemNumber").append("=").append(getLineItemNumber()).append(" ");
/*     */     }
...
/* 235 */     InventoryCountSheetLineItemPropertyId id = new InventoryCountSheetLineItemPropertyId();
/* 236 */     id.setOrganizationId(getOrganizationId());
/* 237 */     id.setRetailLocationId(getRetailLocationId());
/* 238 */     id.setInventoryCountId(getInventoryCountId());
/* 239 */     id.setCountSheetNumber(getCountSheetNumber());
/* 240 */     id.setLineItemNumber(getLineItemNumber());
/* 241 */     id.setPropertyCode(getPropertyCode());
/* 242 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 246 */     setOrganizationId(((InventoryCountSheetLineItemPropertyId)argObjectId).getOrganizationId());
/* 247 */     setRetailLocationId(((InventoryCountSheetLineItemPropertyId)argObjectId).getRetailLocationId());
/* 248 */     setInventoryCountId(((InventoryCountSheetLineItemPropertyId)argObjectId).getInventoryCountId());
/* 249 */     setCountSheetNumber(((InventoryCountSheetLineItemPropertyId)argObjectId).getCountSheetNumber());
/* 250 */     setLineItemNumber(((InventoryCountSheetLineItemPropertyId)argObjectId).getLineItemNumber());
/* 251 */     setPropertyCode(((InventoryCountSheetLineItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"InventoryCountSheetLineItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 271 */     if (this._inventoryCountId != null) values.put("InventoryCountId", DaoUtils.getXmlSafeFieldValue(12, this._inventoryCountId)); 
/* 272 */     if (this._countSheetNumber != null) values.put("CountSheetNumber", DaoUtils.getXmlSafeFieldValue(4, this._countSheetNumber)); 
/* 273 */     if (this._lineItemNumber != null) values.put("LineItemNumber", DaoUtils.getXmlSafeFieldValue(4, this._lineItemNumber)); 
...
/* 316 */             setInventoryCountId((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setInventoryCountId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 325 */             setCountSheetNumber((Integer)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setCountSheetNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "LineItemNumber":
...
/* 334 */             setLineItemNumber((Integer)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setLineItemNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountSheetLineItemPropertyDAO.class
