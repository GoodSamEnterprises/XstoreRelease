...
/*     */ 
/*     */ 
/*     */ public class TransactionNotesPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1876613528L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TransactionNotesPropertyDAO.class);
/*     */   
...
/*  53 */     return this._noteSequence;
/*     */   }
/*     */   
/*     */   public void setNoteSequence(Integer argNoteSequence) {
/*  57 */     if (changed(argNoteSequence, this._noteSequence, "noteSequence")) {
/*  58 */       this._noteSequence = argNoteSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 203 */     if (getNoteSequence() != null) {
/* 204 */       buf.append("noteSequence").append("=").append(getNoteSequence()).append(" ");
/*     */     }
...
/* 250 */     TransactionNotesPropertyId id = new TransactionNotesPropertyId();
/* 251 */     id.setBusinessDate(getBusinessDate());
/* 252 */     id.setNoteSequence(getNoteSequence());
...
/* 262 */     setBusinessDate(((TransactionNotesPropertyId)argObjectId).getBusinessDate());
/* 263 */     setNoteSequence(((TransactionNotesPropertyId)argObjectId).getNoteSequence());
/* 264 */     setOrganizationId(((TransactionNotesPropertyId)argObjectId).getOrganizationId());
/* 265 */     setRetailLocationId(((TransactionNotesPropertyId)argObjectId).getRetailLocationId());
/* 266 */     setTransactionSequence(((TransactionNotesPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setWorkstationId(((TransactionNotesPropertyId)argObjectId).getWorkstationId());
/* 268 */     setPropertyCode(((TransactionNotesPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"TransactionNotesProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 287 */     if (this._noteSequence != null) values.put("NoteSequence", DaoUtils.getXmlSafeFieldValue(4, this._noteSequence)); 
...
/* 325 */             setNoteSequence((Integer)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setNoteSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\TransactionNotesPropertyDAO.class
