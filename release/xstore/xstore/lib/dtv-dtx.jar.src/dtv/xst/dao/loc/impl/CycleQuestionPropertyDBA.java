...
/*     */ 
/*     */ 
/*     */ public class CycleQuestionPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -1158031167L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.question_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_cycle_questions_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND question_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.question_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_cycle_questions_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND question_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO loc_cycle_questions_p(organization_id, question_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._questionId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE loc_cycle_questions_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM loc_cycle_questions_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND question_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND question_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._questionId, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "loc_cycle_questions_p";
/*     */   }
/*     */   
...
/* 115 */     return new CycleQuestionPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class CycleQuestionPropertyFiller
/*     */     implements IFiller {
/*     */     private CycleQuestionPropertyDBA _parent;
/*     */     
/*     */     public CycleQuestionPropertyFiller(CycleQuestionPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._questionId = argResultSet.getString(2);
...
/* 173 */     CycleQuestionPropertyDAO dao = (CycleQuestionPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setQuestionId(this._questionId);
...
/* 190 */     return loadDAO((IDataAccessObject)new CycleQuestionPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     CycleQuestionPropertyDAO dao = (CycleQuestionPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._questionId = dao.getQuestionId();
...
/* 209 */     CycleQuestionPropertyId id = (CycleQuestionPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getQuestionId());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     CycleQuestionPropertyId id = new CycleQuestionPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setQuestionId(this._questionId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\CycleQuestionPropertyDBA.class
