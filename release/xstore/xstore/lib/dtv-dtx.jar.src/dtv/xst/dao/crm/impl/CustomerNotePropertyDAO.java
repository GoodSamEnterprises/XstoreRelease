...
/*     */ 
/*     */ 
/*     */ public class CustomerNotePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1132918011L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerNotePropertyDAO.class);
/*     */   
...
/* 207 */     CustomerNotePropertyId id = new CustomerNotePropertyId();
...
/* 216 */     setOrganizationId(((CustomerNotePropertyId)argObjectId).getOrganizationId());
/* 217 */     setPartyId(((CustomerNotePropertyId)argObjectId).getPartyId());
/* 218 */     setNoteSequence(((CustomerNotePropertyId)argObjectId).getNoteSequence());
/* 219 */     setPropertyCode(((CustomerNotePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CustomerNoteProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\CustomerNotePropertyDAO.class
