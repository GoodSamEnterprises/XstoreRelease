...
/*     */ 
/*     */ 
/*     */ public class SessionWorkstationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -706469470L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SessionWorkstationPropertyDAO.class);
/*     */   
...
/*     */     }
/* 183 */     if (getSessionId() != null) {
/* 184 */       buf.append("sessionId").append("=").append(getSessionId()).append(" ");
/*     */     }
/* 186 */     if (getSessionWorkstationSequenceNbr() != null) {
/* 187 */       buf.append("sessionWorkstationSequenceNbr").append("=").append(getSessionWorkstationSequenceNbr()).append(" ");
/*     */     }
...
/* 221 */     SessionWorkstationPropertyId id = new SessionWorkstationPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setRetailLocationId(getRetailLocationId());
/* 224 */     id.setSessionId(getSessionId());
/* 225 */     id.setSessionWorkstationSequenceNbr(getSessionWorkstationSequenceNbr());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((SessionWorkstationPropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((SessionWorkstationPropertyId)argObjectId).getRetailLocationId());
/* 233 */     setSessionId(((SessionWorkstationPropertyId)argObjectId).getSessionId());
/* 234 */     setSessionWorkstationSequenceNbr(((SessionWorkstationPropertyId)argObjectId).getSessionWorkstationSequenceNbr());
/* 235 */     setPropertyCode(((SessionWorkstationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"SessionWorkstationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._sessionId != null) values.put("SessionId", DaoUtils.getXmlSafeFieldValue(-5, this._sessionId)); 
/* 256 */     if (this._sessionWorkstationSequenceNbr != null) values.put("SessionWorkstationSequenceNbr", DaoUtils.getXmlSafeFieldValue(4, this._sessionWorkstationSequenceNbr)); 
...
/* 299 */             setSessionId((Long)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setSessionId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setSessionWorkstationSequenceNbr((Integer)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setSessionWorkstationSequenceNbr() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\SessionWorkstationPropertyDAO.class
