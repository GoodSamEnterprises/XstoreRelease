...
/*     */ 
/*     */ 
/*     */ public class DealCustomerGroupsPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IDealCustomerGroupsProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new DealCustomerGroupsPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private DealCustomerGroupsPropertyDAO getDAO_() {
/*  44 */     return (DealCustomerGroupsPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     if (setDealId_noev(argDealId) && 
/*  61 */       this._events != null && 
/*  62 */       postEventsForChanges()) {
/*  63 */       this._events.post(IDealCustomerGroupsProperty.SET_DEALID, argDealId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*  72 */     if ((getDAO_().getDealId() == null && argDealId != null) || (
/*  73 */       getDAO_().getDealId() != null && !getDAO_().getDealId().equals(argDealId))) {
/*  74 */       getDAO_().setDealId(argDealId);
/*  75 */       ev_postable = true;
/*     */     } 
/*     */     
...
/* 102 */       this._events.post(IDealCustomerGroupsProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getCustomerGroupId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setCustomerGroupId_noev(argCustomerGroupId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IDealCustomerGroupsProperty.SET_CUSTOMERGROUPID, argCustomerGroupId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getCustomerGroupId() == null && argCustomerGroupId != null) || (
/* 146 */       getDAO_().getCustomerGroupId() != null && !getDAO_().getCustomerGroupId().equals(argCustomerGroupId))) {
/* 147 */       getDAO_().setCustomerGroupId(argCustomerGroupId);
...
/* 170 */       this._events.post(IDealCustomerGroupsProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IDealCustomerGroupsProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IDealCustomerGroupsProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IDealCustomerGroupsProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IDealCustomerGroupsProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IDealCustomerGroupsProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IDealCustomerGroupsProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IDealCustomerGroupsProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IDealCustomerGroupsProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("DealCustomerGroupsPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("DealCustomerGroupsPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealCustomerGroupsPropertyModel.class
