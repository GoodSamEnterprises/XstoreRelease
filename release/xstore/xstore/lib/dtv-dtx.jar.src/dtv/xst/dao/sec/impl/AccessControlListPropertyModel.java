...
/*     */ 
/*     */ 
/*     */ public class AccessControlListPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IAccessControlListProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new AccessControlListPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private AccessControlListPropertyDAO getDAO_() {
/*  44 */     return (AccessControlListPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IAccessControlListProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getSecuredObjectId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setSecuredObjectId_noev(argSecuredObjectId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IAccessControlListProperty.SET_SECUREDOBJECTID, argSecuredObjectId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getSecuredObjectId() == null && argSecuredObjectId != null) || (
/* 112 */       getDAO_().getSecuredObjectId() != null && !getDAO_().getSecuredObjectId().equals(argSecuredObjectId))) {
/* 113 */       getDAO_().setSecuredObjectId(argSecuredObjectId);
...
/* 136 */       this._events.post(IAccessControlListProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 170 */       this._events.post(IAccessControlListProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IAccessControlListProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IAccessControlListProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IAccessControlListProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IAccessControlListProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IAccessControlListProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IAccessControlListProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IAccessControlListProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 429 */     if ("AccessControlListPropertyExtension".equals(argFieldId)) {
...
/* 439 */     if ("AccessControlListPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\AccessControlListPropertyModel.class
