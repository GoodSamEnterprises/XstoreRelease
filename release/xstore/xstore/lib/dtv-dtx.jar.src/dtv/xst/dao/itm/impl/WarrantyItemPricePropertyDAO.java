...
/*     */ 
/*     */ 
/*     */ public class WarrantyItemPricePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1606310959L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WarrantyItemPricePropertyDAO.class);
/*     */   
...
/*  59 */     return this._warrantyPriceSeq;
/*     */   }
/*     */   
/*     */   public void setWarrantyPriceSeq(Long argWarrantyPriceSeq) {
/*  63 */     if (changed(argWarrantyPriceSeq, this._warrantyPriceSeq, "warrantyPriceSeq")) {
/*  64 */       this._warrantyPriceSeq = argWarrantyPriceSeq;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getWarrantyPriceSeq() != null) {
/* 173 */       buf.append("warrantyPriceSeq").append("=").append(getWarrantyPriceSeq()).append(" ");
/*     */     }
...
/* 207 */     WarrantyItemPricePropertyId id = new WarrantyItemPricePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setItemId(getItemId());
/* 210 */     id.setWarrantyPriceSeq(getWarrantyPriceSeq());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((WarrantyItemPricePropertyId)argObjectId).getOrganizationId());
/* 217 */     setItemId(((WarrantyItemPricePropertyId)argObjectId).getItemId());
/* 218 */     setWarrantyPriceSeq(((WarrantyItemPricePropertyId)argObjectId).getWarrantyPriceSeq());
/* 219 */     setPropertyCode(((WarrantyItemPricePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"WarrantyItemPriceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._warrantyPriceSeq != null) values.put("WarrantyPriceSeq", DaoUtils.getXmlSafeFieldValue(-5, this._warrantyPriceSeq)); 
...
/* 282 */             setWarrantyPriceSeq((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setWarrantyPriceSeq() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyItemPricePropertyDAO.class
