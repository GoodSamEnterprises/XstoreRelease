...
/*     */ 
/*     */ 
/*     */ public class RetailTransactionLineItemNotesPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IRetailTransactionLineItemNotesProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new RetailTransactionLineItemNotesPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private RetailTransactionLineItemNotesPropertyDAO getDAO_() {
/*  44 */     return (RetailTransactionLineItemNotesPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 141 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_RETAILTRANSACTIONLINEITEMSEQUENCE, Integer.valueOf(argRetailTransactionLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 281 */     if (getDAO_().getNoteSeq() != null) {
/* 282 */       return getDAO_().getNoteSeq().longValue();
/*     */     }
/*     */     
/* 285 */     return 0L;
/*     */   }
...
/* 294 */     if (setNoteSeq_noev(argNoteSeq) && 
/* 295 */       this._events != null && 
/* 296 */       postEventsForChanges()) {
/* 297 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_NOTESEQ, Long.valueOf(argNoteSeq));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 306 */     if ((getDAO_().getNoteSeq() == null && Long.valueOf(argNoteSeq) != null) || (
/* 307 */       getDAO_().getNoteSeq() != null && !getDAO_().getNoteSeq().equals(Long.valueOf(argNoteSeq)))) {
/* 308 */       getDAO_().setNoteSeq(Long.valueOf(argNoteSeq));
...
/* 331 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(IRetailTransactionLineItemNotesProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("RetailTransactionLineItemNotesPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("RetailTransactionLineItemNotesPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailTransactionLineItemNotesPropertyModel.class
