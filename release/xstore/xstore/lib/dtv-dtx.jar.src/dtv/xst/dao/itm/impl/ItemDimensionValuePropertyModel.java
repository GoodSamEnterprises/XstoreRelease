...
/*     */ 
/*     */ 
/*     */ public class ItemDimensionValuePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IItemDimensionValueProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ItemDimensionValuePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ItemDimensionValuePropertyDAO getDAO_() {
/*  44 */     return (ItemDimensionValuePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IItemDimensionValueProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getDimensionSystem();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setDimensionSystem_noev(argDimensionSystem) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IItemDimensionValueProperty.SET_DIMENSIONSYSTEM, argDimensionSystem);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getDimensionSystem() == null && argDimensionSystem != null) || (
/* 112 */       getDAO_().getDimensionSystem() != null && !getDAO_().getDimensionSystem().equals(argDimensionSystem))) {
/* 113 */       getDAO_().setDimensionSystem(argDimensionSystem);
...
/* 125 */     return getDAO_().getDimension();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setDimension_noev(argDimension) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IItemDimensionValueProperty.SET_DIMENSION, argDimension);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getDimension() == null && argDimension != null) || (
/* 146 */       getDAO_().getDimension() != null && !getDAO_().getDimension().equals(argDimension))) {
/* 147 */       getDAO_().setDimension(argDimension);
...
/* 159 */     return getDAO_().getDimensionValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setDimensionValue_noev(argDimensionValue) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IItemDimensionValueProperty.SET_DIMENSIONVALUE, argDimensionValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getDimensionValue() == null && argDimensionValue != null) || (
/* 180 */       getDAO_().getDimensionValue() != null && !getDAO_().getDimensionValue().equals(argDimensionValue))) {
/* 181 */       getDAO_().setDimensionValue(argDimensionValue);
...
/* 204 */       this._events.post(IItemDimensionValueProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IItemDimensionValueProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IItemDimensionValueProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IItemDimensionValueProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IItemDimensionValueProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IItemDimensionValueProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IItemDimensionValueProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IItemDimensionValueProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IItemDimensionValueProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("ItemDimensionValuePropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("ItemDimensionValuePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemDimensionValuePropertyModel.class
