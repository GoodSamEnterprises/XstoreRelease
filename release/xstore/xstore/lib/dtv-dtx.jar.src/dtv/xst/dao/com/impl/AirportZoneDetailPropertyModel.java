...
/*     */ 
/*     */ 
/*     */ public class AirportZoneDetailPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IAirportZoneDetailProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new AirportZoneDetailPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private AirportZoneDetailPropertyDAO getDAO_() {
/*  44 */     return (AirportZoneDetailPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IAirportZoneDetailProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  99 */     if (setZoneId_noev(argZoneId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IAirportZoneDetailProperty.SET_ZONEID, argZoneId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getZoneId() == null && argZoneId != null) || (
/* 112 */       getDAO_().getZoneId() != null && !getDAO_().getZoneId().equals(argZoneId))) {
/* 113 */       getDAO_().setZoneId(argZoneId);
...
/* 125 */     return getDAO_().getDestinationZoneId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setDestinationZoneId_noev(argDestinationZoneId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IAirportZoneDetailProperty.SET_DESTINATIONZONEID, argDestinationZoneId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getDestinationZoneId() == null && argDestinationZoneId != null) || (
/* 146 */       getDAO_().getDestinationZoneId() != null && !getDAO_().getDestinationZoneId().equals(argDestinationZoneId))) {
/* 147 */       getDAO_().setDestinationZoneId(argDestinationZoneId);
...
/* 170 */       this._events.post(IAirportZoneDetailProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IAirportZoneDetailProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IAirportZoneDetailProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IAirportZoneDetailProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IAirportZoneDetailProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IAirportZoneDetailProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IAirportZoneDetailProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IAirportZoneDetailProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IAirportZoneDetailProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("AirportZoneDetailPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("AirportZoneDetailPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AirportZoneDetailPropertyModel.class
