...
/*     */ 
/*     */ 
/*     */ public class WarrantyModifierPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IWarrantyModifierProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new WarrantyModifierPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private WarrantyModifierPropertyDAO getDAO_() {
/*  44 */     return (WarrantyModifierPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(IWarrantyModifierProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IWarrantyModifierProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 141 */       this._events.post(IWarrantyModifierProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(IWarrantyModifierProperty.SET_RETAILTRANSACTIONLINEITEMSEQUENCE, Integer.valueOf(argRetailTransactionLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(IWarrantyModifierProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(IWarrantyModifierProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 281 */     if (getDAO_().getWarrantyModifierSequence() != null) {
/* 282 */       return getDAO_().getWarrantyModifierSequence().intValue();
/*     */     }
/*     */     
/* 285 */     return 0;
/*     */   }
...
/* 294 */     if (setWarrantyModifierSequence_noev(argWarrantyModifierSequence) && 
/* 295 */       this._events != null && 
/* 296 */       postEventsForChanges()) {
/* 297 */       this._events.post(IWarrantyModifierProperty.SET_WARRANTYMODIFIERSEQUENCE, Integer.valueOf(argWarrantyModifierSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 306 */     if ((getDAO_().getWarrantyModifierSequence() == null && Integer.valueOf(argWarrantyModifierSequence) != null) || (
/* 307 */       getDAO_().getWarrantyModifierSequence() != null && !getDAO_().getWarrantyModifierSequence().equals(Integer.valueOf(argWarrantyModifierSequence)))) {
/* 308 */       getDAO_().setWarrantyModifierSequence(Integer.valueOf(argWarrantyModifierSequence));
...
/* 331 */       this._events.post(IWarrantyModifierProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(IWarrantyModifierProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(IWarrantyModifierProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(IWarrantyModifierProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(IWarrantyModifierProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(IWarrantyModifierProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(IWarrantyModifierProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(IWarrantyModifierProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(IWarrantyModifierProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("WarrantyModifierPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("WarrantyModifierPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\WarrantyModifierPropertyModel.class
