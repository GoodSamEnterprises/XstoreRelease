...
/*     */ 
/*     */ 
/*     */ public class TillControlTransactionDetailPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1566359516L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.trans_seq, t.trans_lineitm_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tsn_till_ctrl_trans_detail_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND trans_lineitm_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  48 */     return "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.trans_seq, t.trans_lineitm_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tsn_till_ctrl_trans_detail_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  54 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND trans_lineitm_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  57 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO tsn_till_ctrl_trans_detail_p(organization_id, rtl_loc_id, wkstn_id, business_date, trans_seq, trans_lineitm_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  68 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, -5, 91, -5, -5, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  71 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  74 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE tsn_till_ctrl_trans_detail_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  90 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM tsn_till_ctrl_trans_detail_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND trans_lineitm_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  99 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND trans_lineitm_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 102 */     return new Object[] { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._transactionSequence, this._transactionLineItemSequence, this._propertyCode };
/*     */   }
/*     */   
/* 105 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { -5, -5, -5, 91, -5, -5, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 108 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 111 */     return "tsn_till_ctrl_trans_detail_p";
/*     */   }
/*     */   
...
/* 119 */     return new TillControlTransactionDetailPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TillControlTransactionDetailPropertyFiller
/*     */     implements IFiller {
/*     */     private TillControlTransactionDetailPropertyDBA _parent;
/*     */     
/*     */     public TillControlTransactionDetailPropertyFiller(TillControlTransactionDetailPropertyDBA argParent) {
...
/* 217 */     TillControlTransactionDetailPropertyDAO dao = (TillControlTransactionDetailPropertyDAO)argDAO;
...
/* 223 */     dao.setTransactionLineItemSequence(this._transactionLineItemSequence);
...
/* 238 */     return loadDAO((IDataAccessObject)new TillControlTransactionDetailPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 242 */     TillControlTransactionDetailPropertyDAO dao = (TillControlTransactionDetailPropertyDAO)argDAO;
...
/* 248 */     this._transactionLineItemSequence = dao.getTransactionLineItemSequence();
...
/* 261 */     TillControlTransactionDetailPropertyId id = (TillControlTransactionDetailPropertyId)argId;
...
/* 267 */     argStatement.setLong(6, id.getTransactionLineItemSequence().longValue());
/* 268 */     argStatement.setString(7, id.getPropertyCode());
/* 269 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 273 */     TillControlTransactionDetailPropertyId id = new TillControlTransactionDetailPropertyId();
...
/* 279 */     id.setTransactionLineItemSequence(this._transactionLineItemSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TillControlTransactionDetailPropertyDBA.class
