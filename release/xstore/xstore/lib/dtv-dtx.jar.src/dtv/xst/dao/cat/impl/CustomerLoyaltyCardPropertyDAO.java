...
/*     */ 
/*     */ 
/*     */ public class CustomerLoyaltyCardPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -982563955L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerLoyaltyCardPropertyDAO.class);
/*     */   
...
/*  48 */     return this._cardNumber;
/*     */   }
/*     */   
/*     */   public void setCardNumber(String argCardNumber) {
/*  52 */     if (changed(argCardNumber, this._cardNumber, "cardNumber")) {
/*  53 */       this._cardNumber = (argCardNumber != null && MANAGE_CASE) ? argCardNumber.toUpperCase() : argCardNumber;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getCardNumber() != null) {
/* 159 */       buf.append("cardNumber").append("=").append(getCardNumber()).append(" ");
/*     */     }
...
/* 193 */     CustomerLoyaltyCardPropertyId id = new CustomerLoyaltyCardPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setCardNumber(getCardNumber());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((CustomerLoyaltyCardPropertyId)argObjectId).getOrganizationId());
/* 202 */     setCardNumber(((CustomerLoyaltyCardPropertyId)argObjectId).getCardNumber());
/* 203 */     setPropertyCode(((CustomerLoyaltyCardPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"CustomerLoyaltyCardProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._cardNumber != null) values.put("CardNumber", DaoUtils.getXmlSafeFieldValue(12, this._cardNumber)); 
...
/* 256 */             setCardNumber((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setCardNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerLoyaltyCardPropertyDAO.class
