...
/*     */ 
/*     */ 
/*     */ public class TransactionPropertyPromptPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -371413780L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TransactionPropertyPromptPropertyDAO.class);
/*     */   
...
/*  49 */     return this._promptPropertyCode;
/*     */   }
/*     */   
/*     */   public void setPromptPropertyCode(String argPromptPropertyCode) {
/*  53 */     if (changed(argPromptPropertyCode, this._promptPropertyCode, "promptPropertyCode")) {
/*  54 */       this._promptPropertyCode = (argPromptPropertyCode != null && MANAGE_CASE) ? argPromptPropertyCode.toUpperCase() : argPromptPropertyCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 170 */     if (getPromptPropertyCode() != null) {
/* 171 */       buf.append("promptPropertyCode").append("=").append(getPromptPropertyCode()).append(" ");
/*     */     }
...
/* 208 */     TransactionPropertyPromptPropertyId id = new TransactionPropertyPromptPropertyId();
...
/* 217 */     setOrganizationId(((TransactionPropertyPromptPropertyId)argObjectId).getOrganizationId());
/* 218 */     setPromptPropertyCode(((TransactionPropertyPromptPropertyId)argObjectId).getPromptPropertyCode());
/* 219 */     setEffectiveDate(((TransactionPropertyPromptPropertyId)argObjectId).getEffectiveDate());
/* 220 */     setPropertyCode(((TransactionPropertyPromptPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 229 */     buf.append("<").append("dao").append(" name=\"TransactionPropertyPromptProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 274 */             setPromptPropertyCode((String)value);
/* 275 */           } catch (Exception ee) {
/* 276 */             throw new DtxException("An exception occurred while calling setPromptPropertyCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "EffectiveDate":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\TransactionPropertyPromptPropertyDAO.class
