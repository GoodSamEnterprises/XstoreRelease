...
/*     */ 
/*     */ 
/*     */ public class TenderTypePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1169466301L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderTypePropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getTenderTypecode() != null) {
/* 159 */       buf.append("tenderTypecode").append("=").append(getTenderTypecode()).append(" ");
/*     */     }
...
/* 193 */     TenderTypePropertyId id = new TenderTypePropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setTenderTypecode(getTenderTypecode());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((TenderTypePropertyId)argObjectId).getOrganizationId());
/* 202 */     setTenderTypecode(((TenderTypePropertyId)argObjectId).getTenderTypecode());
/* 203 */     setPropertyCode(((TenderTypePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"TenderTypeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._tenderTypecode != null) values.put("TenderTypecode", DaoUtils.getXmlSafeFieldValue(12, this._tenderTypecode)); 
...
/* 256 */             setTenderTypecode((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setTenderTypecode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderTypePropertyDAO.class
