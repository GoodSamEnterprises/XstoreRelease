...
/*     */ 
/*     */ 
/*     */ public class CheetahClientDeviceAccessPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ICheetahClientDeviceAccessProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new CheetahClientDeviceAccessPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private CheetahClientDeviceAccessPropertyDAO getDAO_() {
/*  44 */     return (CheetahClientDeviceAccessPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 138 */     if (setToken_noev(argToken) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_TOKEN, argToken);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getToken() == null && argToken != null) || (
/* 151 */       getDAO_().getToken() != null && !getDAO_().getToken().equals(argToken))) {
/* 152 */       getDAO_().setToken(argToken);
...
/* 175 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(ICheetahClientDeviceAccessProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 468 */     if ("CheetahClientDeviceAccessPropertyExtension".equals(argFieldId)) {
...
/* 478 */     if ("CheetahClientDeviceAccessPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\CheetahClientDeviceAccessPropertyModel.class
