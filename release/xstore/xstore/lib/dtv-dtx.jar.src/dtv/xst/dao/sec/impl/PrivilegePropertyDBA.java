...
/*     */ 
/*     */ 
/*     */ public class PrivilegePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.privilege_type, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM sec_privilege_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND privilege_type = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.privilege_type, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM sec_privilege_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND privilege_type = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO sec_privilege_p(organization_id, privilege_type, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._privilegeType, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE sec_privilege_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM sec_privilege_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND privilege_type = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND privilege_type = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._privilegeType, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new PrivilegePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class PrivilegePropertyFiller
/*     */     implements IFiller {
/*     */     private PrivilegePropertyDBA _parent;
/*     */     
/*     */     public PrivilegePropertyFiller(PrivilegePropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._privilegeType = argResultSet.getString(2);
...
/* 173 */     PrivilegePropertyDAO dao = (PrivilegePropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setPrivilegeType(this._privilegeType);
...
/* 190 */     return loadDAO((IDataAccessObject)new PrivilegePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     PrivilegePropertyDAO dao = (PrivilegePropertyDAO)argDAO;
...
/* 209 */     PrivilegePropertyId id = (PrivilegePropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getPrivilegeType());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     PrivilegePropertyId id = new PrivilegePropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setPrivilegeType(this._privilegeType);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\PrivilegePropertyDBA.class
