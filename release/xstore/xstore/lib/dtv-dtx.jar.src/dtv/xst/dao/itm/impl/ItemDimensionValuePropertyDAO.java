...
/*     */ 
/*     */ 
/*     */ public class ItemDimensionValuePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 507768243L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemDimensionValuePropertyDAO.class);
/*     */   
...
/*  70 */     return this._dimensionValue;
/*     */   }
/*     */   
/*     */   public void setDimensionValue(String argDimensionValue) {
/*  74 */     if (changed(argDimensionValue, this._dimensionValue, "dimensionValue")) {
/*  75 */       this._dimensionValue = (argDimensionValue != null && MANAGE_CASE) ? argDimensionValue.toUpperCase() : argDimensionValue;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getDimensionSystem() != null) {
/* 181 */       buf.append("dimensionSystem").append("=").append(getDimensionSystem()).append(" ");
/*     */     }
/* 183 */     if (getDimension() != null) {
/* 184 */       buf.append("dimension").append("=").append(getDimension()).append(" ");
/*     */     }
/* 186 */     if (getDimensionValue() != null) {
/* 187 */       buf.append("dimensionValue").append("=").append(getDimensionValue()).append(" ");
/*     */     }
...
/* 221 */     ItemDimensionValuePropertyId id = new ItemDimensionValuePropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setDimensionSystem(getDimensionSystem());
/* 224 */     id.setDimension(getDimension());
/* 225 */     id.setDimensionValue(getDimensionValue());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((ItemDimensionValuePropertyId)argObjectId).getOrganizationId());
/* 232 */     setDimensionSystem(((ItemDimensionValuePropertyId)argObjectId).getDimensionSystem());
/* 233 */     setDimension(((ItemDimensionValuePropertyId)argObjectId).getDimension());
/* 234 */     setDimensionValue(((ItemDimensionValuePropertyId)argObjectId).getDimensionValue());
/* 235 */     setPropertyCode(((ItemDimensionValuePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"ItemDimensionValueProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._dimensionSystem != null) values.put("DimensionSystem", DaoUtils.getXmlSafeFieldValue(12, this._dimensionSystem)); 
/* 255 */     if (this._dimension != null) values.put("Dimension", DaoUtils.getXmlSafeFieldValue(12, this._dimension)); 
/* 256 */     if (this._dimensionValue != null) values.put("DimensionValue", DaoUtils.getXmlSafeFieldValue(12, this._dimensionValue)); 
...
/* 290 */             setDimensionSystem((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setDimensionSystem() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "Dimension":
...
/* 299 */             setDimension((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setDimension() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "DimensionValue":
...
/* 308 */             setDimensionValue((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setDimensionValue() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemDimensionValuePropertyDAO.class
