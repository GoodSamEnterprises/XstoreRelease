...
/*     */ 
/*     */ 
/*     */ public class XunitResultItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 419773889L;
/*  23 */   private static final Logger _logger = Logger.getLogger(XunitResultItemPropertyDAO.class);
/*     */   
...
/*  50 */     return this._hostname;
/*     */   }
/*     */   
/*     */   public void setHostname(String argHostname) {
/*  54 */     if (changed(argHostname, this._hostname, "hostname")) {
/*  55 */       this._hostname = (argHostname != null && MANAGE_CASE) ? argHostname.toUpperCase() : argHostname;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getResultTimestamp() {
/*  60 */     return this._resultTimestamp;
/*     */   }
/*     */   
/*     */   public void setResultTimestamp(Long argResultTimestamp) {
/*  64 */     if (changed(argResultTimestamp, this._resultTimestamp, "resultTimestamp")) {
/*  65 */       this._resultTimestamp = argResultTimestamp;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getResultItemSequence() {
/*  70 */     return this._resultItemSequence;
/*     */   }
/*     */   
/*     */   public void setResultItemSequence(Long argResultItemSequence) {
/*  74 */     if (changed(argResultItemSequence, this._resultItemSequence, "resultItemSequence")) {
/*  75 */       this._resultItemSequence = argResultItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getHostname() != null) {
/* 181 */       buf.append("hostname").append("=").append(getHostname()).append(" ");
/*     */     }
/* 183 */     if (getResultTimestamp() != null) {
/* 184 */       buf.append("resultTimestamp").append("=").append(getResultTimestamp()).append(" ");
/*     */     }
/* 186 */     if (getResultItemSequence() != null) {
/* 187 */       buf.append("resultItemSequence").append("=").append(getResultItemSequence()).append(" ");
/*     */     }
...
/* 221 */     XunitResultItemPropertyId id = new XunitResultItemPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setHostname(getHostname());
/* 224 */     id.setResultTimestamp(getResultTimestamp());
/* 225 */     id.setResultItemSequence(getResultItemSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((XunitResultItemPropertyId)argObjectId).getOrganizationId());
/* 232 */     setHostname(((XunitResultItemPropertyId)argObjectId).getHostname());
/* 233 */     setResultTimestamp(((XunitResultItemPropertyId)argObjectId).getResultTimestamp());
/* 234 */     setResultItemSequence(((XunitResultItemPropertyId)argObjectId).getResultItemSequence());
/* 235 */     setPropertyCode(((XunitResultItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"XunitResultItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._hostname != null) values.put("Hostname", DaoUtils.getXmlSafeFieldValue(12, this._hostname)); 
/* 255 */     if (this._resultTimestamp != null) values.put("ResultTimestamp", DaoUtils.getXmlSafeFieldValue(-5, this._resultTimestamp)); 
/* 256 */     if (this._resultItemSequence != null) values.put("ResultItemSequence", DaoUtils.getXmlSafeFieldValue(-5, this._resultItemSequence)); 
...
/* 290 */             setHostname((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setHostname() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 299 */             setResultTimestamp((Long)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setResultTimestamp() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setResultItemSequence((Long)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setResultItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\_test\impl\XunitResultItemPropertyDAO.class
