...
/*     */ 
/*     */ 
/*     */ public class InventoryCostItemYearEndPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1914832425L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryCostItemYearEndPropertyDAO.class);
/*     */   
...
/*  50 */     return this._fiscalYear;
/*     */   }
/*     */   
/*     */   public void setFiscalYear(Integer argFiscalYear) {
/*  54 */     if (changed(argFiscalYear, this._fiscalYear, "fiscalYear")) {
/*  55 */       this._fiscalYear = argFiscalYear;
/*     */     }
/*     */   }
/*     */   
...
/*  70 */     return this._itemId;
/*     */   }
/*     */   
/*     */   public void setItemId(String argItemId) {
/*  74 */     if (changed(argItemId, this._itemId, "itemId")) {
/*  75 */       this._itemId = (argItemId != null && MANAGE_CASE) ? argItemId.toUpperCase() : argItemId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getFiscalYear() != null) {
/* 181 */       buf.append("fiscalYear").append("=").append(getFiscalYear()).append(" ");
/*     */     }
/* 183 */     if (getRetailLocationId() != null) {
/* 184 */       buf.append("retailLocationId").append("=").append(getRetailLocationId()).append(" ");
/*     */     }
/* 186 */     if (getItemId() != null) {
/* 187 */       buf.append("itemId").append("=").append(getItemId()).append(" ");
/*     */     }
...
/* 221 */     InventoryCostItemYearEndPropertyId id = new InventoryCostItemYearEndPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setFiscalYear(getFiscalYear());
/* 224 */     id.setRetailLocationId(getRetailLocationId());
/* 225 */     id.setItemId(getItemId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((InventoryCostItemYearEndPropertyId)argObjectId).getOrganizationId());
/* 232 */     setFiscalYear(((InventoryCostItemYearEndPropertyId)argObjectId).getFiscalYear());
/* 233 */     setRetailLocationId(((InventoryCostItemYearEndPropertyId)argObjectId).getRetailLocationId());
/* 234 */     setItemId(((InventoryCostItemYearEndPropertyId)argObjectId).getItemId());
/* 235 */     setPropertyCode(((InventoryCostItemYearEndPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"InventoryCostItemYearEndProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._fiscalYear != null) values.put("FiscalYear", DaoUtils.getXmlSafeFieldValue(4, this._fiscalYear)); 
/* 255 */     if (this._retailLocationId != null) values.put("RetailLocationId", DaoUtils.getXmlSafeFieldValue(-5, this._retailLocationId)); 
/* 256 */     if (this._itemId != null) values.put("ItemId", DaoUtils.getXmlSafeFieldValue(12, this._itemId)); 
...
/* 290 */             setFiscalYear((Integer)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setFiscalYear() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 310 */             throw new DtxException("An exception occurred while calling setItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCostItemYearEndPropertyDAO.class
