...
/*     */ 
/*     */ 
/*     */ public class InventorySummaryCountTransactionDetailId
...
/*     */   
/*     */   public InventorySummaryCountTransactionDetailId() {}
/*     */   
/*     */   public InventorySummaryCountTransactionDetailId(String argObjectIdValue) {
...
/*  68 */     return this._transLineSequence;
/*     */   }
/*     */   
/*     */   public void setTransLineSequence(Integer argTransLineSequence) {
/*  72 */     this._transLineSequence = argTransLineSequence;
/*     */   }
/*     */   
...
/* 103 */       str = tokens[5];
/*     */       
/* 105 */       setTransLineSequence(Integer.valueOf(str));
/*     */     }
...
/* 115 */       return true;
/*     */     }
/* 117 */     if (!(ob instanceof InventorySummaryCountTransactionDetailId)) {
/* 118 */       return false;
/*     */     }
/* 120 */     InventorySummaryCountTransactionDetailId other = (InventorySummaryCountTransactionDetailId)ob;
...
/*     */ 
/*     */       
/* 136 */       .equals(other._transactionSequence))) && ((this._transLineSequence == null && other._transLineSequence == null) || (this._transLineSequence != null && this._transLineSequence
/*     */ 
/*     */       
/* 139 */       .equals(other._transLineSequence))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 150 */       .hashCode()) + ((this._transLineSequence == null) ? 0 : this._transLineSequence
/* 151 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getDtxTypeName() {
/* 156 */     return "InventorySummaryCountTransactionDetail";
/*     */   }
/*     */ 
/*     */   
...
/* 169 */       .append("::").append(String.valueOf(this._transLineSequence))
/* 170 */       .toString();
/*     */   }
/*     */   
...
/* 184 */       return false;
/*     */     }
/* 186 */     if (this._transLineSequence == null) {
/* 187 */       return false;
/*     */     }
/* 189 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\InventorySummaryCountTransactionDetailId.class
