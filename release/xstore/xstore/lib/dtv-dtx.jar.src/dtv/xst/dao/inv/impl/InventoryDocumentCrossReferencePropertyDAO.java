...
/*     */ 
/*     */ 
/*     */ public class InventoryDocumentCrossReferencePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -154660553L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryDocumentCrossReferencePropertyDAO.class);
/*     */   
...
/*     */     }
/* 191 */     if (getDocumentId() != null) {
/* 192 */       buf.append("documentId").append("=").append(getDocumentId()).append(" ");
/*     */     }
...
/* 235 */     InventoryDocumentCrossReferencePropertyId id = new InventoryDocumentCrossReferencePropertyId();
...
/* 246 */     setOrganizationId(((InventoryDocumentCrossReferencePropertyId)argObjectId).getOrganizationId());
/* 247 */     setDocumentId(((InventoryDocumentCrossReferencePropertyId)argObjectId).getDocumentId());
/* 248 */     setInventoryDocumentLineNumber(((InventoryDocumentCrossReferencePropertyId)argObjectId).getInventoryDocumentLineNumber());
/* 249 */     setDocumentTypeCode(((InventoryDocumentCrossReferencePropertyId)argObjectId).getDocumentTypeCode());
/* 250 */     setRetailLocationId(((InventoryDocumentCrossReferencePropertyId)argObjectId).getRetailLocationId());
/* 251 */     setPropertyCode(((InventoryDocumentCrossReferencePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"InventoryDocumentCrossReferenceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 307 */             setDocumentId((String)value);
/* 308 */           } catch (Exception ee) {
/* 309 */             throw new DtxException("An exception occurred while calling setDocumentId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryDocumentCrossReferencePropertyDAO.class
