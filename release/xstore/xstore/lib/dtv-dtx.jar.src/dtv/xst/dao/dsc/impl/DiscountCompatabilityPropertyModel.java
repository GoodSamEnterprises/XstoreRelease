...
/*     */ 
/*     */ 
/*     */ public class DiscountCompatabilityPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IDiscountCompatabilityProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new DiscountCompatabilityPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private DiscountCompatabilityPropertyDAO getDAO_() {
/*  44 */     return (DiscountCompatabilityPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  52 */     return getDAO_().getCompatibleDiscountCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     if (setCompatibleDiscountCode_noev(argCompatibleDiscountCode) && 
/*  61 */       this._events != null && 
/*  62 */       postEventsForChanges()) {
/*  63 */       this._events.post(IDiscountCompatabilityProperty.SET_COMPATIBLEDISCOUNTCODE, argCompatibleDiscountCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*  72 */     if ((getDAO_().getCompatibleDiscountCode() == null && argCompatibleDiscountCode != null) || (
/*  73 */       getDAO_().getCompatibleDiscountCode() != null && !getDAO_().getCompatibleDiscountCode().equals(argCompatibleDiscountCode))) {
/*  74 */       getDAO_().setCompatibleDiscountCode(argCompatibleDiscountCode);
/*  75 */       ev_postable = true;
/*     */     } 
/*     */     
...
/* 102 */       this._events.post(IDiscountCompatabilityProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getPrimaryDiscountCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setPrimaryDiscountCode_noev(argPrimaryDiscountCode) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IDiscountCompatabilityProperty.SET_PRIMARYDISCOUNTCODE, argPrimaryDiscountCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getPrimaryDiscountCode() == null && argPrimaryDiscountCode != null) || (
/* 146 */       getDAO_().getPrimaryDiscountCode() != null && !getDAO_().getPrimaryDiscountCode().equals(argPrimaryDiscountCode))) {
/* 147 */       getDAO_().setPrimaryDiscountCode(argPrimaryDiscountCode);
...
/* 170 */       this._events.post(IDiscountCompatabilityProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IDiscountCompatabilityProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IDiscountCompatabilityProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IDiscountCompatabilityProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IDiscountCompatabilityProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IDiscountCompatabilityProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IDiscountCompatabilityProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IDiscountCompatabilityProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IDiscountCompatabilityProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("DiscountCompatabilityPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("DiscountCompatabilityPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountCompatabilityPropertyModel.class
