...
/*     */ 
/*     */ 
/*     */ public class ItemDealPropertyPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -940445911L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemDealPropertyPropertyDAO.class);
/*     */   
...
/*  60 */     return this._itemDealPropertyCode;
/*     */   }
/*     */   
/*     */   public void setItemDealPropertyCode(String argItemDealPropertyCode) {
/*  64 */     if (changed(argItemDealPropertyCode, this._itemDealPropertyCode, "itemDealPropertyCode")) {
/*  65 */       this._itemDealPropertyCode = (argItemDealPropertyCode != null && MANAGE_CASE) ? argItemDealPropertyCode.toUpperCase() : argItemDealPropertyCode;
/*     */     }
/*     */   }
/*     */   
...
/*  74 */     if (changed(argEffectiveDate, this._effectiveDate, "effectiveDate")) {
...
/*     */     }
/* 184 */     if (getItemDealPropertyCode() != null) {
/* 185 */       buf.append("itemDealPropertyCode").append("=").append(getItemDealPropertyCode()).append(" ");
/*     */     }
/* 187 */     if (getEffectiveDate() != null) {
/* 188 */       buf.append("effectiveDate").append("=").append(getEffectiveDate()).append(" ");
/*     */     }
...
/* 222 */     ItemDealPropertyPropertyId id = new ItemDealPropertyPropertyId();
/* 223 */     id.setOrganizationId(getOrganizationId());
/* 224 */     id.setItemId(getItemId());
/* 225 */     id.setItemDealPropertyCode(getItemDealPropertyCode());
/* 226 */     id.setEffectiveDate(getEffectiveDate());
/* 227 */     id.setPropertyCode(getPropertyCode());
/* 228 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 232 */     setOrganizationId(((ItemDealPropertyPropertyId)argObjectId).getOrganizationId());
/* 233 */     setItemId(((ItemDealPropertyPropertyId)argObjectId).getItemId());
/* 234 */     setItemDealPropertyCode(((ItemDealPropertyPropertyId)argObjectId).getItemDealPropertyCode());
/* 235 */     setEffectiveDate(((ItemDealPropertyPropertyId)argObjectId).getEffectiveDate());
/* 236 */     setPropertyCode(((ItemDealPropertyPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 245 */     buf.append("<").append("dao").append(" name=\"ItemDealPropertyProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._itemId != null) values.put("ItemId", DaoUtils.getXmlSafeFieldValue(12, this._itemId)); 
/* 256 */     if (this._itemDealPropertyCode != null) values.put("ItemDealPropertyCode", DaoUtils.getXmlSafeFieldValue(12, this._itemDealPropertyCode)); 
/* 257 */     if (this._effectiveDate != null) values.put("EffectiveDate", DaoUtils.getXmlSafeFieldValue(91, this._effectiveDate)); 
...
/* 291 */             setItemId((String)value);
/* 292 */           } catch (Exception ee) {
/* 293 */             throw new DtxException("An exception occurred while calling setItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 300 */             setItemDealPropertyCode((String)value);
/* 301 */           } catch (Exception ee) {
/* 302 */             throw new DtxException("An exception occurred while calling setItemDealPropertyCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "EffectiveDate":
...
/* 309 */             setEffectiveDate((Date)value);
/* 310 */           } catch (Exception ee) {
/* 311 */             throw new DtxException("An exception occurred while calling setEffectiveDate() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemDealPropertyPropertyDAO.class
