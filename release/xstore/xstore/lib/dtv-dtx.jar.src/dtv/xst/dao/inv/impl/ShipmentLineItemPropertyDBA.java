...
/*     */ 
/*     */ 
/*     */ public class ShipmentLineItemPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1032721910L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.invctl_document_id, t.document_typcode, t.shipment_seq, t.lineitm_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_shipment_lines_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND invctl_document_id = ?  AND document_typcode = ?  AND shipment_seq = ?  AND lineitm_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  48 */     return "SELECT t.organization_id, t.rtl_loc_id, t.invctl_document_id, t.document_typcode, t.shipment_seq, t.lineitm_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_shipment_lines_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  54 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND invctl_document_id = ?  AND document_typcode = ?  AND shipment_seq = ?  AND lineitm_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  57 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO inv_shipment_lines_p(organization_id, rtl_loc_id, invctl_document_id, document_typcode, shipment_seq, lineitm_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  64 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._documentId, this._documentTypeCode, this._shipmentSequence, this._lineItemSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  65 */     return insertParameterObject;
/*     */   }
/*     */   
/*  68 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, 12, 12, 4, 4, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  71 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  74 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE inv_shipment_lines_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  90 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM inv_shipment_lines_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND invctl_document_id = ?  AND document_typcode = ?  AND shipment_seq = ?  AND lineitm_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  99 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND invctl_document_id = ?  AND document_typcode = ?  AND shipment_seq = ?  AND lineitm_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 102 */     return new Object[] { this._organizationId, this._retailLocationId, this._documentId, this._documentTypeCode, this._shipmentSequence, this._lineItemSequence, this._propertyCode };
/*     */   }
/*     */   
/* 105 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { -5, -5, 12, 12, 4, 4, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 108 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 111 */     return "inv_shipment_lines_p";
/*     */   }
/*     */   
...
/* 119 */     return new ShipmentLineItemPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ShipmentLineItemPropertyFiller
/*     */     implements IFiller {
/*     */     private ShipmentLineItemPropertyDBA _parent;
/*     */     
/*     */     public ShipmentLineItemPropertyFiller(ShipmentLineItemPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 150 */       int primitiveResult = argResultSet.getInt(5);
/* 151 */       if (primitiveResult != 0 || argResultSet.getObject(5) != null) {
/* 152 */         this._parent._shipmentSequence = Integer.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 158 */       primitiveResult = argResultSet.getInt(6);
/* 159 */       if (primitiveResult != 0 || argResultSet.getObject(6) != null) {
/* 160 */         this._parent._lineItemSequence = Integer.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 202 */     ShipmentLineItemPropertyDAO dao = (ShipmentLineItemPropertyDAO)argDAO;
...
/* 207 */     dao.setShipmentSequence(this._shipmentSequence);
...
/* 223 */     return loadDAO((IDataAccessObject)new ShipmentLineItemPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 227 */     ShipmentLineItemPropertyDAO dao = (ShipmentLineItemPropertyDAO)argDAO;
...
/* 232 */     this._shipmentSequence = dao.getShipmentSequence();
/* 233 */     this._lineItemSequence = dao.getLineItemSequence();
...
/* 246 */     ShipmentLineItemPropertyId id = (ShipmentLineItemPropertyId)argId;
...
/* 251 */     argStatement.setInt(5, id.getShipmentSequence().intValue());
/* 252 */     argStatement.setInt(6, id.getLineItemSequence().intValue());
/* 253 */     argStatement.setString(7, id.getPropertyCode());
/* 254 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 258 */     ShipmentLineItemPropertyId id = new ShipmentLineItemPropertyId();
...
/* 263 */     id.setShipmentSequence(this._shipmentSequence);
/* 264 */     id.setLineItemSequence(this._lineItemSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\ShipmentLineItemPropertyDBA.class
