...
/*     */ 
/*     */ 
/*     */ public class TenderDenominationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 471151086L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderDenominationPropertyDAO.class);
/*     */   
...
/*  39 */     return this._denominationId;
/*     */   }
/*     */   
/*     */   public void setDenominationId(String argDenominationId) {
/*  43 */     if (changed(argDenominationId, this._denominationId, "denominationId")) {
/*  44 */       this._denominationId = (argDenominationId != null && MANAGE_CASE) ? argDenominationId.toUpperCase() : argDenominationId;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getDenominationId() != null) {
/* 167 */       buf.append("denominationId").append("=").append(getDenominationId()).append(" ");
/*     */     }
...
/* 207 */     TenderDenominationPropertyId id = new TenderDenominationPropertyId();
/* 208 */     id.setDenominationId(getDenominationId());
...
/* 216 */     setDenominationId(((TenderDenominationPropertyId)argObjectId).getDenominationId());
/* 217 */     setOrganizationId(((TenderDenominationPropertyId)argObjectId).getOrganizationId());
/* 218 */     setTenderId(((TenderDenominationPropertyId)argObjectId).getTenderId());
/* 219 */     setPropertyCode(((TenderDenominationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"TenderDenominationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._denominationId != null) values.put("DenominationId", DaoUtils.getXmlSafeFieldValue(12, this._denominationId)); 
...
/* 264 */             setDenominationId((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setDenominationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderDenominationPropertyDAO.class
