...
/*     */ 
/*     */ 
/*     */ public class CustomerLoyaltyAccountPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1632291738L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerLoyaltyAccountPropertyDAO.class);
/*     */   
...
/*  49 */     return this._cardNumber;
/*     */   }
/*     */   
/*     */   public void setCardNumber(String argCardNumber) {
/*  53 */     if (changed(argCardNumber, this._cardNumber, "cardNumber")) {
/*  54 */       this._cardNumber = (argCardNumber != null && MANAGE_CASE) ? argCardNumber.toUpperCase() : argCardNumber;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getAccountId() {
/*  59 */     return this._accountId;
/*     */   }
/*     */   
/*     */   public void setAccountId(String argAccountId) {
/*  63 */     if (changed(argAccountId, this._accountId, "accountId")) {
/*  64 */       this._accountId = (argAccountId != null && MANAGE_CASE) ? argAccountId.toUpperCase() : argAccountId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getCardNumber() != null) {
/* 170 */       buf.append("cardNumber").append("=").append(getCardNumber()).append(" ");
/*     */     }
/* 172 */     if (getAccountId() != null) {
/* 173 */       buf.append("accountId").append("=").append(getAccountId()).append(" ");
/*     */     }
...
/* 207 */     CustomerLoyaltyAccountPropertyId id = new CustomerLoyaltyAccountPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setCardNumber(getCardNumber());
/* 210 */     id.setAccountId(getAccountId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((CustomerLoyaltyAccountPropertyId)argObjectId).getOrganizationId());
/* 217 */     setCardNumber(((CustomerLoyaltyAccountPropertyId)argObjectId).getCardNumber());
/* 218 */     setAccountId(((CustomerLoyaltyAccountPropertyId)argObjectId).getAccountId());
/* 219 */     setPropertyCode(((CustomerLoyaltyAccountPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CustomerLoyaltyAccountProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._cardNumber != null) values.put("CardNumber", DaoUtils.getXmlSafeFieldValue(12, this._cardNumber)); 
/* 239 */     if (this._accountId != null) values.put("AccountId", DaoUtils.getXmlSafeFieldValue(12, this._accountId)); 
...
/* 273 */             setCardNumber((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setCardNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "AccountId":
...
/* 282 */             setAccountId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setAccountId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerLoyaltyAccountPropertyDAO.class
