...
/*     */ 
/*     */ 
/*     */ public class OrganizerPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -588016124L;
/*  23 */   private static final Logger _logger = Logger.getLogger(OrganizerPropertyDAO.class);
/*     */   
...
/*  50 */     return this._reportName;
/*     */   }
/*     */   
/*     */   public void setReportName(String argReportName) {
/*  54 */     if (changed(argReportName, this._reportName, "reportName")) {
/*  55 */       this._reportName = (argReportName != null && MANAGE_CASE) ? argReportName.toUpperCase() : argReportName;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getReportGroup() {
/*  60 */     return this._reportGroup;
/*     */   }
/*     */   
/*     */   public void setReportGroup(String argReportGroup) {
/*  64 */     if (changed(argReportGroup, this._reportGroup, "reportGroup")) {
/*  65 */       this._reportGroup = (argReportGroup != null && MANAGE_CASE) ? argReportGroup.toUpperCase() : argReportGroup;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getReportElement() {
/*  70 */     return this._reportElement;
/*     */   }
/*     */   
/*     */   public void setReportElement(String argReportElement) {
/*  74 */     if (changed(argReportElement, this._reportElement, "reportElement")) {
/*  75 */       this._reportElement = (argReportElement != null && MANAGE_CASE) ? argReportElement.toUpperCase() : argReportElement;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getReportName() != null) {
/* 181 */       buf.append("reportName").append("=").append(getReportName()).append(" ");
/*     */     }
/* 183 */     if (getReportGroup() != null) {
/* 184 */       buf.append("reportGroup").append("=").append(getReportGroup()).append(" ");
/*     */     }
/* 186 */     if (getReportElement() != null) {
/* 187 */       buf.append("reportElement").append("=").append(getReportElement()).append(" ");
/*     */     }
...
/* 221 */     OrganizerPropertyId id = new OrganizerPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setReportName(getReportName());
/* 224 */     id.setReportGroup(getReportGroup());
/* 225 */     id.setReportElement(getReportElement());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((OrganizerPropertyId)argObjectId).getOrganizationId());
/* 232 */     setReportName(((OrganizerPropertyId)argObjectId).getReportName());
/* 233 */     setReportGroup(((OrganizerPropertyId)argObjectId).getReportGroup());
/* 234 */     setReportElement(((OrganizerPropertyId)argObjectId).getReportElement());
/* 235 */     setPropertyCode(((OrganizerPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"OrganizerProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._reportName != null) values.put("ReportName", DaoUtils.getXmlSafeFieldValue(12, this._reportName)); 
/* 255 */     if (this._reportGroup != null) values.put("ReportGroup", DaoUtils.getXmlSafeFieldValue(12, this._reportGroup)); 
/* 256 */     if (this._reportElement != null) values.put("ReportElement", DaoUtils.getXmlSafeFieldValue(12, this._reportElement)); 
...
/* 290 */             setReportName((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setReportName() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ReportGroup":
...
/* 299 */             setReportGroup((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setReportGroup() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ReportElement":
...
/* 308 */             setReportElement((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setReportElement() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\rpt\impl\OrganizerPropertyDAO.class
