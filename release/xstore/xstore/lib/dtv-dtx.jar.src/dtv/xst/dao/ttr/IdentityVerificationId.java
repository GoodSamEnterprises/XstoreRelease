...
/*     */ 
/*     */ 
/*     */ public class IdentityVerificationId
...
/*     */   
/*     */   public IdentityVerificationId() {}
/*     */   
/*     */   public IdentityVerificationId(String argObjectIdValue) {
...
/*  45 */     return this._identityVerificationSequence;
/*     */   }
/*     */   
/*     */   public void setIdentityVerificationSequence(Integer argIdentityVerificationSequence) {
/*  49 */     this._identityVerificationSequence = argIdentityVerificationSequence;
/*     */   }
/*     */   
...
/* 100 */       str = tokens[1];
/*     */       
/* 102 */       setIdentityVerificationSequence(Integer.valueOf(str));
/* 103 */       str = tokens[2];
/*     */       
...
/* 127 */       return true;
/*     */     }
/* 129 */     if (!(ob instanceof IdentityVerificationId)) {
/* 130 */       return false;
/*     */     }
/* 132 */     IdentityVerificationId other = (IdentityVerificationId)ob;
/* 133 */     return (((this._businessDate == null && other._businessDate == null) || (this._businessDate != null && this._businessDate
/*     */ 
/*     */       
/* 136 */       .equals(other._businessDate))) && ((this._identityVerificationSequence == null && other._identityVerificationSequence == null) || (this._identityVerificationSequence != null && this._identityVerificationSequence
/*     */ 
/*     */       
/* 139 */       .equals(other._identityVerificationSequence))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/* 161 */       .hashCode()) + ((this._identityVerificationSequence == null) ? 0 : this._identityVerificationSequence
...
/* 172 */     return "IdentityVerification";
/*     */   }
/*     */ 
/*     */   
...
/* 181 */       .append("::").append(String.valueOf(this._identityVerificationSequence))
...
/* 192 */       return false;
/*     */     }
/* 194 */     if (this._identityVerificationSequence == null) {
/* 195 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\IdentityVerificationId.class
