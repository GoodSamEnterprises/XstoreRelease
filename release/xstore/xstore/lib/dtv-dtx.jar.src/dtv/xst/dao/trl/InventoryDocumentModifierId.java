...
/*     */ 
/*     */ 
/*     */ public class InventoryDocumentModifierId
...
/*     */   
/*     */   public InventoryDocumentModifierId() {}
/*     */   
/*     */   public InventoryDocumentModifierId(String argObjectIdValue) {
...
/*  44 */     return this._documentModifierSequence;
/*     */   }
/*     */   
/*     */   public void setDocumentModifierSequence(Integer argDocumentModifierSequence) {
/*  48 */     this._documentModifierSequence = argDocumentModifierSequence;
/*     */   }
/*     */   
...
/*  91 */       str = tokens[1];
/*     */       
/*  93 */       setDocumentModifierSequence(Integer.valueOf(str));
/*  94 */       str = tokens[2];
/*     */       
...
/* 115 */       return true;
/*     */     }
/* 117 */     if (!(ob instanceof InventoryDocumentModifierId)) {
/* 118 */       return false;
/*     */     }
/* 120 */     InventoryDocumentModifierId other = (InventoryDocumentModifierId)ob;
/* 121 */     return (((this._businessDate == null && other._businessDate == null) || (this._businessDate != null && this._businessDate
/*     */ 
/*     */       
/* 124 */       .equals(other._businessDate))) && ((this._documentModifierSequence == null && other._documentModifierSequence == null) || (this._documentModifierSequence != null && this._documentModifierSequence
/*     */ 
/*     */       
/* 127 */       .equals(other._documentModifierSequence))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/* 146 */       .hashCode()) + ((this._documentModifierSequence == null) ? 0 : this._documentModifierSequence
...
/* 156 */     return "InventoryDocumentModifier";
/*     */   }
/*     */ 
/*     */   
...
/* 165 */       .append("::").append(String.valueOf(this._documentModifierSequence))
...
/* 175 */       return false;
/*     */     }
/* 177 */     if (this._documentModifierSequence == null) {
/* 178 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\InventoryDocumentModifierId.class
