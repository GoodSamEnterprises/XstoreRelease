...
/*     */ 
/*     */ 
/*     */ public class AddressStatePropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -493438446L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.country_id, t.state_id, t.address_mode, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_address_state_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND country_id = ?  AND state_id = ?  AND address_mode = ?  AND property_code = ?  ";
/*     */   
...
/*  46 */     return "SELECT t.organization_id, t.country_id, t.state_id, t.address_mode, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_address_state_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  52 */     return " WHERE organization_id = ?  AND country_id = ?  AND state_id = ?  AND address_mode = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  55 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO com_address_state_p(organization_id, country_id, state_id, address_mode, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  62 */     Object[][] insertParameterObject = { { this._organizationId, this._countryId, this._stateId, this._addressMode, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  72 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE com_address_state_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  88 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM com_address_state_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND country_id = ?  AND state_id = ?  AND address_mode = ?  AND property_code = ?  ";
/*     */   
...
/*  97 */     return " WHERE organization_id = ?  AND country_id = ?  AND state_id = ?  AND address_mode = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 100 */     return new Object[] { this._organizationId, this._countryId, this._stateId, this._addressMode, this._propertyCode };
/*     */   }
/*     */   
...
/* 109 */     return "com_address_state_p";
/*     */   }
/*     */   
...
/* 117 */     return new AddressStatePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class AddressStatePropertyFiller
/*     */     implements IFiller {
/*     */     private AddressStatePropertyDBA _parent;
/*     */     
/*     */     public AddressStatePropertyFiller(AddressStatePropertyDBA argParent) {
...
/* 137 */       this._parent._stateId = argResultSet.getString(3);
...
/* 177 */     AddressStatePropertyDAO dao = (AddressStatePropertyDAO)argDAO;
/* 178 */     dao.setOrganizationId(this._organizationId);
/* 179 */     dao.setCountryId(this._countryId);
/* 180 */     dao.setStateId(this._stateId);
...
/* 196 */     return loadDAO((IDataAccessObject)new AddressStatePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 200 */     AddressStatePropertyDAO dao = (AddressStatePropertyDAO)argDAO;
/* 201 */     this._organizationId = dao.getOrganizationId();
/* 202 */     this._countryId = dao.getCountryId();
/* 203 */     this._stateId = dao.getStateId();
...
/* 227 */     AddressStatePropertyId id = new AddressStatePropertyId();
/* 228 */     id.setOrganizationId(this._organizationId);
/* 229 */     id.setCountryId(this._countryId);
/* 230 */     id.setStateId(this._stateId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AddressStatePropertyDBA.class
