...
/*     */ 
/*     */ 
/*     */ public class DocumentNotePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 360409282L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DocumentNotePropertyDAO.class);
/*     */   
...
/*  81 */     return this._noteId;
/*     */   }
/*     */   
/*     */   public void setNoteId(Long argNoteId) {
/*  85 */     if (changed(argNoteId, this._noteId, "noteId")) {
/*  86 */       this._noteId = argNoteId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 200 */     if (getNoteId() != null) {
/* 201 */       buf.append("noteId").append("=").append(getNoteId()).append(" ");
/*     */     }
...
/* 235 */     DocumentNotePropertyId id = new DocumentNotePropertyId();
...
/* 240 */     id.setNoteId(getNoteId());
/* 241 */     id.setPropertyCode(getPropertyCode());
/* 242 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 246 */     setOrganizationId(((DocumentNotePropertyId)argObjectId).getOrganizationId());
/* 247 */     setRetailLocationId(((DocumentNotePropertyId)argObjectId).getRetailLocationId());
/* 248 */     setDocumentId(((DocumentNotePropertyId)argObjectId).getDocumentId());
/* 249 */     setDocumentTypeCode(((DocumentNotePropertyId)argObjectId).getDocumentTypeCode());
/* 250 */     setNoteId(((DocumentNotePropertyId)argObjectId).getNoteId());
/* 251 */     setPropertyCode(((DocumentNotePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"DocumentNoteProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 273 */     if (this._noteId != null) values.put("NoteId", DaoUtils.getXmlSafeFieldValue(-5, this._noteId)); 
...
/* 334 */             setNoteId((Long)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setNoteId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\DocumentNotePropertyDAO.class
