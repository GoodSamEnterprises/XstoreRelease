...
/*     */ 
/*     */ 
/*     */ public class ReceiptDataPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 2071585239L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ReceiptDataPropertyDAO.class);
/*     */   
...
/* 250 */     ReceiptDataPropertyId id = new ReceiptDataPropertyId();
...
/* 262 */     setOrganizationId(((ReceiptDataPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((ReceiptDataPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setWorkstationId(((ReceiptDataPropertyId)argObjectId).getWorkstationId());
/* 265 */     setBusinessDate(((ReceiptDataPropertyId)argObjectId).getBusinessDate());
/* 266 */     setTransactionSequence(((ReceiptDataPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setReceiptId(((ReceiptDataPropertyId)argObjectId).getReceiptId());
/* 268 */     setPropertyCode(((ReceiptDataPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"ReceiptDataProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\ReceiptDataPropertyDAO.class
