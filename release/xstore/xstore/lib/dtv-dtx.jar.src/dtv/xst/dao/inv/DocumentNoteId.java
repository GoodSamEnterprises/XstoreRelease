...
/*     */   
/*     */   public DocumentNoteId() {}
/*     */   
/*     */   public DocumentNoteId(String argObjectIdValue) {
...
/*  56 */     return this._noteId;
/*     */   }
/*     */   
/*     */   public void setNoteId(Long argNoteId) {
/*  60 */     this._noteId = argNoteId;
/*     */   }
/*     */   
...
/* 104 */       return true;
/*     */     }
/* 106 */     if (!(ob instanceof DocumentNoteId)) {
/* 107 */       return false;
/*     */     }
/* 109 */     DocumentNoteId other = (DocumentNoteId)ob;
...
/*     */ 
/*     */       
/* 122 */       .equals(other._documentTypeCode))) && ((this._noteId == null && other._noteId == null) || (this._noteId != null && this._noteId
/*     */ 
/*     */       
/* 125 */       .equals(other._noteId))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 135 */       .hashCode()) + ((this._noteId == null) ? 0 : this._noteId
/* 136 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getDtxTypeName() {
/* 141 */     return "DocumentNote";
/*     */   }
/*     */ 
/*     */   
...
/* 153 */       .append("::").append(String.valueOf(this._noteId))
/* 154 */       .toString();
/*     */   }
/*     */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\DocumentNoteId.class
