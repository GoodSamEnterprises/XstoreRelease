...
/*     */ 
/*     */ 
/*     */ public class ShippingCostPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IShippingCostProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ShippingCostPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ShippingCostPropertyDAO getDAO_() {
/*  44 */     return (ShippingCostPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IShippingCostProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  99 */     if (setCategory_noev(argCategory) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IShippingCostProperty.SET_CATEGORY, argCategory);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getCategory() == null && argCategory != null) || (
/* 112 */       getDAO_().getCategory() != null && !getDAO_().getCategory().equals(argCategory))) {
/* 113 */       getDAO_().setCategory(argCategory);
...
/* 125 */     return getDAO_().getBeginRange();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setBeginRange_noev(argBeginRange) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IShippingCostProperty.SET_BEGINRANGE, argBeginRange);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getBeginRange() == null && argBeginRange != null) || (
/* 146 */       getDAO_().getBeginRange() != null && !getDAO_().getBeginRange().equals(argBeginRange))) {
/* 147 */       getDAO_().setBeginRange(argBeginRange);
...
/* 159 */     return getDAO_().getEndRange();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setEndRange_noev(argEndRange) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IShippingCostProperty.SET_ENDRANGE, argEndRange);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getEndRange() == null && argEndRange != null) || (
/* 180 */       getDAO_().getEndRange() != null && !getDAO_().getEndRange().equals(argEndRange))) {
/* 181 */       getDAO_().setEndRange(argEndRange);
...
/* 201 */     if (setCost_noev(argCost) && 
/* 202 */       this._events != null && 
/* 203 */       postEventsForChanges()) {
/* 204 */       this._events.post(IShippingCostProperty.SET_COST, argCost);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 213 */     if ((getDAO_().getCost() == null && argCost != null) || (
/* 214 */       getDAO_().getCost() != null && !getDAO_().getCost().equals(argCost))) {
/* 215 */       getDAO_().setCost(argCost);
...
/* 238 */       this._events.post(IShippingCostProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IShippingCostProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IShippingCostProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IShippingCostProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IShippingCostProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IShippingCostProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IShippingCostProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IShippingCostProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 510 */       this._events.post(IShippingCostProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 531 */     if ("ShippingCostPropertyExtension".equals(argFieldId)) {
...
/* 541 */     if ("ShippingCostPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ShippingCostPropertyModel.class
