...
/*     */ 
/*     */ 
/*     */ public class TenderAuthLogPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.trans_seq, t.rtrans_lineitm_seq, t.attempt_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM ttr_tndr_auth_log_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND rtrans_lineitm_seq = ?  AND attempt_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  49 */     return "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.trans_seq, t.rtrans_lineitm_seq, t.attempt_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM ttr_tndr_auth_log_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  55 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND rtrans_lineitm_seq = ?  AND attempt_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  58 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO ttr_tndr_auth_log_p(organization_id, rtl_loc_id, wkstn_id, business_date, trans_seq, rtrans_lineitm_seq, attempt_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  65 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._transactionSequence, this._retailTransactionLineItemSequence, this._attemptSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  66 */     return insertParameterObject;
/*     */   }
/*     */   
/*  69 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, -5, 91, -5, 4, 4, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  72 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  75 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE ttr_tndr_auth_log_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  91 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM ttr_tndr_auth_log_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND rtrans_lineitm_seq = ?  AND attempt_seq = ?  AND property_code = ?  ";
/*     */   
...
/* 100 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND rtrans_lineitm_seq = ?  AND attempt_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 103 */     return new Object[] { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._transactionSequence, this._retailTransactionLineItemSequence, this._attemptSequence, this._propertyCode };
/*     */   }
/*     */   
/* 106 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { -5, -5, -5, 91, -5, 4, 4, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 109 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 112 */     return "ttr_tndr_auth_log_p";
/*     */   }
/*     */   
...
/* 120 */     return new TenderAuthLogPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TenderAuthLogPropertyFiller
/*     */     implements IFiller {
/*     */     private TenderAuthLogPropertyDBA _parent;
/*     */     
/*     */     public TenderAuthLogPropertyFiller(TenderAuthLogPropertyDBA argParent) {
...
/* 176 */         this._parent._retailTransactionLineItemSequence = Integer.valueOf(i);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 182 */       i = argResultSet.getInt(7);
/* 183 */       if (i != 0 || argResultSet.getObject(7) != null) {
/* 184 */         this._parent._attemptSequence = Integer.valueOf(i);
/*     */       }
/*     */ 
/*     */       
...
/* 226 */     TenderAuthLogPropertyDAO dao = (TenderAuthLogPropertyDAO)argDAO;
...
/* 233 */     dao.setAttemptSequence(this._attemptSequence);
...
/* 248 */     return loadDAO((IDataAccessObject)new TenderAuthLogPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 252 */     TenderAuthLogPropertyDAO dao = (TenderAuthLogPropertyDAO)argDAO;
...
/* 258 */     this._retailTransactionLineItemSequence = dao.getRetailTransactionLineItemSequence();
/* 259 */     this._attemptSequence = dao.getAttemptSequence();
...
/* 272 */     TenderAuthLogPropertyId id = (TenderAuthLogPropertyId)argId;
...
/* 278 */     argStatement.setInt(6, id.getRetailTransactionLineItemSequence().intValue());
/* 279 */     argStatement.setInt(7, id.getAttemptSequence().intValue());
/* 280 */     argStatement.setString(8, id.getPropertyCode());
/* 281 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 285 */     TenderAuthLogPropertyId id = new TenderAuthLogPropertyId();
...
/* 291 */     id.setRetailTransactionLineItemSequence(this._retailTransactionLineItemSequence);
/* 292 */     id.setAttemptSequence(this._attemptSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\TenderAuthLogPropertyDBA.class
