...
/*     */ 
/*     */ 
/*     */ public class TenderRepositoryFloatPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITenderRepositoryFloatProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TenderRepositoryFloatPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TenderRepositoryFloatPropertyDAO getDAO_() {
/*  44 */     return (TenderRepositoryFloatPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITenderRepositoryFloatProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(ITenderRepositoryFloatProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     return getDAO_().getTenderRepositoryId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 138 */     if (setTenderRepositoryId_noev(argTenderRepositoryId) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(ITenderRepositoryFloatProperty.SET_TENDERREPOSITORYID, argTenderRepositoryId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getTenderRepositoryId() == null && argTenderRepositoryId != null) || (
/* 151 */       getDAO_().getTenderRepositoryId() != null && !getDAO_().getTenderRepositoryId().equals(argTenderRepositoryId))) {
/* 152 */       getDAO_().setTenderRepositoryId(argTenderRepositoryId);
...
/* 164 */     return getDAO_().getCurrencyId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */     if (setCurrencyId_noev(argCurrencyId) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(ITenderRepositoryFloatProperty.SET_CURRENCYID, argCurrencyId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getCurrencyId() == null && argCurrencyId != null) || (
/* 185 */       getDAO_().getCurrencyId() != null && !getDAO_().getCurrencyId().equals(argCurrencyId))) {
/* 186 */       getDAO_().setCurrencyId(argCurrencyId);
...
/* 209 */       this._events.post(ITenderRepositoryFloatProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(ITenderRepositoryFloatProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(ITenderRepositoryFloatProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(ITenderRepositoryFloatProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(ITenderRepositoryFloatProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(ITenderRepositoryFloatProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(ITenderRepositoryFloatProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(ITenderRepositoryFloatProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(ITenderRepositoryFloatProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 502 */     if ("TenderRepositoryFloatPropertyExtension".equals(argFieldId)) {
...
/* 512 */     if ("TenderRepositoryFloatPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TenderRepositoryFloatPropertyModel.class
