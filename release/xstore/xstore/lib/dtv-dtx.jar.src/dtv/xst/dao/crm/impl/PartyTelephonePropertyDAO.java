...
/*     */ 
/*     */ 
/*     */ public class PartyTelephonePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -751703085L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PartyTelephonePropertyDAO.class);
/*     */   
...
/*  59 */     return this._telephoneType;
/*     */   }
/*     */   
/*     */   public void setTelephoneType(String argTelephoneType) {
/*  63 */     if (changed(argTelephoneType, this._telephoneType, "telephoneType")) {
/*  64 */       this._telephoneType = (argTelephoneType != null && MANAGE_CASE) ? argTelephoneType.toUpperCase() : argTelephoneType;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getTelephoneType() != null) {
/* 173 */       buf.append("telephoneType").append("=").append(getTelephoneType()).append(" ");
/*     */     }
...
/* 207 */     PartyTelephonePropertyId id = new PartyTelephonePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setPartyId(getPartyId());
/* 210 */     id.setTelephoneType(getTelephoneType());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((PartyTelephonePropertyId)argObjectId).getOrganizationId());
/* 217 */     setPartyId(((PartyTelephonePropertyId)argObjectId).getPartyId());
/* 218 */     setTelephoneType(((PartyTelephonePropertyId)argObjectId).getTelephoneType());
/* 219 */     setPropertyCode(((PartyTelephonePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"PartyTelephoneProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._telephoneType != null) values.put("TelephoneType", DaoUtils.getXmlSafeFieldValue(12, this._telephoneType)); 
...
/* 282 */             setTelephoneType((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setTelephoneType() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\PartyTelephonePropertyDAO.class
