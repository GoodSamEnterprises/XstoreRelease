...
/*    */ 
/*    */ public interface IAddressCountry extends IDataModel, IHasDataProperty<IAddressCountryProperty> {
/*  9 */   public static final EventEnum SET_ORGANIZATIONID = new EventEnum("set organizationId");
/* 10 */   public static final EventEnum SET_COUNTRYID = new EventEnum("set countryId");
/* 11 */   public static final EventEnum SET_ADDRESSMODE = new EventEnum("set addressMode");
...
/* 16 */   public static final EventEnum SET_COUNTRYNAME = new EventEnum("set countryName");
/* 17 */   public static final EventEnum SET_POSTALCODEMAXLENGTH = new EventEnum("set postalCodeMaxLength");
...
/*    */   
/*    */   int getPostalCodeMaxLength();
/*    */   
/*    */   void setPostalCodeMaxLength(int paramInt);
/*    */   
/*    */   IDataModel getAddressCountryExt();
/*    */   
/*    */   void setAddressCountryExt(IDataModel paramIDataModel);
/*    */   
/*    */   List<IAddressCountryProperty> getProperties();
/*    */   
/*    */   void setProperties(List<IAddressCountryProperty> paramList);
/*    */   
/*    */   void addAddressCountryProperty(IAddressCountryProperty paramIAddressCountryProperty);
/*    */   
/*    */   void removeAddressCountryProperty(IAddressCountryProperty paramIAddressCountryProperty);
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\IAddressCountry.class
