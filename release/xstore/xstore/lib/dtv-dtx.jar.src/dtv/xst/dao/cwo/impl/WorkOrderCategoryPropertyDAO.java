...
/*     */ 
/*     */ 
/*     */ public class WorkOrderCategoryPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 586300848L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WorkOrderCategoryPropertyDAO.class);
/*     */   
...
/*  52 */     if (changed(argCategoryId, this._categoryId, "categoryId")) {
/*  53 */       this._categoryId = (argCategoryId != null && MANAGE_CASE) ? argCategoryId.toUpperCase() : argCategoryId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getCategoryId() != null) {
/* 159 */       buf.append("categoryId").append("=").append(getCategoryId()).append(" ");
/*     */     }
...
/* 193 */     WorkOrderCategoryPropertyId id = new WorkOrderCategoryPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setCategoryId(getCategoryId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((WorkOrderCategoryPropertyId)argObjectId).getOrganizationId());
/* 202 */     setCategoryId(((WorkOrderCategoryPropertyId)argObjectId).getCategoryId());
/* 203 */     setPropertyCode(((WorkOrderCategoryPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"WorkOrderCategoryProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._categoryId != null) values.put("CategoryId", DaoUtils.getXmlSafeFieldValue(12, this._categoryId)); 
...
/* 256 */             setCategoryId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setCategoryId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkOrderCategoryPropertyDAO.class
