...
/*     */ 
/*     */ 
/*     */ public class ShipperPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1776084534L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ShipperPropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getShipperId() != null) {
/* 159 */       buf.append("shipperId").append("=").append(getShipperId()).append(" ");
/*     */     }
...
/* 193 */     ShipperPropertyId id = new ShipperPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setShipperId(getShipperId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((ShipperPropertyId)argObjectId).getOrganizationId());
/* 202 */     setShipperId(((ShipperPropertyId)argObjectId).getShipperId());
/* 203 */     setPropertyCode(((ShipperPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ShipperProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._shipperId != null) values.put("ShipperId", DaoUtils.getXmlSafeFieldValue(12, this._shipperId)); 
...
/* 256 */             setShipperId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setShipperId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\ShipperPropertyDAO.class
