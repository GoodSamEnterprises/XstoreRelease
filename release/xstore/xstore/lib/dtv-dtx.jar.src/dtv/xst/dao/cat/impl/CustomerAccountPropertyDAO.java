...
/*     */ 
/*     */ 
/*     */ public class CustomerAccountPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1627907908L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerAccountPropertyDAO.class);
/*     */   
...
/* 207 */     CustomerAccountPropertyId id = new CustomerAccountPropertyId();
...
/* 216 */     setOrganizationId(((CustomerAccountPropertyId)argObjectId).getOrganizationId());
/* 217 */     setCustAccountId(((CustomerAccountPropertyId)argObjectId).getCustAccountId());
/* 218 */     setCustAccountCode(((CustomerAccountPropertyId)argObjectId).getCustAccountCode());
/* 219 */     setPropertyCode(((CustomerAccountPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CustomerAccountProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerAccountPropertyDAO.class
