...
/*     */ 
/*     */ 
/*     */ public class MovementPendingTransactionLineItemPropertyId
...
/*     */   
/*     */   public MovementPendingTransactionLineItemPropertyId() {}
/*     */   
/*     */   public MovementPendingTransactionLineItemPropertyId(String argObjectIdValue) {
...
/* 112 */       str = tokens[5];
/*     */       
/* 114 */       setLineItemSequence(Integer.valueOf(str));
/* 115 */       str = tokens[6];
/*     */       
...
/* 132 */       return true;
/*     */     }
/* 134 */     if (!(ob instanceof MovementPendingTransactionLineItemPropertyId)) {
/* 135 */       return false;
/*     */     }
/* 137 */     MovementPendingTransactionLineItemPropertyId other = (MovementPendingTransactionLineItemPropertyId)ob;
...
/*     */ 
/*     */       
/* 153 */       .equals(other._transactionSequence))) && ((this._lineItemSequence == null && other._lineItemSequence == null) || (this._lineItemSequence != null && this._lineItemSequence
/*     */ 
/*     */       
/* 156 */       .equals(other._lineItemSequence))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 170 */       .hashCode()) + ((this._lineItemSequence == null) ? 0 : this._lineItemSequence
...
/* 177 */     return "MovementPendingTransactionLineItemProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 190 */       .append("::").append(String.valueOf(this._lineItemSequence))
...
/* 206 */       return false;
/*     */     }
/* 208 */     if (this._lineItemSequence == null) {
/* 209 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\MovementPendingTransactionLineItemPropertyId.class
