...
/*     */ 
/*     */ 
/*     */ public class DataLoaderSummaryPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1695223458L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DataLoaderSummaryPropertyDAO.class);
/*     */   
...
/*  49 */     return this._fileName;
/*     */   }
/*     */   
/*     */   public void setFileName(String argFileName) {
/*  53 */     if (changed(argFileName, this._fileName, "fileName")) {
/*  54 */       this._fileName = (argFileName != null && MANAGE_CASE) ? argFileName.toUpperCase() : argFileName;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getRunTime() {
/*  59 */     return this._runTime;
/*     */   }
/*     */   
/*     */   public void setRunTime(Long argRunTime) {
/*  63 */     if (changed(argRunTime, this._runTime, "runTime")) {
/*  64 */       this._runTime = argRunTime;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getFileName() != null) {
/* 170 */       buf.append("fileName").append("=").append(getFileName()).append(" ");
/*     */     }
/* 172 */     if (getRunTime() != null) {
/* 173 */       buf.append("runTime").append("=").append(getRunTime()).append(" ");
/*     */     }
...
/* 207 */     DataLoaderSummaryPropertyId id = new DataLoaderSummaryPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setFileName(getFileName());
/* 210 */     id.setRunTime(getRunTime());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((DataLoaderSummaryPropertyId)argObjectId).getOrganizationId());
/* 217 */     setFileName(((DataLoaderSummaryPropertyId)argObjectId).getFileName());
/* 218 */     setRunTime(((DataLoaderSummaryPropertyId)argObjectId).getRunTime());
/* 219 */     setPropertyCode(((DataLoaderSummaryPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DataLoaderSummaryProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._fileName != null) values.put("FileName", DaoUtils.getXmlSafeFieldValue(12, this._fileName)); 
/* 239 */     if (this._runTime != null) values.put("RunTime", DaoUtils.getXmlSafeFieldValue(-5, this._runTime)); 
...
/* 273 */             setFileName((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setFileName() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "RunTime":
...
/* 282 */             setRunTime((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setRunTime() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\DataLoaderSummaryPropertyDAO.class
