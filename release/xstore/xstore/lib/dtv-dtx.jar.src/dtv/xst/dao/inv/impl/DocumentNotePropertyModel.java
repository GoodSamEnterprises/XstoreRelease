...
/*     */ 
/*     */ 
/*     */ public class DocumentNotePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IDocumentNoteProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new DocumentNotePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private DocumentNotePropertyDAO getDAO_() {
/*  44 */     return (DocumentNotePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IDocumentNoteProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IDocumentNoteProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 141 */       this._events.post(IDocumentNoteProperty.SET_DOCUMENTID, argDocumentId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 175 */       this._events.post(IDocumentNoteProperty.SET_DOCUMENTTYPECODE, argDocumentTypeCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 198 */     if (getDAO_().getNoteId() != null) {
/* 199 */       return getDAO_().getNoteId().longValue();
/*     */     }
/*     */     
/* 202 */     return 0L;
/*     */   }
...
/* 211 */     if (setNoteId_noev(argNoteId) && 
/* 212 */       this._events != null && 
/* 213 */       postEventsForChanges()) {
/* 214 */       this._events.post(IDocumentNoteProperty.SET_NOTEID, Long.valueOf(argNoteId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 223 */     if ((getDAO_().getNoteId() == null && Long.valueOf(argNoteId) != null) || (
/* 224 */       getDAO_().getNoteId() != null && !getDAO_().getNoteId().equals(Long.valueOf(argNoteId)))) {
/* 225 */       getDAO_().setNoteId(Long.valueOf(argNoteId));
...
/* 248 */       this._events.post(IDocumentNoteProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(IDocumentNoteProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(IDocumentNoteProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(IDocumentNoteProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(IDocumentNoteProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(IDocumentNoteProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(IDocumentNoteProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(IDocumentNoteProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 520 */       this._events.post(IDocumentNoteProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 541 */     if ("DocumentNotePropertyExtension".equals(argFieldId)) {
...
/* 551 */     if ("DocumentNotePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\DocumentNotePropertyModel.class
