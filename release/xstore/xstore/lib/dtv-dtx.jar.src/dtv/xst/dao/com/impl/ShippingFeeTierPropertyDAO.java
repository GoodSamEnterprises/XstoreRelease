...
/*     */ 
/*     */ 
/*     */ public class ShippingFeeTierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -882558769L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ShippingFeeTierPropertyDAO.class);
/*     */   
...
/*  39 */     return this._ruleName;
/*     */   }
/*     */   
/*     */   public void setRuleName(String argRuleName) {
/*  43 */     if (changed(argRuleName, this._ruleName, "ruleName")) {
/*  44 */       this._ruleName = (argRuleName != null && MANAGE_CASE) ? argRuleName.toUpperCase() : argRuleName;
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     return this._parentRuleName;
/*     */   }
/*     */   
/*     */   public void setParentRuleName(String argParentRuleName) {
/*  63 */     if (changed(argParentRuleName, this._parentRuleName, "parentRuleName")) {
/*  64 */       this._parentRuleName = (argParentRuleName != null && MANAGE_CASE) ? argParentRuleName.toUpperCase() : argParentRuleName;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getRuleName() != null) {
/* 167 */       buf.append("ruleName").append("=").append(getRuleName()).append(" ");
/*     */     }
/* 169 */     if (getOrganizationId() != null) {
/* 170 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 172 */     if (getParentRuleName() != null) {
/* 173 */       buf.append("parentRuleName").append("=").append(getParentRuleName()).append(" ");
/*     */     }
...
/* 207 */     ShippingFeeTierPropertyId id = new ShippingFeeTierPropertyId();
/* 208 */     id.setRuleName(getRuleName());
/* 209 */     id.setOrganizationId(getOrganizationId());
/* 210 */     id.setParentRuleName(getParentRuleName());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setRuleName(((ShippingFeeTierPropertyId)argObjectId).getRuleName());
/* 217 */     setOrganizationId(((ShippingFeeTierPropertyId)argObjectId).getOrganizationId());
/* 218 */     setParentRuleName(((ShippingFeeTierPropertyId)argObjectId).getParentRuleName());
/* 219 */     setPropertyCode(((ShippingFeeTierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"ShippingFeeTierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._ruleName != null) values.put("RuleName", DaoUtils.getXmlSafeFieldValue(12, this._ruleName)); 
/* 238 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 239 */     if (this._parentRuleName != null) values.put("ParentRuleName", DaoUtils.getXmlSafeFieldValue(12, this._parentRuleName)); 
...
/* 264 */             setRuleName((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setRuleName() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 282 */             setParentRuleName((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setParentRuleName() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ShippingFeeTierPropertyDAO.class
