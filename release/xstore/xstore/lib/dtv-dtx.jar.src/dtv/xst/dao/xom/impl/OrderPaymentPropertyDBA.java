...
/*     */ 
/*     */ 
/*     */ public class OrderPaymentPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 2036739309L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.order_id, t.sequence, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xom_order_payment_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND order_id = ?  AND sequence = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.order_id, t.sequence, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xom_order_payment_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND order_id = ?  AND sequence = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO xom_order_payment_p(organization_id, order_id, sequence, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE xom_order_payment_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM xom_order_payment_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND order_id = ?  AND sequence = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND order_id = ?  AND sequence = ?  AND property_code = ?  ";
/*     */   }
...
/* 108 */     return "xom_order_payment_p";
/*     */   }
/*     */   
...
/* 116 */     return new OrderPaymentPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class OrderPaymentPropertyFiller
/*     */     implements IFiller {
/*     */     private OrderPaymentPropertyDBA _parent;
/*     */     
/*     */     public OrderPaymentPropertyFiller(OrderPaymentPropertyDBA argParent) {
...
/* 182 */     OrderPaymentPropertyDAO dao = (OrderPaymentPropertyDAO)argDAO;
...
/* 200 */     return loadDAO((IDataAccessObject)new OrderPaymentPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     OrderPaymentPropertyDAO dao = (OrderPaymentPropertyDAO)argDAO;
...
/* 220 */     OrderPaymentPropertyId id = (OrderPaymentPropertyId)argId;
...
/* 229 */     OrderPaymentPropertyId id = new OrderPaymentPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderPaymentPropertyDBA.class
