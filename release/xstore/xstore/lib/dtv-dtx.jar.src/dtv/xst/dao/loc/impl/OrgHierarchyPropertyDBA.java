...
/*     */ 
/*     */ 
/*     */ public class OrgHierarchyPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -528828218L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.org_code, t.org_value, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_org_hierarchy_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND org_code = ?  AND org_value = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.org_code, t.org_value, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_org_hierarchy_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND org_code = ?  AND org_value = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO loc_org_hierarchy_p(organization_id, org_code, org_value, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE loc_org_hierarchy_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM loc_org_hierarchy_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND org_code = ?  AND org_value = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND org_code = ?  AND org_value = ?  AND property_code = ?  ";
/*     */   }
...
/* 108 */     return "loc_org_hierarchy_p";
/*     */   }
/*     */   
...
/* 116 */     return new OrgHierarchyPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class OrgHierarchyPropertyFiller
/*     */     implements IFiller {
/*     */     private OrgHierarchyPropertyDBA _parent;
/*     */     
/*     */     public OrgHierarchyPropertyFiller(OrgHierarchyPropertyDBA argParent) {
...
/* 175 */     OrgHierarchyPropertyDAO dao = (OrgHierarchyPropertyDAO)argDAO;
...
/* 193 */     return loadDAO((IDataAccessObject)new OrgHierarchyPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     OrgHierarchyPropertyDAO dao = (OrgHierarchyPropertyDAO)argDAO;
...
/* 213 */     OrgHierarchyPropertyId id = (OrgHierarchyPropertyId)argId;
...
/* 222 */     OrgHierarchyPropertyId id = new OrgHierarchyPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\OrgHierarchyPropertyDBA.class
