...
/*     */ 
/*     */ 
/*     */ public class DiscountItemInclusionsPropertyId
...
/*     */   
/*     */   public DiscountItemInclusionsPropertyId() {}
/*     */   
/*     */   public DiscountItemInclusionsPropertyId(String argObjectIdValue) {
...
/*  97 */       return true;
/*     */     }
/*  99 */     if (!(ob instanceof DiscountItemInclusionsPropertyId)) {
/* 100 */       return false;
/*     */     }
/* 102 */     DiscountItemInclusionsPropertyId other = (DiscountItemInclusionsPropertyId)ob;
/* 103 */     return (((this._discountCode == null && other._discountCode == null) || (this._discountCode != null && this._discountCode
/*     */ 
/*     */       
/* 106 */       .equals(other._discountCode))) && ((this._itemId == null && other._itemId == null) || (this._itemId != null && this._itemId
/*     */ 
/*     */       
/* 109 */       .equals(other._itemId))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/* 130 */     return "DiscountItemInclusionsProperty";
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\DiscountItemInclusionsPropertyId.class
