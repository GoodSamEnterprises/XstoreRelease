...
/*    */ 
/*    */ 
/*    */ public class LineItemAssociationModifierPropertiesRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(7);
/*    */   
/*    */   public String getSelect() {
/* 22 */     return "SELECT parent_business_date, lineitm_assoc_mod_seq, organization_id, parent_rtl_loc_id, parent_rtrans_lineitm_seq, parent_trans_seq, parent_wkstn_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id FROM trl_lineitm_assoc_mod_p WHERE parent_business_date = ? AND lineitm_assoc_mod_seq = ? AND organization_id = ? AND parent_rtl_loc_id = ? AND parent_rtrans_lineitm_seq = ? AND parent_trans_seq = ? AND parent_wkstn_id = ?";
/*    */   }
/*    */ 
/*    */   
/*    */   public void setParent(IDataAccessObject argDAO) {
/* 27 */     LineItemAssociationModifierDAO dao = (LineItemAssociationModifierDAO)argDAO;
/* 28 */     this._parameterList.add(dao.getBusinessDate());
/* 29 */     this._parameterList.add(dao.getLineItemAssociationModifierSequence());
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\LineItemAssociationModifierPropertiesRelationshipDBA.class
