...
/*     */ 
/*     */ 
/*     */ public class CorrectionModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1712128362L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CorrectionModifierPropertyDAO.class);
/*     */   
...
/* 250 */     CorrectionModifierPropertyId id = new CorrectionModifierPropertyId();
...
/* 262 */     setBusinessDate(((CorrectionModifierPropertyId)argObjectId).getBusinessDate());
/* 263 */     setOrganizationId(((CorrectionModifierPropertyId)argObjectId).getOrganizationId());
/* 264 */     setRetailLocationId(((CorrectionModifierPropertyId)argObjectId).getRetailLocationId());
/* 265 */     setRetailTransactionLineItemSequence(((CorrectionModifierPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 266 */     setTransactionSequence(((CorrectionModifierPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setWorkstationId(((CorrectionModifierPropertyId)argObjectId).getWorkstationId());
/* 268 */     setPropertyCode(((CorrectionModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"CorrectionModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\CorrectionModifierPropertyDAO.class
