...
/*     */ 
/*     */ 
/*     */ public class MatrixSortOrderPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1455308900L;
/*  23 */   private static final Logger _logger = Logger.getLogger(MatrixSortOrderPropertyDAO.class);
/*     */   
...
/*  49 */     return this._matrixSortType;
/*     */   }
/*     */   
/*     */   public void setMatrixSortType(String argMatrixSortType) {
/*  53 */     if (changed(argMatrixSortType, this._matrixSortType, "matrixSortType")) {
/*  54 */       this._matrixSortType = (argMatrixSortType != null && MANAGE_CASE) ? argMatrixSortType.toUpperCase() : argMatrixSortType;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getMatrixSortId() {
/*  59 */     return this._matrixSortId;
/*     */   }
/*     */   
/*     */   public void setMatrixSortId(String argMatrixSortId) {
/*  63 */     if (changed(argMatrixSortId, this._matrixSortId, "matrixSortId")) {
/*  64 */       this._matrixSortId = (argMatrixSortId != null && MANAGE_CASE) ? argMatrixSortId.toUpperCase() : argMatrixSortId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getMatrixSortType() != null) {
/* 170 */       buf.append("matrixSortType").append("=").append(getMatrixSortType()).append(" ");
/*     */     }
/* 172 */     if (getMatrixSortId() != null) {
/* 173 */       buf.append("matrixSortId").append("=").append(getMatrixSortId()).append(" ");
/*     */     }
...
/* 207 */     MatrixSortOrderPropertyId id = new MatrixSortOrderPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setMatrixSortType(getMatrixSortType());
/* 210 */     id.setMatrixSortId(getMatrixSortId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((MatrixSortOrderPropertyId)argObjectId).getOrganizationId());
/* 217 */     setMatrixSortType(((MatrixSortOrderPropertyId)argObjectId).getMatrixSortType());
/* 218 */     setMatrixSortId(((MatrixSortOrderPropertyId)argObjectId).getMatrixSortId());
/* 219 */     setPropertyCode(((MatrixSortOrderPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"MatrixSortOrderProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._matrixSortType != null) values.put("MatrixSortType", DaoUtils.getXmlSafeFieldValue(12, this._matrixSortType)); 
/* 239 */     if (this._matrixSortId != null) values.put("MatrixSortId", DaoUtils.getXmlSafeFieldValue(12, this._matrixSortId)); 
...
/* 273 */             setMatrixSortType((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setMatrixSortType() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "MatrixSortId":
...
/* 282 */             setMatrixSortId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setMatrixSortId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\MatrixSortOrderPropertyDAO.class
