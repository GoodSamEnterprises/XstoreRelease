...
/*     */ 
/*     */ 
/*     */ public class EmployeeMessagePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.message_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM hrs_employee_message_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND message_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.message_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM hrs_employee_message_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND message_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO hrs_employee_message_p(organization_id, message_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._messageId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE hrs_employee_message_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM hrs_employee_message_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND message_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND message_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._messageId, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "hrs_employee_message_p";
/*     */   }
/*     */   
...
/* 115 */     return new EmployeeMessagePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class EmployeeMessagePropertyFiller
/*     */     implements IFiller {
/*     */     private EmployeeMessagePropertyDBA _parent;
/*     */     
/*     */     public EmployeeMessagePropertyFiller(EmployeeMessagePropertyDBA argParent) {
...
/* 138 */         this._parent._messageId = Long.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 180 */     EmployeeMessagePropertyDAO dao = (EmployeeMessagePropertyDAO)argDAO;
/* 181 */     dao.setOrganizationId(this._organizationId);
/* 182 */     dao.setMessageId(this._messageId);
...
/* 197 */     return loadDAO((IDataAccessObject)new EmployeeMessagePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 201 */     EmployeeMessagePropertyDAO dao = (EmployeeMessagePropertyDAO)argDAO;
/* 202 */     this._organizationId = dao.getOrganizationId();
/* 203 */     this._messageId = dao.getMessageId();
...
/* 216 */     EmployeeMessagePropertyId id = (EmployeeMessagePropertyId)argId;
/* 217 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 218 */     argStatement.setLong(2, id.getMessageId().longValue());
/* 219 */     argStatement.setString(3, id.getPropertyCode());
/* 220 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 224 */     EmployeeMessagePropertyId id = new EmployeeMessagePropertyId();
/* 225 */     id.setOrganizationId(this._organizationId);
/* 226 */     id.setMessageId(this._messageId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeMessagePropertyDBA.class
