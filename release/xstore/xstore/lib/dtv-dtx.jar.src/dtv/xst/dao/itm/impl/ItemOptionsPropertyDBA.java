...
/*     */ 
/*     */ 
/*     */ public class ItemOptionsPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.item_id, t.level_code, t.level_value, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_options_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND level_code = ?  AND level_value = ?  AND property_code = ?  ";
/*     */   
...
/*  46 */     return "SELECT t.organization_id, t.item_id, t.level_code, t.level_value, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_options_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  52 */     return " WHERE organization_id = ?  AND item_id = ?  AND level_code = ?  AND level_value = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  55 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_item_options_p(organization_id, item_id, level_code, level_value, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  62 */     Object[][] insertParameterObject = { { this._organizationId, this._itemId, this._levelCode, this._levelValue, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  72 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_item_options_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  88 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_item_options_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND level_code = ?  AND level_value = ?  AND property_code = ?  ";
/*     */   
...
/*  97 */     return " WHERE organization_id = ?  AND item_id = ?  AND level_code = ?  AND level_value = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 100 */     return new Object[] { this._organizationId, this._itemId, this._levelCode, this._levelValue, this._propertyCode };
/*     */   }
/*     */   
...
/* 117 */     return new ItemOptionsPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ItemOptionsPropertyFiller
/*     */     implements IFiller {
/*     */     private ItemOptionsPropertyDBA _parent;
/*     */     
/*     */     public ItemOptionsPropertyFiller(ItemOptionsPropertyDBA argParent) {
...
/* 137 */       this._parent._levelCode = argResultSet.getString(3);
/* 138 */       this._parent._levelValue = argResultSet.getString(4);
...
/* 177 */     ItemOptionsPropertyDAO dao = (ItemOptionsPropertyDAO)argDAO;
/* 178 */     dao.setOrganizationId(this._organizationId);
/* 179 */     dao.setItemId(this._itemId);
/* 180 */     dao.setLevelCode(this._levelCode);
/* 181 */     dao.setLevelValue(this._levelValue);
...
/* 196 */     return loadDAO((IDataAccessObject)new ItemOptionsPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 200 */     ItemOptionsPropertyDAO dao = (ItemOptionsPropertyDAO)argDAO;
/* 201 */     this._organizationId = dao.getOrganizationId();
/* 202 */     this._itemId = dao.getItemId();
/* 203 */     this._levelCode = dao.getLevelCode();
/* 204 */     this._levelValue = dao.getLevelValue();
...
/* 217 */     ItemOptionsPropertyId id = (ItemOptionsPropertyId)argId;
/* 218 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 219 */     argStatement.setString(2, id.getItemId());
/* 220 */     argStatement.setString(3, id.getLevelCode());
/* 221 */     argStatement.setString(4, id.getLevelValue());
/* 222 */     argStatement.setString(5, id.getPropertyCode());
/* 223 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 227 */     ItemOptionsPropertyId id = new ItemOptionsPropertyId();
/* 228 */     id.setOrganizationId(this._organizationId);
/* 229 */     id.setItemId(this._itemId);
/* 230 */     id.setLevelCode(this._levelCode);
/* 231 */     id.setLevelValue(this._levelValue);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemOptionsPropertyDBA.class
