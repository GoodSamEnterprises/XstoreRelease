...
/*     */ 
/*     */ 
/*     */ public class SubstituteItemsPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1473222427L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SubstituteItemsPropertyDAO.class);
/*     */   
...
/*  51 */     return this._primaryItemId;
/*     */   }
/*     */   
/*     */   public void setPrimaryItemId(String argPrimaryItemId) {
/*  55 */     if (changed(argPrimaryItemId, this._primaryItemId, "primaryItemId")) {
/*  56 */       this._primaryItemId = (argPrimaryItemId != null && MANAGE_CASE) ? argPrimaryItemId.toUpperCase() : argPrimaryItemId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getSubstituteItemId() {
/*  61 */     return this._substituteItemId;
/*     */   }
/*     */   
/*     */   public void setSubstituteItemId(String argSubstituteItemId) {
/*  65 */     if (changed(argSubstituteItemId, this._substituteItemId, "substituteItemId")) {
/*  66 */       this._substituteItemId = (argSubstituteItemId != null && MANAGE_CASE) ? argSubstituteItemId.toUpperCase() : argSubstituteItemId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getLevelCode() {
/*  71 */     return this._levelCode;
/*     */   }
/*     */   
/*     */   public void setLevelCode(String argLevelCode) {
/*  75 */     if (changed(argLevelCode, this._levelCode, "levelCode")) {
/*  76 */       this._levelCode = (argLevelCode != null && MANAGE_CASE) ? argLevelCode.toUpperCase() : argLevelCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getLevelValue() {
/*  81 */     return this._levelValue;
/*     */   }
/*     */   
/*     */   public void setLevelValue(String argLevelValue) {
/*  85 */     if (changed(argLevelValue, this._levelValue, "levelValue")) {
/*  86 */       this._levelValue = (argLevelValue != null && MANAGE_CASE) ? argLevelValue.toUpperCase() : argLevelValue;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 191 */     if (getPrimaryItemId() != null) {
/* 192 */       buf.append("primaryItemId").append("=").append(getPrimaryItemId()).append(" ");
/*     */     }
/* 194 */     if (getSubstituteItemId() != null) {
/* 195 */       buf.append("substituteItemId").append("=").append(getSubstituteItemId()).append(" ");
/*     */     }
/* 197 */     if (getLevelCode() != null) {
/* 198 */       buf.append("levelCode").append("=").append(getLevelCode()).append(" ");
/*     */     }
/* 200 */     if (getLevelValue() != null) {
/* 201 */       buf.append("levelValue").append("=").append(getLevelValue()).append(" ");
/*     */     }
...
/* 235 */     SubstituteItemsPropertyId id = new SubstituteItemsPropertyId();
/* 236 */     id.setOrganizationId(getOrganizationId());
/* 237 */     id.setPrimaryItemId(getPrimaryItemId());
/* 238 */     id.setSubstituteItemId(getSubstituteItemId());
/* 239 */     id.setLevelCode(getLevelCode());
/* 240 */     id.setLevelValue(getLevelValue());
/* 241 */     id.setPropertyCode(getPropertyCode());
/* 242 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 246 */     setOrganizationId(((SubstituteItemsPropertyId)argObjectId).getOrganizationId());
/* 247 */     setPrimaryItemId(((SubstituteItemsPropertyId)argObjectId).getPrimaryItemId());
/* 248 */     setSubstituteItemId(((SubstituteItemsPropertyId)argObjectId).getSubstituteItemId());
/* 249 */     setLevelCode(((SubstituteItemsPropertyId)argObjectId).getLevelCode());
/* 250 */     setLevelValue(((SubstituteItemsPropertyId)argObjectId).getLevelValue());
/* 251 */     setPropertyCode(((SubstituteItemsPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"SubstituteItemsProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 270 */     if (this._primaryItemId != null) values.put("PrimaryItemId", DaoUtils.getXmlSafeFieldValue(12, this._primaryItemId)); 
/* 271 */     if (this._substituteItemId != null) values.put("SubstituteItemId", DaoUtils.getXmlSafeFieldValue(12, this._substituteItemId)); 
/* 272 */     if (this._levelCode != null) values.put("LevelCode", DaoUtils.getXmlSafeFieldValue(12, this._levelCode)); 
/* 273 */     if (this._levelValue != null) values.put("LevelValue", DaoUtils.getXmlSafeFieldValue(12, this._levelValue)); 
...
/* 307 */             setPrimaryItemId((String)value);
/* 308 */           } catch (Exception ee) {
/* 309 */             throw new DtxException("An exception occurred while calling setPrimaryItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 316 */             setSubstituteItemId((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setSubstituteItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "LevelCode":
...
/* 325 */             setLevelCode((String)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setLevelCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "LevelValue":
...
/* 334 */             setLevelValue((String)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setLevelValue() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\SubstituteItemsPropertyDAO.class
