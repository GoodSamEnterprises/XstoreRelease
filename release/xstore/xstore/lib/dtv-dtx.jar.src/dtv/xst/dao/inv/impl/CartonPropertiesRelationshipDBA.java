...
/*    */ 
/*    */ 
/*    */ public class CartonPropertiesRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(5);
/*    */   
/*    */   public String getSelect() {
/* 22 */     return "SELECT invctl_document_id, document_typcode, carton_id, organization_id, rtl_loc_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id FROM inv_carton_p WHERE invctl_document_id = ? AND document_typcode = ? AND carton_id = ? AND organization_id = ? AND rtl_loc_id = ?";
/*    */   }
/*    */ 
/*    */   
/*    */   public void setParent(IDataAccessObject argDAO) {
/* 27 */     CartonDAO dao = (CartonDAO)argDAO;
/* 28 */     this._parameterList.add(dao.getDocumentId());
/* 29 */     this._parameterList.add(dao.getDocumentTypeCode());
/* 30 */     this._parameterList.add(dao.getCartonId());
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\CartonPropertiesRelationshipDBA.class
