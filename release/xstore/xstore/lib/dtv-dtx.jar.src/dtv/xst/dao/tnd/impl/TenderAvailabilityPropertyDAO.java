...
/*     */ 
/*     */ 
/*     */ public class TenderAvailabilityPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1110760804L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderAvailabilityPropertyDAO.class);
/*     */   
...
/*  39 */     return this._availabilityCode;
/*     */   }
/*     */   
/*     */   public void setAvailabilityCode(String argAvailabilityCode) {
/*  43 */     if (changed(argAvailabilityCode, this._availabilityCode, "availabilityCode")) {
/*  44 */       this._availabilityCode = (argAvailabilityCode != null && MANAGE_CASE) ? argAvailabilityCode.toUpperCase() : argAvailabilityCode;
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     return this._tenderId;
/*     */   }
/*     */   
/*     */   public void setTenderId(String argTenderId) {
/*  63 */     if (changed(argTenderId, this._tenderId, "tenderId")) {
/*  64 */       this._tenderId = (argTenderId != null && MANAGE_CASE) ? argTenderId.toUpperCase() : argTenderId;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getAvailabilityCode() != null) {
/* 167 */       buf.append("availabilityCode").append("=").append(getAvailabilityCode()).append(" ");
/*     */     }
/* 169 */     if (getOrganizationId() != null) {
/* 170 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 172 */     if (getTenderId() != null) {
/* 173 */       buf.append("tenderId").append("=").append(getTenderId()).append(" ");
/*     */     }
...
/* 207 */     TenderAvailabilityPropertyId id = new TenderAvailabilityPropertyId();
/* 208 */     id.setAvailabilityCode(getAvailabilityCode());
/* 209 */     id.setOrganizationId(getOrganizationId());
/* 210 */     id.setTenderId(getTenderId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setAvailabilityCode(((TenderAvailabilityPropertyId)argObjectId).getAvailabilityCode());
/* 217 */     setOrganizationId(((TenderAvailabilityPropertyId)argObjectId).getOrganizationId());
/* 218 */     setTenderId(((TenderAvailabilityPropertyId)argObjectId).getTenderId());
/* 219 */     setPropertyCode(((TenderAvailabilityPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"TenderAvailabilityProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._availabilityCode != null) values.put("AvailabilityCode", DaoUtils.getXmlSafeFieldValue(12, this._availabilityCode)); 
/* 238 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 239 */     if (this._tenderId != null) values.put("TenderId", DaoUtils.getXmlSafeFieldValue(12, this._tenderId)); 
...
/* 264 */             setAvailabilityCode((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setAvailabilityCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 282 */             setTenderId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setTenderId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderAvailabilityPropertyDAO.class
