...
/*     */ 
/*     */ 
/*     */ public class CustomerAccountNotePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1251449302L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerAccountNotePropertyDAO.class);
/*     */   
...
/*  40 */     return this._noteSequence;
/*     */   }
/*     */   
/*     */   public void setNoteSequence(Long argNoteSequence) {
/*  44 */     if (changed(argNoteSequence, this._noteSequence, "noteSequence")) {
/*  45 */       this._noteSequence = argNoteSequence;
/*     */     }
/*     */   }
/*     */   
...
/* 177 */     if (getNoteSequence() != null) {
/* 178 */       buf.append("noteSequence").append("=").append(getNoteSequence()).append(" ");
/*     */     }
/* 180 */     if (getOrganizationId() != null) {
/* 181 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 183 */     if (getCustAccountId() != null) {
/* 184 */       buf.append("custAccountId").append("=").append(getCustAccountId()).append(" ");
/*     */     }
/* 186 */     if (getCustAccountCode() != null) {
/* 187 */       buf.append("custAccountCode").append("=").append(getCustAccountCode()).append(" ");
/*     */     }
...
/* 221 */     CustomerAccountNotePropertyId id = new CustomerAccountNotePropertyId();
/* 222 */     id.setNoteSequence(getNoteSequence());
/* 223 */     id.setOrganizationId(getOrganizationId());
/* 224 */     id.setCustAccountId(getCustAccountId());
/* 225 */     id.setCustAccountCode(getCustAccountCode());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setNoteSequence(((CustomerAccountNotePropertyId)argObjectId).getNoteSequence());
/* 232 */     setOrganizationId(((CustomerAccountNotePropertyId)argObjectId).getOrganizationId());
/* 233 */     setCustAccountId(((CustomerAccountNotePropertyId)argObjectId).getCustAccountId());
/* 234 */     setCustAccountCode(((CustomerAccountNotePropertyId)argObjectId).getCustAccountCode());
/* 235 */     setPropertyCode(((CustomerAccountNotePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"CustomerAccountNoteProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 253 */     if (this._noteSequence != null) values.put("NoteSequence", DaoUtils.getXmlSafeFieldValue(-5, this._noteSequence)); 
/* 254 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 255 */     if (this._custAccountId != null) values.put("CustAccountId", DaoUtils.getXmlSafeFieldValue(12, this._custAccountId)); 
/* 256 */     if (this._custAccountCode != null) values.put("CustAccountCode", DaoUtils.getXmlSafeFieldValue(12, this._custAccountCode)); 
...
/* 281 */             setNoteSequence((Long)value);
/* 282 */           } catch (Exception ee) {
/* 283 */             throw new DtxException("An exception occurred while calling setNoteSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 299 */             setCustAccountId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setCustAccountId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setCustAccountCode((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setCustAccountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerAccountNotePropertyDAO.class
