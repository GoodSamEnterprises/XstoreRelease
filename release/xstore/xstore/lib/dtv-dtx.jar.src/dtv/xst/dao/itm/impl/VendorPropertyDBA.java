...
/*     */ 
/*     */ 
/*     */ public class VendorPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.vendor_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_vendor_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND vendor_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.vendor_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_vendor_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND vendor_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_vendor_p(organization_id, vendor_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._vendorId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_vendor_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_vendor_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND vendor_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND vendor_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._vendorId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new VendorPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class VendorPropertyFiller
/*     */     implements IFiller {
/*     */     private VendorPropertyDBA _parent;
/*     */     
/*     */     public VendorPropertyFiller(VendorPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._vendorId = argResultSet.getString(2);
...
/* 173 */     VendorPropertyDAO dao = (VendorPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setVendorId(this._vendorId);
...
/* 190 */     return loadDAO((IDataAccessObject)new VendorPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     VendorPropertyDAO dao = (VendorPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._vendorId = dao.getVendorId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\VendorPropertyDBA.class
