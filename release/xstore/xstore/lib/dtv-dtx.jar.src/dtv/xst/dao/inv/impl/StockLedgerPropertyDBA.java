...
/*     */ 
/*     */ 
/*     */ public class StockLedgerPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.bucket_id, t.inv_location_id, t.item_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_stock_ledger_acct_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND bucket_id = ?  AND inv_location_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   
...
/*  47 */     return "SELECT t.organization_id, t.rtl_loc_id, t.bucket_id, t.inv_location_id, t.item_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_stock_ledger_acct_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  53 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND bucket_id = ?  AND inv_location_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  56 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO inv_stock_ledger_acct_p(organization_id, rtl_loc_id, bucket_id, inv_location_id, item_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  63 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._bucketId, this._invLocationId, this._itemId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  73 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE inv_stock_ledger_acct_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  89 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM inv_stock_ledger_acct_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND bucket_id = ?  AND inv_location_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   
...
/*  98 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND bucket_id = ?  AND inv_location_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 101 */     return new Object[] { this._organizationId, this._retailLocationId, this._bucketId, this._invLocationId, this._itemId, this._propertyCode };
/*     */   }
/*     */   
...
/* 110 */     return "inv_stock_ledger_acct_p";
/*     */   }
/*     */   
...
/* 118 */     return new StockLedgerPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class StockLedgerPropertyFiller
/*     */     implements IFiller {
/*     */     private StockLedgerPropertyDBA _parent;
/*     */     
/*     */     public StockLedgerPropertyFiller(StockLedgerPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 145 */       this._parent._bucketId = argResultSet.getString(3);
/* 146 */       this._parent._invLocationId = argResultSet.getString(4);
/* 147 */       this._parent._itemId = argResultSet.getString(5);
...
/* 186 */     StockLedgerPropertyDAO dao = (StockLedgerPropertyDAO)argDAO;
/* 187 */     dao.setOrganizationId(this._organizationId);
/* 188 */     dao.setRetailLocationId(this._retailLocationId);
/* 189 */     dao.setBucketId(this._bucketId);
/* 190 */     dao.setInvLocationId(this._invLocationId);
...
/* 206 */     return loadDAO((IDataAccessObject)new StockLedgerPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 210 */     StockLedgerPropertyDAO dao = (StockLedgerPropertyDAO)argDAO;
/* 211 */     this._organizationId = dao.getOrganizationId();
/* 212 */     this._retailLocationId = dao.getRetailLocationId();
/* 213 */     this._bucketId = dao.getBucketId();
/* 214 */     this._invLocationId = dao.getInvLocationId();
/* 215 */     this._itemId = dao.getItemId();
...
/* 228 */     StockLedgerPropertyId id = (StockLedgerPropertyId)argId;
/* 229 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 230 */     argStatement.setLong(2, id.getRetailLocationId().longValue());
/* 231 */     argStatement.setString(3, id.getBucketId());
/* 232 */     argStatement.setString(4, id.getInvLocationId());
/* 233 */     argStatement.setString(5, id.getItemId());
/* 234 */     argStatement.setString(6, id.getPropertyCode());
/* 235 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 239 */     StockLedgerPropertyId id = new StockLedgerPropertyId();
/* 240 */     id.setOrganizationId(this._organizationId);
/* 241 */     id.setRetailLocationId(this._retailLocationId);
/* 242 */     id.setBucketId(this._bucketId);
/* 243 */     id.setInvLocationId(this._invLocationId);
/* 244 */     id.setItemId(this._itemId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\StockLedgerPropertyDBA.class
