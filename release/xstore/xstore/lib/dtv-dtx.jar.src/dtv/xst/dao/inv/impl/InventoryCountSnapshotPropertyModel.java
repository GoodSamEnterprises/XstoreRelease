...
/*     */ 
/*     */ 
/*     */ public class InventoryCountSnapshotPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IInventoryCountSnapshotProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new InventoryCountSnapshotPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private InventoryCountSnapshotPropertyDAO getDAO_() {
/*  44 */     return (InventoryCountSnapshotPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IInventoryCountSnapshotProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IInventoryCountSnapshotProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 141 */       this._events.post(IInventoryCountSnapshotProperty.SET_INVENTORYCOUNTID, argInventoryCountId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 164 */     return getDAO_().getInventoryLocationId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */     if (setInventoryLocationId_noev(argInventoryLocationId) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IInventoryCountSnapshotProperty.SET_INVENTORYLOCATIONID, argInventoryLocationId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getInventoryLocationId() == null && argInventoryLocationId != null) || (
/* 185 */       getDAO_().getInventoryLocationId() != null && !getDAO_().getInventoryLocationId().equals(argInventoryLocationId))) {
/* 186 */       getDAO_().setInventoryLocationId(argInventoryLocationId);
...
/* 198 */     return getDAO_().getInventoryBucketId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 206 */     if (setInventoryBucketId_noev(argInventoryBucketId) && 
/* 207 */       this._events != null && 
/* 208 */       postEventsForChanges()) {
/* 209 */       this._events.post(IInventoryCountSnapshotProperty.SET_INVENTORYBUCKETID, argInventoryBucketId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 218 */     if ((getDAO_().getInventoryBucketId() == null && argInventoryBucketId != null) || (
/* 219 */       getDAO_().getInventoryBucketId() != null && !getDAO_().getInventoryBucketId().equals(argInventoryBucketId))) {
/* 220 */       getDAO_().setInventoryBucketId(argInventoryBucketId);
...
/* 243 */       this._events.post(IInventoryCountSnapshotProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IInventoryCountSnapshotProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IInventoryCountSnapshotProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IInventoryCountSnapshotProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IInventoryCountSnapshotProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IInventoryCountSnapshotProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IInventoryCountSnapshotProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(IInventoryCountSnapshotProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 515 */       this._events.post(IInventoryCountSnapshotProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 549 */       this._events.post(IInventoryCountSnapshotProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 570 */     if ("InventoryCountSnapshotPropertyExtension".equals(argFieldId)) {
...
/* 580 */     if ("InventoryCountSnapshotPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountSnapshotPropertyModel.class
