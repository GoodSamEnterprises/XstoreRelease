...
/*     */ 
/*     */ 
/*     */ public class InventoryJournalPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1820928336L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryJournalPropertyDAO.class);
/*     */   
...
/* 104 */     return this._journalSequence;
/*     */   }
/*     */   
/*     */   public void setJournalSequence(Long argJournalSequence) {
/* 108 */     if (changed(argJournalSequence, this._journalSequence, "journalSequence")) {
/* 109 */       this._journalSequence = argJournalSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 229 */     if (getJournalSequence() != null) {
/* 230 */       buf.append("journalSequence").append("=").append(getJournalSequence()).append(" ");
/*     */     }
...
/* 264 */     InventoryJournalPropertyId id = new InventoryJournalPropertyId();
...
/* 271 */     id.setJournalSequence(getJournalSequence());
/* 272 */     id.setPropertyCode(getPropertyCode());
/* 273 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 277 */     setOrganizationId(((InventoryJournalPropertyId)argObjectId).getOrganizationId());
/* 278 */     setRetailLocationId(((InventoryJournalPropertyId)argObjectId).getRetailLocationId());
/* 279 */     setWorkstationId(((InventoryJournalPropertyId)argObjectId).getWorkstationId());
/* 280 */     setBusinessDate(((InventoryJournalPropertyId)argObjectId).getBusinessDate());
/* 281 */     setTransactionSequence(((InventoryJournalPropertyId)argObjectId).getTransactionSequence());
/* 282 */     setTransactionLineItemSequence(((InventoryJournalPropertyId)argObjectId).getTransactionLineItemSequence());
/* 283 */     setJournalSequence(((InventoryJournalPropertyId)argObjectId).getJournalSequence());
/* 284 */     setPropertyCode(((InventoryJournalPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"InventoryJournalProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 308 */     if (this._journalSequence != null) values.put("JournalSequence", DaoUtils.getXmlSafeFieldValue(-5, this._journalSequence)); 
...
/* 387 */             setJournalSequence((Long)value);
/* 388 */           } catch (Exception ee) {
/* 389 */             throw new DtxException("An exception occurred while calling setJournalSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryJournalPropertyDAO.class
