...
/*     */ 
/*     */ 
/*     */ public class DiscountItemInclusionsDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -844796405L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DiscountItemInclusionsDAO.class);
/*     */   
...
/* 136 */     DiscountItemInclusionsId id = new DiscountItemInclusionsId();
...
/* 144 */     setDiscountCode(((DiscountItemInclusionsId)argObjectId).getDiscountCode());
/* 145 */     setItemId(((DiscountItemInclusionsId)argObjectId).getItemId());
/* 146 */     setOrganizationId(((DiscountItemInclusionsId)argObjectId).getOrganizationId());
/*     */   }
/*     */   
...
/* 155 */     buf.append("<").append("dao").append(" name=\"DiscountItemInclusions\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountItemInclusionsDAO.class
