...
/*     */ 
/*     */ 
/*     */ public class ItemRestrictGS1PropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.item_id, t.field_id, t.start_value, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_restrict_gs1_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND field_id = ?  AND start_value = ?  AND property_code = ?  ";
/*     */   
...
/*  46 */     return "SELECT t.organization_id, t.item_id, t.field_id, t.start_value, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_restrict_gs1_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  52 */     return " WHERE organization_id = ?  AND item_id = ?  AND field_id = ?  AND start_value = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  55 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_restrict_gs1_p(organization_id, item_id, field_id, start_value, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  62 */     Object[][] insertParameterObject = { { this._organizationId, this._itemId, this._fieldId, this._startValue, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  72 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_restrict_gs1_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  88 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_restrict_gs1_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND field_id = ?  AND start_value = ?  AND property_code = ?  ";
/*     */   
...
/*  97 */     return " WHERE organization_id = ?  AND item_id = ?  AND field_id = ?  AND start_value = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 100 */     return new Object[] { this._organizationId, this._itemId, this._fieldId, this._startValue, this._propertyCode };
/*     */   }
/*     */   
...
/* 117 */     return new ItemRestrictGS1PropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ItemRestrictGS1PropertyFiller
/*     */     implements IFiller {
/*     */     private ItemRestrictGS1PropertyDBA _parent;
/*     */     
/*     */     public ItemRestrictGS1PropertyFiller(ItemRestrictGS1PropertyDBA argParent) {
...
/* 177 */     ItemRestrictGS1PropertyDAO dao = (ItemRestrictGS1PropertyDAO)argDAO;
/* 178 */     dao.setOrganizationId(this._organizationId);
/* 179 */     dao.setItemId(this._itemId);
/* 180 */     dao.setFieldId(this._fieldId);
/* 181 */     dao.setStartValue(this._startValue);
...
/* 196 */     return loadDAO((IDataAccessObject)new ItemRestrictGS1PropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 200 */     ItemRestrictGS1PropertyDAO dao = (ItemRestrictGS1PropertyDAO)argDAO;
/* 201 */     this._organizationId = dao.getOrganizationId();
/* 202 */     this._itemId = dao.getItemId();
/* 203 */     this._fieldId = dao.getFieldId();
/* 204 */     this._startValue = dao.getStartValue();
...
/* 217 */     ItemRestrictGS1PropertyId id = (ItemRestrictGS1PropertyId)argId;
/* 218 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 219 */     argStatement.setString(2, id.getItemId());
/* 220 */     argStatement.setString(3, id.getFieldId());
/* 221 */     argStatement.setString(4, id.getStartValue());
/* 222 */     argStatement.setString(5, id.getPropertyCode());
/* 223 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 227 */     ItemRestrictGS1PropertyId id = new ItemRestrictGS1PropertyId();
/* 228 */     id.setOrganizationId(this._organizationId);
/* 229 */     id.setItemId(this._itemId);
/* 230 */     id.setFieldId(this._fieldId);
/* 231 */     id.setStartValue(this._startValue);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemRestrictGS1PropertyDBA.class
