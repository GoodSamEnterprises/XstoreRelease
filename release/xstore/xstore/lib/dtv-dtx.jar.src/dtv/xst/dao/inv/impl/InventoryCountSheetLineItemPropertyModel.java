...
/*     */ 
/*     */ 
/*     */ public class InventoryCountSheetLineItemPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IInventoryCountSheetLineItemProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new InventoryCountSheetLineItemPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private InventoryCountSheetLineItemPropertyDAO getDAO_() {
/*  44 */     return (InventoryCountSheetLineItemPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     return getDAO_().getInventoryCountId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 138 */     if (setInventoryCountId_noev(argInventoryCountId) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_INVENTORYCOUNTID, argInventoryCountId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getInventoryCountId() == null && argInventoryCountId != null) || (
/* 151 */       getDAO_().getInventoryCountId() != null && !getDAO_().getInventoryCountId().equals(argInventoryCountId))) {
/* 152 */       getDAO_().setInventoryCountId(argInventoryCountId);
...
/* 164 */     if (getDAO_().getCountSheetNumber() != null) {
/* 165 */       return getDAO_().getCountSheetNumber().intValue();
/*     */     }
/*     */     
/* 168 */     return 0;
/*     */   }
...
/* 177 */     if (setCountSheetNumber_noev(argCountSheetNumber) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_COUNTSHEETNUMBER, Integer.valueOf(argCountSheetNumber));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getCountSheetNumber() == null && Integer.valueOf(argCountSheetNumber) != null) || (
/* 190 */       getDAO_().getCountSheetNumber() != null && !getDAO_().getCountSheetNumber().equals(Integer.valueOf(argCountSheetNumber)))) {
/* 191 */       getDAO_().setCountSheetNumber(Integer.valueOf(argCountSheetNumber));
...
/* 203 */     if (getDAO_().getLineItemNumber() != null) {
/* 204 */       return getDAO_().getLineItemNumber().intValue();
/*     */     }
/*     */     
/* 207 */     return 0;
/*     */   }
...
/* 216 */     if (setLineItemNumber_noev(argLineItemNumber) && 
/* 217 */       this._events != null && 
/* 218 */       postEventsForChanges()) {
/* 219 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_LINEITEMNUMBER, Integer.valueOf(argLineItemNumber));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 228 */     if ((getDAO_().getLineItemNumber() == null && Integer.valueOf(argLineItemNumber) != null) || (
/* 229 */       getDAO_().getLineItemNumber() != null && !getDAO_().getLineItemNumber().equals(Integer.valueOf(argLineItemNumber)))) {
/* 230 */       getDAO_().setLineItemNumber(Integer.valueOf(argLineItemNumber));
...
/* 253 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 287 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 321 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 355 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 389 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 423 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 457 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 491 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 525 */       this._events.post(IInventoryCountSheetLineItemProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 546 */     if ("InventoryCountSheetLineItemPropertyExtension".equals(argFieldId)) {
...
/* 556 */     if ("InventoryCountSheetLineItemPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountSheetLineItemPropertyModel.class
