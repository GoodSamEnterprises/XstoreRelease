...
/*     */ 
/*     */ 
/*     */ public class TillControlTransactionDAO
/*     */   extends PosTransactionDAO
/*     */ {
/*     */   private static final long serialVersionUID = -62627594L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TillControlTransactionDAO.class);
/*     */   
...
/*  76 */     return this._typeCode;
/*     */   }
/*     */   
/*     */   public void setTypeCode(String argTypeCode) {
/*  80 */     if (changed(argTypeCode, this._typeCode, "typeCode")) {
/*  81 */       this._typeCode = argTypeCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getEmployeeId() {
/*  86 */     return this._employeeId;
/*     */   }
/*     */   
/*     */   public void setEmployeeId(String argEmployeeId) {
/*  90 */     if (changed(argEmployeeId, this._employeeId, "employeeId")) {
/*  91 */       this._employeeId = argEmployeeId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 122 */     if (getTypeCode() != null) {
/* 123 */       buf.append("typeCode").append("=").append(getTypeCode()).append(" ");
/*     */     }
/* 125 */     if (getEmployeeId() != null) {
/* 126 */       buf.append("employeeId").append("=").append(getEmployeeId()).append(" ");
/*     */     }
...
/* 138 */     buf.append("<").append("dao").append(" name=\"TillControlTransaction\" cmd=\"" + getObjectStateString() + "\">");
...
/* 151 */     if (this._typeCode != null) values.put("TypeCode", DaoUtils.getXmlSafeFieldValue(12, this._typeCode)); 
/* 152 */     if (this._employeeId != null) values.put("EmployeeId", DaoUtils.getXmlSafeFieldValue(12, this._employeeId)); 
...
/* 205 */             setTypeCode((String)value);
/* 206 */           } catch (Exception ee) {
/* 207 */             throw new DtxException("An exception occurred while calling setTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "EmployeeId":
...
/* 214 */             setEmployeeId((String)value);
/* 215 */           } catch (Exception ee) {
/* 216 */             throw new DtxException("An exception occurred while calling setEmployeeId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ReasonCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TillControlTransactionDAO.class
