...
/*     */ 
/*     */ 
/*     */ public class WarrantyItemCrossReferencePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1139731697L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WarrantyItemCrossReferencePropertyDAO.class);
/*     */   
...
/*  59 */     return this._warrantyItemId;
/*     */   }
/*     */   
/*     */   public void setWarrantyItemId(String argWarrantyItemId) {
/*  63 */     if (changed(argWarrantyItemId, this._warrantyItemId, "warrantyItemId")) {
/*  64 */       this._warrantyItemId = (argWarrantyItemId != null && MANAGE_CASE) ? argWarrantyItemId.toUpperCase() : argWarrantyItemId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getWarrantyItemId() != null) {
/* 173 */       buf.append("warrantyItemId").append("=").append(getWarrantyItemId()).append(" ");
/*     */     }
...
/* 207 */     WarrantyItemCrossReferencePropertyId id = new WarrantyItemCrossReferencePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setItemId(getItemId());
/* 210 */     id.setWarrantyItemId(getWarrantyItemId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((WarrantyItemCrossReferencePropertyId)argObjectId).getOrganizationId());
/* 217 */     setItemId(((WarrantyItemCrossReferencePropertyId)argObjectId).getItemId());
/* 218 */     setWarrantyItemId(((WarrantyItemCrossReferencePropertyId)argObjectId).getWarrantyItemId());
/* 219 */     setPropertyCode(((WarrantyItemCrossReferencePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"WarrantyItemCrossReferenceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._warrantyItemId != null) values.put("WarrantyItemId", DaoUtils.getXmlSafeFieldValue(12, this._warrantyItemId)); 
...
/* 282 */             setWarrantyItemId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setWarrantyItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyItemCrossReferencePropertyDAO.class
