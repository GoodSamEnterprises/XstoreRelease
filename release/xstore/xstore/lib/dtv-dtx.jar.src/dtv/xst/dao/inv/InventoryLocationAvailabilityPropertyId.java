...
/*     */ 
/*     */ 
/*     */ public class InventoryLocationAvailabilityPropertyId
...
/*     */   
/*     */   public InventoryLocationAvailabilityPropertyId() {}
/*     */   
/*     */   public InventoryLocationAvailabilityPropertyId(String argObjectIdValue) {
...
/*  48 */     return this._availabilityCode;
/*     */   }
/*     */   
/*     */   public void setAvailabilityCode(String argAvailabilityCode) {
/*  52 */     this._availabilityCode = (argAvailabilityCode != null && MANAGE_CASE) ? argAvailabilityCode.toUpperCase() : argAvailabilityCode;
/*     */   }
/*     */   
...
/*  87 */         setAvailabilityCode((String)null);
/*     */       } else {
/*     */         
/*  90 */         setAvailabilityCode(str);
/*     */       } 
/*  92 */       str = tokens[4];
/*     */       
...
/* 109 */       return true;
/*     */     }
/* 111 */     if (!(ob instanceof InventoryLocationAvailabilityPropertyId)) {
/* 112 */       return false;
/*     */     }
/* 114 */     InventoryLocationAvailabilityPropertyId other = (InventoryLocationAvailabilityPropertyId)ob;
...
/*     */ 
/*     */       
/* 124 */       .equals(other._locationId))) && ((this._availabilityCode == null && other._availabilityCode == null) || (this._availabilityCode != null && this._availabilityCode
/*     */ 
/*     */       
/* 127 */       .equals(other._availabilityCode))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 139 */       .hashCode()) + ((this._availabilityCode == null) ? 0 : this._availabilityCode
...
/* 146 */     return "InventoryLocationAvailabilityProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 157 */       .append("::").append(this._availabilityCode)
...
/* 167 */       return false;
/*     */     }
/* 169 */     if (this._availabilityCode == null) {
/* 170 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\InventoryLocationAvailabilityPropertyId.class
