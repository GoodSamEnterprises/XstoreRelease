...
/*     */ 
/*     */ 
/*     */ public class InventoryTransactionDetailPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -333611544L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryTransactionDetailPropertyDAO.class);
/*     */   
...
/*  93 */     return this._inventoryDetailSequence;
/*     */   }
/*     */   
/*     */   public void setInventoryDetailSequence(Integer argInventoryDetailSequence) {
/*  97 */     if (changed(argInventoryDetailSequence, this._inventoryDetailSequence, "inventoryDetailSequence")) {
/*  98 */       this._inventoryDetailSequence = argInventoryDetailSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 215 */     if (getInventoryDetailSequence() != null) {
/* 216 */       buf.append("inventoryDetailSequence").append("=").append(getInventoryDetailSequence()).append(" ");
/*     */     }
...
/* 250 */     InventoryTransactionDetailPropertyId id = new InventoryTransactionDetailPropertyId();
...
/* 256 */     id.setInventoryDetailSequence(getInventoryDetailSequence());
/* 257 */     id.setPropertyCode(getPropertyCode());
/* 258 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 262 */     setOrganizationId(((InventoryTransactionDetailPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((InventoryTransactionDetailPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setBusinessDate(((InventoryTransactionDetailPropertyId)argObjectId).getBusinessDate());
/* 265 */     setWorkstationId(((InventoryTransactionDetailPropertyId)argObjectId).getWorkstationId());
/* 266 */     setTransactionSequence(((InventoryTransactionDetailPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setInventoryDetailSequence(((InventoryTransactionDetailPropertyId)argObjectId).getInventoryDetailSequence());
/* 268 */     setPropertyCode(((InventoryTransactionDetailPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"InventoryTransactionDetailProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 291 */     if (this._inventoryDetailSequence != null) values.put("InventoryDetailSequence", DaoUtils.getXmlSafeFieldValue(4, this._inventoryDetailSequence)); 
...
/* 361 */             setInventoryDetailSequence((Integer)value);
/* 362 */           } catch (Exception ee) {
/* 363 */             throw new DtxException("An exception occurred while calling setInventoryDetailSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryTransactionDetailPropertyDAO.class
