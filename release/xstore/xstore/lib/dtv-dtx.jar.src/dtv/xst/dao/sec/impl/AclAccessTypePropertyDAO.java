...
/*     */ 
/*     */ 
/*     */ public class AclAccessTypePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -39042883L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AclAccessTypePropertyDAO.class);
/*     */   
...
/*  39 */     return this._accessTypeCode;
/*     */   }
/*     */   
/*     */   public void setAccessTypeCode(String argAccessTypeCode) {
/*  43 */     if (changed(argAccessTypeCode, this._accessTypeCode, "accessTypeCode")) {
/*  44 */       this._accessTypeCode = (argAccessTypeCode != null && MANAGE_CASE) ? argAccessTypeCode.toUpperCase() : argAccessTypeCode;
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     return this._securedObjectId;
/*     */   }
/*     */   
/*     */   public void setSecuredObjectId(String argSecuredObjectId) {
/*  63 */     if (changed(argSecuredObjectId, this._securedObjectId, "securedObjectId")) {
/*  64 */       this._securedObjectId = (argSecuredObjectId != null && MANAGE_CASE) ? argSecuredObjectId.toUpperCase() : argSecuredObjectId;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getAccessTypeCode() != null) {
/* 167 */       buf.append("accessTypeCode").append("=").append(getAccessTypeCode()).append(" ");
/*     */     }
/* 169 */     if (getOrganizationId() != null) {
/* 170 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 172 */     if (getSecuredObjectId() != null) {
/* 173 */       buf.append("securedObjectId").append("=").append(getSecuredObjectId()).append(" ");
/*     */     }
...
/* 207 */     AclAccessTypePropertyId id = new AclAccessTypePropertyId();
/* 208 */     id.setAccessTypeCode(getAccessTypeCode());
/* 209 */     id.setOrganizationId(getOrganizationId());
/* 210 */     id.setSecuredObjectId(getSecuredObjectId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setAccessTypeCode(((AclAccessTypePropertyId)argObjectId).getAccessTypeCode());
/* 217 */     setOrganizationId(((AclAccessTypePropertyId)argObjectId).getOrganizationId());
/* 218 */     setSecuredObjectId(((AclAccessTypePropertyId)argObjectId).getSecuredObjectId());
/* 219 */     setPropertyCode(((AclAccessTypePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"AclAccessTypeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._accessTypeCode != null) values.put("AccessTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._accessTypeCode)); 
/* 238 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 239 */     if (this._securedObjectId != null) values.put("SecuredObjectId", DaoUtils.getXmlSafeFieldValue(12, this._securedObjectId)); 
...
/* 264 */             setAccessTypeCode((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setAccessTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 282 */             setSecuredObjectId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setSecuredObjectId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\AclAccessTypePropertyDAO.class
