...
/*    */ 
/*    */ public interface ICheetahClientDeviceAccess extends IDataModel, IHasDataProperty<ICheetahClientDeviceAccessProperty> {
/*  9 */   public static final EventEnum SET_ORGANIZATIONID = new EventEnum("set organizationId");
/* 10 */   public static final EventEnum SET_RETAILLOCATIONID = new EventEnum("set retailLocationId");
/* 11 */   public static final EventEnum SET_TOKEN = new EventEnum("set token");
/* 12 */   public static final EventEnum SET_WORKSTATIONID = new EventEnum("set workstationId");
/* 13 */   public static final EventEnum SET_STATUS = new EventEnum("set status");
...
/*    */   String getToken();
/*    */   
/*    */   void setToken(String paramString);
/*    */   
...
/*    */   
/*    */   IDataModel getCheetahClientDeviceAccessExt();
/*    */   
/*    */   void setCheetahClientDeviceAccessExt(IDataModel paramIDataModel);
/*    */   
/*    */   List<ICheetahClientDeviceAccessProperty> getProperties();
/*    */   
/*    */   void setProperties(List<ICheetahClientDeviceAccessProperty> paramList);
/*    */   
/*    */   void addCheetahClientDeviceAccessProperty(ICheetahClientDeviceAccessProperty paramICheetahClientDeviceAccessProperty);
/*    */   
/*    */   void removeCheetahClientDeviceAccessProperty(ICheetahClientDeviceAccessProperty paramICheetahClientDeviceAccessProperty);
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\ICheetahClientDeviceAccess.class
