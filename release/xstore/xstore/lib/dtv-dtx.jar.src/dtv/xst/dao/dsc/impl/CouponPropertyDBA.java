...
/*     */ 
/*     */ 
/*     */ public class CouponPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.coupon_serial_nbr, t.organization_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM dsc_coupon_xref_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE coupon_serial_nbr = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.coupon_serial_nbr, t.organization_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM dsc_coupon_xref_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE coupon_serial_nbr = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO dsc_coupon_xref_p(coupon_serial_nbr, organization_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._couponSerialNumber, this._organizationId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE dsc_coupon_xref_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM dsc_coupon_xref_p" }; private static final String WHERE_OBJECT = " WHERE coupon_serial_nbr = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE coupon_serial_nbr = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._couponSerialNumber, this._organizationId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new CouponPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class CouponPropertyFiller
/*     */     implements IFiller {
/*     */     private CouponPropertyDBA _parent;
/*     */     
/*     */     public CouponPropertyFiller(CouponPropertyDBA argParent) {
/* 123 */       this._parent = argParent;
/*     */     }
/*     */     public void fill(ResultSet argResultSet) throws SQLException {
/* 126 */       this._parent._couponSerialNumber = argResultSet.getString(1);
/*     */ 
/*     */       
...
/* 173 */     CouponPropertyDAO dao = (CouponPropertyDAO)argDAO;
/* 174 */     dao.setCouponSerialNumber(this._couponSerialNumber);
...
/* 190 */     return loadDAO((IDataAccessObject)new CouponPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     CouponPropertyDAO dao = (CouponPropertyDAO)argDAO;
/* 195 */     this._couponSerialNumber = dao.getCouponSerialNumber();
...
/* 209 */     CouponPropertyId id = (CouponPropertyId)argId;
/* 210 */     argStatement.setString(1, id.getCouponSerialNumber());
...
/* 217 */     CouponPropertyId id = new CouponPropertyId();
/* 218 */     id.setCouponSerialNumber(this._couponSerialNumber);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\CouponPropertyDBA.class
