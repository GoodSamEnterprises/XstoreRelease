...
/*     */ 
/*     */ 
/*     */ public class LineItemAssociationModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1822693722L;
/*  23 */   private static final Logger _logger = Logger.getLogger(LineItemAssociationModifierPropertyDAO.class);
/*     */   
...
/*  54 */     return this._lineItemAssociationModifierSequence;
/*     */   }
/*     */   
/*     */   public void setLineItemAssociationModifierSequence(Integer argLineItemAssociationModifierSequence) {
/*  58 */     if (changed(argLineItemAssociationModifierSequence, this._lineItemAssociationModifierSequence, "lineItemAssociationModifierSequence")) {
/*  59 */       this._lineItemAssociationModifierSequence = argLineItemAssociationModifierSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 214 */     if (getLineItemAssociationModifierSequence() != null) {
/* 215 */       buf.append("lineItemAssociationModifierSequence").append("=").append(getLineItemAssociationModifierSequence()).append(" ");
/*     */     }
...
/* 264 */     LineItemAssociationModifierPropertyId id = new LineItemAssociationModifierPropertyId();
/* 265 */     id.setBusinessDate(getBusinessDate());
/* 266 */     id.setLineItemAssociationModifierSequence(getLineItemAssociationModifierSequence());
...
/* 277 */     setBusinessDate(((LineItemAssociationModifierPropertyId)argObjectId).getBusinessDate());
/* 278 */     setLineItemAssociationModifierSequence(((LineItemAssociationModifierPropertyId)argObjectId).getLineItemAssociationModifierSequence());
/* 279 */     setOrganizationId(((LineItemAssociationModifierPropertyId)argObjectId).getOrganizationId());
/* 280 */     setRetailLocationId(((LineItemAssociationModifierPropertyId)argObjectId).getRetailLocationId());
/* 281 */     setRetailTransactionLineItemSequence(((LineItemAssociationModifierPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 282 */     setTransactionSequence(((LineItemAssociationModifierPropertyId)argObjectId).getTransactionSequence());
/* 283 */     setWorkstationId(((LineItemAssociationModifierPropertyId)argObjectId).getWorkstationId());
/* 284 */     setPropertyCode(((LineItemAssociationModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"LineItemAssociationModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 303 */     if (this._lineItemAssociationModifierSequence != null) values.put("LineItemAssociationModifierSequence", DaoUtils.getXmlSafeFieldValue(4, this._lineItemAssociationModifierSequence)); 
...
/* 342 */             setLineItemAssociationModifierSequence((Integer)value);
/* 343 */           } catch (Exception ee) {
/* 344 */             throw new DtxException("An exception occurred while calling setLineItemAssociationModifierSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\LineItemAssociationModifierPropertyDAO.class
