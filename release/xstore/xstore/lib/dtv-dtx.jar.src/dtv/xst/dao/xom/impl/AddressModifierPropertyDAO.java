...
/*     */ 
/*     */ 
/*     */ public class AddressModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1388957120L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AddressModifierPropertyDAO.class);
/*     */   
...
/*     */     }
/* 169 */     if (getOrderId() != null) {
/* 170 */       buf.append("orderId").append("=").append(getOrderId()).append(" ");
/*     */     }
...
/* 207 */     AddressModifierPropertyId id = new AddressModifierPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setOrderId(getOrderId());
...
/* 216 */     setOrganizationId(((AddressModifierPropertyId)argObjectId).getOrganizationId());
/* 217 */     setOrderId(((AddressModifierPropertyId)argObjectId).getOrderId());
/* 218 */     setSequence(((AddressModifierPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((AddressModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"AddressModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._orderId != null) values.put("OrderId", DaoUtils.getXmlSafeFieldValue(12, this._orderId)); 
/* 239 */     if (this._sequence != null) values.put("Sequence", DaoUtils.getXmlSafeFieldValue(-5, this._sequence)); 
...
/* 273 */             setOrderId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setOrderId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "Sequence":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\AddressModifierPropertyDAO.class
