...
/*    */ 
/*    */ 
/*    */ public class CustomerItemAccountDetailPropertiesRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(4);
/*    */   
/*    */   public String getSelect() {
/* 22 */     return "SELECT organization_id, cust_acct_id, cust_acct_code, cust_item_acct_detail_item_nbr, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id FROM cat_cust_item_acct_detail_p WHERE organization_id = ? AND cust_acct_id = ? AND cust_acct_code = ? AND cust_item_acct_detail_item_nbr = ?";
/*    */   }
/*    */ 
/*    */   
/*    */   public void setParent(IDataAccessObject argDAO) {
/* 27 */     CustomerItemAccountDetailDAO dao = (CustomerItemAccountDetailDAO)argDAO;
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerItemAccountDetailPropertiesRelationshipDBA.class
