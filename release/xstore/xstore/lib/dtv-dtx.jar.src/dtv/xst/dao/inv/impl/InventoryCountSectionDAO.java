...
/*     */ 
/*     */ 
/*     */ public class InventoryCountSectionDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 2004539954L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryCountSectionDAO.class);
/*     */   
...
/*  61 */     if (changed(argInventoryBucketId, this._inventoryBucketId, "inventoryBucketId")) {
...
/*  67 */     return this._sectionId;
/*     */   }
/*     */   
/*     */   public void setSectionId(String argSectionId) {
/*  71 */     if (changed(argSectionId, this._sectionId, "sectionId")) {
/*  72 */       this._sectionId = (argSectionId != null && MANAGE_CASE) ? argSectionId.toUpperCase() : argSectionId;
/*     */     }
/*     */   }
/*     */   
...
/* 129 */     return this._inventoryBucketName;
/*     */   }
/*     */   
/*     */   public void setInventoryBucketName(String argInventoryBucketName) {
/* 133 */     if (changed(argInventoryBucketName, this._inventoryBucketName, "inventoryBucketName")) {
/* 134 */       this._inventoryBucketName = argInventoryBucketName;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 149 */     if (getInventoryBucketId() != null) {
/* 150 */       buf.append("inventoryBucketId").append("=").append(getInventoryBucketId()).append(" ");
/*     */     }
/* 152 */     if (getSectionId() != null) {
/* 153 */       buf.append("sectionId").append("=").append(getSectionId()).append(" ");
/*     */     }
...
/*     */     }
/* 170 */     if (getInventoryBucketName() != null) {
/* 171 */       buf.append("inventoryBucketName").append("=").append(getInventoryBucketName()).append(" ");
/*     */     }
/*     */     
...
/* 178 */     InventoryCountSectionId id = new InventoryCountSectionId();
/* 179 */     id.setOrganizationId(getOrganizationId());
/* 180 */     id.setRetailLocationId(getRetailLocationId());
/* 181 */     id.setInventoryBucketId(getInventoryBucketId());
/* 182 */     id.setSectionId(getSectionId());
/* 183 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 187 */     setOrganizationId(((InventoryCountSectionId)argObjectId).getOrganizationId());
/* 188 */     setRetailLocationId(((InventoryCountSectionId)argObjectId).getRetailLocationId());
/* 189 */     setInventoryBucketId(((InventoryCountSectionId)argObjectId).getInventoryBucketId());
/* 190 */     setSectionId(((InventoryCountSectionId)argObjectId).getSectionId());
/*     */   }
/*     */   
...
/* 199 */     buf.append("<").append("dao").append(" name=\"InventoryCountSection\" cmd=\"" + getObjectStateString() + "\">");
...
/* 210 */     if (this._inventoryBucketId != null) values.put("InventoryBucketId", DaoUtils.getXmlSafeFieldValue(12, this._inventoryBucketId)); 
/* 211 */     if (this._sectionId != null) values.put("SectionId", DaoUtils.getXmlSafeFieldValue(12, this._sectionId)); 
...
/* 216 */     if (this._sortOrder != null) values.put("SortOrder", DaoUtils.getXmlSafeFieldValue(4, this._sortOrder)); 
/* 217 */     if (this._inventoryBucketName != null) values.put("InventoryBucketName", DaoUtils.getXmlSafeFieldValue(12, this._inventoryBucketName)); 
/* 218 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/* 251 */             setInventoryBucketId((String)value);
/* 252 */           } catch (Exception ee) {
/* 253 */             throw new DtxException("An exception occurred while calling setInventoryBucketId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "SectionId":
...
/* 260 */             setSectionId((String)value);
/* 261 */           } catch (Exception ee) {
/* 262 */             throw new DtxException("An exception occurred while calling setSectionId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CreateDate":
...
/* 305 */             setSortOrder((Integer)value);
/* 306 */           } catch (Exception ee) {
/* 307 */             throw new DtxException("An exception occurred while calling setSortOrder() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 314 */             setInventoryBucketName((String)value);
/* 315 */           } catch (Exception ee) {
/* 316 */             throw new DtxException("An exception occurred while calling setInventoryBucketName() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountSectionDAO.class
