...
/*     */ 
/*     */ 
/*     */ public class TaxAuthorityPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITaxAuthorityProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TaxAuthorityPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TaxAuthorityPropertyDAO getDAO_() {
/*  44 */     return (TaxAuthorityPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITaxAuthorityProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getTaxAuthorityId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setTaxAuthorityId_noev(argTaxAuthorityId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ITaxAuthorityProperty.SET_TAXAUTHORITYID, argTaxAuthorityId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getTaxAuthorityId() == null && argTaxAuthorityId != null) || (
/* 112 */       getDAO_().getTaxAuthorityId() != null && !getDAO_().getTaxAuthorityId().equals(argTaxAuthorityId))) {
/* 113 */       getDAO_().setTaxAuthorityId(argTaxAuthorityId);
...
/* 136 */       this._events.post(ITaxAuthorityProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 170 */       this._events.post(ITaxAuthorityProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(ITaxAuthorityProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(ITaxAuthorityProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(ITaxAuthorityProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(ITaxAuthorityProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(ITaxAuthorityProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(ITaxAuthorityProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(ITaxAuthorityProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 429 */     if ("TaxAuthorityPropertyExtension".equals(argFieldId)) {
...
/* 439 */     if ("TaxAuthorityPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxAuthorityPropertyModel.class
