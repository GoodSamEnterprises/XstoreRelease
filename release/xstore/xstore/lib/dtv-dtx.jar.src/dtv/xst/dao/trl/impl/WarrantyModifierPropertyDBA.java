...
/*     */ 
/*     */ 
/*     */ public class WarrantyModifierPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.business_date, t.organization_id, t.rtl_loc_id, t.rtrans_lineitm_seq, t.trans_seq, t.wkstn_id, t.warranty_modifier_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trl_warranty_modifier_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE business_date = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND wkstn_id = ?  AND warranty_modifier_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  49 */     return "SELECT t.business_date, t.organization_id, t.rtl_loc_id, t.rtrans_lineitm_seq, t.trans_seq, t.wkstn_id, t.warranty_modifier_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trl_warranty_modifier_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  55 */     return " WHERE business_date = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND wkstn_id = ?  AND warranty_modifier_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  58 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trl_warranty_modifier_p(business_date, organization_id, rtl_loc_id, rtrans_lineitm_seq, trans_seq, wkstn_id, warranty_modifier_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  65 */     Object[][] insertParameterObject = { { this._businessDate, this._organizationId, this._retailLocationId, this._retailTransactionLineItemSequence, this._transactionSequence, this._workstationId, this._warrantyModifierSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  66 */     return insertParameterObject;
/*     */   }
/*     */   
/*  69 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { 91, -5, -5, 4, -5, -5, 4, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  72 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  75 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trl_warranty_modifier_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  91 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trl_warranty_modifier_p" }; private static final String WHERE_OBJECT = " WHERE business_date = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND wkstn_id = ?  AND warranty_modifier_seq = ?  AND property_code = ?  ";
/*     */   
...
/* 100 */     return " WHERE business_date = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND wkstn_id = ?  AND warranty_modifier_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 103 */     return new Object[] { this._businessDate, this._organizationId, this._retailLocationId, this._retailTransactionLineItemSequence, this._transactionSequence, this._workstationId, this._warrantyModifierSequence, this._propertyCode };
/*     */   }
/*     */   
/* 106 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { 91, -5, -5, 4, -5, -5, 4, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 109 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 112 */     return "trl_warranty_modifier_p";
/*     */   }
/*     */   
...
/* 120 */     return new WarrantyModifierPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class WarrantyModifierPropertyFiller
/*     */     implements IFiller {
/*     */     private WarrantyModifierPropertyDBA _parent;
/*     */     
/*     */     public WarrantyModifierPropertyFiller(WarrantyModifierPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 142 */       long l2 = argResultSet.getLong(2);
/* 143 */       if (l2 != 0L || argResultSet.getObject(2) != null) {
/* 144 */         this._parent._organizationId = Long.valueOf(l2);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 150 */       l2 = argResultSet.getLong(3);
/* 151 */       if (l2 != 0L || argResultSet.getObject(3) != null) {
/* 152 */         this._parent._retailLocationId = Long.valueOf(l2);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 182 */       int primitiveResult = argResultSet.getInt(7);
/* 183 */       if (primitiveResult != 0 || argResultSet.getObject(7) != null) {
/* 184 */         this._parent._warrantyModifierSequence = Integer.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 226 */     WarrantyModifierPropertyDAO dao = (WarrantyModifierPropertyDAO)argDAO;
...
/* 233 */     dao.setWarrantyModifierSequence(this._warrantyModifierSequence);
...
/* 248 */     return loadDAO((IDataAccessObject)new WarrantyModifierPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 252 */     WarrantyModifierPropertyDAO dao = (WarrantyModifierPropertyDAO)argDAO;
...
/* 259 */     this._warrantyModifierSequence = dao.getWarrantyModifierSequence();
...
/* 272 */     WarrantyModifierPropertyId id = (WarrantyModifierPropertyId)argId;
...
/* 279 */     argStatement.setInt(7, id.getWarrantyModifierSequence().intValue());
/* 280 */     argStatement.setString(8, id.getPropertyCode());
/* 281 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 285 */     WarrantyModifierPropertyId id = new WarrantyModifierPropertyId();
...
/* 292 */     id.setWarrantyModifierSequence(this._warrantyModifierSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\WarrantyModifierPropertyDBA.class
