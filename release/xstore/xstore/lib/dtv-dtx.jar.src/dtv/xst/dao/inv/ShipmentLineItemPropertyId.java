...
/*     */ 
/*     */ 
/*     */ public class ShipmentLineItemPropertyId
...
/*     */   
/*     */   public ShipmentLineItemPropertyId() {}
/*     */   
/*     */   public ShipmentLineItemPropertyId(String argObjectIdValue) {
...
/*  58 */     return this._shipmentSequence;
/*     */   }
/*     */   
/*     */   public void setShipmentSequence(Integer argShipmentSequence) {
/*  62 */     this._shipmentSequence = argShipmentSequence;
/*     */   }
/*     */   
/*     */   public Integer getLineItemSequence() {
/*  66 */     return this._lineItemSequence;
/*     */   }
/*     */   
/*     */   public void setLineItemSequence(Integer argLineItemSequence) {
/*  70 */     this._lineItemSequence = argLineItemSequence;
/*     */   }
/*     */   
...
/* 110 */       str = tokens[4];
/*     */       
/* 112 */       setShipmentSequence(Integer.valueOf(str));
/* 113 */       str = tokens[5];
/*     */       
/* 115 */       setLineItemSequence(Integer.valueOf(str));
/* 116 */       str = tokens[6];
/*     */       
...
/* 133 */       return true;
/*     */     }
/* 135 */     if (!(ob instanceof ShipmentLineItemPropertyId)) {
/* 136 */       return false;
/*     */     }
/* 138 */     ShipmentLineItemPropertyId other = (ShipmentLineItemPropertyId)ob;
...
/*     */ 
/*     */       
/* 151 */       .equals(other._documentTypeCode))) && ((this._shipmentSequence == null && other._shipmentSequence == null) || (this._shipmentSequence != null && this._shipmentSequence
/*     */ 
/*     */       
/* 154 */       .equals(other._shipmentSequence))) && ((this._lineItemSequence == null && other._lineItemSequence == null) || (this._lineItemSequence != null && this._lineItemSequence
/*     */ 
/*     */       
/* 157 */       .equals(other._lineItemSequence))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 170 */       .hashCode()) + ((this._shipmentSequence == null) ? 0 : this._shipmentSequence
/* 171 */       .hashCode()) + ((this._lineItemSequence == null) ? 0 : this._lineItemSequence
...
/* 178 */     return "ShipmentLineItemProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 190 */       .append("::").append(String.valueOf(this._shipmentSequence))
/* 191 */       .append("::").append(String.valueOf(this._lineItemSequence))
...
/* 204 */       return false;
/*     */     }
/* 206 */     if (this._shipmentSequence == null) {
/* 207 */       return false;
/*     */     }
/* 209 */     if (this._lineItemSequence == null) {
/* 210 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\ShipmentLineItemPropertyId.class
