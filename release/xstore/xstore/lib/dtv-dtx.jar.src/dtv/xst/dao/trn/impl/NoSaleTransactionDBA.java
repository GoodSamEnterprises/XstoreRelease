...
/*     */ 
/*     */ 
/*     */ public class NoSaleTransactionDBA
...
/*     */   private String _noSaleReasonCode;
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.create_date, t.create_user_id, t.update_date, t.update_user_id, t.no_sale_reascode FROM trn_no_sale_trans t";
...
/*  44 */     return "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.create_date, t.create_user_id, t.update_date, t.update_user_id, t.no_sale_reascode FROM trn_no_sale_trans t";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trn_no_sale_trans(organization_id, rtl_loc_id, business_date, wkstn_id, trans_seq, create_date, create_user_id, update_date, update_user_id, no_sale_reascode) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */ 
/*     */   
...
/*  63 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._businessDate, this._workstationId, this._transactionSequence, this._createDate, this._createUserId, this._updateDate, this._updateUserId, this._noSaleReasonCode } };
...
/*     */   }
/*     */   
/*  74 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trn_no_sale_trans SET update_date = ?, update_user_id = ?, no_sale_reascode = ?" };
/*     */ 
/*     */   
...
/*  83 */     Object[][] updateParameterObject = { { this._updateDate, this._updateUserId, this._noSaleReasonCode } };
...
/*     */   }
/*     */   
/*  93 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trn_no_sale_trans" };
...
/* 128 */     return new NoSaleTransactionFiller(this);
/*     */   }
/*     */   
/*     */   private static class NoSaleTransactionFiller
/*     */     implements IFiller {
/*     */     private NoSaleTransactionDBA _parent;
/*     */     
/*     */     public NoSaleTransactionFiller(NoSaleTransactionDBA argParent) {
...
/* 200 */       this._parent._noSaleReasonCode = argResultSet.getString(10);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 208 */     NoSaleTransactionDAO dao = (NoSaleTransactionDAO)argDAO;
...
/* 218 */     dao.setNoSaleReasonCode(this._noSaleReasonCode);
...
/* 225 */     return loadDAO((IDataAccessObject)new NoSaleTransactionDAO());
/*     */   }
/*     */ 
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 230 */     NoSaleTransactionDAO dao = (NoSaleTransactionDAO)argDAO;
...
/* 241 */     this._noSaleReasonCode = dao.getNoSaleReasonCode();
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\NoSaleTransactionDBA.class
