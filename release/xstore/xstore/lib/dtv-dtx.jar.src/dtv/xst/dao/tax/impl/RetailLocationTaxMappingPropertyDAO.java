...
/*     */ 
/*     */ 
/*     */ public class RetailLocationTaxMappingPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1098107472L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RetailLocationTaxMappingPropertyDAO.class);
/*     */   
...
/* 193 */     RetailLocationTaxMappingPropertyId id = new RetailLocationTaxMappingPropertyId();
...
/* 201 */     setOrganizationId(((RetailLocationTaxMappingPropertyId)argObjectId).getOrganizationId());
/* 202 */     setRetailLocationId(((RetailLocationTaxMappingPropertyId)argObjectId).getRetailLocationId());
/* 203 */     setPropertyCode(((RetailLocationTaxMappingPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"RetailLocationTaxMappingProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._retailLocationId != null) values.put("RetailLocationId", DaoUtils.getXmlSafeFieldValue(-5, this._retailLocationId)); 
...
/* 256 */             setRetailLocationId((Long)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setRetailLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\RetailLocationTaxMappingPropertyDAO.class
