...
/*     */ 
/*     */ 
/*     */ public class LineItemAssociationModifierId
...
/*     */   
/*     */   public LineItemAssociationModifierId() {}
/*     */   
/*     */   public LineItemAssociationModifierId(String argObjectIdValue) {
...
/*  45 */     return this._lineItemAssociationModifierSequence;
/*     */   }
/*     */   
/*     */   public void setLineItemAssociationModifierSequence(Integer argLineItemAssociationModifierSequence) {
/*  49 */     this._lineItemAssociationModifierSequence = argLineItemAssociationModifierSequence;
/*     */   }
/*     */   
...
/* 100 */       str = tokens[1];
/*     */       
/* 102 */       setLineItemAssociationModifierSequence(Integer.valueOf(str));
/* 103 */       str = tokens[2];
/*     */       
...
/* 127 */       return true;
/*     */     }
/* 129 */     if (!(ob instanceof LineItemAssociationModifierId)) {
/* 130 */       return false;
/*     */     }
/* 132 */     LineItemAssociationModifierId other = (LineItemAssociationModifierId)ob;
/* 133 */     return (((this._businessDate == null && other._businessDate == null) || (this._businessDate != null && this._businessDate
/*     */ 
/*     */       
/* 136 */       .equals(other._businessDate))) && ((this._lineItemAssociationModifierSequence == null && other._lineItemAssociationModifierSequence == null) || (this._lineItemAssociationModifierSequence != null && this._lineItemAssociationModifierSequence
/*     */ 
/*     */       
/* 139 */       .equals(other._lineItemAssociationModifierSequence))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/*     */ 
/*     */       
/* 145 */       .equals(other._retailLocationId))) && ((this._retailTransactionLineItemSequence == null && other._retailTransactionLineItemSequence == null) || (this._retailTransactionLineItemSequence != null && this._retailTransactionLineItemSequence
/*     */ 
/*     */       
...
/* 161 */       .hashCode()) + ((this._lineItemAssociationModifierSequence == null) ? 0 : this._lineItemAssociationModifierSequence
/* 162 */       .hashCode()) + ((this._organizationId == null) ? 0 : this._organizationId
/* 163 */       .hashCode()) + ((this._retailLocationId == null) ? 0 : this._retailLocationId
...
/* 172 */     return "LineItemAssociationModifier";
/*     */   }
/*     */ 
/*     */   
...
/* 181 */       .append("::").append(String.valueOf(this._lineItemAssociationModifierSequence))
/* 182 */       .append("::").append(String.valueOf(this._organizationId))
/* 183 */       .append("::").append(String.valueOf(this._retailLocationId))
...
/* 192 */       return false;
/*     */     }
/* 194 */     if (this._lineItemAssociationModifierSequence == null) {
/* 195 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\LineItemAssociationModifierId.class
