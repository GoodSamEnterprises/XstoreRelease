...
/*     */ 
/*     */ 
/*     */ public class PayrollCategoryPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IPayrollCategoryProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new PayrollCategoryPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private PayrollCategoryPropertyDAO getDAO_() {
/*  44 */     return (PayrollCategoryPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IPayrollCategoryProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getPayrollCategory();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setPayrollCategory_noev(argPayrollCategory) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IPayrollCategoryProperty.SET_PAYROLLCATEGORY, argPayrollCategory);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getPayrollCategory() == null && argPayrollCategory != null) || (
/* 112 */       getDAO_().getPayrollCategory() != null && !getDAO_().getPayrollCategory().equals(argPayrollCategory))) {
/* 113 */       getDAO_().setPayrollCategory(argPayrollCategory);
...
/* 136 */       this._events.post(IPayrollCategoryProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 170 */       this._events.post(IPayrollCategoryProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IPayrollCategoryProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IPayrollCategoryProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IPayrollCategoryProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IPayrollCategoryProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IPayrollCategoryProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IPayrollCategoryProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IPayrollCategoryProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 429 */     if ("PayrollCategoryPropertyExtension".equals(argFieldId)) {
...
/* 439 */     if ("PayrollCategoryPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\impl\PayrollCategoryPropertyModel.class
