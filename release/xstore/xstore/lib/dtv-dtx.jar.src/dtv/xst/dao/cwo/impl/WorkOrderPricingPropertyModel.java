...
/*     */ 
/*     */ 
/*     */ public class WorkOrderPricingPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IWorkOrderPricingProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new WorkOrderPricingPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private WorkOrderPricingPropertyDAO getDAO_() {
/*  44 */     return (WorkOrderPricingPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IWorkOrderPricingProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getPriceCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setPriceCode_noev(argPriceCode) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IWorkOrderPricingProperty.SET_PRICECODE, argPriceCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getPriceCode() == null && argPriceCode != null) || (
/* 112 */       getDAO_().getPriceCode() != null && !getDAO_().getPriceCode().equals(argPriceCode))) {
/* 113 */       getDAO_().setPriceCode(argPriceCode);
...
/* 136 */       this._events.post(IWorkOrderPricingProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 170 */       this._events.post(IWorkOrderPricingProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IWorkOrderPricingProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IWorkOrderPricingProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IWorkOrderPricingProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IWorkOrderPricingProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IWorkOrderPricingProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IWorkOrderPricingProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IWorkOrderPricingProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IWorkOrderPricingProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("WorkOrderPricingPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("WorkOrderPricingPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkOrderPricingPropertyModel.class
