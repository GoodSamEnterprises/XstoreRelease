...
/*     */ import dtv.xst.dao.itm.IItemMessageTypesProperty;
/*     */ import dtv.xst.dao.itm.ItemMessageTypesPropertyId;
...
/*     */ 
/*     */ public class ItemMessageTypesModel extends AbstractDataModelWithPropertyImpl<IItemMessageTypesProperty> implements IItemMessageTypes {
...
/*     */   }
/*     */   private IDataModel _myExtension; private HistoricalList<IItemMessageTypesProperty> _properties; private transient HistoricalList<IItemMessageTypesProperty> _propertiesSavepoint;
/*     */   
/*     */   public void initDAO() {
/*  38 */     setDAO((IDataAccessObject)new ItemMessageTypesDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ItemMessageTypesDAO getDAO_() {
/*  46 */     return (ItemMessageTypesDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */       this._events.post(IItemMessageTypes.SET_MESSAGEID, argMessageId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */         
/*  80 */         Iterator<ItemMessageTypesPropertyModel> it = this._properties.iterator();
/*  81 */         while (it.hasNext())
/*     */         {
/*  83 */           ((ItemMessageTypesPropertyModel)it.next()).setMessageId_noev(argMessageId);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* 112 */       this._events.post(IItemMessageTypes.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */         
/* 127 */         Iterator<ItemMessageTypesPropertyModel> it = this._properties.iterator();
/* 128 */         while (it.hasNext())
/*     */         {
/* 130 */           ((ItemMessageTypesPropertyModel)it.next()).setOrganizationId_noev(argOrganizationId);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* 143 */     return getDAO_().getLineItemType();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 151 */     if (setLineItemType_noev(argLineItemType) && 
/* 152 */       this._events != null && 
/* 153 */       postEventsForChanges()) {
/* 154 */       this._events.post(IItemMessageTypes.SET_LINEITEMTYPE, argLineItemType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public boolean setLineItemType_noev(String argLineItemType) {
/* 161 */     boolean ev_postable = false;
/*     */     
/* 163 */     if ((getDAO_().getLineItemType() == null && argLineItemType != null) || (
/* 164 */       getDAO_().getLineItemType() != null && !getDAO_().getLineItemType().equals(argLineItemType))) {
/* 165 */       getDAO_().setLineItemType(argLineItemType);
/* 166 */       ev_postable = true;
/* 167 */       if (this._properties != null) {
/*     */         
/* 169 */         Iterator<ItemMessageTypesPropertyModel> it = this._properties.iterator();
/* 170 */         while (it.hasNext())
/*     */         {
/* 172 */           ((ItemMessageTypesPropertyModel)it.next()).setLineItemType_noev(argLineItemType);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* 196 */       this._events.post(IItemMessageTypes.SET_ORGCODE, argOrgCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 230 */       this._events.post(IItemMessageTypes.SET_ORGVALUE, argOrgValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 264 */       this._events.post(IItemMessageTypes.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 298 */       this._events.post(IItemMessageTypes.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 332 */       this._events.post(IItemMessageTypes.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 366 */       this._events.post(IItemMessageTypes.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/*     */   protected IItemMessageTypesProperty newProperty(String argPropertyName) {
/* 385 */     ItemMessageTypesPropertyId id = new ItemMessageTypesPropertyId();
/*     */     
/* 387 */     id.setMessageId(getMessageId());
/* 388 */     id.setLineItemType(getLineItemType());
/* 389 */     id.setPropertyCode(argPropertyName);
/*     */     
/* 391 */     IItemMessageTypesProperty prop = (IItemMessageTypesProperty)DataFactory.getInstance().createNewObject((IObjectId)id, IItemMessageTypesProperty.class);
/* 392 */     return prop;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   public List<IItemMessageTypesProperty> getProperties() {
/* 401 */     if (this._properties == null) {
/* 402 */       this._properties = new HistoricalList(null);
/*     */     }
/* 404 */     return (List<IItemMessageTypesProperty>)this._properties;
/*     */   }
/*     */   
/*     */   public void setProperties(List<IItemMessageTypesProperty> argProperties) {
...
/*     */     } 
/*     */     
/* 414 */     for (IItemMessageTypesProperty child : this._properties) {
/* 415 */       ItemMessageTypesPropertyModel model = (ItemMessageTypesPropertyModel)child;
/* 416 */       model.setMessageId_noev(getMessageId());
/* 417 */       model.setOrganizationId_noev(getOrganizationId());
/* 418 */       model.setLineItemType_noev(getLineItemType());
...
/*     */   }
/*     */   
/*     */   public void addItemMessageTypesProperty(IItemMessageTypesProperty argItemMessageTypesProperty) {
/* 433 */     if (this._properties == null) {
/* 434 */       this._properties = new HistoricalList(null);
/*     */     }
/* 436 */     argItemMessageTypesProperty.setMessageId(getMessageId());
/* 437 */     argItemMessageTypesProperty.setOrganizationId(getOrganizationId());
/* 438 */     argItemMessageTypesProperty.setLineItemType(getLineItemType());
/* 439 */     if (argItemMessageTypesProperty instanceof IDataModelImpl) {
/* 440 */       IDataAccessObject childDao = ((IDataModelImpl)argItemMessageTypesProperty).getDAO();
...
/* 449 */       this._eventManager.registerEventHandler((IEventAware)this._eventCascade, (IEventSource)new EventDescriptor(argItemMessageTypesProperty));
/*     */     }
/*     */     
/* 452 */     this._properties.add(argItemMessageTypesProperty);
/* 453 */     if (postEventsForChanges()) {
/* 454 */       this._events.post(IItemMessageTypes.ADD_PROPERTIES, argItemMessageTypesProperty);
/*     */     }
/*     */   }
/*     */   
/*     */   public void removeItemMessageTypesProperty(IItemMessageTypesProperty argItemMessageTypesProperty) {
/* 459 */     if (this._properties != null) {
/*     */       
/* 461 */       if (postEventsForChanges()) {
/* 462 */         this._eventManager.deregisterEventHandler((IEventAware)this._eventCascade, (IEventSource)new EventDescriptor(argItemMessageTypesProperty));
/*     */       }
/* 464 */       this._properties.remove(argItemMessageTypesProperty);
/* 465 */       if (postEventsForChanges()) {
/* 466 */         this._events.post(IItemMessageTypes.REMOVE_PROPERTIES, argItemMessageTypesProperty);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*     */     }
/* 476 */     if ("ItemMessageTypesExtension".equals(argFieldId)) {
...
/* 487 */       setProperties(changeToList(argValue, IItemMessageTypesProperty.class));
/*     */     }
/* 489 */     else if ("ItemMessageTypesExtension".equals(argFieldId)) {
...
/* 505 */       for (IItemMessageTypesProperty relationship : this._properties) {
/* 506 */         ((IDataModelImpl)relationship).setDependencies(argPD, argEM);
/*     */       }
/*     */     }
/*     */   }
/*     */   
/*     */   public IDataModel getItemMessageTypesExt() {
/* 512 */     return this._myExtension;
/*     */   }
/*     */   
/*     */   public void setItemMessageTypesExt(IDataModel argExt) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemMessageTypesModel.class
