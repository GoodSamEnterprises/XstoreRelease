...
/*     */ 
/*     */ 
/*     */ public class InventoryTransactionDetailId
...
/*     */   
/*     */   public InventoryTransactionDetailId() {}
/*     */   
/*     */   public InventoryTransactionDetailId(String argObjectIdValue) {
...
/*  68 */     return this._inventoryDetailSequence;
/*     */   }
/*     */   
/*     */   public void setInventoryDetailSequence(Integer argInventoryDetailSequence) {
/*  72 */     this._inventoryDetailSequence = argInventoryDetailSequence;
/*     */   }
/*     */   
...
/* 103 */       str = tokens[5];
/*     */       
/* 105 */       setInventoryDetailSequence(Integer.valueOf(str));
/*     */     }
...
/* 115 */       return true;
/*     */     }
/* 117 */     if (!(ob instanceof InventoryTransactionDetailId)) {
/* 118 */       return false;
/*     */     }
/* 120 */     InventoryTransactionDetailId other = (InventoryTransactionDetailId)ob;
...
/*     */ 
/*     */       
/* 136 */       .equals(other._transactionSequence))) && ((this._inventoryDetailSequence == null && other._inventoryDetailSequence == null) || (this._inventoryDetailSequence != null && this._inventoryDetailSequence
/*     */ 
/*     */       
/* 139 */       .equals(other._inventoryDetailSequence))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 150 */       .hashCode()) + ((this._inventoryDetailSequence == null) ? 0 : this._inventoryDetailSequence
/* 151 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getDtxTypeName() {
/* 156 */     return "InventoryTransactionDetail";
/*     */   }
/*     */ 
/*     */   
...
/* 169 */       .append("::").append(String.valueOf(this._inventoryDetailSequence))
/* 170 */       .toString();
/*     */   }
/*     */   
...
/* 184 */       return false;
/*     */     }
/* 186 */     if (this._inventoryDetailSequence == null) {
/* 187 */       return false;
/*     */     }
/* 189 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\InventoryTransactionDetailId.class
