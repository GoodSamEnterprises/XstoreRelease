...
/*     */ 
/*     */ 
/*     */ public class SaleTaxModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1325129808L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SaleTaxModifierPropertyDAO.class);
/*     */   
...
/*  84 */     return this._saleTaxModifierSequence;
/*     */   }
/*     */   
/*     */   public void setSaleTaxModifierSequence(Integer argSaleTaxModifierSequence) {
/*  88 */     if (changed(argSaleTaxModifierSequence, this._saleTaxModifierSequence, "saleTaxModifierSequence")) {
/*  89 */       this._saleTaxModifierSequence = argSaleTaxModifierSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 223 */     if (getSaleTaxModifierSequence() != null) {
/* 224 */       buf.append("saleTaxModifierSequence").append("=").append(getSaleTaxModifierSequence()).append(" ");
/*     */     }
...
/* 264 */     SaleTaxModifierPropertyId id = new SaleTaxModifierPropertyId();
...
/* 269 */     id.setSaleTaxModifierSequence(getSaleTaxModifierSequence());
...
/* 277 */     setBusinessDate(((SaleTaxModifierPropertyId)argObjectId).getBusinessDate());
/* 278 */     setOrganizationId(((SaleTaxModifierPropertyId)argObjectId).getOrganizationId());
/* 279 */     setRetailLocationId(((SaleTaxModifierPropertyId)argObjectId).getRetailLocationId());
/* 280 */     setRetailTransactionLineItemSequence(((SaleTaxModifierPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 281 */     setSaleTaxModifierSequence(((SaleTaxModifierPropertyId)argObjectId).getSaleTaxModifierSequence());
/* 282 */     setTransactionSequence(((SaleTaxModifierPropertyId)argObjectId).getTransactionSequence());
/* 283 */     setWorkstationId(((SaleTaxModifierPropertyId)argObjectId).getWorkstationId());
/* 284 */     setPropertyCode(((SaleTaxModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"SaleTaxModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 306 */     if (this._saleTaxModifierSequence != null) values.put("SaleTaxModifierSequence", DaoUtils.getXmlSafeFieldValue(4, this._saleTaxModifierSequence)); 
...
/* 369 */             setSaleTaxModifierSequence((Integer)value);
/* 370 */           } catch (Exception ee) {
/* 371 */             throw new DtxException("An exception occurred while calling setSaleTaxModifierSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\SaleTaxModifierPropertyDAO.class
