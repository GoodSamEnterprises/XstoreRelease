...
/*     */ 
/*     */ 
/*     */ public class EmployeeMessagePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IEmployeeMessageProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new EmployeeMessagePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private EmployeeMessagePropertyDAO getDAO_() {
/*  44 */     return (EmployeeMessagePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IEmployeeMessageProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     if (getDAO_().getMessageId() != null) {
/*  92 */       return getDAO_().getMessageId().longValue();
/*     */     }
/*     */     
/*  95 */     return 0L;
/*     */   }
...
/* 104 */     if (setMessageId_noev(argMessageId) && 
/* 105 */       this._events != null && 
/* 106 */       postEventsForChanges()) {
/* 107 */       this._events.post(IEmployeeMessageProperty.SET_MESSAGEID, Long.valueOf(argMessageId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 116 */     if ((getDAO_().getMessageId() == null && Long.valueOf(argMessageId) != null) || (
/* 117 */       getDAO_().getMessageId() != null && !getDAO_().getMessageId().equals(Long.valueOf(argMessageId)))) {
/* 118 */       getDAO_().setMessageId(Long.valueOf(argMessageId));
...
/* 141 */       this._events.post(IEmployeeMessageProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 175 */       this._events.post(IEmployeeMessageProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(IEmployeeMessageProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IEmployeeMessageProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IEmployeeMessageProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IEmployeeMessageProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IEmployeeMessageProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IEmployeeMessageProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IEmployeeMessageProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 434 */     if ("EmployeeMessagePropertyExtension".equals(argFieldId)) {
...
/* 444 */     if ("EmployeeMessagePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeMessagePropertyModel.class
