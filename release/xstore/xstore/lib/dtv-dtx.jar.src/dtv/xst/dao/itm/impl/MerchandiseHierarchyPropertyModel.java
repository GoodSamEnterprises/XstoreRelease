...
/*     */ 
/*     */ 
/*     */ public class MerchandiseHierarchyPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IMerchandiseHierarchyProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new MerchandiseHierarchyPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private MerchandiseHierarchyPropertyDAO getDAO_() {
/*  44 */     return (MerchandiseHierarchyPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  52 */     return getDAO_().getHierarchyId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     if (setHierarchyId_noev(argHierarchyId) && 
/*  61 */       this._events != null && 
/*  62 */       postEventsForChanges()) {
/*  63 */       this._events.post(IMerchandiseHierarchyProperty.SET_HIERARCHYID, argHierarchyId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*  72 */     if ((getDAO_().getHierarchyId() == null && argHierarchyId != null) || (
/*  73 */       getDAO_().getHierarchyId() != null && !getDAO_().getHierarchyId().equals(argHierarchyId))) {
/*  74 */       getDAO_().setHierarchyId(argHierarchyId);
/*  75 */       ev_postable = true;
/*     */     } 
/*     */     
...
/* 102 */       this._events.post(IMerchandiseHierarchyProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 136 */       this._events.post(IMerchandiseHierarchyProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 170 */       this._events.post(IMerchandiseHierarchyProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IMerchandiseHierarchyProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IMerchandiseHierarchyProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IMerchandiseHierarchyProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IMerchandiseHierarchyProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IMerchandiseHierarchyProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IMerchandiseHierarchyProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IMerchandiseHierarchyProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 429 */     if ("MerchandiseHierarchyPropertyExtension".equals(argFieldId)) {
...
/* 439 */     if ("MerchandiseHierarchyPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\MerchandiseHierarchyPropertyModel.class
