...
/*     */ 
/*     */ 
/*     */ public class CustomizationModifierPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ICustomizationModifierProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new CustomizationModifierPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private CustomizationModifierPropertyDAO getDAO_() {
/*  44 */     return (CustomizationModifierPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ICustomizationModifierProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(ICustomizationModifierProperty.SET_ORDERID, argOrderId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 141 */       this._events.post(ICustomizationModifierProperty.SET_SEQUENCE, Integer.valueOf(argSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 164 */     if (getDAO_().getModSequence() != null) {
/* 165 */       return getDAO_().getModSequence().intValue();
/*     */     }
/*     */     
/* 168 */     return 0;
/*     */   }
...
/* 177 */     if (setModSequence_noev(argModSequence) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(ICustomizationModifierProperty.SET_MODSEQUENCE, Integer.valueOf(argModSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getModSequence() == null && Integer.valueOf(argModSequence) != null) || (
/* 190 */       getDAO_().getModSequence() != null && !getDAO_().getModSequence().equals(Integer.valueOf(argModSequence)))) {
/* 191 */       getDAO_().setModSequence(Integer.valueOf(argModSequence));
...
/* 214 */       this._events.post(ICustomizationModifierProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 248 */       this._events.post(ICustomizationModifierProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(ICustomizationModifierProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(ICustomizationModifierProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(ICustomizationModifierProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(ICustomizationModifierProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(ICustomizationModifierProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(ICustomizationModifierProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(ICustomizationModifierProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 507 */     if ("CustomizationModifierPropertyExtension".equals(argFieldId)) {
...
/* 517 */     if ("CustomizationModifierPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\CustomizationModifierPropertyModel.class
