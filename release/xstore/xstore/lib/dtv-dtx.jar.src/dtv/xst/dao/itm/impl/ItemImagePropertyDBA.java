...
/*     */ 
/*     */ 
/*     */ public class ItemImagePropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 459615197L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.item_id, t.feature_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_images_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND feature_id = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.item_id, t.feature_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_images_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND item_id = ?  AND feature_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_item_images_p(organization_id, item_id, feature_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._itemId, this._featureId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_item_images_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_item_images_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND feature_id = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND item_id = ?  AND feature_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._itemId, this._featureId, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new ItemImagePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ItemImagePropertyFiller
/*     */     implements IFiller {
/*     */     private ItemImagePropertyDBA _parent;
/*     */     
/*     */     public ItemImagePropertyFiller(ItemImagePropertyDBA argParent) {
...
/* 136 */       this._parent._featureId = argResultSet.getString(3);
...
/* 175 */     ItemImagePropertyDAO dao = (ItemImagePropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setItemId(this._itemId);
/* 178 */     dao.setFeatureId(this._featureId);
...
/* 193 */     return loadDAO((IDataAccessObject)new ItemImagePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     ItemImagePropertyDAO dao = (ItemImagePropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._itemId = dao.getItemId();
/* 200 */     this._featureId = dao.getFeatureId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemImagePropertyDBA.class
