...
/*     */ 
/*     */ 
/*     */ public class WarrantyModifierId
...
/*     */   
/*     */   public WarrantyModifierId() {}
/*     */   
/*     */   public WarrantyModifierId(String argObjectIdValue) {
...
/*  77 */     return this._warrantyModifierSequence;
/*     */   }
/*     */   
/*     */   public void setWarrantyModifierSequence(Integer argWarrantyModifierSequence) {
/*  81 */     this._warrantyModifierSequence = argWarrantyModifierSequence;
/*     */   }
/*     */   
...
/* 115 */       str = tokens[6];
/*     */       
/* 117 */       setWarrantyModifierSequence(Integer.valueOf(str));
/*     */     }
...
/* 127 */       return true;
/*     */     }
/* 129 */     if (!(ob instanceof WarrantyModifierId)) {
/* 130 */       return false;
/*     */     }
/* 132 */     WarrantyModifierId other = (WarrantyModifierId)ob;
...
/*     */ 
/*     */       
/* 151 */       .equals(other._workstationId))) && ((this._warrantyModifierSequence == null && other._warrantyModifierSequence == null) || (this._warrantyModifierSequence != null && this._warrantyModifierSequence
/*     */ 
/*     */       
/* 154 */       .equals(other._warrantyModifierSequence))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 166 */       .hashCode()) + ((this._warrantyModifierSequence == null) ? 0 : this._warrantyModifierSequence
/* 167 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getDtxTypeName() {
/* 172 */     return "WarrantyModifier";
/*     */   }
/*     */ 
/*     */   
...
/* 186 */       .append("::").append(String.valueOf(this._warrantyModifierSequence))
/* 187 */       .toString();
/*     */   }
/*     */   
...
/* 204 */       return false;
/*     */     }
/* 206 */     if (this._warrantyModifierSequence == null) {
/* 207 */       return false;
/*     */     }
/* 209 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\WarrantyModifierId.class
