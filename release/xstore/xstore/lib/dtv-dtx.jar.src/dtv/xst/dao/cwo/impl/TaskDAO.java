...
/*     */ import dtv.xst.dao.itm.impl.NonPhysicalItemDAO;
...
/*  23 */   private static final Logger _logger = Logger.getLogger(TaskDAO.class);
/*     */   
...
/*  75 */     return this._categoryId;
/*     */   }
/*     */   
/*     */   public void setCategoryId(String argCategoryId) {
/*  79 */     if (changed(argCategoryId, this._categoryId, "categoryId")) {
/*  80 */       this._categoryId = argCategoryId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getPriceType() {
/*  85 */     return this._priceType;
/*     */   }
/*     */   
/*     */   public void setPriceType(String argPriceType) {
/*  89 */     if (changed(argPriceType, this._priceType, "priceType")) {
/*  90 */       this._priceType = argPriceType;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 111 */     if (getCategoryId() != null) {
/* 112 */       buf.append("categoryId").append("=").append(getCategoryId()).append(" ");
/*     */     }
/* 114 */     if (getPriceType() != null) {
/* 115 */       buf.append("priceType").append("=").append(getPriceType()).append(" ");
/*     */     }
/*     */     
...
/* 123 */     StringBuilder buf = new StringBuilder(2100);
/* 124 */     buf.append("<").append("dao").append(" name=\"Task\" cmd=\"" + getObjectStateString() + "\">");
...
/* 137 */     if (this._categoryId != null) values.put("CategoryId", DaoUtils.getXmlSafeFieldValue(12, this._categoryId)); 
/* 138 */     if (this._priceType != null) values.put("PriceType", DaoUtils.getXmlSafeFieldValue(12, this._priceType)); 
/* 139 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/* 190 */             setCategoryId((String)value);
/* 191 */           } catch (Exception ee) {
/* 192 */             throw new DtxException("An exception occurred while calling setCategoryId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PriceType":
...
/* 199 */             setPriceType((String)value);
/* 200 */           } catch (Exception ee) {
/* 201 */             throw new DtxException("An exception occurred while calling setPriceType() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\TaskDAO.class
