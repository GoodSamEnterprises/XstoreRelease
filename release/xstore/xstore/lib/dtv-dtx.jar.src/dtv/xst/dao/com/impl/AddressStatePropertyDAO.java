...
/*     */ 
/*     */ 
/*     */ public class AddressStatePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -493438446L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AddressStatePropertyDAO.class);
/*     */   
...
/*  60 */     return this._stateId;
/*     */   }
/*     */   
/*     */   public void setStateId(String argStateId) {
/*  64 */     if (changed(argStateId, this._stateId, "stateId")) {
/*  65 */       this._stateId = (argStateId != null && MANAGE_CASE) ? argStateId.toUpperCase() : argStateId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 183 */     if (getStateId() != null) {
/* 184 */       buf.append("stateId").append("=").append(getStateId()).append(" ");
/*     */     }
...
/* 221 */     AddressStatePropertyId id = new AddressStatePropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setCountryId(getCountryId());
/* 224 */     id.setStateId(getStateId());
...
/* 231 */     setOrganizationId(((AddressStatePropertyId)argObjectId).getOrganizationId());
/* 232 */     setCountryId(((AddressStatePropertyId)argObjectId).getCountryId());
/* 233 */     setStateId(((AddressStatePropertyId)argObjectId).getStateId());
/* 234 */     setAddressMode(((AddressStatePropertyId)argObjectId).getAddressMode());
/* 235 */     setPropertyCode(((AddressStatePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"AddressStateProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._stateId != null) values.put("StateId", DaoUtils.getXmlSafeFieldValue(12, this._stateId)); 
...
/* 299 */             setStateId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setStateId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "AddressMode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AddressStatePropertyDAO.class
