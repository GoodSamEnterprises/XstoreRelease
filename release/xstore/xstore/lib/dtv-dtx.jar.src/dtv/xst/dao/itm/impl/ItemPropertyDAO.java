...
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemPropertyDAO.class);
/*     */   
...
/* 193 */     ItemPropertyId id = new ItemPropertyId();
...
/* 201 */     setOrganizationId(((ItemPropertyId)argObjectId).getOrganizationId());
/* 202 */     setItemId(((ItemPropertyId)argObjectId).getItemId());
/* 203 */     setPropertyCode(((ItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemPropertyDAO.class
