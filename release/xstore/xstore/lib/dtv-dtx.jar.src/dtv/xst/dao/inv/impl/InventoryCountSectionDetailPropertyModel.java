...
/*     */ 
/*     */ 
/*     */ public class InventoryCountSectionDetailPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IInventoryCountSectionDetailProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new InventoryCountSectionDetailPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private InventoryCountSectionDetailPropertyDAO getDAO_() {
/*  44 */     return (InventoryCountSectionDetailPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IInventoryCountSectionDetailProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IInventoryCountSectionDetailProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     return getDAO_().getInventoryBucketId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 138 */     if (setInventoryBucketId_noev(argInventoryBucketId) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IInventoryCountSectionDetailProperty.SET_INVENTORYBUCKETID, argInventoryBucketId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getInventoryBucketId() == null && argInventoryBucketId != null) || (
/* 151 */       getDAO_().getInventoryBucketId() != null && !getDAO_().getInventoryBucketId().equals(argInventoryBucketId))) {
/* 152 */       getDAO_().setInventoryBucketId(argInventoryBucketId);
...
/* 164 */     return getDAO_().getSectionId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */     if (setSectionId_noev(argSectionId) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IInventoryCountSectionDetailProperty.SET_SECTIONID, argSectionId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getSectionId() == null && argSectionId != null) || (
/* 185 */       getDAO_().getSectionId() != null && !getDAO_().getSectionId().equals(argSectionId))) {
/* 186 */       getDAO_().setSectionId(argSectionId);
...
/* 198 */     if (getDAO_().getSectionDetailNumber() != null) {
/* 199 */       return getDAO_().getSectionDetailNumber().intValue();
/*     */     }
/*     */     
/* 202 */     return 0;
/*     */   }
...
/* 211 */     if (setSectionDetailNumber_noev(argSectionDetailNumber) && 
/* 212 */       this._events != null && 
/* 213 */       postEventsForChanges()) {
/* 214 */       this._events.post(IInventoryCountSectionDetailProperty.SET_SECTIONDETAILNUMBER, Integer.valueOf(argSectionDetailNumber));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 223 */     if ((getDAO_().getSectionDetailNumber() == null && Integer.valueOf(argSectionDetailNumber) != null) || (
/* 224 */       getDAO_().getSectionDetailNumber() != null && !getDAO_().getSectionDetailNumber().equals(Integer.valueOf(argSectionDetailNumber)))) {
/* 225 */       getDAO_().setSectionDetailNumber(Integer.valueOf(argSectionDetailNumber));
...
/* 248 */       this._events.post(IInventoryCountSectionDetailProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(IInventoryCountSectionDetailProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(IInventoryCountSectionDetailProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(IInventoryCountSectionDetailProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(IInventoryCountSectionDetailProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(IInventoryCountSectionDetailProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(IInventoryCountSectionDetailProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(IInventoryCountSectionDetailProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 520 */       this._events.post(IInventoryCountSectionDetailProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 541 */     if ("InventoryCountSectionDetailPropertyExtension".equals(argFieldId)) {
...
/* 551 */     if ("InventoryCountSectionDetailPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountSectionDetailPropertyModel.class
