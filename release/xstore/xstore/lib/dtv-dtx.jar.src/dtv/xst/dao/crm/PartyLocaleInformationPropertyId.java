...
/*     */ 
/*     */ 
/*     */ public class PartyLocaleInformationPropertyId
...
/*     */   
/*     */   public PartyLocaleInformationPropertyId() {}
/*     */   
/*     */   public PartyLocaleInformationPropertyId(String argObjectIdValue) {
...
/*  67 */       str = tokens[2];
/*     */       
/*  69 */       setSequence(Integer.valueOf(str));
/*  70 */       str = tokens[3];
/*     */       
...
/*  87 */       return true;
/*     */     }
/*  89 */     if (!(ob instanceof PartyLocaleInformationPropertyId)) {
/*  90 */       return false;
/*     */     }
/*  92 */     PartyLocaleInformationPropertyId other = (PartyLocaleInformationPropertyId)ob;
...
/*     */ 
/*     */       
/*  99 */       .equals(other._partyId))) && ((this._sequence == null && other._sequence == null) || (this._sequence != null && this._sequence
/*     */ 
/*     */       
/* 102 */       .equals(other._sequence))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 120 */     return "PartyLocaleInformationProperty";
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\PartyLocaleInformationPropertyId.class
