...
/*     */ 
/*     */ 
/*     */ public class ReportDataPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 898309907L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ReportDataPropertyDAO.class);
/*     */   
...
/* 221 */     ReportDataPropertyId id = new ReportDataPropertyId();
...
/* 231 */     setOrganizationId(((ReportDataPropertyId)argObjectId).getOrganizationId());
/* 232 */     setOwnerId(((ReportDataPropertyId)argObjectId).getOwnerId());
/* 233 */     setOwnerType(((ReportDataPropertyId)argObjectId).getOwnerType());
/* 234 */     setReportId(((ReportDataPropertyId)argObjectId).getReportId());
/* 235 */     setPropertyCode(((ReportDataPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"ReportDataProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ReportDataPropertyDAO.class
