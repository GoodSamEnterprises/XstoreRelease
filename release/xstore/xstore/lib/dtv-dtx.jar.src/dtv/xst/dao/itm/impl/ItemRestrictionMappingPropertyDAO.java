...
/*     */ 
/*     */ 
/*     */ public class ItemRestrictionMappingPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 253944042L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemRestrictionMappingPropertyDAO.class);
/*     */   
...
/*  50 */     return this._merchHierarchyLevel;
/*     */   }
/*     */   
/*     */   public void setMerchHierarchyLevel(String argMerchHierarchyLevel) {
/*  54 */     if (changed(argMerchHierarchyLevel, this._merchHierarchyLevel, "merchHierarchyLevel")) {
/*  55 */       this._merchHierarchyLevel = (argMerchHierarchyLevel != null && MANAGE_CASE) ? argMerchHierarchyLevel.toUpperCase() : argMerchHierarchyLevel;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getMerchHierarchyId() {
/*  60 */     return this._merchHierarchyId;
/*     */   }
/*     */   
/*     */   public void setMerchHierarchyId(String argMerchHierarchyId) {
/*  64 */     if (changed(argMerchHierarchyId, this._merchHierarchyId, "merchHierarchyId")) {
/*  65 */       this._merchHierarchyId = (argMerchHierarchyId != null && MANAGE_CASE) ? argMerchHierarchyId.toUpperCase() : argMerchHierarchyId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getRestrictionCategory() {
/*  70 */     return this._restrictionCategory;
/*     */   }
/*     */   
/*     */   public void setRestrictionCategory(String argRestrictionCategory) {
/*  74 */     if (changed(argRestrictionCategory, this._restrictionCategory, "restrictionCategory")) {
/*  75 */       this._restrictionCategory = (argRestrictionCategory != null && MANAGE_CASE) ? argRestrictionCategory.toUpperCase() : argRestrictionCategory;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getMerchHierarchyLevel() != null) {
/* 181 */       buf.append("merchHierarchyLevel").append("=").append(getMerchHierarchyLevel()).append(" ");
/*     */     }
/* 183 */     if (getMerchHierarchyId() != null) {
/* 184 */       buf.append("merchHierarchyId").append("=").append(getMerchHierarchyId()).append(" ");
/*     */     }
/* 186 */     if (getRestrictionCategory() != null) {
/* 187 */       buf.append("restrictionCategory").append("=").append(getRestrictionCategory()).append(" ");
/*     */     }
...
/* 221 */     ItemRestrictionMappingPropertyId id = new ItemRestrictionMappingPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setMerchHierarchyLevel(getMerchHierarchyLevel());
/* 224 */     id.setMerchHierarchyId(getMerchHierarchyId());
/* 225 */     id.setRestrictionCategory(getRestrictionCategory());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((ItemRestrictionMappingPropertyId)argObjectId).getOrganizationId());
/* 232 */     setMerchHierarchyLevel(((ItemRestrictionMappingPropertyId)argObjectId).getMerchHierarchyLevel());
/* 233 */     setMerchHierarchyId(((ItemRestrictionMappingPropertyId)argObjectId).getMerchHierarchyId());
/* 234 */     setRestrictionCategory(((ItemRestrictionMappingPropertyId)argObjectId).getRestrictionCategory());
/* 235 */     setPropertyCode(((ItemRestrictionMappingPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"ItemRestrictionMappingProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._merchHierarchyLevel != null) values.put("MerchHierarchyLevel", DaoUtils.getXmlSafeFieldValue(12, this._merchHierarchyLevel)); 
/* 255 */     if (this._merchHierarchyId != null) values.put("MerchHierarchyId", DaoUtils.getXmlSafeFieldValue(12, this._merchHierarchyId)); 
/* 256 */     if (this._restrictionCategory != null) values.put("RestrictionCategory", DaoUtils.getXmlSafeFieldValue(12, this._restrictionCategory)); 
...
/* 290 */             setMerchHierarchyLevel((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setMerchHierarchyLevel() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 299 */             setMerchHierarchyId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setMerchHierarchyId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setRestrictionCategory((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setRestrictionCategory() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemRestrictionMappingPropertyDAO.class
