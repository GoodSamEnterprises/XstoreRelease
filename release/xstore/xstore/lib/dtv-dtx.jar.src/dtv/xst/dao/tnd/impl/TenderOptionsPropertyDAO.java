...
/*     */ 
/*     */ 
/*     */ public class TenderOptionsPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */   implements IHasConfigElement
/*     */ {
/*     */   private static final long serialVersionUID = -1538401025L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderOptionsPropertyDAO.class);
/*     */   
...
/*  59 */     return this._configElement;
/*     */   }
/*     */   
/*     */   public void setConfigElement(String argConfigElement) {
/*  63 */     if (changed(argConfigElement, this._configElement, "configElement")) {
/*  64 */       this._configElement = (argConfigElement != null && MANAGE_CASE) ? argConfigElement.toUpperCase() : argConfigElement;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getTenderId() != null) {
/* 170 */       buf.append("tenderId").append("=").append(getTenderId()).append(" ");
/*     */     }
/* 172 */     if (getConfigElement() != null) {
/* 173 */       buf.append("configElement").append("=").append(getConfigElement()).append(" ");
/*     */     }
...
/* 207 */     TenderOptionsPropertyId id = new TenderOptionsPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setTenderId(getTenderId());
/* 210 */     id.setConfigElement(getConfigElement());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((TenderOptionsPropertyId)argObjectId).getOrganizationId());
/* 217 */     setTenderId(((TenderOptionsPropertyId)argObjectId).getTenderId());
/* 218 */     setConfigElement(((TenderOptionsPropertyId)argObjectId).getConfigElement());
/* 219 */     setPropertyCode(((TenderOptionsPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"TenderOptionsProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._tenderId != null) values.put("TenderId", DaoUtils.getXmlSafeFieldValue(12, this._tenderId)); 
/* 239 */     if (this._configElement != null) values.put("ConfigElement", DaoUtils.getXmlSafeFieldValue(12, this._configElement)); 
...
/* 273 */             setTenderId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setTenderId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ConfigElement":
...
/* 282 */             setConfigElement((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setConfigElement() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderOptionsPropertyDAO.class
