...
/*     */ 
/*     */ 
/*     */ public class RetailInventoryLocationModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 903566394L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RetailInventoryLocationModifierPropertyDAO.class);
/*     */   
...
/*  94 */     return this._transactionLineItemSequence;
/*     */   }
/*     */   
/*     */   public void setTransactionLineItemSequence(Long argTransactionLineItemSequence) {
/*  98 */     if (changed(argTransactionLineItemSequence, this._transactionLineItemSequence, "transactionLineItemSequence")) {
/*  99 */       this._transactionLineItemSequence = argTransactionLineItemSequence;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getModifierSequence() {
/* 104 */     return this._modifierSequence;
/*     */   }
/*     */   
/*     */   public void setModifierSequence(Long argModifierSequence) {
/* 108 */     if (changed(argModifierSequence, this._modifierSequence, "modifierSequence")) {
/* 109 */       this._modifierSequence = argModifierSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 226 */     if (getTransactionLineItemSequence() != null) {
/* 227 */       buf.append("transactionLineItemSequence").append("=").append(getTransactionLineItemSequence()).append(" ");
/*     */     }
/* 229 */     if (getModifierSequence() != null) {
/* 230 */       buf.append("modifierSequence").append("=").append(getModifierSequence()).append(" ");
/*     */     }
...
/* 264 */     RetailInventoryLocationModifierPropertyId id = new RetailInventoryLocationModifierPropertyId();
...
/* 270 */     id.setTransactionLineItemSequence(getTransactionLineItemSequence());
/* 271 */     id.setModifierSequence(getModifierSequence());
/* 272 */     id.setPropertyCode(getPropertyCode());
/* 273 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 277 */     setOrganizationId(((RetailInventoryLocationModifierPropertyId)argObjectId).getOrganizationId());
/* 278 */     setRetailLocationId(((RetailInventoryLocationModifierPropertyId)argObjectId).getRetailLocationId());
/* 279 */     setWorkstationId(((RetailInventoryLocationModifierPropertyId)argObjectId).getWorkstationId());
/* 280 */     setBusinessDate(((RetailInventoryLocationModifierPropertyId)argObjectId).getBusinessDate());
/* 281 */     setTransactionSequence(((RetailInventoryLocationModifierPropertyId)argObjectId).getTransactionSequence());
/* 282 */     setTransactionLineItemSequence(((RetailInventoryLocationModifierPropertyId)argObjectId).getTransactionLineItemSequence());
/* 283 */     setModifierSequence(((RetailInventoryLocationModifierPropertyId)argObjectId).getModifierSequence());
/* 284 */     setPropertyCode(((RetailInventoryLocationModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"RetailInventoryLocationModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 307 */     if (this._transactionLineItemSequence != null) values.put("TransactionLineItemSequence", DaoUtils.getXmlSafeFieldValue(-5, this._transactionLineItemSequence)); 
/* 308 */     if (this._modifierSequence != null) values.put("ModifierSequence", DaoUtils.getXmlSafeFieldValue(-5, this._modifierSequence)); 
...
/* 378 */             setTransactionLineItemSequence((Long)value);
/* 379 */           } catch (Exception ee) {
/* 380 */             throw new DtxException("An exception occurred while calling setTransactionLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 387 */             setModifierSequence((Long)value);
/* 388 */           } catch (Exception ee) {
/* 389 */             throw new DtxException("An exception occurred while calling setModifierSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailInventoryLocationModifierPropertyDAO.class
