...
/*     */ 
/*     */ 
/*     */ public class ItemMessageCrossReferencePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1882708908L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemMessageCrossReferencePropertyDAO.class);
/*     */   
...
/* 207 */     ItemMessageCrossReferencePropertyId id = new ItemMessageCrossReferencePropertyId();
...
/* 216 */     setMessageId(((ItemMessageCrossReferencePropertyId)argObjectId).getMessageId());
/* 217 */     setOrganizationId(((ItemMessageCrossReferencePropertyId)argObjectId).getOrganizationId());
/* 218 */     setItemId(((ItemMessageCrossReferencePropertyId)argObjectId).getItemId());
/* 219 */     setPropertyCode(((ItemMessageCrossReferencePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"ItemMessageCrossReferenceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemMessageCrossReferencePropertyDAO.class
