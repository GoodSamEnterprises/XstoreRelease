...
/*     */ 
/*     */ 
/*     */ public class AccessControlListPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 243276396L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AccessControlListPropertyDAO.class);
/*     */   
...
/*  48 */     return this._securedObjectId;
/*     */   }
/*     */   
/*     */   public void setSecuredObjectId(String argSecuredObjectId) {
/*  52 */     if (changed(argSecuredObjectId, this._securedObjectId, "securedObjectId")) {
/*  53 */       this._securedObjectId = (argSecuredObjectId != null && MANAGE_CASE) ? argSecuredObjectId.toUpperCase() : argSecuredObjectId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getSecuredObjectId() != null) {
/* 159 */       buf.append("securedObjectId").append("=").append(getSecuredObjectId()).append(" ");
/*     */     }
...
/* 193 */     AccessControlListPropertyId id = new AccessControlListPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setSecuredObjectId(getSecuredObjectId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((AccessControlListPropertyId)argObjectId).getOrganizationId());
/* 202 */     setSecuredObjectId(((AccessControlListPropertyId)argObjectId).getSecuredObjectId());
/* 203 */     setPropertyCode(((AccessControlListPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"AccessControlListProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._securedObjectId != null) values.put("SecuredObjectId", DaoUtils.getXmlSafeFieldValue(12, this._securedObjectId)); 
...
/* 256 */             setSecuredObjectId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setSecuredObjectId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\AccessControlListPropertyDAO.class
