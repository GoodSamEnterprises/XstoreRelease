...
/*     */ 
/*     */ 
/*     */ public class ItemRestrictionMappingPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IItemRestrictionMappingProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ItemRestrictionMappingPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ItemRestrictionMappingPropertyDAO getDAO_() {
/*  44 */     return (ItemRestrictionMappingPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IItemRestrictionMappingProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getMerchHierarchyLevel();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setMerchHierarchyLevel_noev(argMerchHierarchyLevel) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IItemRestrictionMappingProperty.SET_MERCHHIERARCHYLEVEL, argMerchHierarchyLevel);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getMerchHierarchyLevel() == null && argMerchHierarchyLevel != null) || (
/* 112 */       getDAO_().getMerchHierarchyLevel() != null && !getDAO_().getMerchHierarchyLevel().equals(argMerchHierarchyLevel))) {
/* 113 */       getDAO_().setMerchHierarchyLevel(argMerchHierarchyLevel);
...
/* 125 */     return getDAO_().getMerchHierarchyId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setMerchHierarchyId_noev(argMerchHierarchyId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IItemRestrictionMappingProperty.SET_MERCHHIERARCHYID, argMerchHierarchyId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getMerchHierarchyId() == null && argMerchHierarchyId != null) || (
/* 146 */       getDAO_().getMerchHierarchyId() != null && !getDAO_().getMerchHierarchyId().equals(argMerchHierarchyId))) {
/* 147 */       getDAO_().setMerchHierarchyId(argMerchHierarchyId);
...
/* 159 */     return getDAO_().getRestrictionCategory();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setRestrictionCategory_noev(argRestrictionCategory) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IItemRestrictionMappingProperty.SET_RESTRICTIONCATEGORY, argRestrictionCategory);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getRestrictionCategory() == null && argRestrictionCategory != null) || (
/* 180 */       getDAO_().getRestrictionCategory() != null && !getDAO_().getRestrictionCategory().equals(argRestrictionCategory))) {
/* 181 */       getDAO_().setRestrictionCategory(argRestrictionCategory);
...
/* 204 */       this._events.post(IItemRestrictionMappingProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IItemRestrictionMappingProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IItemRestrictionMappingProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IItemRestrictionMappingProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IItemRestrictionMappingProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IItemRestrictionMappingProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IItemRestrictionMappingProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IItemRestrictionMappingProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IItemRestrictionMappingProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("ItemRestrictionMappingPropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("ItemRestrictionMappingPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemRestrictionMappingPropertyModel.class
