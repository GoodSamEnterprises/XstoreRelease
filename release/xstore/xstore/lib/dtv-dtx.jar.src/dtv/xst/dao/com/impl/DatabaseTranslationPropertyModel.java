...
/*     */ 
/*     */ 
/*     */ public class DatabaseTranslationPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IDatabaseTranslationProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new DatabaseTranslationPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private DatabaseTranslationPropertyDAO getDAO_() {
/*  44 */     return (DatabaseTranslationPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IDatabaseTranslationProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  99 */     if (setLocale_noev(argLocale) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IDatabaseTranslationProperty.SET_LOCALE, argLocale);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getLocale() == null && argLocale != null) || (
/* 112 */       getDAO_().getLocale() != null && !getDAO_().getLocale().equals(argLocale))) {
/* 113 */       getDAO_().setLocale(argLocale);
...
/* 125 */     return getDAO_().getTranslationKey();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setTranslationKey_noev(argTranslationKey) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IDatabaseTranslationProperty.SET_TRANSLATIONKEY, argTranslationKey);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getTranslationKey() == null && argTranslationKey != null) || (
/* 146 */       getDAO_().getTranslationKey() != null && !getDAO_().getTranslationKey().equals(argTranslationKey))) {
/* 147 */       getDAO_().setTranslationKey(argTranslationKey);
...
/* 170 */       this._events.post(IDatabaseTranslationProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IDatabaseTranslationProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IDatabaseTranslationProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IDatabaseTranslationProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IDatabaseTranslationProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IDatabaseTranslationProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IDatabaseTranslationProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IDatabaseTranslationProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IDatabaseTranslationProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("DatabaseTranslationPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("DatabaseTranslationPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\DatabaseTranslationPropertyModel.class
