...
/*     */ 
/*     */ 
/*     */ public class DeviceRegistrationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1260009148L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DeviceRegistrationPropertyDAO.class);
/*     */   
...
/*  59 */     return this._workstationId;
/*     */   }
/*     */   
/*     */   public void setWorkstationId(Long argWorkstationId) {
/*  63 */     if (changed(argWorkstationId, this._workstationId, "workstationId")) {
/*  64 */       this._workstationId = argWorkstationId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getWorkstationId() != null) {
/* 173 */       buf.append("workstationId").append("=").append(getWorkstationId()).append(" ");
/*     */     }
...
/* 207 */     DeviceRegistrationPropertyId id = new DeviceRegistrationPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setWorkstationId(getWorkstationId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((DeviceRegistrationPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((DeviceRegistrationPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setWorkstationId(((DeviceRegistrationPropertyId)argObjectId).getWorkstationId());
/* 219 */     setPropertyCode(((DeviceRegistrationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DeviceRegistrationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._workstationId != null) values.put("WorkstationId", DaoUtils.getXmlSafeFieldValue(-5, this._workstationId)); 
...
/* 282 */             setWorkstationId((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setWorkstationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\DeviceRegistrationPropertyDAO.class
