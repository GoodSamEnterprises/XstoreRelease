...
/*     */ 
/*     */ 
/*     */ public class CountryReturnMapPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ICountryReturnMapProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new CountryReturnMapPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private CountryReturnMapPropertyDAO getDAO_() {
/*  44 */     return (CountryReturnMapPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ICountryReturnMapProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getPurchasedFrom();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setPurchasedFrom_noev(argPurchasedFrom) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ICountryReturnMapProperty.SET_PURCHASEDFROM, argPurchasedFrom);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getPurchasedFrom() == null && argPurchasedFrom != null) || (
/* 112 */       getDAO_().getPurchasedFrom() != null && !getDAO_().getPurchasedFrom().equals(argPurchasedFrom))) {
/* 113 */       getDAO_().setPurchasedFrom(argPurchasedFrom);
...
/* 125 */     return getDAO_().getReturnTo();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setReturnTo_noev(argReturnTo) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(ICountryReturnMapProperty.SET_RETURNTO, argReturnTo);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getReturnTo() == null && argReturnTo != null) || (
/* 146 */       getDAO_().getReturnTo() != null && !getDAO_().getReturnTo().equals(argReturnTo))) {
/* 147 */       getDAO_().setReturnTo(argReturnTo);
...
/* 170 */       this._events.post(ICountryReturnMapProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(ICountryReturnMapProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(ICountryReturnMapProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(ICountryReturnMapProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(ICountryReturnMapProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(ICountryReturnMapProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(ICountryReturnMapProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(ICountryReturnMapProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(ICountryReturnMapProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("CountryReturnMapPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("CountryReturnMapPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\CountryReturnMapPropertyModel.class
