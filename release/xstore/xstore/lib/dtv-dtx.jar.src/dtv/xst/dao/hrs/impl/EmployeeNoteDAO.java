...
/*     */ 
/*     */ 
/*     */ public class EmployeeNoteDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1564190752L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeNoteDAO.class);
/*     */   
...
/*  47 */     return this._employeeId;
/*     */   }
/*     */   
/*     */   public void setEmployeeId(String argEmployeeId) {
/*  51 */     if (changed(argEmployeeId, this._employeeId, "employeeId")) {
/*  52 */       this._employeeId = (argEmployeeId != null && MANAGE_CASE) ? argEmployeeId.toUpperCase() : argEmployeeId;
/*     */     }
/*     */   }
/*     */   
...
/* 109 */     return this._note;
/*     */   }
/*     */   
/*     */   public void setNote(String argNote) {
/* 113 */     if (changed(argNote, this._note, "note")) {
/* 114 */       this._note = argNote;
/*     */     }
/*     */   }
/*     */   
/*     */   public Date getNoteTimeStamp() {
/* 119 */     return (Date)this._noteTimeStamp;
/*     */   }
/*     */   
/*     */   public void setNoteTimeStamp(Date argNoteTimeStamp) {
/* 123 */     if (changed(argNoteTimeStamp, this._noteTimeStamp, "noteTimeStamp")) {
/* 124 */       this._noteTimeStamp = (argNoteTimeStamp == null || argNoteTimeStamp instanceof DtvDate) ? (DtvDate)argNoteTimeStamp : new DtvDate(argNoteTimeStamp);
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   public Long getCreatorPartyId() {
/* 130 */     return this._creatorPartyId;
/*     */   }
/*     */   
/*     */   public void setCreatorPartyId(Long argCreatorPartyId) {
/* 134 */     if (changed(argCreatorPartyId, this._creatorPartyId, "creatorPartyId")) {
/* 135 */       this._creatorPartyId = argCreatorPartyId;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 147 */     if (getEmployeeId() != null) {
/* 148 */       buf.append("employeeId").append("=").append(getEmployeeId()).append(" ");
/*     */     }
...
/*     */     }
/* 165 */     if (getNote() != null) {
/* 166 */       buf.append("note").append("=").append(getNote()).append(" ");
/*     */     }
/* 168 */     if (getNoteTimeStamp() != null) {
/* 169 */       buf.append("noteTimeStamp").append("=").append(getNoteTimeStamp()).append(" ");
/*     */     }
/* 171 */     if (getCreatorPartyId() != null) {
/* 172 */       buf.append("creatorPartyId").append("=").append(getCreatorPartyId()).append(" ");
/*     */     }
/*     */     
...
/* 179 */     EmployeeNoteId id = new EmployeeNoteId();
/* 180 */     id.setOrganizationId(getOrganizationId());
/* 181 */     id.setEmployeeId(getEmployeeId());
/* 182 */     id.setNoteSequence(getNoteSequence());
/* 183 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 187 */     setOrganizationId(((EmployeeNoteId)argObjectId).getOrganizationId());
/* 188 */     setEmployeeId(((EmployeeNoteId)argObjectId).getEmployeeId());
/* 189 */     setNoteSequence(((EmployeeNoteId)argObjectId).getNoteSequence());
/*     */   }
/*     */   
...
/* 198 */     buf.append("<").append("dao").append(" name=\"EmployeeNote\" cmd=\"" + getObjectStateString() + "\">");
...
/* 208 */     if (this._employeeId != null) values.put("EmployeeId", DaoUtils.getXmlSafeFieldValue(12, this._employeeId)); 
...
/* 214 */     if (this._note != null) values.put("Note", DaoUtils.getXmlSafeFieldValue(2005, this._note)); 
/* 215 */     if (this._noteTimeStamp != null) values.put("NoteTimeStamp", DaoUtils.getXmlSafeFieldValue(91, this._noteTimeStamp)); 
/* 216 */     if (this._creatorPartyId != null) values.put("CreatorPartyId", DaoUtils.getXmlSafeFieldValue(-5, this._creatorPartyId)); 
/* 217 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/* 241 */             setEmployeeId((String)value);
/* 242 */           } catch (Exception ee) {
/* 243 */             throw new DtxException("An exception occurred while calling setEmployeeId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "NoteSequence":
...
/*     */         case "Note":
/*     */           try {
/* 294 */             Object value = DaoUtils.getFieldValueForXmlString(2005, fieldValue);
/* 295 */             setNote((String)value);
/* 296 */           } catch (Exception ee) {
/* 297 */             throw new DtxException("An exception occurred while calling setNote() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "NoteTimeStamp":
...
/* 304 */             setNoteTimeStamp((Date)value);
/* 305 */           } catch (Exception ee) {
/* 306 */             throw new DtxException("An exception occurred while calling setNoteTimeStamp() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CreatorPartyId":
...
/* 313 */             setCreatorPartyId((Long)value);
/* 314 */           } catch (Exception ee) {
/* 315 */             throw new DtxException("An exception occurred while calling setCreatorPartyId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeNoteDAO.class
