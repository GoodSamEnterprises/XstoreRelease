...
/*     */ 
/*     */ 
/*     */ public class RetailPriceModifierPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 540334034L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.business_date, t.organization_id, t.rtl_loc_id, t.rtl_price_mod_seq_nbr, t.rtrans_lineitm_seq, t.trans_seq, t.wkstn_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trl_rtl_price_mod_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE business_date = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND rtl_price_mod_seq_nbr = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   
...
/*  49 */     return "SELECT t.business_date, t.organization_id, t.rtl_loc_id, t.rtl_price_mod_seq_nbr, t.rtrans_lineitm_seq, t.trans_seq, t.wkstn_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trl_rtl_price_mod_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  55 */     return " WHERE business_date = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND rtl_price_mod_seq_nbr = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  58 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trl_rtl_price_mod_p(business_date, organization_id, rtl_loc_id, rtl_price_mod_seq_nbr, rtrans_lineitm_seq, trans_seq, wkstn_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  65 */     Object[][] insertParameterObject = { { this._businessDate, this._organizationId, this._retailLocationId, this._retailPriceModifierSequenceNbr, this._retailTransactionLineItemSequence, this._transactionSequence, this._workstationId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  66 */     return insertParameterObject;
/*     */   }
/*     */   
/*  69 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { 91, -5, -5, 4, 4, -5, -5, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  72 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  75 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trl_rtl_price_mod_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  91 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trl_rtl_price_mod_p" }; private static final String WHERE_OBJECT = " WHERE business_date = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND rtl_price_mod_seq_nbr = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   
...
/* 100 */     return " WHERE business_date = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND rtl_price_mod_seq_nbr = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 103 */     return new Object[] { this._businessDate, this._organizationId, this._retailLocationId, this._retailPriceModifierSequenceNbr, this._retailTransactionLineItemSequence, this._transactionSequence, this._workstationId, this._propertyCode };
/*     */   }
/*     */   
/* 106 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { 91, -5, -5, 4, 4, -5, -5, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 109 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 112 */     return "trl_rtl_price_mod_p";
/*     */   }
/*     */   
...
/* 120 */     return new RetailPriceModifierPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class RetailPriceModifierPropertyFiller
/*     */     implements IFiller {
/*     */     private RetailPriceModifierPropertyDBA _parent;
/*     */     
/*     */     public RetailPriceModifierPropertyFiller(RetailPriceModifierPropertyDBA argParent) {
...
/* 160 */         this._parent._retailPriceModifierSequenceNbr = Integer.valueOf(i);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 166 */       i = argResultSet.getInt(5);
...
/* 226 */     RetailPriceModifierPropertyDAO dao = (RetailPriceModifierPropertyDAO)argDAO;
...
/* 230 */     dao.setRetailPriceModifierSequenceNbr(this._retailPriceModifierSequenceNbr);
...
/* 248 */     return loadDAO((IDataAccessObject)new RetailPriceModifierPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 252 */     RetailPriceModifierPropertyDAO dao = (RetailPriceModifierPropertyDAO)argDAO;
...
/* 256 */     this._retailPriceModifierSequenceNbr = dao.getRetailPriceModifierSequenceNbr();
...
/* 272 */     RetailPriceModifierPropertyId id = (RetailPriceModifierPropertyId)argId;
...
/* 276 */     argStatement.setInt(4, id.getRetailPriceModifierSequenceNbr().intValue());
...
/* 285 */     RetailPriceModifierPropertyId id = new RetailPriceModifierPropertyId();
...
/* 289 */     id.setRetailPriceModifierSequenceNbr(this._retailPriceModifierSequenceNbr);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailPriceModifierPropertyDBA.class
