...
/*     */ 
/*     */ 
/*     */ public class TenderPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -566366999L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.tndr_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tnd_tndr_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND tndr_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.tndr_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tnd_tndr_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND tndr_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO tnd_tndr_p(organization_id, tndr_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._tenderId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE tnd_tndr_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM tnd_tndr_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND tndr_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND tndr_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._tenderId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new TenderPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TenderPropertyFiller
/*     */     implements IFiller {
/*     */     private TenderPropertyDBA _parent;
/*     */     
/*     */     public TenderPropertyFiller(TenderPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._tenderId = argResultSet.getString(2);
...
/* 173 */     TenderPropertyDAO dao = (TenderPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setTenderId(this._tenderId);
...
/* 190 */     return loadDAO((IDataAccessObject)new TenderPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     TenderPropertyDAO dao = (TenderPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._tenderId = dao.getTenderId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderPropertyDBA.class
