...
/*     */ 
/*     */ 
/*     */ public class TransactionPropertyPromptPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITransactionPropertyPromptProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TransactionPropertyPromptPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TransactionPropertyPromptPropertyDAO getDAO_() {
/*  44 */     return (TransactionPropertyPromptPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITransactionPropertyPromptProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getPromptPropertyCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setPromptPropertyCode_noev(argPromptPropertyCode) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ITransactionPropertyPromptProperty.SET_PROMPTPROPERTYCODE, argPromptPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getPromptPropertyCode() == null && argPromptPropertyCode != null) || (
/* 112 */       getDAO_().getPromptPropertyCode() != null && !getDAO_().getPromptPropertyCode().equals(argPromptPropertyCode))) {
/* 113 */       getDAO_().setPromptPropertyCode(argPromptPropertyCode);
...
/* 125 */     return getDAO_().getEffectiveDate();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setEffectiveDate_noev(argEffectiveDate) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(ITransactionPropertyPromptProperty.SET_EFFECTIVEDATE, argEffectiveDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getEffectiveDate() == null && argEffectiveDate != null) || (
/* 146 */       getDAO_().getEffectiveDate() != null && !getDAO_().getEffectiveDate().equals(argEffectiveDate))) {
/* 147 */       getDAO_().setEffectiveDate(argEffectiveDate);
...
/* 170 */       this._events.post(ITransactionPropertyPromptProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(ITransactionPropertyPromptProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(ITransactionPropertyPromptProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(ITransactionPropertyPromptProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(ITransactionPropertyPromptProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(ITransactionPropertyPromptProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(ITransactionPropertyPromptProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(ITransactionPropertyPromptProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(ITransactionPropertyPromptProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("TransactionPropertyPromptPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("TransactionPropertyPromptPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\TransactionPropertyPromptPropertyModel.class
