...
/*     */ 
/*     */ 
/*     */ public class LineItemGenericStoragePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -938208064L;
/*  23 */   private static final Logger _logger = Logger.getLogger(LineItemGenericStoragePropertyDAO.class);
/*     */   
...
/*  73 */     return this._lineItemSequence;
/*     */   }
/*     */   
/*     */   public void setLineItemSequence(Integer argLineItemSequence) {
/*  77 */     if (changed(argLineItemSequence, this._lineItemSequence, "lineItemSequence")) {
/*  78 */       this._lineItemSequence = argLineItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 209 */     if (getLineItemSequence() != null) {
/* 210 */       buf.append("lineItemSequence").append("=").append(getLineItemSequence()).append(" ");
/*     */     }
...
/* 250 */     LineItemGenericStoragePropertyId id = new LineItemGenericStoragePropertyId();
...
/* 254 */     id.setLineItemSequence(getLineItemSequence());
...
/* 262 */     setBusinessDate(((LineItemGenericStoragePropertyId)argObjectId).getBusinessDate());
/* 263 */     setOrganizationId(((LineItemGenericStoragePropertyId)argObjectId).getOrganizationId());
/* 264 */     setRetailLocationId(((LineItemGenericStoragePropertyId)argObjectId).getRetailLocationId());
/* 265 */     setLineItemSequence(((LineItemGenericStoragePropertyId)argObjectId).getLineItemSequence());
/* 266 */     setTransactionSequence(((LineItemGenericStoragePropertyId)argObjectId).getTransactionSequence());
/* 267 */     setWorkstationId(((LineItemGenericStoragePropertyId)argObjectId).getWorkstationId());
/* 268 */     setPropertyCode(((LineItemGenericStoragePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"LineItemGenericStorageProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 289 */     if (this._lineItemSequence != null) values.put("LineItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._lineItemSequence)); 
...
/* 343 */             setLineItemSequence((Integer)value);
/* 344 */           } catch (Exception ee) {
/* 345 */             throw new DtxException("An exception occurred while calling setLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\LineItemGenericStoragePropertyDAO.class
