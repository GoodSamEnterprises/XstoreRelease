...
/*     */ 
/*     */ 
/*     */ public class InvoicePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -987381758L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InvoicePropertyDAO.class);
/*     */   
...
/*     */     }
/* 172 */     if (getInvoiceNumber() != null) {
/* 173 */       buf.append("invoiceNumber").append("=").append(getInvoiceNumber()).append(" ");
/*     */     }
...
/* 207 */     InvoicePropertyId id = new InvoicePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setServiceLocationId(getServiceLocationId());
/* 210 */     id.setInvoiceNumber(getInvoiceNumber());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((InvoicePropertyId)argObjectId).getOrganizationId());
/* 217 */     setServiceLocationId(((InvoicePropertyId)argObjectId).getServiceLocationId());
/* 218 */     setInvoiceNumber(((InvoicePropertyId)argObjectId).getInvoiceNumber());
/* 219 */     setPropertyCode(((InvoicePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"InvoiceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._invoiceNumber != null) values.put("InvoiceNumber", DaoUtils.getXmlSafeFieldValue(12, this._invoiceNumber)); 
...
/* 282 */             setInvoiceNumber((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setInvoiceNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\InvoicePropertyDAO.class
