...
/*     */ 
/*     */ 
/*     */ public class PayrollCategoryPropertyId
...
/*     */   
/*     */   public PayrollCategoryPropertyId() {}
/*     */   
/*     */   public PayrollCategoryPropertyId(String argObjectIdValue) {
...
/*  30 */     return this._payrollCategory;
/*     */   }
/*     */   
/*     */   public void setPayrollCategory(String argPayrollCategory) {
/*  34 */     this._payrollCategory = (argPayrollCategory != null && MANAGE_CASE) ? argPayrollCategory.toUpperCase() : argPayrollCategory;
/*     */   }
/*     */   
...
/*  58 */         setPayrollCategory((String)null);
/*     */       } else {
/*     */         
/*  61 */         setPayrollCategory(str);
/*     */       } 
/*  63 */       str = tokens[2];
/*     */       
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof PayrollCategoryPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     PayrollCategoryPropertyId other = (PayrollCategoryPropertyId)ob;
/*  86 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  89 */       .equals(other._organizationId))) && ((this._payrollCategory == null && other._payrollCategory == null) || (this._payrollCategory != null && this._payrollCategory
/*     */ 
/*     */       
/*  92 */       .equals(other._payrollCategory))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 102 */       .hashCode()) + ((this._payrollCategory == null) ? 0 : this._payrollCategory
...
/* 109 */     return "PayrollCategoryProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 118 */       .append("::").append(this._payrollCategory)
/* 119 */       .append("::").append(this._propertyCode)
/* 120 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 124 */     if (this._payrollCategory == null) {
/* 125 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\PayrollCategoryPropertyId.class
