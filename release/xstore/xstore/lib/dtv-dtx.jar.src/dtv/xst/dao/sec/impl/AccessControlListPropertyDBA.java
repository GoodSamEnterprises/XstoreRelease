...
/*     */ 
/*     */ 
/*     */ public class AccessControlListPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.secured_object_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM sec_acl_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND secured_object_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.secured_object_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM sec_acl_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND secured_object_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO sec_acl_p(organization_id, secured_object_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._securedObjectId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE sec_acl_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM sec_acl_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND secured_object_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND secured_object_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._securedObjectId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new AccessControlListPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class AccessControlListPropertyFiller
/*     */     implements IFiller {
/*     */     private AccessControlListPropertyDBA _parent;
/*     */     
/*     */     public AccessControlListPropertyFiller(AccessControlListPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._securedObjectId = argResultSet.getString(2);
...
/* 173 */     AccessControlListPropertyDAO dao = (AccessControlListPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setSecuredObjectId(this._securedObjectId);
...
/* 190 */     return loadDAO((IDataAccessObject)new AccessControlListPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     AccessControlListPropertyDAO dao = (AccessControlListPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._securedObjectId = dao.getSecuredObjectId();
...
/* 209 */     AccessControlListPropertyId id = (AccessControlListPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getSecuredObjectId());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     AccessControlListPropertyId id = new AccessControlListPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setSecuredObjectId(this._securedObjectId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\AccessControlListPropertyDBA.class
