...
/*     */ 
/*     */ 
/*     */ public class TransactionNotesPropertyId
...
/*     */   
/*     */   public TransactionNotesPropertyId() {}
/*     */   
/*     */   public TransactionNotesPropertyId(String argObjectIdValue) {
...
/*  45 */     return this._noteSequence;
/*     */   }
/*     */   
/*     */   public void setNoteSequence(Integer argNoteSequence) {
/*  49 */     this._noteSequence = argNoteSequence;
/*     */   }
/*     */   
...
/* 100 */       str = tokens[1];
/*     */       
/* 102 */       setNoteSequence(Integer.valueOf(str));
/* 103 */       str = tokens[2];
/*     */       
...
/* 132 */       return true;
/*     */     }
/* 134 */     if (!(ob instanceof TransactionNotesPropertyId)) {
/* 135 */       return false;
/*     */     }
/* 137 */     TransactionNotesPropertyId other = (TransactionNotesPropertyId)ob;
/* 138 */     return (((this._businessDate == null && other._businessDate == null) || (this._businessDate != null && this._businessDate
/*     */ 
/*     */       
/* 141 */       .equals(other._businessDate))) && ((this._noteSequence == null && other._noteSequence == null) || (this._noteSequence != null && this._noteSequence
/*     */ 
/*     */       
/* 144 */       .equals(other._noteSequence))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/* 166 */       .hashCode()) + ((this._noteSequence == null) ? 0 : this._noteSequence
...
/* 177 */     return "TransactionNotesProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 186 */       .append("::").append(String.valueOf(this._noteSequence))
...
/* 197 */       return false;
/*     */     }
/* 199 */     if (this._noteSequence == null) {
/* 200 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\TransactionNotesPropertyId.class
