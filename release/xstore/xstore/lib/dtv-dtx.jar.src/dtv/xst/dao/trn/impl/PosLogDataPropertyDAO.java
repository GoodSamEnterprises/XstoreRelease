...
/*     */ 
/*     */ 
/*     */ public class PosLogDataPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1820289071L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PosLogDataPropertyDAO.class);
/*     */   
...
/*     */     }
/* 195 */     if (getWorkstationId() != null) {
/* 196 */       buf.append("workstationId").append("=").append(getWorkstationId()).append(" ");
/*     */     }
...
/* 236 */     PosLogDataPropertyId id = new PosLogDataPropertyId();
/* 237 */     id.setOrganizationId(getOrganizationId());
/* 238 */     id.setRetailLocationId(getRetailLocationId());
/* 239 */     id.setWorkstationId(getWorkstationId());
...
/* 247 */     setOrganizationId(((PosLogDataPropertyId)argObjectId).getOrganizationId());
/* 248 */     setRetailLocationId(((PosLogDataPropertyId)argObjectId).getRetailLocationId());
/* 249 */     setWorkstationId(((PosLogDataPropertyId)argObjectId).getWorkstationId());
/* 250 */     setBusinessDate(((PosLogDataPropertyId)argObjectId).getBusinessDate());
/* 251 */     setTransactionSequence(((PosLogDataPropertyId)argObjectId).getTransactionSequence());
/* 252 */     setPropertyCode(((PosLogDataPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 261 */     buf.append("<").append("dao").append(" name=\"PosLogDataProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 272 */     if (this._workstationId != null) values.put("WorkstationId", DaoUtils.getXmlSafeFieldValue(-5, this._workstationId)); 
...
/* 317 */             setWorkstationId((Long)value);
/* 318 */           } catch (Exception ee) {
/* 319 */             throw new DtxException("An exception occurred while calling setWorkstationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "BusinessDate":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\PosLogDataPropertyDAO.class
