...
/*     */ 
/*     */ 
/*     */ public class ItemCrossReferencePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.manufacturer_upc, t.organization_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_cross_reference_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE manufacturer_upc = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.manufacturer_upc, t.organization_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_cross_reference_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE manufacturer_upc = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_item_cross_reference_p(manufacturer_upc, organization_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._manufacturerUpc, this._organizationId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_item_cross_reference_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_item_cross_reference_p" }; private static final String WHERE_OBJECT = " WHERE manufacturer_upc = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE manufacturer_upc = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._manufacturerUpc, this._organizationId, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "itm_item_cross_reference_p";
/*     */   }
/*     */   
...
/* 115 */     return new ItemCrossReferencePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ItemCrossReferencePropertyFiller
/*     */     implements IFiller {
/*     */     private ItemCrossReferencePropertyDBA _parent;
/*     */     
/*     */     public ItemCrossReferencePropertyFiller(ItemCrossReferencePropertyDBA argParent) {
...
/* 173 */     ItemCrossReferencePropertyDAO dao = (ItemCrossReferencePropertyDAO)argDAO;
/* 174 */     dao.setManufacturerUpc(this._manufacturerUpc);
...
/* 190 */     return loadDAO((IDataAccessObject)new ItemCrossReferencePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     ItemCrossReferencePropertyDAO dao = (ItemCrossReferencePropertyDAO)argDAO;
/* 195 */     this._manufacturerUpc = dao.getManufacturerUpc();
...
/* 209 */     ItemCrossReferencePropertyId id = (ItemCrossReferencePropertyId)argId;
/* 210 */     argStatement.setString(1, id.getManufacturerUpc());
...
/* 217 */     ItemCrossReferencePropertyId id = new ItemCrossReferencePropertyId();
/* 218 */     id.setManufacturerUpc(this._manufacturerUpc);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemCrossReferencePropertyDBA.class
