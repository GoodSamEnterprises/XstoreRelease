...
/*     */ 
/*     */ 
/*     */ public class EscrowAccountActivityPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1316656172L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EscrowAccountActivityPropertyDAO.class);
/*     */   
...
/*  59 */     return this._seqNbr;
/*     */   }
/*     */   
/*     */   public void setSeqNbr(Long argSeqNbr) {
/*  63 */     if (changed(argSeqNbr, this._seqNbr, "seqNbr")) {
/*  64 */       this._seqNbr = argSeqNbr;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getSeqNbr() != null) {
/* 173 */       buf.append("seqNbr").append("=").append(getSeqNbr()).append(" ");
/*     */     }
...
/* 207 */     EscrowAccountActivityPropertyId id = new EscrowAccountActivityPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setCustAccountId(getCustAccountId());
/* 210 */     id.setSeqNbr(getSeqNbr());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((EscrowAccountActivityPropertyId)argObjectId).getOrganizationId());
/* 217 */     setCustAccountId(((EscrowAccountActivityPropertyId)argObjectId).getCustAccountId());
/* 218 */     setSeqNbr(((EscrowAccountActivityPropertyId)argObjectId).getSeqNbr());
/* 219 */     setPropertyCode(((EscrowAccountActivityPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"EscrowAccountActivityProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._custAccountId != null) values.put("CustAccountId", DaoUtils.getXmlSafeFieldValue(12, this._custAccountId)); 
/* 239 */     if (this._seqNbr != null) values.put("SeqNbr", DaoUtils.getXmlSafeFieldValue(-5, this._seqNbr)); 
...
/* 273 */             setCustAccountId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setCustAccountId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "SeqNbr":
...
/* 282 */             setSeqNbr((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setSeqNbr() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\EscrowAccountActivityPropertyDAO.class
