...
/*     */ 
/*     */ 
/*     */ public class ReportLookupPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -799474717L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ReportLookupPropertyDAO.class);
/*     */   
...
/*  50 */     return this._ownerId;
/*     */   }
/*     */   
/*     */   public void setOwnerId(String argOwnerId) {
/*  54 */     if (changed(argOwnerId, this._ownerId, "ownerId")) {
/*  55 */       this._ownerId = (argOwnerId != null && MANAGE_CASE) ? argOwnerId.toUpperCase() : argOwnerId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getOwnerType() {
/*  60 */     return this._ownerType;
/*     */   }
/*     */   
/*     */   public void setOwnerType(String argOwnerType) {
/*  64 */     if (changed(argOwnerType, this._ownerType, "ownerType")) {
/*  65 */       this._ownerType = (argOwnerType != null && MANAGE_CASE) ? argOwnerType.toUpperCase() : argOwnerType;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getReportId() {
/*  70 */     return this._reportId;
/*     */   }
/*     */   
/*     */   public void setReportId(String argReportId) {
/*  74 */     if (changed(argReportId, this._reportId, "reportId")) {
/*  75 */       this._reportId = (argReportId != null && MANAGE_CASE) ? argReportId.toUpperCase() : argReportId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getOwnerId() != null) {
/* 181 */       buf.append("ownerId").append("=").append(getOwnerId()).append(" ");
/*     */     }
/* 183 */     if (getOwnerType() != null) {
/* 184 */       buf.append("ownerType").append("=").append(getOwnerType()).append(" ");
/*     */     }
/* 186 */     if (getReportId() != null) {
/* 187 */       buf.append("reportId").append("=").append(getReportId()).append(" ");
/*     */     }
...
/* 221 */     ReportLookupPropertyId id = new ReportLookupPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setOwnerId(getOwnerId());
/* 224 */     id.setOwnerType(getOwnerType());
/* 225 */     id.setReportId(getReportId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((ReportLookupPropertyId)argObjectId).getOrganizationId());
/* 232 */     setOwnerId(((ReportLookupPropertyId)argObjectId).getOwnerId());
/* 233 */     setOwnerType(((ReportLookupPropertyId)argObjectId).getOwnerType());
/* 234 */     setReportId(((ReportLookupPropertyId)argObjectId).getReportId());
/* 235 */     setPropertyCode(((ReportLookupPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"ReportLookupProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._ownerId != null) values.put("OwnerId", DaoUtils.getXmlSafeFieldValue(12, this._ownerId)); 
/* 255 */     if (this._ownerType != null) values.put("OwnerType", DaoUtils.getXmlSafeFieldValue(12, this._ownerType)); 
/* 256 */     if (this._reportId != null) values.put("ReportId", DaoUtils.getXmlSafeFieldValue(12, this._reportId)); 
...
/* 290 */             setOwnerId((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setOwnerId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OwnerType":
...
/* 299 */             setOwnerType((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setOwnerType() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ReportId":
...
/* 308 */             setReportId((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setReportId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ReportLookupPropertyDAO.class
