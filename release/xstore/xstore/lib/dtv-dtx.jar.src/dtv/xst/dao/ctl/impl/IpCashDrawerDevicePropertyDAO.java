...
/*     */ 
/*     */ 
/*     */ public class IpCashDrawerDevicePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1992747562L;
/*  23 */   private static final Logger _logger = Logger.getLogger(IpCashDrawerDevicePropertyDAO.class);
/*     */   
...
/*  59 */     return this._cashDrawerId;
/*     */   }
/*     */   
/*     */   public void setCashDrawerId(String argCashDrawerId) {
/*  63 */     if (changed(argCashDrawerId, this._cashDrawerId, "cashDrawerId")) {
/*  64 */       this._cashDrawerId = (argCashDrawerId != null && MANAGE_CASE) ? argCashDrawerId.toUpperCase() : argCashDrawerId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getCashDrawerId() != null) {
/* 173 */       buf.append("cashDrawerId").append("=").append(getCashDrawerId()).append(" ");
/*     */     }
...
/* 207 */     IpCashDrawerDevicePropertyId id = new IpCashDrawerDevicePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setCashDrawerId(getCashDrawerId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((IpCashDrawerDevicePropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((IpCashDrawerDevicePropertyId)argObjectId).getRetailLocationId());
/* 218 */     setCashDrawerId(((IpCashDrawerDevicePropertyId)argObjectId).getCashDrawerId());
/* 219 */     setPropertyCode(((IpCashDrawerDevicePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"IpCashDrawerDeviceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._cashDrawerId != null) values.put("CashDrawerId", DaoUtils.getXmlSafeFieldValue(12, this._cashDrawerId)); 
...
/* 282 */             setCashDrawerId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setCashDrawerId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\IpCashDrawerDevicePropertyDAO.class
