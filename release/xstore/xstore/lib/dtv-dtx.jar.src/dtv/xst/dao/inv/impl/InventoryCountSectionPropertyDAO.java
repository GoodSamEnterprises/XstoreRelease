...
/*     */ 
/*     */ 
/*     */ public class InventoryCountSectionPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1644612135L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryCountSectionPropertyDAO.class);
/*     */   
...
/*  60 */     return this._inventoryBucketId;
/*     */   }
/*     */   
/*     */   public void setInventoryBucketId(String argInventoryBucketId) {
/*  64 */     if (changed(argInventoryBucketId, this._inventoryBucketId, "inventoryBucketId")) {
/*  65 */       this._inventoryBucketId = (argInventoryBucketId != null && MANAGE_CASE) ? argInventoryBucketId.toUpperCase() : argInventoryBucketId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getSectionId() {
/*  70 */     return this._sectionId;
/*     */   }
/*     */   
/*     */   public void setSectionId(String argSectionId) {
/*  74 */     if (changed(argSectionId, this._sectionId, "sectionId")) {
/*  75 */       this._sectionId = (argSectionId != null && MANAGE_CASE) ? argSectionId.toUpperCase() : argSectionId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 183 */     if (getInventoryBucketId() != null) {
/* 184 */       buf.append("inventoryBucketId").append("=").append(getInventoryBucketId()).append(" ");
/*     */     }
/* 186 */     if (getSectionId() != null) {
/* 187 */       buf.append("sectionId").append("=").append(getSectionId()).append(" ");
/*     */     }
...
/* 221 */     InventoryCountSectionPropertyId id = new InventoryCountSectionPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setRetailLocationId(getRetailLocationId());
/* 224 */     id.setInventoryBucketId(getInventoryBucketId());
/* 225 */     id.setSectionId(getSectionId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((InventoryCountSectionPropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((InventoryCountSectionPropertyId)argObjectId).getRetailLocationId());
/* 233 */     setInventoryBucketId(((InventoryCountSectionPropertyId)argObjectId).getInventoryBucketId());
/* 234 */     setSectionId(((InventoryCountSectionPropertyId)argObjectId).getSectionId());
/* 235 */     setPropertyCode(((InventoryCountSectionPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"InventoryCountSectionProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._inventoryBucketId != null) values.put("InventoryBucketId", DaoUtils.getXmlSafeFieldValue(12, this._inventoryBucketId)); 
/* 256 */     if (this._sectionId != null) values.put("SectionId", DaoUtils.getXmlSafeFieldValue(12, this._sectionId)); 
...
/* 299 */             setInventoryBucketId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setInventoryBucketId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "SectionId":
...
/* 308 */             setSectionId((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setSectionId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountSectionPropertyDAO.class
