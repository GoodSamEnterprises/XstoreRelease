...
/*     */ 
/*     */ 
/*     */ public class EmployeeTaskNotePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -881296134L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeTaskNotePropertyDAO.class);
/*     */   
...
/*  60 */     return this._taskId;
/*     */   }
/*     */   
/*     */   public void setTaskId(Long argTaskId) {
/*  64 */     if (changed(argTaskId, this._taskId, "taskId")) {
/*  65 */       this._taskId = argTaskId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getNoteSequence() {
/*  70 */     return this._noteSequence;
/*     */   }
/*     */   
/*     */   public void setNoteSequence(Long argNoteSequence) {
/*  74 */     if (changed(argNoteSequence, this._noteSequence, "noteSequence")) {
/*  75 */       this._noteSequence = argNoteSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 183 */     if (getTaskId() != null) {
/* 184 */       buf.append("taskId").append("=").append(getTaskId()).append(" ");
/*     */     }
/* 186 */     if (getNoteSequence() != null) {
/* 187 */       buf.append("noteSequence").append("=").append(getNoteSequence()).append(" ");
/*     */     }
...
/* 221 */     EmployeeTaskNotePropertyId id = new EmployeeTaskNotePropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setRetailLocationId(getRetailLocationId());
/* 224 */     id.setTaskId(getTaskId());
/* 225 */     id.setNoteSequence(getNoteSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((EmployeeTaskNotePropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((EmployeeTaskNotePropertyId)argObjectId).getRetailLocationId());
/* 233 */     setTaskId(((EmployeeTaskNotePropertyId)argObjectId).getTaskId());
/* 234 */     setNoteSequence(((EmployeeTaskNotePropertyId)argObjectId).getNoteSequence());
/* 235 */     setPropertyCode(((EmployeeTaskNotePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"EmployeeTaskNoteProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._taskId != null) values.put("TaskId", DaoUtils.getXmlSafeFieldValue(-5, this._taskId)); 
/* 256 */     if (this._noteSequence != null) values.put("NoteSequence", DaoUtils.getXmlSafeFieldValue(-5, this._noteSequence)); 
...
/* 299 */             setTaskId((Long)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setTaskId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "NoteSequence":
...
/* 308 */             setNoteSequence((Long)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setNoteSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeTaskNotePropertyDAO.class
