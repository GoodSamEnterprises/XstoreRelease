...
/*     */ 
/*     */ 
/*     */ public class PrivilegePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 23213958L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PrivilegePropertyDAO.class);
/*     */   
...
/*  48 */     return this._privilegeType;
/*     */   }
/*     */   
/*     */   public void setPrivilegeType(String argPrivilegeType) {
/*  52 */     if (changed(argPrivilegeType, this._privilegeType, "privilegeType")) {
/*  53 */       this._privilegeType = (argPrivilegeType != null && MANAGE_CASE) ? argPrivilegeType.toUpperCase() : argPrivilegeType;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getPrivilegeType() != null) {
/* 159 */       buf.append("privilegeType").append("=").append(getPrivilegeType()).append(" ");
/*     */     }
...
/* 193 */     PrivilegePropertyId id = new PrivilegePropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setPrivilegeType(getPrivilegeType());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((PrivilegePropertyId)argObjectId).getOrganizationId());
/* 202 */     setPrivilegeType(((PrivilegePropertyId)argObjectId).getPrivilegeType());
/* 203 */     setPropertyCode(((PrivilegePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"PrivilegeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._privilegeType != null) values.put("PrivilegeType", DaoUtils.getXmlSafeFieldValue(12, this._privilegeType)); 
...
/* 256 */             setPrivilegeType((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setPrivilegeType() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\PrivilegePropertyDAO.class
