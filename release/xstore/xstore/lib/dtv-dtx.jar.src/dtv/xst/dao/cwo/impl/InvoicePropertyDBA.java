...
/*     */ 
/*     */ 
/*     */ public class InvoicePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.service_loc_id, t.invoice_number, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_invoice_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND service_loc_id = ?  AND invoice_number = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.service_loc_id, t.invoice_number, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_invoice_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND service_loc_id = ?  AND invoice_number = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cwo_invoice_p(organization_id, service_loc_id, invoice_number, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._serviceLocationId, this._invoiceNumber, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cwo_invoice_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cwo_invoice_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND service_loc_id = ?  AND invoice_number = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND service_loc_id = ?  AND invoice_number = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._serviceLocationId, this._invoiceNumber, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new InvoicePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class InvoicePropertyFiller
/*     */     implements IFiller {
/*     */     private InvoicePropertyDBA _parent;
/*     */     
/*     */     public InvoicePropertyFiller(InvoicePropertyDBA argParent) {
...
/* 193 */     return loadDAO((IDataAccessObject)new InvoicePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     InvoicePropertyDAO dao = (InvoicePropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._serviceLocationId = dao.getServiceLocationId();
/* 200 */     this._invoiceNumber = dao.getInvoiceNumber();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\InvoicePropertyDBA.class
