...
/*     */ 
/*     */ 
/*     */ public class DiscountTypeEligibilityPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1074738247L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DiscountTypeEligibilityPropertyDAO.class);
/*     */   
...
/*  43 */     if (changed(argDiscountCode, this._discountCode, "discountCode")) {
/*  44 */       this._discountCode = (argDiscountCode != null && MANAGE_CASE) ? argDiscountCode.toUpperCase() : argDiscountCode;
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     return this._saleLineItemTypeCode;
/*     */   }
/*     */   
/*     */   public void setSaleLineItemTypeCode(String argSaleLineItemTypeCode) {
/*  63 */     if (changed(argSaleLineItemTypeCode, this._saleLineItemTypeCode, "saleLineItemTypeCode")) {
...
/* 166 */     if (getDiscountCode() != null) {
/* 167 */       buf.append("discountCode").append("=").append(getDiscountCode()).append(" ");
/*     */     }
/* 169 */     if (getOrganizationId() != null) {
/* 170 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 172 */     if (getSaleLineItemTypeCode() != null) {
/* 173 */       buf.append("saleLineItemTypeCode").append("=").append(getSaleLineItemTypeCode()).append(" ");
/*     */     }
...
/* 207 */     DiscountTypeEligibilityPropertyId id = new DiscountTypeEligibilityPropertyId();
/* 208 */     id.setDiscountCode(getDiscountCode());
/* 209 */     id.setOrganizationId(getOrganizationId());
/* 210 */     id.setSaleLineItemTypeCode(getSaleLineItemTypeCode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setDiscountCode(((DiscountTypeEligibilityPropertyId)argObjectId).getDiscountCode());
/* 217 */     setOrganizationId(((DiscountTypeEligibilityPropertyId)argObjectId).getOrganizationId());
/* 218 */     setSaleLineItemTypeCode(((DiscountTypeEligibilityPropertyId)argObjectId).getSaleLineItemTypeCode());
/* 219 */     setPropertyCode(((DiscountTypeEligibilityPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DiscountTypeEligibilityProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._discountCode != null) values.put("DiscountCode", DaoUtils.getXmlSafeFieldValue(12, this._discountCode)); 
/* 238 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 239 */     if (this._saleLineItemTypeCode != null) values.put("SaleLineItemTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._saleLineItemTypeCode)); 
...
/* 264 */             setDiscountCode((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setDiscountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 282 */             setSaleLineItemTypeCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setSaleLineItemTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountTypeEligibilityPropertyDAO.class
