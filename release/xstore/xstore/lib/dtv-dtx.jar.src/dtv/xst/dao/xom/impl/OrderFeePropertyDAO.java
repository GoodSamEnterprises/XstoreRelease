...
/*     */ 
/*     */ 
/*     */ public class OrderFeePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1068282003L;
/*  23 */   private static final Logger _logger = Logger.getLogger(OrderFeePropertyDAO.class);
/*     */   
...
/* 207 */     OrderFeePropertyId id = new OrderFeePropertyId();
...
/* 216 */     setOrganizationId(((OrderFeePropertyId)argObjectId).getOrganizationId());
/* 217 */     setOrderId(((OrderFeePropertyId)argObjectId).getOrderId());
/* 218 */     setSequence(((OrderFeePropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((OrderFeePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"OrderFeeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderFeePropertyDAO.class
