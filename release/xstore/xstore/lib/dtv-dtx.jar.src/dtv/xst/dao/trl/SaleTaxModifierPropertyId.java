...
/*     */ 
/*     */ 
/*     */ public class SaleTaxModifierPropertyId
...
/*     */   
/*     */   public SaleTaxModifierPropertyId() {}
/*     */   
/*     */   public SaleTaxModifierPropertyId(String argObjectIdValue) {
...
/*  62 */     return this._saleTaxModifierSequence;
/*     */   }
/*     */   
/*     */   public void setSaleTaxModifierSequence(Integer argSaleTaxModifierSequence) {
/*  66 */     this._saleTaxModifierSequence = argSaleTaxModifierSequence;
/*     */   }
/*     */   
...
/* 118 */       str = tokens[4];
/*     */       
/* 120 */       setSaleTaxModifierSequence(Integer.valueOf(str));
/* 121 */       str = tokens[5];
/*     */       
...
/* 144 */       return true;
/*     */     }
/* 146 */     if (!(ob instanceof SaleTaxModifierPropertyId)) {
/* 147 */       return false;
/*     */     }
/* 149 */     SaleTaxModifierPropertyId other = (SaleTaxModifierPropertyId)ob;
...
/*     */ 
/*     */       
/* 162 */       .equals(other._retailTransactionLineItemSequence))) && ((this._saleTaxModifierSequence == null && other._saleTaxModifierSequence == null) || (this._saleTaxModifierSequence != null && this._saleTaxModifierSequence
/*     */ 
/*     */       
/* 165 */       .equals(other._saleTaxModifierSequence))) && ((this._transactionSequence == null && other._transactionSequence == null) || (this._transactionSequence != null && this._transactionSequence
/*     */ 
/*     */       
...
/* 184 */       .hashCode()) + ((this._saleTaxModifierSequence == null) ? 0 : this._saleTaxModifierSequence
...
/* 193 */     return "SaleTaxModifierProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 205 */       .append("::").append(String.valueOf(this._saleTaxModifierSequence))
...
/* 220 */       return false;
/*     */     }
/* 222 */     if (this._saleTaxModifierSequence == null) {
/* 223 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\SaleTaxModifierPropertyId.class
