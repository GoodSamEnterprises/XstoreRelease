...
/*     */ 
/*     */ 
/*     */ public class TimecardEntryCommentPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITimecardEntryCommentProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TimecardEntryCommentPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TimecardEntryCommentPropertyDAO getDAO_() {
/*  44 */     return (TimecardEntryCommentPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITimecardEntryCommentProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getWeekEndingDate();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setWeekEndingDate_noev(argWeekEndingDate) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ITimecardEntryCommentProperty.SET_WEEKENDINGDATE, argWeekEndingDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getWeekEndingDate() == null && argWeekEndingDate != null) || (
/* 112 */       getDAO_().getWeekEndingDate() != null && !getDAO_().getWeekEndingDate().equals(argWeekEndingDate))) {
/* 113 */       getDAO_().setWeekEndingDate(argWeekEndingDate);
...
/* 141 */       this._events.post(ITimecardEntryCommentProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(ITimecardEntryCommentProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 203 */     if (getDAO_().getPartyId() != null) {
/* 204 */       return getDAO_().getPartyId().longValue();
/*     */     }
/*     */     
/* 207 */     return 0L;
/*     */   }
...
/* 216 */     if (setPartyId_noev(argPartyId) && 
/* 217 */       this._events != null && 
/* 218 */       postEventsForChanges()) {
/* 219 */       this._events.post(ITimecardEntryCommentProperty.SET_PARTYID, Long.valueOf(argPartyId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 228 */     if ((getDAO_().getPartyId() == null && Long.valueOf(argPartyId) != null) || (
/* 229 */       getDAO_().getPartyId() != null && !getDAO_().getPartyId().equals(Long.valueOf(argPartyId)))) {
/* 230 */       getDAO_().setPartyId(Long.valueOf(argPartyId));
...
/* 242 */     if (getDAO_().getCommentSeq() != null) {
/* 243 */       return getDAO_().getCommentSeq().longValue();
/*     */     }
/*     */     
/* 246 */     return 0L;
/*     */   }
...
/* 255 */     if (setCommentSeq_noev(argCommentSeq) && 
/* 256 */       this._events != null && 
/* 257 */       postEventsForChanges()) {
/* 258 */       this._events.post(ITimecardEntryCommentProperty.SET_COMMENTSEQ, Long.valueOf(argCommentSeq));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 267 */     if ((getDAO_().getCommentSeq() == null && Long.valueOf(argCommentSeq) != null) || (
/* 268 */       getDAO_().getCommentSeq() != null && !getDAO_().getCommentSeq().equals(Long.valueOf(argCommentSeq)))) {
/* 269 */       getDAO_().setCommentSeq(Long.valueOf(argCommentSeq));
...
/* 292 */       this._events.post(ITimecardEntryCommentProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 326 */       this._events.post(ITimecardEntryCommentProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 360 */       this._events.post(ITimecardEntryCommentProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 394 */       this._events.post(ITimecardEntryCommentProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 428 */       this._events.post(ITimecardEntryCommentProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 462 */       this._events.post(ITimecardEntryCommentProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 496 */       this._events.post(ITimecardEntryCommentProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 530 */       this._events.post(ITimecardEntryCommentProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 564 */       this._events.post(ITimecardEntryCommentProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 585 */     if ("TimecardEntryCommentPropertyExtension".equals(argFieldId)) {
...
/* 595 */     if ("TimecardEntryCommentPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\impl\TimecardEntryCommentPropertyModel.class
