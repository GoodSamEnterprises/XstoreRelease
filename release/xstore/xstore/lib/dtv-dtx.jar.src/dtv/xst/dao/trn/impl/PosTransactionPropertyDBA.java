...
/*     */ 
/*     */ 
/*     */ public class PosTransactionPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 926101503L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_trans_p t";
...
/*  47 */     return "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_trans_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  56 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trn_trans_p(organization_id, rtl_loc_id, business_date, wkstn_id, trans_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  73 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trn_trans_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  89 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trn_trans_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND business_date = ?  AND wkstn_id = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   
...
/* 118 */     return new PosTransactionPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class PosTransactionPropertyFiller
/*     */     implements IFiller {
/*     */     private PosTransactionPropertyDBA _parent;
/*     */     
/*     */     public PosTransactionPropertyFiller(PosTransactionPropertyDBA argParent) {
...
/* 208 */     PosTransactionPropertyDAO dao = (PosTransactionPropertyDAO)argDAO;
...
/* 228 */     return loadDAO((IDataAccessObject)new PosTransactionPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 232 */     PosTransactionPropertyDAO dao = (PosTransactionPropertyDAO)argDAO;
...
/* 250 */     PosTransactionPropertyId id = (PosTransactionPropertyId)argId;
...
/* 261 */     PosTransactionPropertyId id = new PosTransactionPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\PosTransactionPropertyDBA.class
