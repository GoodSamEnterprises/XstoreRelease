...
/*     */ 
/*     */ 
/*     */ public class ItemRestrictGS1PropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IItemRestrictGS1Property
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ItemRestrictGS1PropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ItemRestrictGS1PropertyDAO getDAO_() {
/*  44 */     return (ItemRestrictGS1PropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IItemRestrictGS1Property.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IItemRestrictGS1Property.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 133 */     if (setFieldId_noev(argFieldId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IItemRestrictGS1Property.SET_FIELDID, argFieldId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getFieldId() == null && argFieldId != null) || (
/* 146 */       getDAO_().getFieldId() != null && !getDAO_().getFieldId().equals(argFieldId))) {
/* 147 */       getDAO_().setFieldId(argFieldId);
...
/* 159 */     return getDAO_().getStartValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setStartValue_noev(argStartValue) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IItemRestrictGS1Property.SET_STARTVALUE, argStartValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getStartValue() == null && argStartValue != null) || (
/* 180 */       getDAO_().getStartValue() != null && !getDAO_().getStartValue().equals(argStartValue))) {
/* 181 */       getDAO_().setStartValue(argStartValue);
...
/* 204 */       this._events.post(IItemRestrictGS1Property.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IItemRestrictGS1Property.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IItemRestrictGS1Property.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IItemRestrictGS1Property.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IItemRestrictGS1Property.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IItemRestrictGS1Property.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IItemRestrictGS1Property.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IItemRestrictGS1Property.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IItemRestrictGS1Property.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("ItemRestrictGS1PropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("ItemRestrictGS1PropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemRestrictGS1PropertyModel.class
