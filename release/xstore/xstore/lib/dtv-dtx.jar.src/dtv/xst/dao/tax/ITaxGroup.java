...
/*    */ 
/*    */ public interface ITaxGroup extends IDataModel, IHasDataProperty<ITaxGroupProperty> {
...
/* 19 */   public static final EventEnum SET_TAXCODEID = new EventEnum("set taxCodeId");
/* 20 */   public static final EventEnum SET_EXTERNALSYSTEM = new EventEnum("set externalSystem");
/* 21 */   public static final EventEnum SET_TAXCODE = new EventEnum("set TaxCode");
...
/*    */   String getTaxCodeId();
/*    */   
/*    */   void setTaxCodeId(String paramString);
/*    */   
/*    */   String getExternalSystem();
/*    */   
/*    */   void setExternalSystem(String paramString);
/*    */   
/*    */   IDataModel getTaxGroupExt();
/*    */   
/*    */   void setTaxGroupExt(IDataModel paramIDataModel);
/*    */   
/*    */   ITaxCode getTaxCode();
/*    */   
/*    */   void setTaxCode(ITaxCode paramITaxCode);
/*    */   
/*    */   List<ITaxGroupProperty> getProperties();
/*    */   
/*    */   void setProperties(List<ITaxGroupProperty> paramList);
/*    */   
/*    */   void addTaxGroupProperty(ITaxGroupProperty paramITaxGroupProperty);
/*    */   
/*    */   void removeTaxGroupProperty(ITaxGroupProperty paramITaxGroupProperty);
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\ITaxGroup.class
