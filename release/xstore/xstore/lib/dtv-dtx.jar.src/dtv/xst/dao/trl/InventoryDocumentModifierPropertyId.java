...
/*     */ 
/*     */ 
/*     */ public class InventoryDocumentModifierPropertyId
...
/*     */   
/*     */   public InventoryDocumentModifierPropertyId() {}
/*     */   
/*     */   public InventoryDocumentModifierPropertyId(String argObjectIdValue) {
...
/*  45 */     return this._documentModifierSequence;
/*     */   }
/*     */   
/*     */   public void setDocumentModifierSequence(Integer argDocumentModifierSequence) {
/*  49 */     this._documentModifierSequence = argDocumentModifierSequence;
/*     */   }
/*     */   
...
/* 100 */       str = tokens[1];
/*     */       
/* 102 */       setDocumentModifierSequence(Integer.valueOf(str));
/* 103 */       str = tokens[2];
/*     */       
...
/* 132 */       return true;
/*     */     }
/* 134 */     if (!(ob instanceof InventoryDocumentModifierPropertyId)) {
/* 135 */       return false;
/*     */     }
/* 137 */     InventoryDocumentModifierPropertyId other = (InventoryDocumentModifierPropertyId)ob;
/* 138 */     return (((this._businessDate == null && other._businessDate == null) || (this._businessDate != null && this._businessDate
/*     */ 
/*     */       
/* 141 */       .equals(other._businessDate))) && ((this._documentModifierSequence == null && other._documentModifierSequence == null) || (this._documentModifierSequence != null && this._documentModifierSequence
/*     */ 
/*     */       
/* 144 */       .equals(other._documentModifierSequence))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/*     */ 
/*     */       
/* 150 */       .equals(other._retailLocationId))) && ((this._transactionSequence == null && other._transactionSequence == null) || (this._transactionSequence != null && this._transactionSequence
/*     */ 
/*     */       
...
/* 166 */       .hashCode()) + ((this._documentModifierSequence == null) ? 0 : this._documentModifierSequence
...
/* 177 */     return "InventoryDocumentModifierProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 186 */       .append("::").append(String.valueOf(this._documentModifierSequence))
...
/* 197 */       return false;
/*     */     }
/* 199 */     if (this._documentModifierSequence == null) {
/* 200 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\InventoryDocumentModifierPropertyId.class
