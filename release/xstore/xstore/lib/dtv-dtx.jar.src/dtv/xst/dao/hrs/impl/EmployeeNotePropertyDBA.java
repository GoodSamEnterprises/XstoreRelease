...
/*     */ 
/*     */ 
/*     */ public class EmployeeNotePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.employee_id, t.note_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM hrs_employee_notes_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND employee_id = ?  AND note_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.employee_id, t.note_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM hrs_employee_notes_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND employee_id = ?  AND note_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO hrs_employee_notes_p(organization_id, employee_id, note_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._employeeId, this._noteSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE hrs_employee_notes_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM hrs_employee_notes_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND employee_id = ?  AND note_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND employee_id = ?  AND note_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._employeeId, this._noteSequence, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "hrs_employee_notes_p";
/*     */   }
/*     */   
...
/* 116 */     return new EmployeeNotePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class EmployeeNotePropertyFiller
/*     */     implements IFiller {
/*     */     private EmployeeNotePropertyDBA _parent;
/*     */     
/*     */     public EmployeeNotePropertyFiller(EmployeeNotePropertyDBA argParent) {
...
/* 140 */         this._parent._noteSequence = Long.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 182 */     EmployeeNotePropertyDAO dao = (EmployeeNotePropertyDAO)argDAO;
...
/* 200 */     return loadDAO((IDataAccessObject)new EmployeeNotePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     EmployeeNotePropertyDAO dao = (EmployeeNotePropertyDAO)argDAO;
/* 205 */     this._organizationId = dao.getOrganizationId();
/* 206 */     this._employeeId = dao.getEmployeeId();
/* 207 */     this._noteSequence = dao.getNoteSequence();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeNotePropertyDBA.class
