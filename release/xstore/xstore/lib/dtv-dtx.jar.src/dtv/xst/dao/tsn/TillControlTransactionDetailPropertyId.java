...
/*     */ 
/*     */ 
/*     */ public class TillControlTransactionDetailPropertyId
...
/*     */   
/*     */   public TillControlTransactionDetailPropertyId() {}
/*     */   
/*     */   public TillControlTransactionDetailPropertyId(String argObjectIdValue) {
...
/* 132 */       return true;
/*     */     }
/* 134 */     if (!(ob instanceof TillControlTransactionDetailPropertyId)) {
/* 135 */       return false;
/*     */     }
/* 137 */     TillControlTransactionDetailPropertyId other = (TillControlTransactionDetailPropertyId)ob;
...
/*     */ 
/*     */       
/* 153 */       .equals(other._transactionSequence))) && ((this._transactionLineItemSequence == null && other._transactionLineItemSequence == null) || (this._transactionLineItemSequence != null && this._transactionLineItemSequence
/*     */ 
/*     */       
/* 156 */       .equals(other._transactionLineItemSequence))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 170 */       .hashCode()) + ((this._transactionLineItemSequence == null) ? 0 : this._transactionLineItemSequence
...
/* 177 */     return "TillControlTransactionDetailProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 190 */       .append("::").append(String.valueOf(this._transactionLineItemSequence))
...
/* 206 */       return false;
/*     */     }
/* 208 */     if (this._transactionLineItemSequence == null) {
/* 209 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\TillControlTransactionDetailPropertyId.class
