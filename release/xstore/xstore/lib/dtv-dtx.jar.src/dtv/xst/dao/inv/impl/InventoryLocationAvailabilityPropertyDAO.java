...
/*     */ 
/*     */ 
/*     */ public class InventoryLocationAvailabilityPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -807989503L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryLocationAvailabilityPropertyDAO.class);
/*     */   
...
/*  60 */     return this._locationId;
/*     */   }
/*     */   
/*     */   public void setLocationId(String argLocationId) {
/*  64 */     if (changed(argLocationId, this._locationId, "locationId")) {
/*  65 */       this._locationId = (argLocationId != null && MANAGE_CASE) ? argLocationId.toUpperCase() : argLocationId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getAvailabilityCode() {
/*  70 */     return this._availabilityCode;
/*     */   }
/*     */   
/*     */   public void setAvailabilityCode(String argAvailabilityCode) {
/*  74 */     if (changed(argAvailabilityCode, this._availabilityCode, "availabilityCode")) {
/*  75 */       this._availabilityCode = (argAvailabilityCode != null && MANAGE_CASE) ? argAvailabilityCode.toUpperCase() : argAvailabilityCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 183 */     if (getLocationId() != null) {
/* 184 */       buf.append("locationId").append("=").append(getLocationId()).append(" ");
/*     */     }
/* 186 */     if (getAvailabilityCode() != null) {
/* 187 */       buf.append("availabilityCode").append("=").append(getAvailabilityCode()).append(" ");
/*     */     }
...
/* 221 */     InventoryLocationAvailabilityPropertyId id = new InventoryLocationAvailabilityPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setRetailLocationId(getRetailLocationId());
/* 224 */     id.setLocationId(getLocationId());
/* 225 */     id.setAvailabilityCode(getAvailabilityCode());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((InventoryLocationAvailabilityPropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((InventoryLocationAvailabilityPropertyId)argObjectId).getRetailLocationId());
/* 233 */     setLocationId(((InventoryLocationAvailabilityPropertyId)argObjectId).getLocationId());
/* 234 */     setAvailabilityCode(((InventoryLocationAvailabilityPropertyId)argObjectId).getAvailabilityCode());
/* 235 */     setPropertyCode(((InventoryLocationAvailabilityPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"InventoryLocationAvailabilityProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._locationId != null) values.put("LocationId", DaoUtils.getXmlSafeFieldValue(12, this._locationId)); 
/* 256 */     if (this._availabilityCode != null) values.put("AvailabilityCode", DaoUtils.getXmlSafeFieldValue(12, this._availabilityCode)); 
...
/* 299 */             setLocationId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setAvailabilityCode((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setAvailabilityCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryLocationAvailabilityPropertyDAO.class
