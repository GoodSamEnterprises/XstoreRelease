...
/*     */ 
/*     */ 
/*     */ public class SaleTaxModifierId
...
/*     */   
/*     */   public SaleTaxModifierId() {}
/*     */   
/*     */   public SaleTaxModifierId(String argObjectIdValue) {
...
/*  61 */     return this._saleTaxModifierSequence;
/*     */   }
/*     */   
/*     */   public void setSaleTaxModifierSequence(Integer argSaleTaxModifierSequence) {
/*  65 */     this._saleTaxModifierSequence = argSaleTaxModifierSequence;
/*     */   }
/*     */   
...
/* 109 */       str = tokens[4];
/*     */       
/* 111 */       setSaleTaxModifierSequence(Integer.valueOf(str));
/* 112 */       str = tokens[5];
/*     */       
...
/* 127 */       return true;
/*     */     }
/* 129 */     if (!(ob instanceof SaleTaxModifierId)) {
/* 130 */       return false;
/*     */     }
/* 132 */     SaleTaxModifierId other = (SaleTaxModifierId)ob;
...
/*     */ 
/*     */       
/* 145 */       .equals(other._retailTransactionLineItemSequence))) && ((this._saleTaxModifierSequence == null && other._saleTaxModifierSequence == null) || (this._saleTaxModifierSequence != null && this._saleTaxModifierSequence
/*     */ 
/*     */       
/* 148 */       .equals(other._saleTaxModifierSequence))) && ((this._transactionSequence == null && other._transactionSequence == null) || (this._transactionSequence != null && this._transactionSequence
/*     */ 
/*     */       
...
/* 164 */       .hashCode()) + ((this._saleTaxModifierSequence == null) ? 0 : this._saleTaxModifierSequence
...
/* 184 */       .append("::").append(String.valueOf(this._saleTaxModifierSequence))
...
/* 198 */       return false;
/*     */     }
/* 200 */     if (this._saleTaxModifierSequence == null) {
/* 201 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\SaleTaxModifierId.class
