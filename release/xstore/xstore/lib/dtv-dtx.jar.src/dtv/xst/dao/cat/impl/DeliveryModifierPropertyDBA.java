...
/*     */ 
/*     */ 
/*     */ public class DeliveryModifierPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -481781248L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.cust_acct_id, t.cust_acct_code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cat_delivery_modifier_p t";
...
/*  45 */     return "SELECT t.organization_id, t.cust_acct_id, t.cust_acct_code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cat_delivery_modifier_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cat_delivery_modifier_p(organization_id, cust_acct_id, cust_acct_code, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cat_delivery_modifier_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cat_delivery_modifier_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND cust_acct_id = ?  AND cust_acct_code = ?  AND property_code = ?  ";
/*     */   
...
/* 108 */     return "cat_delivery_modifier_p";
/*     */   }
/*     */   
...
/* 116 */     return new DeliveryModifierPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class DeliveryModifierPropertyFiller
/*     */     implements IFiller {
/*     */     private DeliveryModifierPropertyDBA _parent;
/*     */     
/*     */     public DeliveryModifierPropertyFiller(DeliveryModifierPropertyDBA argParent) {
...
/* 175 */     DeliveryModifierPropertyDAO dao = (DeliveryModifierPropertyDAO)argDAO;
...
/* 193 */     return loadDAO((IDataAccessObject)new DeliveryModifierPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     DeliveryModifierPropertyDAO dao = (DeliveryModifierPropertyDAO)argDAO;
...
/* 213 */     DeliveryModifierPropertyId id = (DeliveryModifierPropertyId)argId;
...
/* 222 */     DeliveryModifierPropertyId id = new DeliveryModifierPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\DeliveryModifierPropertyDBA.class
