...
/*     */ 
/*     */ 
/*     */ public class TillControlTransactionDetailPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1566359516L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TillControlTransactionDetailPropertyDAO.class);
/*     */   
...
/*     */     }
/* 215 */     if (getTransactionLineItemSequence() != null) {
/* 216 */       buf.append("transactionLineItemSequence").append("=").append(getTransactionLineItemSequence()).append(" ");
/*     */     }
...
/* 250 */     TillControlTransactionDetailPropertyId id = new TillControlTransactionDetailPropertyId();
...
/* 256 */     id.setTransactionLineItemSequence(getTransactionLineItemSequence());
/* 257 */     id.setPropertyCode(getPropertyCode());
/* 258 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 262 */     setOrganizationId(((TillControlTransactionDetailPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((TillControlTransactionDetailPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setWorkstationId(((TillControlTransactionDetailPropertyId)argObjectId).getWorkstationId());
/* 265 */     setBusinessDate(((TillControlTransactionDetailPropertyId)argObjectId).getBusinessDate());
/* 266 */     setTransactionSequence(((TillControlTransactionDetailPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setTransactionLineItemSequence(((TillControlTransactionDetailPropertyId)argObjectId).getTransactionLineItemSequence());
/* 268 */     setPropertyCode(((TillControlTransactionDetailPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"TillControlTransactionDetailProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 291 */     if (this._transactionLineItemSequence != null) values.put("TransactionLineItemSequence", DaoUtils.getXmlSafeFieldValue(-5, this._transactionLineItemSequence)); 
...
/* 361 */             setTransactionLineItemSequence((Long)value);
/* 362 */           } catch (Exception ee) {
/* 363 */             throw new DtxException("An exception occurred while calling setTransactionLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TillControlTransactionDetailPropertyDAO.class
