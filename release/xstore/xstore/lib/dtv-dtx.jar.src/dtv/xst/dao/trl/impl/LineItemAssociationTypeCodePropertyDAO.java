...
/*     */ 
/*     */ 
/*     */ public class LineItemAssociationTypeCodePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 294909974L;
/*  23 */   private static final Logger _logger = Logger.getLogger(LineItemAssociationTypeCodePropertyDAO.class);
/*     */   
...
/*  38 */     return this._lineItemAssociationTypeCode;
/*     */   }
/*     */   
/*     */   public void setLineItemAssociationTypeCode(String argLineItemAssociationTypeCode) {
/*  42 */     if (changed(argLineItemAssociationTypeCode, this._lineItemAssociationTypeCode, "lineItemAssociationTypeCode")) {
/*  43 */       this._lineItemAssociationTypeCode = (argLineItemAssociationTypeCode != null && MANAGE_CASE) ? argLineItemAssociationTypeCode.toUpperCase() : argLineItemAssociationTypeCode;
/*     */     }
/*     */   }
/*     */   
...
/* 155 */     if (getLineItemAssociationTypeCode() != null) {
/* 156 */       buf.append("lineItemAssociationTypeCode").append("=").append(getLineItemAssociationTypeCode()).append(" ");
/*     */     }
...
/* 193 */     LineItemAssociationTypeCodePropertyId id = new LineItemAssociationTypeCodePropertyId();
/* 194 */     id.setLineItemAssociationTypeCode(getLineItemAssociationTypeCode());
...
/* 201 */     setLineItemAssociationTypeCode(((LineItemAssociationTypeCodePropertyId)argObjectId).getLineItemAssociationTypeCode());
/* 202 */     setOrganizationId(((LineItemAssociationTypeCodePropertyId)argObjectId).getOrganizationId());
/* 203 */     setPropertyCode(((LineItemAssociationTypeCodePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"LineItemAssociationTypeCodeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 221 */     if (this._lineItemAssociationTypeCode != null) values.put("LineItemAssociationTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._lineItemAssociationTypeCode)); 
...
/* 247 */             setLineItemAssociationTypeCode((String)value);
/* 248 */           } catch (Exception ee) {
/* 249 */             throw new DtxException("An exception occurred while calling setLineItemAssociationTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
/*     */           try {
/* 255 */             Object value = DaoUtils.getFieldValueForXmlString(-5, fieldValue);
/* 256 */             setOrganizationId((Long)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setOrganizationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\LineItemAssociationTypeCodePropertyDAO.class
