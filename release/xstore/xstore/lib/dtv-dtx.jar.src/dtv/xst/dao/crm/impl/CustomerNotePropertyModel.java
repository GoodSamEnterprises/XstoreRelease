...
/*     */ 
/*     */ 
/*     */ public class CustomerNotePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ICustomerNoteProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new CustomerNotePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private CustomerNotePropertyDAO getDAO_() {
/*  44 */     return (CustomerNotePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ICustomerNoteProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(ICustomerNoteProperty.SET_PARTYID, Long.valueOf(argPartyId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     if (getDAO_().getNoteSequence() != null) {
/* 131 */       return getDAO_().getNoteSequence().longValue();
/*     */     }
/*     */     
/* 134 */     return 0L;
/*     */   }
...
/* 143 */     if (setNoteSequence_noev(argNoteSequence) && 
/* 144 */       this._events != null && 
/* 145 */       postEventsForChanges()) {
/* 146 */       this._events.post(ICustomerNoteProperty.SET_NOTESEQUENCE, Long.valueOf(argNoteSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 155 */     if ((getDAO_().getNoteSequence() == null && Long.valueOf(argNoteSequence) != null) || (
/* 156 */       getDAO_().getNoteSequence() != null && !getDAO_().getNoteSequence().equals(Long.valueOf(argNoteSequence)))) {
/* 157 */       getDAO_().setNoteSequence(Long.valueOf(argNoteSequence));
...
/* 180 */       this._events.post(ICustomerNoteProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 214 */       this._events.post(ICustomerNoteProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 248 */       this._events.post(ICustomerNoteProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(ICustomerNoteProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(ICustomerNoteProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(ICustomerNoteProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(ICustomerNoteProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(ICustomerNoteProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(ICustomerNoteProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 473 */     if ("CustomerNotePropertyExtension".equals(argFieldId)) {
...
/* 483 */     if ("CustomerNotePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\CustomerNotePropertyModel.class
