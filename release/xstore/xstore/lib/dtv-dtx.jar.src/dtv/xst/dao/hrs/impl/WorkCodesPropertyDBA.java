...
/*     */ 
/*     */ 
/*     */ public class WorkCodesPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1399404650L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.work_code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM hrs_work_codes_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND work_code = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.work_code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM hrs_work_codes_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND work_code = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO hrs_work_codes_p(organization_id, work_code, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._workCode, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE hrs_work_codes_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM hrs_work_codes_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND work_code = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND work_code = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._workCode, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new WorkCodesPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class WorkCodesPropertyFiller
/*     */     implements IFiller {
/*     */     private WorkCodesPropertyDBA _parent;
/*     */     
/*     */     public WorkCodesPropertyFiller(WorkCodesPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._workCode = argResultSet.getString(2);
...
/* 173 */     WorkCodesPropertyDAO dao = (WorkCodesPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setWorkCode(this._workCode);
...
/* 190 */     return loadDAO((IDataAccessObject)new WorkCodesPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     WorkCodesPropertyDAO dao = (WorkCodesPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._workCode = dao.getWorkCode();
...
/* 209 */     WorkCodesPropertyId id = (WorkCodesPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getWorkCode());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     WorkCodesPropertyId id = new WorkCodesPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setWorkCode(this._workCode);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\WorkCodesPropertyDBA.class
