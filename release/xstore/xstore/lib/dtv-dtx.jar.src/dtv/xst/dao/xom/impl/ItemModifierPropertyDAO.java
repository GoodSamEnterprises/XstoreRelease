...
/*     */ 
/*     */ 
/*     */ public class ItemModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1414523679L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemModifierPropertyDAO.class);
/*     */   
...
/* 207 */     ItemModifierPropertyId id = new ItemModifierPropertyId();
...
/* 216 */     setOrganizationId(((ItemModifierPropertyId)argObjectId).getOrganizationId());
/* 217 */     setOrderId(((ItemModifierPropertyId)argObjectId).getOrderId());
/* 218 */     setSequence(((ItemModifierPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((ItemModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"ItemModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\ItemModifierPropertyDAO.class
