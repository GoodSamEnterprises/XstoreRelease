...
/*     */ 
/*     */ 
/*     */ public class PartyCrossReferencePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1716982854L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PartyCrossReferencePropertyDAO.class);
/*     */   
...
/*  40 */     return this._childPartyId;
/*     */   }
/*     */   
/*     */   public void setChildPartyId(Long argChildPartyId) {
/*  44 */     if (changed(argChildPartyId, this._childPartyId, "childPartyId")) {
/*  45 */       this._childPartyId = argChildPartyId;
/*     */     }
/*     */   }
/*     */   
...
/*  60 */     return this._parentPartyId;
/*     */   }
/*     */   
/*     */   public void setParentPartyId(Long argParentPartyId) {
/*  64 */     if (changed(argParentPartyId, this._parentPartyId, "parentPartyId")) {
/*  65 */       this._parentPartyId = argParentPartyId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getPartyRelationshipTypeCode() {
/*  70 */     return this._partyRelationshipTypeCode;
/*     */   }
/*     */   
/*     */   public void setPartyRelationshipTypeCode(String argPartyRelationshipTypeCode) {
/*  74 */     if (changed(argPartyRelationshipTypeCode, this._partyRelationshipTypeCode, "partyRelationshipTypeCode")) {
/*  75 */       this._partyRelationshipTypeCode = (argPartyRelationshipTypeCode != null && MANAGE_CASE) ? argPartyRelationshipTypeCode.toUpperCase() : argPartyRelationshipTypeCode;
/*     */     }
/*     */   }
/*     */   
...
/* 177 */     if (getChildPartyId() != null) {
/* 178 */       buf.append("childPartyId").append("=").append(getChildPartyId()).append(" ");
/*     */     }
/* 180 */     if (getOrganizationId() != null) {
/* 181 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 183 */     if (getParentPartyId() != null) {
/* 184 */       buf.append("parentPartyId").append("=").append(getParentPartyId()).append(" ");
/*     */     }
/* 186 */     if (getPartyRelationshipTypeCode() != null) {
/* 187 */       buf.append("partyRelationshipTypeCode").append("=").append(getPartyRelationshipTypeCode()).append(" ");
/*     */     }
...
/* 221 */     PartyCrossReferencePropertyId id = new PartyCrossReferencePropertyId();
/* 222 */     id.setChildPartyId(getChildPartyId());
/* 223 */     id.setOrganizationId(getOrganizationId());
/* 224 */     id.setParentPartyId(getParentPartyId());
/* 225 */     id.setPartyRelationshipTypeCode(getPartyRelationshipTypeCode());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setChildPartyId(((PartyCrossReferencePropertyId)argObjectId).getChildPartyId());
/* 232 */     setOrganizationId(((PartyCrossReferencePropertyId)argObjectId).getOrganizationId());
/* 233 */     setParentPartyId(((PartyCrossReferencePropertyId)argObjectId).getParentPartyId());
/* 234 */     setPartyRelationshipTypeCode(((PartyCrossReferencePropertyId)argObjectId).getPartyRelationshipTypeCode());
/* 235 */     setPropertyCode(((PartyCrossReferencePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"PartyCrossReferenceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 253 */     if (this._childPartyId != null) values.put("ChildPartyId", DaoUtils.getXmlSafeFieldValue(-5, this._childPartyId)); 
/* 254 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 255 */     if (this._parentPartyId != null) values.put("ParentPartyId", DaoUtils.getXmlSafeFieldValue(-5, this._parentPartyId)); 
/* 256 */     if (this._partyRelationshipTypeCode != null) values.put("PartyRelationshipTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._partyRelationshipTypeCode)); 
...
/* 281 */             setChildPartyId((Long)value);
/* 282 */           } catch (Exception ee) {
/* 283 */             throw new DtxException("An exception occurred while calling setChildPartyId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 299 */             setParentPartyId((Long)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setParentPartyId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setPartyRelationshipTypeCode((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setPartyRelationshipTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\PartyCrossReferencePropertyDAO.class
