...
/*     */ 
/*     */ 
/*     */ public class DealTriggerPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -36700799L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.deal_id, t.deal_trigger, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM prc_deal_trig_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND deal_id = ?  AND deal_trigger = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.deal_id, t.deal_trigger, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM prc_deal_trig_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND deal_id = ?  AND deal_trigger = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO prc_deal_trig_p(organization_id, deal_id, deal_trigger, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._dealId, this._trigger, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE prc_deal_trig_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM prc_deal_trig_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND deal_id = ?  AND deal_trigger = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND deal_id = ?  AND deal_trigger = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._dealId, this._trigger, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new DealTriggerPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class DealTriggerPropertyFiller
/*     */     implements IFiller {
/*     */     private DealTriggerPropertyDBA _parent;
/*     */     
/*     */     public DealTriggerPropertyFiller(DealTriggerPropertyDBA argParent) {
...
/* 136 */       this._parent._trigger = argResultSet.getString(3);
...
/* 175 */     DealTriggerPropertyDAO dao = (DealTriggerPropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setDealId(this._dealId);
/* 178 */     dao.setTrigger(this._trigger);
...
/* 193 */     return loadDAO((IDataAccessObject)new DealTriggerPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     DealTriggerPropertyDAO dao = (DealTriggerPropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._dealId = dao.getDealId();
/* 200 */     this._trigger = dao.getTrigger();
...
/* 213 */     DealTriggerPropertyId id = (DealTriggerPropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getDealId());
/* 216 */     argStatement.setString(3, id.getTrigger());
/* 217 */     argStatement.setString(4, id.getPropertyCode());
/* 218 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 222 */     DealTriggerPropertyId id = new DealTriggerPropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setDealId(this._dealId);
/* 225 */     id.setTrigger(this._trigger);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealTriggerPropertyDBA.class
