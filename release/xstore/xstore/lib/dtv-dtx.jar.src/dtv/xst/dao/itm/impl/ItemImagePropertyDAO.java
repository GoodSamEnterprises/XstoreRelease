...
/*     */ 
/*     */ 
/*     */ public class ItemImagePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 459615197L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemImagePropertyDAO.class);
/*     */   
...
/*  59 */     return this._featureId;
/*     */   }
/*     */   
/*     */   public void setFeatureId(String argFeatureId) {
/*  63 */     if (changed(argFeatureId, this._featureId, "featureId")) {
/*  64 */       this._featureId = (argFeatureId != null && MANAGE_CASE) ? argFeatureId.toUpperCase() : argFeatureId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getFeatureId() != null) {
/* 173 */       buf.append("featureId").append("=").append(getFeatureId()).append(" ");
/*     */     }
...
/* 207 */     ItemImagePropertyId id = new ItemImagePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setItemId(getItemId());
/* 210 */     id.setFeatureId(getFeatureId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((ItemImagePropertyId)argObjectId).getOrganizationId());
/* 217 */     setItemId(((ItemImagePropertyId)argObjectId).getItemId());
/* 218 */     setFeatureId(((ItemImagePropertyId)argObjectId).getFeatureId());
/* 219 */     setPropertyCode(((ItemImagePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"ItemImageProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._featureId != null) values.put("FeatureId", DaoUtils.getXmlSafeFieldValue(12, this._featureId)); 
...
/* 282 */             setFeatureId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setFeatureId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemImagePropertyDAO.class
