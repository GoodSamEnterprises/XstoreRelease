...
/*     */ 
/*     */ 
/*     */ public class DiscountGroupMappingPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IDiscountGroupMappingProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new DiscountGroupMappingPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private DiscountGroupMappingPropertyDAO getDAO_() {
/*  44 */     return (DiscountGroupMappingPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  52 */     return getDAO_().getCustomerGroupId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     if (setCustomerGroupId_noev(argCustomerGroupId) && 
/*  61 */       this._events != null && 
/*  62 */       postEventsForChanges()) {
/*  63 */       this._events.post(IDiscountGroupMappingProperty.SET_CUSTOMERGROUPID, argCustomerGroupId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*  72 */     if ((getDAO_().getCustomerGroupId() == null && argCustomerGroupId != null) || (
/*  73 */       getDAO_().getCustomerGroupId() != null && !getDAO_().getCustomerGroupId().equals(argCustomerGroupId))) {
/*  74 */       getDAO_().setCustomerGroupId(argCustomerGroupId);
/*  75 */       ev_postable = true;
/*     */     } 
/*     */     
...
/*  86 */     return getDAO_().getDiscountCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  94 */     if (setDiscountCode_noev(argDiscountCode) && 
/*  95 */       this._events != null && 
/*  96 */       postEventsForChanges()) {
/*  97 */       this._events.post(IDiscountGroupMappingProperty.SET_DISCOUNTCODE, argDiscountCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 106 */     if ((getDAO_().getDiscountCode() == null && argDiscountCode != null) || (
/* 107 */       getDAO_().getDiscountCode() != null && !getDAO_().getDiscountCode().equals(argDiscountCode))) {
/* 108 */       getDAO_().setDiscountCode(argDiscountCode);
...
/* 136 */       this._events.post(IDiscountGroupMappingProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 170 */       this._events.post(IDiscountGroupMappingProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IDiscountGroupMappingProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IDiscountGroupMappingProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IDiscountGroupMappingProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IDiscountGroupMappingProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IDiscountGroupMappingProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IDiscountGroupMappingProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IDiscountGroupMappingProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IDiscountGroupMappingProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("DiscountGroupMappingPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("DiscountGroupMappingPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountGroupMappingPropertyModel.class
