...
/*     */ 
/*     */ 
/*     */ public class WorkItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -666155047L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WorkItemPropertyDAO.class);
/*     */   
...
/*  70 */     return this._workItemSequence;
/*     */   }
/*     */   
/*     */   public void setWorkItemSequence(Integer argWorkItemSequence) {
/*  74 */     if (changed(argWorkItemSequence, this._workItemSequence, "workItemSequence")) {
/*  75 */       this._workItemSequence = argWorkItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 186 */     if (getWorkItemSequence() != null) {
/* 187 */       buf.append("workItemSequence").append("=").append(getWorkItemSequence()).append(" ");
/*     */     }
...
/* 221 */     WorkItemPropertyId id = new WorkItemPropertyId();
...
/* 225 */     id.setWorkItemSequence(getWorkItemSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((WorkItemPropertyId)argObjectId).getOrganizationId());
/* 232 */     setCustAccountId(((WorkItemPropertyId)argObjectId).getCustAccountId());
/* 233 */     setCustAccountCode(((WorkItemPropertyId)argObjectId).getCustAccountCode());
/* 234 */     setWorkItemSequence(((WorkItemPropertyId)argObjectId).getWorkItemSequence());
/* 235 */     setPropertyCode(((WorkItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"WorkItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 256 */     if (this._workItemSequence != null) values.put("WorkItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._workItemSequence)); 
...
/* 308 */             setWorkItemSequence((Integer)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setWorkItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkItemPropertyDAO.class
