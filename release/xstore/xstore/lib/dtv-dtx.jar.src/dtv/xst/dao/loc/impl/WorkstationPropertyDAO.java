...
/*     */ 
/*     */ 
/*     */ public class WorkstationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1638837208L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WorkstationPropertyDAO.class);
/*     */   
...
/* 207 */     WorkstationPropertyId id = new WorkstationPropertyId();
...
/* 216 */     setOrganizationId(((WorkstationPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((WorkstationPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setWorkstationId(((WorkstationPropertyId)argObjectId).getWorkstationId());
/* 219 */     setPropertyCode(((WorkstationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"WorkstationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\WorkstationPropertyDAO.class
