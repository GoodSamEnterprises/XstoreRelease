...
/*     */ 
/*     */ 
/*     */ public class TenderPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -566366999L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderPropertyDAO.class);
/*     */   
...
/*  52 */     if (changed(argTenderId, this._tenderId, "tenderId")) {
/*  53 */       this._tenderId = (argTenderId != null && MANAGE_CASE) ? argTenderId.toUpperCase() : argTenderId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getTenderId() != null) {
/* 159 */       buf.append("tenderId").append("=").append(getTenderId()).append(" ");
/*     */     }
...
/* 193 */     TenderPropertyId id = new TenderPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setTenderId(getTenderId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((TenderPropertyId)argObjectId).getOrganizationId());
/* 202 */     setTenderId(((TenderPropertyId)argObjectId).getTenderId());
/* 203 */     setPropertyCode(((TenderPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"TenderProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._tenderId != null) values.put("TenderId", DaoUtils.getXmlSafeFieldValue(12, this._tenderId)); 
...
/* 256 */             setTenderId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setTenderId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderPropertyDAO.class
