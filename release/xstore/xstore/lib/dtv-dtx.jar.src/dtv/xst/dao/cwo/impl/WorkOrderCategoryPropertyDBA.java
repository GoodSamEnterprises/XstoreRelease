...
/*     */ 
/*     */ 
/*     */ public class WorkOrderCategoryPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.category_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_work_order_category_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND category_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.category_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_work_order_category_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND category_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cwo_work_order_category_p(organization_id, category_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._categoryId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cwo_work_order_category_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cwo_work_order_category_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND category_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND category_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._categoryId, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "cwo_work_order_category_p";
/*     */   }
/*     */   
...
/* 115 */     return new WorkOrderCategoryPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class WorkOrderCategoryPropertyFiller
/*     */     implements IFiller {
/*     */     private WorkOrderCategoryPropertyDBA _parent;
/*     */     
/*     */     public WorkOrderCategoryPropertyFiller(WorkOrderCategoryPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._categoryId = argResultSet.getString(2);
...
/* 173 */     WorkOrderCategoryPropertyDAO dao = (WorkOrderCategoryPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setCategoryId(this._categoryId);
...
/* 190 */     return loadDAO((IDataAccessObject)new WorkOrderCategoryPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     WorkOrderCategoryPropertyDAO dao = (WorkOrderCategoryPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._categoryId = dao.getCategoryId();
...
/* 209 */     WorkOrderCategoryPropertyId id = (WorkOrderCategoryPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getCategoryId());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     WorkOrderCategoryPropertyId id = new WorkOrderCategoryPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setCategoryId(this._categoryId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkOrderCategoryPropertyDBA.class
