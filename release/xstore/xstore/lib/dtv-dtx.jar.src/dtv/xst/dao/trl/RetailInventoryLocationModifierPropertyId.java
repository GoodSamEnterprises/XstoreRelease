...
/*     */ 
/*     */ 
/*     */ public class RetailInventoryLocationModifierPropertyId
...
/*     */   
/*     */   public RetailInventoryLocationModifierPropertyId() {}
/*     */   
/*     */   public RetailInventoryLocationModifierPropertyId(String argObjectIdValue) {
...
/*  78 */     return this._modifierSequence;
/*     */   }
/*     */   
/*     */   public void setModifierSequence(Long argModifierSequence) {
/*  82 */     this._modifierSequence = argModifierSequence;
/*     */   }
/*     */   
...
/* 124 */       str = tokens[6];
/*     */       
/* 126 */       setModifierSequence(Long.valueOf(str));
/* 127 */       str = tokens[7];
/*     */       
...
/* 144 */       return true;
/*     */     }
/* 146 */     if (!(ob instanceof RetailInventoryLocationModifierPropertyId)) {
/* 147 */       return false;
/*     */     }
/* 149 */     RetailInventoryLocationModifierPropertyId other = (RetailInventoryLocationModifierPropertyId)ob;
...
/*     */ 
/*     */       
/* 168 */       .equals(other._transactionLineItemSequence))) && ((this._modifierSequence == null && other._modifierSequence == null) || (this._modifierSequence != null && this._modifierSequence
/*     */ 
/*     */       
/* 171 */       .equals(other._modifierSequence))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 186 */       .hashCode()) + ((this._modifierSequence == null) ? 0 : this._modifierSequence
...
/* 193 */     return "RetailInventoryLocationModifierProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 207 */       .append("::").append(String.valueOf(this._modifierSequence))
...
/* 226 */       return false;
/*     */     }
/* 228 */     if (this._modifierSequence == null) {
/* 229 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\RetailInventoryLocationModifierPropertyId.class
