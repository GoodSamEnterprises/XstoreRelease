...
/*     */ 
/*     */ 
/*     */ public class TimecardEntryPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -537577494L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TimecardEntryPropertyDAO.class);
/*     */   
...
/*  56 */     if (changed(argBusinessDate, this._businessDate, "businessDate")) {
...
/*  83 */     return this._timecardEntryId;
/*     */   }
/*     */   
/*     */   public void setTimecardEntryId(Long argTimecardEntryId) {
/*  87 */     if (changed(argTimecardEntryId, this._timecardEntryId, "timecardEntryId")) {
/*  88 */       this._timecardEntryId = argTimecardEntryId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 203 */     if (getBusinessDate() != null) {
/* 204 */       buf.append("businessDate").append("=").append(getBusinessDate()).append(" ");
/*     */     }
/* 206 */     if (getRetailLocationId() != null) {
/* 207 */       buf.append("retailLocationId").append("=").append(getRetailLocationId()).append(" ");
/*     */     }
/* 209 */     if (getPartyId() != null) {
/* 210 */       buf.append("partyId").append("=").append(getPartyId()).append(" ");
/*     */     }
/* 212 */     if (getTimecardEntryId() != null) {
/* 213 */       buf.append("timecardEntryId").append("=").append(getTimecardEntryId()).append(" ");
/*     */     }
...
/* 250 */     TimecardEntryPropertyId id = new TimecardEntryPropertyId();
...
/* 254 */     id.setPartyId(getPartyId());
/* 255 */     id.setTimecardEntryId(getTimecardEntryId());
...
/* 262 */     setOrganizationId(((TimecardEntryPropertyId)argObjectId).getOrganizationId());
/* 263 */     setBusinessDate(((TimecardEntryPropertyId)argObjectId).getBusinessDate());
/* 264 */     setRetailLocationId(((TimecardEntryPropertyId)argObjectId).getRetailLocationId());
/* 265 */     setPartyId(((TimecardEntryPropertyId)argObjectId).getPartyId());
/* 266 */     setTimecardEntryId(((TimecardEntryPropertyId)argObjectId).getTimecardEntryId());
/* 267 */     setWorkstationId(((TimecardEntryPropertyId)argObjectId).getWorkstationId());
/* 268 */     setPropertyCode(((TimecardEntryPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"TimecardEntryProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 290 */     if (this._timecardEntryId != null) values.put("TimecardEntryId", DaoUtils.getXmlSafeFieldValue(-5, this._timecardEntryId)); 
...
/* 352 */             setTimecardEntryId((Long)value);
/* 353 */           } catch (Exception ee) {
/* 354 */             throw new DtxException("An exception occurred while calling setTimecardEntryId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "WorkstationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\impl\TimecardEntryPropertyDAO.class
