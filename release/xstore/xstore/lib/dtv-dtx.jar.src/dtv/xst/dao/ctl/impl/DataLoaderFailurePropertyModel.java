...
/*     */ 
/*     */ 
/*     */ public class DataLoaderFailurePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IDataLoaderFailureProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new DataLoaderFailurePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private DataLoaderFailurePropertyDAO getDAO_() {
/*  44 */     return (DataLoaderFailurePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IDataLoaderFailureProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  99 */     if (setFileName_noev(argFileName) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IDataLoaderFailureProperty.SET_FILENAME, argFileName);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getFileName() == null && argFileName != null) || (
/* 112 */       getDAO_().getFileName() != null && !getDAO_().getFileName().equals(argFileName))) {
/* 113 */       getDAO_().setFileName(argFileName);
...
/* 125 */     if (getDAO_().getRunTime() != null) {
/* 126 */       return getDAO_().getRunTime().longValue();
/*     */     }
/*     */     
/* 129 */     return 0L;
/*     */   }
...
/* 138 */     if (setRunTime_noev(argRunTime) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IDataLoaderFailureProperty.SET_RUNTIME, Long.valueOf(argRunTime));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getRunTime() == null && Long.valueOf(argRunTime) != null) || (
/* 151 */       getDAO_().getRunTime() != null && !getDAO_().getRunTime().equals(Long.valueOf(argRunTime)))) {
/* 152 */       getDAO_().setRunTime(Long.valueOf(argRunTime));
...
/* 164 */     if (getDAO_().getFailureSequence() != null) {
/* 165 */       return getDAO_().getFailureSequence().intValue();
/*     */     }
/*     */     
/* 168 */     return 0;
/*     */   }
...
/* 177 */     if (setFailureSequence_noev(argFailureSequence) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(IDataLoaderFailureProperty.SET_FAILURESEQUENCE, Integer.valueOf(argFailureSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getFailureSequence() == null && Integer.valueOf(argFailureSequence) != null) || (
/* 190 */       getDAO_().getFailureSequence() != null && !getDAO_().getFailureSequence().equals(Integer.valueOf(argFailureSequence)))) {
/* 191 */       getDAO_().setFailureSequence(Integer.valueOf(argFailureSequence));
...
/* 214 */       this._events.post(IDataLoaderFailureProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 248 */       this._events.post(IDataLoaderFailureProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(IDataLoaderFailureProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(IDataLoaderFailureProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(IDataLoaderFailureProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(IDataLoaderFailureProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(IDataLoaderFailureProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(IDataLoaderFailureProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(IDataLoaderFailureProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 507 */     if ("DataLoaderFailurePropertyExtension".equals(argFieldId)) {
...
/* 517 */     if ("DataLoaderFailurePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\DataLoaderFailurePropertyModel.class
