...
/*     */ 
/*     */ 
/*     */ public class XunitResultItemPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IXunitResultItemProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new XunitResultItemPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private XunitResultItemPropertyDAO getDAO_() {
/*  44 */     return (XunitResultItemPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IXunitResultItemProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  99 */     if (setHostname_noev(argHostname) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IXunitResultItemProperty.SET_HOSTNAME, argHostname);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getHostname() == null && argHostname != null) || (
/* 112 */       getDAO_().getHostname() != null && !getDAO_().getHostname().equals(argHostname))) {
/* 113 */       getDAO_().setHostname(argHostname);
...
/* 125 */     if (getDAO_().getResultTimestamp() != null) {
/* 126 */       return getDAO_().getResultTimestamp().longValue();
/*     */     }
/*     */     
/* 129 */     return 0L;
/*     */   }
...
/* 138 */     if (setResultTimestamp_noev(argResultTimestamp) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IXunitResultItemProperty.SET_RESULTTIMESTAMP, Long.valueOf(argResultTimestamp));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getResultTimestamp() == null && Long.valueOf(argResultTimestamp) != null) || (
/* 151 */       getDAO_().getResultTimestamp() != null && !getDAO_().getResultTimestamp().equals(Long.valueOf(argResultTimestamp)))) {
/* 152 */       getDAO_().setResultTimestamp(Long.valueOf(argResultTimestamp));
...
/* 164 */     if (getDAO_().getResultItemSequence() != null) {
/* 165 */       return getDAO_().getResultItemSequence().longValue();
/*     */     }
/*     */     
/* 168 */     return 0L;
/*     */   }
...
/* 177 */     if (setResultItemSequence_noev(argResultItemSequence) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(IXunitResultItemProperty.SET_RESULTITEMSEQUENCE, Long.valueOf(argResultItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getResultItemSequence() == null && Long.valueOf(argResultItemSequence) != null) || (
/* 190 */       getDAO_().getResultItemSequence() != null && !getDAO_().getResultItemSequence().equals(Long.valueOf(argResultItemSequence)))) {
/* 191 */       getDAO_().setResultItemSequence(Long.valueOf(argResultItemSequence));
...
/* 214 */       this._events.post(IXunitResultItemProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 248 */       this._events.post(IXunitResultItemProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(IXunitResultItemProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(IXunitResultItemProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(IXunitResultItemProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(IXunitResultItemProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(IXunitResultItemProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(IXunitResultItemProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(IXunitResultItemProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 507 */     if ("XunitResultItemPropertyExtension".equals(argFieldId)) {
...
/* 517 */     if ("XunitResultItemPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\_test\impl\XunitResultItemPropertyModel.class
