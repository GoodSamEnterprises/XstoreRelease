...
/*     */ 
/*     */ 
/*     */ public class TaxCodePropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 628315661L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.tax_code_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tax_tax_code_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND tax_code_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.tax_code_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tax_tax_code_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND tax_code_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO tax_tax_code_p(organization_id, tax_code_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._taxCodeId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE tax_tax_code_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM tax_tax_code_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND tax_code_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND tax_code_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._taxCodeId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new TaxCodePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TaxCodePropertyFiller
/*     */     implements IFiller {
/*     */     private TaxCodePropertyDBA _parent;
/*     */     
/*     */     public TaxCodePropertyFiller(TaxCodePropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._taxCodeId = argResultSet.getString(2);
...
/* 173 */     TaxCodePropertyDAO dao = (TaxCodePropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setTaxCodeId(this._taxCodeId);
...
/* 190 */     return loadDAO((IDataAccessObject)new TaxCodePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     TaxCodePropertyDAO dao = (TaxCodePropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._taxCodeId = dao.getTaxCodeId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxCodePropertyDBA.class
