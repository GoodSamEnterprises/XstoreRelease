...
/*     */ 
/*     */ 
/*     */ public class DocumentInventoryLocationModifierPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IDocumentInventoryLocationModifierProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new DocumentInventoryLocationModifierPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private DocumentInventoryLocationModifierPropertyDAO getDAO_() {
/*  44 */     return (DocumentInventoryLocationModifierPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 141 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_DOCUMENTID, argDocumentId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 175 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_DOCUMENTTYPECODE, argDocumentTypeCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 198 */     if (getDAO_().getDocumentLineNumber() != null) {
/* 199 */       return getDAO_().getDocumentLineNumber().longValue();
/*     */     }
/*     */     
/* 202 */     return 0L;
/*     */   }
...
/* 211 */     if (setDocumentLineNumber_noev(argDocumentLineNumber) && 
/* 212 */       this._events != null && 
/* 213 */       postEventsForChanges()) {
/* 214 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_DOCUMENTLINENUMBER, Long.valueOf(argDocumentLineNumber));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 223 */     if ((getDAO_().getDocumentLineNumber() == null && Long.valueOf(argDocumentLineNumber) != null) || (
/* 224 */       getDAO_().getDocumentLineNumber() != null && !getDAO_().getDocumentLineNumber().equals(Long.valueOf(argDocumentLineNumber)))) {
/* 225 */       getDAO_().setDocumentLineNumber(Long.valueOf(argDocumentLineNumber));
...
/* 237 */     if (getDAO_().getModifierSequence() != null) {
/* 238 */       return getDAO_().getModifierSequence().longValue();
/*     */     }
/*     */     
/* 241 */     return 0L;
/*     */   }
...
/* 250 */     if (setModifierSequence_noev(argModifierSequence) && 
/* 251 */       this._events != null && 
/* 252 */       postEventsForChanges()) {
/* 253 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_MODIFIERSEQUENCE, Long.valueOf(argModifierSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 262 */     if ((getDAO_().getModifierSequence() == null && Long.valueOf(argModifierSequence) != null) || (
/* 263 */       getDAO_().getModifierSequence() != null && !getDAO_().getModifierSequence().equals(Long.valueOf(argModifierSequence)))) {
/* 264 */       getDAO_().setModifierSequence(Long.valueOf(argModifierSequence));
...
/* 287 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 321 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 355 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 389 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 423 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 457 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 491 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 525 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 559 */       this._events.post(IDocumentInventoryLocationModifierProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 580 */     if ("DocumentInventoryLocationModifierPropertyExtension".equals(argFieldId)) {
...
/* 590 */     if ("DocumentInventoryLocationModifierPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\DocumentInventoryLocationModifierPropertyModel.class
