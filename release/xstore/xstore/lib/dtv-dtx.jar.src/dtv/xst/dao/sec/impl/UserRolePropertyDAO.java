...
/*     */ 
/*     */ 
/*     */ public class UserRolePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -225634314L;
/*  23 */   private static final Logger _logger = Logger.getLogger(UserRolePropertyDAO.class);
/*     */   
...
/*  48 */     return this._userRoleId;
/*     */   }
/*     */   
/*     */   public void setUserRoleId(Integer argUserRoleId) {
/*  52 */     if (changed(argUserRoleId, this._userRoleId, "userRoleId")) {
/*  53 */       this._userRoleId = argUserRoleId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getUserRoleId() != null) {
/* 159 */       buf.append("userRoleId").append("=").append(getUserRoleId()).append(" ");
/*     */     }
...
/* 193 */     UserRolePropertyId id = new UserRolePropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setUserRoleId(getUserRoleId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((UserRolePropertyId)argObjectId).getOrganizationId());
/* 202 */     setUserRoleId(((UserRolePropertyId)argObjectId).getUserRoleId());
/* 203 */     setPropertyCode(((UserRolePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"UserRoleProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._userRoleId != null) values.put("UserRoleId", DaoUtils.getXmlSafeFieldValue(4, this._userRoleId)); 
...
/* 256 */             setUserRoleId((Integer)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setUserRoleId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\UserRolePropertyDAO.class
