...
/*    */ 
/*    */ 
/*    */ public class PosTransactionLinkLinkedTransactionRelationshipDBA
...
/* 29 */     PosTransactionLinkDAO dao = (PosTransactionLinkDAO)argDAO;
...
/* 33 */     this._parameterList.add(dao.getLinkRetailLocationId());
/* 34 */     this._childObjectId.setRetailLocationId(dao.getLinkRetailLocationId());
/* 35 */     this._parameterList.add(dao.getLinkBusinessDate());
/* 36 */     this._childObjectId.setBusinessDate(dao.getLinkBusinessDate());
/* 37 */     this._parameterList.add(dao.getLinkWorkstationId());
/* 38 */     this._childObjectId.setWorkstationId(dao.getLinkWorkstationId());
/* 39 */     this._parameterList.add(dao.getLinkTransactionSequence());
/* 40 */     this._childObjectId.setTransactionSequence(dao.getLinkTransactionSequence());
/*    */   }
/*    */ 
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\PosTransactionLinkLinkedTransactionRelationshipDBA.class
