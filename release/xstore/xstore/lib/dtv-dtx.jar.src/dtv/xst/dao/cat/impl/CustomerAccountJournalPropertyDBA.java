...
/*     */ 
/*     */ 
/*     */ public class CustomerAccountJournalPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1985877469L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.cust_acct_id, t.cust_acct_code, t.journal_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cat_cust_acct_journal_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND cust_acct_id = ?  AND cust_acct_code = ?  AND journal_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  46 */     return "SELECT t.organization_id, t.cust_acct_id, t.cust_acct_code, t.journal_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cat_cust_acct_journal_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  52 */     return " WHERE organization_id = ?  AND cust_acct_id = ?  AND cust_acct_code = ?  AND journal_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  55 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cat_cust_acct_journal_p(organization_id, cust_acct_id, cust_acct_code, journal_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  62 */     Object[][] insertParameterObject = { { this._organizationId, this._custAccountId, this._custAccountCode, this._journalSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  72 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cat_cust_acct_journal_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  88 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cat_cust_acct_journal_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND cust_acct_id = ?  AND cust_acct_code = ?  AND journal_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  97 */     return " WHERE organization_id = ?  AND cust_acct_id = ?  AND cust_acct_code = ?  AND journal_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 100 */     return new Object[] { this._organizationId, this._custAccountId, this._custAccountCode, this._journalSequence, this._propertyCode };
/*     */   }
/*     */   
...
/* 109 */     return "cat_cust_acct_journal_p";
/*     */   }
/*     */   
...
/* 117 */     return new CustomerAccountJournalPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class CustomerAccountJournalPropertyFiller
/*     */     implements IFiller {
/*     */     private CustomerAccountJournalPropertyDBA _parent;
/*     */     
/*     */     public CustomerAccountJournalPropertyFiller(CustomerAccountJournalPropertyDBA argParent) {
...
/* 184 */     CustomerAccountJournalPropertyDAO dao = (CustomerAccountJournalPropertyDAO)argDAO;
...
/* 203 */     return loadDAO((IDataAccessObject)new CustomerAccountJournalPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 207 */     CustomerAccountJournalPropertyDAO dao = (CustomerAccountJournalPropertyDAO)argDAO;
...
/* 224 */     CustomerAccountJournalPropertyId id = (CustomerAccountJournalPropertyId)argId;
...
/* 234 */     CustomerAccountJournalPropertyId id = new CustomerAccountJournalPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerAccountJournalPropertyDBA.class
