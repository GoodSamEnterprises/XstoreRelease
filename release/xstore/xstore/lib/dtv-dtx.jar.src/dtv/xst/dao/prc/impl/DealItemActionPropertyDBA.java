...
/*     */ 
/*     */ 
/*     */ public class DealItemActionPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.deal_id, t.item_ordinal, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM prc_deal_item_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND deal_id = ?  AND item_ordinal = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.deal_id, t.item_ordinal, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM prc_deal_item_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND deal_id = ?  AND item_ordinal = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO prc_deal_item_p(organization_id, deal_id, item_ordinal, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._dealId, this._ordinal, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE prc_deal_item_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM prc_deal_item_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND deal_id = ?  AND item_ordinal = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND deal_id = ?  AND item_ordinal = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._dealId, this._ordinal, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new DealItemActionPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class DealItemActionPropertyFiller
/*     */     implements IFiller {
/*     */     private DealItemActionPropertyDBA _parent;
/*     */     
/*     */     public DealItemActionPropertyFiller(DealItemActionPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._dealId = argResultSet.getString(2);
/*     */ 
/*     */       
/* 138 */       int primitiveResult = argResultSet.getInt(3);
/* 139 */       if (primitiveResult != 0 || argResultSet.getObject(3) != null) {
/* 140 */         this._parent._ordinal = Integer.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 182 */     DealItemActionPropertyDAO dao = (DealItemActionPropertyDAO)argDAO;
...
/* 200 */     return loadDAO((IDataAccessObject)new DealItemActionPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     DealItemActionPropertyDAO dao = (DealItemActionPropertyDAO)argDAO;
/* 205 */     this._organizationId = dao.getOrganizationId();
/* 206 */     this._dealId = dao.getDealId();
/* 207 */     this._ordinal = dao.getOrdinal();
...
/* 220 */     DealItemActionPropertyId id = (DealItemActionPropertyId)argId;
/* 221 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 222 */     argStatement.setString(2, id.getDealId());
/* 223 */     argStatement.setInt(3, id.getOrdinal().intValue());
/* 224 */     argStatement.setString(4, id.getPropertyCode());
/* 225 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 229 */     DealItemActionPropertyId id = new DealItemActionPropertyId();
/* 230 */     id.setOrganizationId(this._organizationId);
/* 231 */     id.setDealId(this._dealId);
/* 232 */     id.setOrdinal(this._ordinal);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealItemActionPropertyDBA.class
