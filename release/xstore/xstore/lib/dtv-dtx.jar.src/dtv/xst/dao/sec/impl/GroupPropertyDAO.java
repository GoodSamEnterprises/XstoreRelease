...
/*     */ 
/*     */ 
/*     */ public class GroupPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1858435412L;
/*  23 */   private static final Logger _logger = Logger.getLogger(GroupPropertyDAO.class);
/*     */   
...
/*  38 */     return this._groupId;
/*     */   }
/*     */   
/*     */   public void setGroupId(String argGroupId) {
/*  42 */     if (changed(argGroupId, this._groupId, "groupId")) {
...
/* 156 */       buf.append("groupId").append("=").append(getGroupId()).append(" ");
/*     */     }
...
/* 193 */     GroupPropertyId id = new GroupPropertyId();
/* 194 */     id.setGroupId(getGroupId());
...
/* 201 */     setGroupId(((GroupPropertyId)argObjectId).getGroupId());
/* 202 */     setOrganizationId(((GroupPropertyId)argObjectId).getOrganizationId());
/* 203 */     setPropertyCode(((GroupPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"GroupProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 221 */     if (this._groupId != null) values.put("GroupId", DaoUtils.getXmlSafeFieldValue(12, this._groupId)); 
...
/* 247 */             setGroupId((String)value);
/* 248 */           } catch (Exception ee) {
/* 249 */             throw new DtxException("An exception occurred while calling setGroupId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\GroupPropertyDAO.class
