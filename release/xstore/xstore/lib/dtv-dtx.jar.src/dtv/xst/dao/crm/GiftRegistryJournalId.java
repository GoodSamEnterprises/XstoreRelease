...
/*     */ 
/*     */ 
/*     */ public class GiftRegistryJournalId
/*     */   extends AbstractObjectId
/*     */ {
/*     */   private static final long serialVersionUID = -909944630L;
/*     */   private Long _journalSequence;
/*     */   
/*     */   public GiftRegistryJournalId() {}
/*     */   
/*     */   public GiftRegistryJournalId(String argObjectIdValue) {
...
/*  29 */     return this._journalSequence;
/*     */   }
/*     */   
/*     */   public void setJournalSequence(Long argJournalSequence) {
/*  33 */     this._journalSequence = argJournalSequence;
/*     */   }
/*     */   
...
/*  46 */       str = tokens[1];
/*     */       
/*  48 */       setJournalSequence(Long.valueOf(str));
/*     */     }
...
/*  58 */       return true;
/*     */     }
/*  60 */     if (!(ob instanceof GiftRegistryJournalId)) {
/*  61 */       return false;
/*     */     }
/*  63 */     GiftRegistryJournalId other = (GiftRegistryJournalId)ob;
/*  64 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  67 */       .equals(other._organizationId))) && ((this._journalSequence == null && other._journalSequence == null) || (this._journalSequence != null && this._journalSequence
/*     */ 
/*     */       
/*  70 */       .equals(other._journalSequence))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  77 */       .hashCode()) + ((this._journalSequence == null) ? 0 : this._journalSequence
/*  78 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getDtxTypeName() {
/*  83 */     return "GiftRegistryJournal";
/*     */   }
/*     */ 
/*     */   
...
/*  92 */       .append("::").append(String.valueOf(this._journalSequence))
/*  93 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/*  97 */     if (this._journalSequence == null) {
/*  98 */       return false;
/*     */     }
/* 100 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\GiftRegistryJournalId.class
