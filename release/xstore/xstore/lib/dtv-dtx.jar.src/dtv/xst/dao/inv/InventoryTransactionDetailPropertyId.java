...
/*     */ 
/*     */ 
/*     */ public class InventoryTransactionDetailPropertyId
...
/*     */   
/*     */   public InventoryTransactionDetailPropertyId() {}
/*     */   
/*     */   public InventoryTransactionDetailPropertyId(String argObjectIdValue) {
...
/*  69 */     return this._inventoryDetailSequence;
/*     */   }
/*     */   
/*     */   public void setInventoryDetailSequence(Integer argInventoryDetailSequence) {
/*  73 */     this._inventoryDetailSequence = argInventoryDetailSequence;
/*     */   }
/*     */   
...
/* 112 */       str = tokens[5];
/*     */       
/* 114 */       setInventoryDetailSequence(Integer.valueOf(str));
/* 115 */       str = tokens[6];
/*     */       
...
/* 132 */       return true;
/*     */     }
/* 134 */     if (!(ob instanceof InventoryTransactionDetailPropertyId)) {
/* 135 */       return false;
/*     */     }
/* 137 */     InventoryTransactionDetailPropertyId other = (InventoryTransactionDetailPropertyId)ob;
...
/*     */ 
/*     */       
/* 153 */       .equals(other._transactionSequence))) && ((this._inventoryDetailSequence == null && other._inventoryDetailSequence == null) || (this._inventoryDetailSequence != null && this._inventoryDetailSequence
/*     */ 
/*     */       
/* 156 */       .equals(other._inventoryDetailSequence))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 170 */       .hashCode()) + ((this._inventoryDetailSequence == null) ? 0 : this._inventoryDetailSequence
...
/* 177 */     return "InventoryTransactionDetailProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 190 */       .append("::").append(String.valueOf(this._inventoryDetailSequence))
...
/* 206 */       return false;
/*     */     }
/* 208 */     if (this._inventoryDetailSequence == null) {
/* 209 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\InventoryTransactionDetailPropertyId.class
