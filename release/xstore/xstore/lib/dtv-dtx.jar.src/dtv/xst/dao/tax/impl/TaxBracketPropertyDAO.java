...
/*     */ 
/*     */ 
/*     */ public class TaxBracketPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 2038681490L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxBracketPropertyDAO.class);
/*     */   
...
/*  49 */     return this._taxBracketId;
/*     */   }
/*     */   
/*     */   public void setTaxBracketId(String argTaxBracketId) {
/*  53 */     if (changed(argTaxBracketId, this._taxBracketId, "taxBracketId")) {
/*  54 */       this._taxBracketId = (argTaxBracketId != null && MANAGE_CASE) ? argTaxBracketId.toUpperCase() : argTaxBracketId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getTaxBracketSequence() {
/*  59 */     return this._taxBracketSequence;
/*     */   }
/*     */   
/*     */   public void setTaxBracketSequence(Integer argTaxBracketSequence) {
/*  63 */     if (changed(argTaxBracketSequence, this._taxBracketSequence, "taxBracketSequence")) {
/*  64 */       this._taxBracketSequence = argTaxBracketSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getTaxBracketId() != null) {
/* 170 */       buf.append("taxBracketId").append("=").append(getTaxBracketId()).append(" ");
/*     */     }
/* 172 */     if (getTaxBracketSequence() != null) {
/* 173 */       buf.append("taxBracketSequence").append("=").append(getTaxBracketSequence()).append(" ");
/*     */     }
...
/* 207 */     TaxBracketPropertyId id = new TaxBracketPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setTaxBracketId(getTaxBracketId());
/* 210 */     id.setTaxBracketSequence(getTaxBracketSequence());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((TaxBracketPropertyId)argObjectId).getOrganizationId());
/* 217 */     setTaxBracketId(((TaxBracketPropertyId)argObjectId).getTaxBracketId());
/* 218 */     setTaxBracketSequence(((TaxBracketPropertyId)argObjectId).getTaxBracketSequence());
/* 219 */     setPropertyCode(((TaxBracketPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"TaxBracketProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._taxBracketId != null) values.put("TaxBracketId", DaoUtils.getXmlSafeFieldValue(12, this._taxBracketId)); 
/* 239 */     if (this._taxBracketSequence != null) values.put("TaxBracketSequence", DaoUtils.getXmlSafeFieldValue(4, this._taxBracketSequence)); 
...
/* 273 */             setTaxBracketId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setTaxBracketId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 282 */             setTaxBracketSequence((Integer)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setTaxBracketSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxBracketPropertyDAO.class
