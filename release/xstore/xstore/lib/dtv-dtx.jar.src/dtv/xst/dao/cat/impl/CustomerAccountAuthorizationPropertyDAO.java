...
/*     */ 
/*     */ 
/*     */ public class CustomerAccountAuthorizationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1070701663L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerAccountAuthorizationPropertyDAO.class);
/*     */   
...
/*  56 */     if (changed(argRetailTransactionLineItemSequence, this._retailTransactionLineItemSequence, "retailTransactionLineItemSequence")) {
...
/*  82 */     return (Date)this._businessDate;
/*     */   }
/*     */   
/*     */   public void setBusinessDate(Date argBusinessDate) {
/*  86 */     if (changed(argBusinessDate, this._businessDate, "businessDate")) {
/*  87 */       this._businessDate = (argBusinessDate == null || argBusinessDate instanceof DtvDate) ? (DtvDate)argBusinessDate : new DtvDate(argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   public Long getTransactionSequence() {
/*  93 */     return this._transactionSequence;
/*     */   }
/*     */   
/*     */   public void setTransactionSequence(Long argTransactionSequence) {
/*  97 */     if (changed(argTransactionSequence, this._transactionSequence, "transactionSequence")) {
/*  98 */       this._transactionSequence = argTransactionSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 203 */     if (getRetailTransactionLineItemSequence() != null) {
/* 204 */       buf.append("retailTransactionLineItemSequence").append("=").append(getRetailTransactionLineItemSequence()).append(" ");
/*     */     }
...
/*     */     }
/* 212 */     if (getBusinessDate() != null) {
/* 213 */       buf.append("businessDate").append("=").append(getBusinessDate()).append(" ");
/*     */     }
/* 215 */     if (getTransactionSequence() != null) {
/* 216 */       buf.append("transactionSequence").append("=").append(getTransactionSequence()).append(" ");
/*     */     }
...
/* 250 */     CustomerAccountAuthorizationPropertyId id = new CustomerAccountAuthorizationPropertyId();
/* 251 */     id.setOrganizationId(getOrganizationId());
/* 252 */     id.setRetailTransactionLineItemSequence(getRetailTransactionLineItemSequence());
...
/* 256 */     id.setTransactionSequence(getTransactionSequence());
/* 257 */     id.setPropertyCode(getPropertyCode());
/* 258 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 262 */     setOrganizationId(((CustomerAccountAuthorizationPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailTransactionLineItemSequence(((CustomerAccountAuthorizationPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 264 */     setRetailLocationId(((CustomerAccountAuthorizationPropertyId)argObjectId).getRetailLocationId());
/* 265 */     setWorkstationId(((CustomerAccountAuthorizationPropertyId)argObjectId).getWorkstationId());
/* 266 */     setBusinessDate(((CustomerAccountAuthorizationPropertyId)argObjectId).getBusinessDate());
/* 267 */     setTransactionSequence(((CustomerAccountAuthorizationPropertyId)argObjectId).getTransactionSequence());
/* 268 */     setPropertyCode(((CustomerAccountAuthorizationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"CustomerAccountAuthorizationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 287 */     if (this._retailTransactionLineItemSequence != null) values.put("RetailTransactionLineItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._retailTransactionLineItemSequence)); 
...
/* 290 */     if (this._businessDate != null) values.put("BusinessDate", DaoUtils.getXmlSafeFieldValue(91, this._businessDate)); 
/* 291 */     if (this._transactionSequence != null) values.put("TransactionSequence", DaoUtils.getXmlSafeFieldValue(-5, this._transactionSequence)); 
...
/* 325 */             setRetailTransactionLineItemSequence((Integer)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setRetailTransactionLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 352 */             setBusinessDate((Date)value);
/* 353 */           } catch (Exception ee) {
/* 354 */             throw new DtxException("An exception occurred while calling setBusinessDate() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 361 */             setTransactionSequence((Long)value);
/* 362 */           } catch (Exception ee) {
/* 363 */             throw new DtxException("An exception occurred while calling setTransactionSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerAccountAuthorizationPropertyDAO.class
