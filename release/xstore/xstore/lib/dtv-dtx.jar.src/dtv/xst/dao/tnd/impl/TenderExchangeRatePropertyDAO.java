...
/*     */ 
/*     */ 
/*     */ public class TenderExchangeRatePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1042974124L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderExchangeRatePropertyDAO.class);
/*     */   
...
/*  51 */     return this._baseCurrency;
/*     */   }
/*     */   
/*     */   public void setBaseCurrency(String argBaseCurrency) {
/*  55 */     if (changed(argBaseCurrency, this._baseCurrency, "baseCurrency")) {
/*  56 */       this._baseCurrency = (argBaseCurrency != null && MANAGE_CASE) ? argBaseCurrency.toUpperCase() : argBaseCurrency;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getTargetCurrency() {
/*  61 */     return this._targetCurrency;
/*     */   }
/*     */   
/*     */   public void setTargetCurrency(String argTargetCurrency) {
/*  65 */     if (changed(argTargetCurrency, this._targetCurrency, "targetCurrency")) {
/*  66 */       this._targetCurrency = (argTargetCurrency != null && MANAGE_CASE) ? argTargetCurrency.toUpperCase() : argTargetCurrency;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 191 */     if (getBaseCurrency() != null) {
/* 192 */       buf.append("baseCurrency").append("=").append(getBaseCurrency()).append(" ");
/*     */     }
/* 194 */     if (getTargetCurrency() != null) {
/* 195 */       buf.append("targetCurrency").append("=").append(getTargetCurrency()).append(" ");
/*     */     }
...
/* 235 */     TenderExchangeRatePropertyId id = new TenderExchangeRatePropertyId();
/* 236 */     id.setOrganizationId(getOrganizationId());
/* 237 */     id.setBaseCurrency(getBaseCurrency());
/* 238 */     id.setTargetCurrency(getTargetCurrency());
...
/* 246 */     setOrganizationId(((TenderExchangeRatePropertyId)argObjectId).getOrganizationId());
/* 247 */     setBaseCurrency(((TenderExchangeRatePropertyId)argObjectId).getBaseCurrency());
/* 248 */     setTargetCurrency(((TenderExchangeRatePropertyId)argObjectId).getTargetCurrency());
/* 249 */     setLevelCode(((TenderExchangeRatePropertyId)argObjectId).getLevelCode());
/* 250 */     setLevelValue(((TenderExchangeRatePropertyId)argObjectId).getLevelValue());
/* 251 */     setPropertyCode(((TenderExchangeRatePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"TenderExchangeRateProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 270 */     if (this._baseCurrency != null) values.put("BaseCurrency", DaoUtils.getXmlSafeFieldValue(12, this._baseCurrency)); 
/* 271 */     if (this._targetCurrency != null) values.put("TargetCurrency", DaoUtils.getXmlSafeFieldValue(12, this._targetCurrency)); 
...
/* 307 */             setBaseCurrency((String)value);
/* 308 */           } catch (Exception ee) {
/* 309 */             throw new DtxException("An exception occurred while calling setBaseCurrency() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "TargetCurrency":
...
/* 316 */             setTargetCurrency((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setTargetCurrency() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "LevelCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderExchangeRatePropertyDAO.class
