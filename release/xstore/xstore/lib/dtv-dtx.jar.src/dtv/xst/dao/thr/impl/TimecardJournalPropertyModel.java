...
/*     */ 
/*     */ 
/*     */ public class TimecardJournalPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITimecardJournalProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TimecardJournalPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TimecardJournalPropertyDAO getDAO_() {
/*  44 */     return (TimecardJournalPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITimecardJournalProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getBusinessDate();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setBusinessDate_noev(argBusinessDate) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ITimecardJournalProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getBusinessDate() == null && argBusinessDate != null) || (
/* 112 */       getDAO_().getBusinessDate() != null && !getDAO_().getBusinessDate().equals(argBusinessDate))) {
/* 113 */       getDAO_().setBusinessDate(argBusinessDate);
...
/* 141 */       this._events.post(ITimecardJournalProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 164 */     if (getDAO_().getPartyId() != null) {
/* 165 */       return getDAO_().getPartyId().longValue();
/*     */     }
/*     */     
/* 168 */     return 0L;
/*     */   }
...
/* 177 */     if (setPartyId_noev(argPartyId) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(ITimecardJournalProperty.SET_PARTYID, Long.valueOf(argPartyId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getPartyId() == null && Long.valueOf(argPartyId) != null) || (
/* 190 */       getDAO_().getPartyId() != null && !getDAO_().getPartyId().equals(Long.valueOf(argPartyId)))) {
/* 191 */       getDAO_().setPartyId(Long.valueOf(argPartyId));
...
/* 203 */     if (getDAO_().getTimecardEntryId() != null) {
/* 204 */       return getDAO_().getTimecardEntryId().longValue();
/*     */     }
/*     */     
/* 207 */     return 0L;
/*     */   }
...
/* 216 */     if (setTimecardEntryId_noev(argTimecardEntryId) && 
/* 217 */       this._events != null && 
/* 218 */       postEventsForChanges()) {
/* 219 */       this._events.post(ITimecardJournalProperty.SET_TIMECARDENTRYID, Long.valueOf(argTimecardEntryId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 228 */     if ((getDAO_().getTimecardEntryId() == null && Long.valueOf(argTimecardEntryId) != null) || (
/* 229 */       getDAO_().getTimecardEntryId() != null && !getDAO_().getTimecardEntryId().equals(Long.valueOf(argTimecardEntryId)))) {
/* 230 */       getDAO_().setTimecardEntryId(Long.valueOf(argTimecardEntryId));
...
/* 258 */       this._events.post(ITimecardJournalProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 281 */     if (getDAO_().getTimecardEntrySeq() != null) {
/* 282 */       return getDAO_().getTimecardEntrySeq().longValue();
/*     */     }
/*     */     
/* 285 */     return 0L;
/*     */   }
...
/* 294 */     if (setTimecardEntrySeq_noev(argTimecardEntrySeq) && 
/* 295 */       this._events != null && 
/* 296 */       postEventsForChanges()) {
/* 297 */       this._events.post(ITimecardJournalProperty.SET_TIMECARDENTRYSEQ, Long.valueOf(argTimecardEntrySeq));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 306 */     if ((getDAO_().getTimecardEntrySeq() == null && Long.valueOf(argTimecardEntrySeq) != null) || (
/* 307 */       getDAO_().getTimecardEntrySeq() != null && !getDAO_().getTimecardEntrySeq().equals(Long.valueOf(argTimecardEntrySeq)))) {
/* 308 */       getDAO_().setTimecardEntrySeq(Long.valueOf(argTimecardEntrySeq));
...
/* 331 */       this._events.post(ITimecardJournalProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(ITimecardJournalProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(ITimecardJournalProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(ITimecardJournalProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(ITimecardJournalProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(ITimecardJournalProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(ITimecardJournalProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(ITimecardJournalProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(ITimecardJournalProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("TimecardJournalPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("TimecardJournalPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\impl\TimecardJournalPropertyModel.class
