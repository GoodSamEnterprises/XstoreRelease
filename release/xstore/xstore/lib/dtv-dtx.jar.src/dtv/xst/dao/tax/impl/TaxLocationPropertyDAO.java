...
/*     */ 
/*     */ 
/*     */ public class TaxLocationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1692299861L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxLocationPropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getTaxLocationId() != null) {
/* 159 */       buf.append("taxLocationId").append("=").append(getTaxLocationId()).append(" ");
/*     */     }
...
/* 193 */     TaxLocationPropertyId id = new TaxLocationPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setTaxLocationId(getTaxLocationId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((TaxLocationPropertyId)argObjectId).getOrganizationId());
/* 202 */     setTaxLocationId(((TaxLocationPropertyId)argObjectId).getTaxLocationId());
/* 203 */     setPropertyCode(((TaxLocationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"TaxLocationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._taxLocationId != null) values.put("TaxLocationId", DaoUtils.getXmlSafeFieldValue(12, this._taxLocationId)); 
...
/* 256 */             setTaxLocationId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setTaxLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxLocationPropertyDAO.class
