...
/*     */ 
/*     */ 
/*     */ public class CategoryServiceLocationPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.service_loc_id, t.category_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_category_service_loc_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND service_loc_id = ?  AND category_id = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.service_loc_id, t.category_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_category_service_loc_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND service_loc_id = ?  AND category_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cwo_category_service_loc_p(organization_id, service_loc_id, category_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._serviceLocationId, this._categoryId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cwo_category_service_loc_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cwo_category_service_loc_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND service_loc_id = ?  AND category_id = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND service_loc_id = ?  AND category_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._serviceLocationId, this._categoryId, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "cwo_category_service_loc_p";
/*     */   }
/*     */   
...
/* 116 */     return new CategoryServiceLocationPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class CategoryServiceLocationPropertyFiller
/*     */     implements IFiller {
/*     */     private CategoryServiceLocationPropertyDBA _parent;
/*     */     
/*     */     public CategoryServiceLocationPropertyFiller(CategoryServiceLocationPropertyDBA argParent) {
...
/* 175 */     CategoryServiceLocationPropertyDAO dao = (CategoryServiceLocationPropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setServiceLocationId(this._serviceLocationId);
/* 178 */     dao.setCategoryId(this._categoryId);
...
/* 193 */     return loadDAO((IDataAccessObject)new CategoryServiceLocationPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     CategoryServiceLocationPropertyDAO dao = (CategoryServiceLocationPropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._serviceLocationId = dao.getServiceLocationId();
/* 200 */     this._categoryId = dao.getCategoryId();
...
/* 213 */     CategoryServiceLocationPropertyId id = (CategoryServiceLocationPropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getServiceLocationId());
/* 216 */     argStatement.setString(3, id.getCategoryId());
/* 217 */     argStatement.setString(4, id.getPropertyCode());
/* 218 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 222 */     CategoryServiceLocationPropertyId id = new CategoryServiceLocationPropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setServiceLocationId(this._serviceLocationId);
/* 225 */     id.setCategoryId(this._categoryId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\CategoryServiceLocationPropertyDBA.class
