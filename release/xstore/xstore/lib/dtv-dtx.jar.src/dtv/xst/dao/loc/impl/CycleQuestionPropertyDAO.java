...
/*     */ 
/*     */ 
/*     */ public class CycleQuestionPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1158031167L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CycleQuestionPropertyDAO.class);
/*     */   
...
/*  48 */     return this._questionId;
/*     */   }
/*     */   
/*     */   public void setQuestionId(String argQuestionId) {
/*  52 */     if (changed(argQuestionId, this._questionId, "questionId")) {
/*  53 */       this._questionId = (argQuestionId != null && MANAGE_CASE) ? argQuestionId.toUpperCase() : argQuestionId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getQuestionId() != null) {
/* 159 */       buf.append("questionId").append("=").append(getQuestionId()).append(" ");
/*     */     }
...
/* 193 */     CycleQuestionPropertyId id = new CycleQuestionPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setQuestionId(getQuestionId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((CycleQuestionPropertyId)argObjectId).getOrganizationId());
/* 202 */     setQuestionId(((CycleQuestionPropertyId)argObjectId).getQuestionId());
/* 203 */     setPropertyCode(((CycleQuestionPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"CycleQuestionProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._questionId != null) values.put("QuestionId", DaoUtils.getXmlSafeFieldValue(12, this._questionId)); 
...
/* 256 */             setQuestionId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setQuestionId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\CycleQuestionPropertyDAO.class
