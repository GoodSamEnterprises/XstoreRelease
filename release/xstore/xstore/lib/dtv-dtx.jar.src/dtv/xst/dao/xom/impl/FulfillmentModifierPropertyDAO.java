...
/*     */ 
/*     */ 
/*     */ public class FulfillmentModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 681803690L;
/*  23 */   private static final Logger _logger = Logger.getLogger(FulfillmentModifierPropertyDAO.class);
/*     */   
...
/* 207 */     FulfillmentModifierPropertyId id = new FulfillmentModifierPropertyId();
...
/* 216 */     setOrganizationId(((FulfillmentModifierPropertyId)argObjectId).getOrganizationId());
/* 217 */     setOrderId(((FulfillmentModifierPropertyId)argObjectId).getOrderId());
/* 218 */     setSequence(((FulfillmentModifierPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((FulfillmentModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"FulfillmentModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\FulfillmentModifierPropertyDAO.class
