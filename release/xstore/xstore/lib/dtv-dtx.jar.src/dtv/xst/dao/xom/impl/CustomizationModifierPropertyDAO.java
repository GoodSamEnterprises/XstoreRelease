...
/*     */ 
/*     */ 
/*     */ public class CustomizationModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -947792993L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomizationModifierPropertyDAO.class);
/*     */   
...
/* 221 */     CustomizationModifierPropertyId id = new CustomizationModifierPropertyId();
...
/* 231 */     setOrganizationId(((CustomizationModifierPropertyId)argObjectId).getOrganizationId());
/* 232 */     setOrderId(((CustomizationModifierPropertyId)argObjectId).getOrderId());
/* 233 */     setSequence(((CustomizationModifierPropertyId)argObjectId).getSequence());
/* 234 */     setModSequence(((CustomizationModifierPropertyId)argObjectId).getModSequence());
/* 235 */     setPropertyCode(((CustomizationModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"CustomizationModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\CustomizationModifierPropertyDAO.class
