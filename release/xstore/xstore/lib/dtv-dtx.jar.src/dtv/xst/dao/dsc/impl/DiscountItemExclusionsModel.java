...
/*     */ import dtv.xst.dao.dsc.DiscountItemExclusionsPropertyId;
/*     */ import dtv.xst.dao.dsc.IDiscountItemExclusions;
/*     */ import dtv.xst.dao.dsc.IDiscountItemExclusionsProperty;
...
/*     */ 
/*     */ public class DiscountItemExclusionsModel extends AbstractDataModelWithPropertyImpl<IDiscountItemExclusionsProperty> implements IDiscountItemExclusions {
...
/*     */   }
/*     */   private IDataModel _myExtension; private HistoricalList<IDiscountItemExclusionsProperty> _properties; private transient HistoricalList<IDiscountItemExclusionsProperty> _propertiesSavepoint;
/*     */   
/*     */   public void initDAO() {
/*  38 */     setDAO((IDataAccessObject)new DiscountItemExclusionsDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private DiscountItemExclusionsDAO getDAO_() {
/*  46 */     return (DiscountItemExclusionsDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  65 */       this._events.post(IDiscountItemExclusions.SET_DISCOUNTCODE, argDiscountCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */         
/*  80 */         Iterator<DiscountItemExclusionsPropertyModel> it = this._properties.iterator();
/*  81 */         while (it.hasNext())
/*     */         {
/*  83 */           ((DiscountItemExclusionsPropertyModel)it.next()).setDiscountCode_noev(argDiscountCode);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* 107 */       this._events.post(IDiscountItemExclusions.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */         
/* 122 */         Iterator<DiscountItemExclusionsPropertyModel> it = this._properties.iterator();
/* 123 */         while (it.hasNext())
/*     */         {
/* 125 */           ((DiscountItemExclusionsPropertyModel)it.next()).setItemId_noev(argItemId);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* 154 */       this._events.post(IDiscountItemExclusions.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */         
/* 169 */         Iterator<DiscountItemExclusionsPropertyModel> it = this._properties.iterator();
/* 170 */         while (it.hasNext())
/*     */         {
/* 172 */           ((DiscountItemExclusionsPropertyModel)it.next()).setOrganizationId_noev(argOrganizationId);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
...
/* 196 */       this._events.post(IDiscountItemExclusions.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 230 */       this._events.post(IDiscountItemExclusions.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 264 */       this._events.post(IDiscountItemExclusions.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 298 */       this._events.post(IDiscountItemExclusions.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/*     */   protected IDiscountItemExclusionsProperty newProperty(String argPropertyName) {
/* 317 */     DiscountItemExclusionsPropertyId id = new DiscountItemExclusionsPropertyId();
/*     */     
/* 319 */     id.setDiscountCode(getDiscountCode());
/* 320 */     id.setItemId(getItemId());
/* 321 */     id.setPropertyCode(argPropertyName);
/*     */     
/* 323 */     IDiscountItemExclusionsProperty prop = (IDiscountItemExclusionsProperty)DataFactory.getInstance().createNewObject((IObjectId)id, IDiscountItemExclusionsProperty.class);
/* 324 */     return prop;
/*     */   }
/*     */ 
/*     */ 
...
/*     */   public List<IDiscountItemExclusionsProperty> getProperties() {
/* 333 */     if (this._properties == null) {
/* 334 */       this._properties = new HistoricalList(null);
/*     */     }
/* 336 */     return (List<IDiscountItemExclusionsProperty>)this._properties;
/*     */   }
/*     */   
/*     */   public void setProperties(List<IDiscountItemExclusionsProperty> argProperties) {
...
/*     */     } 
/*     */     
/* 346 */     for (IDiscountItemExclusionsProperty child : this._properties) {
/* 347 */       DiscountItemExclusionsPropertyModel model = (DiscountItemExclusionsPropertyModel)child;
...
/*     */   }
/*     */   
/*     */   public void addDiscountItemExclusionsProperty(IDiscountItemExclusionsProperty argDiscountItemExclusionsProperty) {
/* 365 */     if (this._properties == null) {
/* 366 */       this._properties = new HistoricalList(null);
/*     */     }
/* 368 */     argDiscountItemExclusionsProperty.setDiscountCode(getDiscountCode());
/* 369 */     argDiscountItemExclusionsProperty.setItemId(getItemId());
/* 370 */     argDiscountItemExclusionsProperty.setOrganizationId(getOrganizationId());
/* 371 */     if (argDiscountItemExclusionsProperty instanceof IDataModelImpl) {
/* 372 */       IDataAccessObject childDao = ((IDataModelImpl)argDiscountItemExclusionsProperty).getDAO();
...
/* 381 */       this._eventManager.registerEventHandler((IEventAware)this._eventCascade, (IEventSource)new EventDescriptor(argDiscountItemExclusionsProperty));
/*     */     }
/*     */     
/* 384 */     this._properties.add(argDiscountItemExclusionsProperty);
/* 385 */     if (postEventsForChanges()) {
/* 386 */       this._events.post(IDiscountItemExclusions.ADD_PROPERTIES, argDiscountItemExclusionsProperty);
/*     */     }
/*     */   }
/*     */   
/*     */   public void removeDiscountItemExclusionsProperty(IDiscountItemExclusionsProperty argDiscountItemExclusionsProperty) {
/* 391 */     if (this._properties != null) {
/*     */       
/* 393 */       if (postEventsForChanges()) {
/* 394 */         this._eventManager.deregisterEventHandler((IEventAware)this._eventCascade, (IEventSource)new EventDescriptor(argDiscountItemExclusionsProperty));
/*     */       }
/* 396 */       this._properties.remove(argDiscountItemExclusionsProperty);
/* 397 */       if (postEventsForChanges()) {
/* 398 */         this._events.post(IDiscountItemExclusions.REMOVE_PROPERTIES, argDiscountItemExclusionsProperty);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*     */     }
/* 408 */     if ("DiscountItemExclusionsExtension".equals(argFieldId)) {
...
/* 419 */       setProperties(changeToList(argValue, IDiscountItemExclusionsProperty.class));
/*     */     }
/* 421 */     else if ("DiscountItemExclusionsExtension".equals(argFieldId)) {
...
/* 437 */       for (IDiscountItemExclusionsProperty relationship : this._properties) {
/* 438 */         ((IDataModelImpl)relationship).setDependencies(argPD, argEM);
/*     */       }
/*     */     }
/*     */   }
/*     */   
/*     */   public IDataModel getDiscountItemExclusionsExt() {
/* 444 */     return this._myExtension;
/*     */   }
/*     */   
/*     */   public void setDiscountItemExclusionsExt(IDataModel argExt) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountItemExclusionsModel.class
