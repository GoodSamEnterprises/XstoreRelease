...
/*     */ 
/*     */ 
/*     */ public class ItemPromptPropertyPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1392489313L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemPromptPropertyPropertyDAO.class);
/*     */   
...
/*  59 */     return this._promptPropertyCode;
/*     */   }
/*     */   
/*     */   public void setPromptPropertyCode(String argPromptPropertyCode) {
/*  63 */     if (changed(argPromptPropertyCode, this._promptPropertyCode, "promptPropertyCode")) {
/*  64 */       this._promptPropertyCode = (argPromptPropertyCode != null && MANAGE_CASE) ? argPromptPropertyCode.toUpperCase() : argPromptPropertyCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getItemId() != null) {
/* 170 */       buf.append("itemId").append("=").append(getItemId()).append(" ");
/*     */     }
/* 172 */     if (getPromptPropertyCode() != null) {
/* 173 */       buf.append("promptPropertyCode").append("=").append(getPromptPropertyCode()).append(" ");
/*     */     }
...
/* 207 */     ItemPromptPropertyPropertyId id = new ItemPromptPropertyPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setItemId(getItemId());
/* 210 */     id.setPromptPropertyCode(getPromptPropertyCode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((ItemPromptPropertyPropertyId)argObjectId).getOrganizationId());
/* 217 */     setItemId(((ItemPromptPropertyPropertyId)argObjectId).getItemId());
/* 218 */     setPromptPropertyCode(((ItemPromptPropertyPropertyId)argObjectId).getPromptPropertyCode());
/* 219 */     setPropertyCode(((ItemPromptPropertyPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"ItemPromptPropertyProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._itemId != null) values.put("ItemId", DaoUtils.getXmlSafeFieldValue(12, this._itemId)); 
/* 239 */     if (this._promptPropertyCode != null) values.put("PromptPropertyCode", DaoUtils.getXmlSafeFieldValue(12, this._promptPropertyCode)); 
...
/* 273 */             setItemId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 282 */             setPromptPropertyCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setPromptPropertyCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemPromptPropertyPropertyDAO.class
