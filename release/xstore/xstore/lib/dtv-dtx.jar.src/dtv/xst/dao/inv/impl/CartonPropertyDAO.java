...
/*     */ 
/*     */ 
/*     */ public class CartonPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -883564524L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CartonPropertyDAO.class);
/*     */   
...
/*  61 */     return this._cartonId;
/*     */   }
/*     */   
/*     */   public void setCartonId(String argCartonId) {
/*  65 */     if (changed(argCartonId, this._cartonId, "cartonId")) {
/*  66 */       this._cartonId = (argCartonId != null && MANAGE_CASE) ? argCartonId.toUpperCase() : argCartonId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 194 */     if (getCartonId() != null) {
/* 195 */       buf.append("cartonId").append("=").append(getCartonId()).append(" ");
/*     */     }
...
/* 246 */     setDocumentId(((CartonPropertyId)argObjectId).getDocumentId());
/* 247 */     setDocumentTypeCode(((CartonPropertyId)argObjectId).getDocumentTypeCode());
/* 248 */     setCartonId(((CartonPropertyId)argObjectId).getCartonId());
/* 249 */     setOrganizationId(((CartonPropertyId)argObjectId).getOrganizationId());
/* 250 */     setRetailLocationId(((CartonPropertyId)argObjectId).getRetailLocationId());
/* 251 */     setPropertyCode(((CartonPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"CartonProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 271 */     if (this._cartonId != null) values.put("CartonId", DaoUtils.getXmlSafeFieldValue(12, this._cartonId)); 
...
/* 316 */             setCartonId((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setCartonId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\CartonPropertyDAO.class
