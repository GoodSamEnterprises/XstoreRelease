...
/*     */ import dtv.xst.dao.crm.PartyPropertyId;
...
/*     */ 
/*     */ 
/*     */ public class PartyPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1331775163L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.party_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM crm_party_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND party_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.party_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM crm_party_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND party_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO crm_party_p(organization_id, party_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._partyId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE crm_party_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM crm_party_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND party_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND party_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._partyId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new PartyPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class PartyPropertyFiller
/*     */     implements IFiller {
/*     */     private PartyPropertyDBA _parent;
/*     */     
/*     */     public PartyPropertyFiller(PartyPropertyDBA argParent) {
...
/* 180 */     PartyPropertyDAO dao = (PartyPropertyDAO)argDAO;
...
/* 197 */     return loadDAO((IDataAccessObject)new PartyPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 201 */     PartyPropertyDAO dao = (PartyPropertyDAO)argDAO;
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\PartyPropertyDBA.class
