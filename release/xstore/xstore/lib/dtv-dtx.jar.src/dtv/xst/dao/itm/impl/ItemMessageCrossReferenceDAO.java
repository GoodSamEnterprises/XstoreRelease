...
/*     */ 
/*     */ 
/*     */ public class ItemMessageCrossReferenceDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1678003873L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemMessageCrossReferenceDAO.class);
/*     */   
...
/*  60 */     if (changed(argItemId, this._itemId, "itemId")) {
...
/*     */     }
/* 138 */     if (getItemId() != null) {
/* 139 */       buf.append("itemId").append("=").append(getItemId()).append(" ");
/*     */     }
...
/* 164 */     ItemMessageCrossReferenceId id = new ItemMessageCrossReferenceId();
/* 165 */     id.setMessageId(getMessageId());
/* 166 */     id.setOrganizationId(getOrganizationId());
/* 167 */     id.setItemId(getItemId());
/* 168 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 172 */     setMessageId(((ItemMessageCrossReferenceId)argObjectId).getMessageId());
/* 173 */     setOrganizationId(((ItemMessageCrossReferenceId)argObjectId).getOrganizationId());
/* 174 */     setItemId(((ItemMessageCrossReferenceId)argObjectId).getItemId());
/*     */   }
/*     */   
...
/* 183 */     buf.append("<").append("dao").append(" name=\"ItemMessageCrossReference\" cmd=\"" + getObjectStateString() + "\">");
...
/* 194 */     if (this._itemId != null) values.put("ItemId", DaoUtils.getXmlSafeFieldValue(12, this._itemId)); 
...
/* 234 */             setItemId((String)value);
/* 235 */           } catch (Exception ee) {
/* 236 */             throw new DtxException("An exception occurred while calling setItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrgCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemMessageCrossReferenceDAO.class
