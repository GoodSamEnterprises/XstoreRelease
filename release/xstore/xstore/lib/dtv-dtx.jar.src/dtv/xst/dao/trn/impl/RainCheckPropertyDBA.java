...
/*     */ 
/*     */ 
/*     */ public class RainCheckPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -1152175191L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rain_check_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_raincheck_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rain_check_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.rain_check_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_raincheck_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND rain_check_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trn_raincheck_p(organization_id, rain_check_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._rainCheckId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trn_raincheck_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trn_raincheck_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rain_check_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND rain_check_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._rainCheckId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new RainCheckPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class RainCheckPropertyFiller
/*     */     implements IFiller {
/*     */     private RainCheckPropertyDBA _parent;
/*     */     
/*     */     public RainCheckPropertyFiller(RainCheckPropertyDBA argParent) {
...
/* 173 */     RainCheckPropertyDAO dao = (RainCheckPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setRainCheckId(this._rainCheckId);
...
/* 190 */     return loadDAO((IDataAccessObject)new RainCheckPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     RainCheckPropertyDAO dao = (RainCheckPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._rainCheckId = dao.getRainCheckId();
...
/* 209 */     RainCheckPropertyId id = (RainCheckPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getRainCheckId());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     RainCheckPropertyId id = new RainCheckPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setRainCheckId(this._rainCheckId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\RainCheckPropertyDBA.class
