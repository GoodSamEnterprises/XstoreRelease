...
/*     */ 
/*     */ 
/*     */ public class EscrowAccountActivityPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IEscrowAccountActivityProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new EscrowAccountActivityPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private EscrowAccountActivityPropertyDAO getDAO_() {
/*  44 */     return (EscrowAccountActivityPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IEscrowAccountActivityProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IEscrowAccountActivityProperty.SET_CUSTACCOUNTID, argCustAccountId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     if (getDAO_().getSeqNbr() != null) {
/* 126 */       return getDAO_().getSeqNbr().longValue();
/*     */     }
/*     */     
/* 129 */     return 0L;
/*     */   }
...
/* 138 */     if (setSeqNbr_noev(argSeqNbr) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IEscrowAccountActivityProperty.SET_SEQNBR, Long.valueOf(argSeqNbr));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getSeqNbr() == null && Long.valueOf(argSeqNbr) != null) || (
/* 151 */       getDAO_().getSeqNbr() != null && !getDAO_().getSeqNbr().equals(Long.valueOf(argSeqNbr)))) {
/* 152 */       getDAO_().setSeqNbr(Long.valueOf(argSeqNbr));
...
/* 175 */       this._events.post(IEscrowAccountActivityProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(IEscrowAccountActivityProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IEscrowAccountActivityProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IEscrowAccountActivityProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IEscrowAccountActivityProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IEscrowAccountActivityProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IEscrowAccountActivityProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IEscrowAccountActivityProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IEscrowAccountActivityProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 468 */     if ("EscrowAccountActivityPropertyExtension".equals(argFieldId)) {
...
/* 478 */     if ("EscrowAccountActivityPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\EscrowAccountActivityPropertyModel.class
