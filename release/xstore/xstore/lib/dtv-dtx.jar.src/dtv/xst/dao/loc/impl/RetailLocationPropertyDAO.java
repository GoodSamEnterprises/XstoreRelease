...
/*     */ 
/*     */ 
/*     */ public class RetailLocationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 933353453L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RetailLocationPropertyDAO.class);
/*     */   
...
/* 193 */     RetailLocationPropertyId id = new RetailLocationPropertyId();
...
/* 201 */     setOrganizationId(((RetailLocationPropertyId)argObjectId).getOrganizationId());
/* 202 */     setRetailLocationId(((RetailLocationPropertyId)argObjectId).getRetailLocationId());
/* 203 */     setPropertyCode(((RetailLocationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"RetailLocationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\RetailLocationPropertyDAO.class
