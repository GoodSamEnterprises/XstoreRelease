...
/*     */ 
/*     */ 
/*     */ public class ShippingFeeTierPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IShippingFeeTierProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ShippingFeeTierPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ShippingFeeTierPropertyDAO getDAO_() {
/*  44 */     return (ShippingFeeTierPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     if (setRuleName_noev(argRuleName) && 
/*  61 */       this._events != null && 
/*  62 */       postEventsForChanges()) {
/*  63 */       this._events.post(IShippingFeeTierProperty.SET_RULENAME, argRuleName);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*  72 */     if ((getDAO_().getRuleName() == null && argRuleName != null) || (
/*  73 */       getDAO_().getRuleName() != null && !getDAO_().getRuleName().equals(argRuleName))) {
/*  74 */       getDAO_().setRuleName(argRuleName);
/*  75 */       ev_postable = true;
/*     */     } 
/*     */     
...
/* 102 */       this._events.post(IShippingFeeTierProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getParentRuleName();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setParentRuleName_noev(argParentRuleName) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IShippingFeeTierProperty.SET_PARENTRULENAME, argParentRuleName);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getParentRuleName() == null && argParentRuleName != null) || (
/* 146 */       getDAO_().getParentRuleName() != null && !getDAO_().getParentRuleName().equals(argParentRuleName))) {
/* 147 */       getDAO_().setParentRuleName(argParentRuleName);
...
/* 170 */       this._events.post(IShippingFeeTierProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IShippingFeeTierProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IShippingFeeTierProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IShippingFeeTierProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IShippingFeeTierProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IShippingFeeTierProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IShippingFeeTierProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IShippingFeeTierProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IShippingFeeTierProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("ShippingFeeTierPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("ShippingFeeTierPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ShippingFeeTierPropertyModel.class
