...
/*     */ 
/*     */ 
/*     */ public class ReturnedItemCountPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2111637118L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ReturnedItemCountPropertyDAO.class);
/*     */   
...
/*  83 */     return this._retailTransactionLineItemSequence;
/*     */   }
/*     */   
/*     */   public void setRetailTransactionLineItemSequence(Integer argRetailTransactionLineItemSequence) {
/*  87 */     if (changed(argRetailTransactionLineItemSequence, this._retailTransactionLineItemSequence, "retailTransactionLineItemSequence")) {
/*  88 */       this._retailTransactionLineItemSequence = argRetailTransactionLineItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 209 */     if (getBusinessDate() != null) {
/* 210 */       buf.append("businessDate").append("=").append(getBusinessDate()).append(" ");
/*     */     }
/* 212 */     if (getRetailTransactionLineItemSequence() != null) {
/* 213 */       buf.append("retailTransactionLineItemSequence").append("=").append(getRetailTransactionLineItemSequence()).append(" ");
/*     */     }
...
/* 250 */     ReturnedItemCountPropertyId id = new ReturnedItemCountPropertyId();
...
/* 254 */     id.setBusinessDate(getBusinessDate());
...
/* 262 */     setOrganizationId(((ReturnedItemCountPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((ReturnedItemCountPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setWorkstationId(((ReturnedItemCountPropertyId)argObjectId).getWorkstationId());
/* 265 */     setBusinessDate(((ReturnedItemCountPropertyId)argObjectId).getBusinessDate());
/* 266 */     setRetailTransactionLineItemSequence(((ReturnedItemCountPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 267 */     setTransactionSequence(((ReturnedItemCountPropertyId)argObjectId).getTransactionSequence());
/* 268 */     setPropertyCode(((ReturnedItemCountPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"ReturnedItemCountProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 289 */     if (this._businessDate != null) values.put("BusinessDate", DaoUtils.getXmlSafeFieldValue(91, this._businessDate)); 
/* 290 */     if (this._retailTransactionLineItemSequence != null) values.put("RetailTransactionLineItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._retailTransactionLineItemSequence)); 
...
/* 334 */             setWorkstationId((Long)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setWorkstationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "BusinessDate":
...
/* 343 */             setBusinessDate((Date)value);
/* 344 */           } catch (Exception ee) {
/* 345 */             throw new DtxException("An exception occurred while calling setBusinessDate() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 352 */             setRetailTransactionLineItemSequence((Integer)value);
/* 353 */           } catch (Exception ee) {
/* 354 */             throw new DtxException("An exception occurred while calling setRetailTransactionLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\ReturnedItemCountPropertyDAO.class
