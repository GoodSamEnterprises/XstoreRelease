...
/*     */ 
/*     */ 
/*     */ public class ReturnedItemCountDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1822266509L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ReturnedItemCountDAO.class);
/*     */   
...
/*  79 */     return this._retailTransactionLineItemSequence;
/*     */   }
/*     */   
/*     */   public void setRetailTransactionLineItemSequence(Integer argRetailTransactionLineItemSequence) {
/*  83 */     if (changed(argRetailTransactionLineItemSequence, this._retailTransactionLineItemSequence, "retailTransactionLineItemSequence")) {
/*  84 */       this._retailTransactionLineItemSequence = argRetailTransactionLineItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/* 141 */     return this._returnedCount;
/*     */   }
/*     */   
/*     */   public void setReturnedCount(BigDecimal argReturnedCount) {
/* 145 */     if (changed(argReturnedCount, this._returnedCount, "returnedCount")) {
/* 146 */       this._returnedCount = argReturnedCount;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 167 */     if (getRetailTransactionLineItemSequence() != null) {
/* 168 */       buf.append("retailTransactionLineItemSequence").append("=").append(getRetailTransactionLineItemSequence()).append(" ");
/*     */     }
/* 170 */     if (getTransactionSequence() != null) {
/* 171 */       buf.append("transactionSequence").append("=").append(getTransactionSequence()).append(" ");
/*     */     }
...
/*     */     }
/* 185 */     if (getReturnedCount() != null) {
/* 186 */       buf.append("returnedCount").append("=").append(getReturnedCount()).append(" ");
/*     */     }
/*     */     
...
/* 193 */     ReturnedItemCountId id = new ReturnedItemCountId();
...
/* 198 */     id.setRetailTransactionLineItemSequence(getRetailTransactionLineItemSequence());
/* 199 */     id.setTransactionSequence(getTransactionSequence());
/* 200 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 204 */     setOrganizationId(((ReturnedItemCountId)argObjectId).getOrganizationId());
/* 205 */     setRetailLocationId(((ReturnedItemCountId)argObjectId).getRetailLocationId());
/* 206 */     setWorkstationId(((ReturnedItemCountId)argObjectId).getWorkstationId());
/* 207 */     setBusinessDate(((ReturnedItemCountId)argObjectId).getBusinessDate());
/* 208 */     setRetailTransactionLineItemSequence(((ReturnedItemCountId)argObjectId).getRetailTransactionLineItemSequence());
/* 209 */     setTransactionSequence(((ReturnedItemCountId)argObjectId).getTransactionSequence());
/*     */   }
/*     */   
...
/* 218 */     buf.append("<").append("dao").append(" name=\"ReturnedItemCount\" cmd=\"" + getObjectStateString() + "\">");
...
/* 231 */     if (this._retailTransactionLineItemSequence != null) values.put("RetailTransactionLineItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._retailTransactionLineItemSequence)); 
/* 232 */     if (this._transactionSequence != null) values.put("TransactionSequence", DaoUtils.getXmlSafeFieldValue(-5, this._transactionSequence)); 
...
/* 237 */     if (this._returnedCount != null) values.put("ReturnedCount", DaoUtils.getXmlSafeFieldValue(3, this._returnedCount)); 
/* 238 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/*     */           try {
/* 288 */             Object value = DaoUtils.getFieldValueForXmlString(4, fieldValue);
/* 289 */             setRetailTransactionLineItemSequence((Integer)value);
/* 290 */           } catch (Exception ee) {
/* 291 */             throw new DtxException("An exception occurred while calling setRetailTransactionLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 298 */             setTransactionSequence((Long)value);
/* 299 */           } catch (Exception ee) {
/* 300 */             throw new DtxException("An exception occurred while calling setTransactionSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CreateDate":
...
/* 343 */             setReturnedCount((BigDecimal)value);
/* 344 */           } catch (Exception ee) {
/* 345 */             throw new DtxException("An exception occurred while calling setReturnedCount() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\ReturnedItemCountDAO.class
