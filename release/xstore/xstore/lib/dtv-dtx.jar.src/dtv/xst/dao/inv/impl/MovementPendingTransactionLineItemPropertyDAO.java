...
/*     */ 
/*     */ 
/*     */ public class MovementPendingTransactionLineItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 269307954L;
/*  23 */   private static final Logger _logger = Logger.getLogger(MovementPendingTransactionLineItemPropertyDAO.class);
/*     */   
...
/* 250 */     MovementPendingTransactionLineItemPropertyId id = new MovementPendingTransactionLineItemPropertyId();
...
/* 262 */     setOrganizationId(((MovementPendingTransactionLineItemPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((MovementPendingTransactionLineItemPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setBusinessDate(((MovementPendingTransactionLineItemPropertyId)argObjectId).getBusinessDate());
/* 265 */     setWorkstationId(((MovementPendingTransactionLineItemPropertyId)argObjectId).getWorkstationId());
/* 266 */     setTransactionSequence(((MovementPendingTransactionLineItemPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setLineItemSequence(((MovementPendingTransactionLineItemPropertyId)argObjectId).getLineItemSequence());
/* 268 */     setPropertyCode(((MovementPendingTransactionLineItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"MovementPendingTransactionLineItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\MovementPendingTransactionLineItemPropertyDAO.class
