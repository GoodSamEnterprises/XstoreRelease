...
/*     */ 
/*     */ 
/*     */ public class AirportZonePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1800889876L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AirportZonePropertyDAO.class);
/*     */   
...
/*  48 */     return this._zoneId;
/*     */   }
/*     */   
/*     */   public void setZoneId(String argZoneId) {
/*  52 */     if (changed(argZoneId, this._zoneId, "zoneId")) {
/*  53 */       this._zoneId = (argZoneId != null && MANAGE_CASE) ? argZoneId.toUpperCase() : argZoneId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getZoneId() != null) {
/* 159 */       buf.append("zoneId").append("=").append(getZoneId()).append(" ");
/*     */     }
...
/* 193 */     AirportZonePropertyId id = new AirportZonePropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setZoneId(getZoneId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((AirportZonePropertyId)argObjectId).getOrganizationId());
/* 202 */     setZoneId(((AirportZonePropertyId)argObjectId).getZoneId());
/* 203 */     setPropertyCode(((AirportZonePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"AirportZoneProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._zoneId != null) values.put("ZoneId", DaoUtils.getXmlSafeFieldValue(12, this._zoneId)); 
...
/* 256 */             setZoneId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setZoneId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AirportZonePropertyDAO.class
