...
/*     */ 
/*     */ 
/*     */ public class ReceiptLookupPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1436687783L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ReceiptLookupPropertyDAO.class);
/*     */   
...
/*  93 */     return this._receiptId;
/*     */   }
/*     */   
/*     */   public void setReceiptId(String argReceiptId) {
/*  97 */     if (changed(argReceiptId, this._receiptId, "receiptId")) {
/*  98 */       this._receiptId = (argReceiptId != null && MANAGE_CASE) ? argReceiptId.toUpperCase() : argReceiptId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 215 */     if (getReceiptId() != null) {
/* 216 */       buf.append("receiptId").append("=").append(getReceiptId()).append(" ");
/*     */     }
...
/* 250 */     ReceiptLookupPropertyId id = new ReceiptLookupPropertyId();
...
/* 256 */     id.setReceiptId(getReceiptId());
/* 257 */     id.setPropertyCode(getPropertyCode());
/* 258 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 262 */     setOrganizationId(((ReceiptLookupPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((ReceiptLookupPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setWorkstationId(((ReceiptLookupPropertyId)argObjectId).getWorkstationId());
/* 265 */     setBusinessDate(((ReceiptLookupPropertyId)argObjectId).getBusinessDate());
/* 266 */     setTransactionSequence(((ReceiptLookupPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setReceiptId(((ReceiptLookupPropertyId)argObjectId).getReceiptId());
/* 268 */     setPropertyCode(((ReceiptLookupPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"ReceiptLookupProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 291 */     if (this._receiptId != null) values.put("ReceiptId", DaoUtils.getXmlSafeFieldValue(12, this._receiptId)); 
...
/* 361 */             setReceiptId((String)value);
/* 362 */           } catch (Exception ee) {
/* 363 */             throw new DtxException("An exception occurred while calling setReceiptId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\ReceiptLookupPropertyDAO.class
