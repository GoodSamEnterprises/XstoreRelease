...
/*     */ 
/*     */ 
/*     */ public class InventorySummaryCountTransactionDetailPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2047589665L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventorySummaryCountTransactionDetailPropertyDAO.class);
/*     */   
...
/*  93 */     return this._transLineSequence;
/*     */   }
/*     */   
/*     */   public void setTransLineSequence(Integer argTransLineSequence) {
/*  97 */     if (changed(argTransLineSequence, this._transLineSequence, "transLineSequence")) {
/*  98 */       this._transLineSequence = argTransLineSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 215 */     if (getTransLineSequence() != null) {
/* 216 */       buf.append("transLineSequence").append("=").append(getTransLineSequence()).append(" ");
/*     */     }
...
/* 250 */     InventorySummaryCountTransactionDetailPropertyId id = new InventorySummaryCountTransactionDetailPropertyId();
...
/* 256 */     id.setTransLineSequence(getTransLineSequence());
/* 257 */     id.setPropertyCode(getPropertyCode());
/* 258 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 262 */     setOrganizationId(((InventorySummaryCountTransactionDetailPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((InventorySummaryCountTransactionDetailPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setWorkstationId(((InventorySummaryCountTransactionDetailPropertyId)argObjectId).getWorkstationId());
/* 265 */     setBusinessDate(((InventorySummaryCountTransactionDetailPropertyId)argObjectId).getBusinessDate());
/* 266 */     setTransactionSequence(((InventorySummaryCountTransactionDetailPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setTransLineSequence(((InventorySummaryCountTransactionDetailPropertyId)argObjectId).getTransLineSequence());
/* 268 */     setPropertyCode(((InventorySummaryCountTransactionDetailPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"InventorySummaryCountTransactionDetailProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 291 */     if (this._transLineSequence != null) values.put("TransLineSequence", DaoUtils.getXmlSafeFieldValue(4, this._transLineSequence)); 
...
/* 361 */             setTransLineSequence((Integer)value);
/* 362 */           } catch (Exception ee) {
/* 363 */             throw new DtxException("An exception occurred while calling setTransLineSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventorySummaryCountTransactionDetailPropertyDAO.class
