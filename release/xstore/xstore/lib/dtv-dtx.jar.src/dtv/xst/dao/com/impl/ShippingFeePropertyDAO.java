...
/*     */ 
/*     */ 
/*     */ public class ShippingFeePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 921026765L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ShippingFeePropertyDAO.class);
/*     */   
...
/*  38 */     return this._ruleName;
/*     */   }
/*     */   
/*     */   public void setRuleName(String argRuleName) {
/*  42 */     if (changed(argRuleName, this._ruleName, "ruleName")) {
/*  43 */       this._ruleName = (argRuleName != null && MANAGE_CASE) ? argRuleName.toUpperCase() : argRuleName;
/*     */     }
/*     */   }
/*     */   
...
/* 155 */     if (getRuleName() != null) {
/* 156 */       buf.append("ruleName").append("=").append(getRuleName()).append(" ");
/*     */     }
...
/* 193 */     ShippingFeePropertyId id = new ShippingFeePropertyId();
/* 194 */     id.setRuleName(getRuleName());
...
/* 201 */     setRuleName(((ShippingFeePropertyId)argObjectId).getRuleName());
/* 202 */     setOrganizationId(((ShippingFeePropertyId)argObjectId).getOrganizationId());
/* 203 */     setPropertyCode(((ShippingFeePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ShippingFeeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 221 */     if (this._ruleName != null) values.put("RuleName", DaoUtils.getXmlSafeFieldValue(12, this._ruleName)); 
...
/* 247 */             setRuleName((String)value);
/* 248 */           } catch (Exception ee) {
/* 249 */             throw new DtxException("An exception occurred while calling setRuleName() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ShippingFeePropertyDAO.class
