...
/*     */ 
/*     */ 
/*     */ public class PayrollCategoryPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.payroll_category, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM thr_payroll_category_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND payroll_category = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.payroll_category, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM thr_payroll_category_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND payroll_category = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO thr_payroll_category_p(organization_id, payroll_category, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._payrollCategory, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE thr_payroll_category_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM thr_payroll_category_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND payroll_category = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND payroll_category = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._payrollCategory, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "thr_payroll_category_p";
/*     */   }
/*     */   
...
/* 115 */     return new PayrollCategoryPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class PayrollCategoryPropertyFiller
/*     */     implements IFiller {
/*     */     private PayrollCategoryPropertyDBA _parent;
/*     */     
/*     */     public PayrollCategoryPropertyFiller(PayrollCategoryPropertyDBA argParent) {
...
/* 173 */     PayrollCategoryPropertyDAO dao = (PayrollCategoryPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setPayrollCategory(this._payrollCategory);
...
/* 190 */     return loadDAO((IDataAccessObject)new PayrollCategoryPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     PayrollCategoryPropertyDAO dao = (PayrollCategoryPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._payrollCategory = dao.getPayrollCategory();
...
/* 209 */     PayrollCategoryPropertyId id = (PayrollCategoryPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getPayrollCategory());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     PayrollCategoryPropertyId id = new PayrollCategoryPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setPayrollCategory(this._payrollCategory);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\impl\PayrollCategoryPropertyDBA.class
