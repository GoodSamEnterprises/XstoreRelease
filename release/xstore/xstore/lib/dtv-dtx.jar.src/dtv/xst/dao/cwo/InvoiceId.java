...
/*     */   public InvoiceId() {}
/*     */   
/*     */   public InvoiceId(String argObjectIdValue) {
...
/*  38 */     return this._invoiceNumber;
/*     */   }
/*     */   
/*     */   public void setInvoiceNumber(String argInvoiceNumber) {
/*  42 */     this._invoiceNumber = (argInvoiceNumber != null && MANAGE_CASE) ? argInvoiceNumber.toUpperCase() : argInvoiceNumber;
/*     */   }
/*     */   
...
/*  66 */         setInvoiceNumber((String)null);
/*     */       } else {
/*     */         
/*  69 */         setInvoiceNumber(str);
/*     */       }
/*     */     
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof InvoiceId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     InvoiceId other = (InvoiceId)ob;
...
/*     */ 
/*     */       
/*  92 */       .equals(other._serviceLocationId))) && ((this._invoiceNumber == null && other._invoiceNumber == null) || (this._invoiceNumber != null && this._invoiceNumber
/*     */ 
/*     */       
/*  95 */       .equals(other._invoiceNumber))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 103 */       .hashCode()) + ((this._invoiceNumber == null) ? 0 : this._invoiceNumber
/* 104 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
...
/* 119 */       .append("::").append(this._invoiceNumber)
/* 120 */       .toString();
/*     */   }
/*     */   
...
/* 125 */       return false;
/*     */     }
/* 127 */     if (this._invoiceNumber == null) {
/* 128 */       return false;
/*     */     }
/* 130 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\InvoiceId.class
