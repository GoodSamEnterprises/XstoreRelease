...
/*     */ 
/*     */ 
/*     */ public class FiscalYearPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -399287760L;
/*  23 */   private static final Logger _logger = Logger.getLogger(FiscalYearPropertyDAO.class);
/*     */   
...
/*  48 */     return this._fiscalYear;
/*     */   }
/*     */   
/*     */   public void setFiscalYear(Integer argFiscalYear) {
/*  52 */     if (changed(argFiscalYear, this._fiscalYear, "fiscalYear")) {
/*  53 */       this._fiscalYear = argFiscalYear;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getFiscalYear() != null) {
/* 159 */       buf.append("fiscalYear").append("=").append(getFiscalYear()).append(" ");
/*     */     }
...
/* 193 */     FiscalYearPropertyId id = new FiscalYearPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setFiscalYear(getFiscalYear());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((FiscalYearPropertyId)argObjectId).getOrganizationId());
/* 202 */     setFiscalYear(((FiscalYearPropertyId)argObjectId).getFiscalYear());
/* 203 */     setPropertyCode(((FiscalYearPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"FiscalYearProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._fiscalYear != null) values.put("FiscalYear", DaoUtils.getXmlSafeFieldValue(4, this._fiscalYear)); 
...
/*     */         case "FiscalYear":
/*     */           try {
/* 255 */             Object value = DaoUtils.getFieldValueForXmlString(4, fieldValue);
/* 256 */             setFiscalYear((Integer)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setFiscalYear() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\FiscalYearPropertyDAO.class
