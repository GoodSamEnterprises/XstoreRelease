...
/*     */ 
/*     */ 
/*     */ public class StockLedgerPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IStockLedgerProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new StockLedgerPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private StockLedgerPropertyDAO getDAO_() {
/*  44 */     return (StockLedgerPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IStockLedgerProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IStockLedgerProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     return getDAO_().getBucketId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 138 */     if (setBucketId_noev(argBucketId) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IStockLedgerProperty.SET_BUCKETID, argBucketId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getBucketId() == null && argBucketId != null) || (
/* 151 */       getDAO_().getBucketId() != null && !getDAO_().getBucketId().equals(argBucketId))) {
/* 152 */       getDAO_().setBucketId(argBucketId);
...
/* 164 */     return getDAO_().getInvLocationId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */     if (setInvLocationId_noev(argInvLocationId) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IStockLedgerProperty.SET_INVLOCATIONID, argInvLocationId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getInvLocationId() == null && argInvLocationId != null) || (
/* 185 */       getDAO_().getInvLocationId() != null && !getDAO_().getInvLocationId().equals(argInvLocationId))) {
/* 186 */       getDAO_().setInvLocationId(argInvLocationId);
...
/* 206 */     if (setItemId_noev(argItemId) && 
/* 207 */       this._events != null && 
/* 208 */       postEventsForChanges()) {
/* 209 */       this._events.post(IStockLedgerProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 218 */     if ((getDAO_().getItemId() == null && argItemId != null) || (
/* 219 */       getDAO_().getItemId() != null && !getDAO_().getItemId().equals(argItemId))) {
/* 220 */       getDAO_().setItemId(argItemId);
...
/* 243 */       this._events.post(IStockLedgerProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IStockLedgerProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IStockLedgerProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IStockLedgerProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IStockLedgerProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IStockLedgerProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IStockLedgerProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(IStockLedgerProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 515 */       this._events.post(IStockLedgerProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 536 */     if ("StockLedgerPropertyExtension".equals(argFieldId)) {
...
/* 546 */     if ("StockLedgerPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\StockLedgerPropertyModel.class
