...
/*     */ 
/*     */ 
/*     */ public class OrderModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 152714522L;
/*  23 */   private static final Logger _logger = Logger.getLogger(OrderModifierPropertyDAO.class);
/*     */   
...
/* 250 */     OrderModifierPropertyId id = new OrderModifierPropertyId();
...
/* 262 */     setOrganizationId(((OrderModifierPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((OrderModifierPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setBusinessDate(((OrderModifierPropertyId)argObjectId).getBusinessDate());
/* 265 */     setWorkstationId(((OrderModifierPropertyId)argObjectId).getWorkstationId());
/* 266 */     setTransactionSequence(((OrderModifierPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setRetailTransactionLineItemSequence(((OrderModifierPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 268 */     setPropertyCode(((OrderModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"OrderModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderModifierPropertyDAO.class
