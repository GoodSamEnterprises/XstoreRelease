...
/*     */ 
/*     */ 
/*     */ public class TaxRateRulePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1609335708L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxRateRulePropertyDAO.class);
/*     */   
...
/*  51 */     return this._taxGroupId;
/*     */   }
/*     */   
/*     */   public void setTaxGroupId(String argTaxGroupId) {
/*  55 */     if (changed(argTaxGroupId, this._taxGroupId, "taxGroupId")) {
/*  56 */       this._taxGroupId = (argTaxGroupId != null && MANAGE_CASE) ? argTaxGroupId.toUpperCase() : argTaxGroupId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getTaxLocationId() {
/*  61 */     return this._taxLocationId;
/*     */   }
/*     */   
/*     */   public void setTaxLocationId(String argTaxLocationId) {
/*  65 */     if (changed(argTaxLocationId, this._taxLocationId, "taxLocationId")) {
/*  66 */       this._taxLocationId = (argTaxLocationId != null && MANAGE_CASE) ? argTaxLocationId.toUpperCase() : argTaxLocationId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getTaxRateRuleSequence() {
/*  71 */     return this._taxRateRuleSequence;
/*     */   }
/*     */   
/*     */   public void setTaxRateRuleSequence(Integer argTaxRateRuleSequence) {
/*  75 */     if (changed(argTaxRateRuleSequence, this._taxRateRuleSequence, "taxRateRuleSequence")) {
/*  76 */       this._taxRateRuleSequence = argTaxRateRuleSequence;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getTaxRuleSequence() {
/*  81 */     return this._taxRuleSequence;
/*     */   }
/*     */   
/*     */   public void setTaxRuleSequence(Integer argTaxRuleSequence) {
/*  85 */     if (changed(argTaxRuleSequence, this._taxRuleSequence, "taxRuleSequence")) {
/*  86 */       this._taxRuleSequence = argTaxRuleSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 191 */     if (getTaxGroupId() != null) {
/* 192 */       buf.append("taxGroupId").append("=").append(getTaxGroupId()).append(" ");
/*     */     }
/* 194 */     if (getTaxLocationId() != null) {
/* 195 */       buf.append("taxLocationId").append("=").append(getTaxLocationId()).append(" ");
/*     */     }
/* 197 */     if (getTaxRateRuleSequence() != null) {
/* 198 */       buf.append("taxRateRuleSequence").append("=").append(getTaxRateRuleSequence()).append(" ");
/*     */     }
/* 200 */     if (getTaxRuleSequence() != null) {
/* 201 */       buf.append("taxRuleSequence").append("=").append(getTaxRuleSequence()).append(" ");
/*     */     }
...
/* 235 */     TaxRateRulePropertyId id = new TaxRateRulePropertyId();
/* 236 */     id.setOrganizationId(getOrganizationId());
/* 237 */     id.setTaxGroupId(getTaxGroupId());
/* 238 */     id.setTaxLocationId(getTaxLocationId());
/* 239 */     id.setTaxRateRuleSequence(getTaxRateRuleSequence());
/* 240 */     id.setTaxRuleSequence(getTaxRuleSequence());
/* 241 */     id.setPropertyCode(getPropertyCode());
/* 242 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 246 */     setOrganizationId(((TaxRateRulePropertyId)argObjectId).getOrganizationId());
/* 247 */     setTaxGroupId(((TaxRateRulePropertyId)argObjectId).getTaxGroupId());
/* 248 */     setTaxLocationId(((TaxRateRulePropertyId)argObjectId).getTaxLocationId());
/* 249 */     setTaxRateRuleSequence(((TaxRateRulePropertyId)argObjectId).getTaxRateRuleSequence());
/* 250 */     setTaxRuleSequence(((TaxRateRulePropertyId)argObjectId).getTaxRuleSequence());
/* 251 */     setPropertyCode(((TaxRateRulePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"TaxRateRuleProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 270 */     if (this._taxGroupId != null) values.put("TaxGroupId", DaoUtils.getXmlSafeFieldValue(12, this._taxGroupId)); 
/* 271 */     if (this._taxLocationId != null) values.put("TaxLocationId", DaoUtils.getXmlSafeFieldValue(12, this._taxLocationId)); 
/* 272 */     if (this._taxRateRuleSequence != null) values.put("TaxRateRuleSequence", DaoUtils.getXmlSafeFieldValue(4, this._taxRateRuleSequence)); 
/* 273 */     if (this._taxRuleSequence != null) values.put("TaxRuleSequence", DaoUtils.getXmlSafeFieldValue(4, this._taxRuleSequence)); 
...
/* 307 */             setTaxGroupId((String)value);
/* 308 */           } catch (Exception ee) {
/* 309 */             throw new DtxException("An exception occurred while calling setTaxGroupId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "TaxLocationId":
...
/* 316 */             setTaxLocationId((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setTaxLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 325 */             setTaxRateRuleSequence((Integer)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setTaxRateRuleSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 334 */             setTaxRuleSequence((Integer)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setTaxRuleSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxRateRulePropertyDAO.class
