...
/*     */ 
/*     */ 
/*     */ public class CustomerLoyaltyCardPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -982563955L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.cust_acct_card_nbr, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cat_cust_acct_card_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND cust_acct_card_nbr = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.cust_acct_card_nbr, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cat_cust_acct_card_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND cust_acct_card_nbr = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cat_cust_acct_card_p(organization_id, cust_acct_card_nbr, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._cardNumber, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cat_cust_acct_card_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cat_cust_acct_card_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND cust_acct_card_nbr = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND cust_acct_card_nbr = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._cardNumber, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "cat_cust_acct_card_p";
/*     */   }
/*     */   
...
/* 115 */     return new CustomerLoyaltyCardPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class CustomerLoyaltyCardPropertyFiller
/*     */     implements IFiller {
/*     */     private CustomerLoyaltyCardPropertyDBA _parent;
/*     */     
/*     */     public CustomerLoyaltyCardPropertyFiller(CustomerLoyaltyCardPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._cardNumber = argResultSet.getString(2);
...
/* 173 */     CustomerLoyaltyCardPropertyDAO dao = (CustomerLoyaltyCardPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setCardNumber(this._cardNumber);
...
/* 190 */     return loadDAO((IDataAccessObject)new CustomerLoyaltyCardPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     CustomerLoyaltyCardPropertyDAO dao = (CustomerLoyaltyCardPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._cardNumber = dao.getCardNumber();
...
/* 209 */     CustomerLoyaltyCardPropertyId id = (CustomerLoyaltyCardPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getCardNumber());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     CustomerLoyaltyCardPropertyId id = new CustomerLoyaltyCardPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setCardNumber(this._cardNumber);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerLoyaltyCardPropertyDBA.class
