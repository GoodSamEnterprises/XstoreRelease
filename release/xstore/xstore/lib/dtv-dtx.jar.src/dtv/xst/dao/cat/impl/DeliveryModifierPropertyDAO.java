...
/*     */ 
/*     */ 
/*     */ public class DeliveryModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -481781248L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DeliveryModifierPropertyDAO.class);
/*     */   
...
/* 207 */     DeliveryModifierPropertyId id = new DeliveryModifierPropertyId();
...
/* 216 */     setOrganizationId(((DeliveryModifierPropertyId)argObjectId).getOrganizationId());
/* 217 */     setCustAccountId(((DeliveryModifierPropertyId)argObjectId).getCustAccountId());
/* 218 */     setCustAccountCode(((DeliveryModifierPropertyId)argObjectId).getCustAccountCode());
/* 219 */     setPropertyCode(((DeliveryModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DeliveryModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._custAccountCode != null) values.put("CustAccountCode", DaoUtils.getXmlSafeFieldValue(12, this._custAccountCode)); 
...
/* 282 */             setCustAccountCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setCustAccountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\DeliveryModifierPropertyDAO.class
