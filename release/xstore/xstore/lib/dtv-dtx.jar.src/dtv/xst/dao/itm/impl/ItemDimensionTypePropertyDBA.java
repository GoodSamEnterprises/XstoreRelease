...
/*     */ 
/*     */ 
/*     */ public class ItemDimensionTypePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.dimension_system, t.dimension, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_dimension_type_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND dimension_system = ?  AND dimension = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.dimension_system, t.dimension, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_dimension_type_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND dimension_system = ?  AND dimension = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_item_dimension_type_p(organization_id, dimension_system, dimension, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._dimensionSystem, this._dimension, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_item_dimension_type_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_item_dimension_type_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND dimension_system = ?  AND dimension = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND dimension_system = ?  AND dimension = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._dimensionSystem, this._dimension, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "itm_item_dimension_type_p";
/*     */   }
/*     */   
...
/* 116 */     return new ItemDimensionTypePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ItemDimensionTypePropertyFiller
/*     */     implements IFiller {
/*     */     private ItemDimensionTypePropertyDBA _parent;
/*     */     
/*     */     public ItemDimensionTypePropertyFiller(ItemDimensionTypePropertyDBA argParent) {
...
/* 175 */     ItemDimensionTypePropertyDAO dao = (ItemDimensionTypePropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setDimensionSystem(this._dimensionSystem);
/* 178 */     dao.setDimension(this._dimension);
...
/* 193 */     return loadDAO((IDataAccessObject)new ItemDimensionTypePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     ItemDimensionTypePropertyDAO dao = (ItemDimensionTypePropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._dimensionSystem = dao.getDimensionSystem();
/* 200 */     this._dimension = dao.getDimension();
...
/* 213 */     ItemDimensionTypePropertyId id = (ItemDimensionTypePropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getDimensionSystem());
/* 216 */     argStatement.setString(3, id.getDimension());
/* 217 */     argStatement.setString(4, id.getPropertyCode());
/* 218 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 222 */     ItemDimensionTypePropertyId id = new ItemDimensionTypePropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setDimensionSystem(this._dimensionSystem);
/* 225 */     id.setDimension(this._dimension);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemDimensionTypePropertyDBA.class
