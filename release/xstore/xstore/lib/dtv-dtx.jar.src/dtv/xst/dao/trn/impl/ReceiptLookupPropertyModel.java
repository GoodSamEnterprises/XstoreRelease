...
/*     */ 
/*     */ 
/*     */ public class ReceiptLookupPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IReceiptLookupProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ReceiptLookupPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ReceiptLookupPropertyDAO getDAO_() {
/*  44 */     return (ReceiptLookupPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IReceiptLookupProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IReceiptLookupProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 146 */       this._events.post(IReceiptLookupProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(IReceiptLookupProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(IReceiptLookupProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 242 */     return getDAO_().getReceiptId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 250 */     if (setReceiptId_noev(argReceiptId) && 
/* 251 */       this._events != null && 
/* 252 */       postEventsForChanges()) {
/* 253 */       this._events.post(IReceiptLookupProperty.SET_RECEIPTID, argReceiptId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 262 */     if ((getDAO_().getReceiptId() == null && argReceiptId != null) || (
/* 263 */       getDAO_().getReceiptId() != null && !getDAO_().getReceiptId().equals(argReceiptId))) {
/* 264 */       getDAO_().setReceiptId(argReceiptId);
...
/* 287 */       this._events.post(IReceiptLookupProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 321 */       this._events.post(IReceiptLookupProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 355 */       this._events.post(IReceiptLookupProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 389 */       this._events.post(IReceiptLookupProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 423 */       this._events.post(IReceiptLookupProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 457 */       this._events.post(IReceiptLookupProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 491 */       this._events.post(IReceiptLookupProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 525 */       this._events.post(IReceiptLookupProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 559 */       this._events.post(IReceiptLookupProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 580 */     if ("ReceiptLookupPropertyExtension".equals(argFieldId)) {
...
/* 590 */     if ("ReceiptLookupPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\ReceiptLookupPropertyModel.class
