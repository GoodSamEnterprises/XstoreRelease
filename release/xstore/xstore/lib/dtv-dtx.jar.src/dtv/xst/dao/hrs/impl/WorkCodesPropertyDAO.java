...
/*     */ 
/*     */ 
/*     */ public class WorkCodesPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1399404650L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WorkCodesPropertyDAO.class);
/*     */   
...
/*  48 */     return this._workCode;
/*     */   }
/*     */   
/*     */   public void setWorkCode(String argWorkCode) {
/*  52 */     if (changed(argWorkCode, this._workCode, "workCode")) {
/*  53 */       this._workCode = (argWorkCode != null && MANAGE_CASE) ? argWorkCode.toUpperCase() : argWorkCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getWorkCode() != null) {
/* 159 */       buf.append("workCode").append("=").append(getWorkCode()).append(" ");
/*     */     }
...
/* 193 */     WorkCodesPropertyId id = new WorkCodesPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setWorkCode(getWorkCode());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((WorkCodesPropertyId)argObjectId).getOrganizationId());
/* 202 */     setWorkCode(((WorkCodesPropertyId)argObjectId).getWorkCode());
/* 203 */     setPropertyCode(((WorkCodesPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"WorkCodesProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._workCode != null) values.put("WorkCode", DaoUtils.getXmlSafeFieldValue(12, this._workCode)); 
...
/* 256 */             setWorkCode((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setWorkCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\WorkCodesPropertyDAO.class
