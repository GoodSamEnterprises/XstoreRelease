...
/*     */ 
/*     */ 
/*     */ public class InventoryCountSheetPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 704691681L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryCountSheetPropertyDAO.class);
/*     */   
...
/*  70 */     return this._countSheetNumber;
/*     */   }
/*     */   
/*     */   public void setCountSheetNumber(Integer argCountSheetNumber) {
/*  74 */     if (changed(argCountSheetNumber, this._countSheetNumber, "countSheetNumber")) {
/*  75 */       this._countSheetNumber = argCountSheetNumber;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 186 */     if (getCountSheetNumber() != null) {
/* 187 */       buf.append("countSheetNumber").append("=").append(getCountSheetNumber()).append(" ");
/*     */     }
...
/* 221 */     InventoryCountSheetPropertyId id = new InventoryCountSheetPropertyId();
...
/* 225 */     id.setCountSheetNumber(getCountSheetNumber());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((InventoryCountSheetPropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((InventoryCountSheetPropertyId)argObjectId).getRetailLocationId());
/* 233 */     setInventoryCountId(((InventoryCountSheetPropertyId)argObjectId).getInventoryCountId());
/* 234 */     setCountSheetNumber(((InventoryCountSheetPropertyId)argObjectId).getCountSheetNumber());
/* 235 */     setPropertyCode(((InventoryCountSheetPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"InventoryCountSheetProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 256 */     if (this._countSheetNumber != null) values.put("CountSheetNumber", DaoUtils.getXmlSafeFieldValue(4, this._countSheetNumber)); 
...
/* 308 */             setCountSheetNumber((Integer)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setCountSheetNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountSheetPropertyDAO.class
