...
/*     */ 
/*     */ 
/*     */ public class TenderAvailabilityDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 754612847L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderAvailabilityDAO.class);
/*     */   
...
/*  34 */     return this._availabilityCode;
/*     */   }
/*     */   
/*     */   public void setAvailabilityCode(String argAvailabilityCode) {
/*  38 */     if (changed(argAvailabilityCode, this._availabilityCode, "availabilityCode")) {
/*  39 */       this._availabilityCode = (argAvailabilityCode != null && MANAGE_CASE) ? argAvailabilityCode.toUpperCase() : argAvailabilityCode;
/*     */     }
/*     */   }
/*     */   
...
/*  58 */     if (changed(argTenderId, this._tenderId, "tenderId")) {
/*  59 */       this._tenderId = (argTenderId != null && MANAGE_CASE) ? argTenderId.toUpperCase() : argTenderId;
/*     */     }
/*     */   }
/*     */   
...
/* 110 */     if (getAvailabilityCode() != null) {
/* 111 */       buf.append("availabilityCode").append("=").append(getAvailabilityCode()).append(" ");
/*     */     }
/* 113 */     if (getOrganizationId() != null) {
/* 114 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 116 */     if (getTenderId() != null) {
/* 117 */       buf.append("tenderId").append("=").append(getTenderId()).append(" ");
/*     */     }
...
/* 136 */     TenderAvailabilityId id = new TenderAvailabilityId();
/* 137 */     id.setAvailabilityCode(getAvailabilityCode());
/* 138 */     id.setOrganizationId(getOrganizationId());
/* 139 */     id.setTenderId(getTenderId());
/* 140 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 144 */     setAvailabilityCode(((TenderAvailabilityId)argObjectId).getAvailabilityCode());
/* 145 */     setOrganizationId(((TenderAvailabilityId)argObjectId).getOrganizationId());
/* 146 */     setTenderId(((TenderAvailabilityId)argObjectId).getTenderId());
/*     */   }
/*     */   
...
/* 155 */     buf.append("<").append("dao").append(" name=\"TenderAvailability\" cmd=\"" + getObjectStateString() + "\">");
...
/* 164 */     if (this._availabilityCode != null) values.put("AvailabilityCode", DaoUtils.getXmlSafeFieldValue(12, this._availabilityCode)); 
/* 165 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 166 */     if (this._tenderId != null) values.put("TenderId", DaoUtils.getXmlSafeFieldValue(12, this._tenderId)); 
...
/* 186 */             setAvailabilityCode((String)value);
/* 187 */           } catch (Exception ee) {
/* 188 */             throw new DtxException("An exception occurred while calling setAvailabilityCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 204 */             setTenderId((String)value);
/* 205 */           } catch (Exception ee) {
/* 206 */             throw new DtxException("An exception occurred while calling setTenderId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CreateDate":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderAvailabilityDAO.class
