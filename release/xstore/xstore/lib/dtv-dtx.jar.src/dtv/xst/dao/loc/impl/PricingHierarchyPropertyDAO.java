...
/*     */ 
/*     */ 
/*     */ public class PricingHierarchyPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 114579492L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PricingHierarchyPropertyDAO.class);
/*     */   
...
/* 207 */     PricingHierarchyPropertyId id = new PricingHierarchyPropertyId();
...
/* 216 */     setOrganizationId(((PricingHierarchyPropertyId)argObjectId).getOrganizationId());
/* 217 */     setLevelCode(((PricingHierarchyPropertyId)argObjectId).getLevelCode());
/* 218 */     setLevelValue(((PricingHierarchyPropertyId)argObjectId).getLevelValue());
/* 219 */     setPropertyCode(((PricingHierarchyPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"PricingHierarchyProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\PricingHierarchyPropertyDAO.class
