...
/*    */ 
/*    */ 
/*    */ public class OrderLineItemRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(3);
/*    */   
/* 21 */   ItemModifierId _childObjectId = null;
/*    */   
/*    */   public String getSelect() {
/* 24 */     return "SELECT organization_id, order_id, detail_seq, create_date, create_user_id, update_date, update_user_id, item_id, description, image_url FROM xom_item_mod WHERE organization_id = ? AND order_id = ? AND detail_seq = ?";
/*    */   }
/*    */ 
/*    */   
/*    */   public void setParent(IDataAccessObject argDAO) {
/* 29 */     OrderLineDAO dao = (OrderLineDAO)argDAO;
/* 30 */     this._childObjectId = new ItemModifierId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderLineItemRelationshipDBA.class
