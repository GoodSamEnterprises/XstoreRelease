...
/*     */ 
/*     */ 
/*     */ public class UserPasswordPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IUserPasswordProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new UserPasswordPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private UserPasswordPropertyDAO getDAO_() {
/*  44 */     return (UserPasswordPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IUserPasswordProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  99 */     if (setUser_noev(argUser) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IUserPasswordProperty.SET_USER, argUser);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getUser() == null && argUser != null) || (
/* 112 */       getDAO_().getUser() != null && !getDAO_().getUser().equals(argUser))) {
/* 113 */       getDAO_().setUser(argUser);
...
/* 126 */       return getDAO_().getSequence().longValue();
/*     */     }
/*     */     
/* 129 */     return 0L;
/*     */   }
...
/* 141 */       this._events.post(IUserPasswordProperty.SET_SEQUENCE, Long.valueOf(argSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getSequence() == null && Long.valueOf(argSequence) != null) || (
/* 151 */       getDAO_().getSequence() != null && !getDAO_().getSequence().equals(Long.valueOf(argSequence)))) {
/* 152 */       getDAO_().setSequence(Long.valueOf(argSequence));
...
/* 175 */       this._events.post(IUserPasswordProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(IUserPasswordProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IUserPasswordProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IUserPasswordProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IUserPasswordProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IUserPasswordProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IUserPasswordProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IUserPasswordProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IUserPasswordProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 468 */     if ("UserPasswordPropertyExtension".equals(argFieldId)) {
...
/* 478 */     if ("UserPasswordPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\UserPasswordPropertyModel.class
