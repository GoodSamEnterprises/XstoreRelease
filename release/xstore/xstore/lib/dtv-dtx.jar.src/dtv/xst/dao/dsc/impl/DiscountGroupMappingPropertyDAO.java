...
/*     */ 
/*     */ 
/*     */ public class DiscountGroupMappingPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2042080443L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DiscountGroupMappingPropertyDAO.class);
/*     */   
...
/*  43 */     if (changed(argCustomerGroupId, this._customerGroupId, "customerGroupId")) {
/*  44 */       this._customerGroupId = (argCustomerGroupId != null && MANAGE_CASE) ? argCustomerGroupId.toUpperCase() : argCustomerGroupId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getDiscountCode() {
/*  49 */     return this._discountCode;
/*     */   }
/*     */   
/*     */   public void setDiscountCode(String argDiscountCode) {
/*  53 */     if (changed(argDiscountCode, this._discountCode, "discountCode")) {
/*  54 */       this._discountCode = (argDiscountCode != null && MANAGE_CASE) ? argDiscountCode.toUpperCase() : argDiscountCode;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getCustomerGroupId() != null) {
/* 167 */       buf.append("customerGroupId").append("=").append(getCustomerGroupId()).append(" ");
/*     */     }
/* 169 */     if (getDiscountCode() != null) {
/* 170 */       buf.append("discountCode").append("=").append(getDiscountCode()).append(" ");
/*     */     }
...
/* 207 */     DiscountGroupMappingPropertyId id = new DiscountGroupMappingPropertyId();
/* 208 */     id.setCustomerGroupId(getCustomerGroupId());
/* 209 */     id.setDiscountCode(getDiscountCode());
...
/* 216 */     setCustomerGroupId(((DiscountGroupMappingPropertyId)argObjectId).getCustomerGroupId());
/* 217 */     setDiscountCode(((DiscountGroupMappingPropertyId)argObjectId).getDiscountCode());
/* 218 */     setOrganizationId(((DiscountGroupMappingPropertyId)argObjectId).getOrganizationId());
/* 219 */     setPropertyCode(((DiscountGroupMappingPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DiscountGroupMappingProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._customerGroupId != null) values.put("CustomerGroupId", DaoUtils.getXmlSafeFieldValue(12, this._customerGroupId)); 
/* 238 */     if (this._discountCode != null) values.put("DiscountCode", DaoUtils.getXmlSafeFieldValue(12, this._discountCode)); 
...
/* 264 */             setCustomerGroupId((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setCustomerGroupId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "DiscountCode":
...
/* 273 */             setDiscountCode((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setDiscountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountGroupMappingPropertyDAO.class
