...
/*     */ 
/*     */ 
/*     */ public class TenderExchangeRatePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITenderExchangeRateProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TenderExchangeRatePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TenderExchangeRatePropertyDAO getDAO_() {
/*  44 */     return (TenderExchangeRatePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITenderExchangeRateProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getBaseCurrency();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setBaseCurrency_noev(argBaseCurrency) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ITenderExchangeRateProperty.SET_BASECURRENCY, argBaseCurrency);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getBaseCurrency() == null && argBaseCurrency != null) || (
/* 112 */       getDAO_().getBaseCurrency() != null && !getDAO_().getBaseCurrency().equals(argBaseCurrency))) {
/* 113 */       getDAO_().setBaseCurrency(argBaseCurrency);
...
/* 125 */     return getDAO_().getTargetCurrency();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setTargetCurrency_noev(argTargetCurrency) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(ITenderExchangeRateProperty.SET_TARGETCURRENCY, argTargetCurrency);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getTargetCurrency() == null && argTargetCurrency != null) || (
/* 146 */       getDAO_().getTargetCurrency() != null && !getDAO_().getTargetCurrency().equals(argTargetCurrency))) {
/* 147 */       getDAO_().setTargetCurrency(argTargetCurrency);
...
/* 170 */       this._events.post(ITenderExchangeRateProperty.SET_LEVELCODE, argLevelCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(ITenderExchangeRateProperty.SET_LEVELVALUE, argLevelValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(ITenderExchangeRateProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(ITenderExchangeRateProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(ITenderExchangeRateProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(ITenderExchangeRateProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(ITenderExchangeRateProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(ITenderExchangeRateProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(ITenderExchangeRateProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(ITenderExchangeRateProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 510 */       this._events.post(ITenderExchangeRateProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 531 */     if ("TenderExchangeRatePropertyExtension".equals(argFieldId)) {
...
/* 541 */     if ("TenderExchangeRatePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\impl\TenderExchangeRatePropertyModel.class
