...
/*     */ 
/*     */ 
/*     */ public class InventoryBucketPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1217736251L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryBucketPropertyDAO.class);
/*     */   
...
/*     */     }
/* 172 */     if (getBucketId() != null) {
/* 173 */       buf.append("bucketId").append("=").append(getBucketId()).append(" ");
/*     */     }
...
/* 207 */     InventoryBucketPropertyId id = new InventoryBucketPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setBucketId(getBucketId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((InventoryBucketPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((InventoryBucketPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setBucketId(((InventoryBucketPropertyId)argObjectId).getBucketId());
/* 219 */     setPropertyCode(((InventoryBucketPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"InventoryBucketProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._bucketId != null) values.put("BucketId", DaoUtils.getXmlSafeFieldValue(12, this._bucketId)); 
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryBucketPropertyDAO.class
