...
/*     */   
/*     */   public TenderPropertyId() {}
/*     */   
/*     */   public TenderPropertyId(String argObjectIdValue) {
...
/*  30 */     return this._tenderId;
/*     */   }
/*     */   
/*     */   public void setTenderId(String argTenderId) {
/*  34 */     this._tenderId = (argTenderId != null && MANAGE_CASE) ? argTenderId.toUpperCase() : argTenderId;
/*     */   }
/*     */   
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof TenderPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     TenderPropertyId other = (TenderPropertyId)ob;
/*  86 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  89 */       .equals(other._organizationId))) && ((this._tenderId == null && other._tenderId == null) || (this._tenderId != null && this._tenderId
/*     */ 
/*     */       
/*  92 */       .equals(other._tenderId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 102 */       .hashCode()) + ((this._tenderId == null) ? 0 : this._tenderId
...
/* 118 */       .append("::").append(this._tenderId)
/* 119 */       .append("::").append(this._propertyCode)
/* 120 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 124 */     if (this._tenderId == null) {
/* 125 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\TenderPropertyId.class
