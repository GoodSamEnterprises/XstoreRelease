...
/*     */ 
/*     */ 
/*     */ public class AirportPropertyId
...
/*     */   
/*     */   public AirportPropertyId() {}
/*     */   
/*     */   public AirportPropertyId(String argObjectIdValue) {
...
/*  30 */     return this._airportCode;
/*     */   }
/*     */   
/*     */   public void setAirportCode(String argAirportCode) {
/*  34 */     this._airportCode = (argAirportCode != null && MANAGE_CASE) ? argAirportCode.toUpperCase() : argAirportCode;
/*     */   }
/*     */   
...
/*  58 */         setAirportCode((String)null);
/*     */       } else {
/*     */         
/*  61 */         setAirportCode(str);
/*     */       } 
/*  63 */       str = tokens[2];
/*     */       
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof AirportPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     AirportPropertyId other = (AirportPropertyId)ob;
/*  86 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  89 */       .equals(other._organizationId))) && ((this._airportCode == null && other._airportCode == null) || (this._airportCode != null && this._airportCode
/*     */ 
/*     */       
/*  92 */       .equals(other._airportCode))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 102 */       .hashCode()) + ((this._airportCode == null) ? 0 : this._airportCode
...
/* 118 */       .append("::").append(this._airportCode)
/* 119 */       .append("::").append(this._propertyCode)
/* 120 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 124 */     if (this._airportCode == null) {
/* 125 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\AirportPropertyId.class
