...
/*     */ 
/*     */ 
/*     */ public class SessionPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1409451627L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SessionPropertyDAO.class);
/*     */   
...
/*  59 */     return this._sessionId;
/*     */   }
/*     */   
/*     */   public void setSessionId(Long argSessionId) {
/*  63 */     if (changed(argSessionId, this._sessionId, "sessionId")) {
/*  64 */       this._sessionId = argSessionId;
/*     */     }
/*     */   }
/*     */   
...
/* 173 */       buf.append("sessionId").append("=").append(getSessionId()).append(" ");
/*     */     }
...
/* 207 */     SessionPropertyId id = new SessionPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setSessionId(getSessionId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((SessionPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((SessionPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setSessionId(((SessionPropertyId)argObjectId).getSessionId());
/* 219 */     setPropertyCode(((SessionPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"SessionProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._sessionId != null) values.put("SessionId", DaoUtils.getXmlSafeFieldValue(-5, this._sessionId)); 
...
/* 282 */             setSessionId((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setSessionId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\SessionPropertyDAO.class
