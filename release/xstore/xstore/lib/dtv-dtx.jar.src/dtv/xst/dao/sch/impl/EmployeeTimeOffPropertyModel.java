...
/*     */ 
/*     */ 
/*     */ public class EmployeeTimeOffPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IEmployeeTimeOffProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new EmployeeTimeOffPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private EmployeeTimeOffPropertyDAO getDAO_() {
/*  44 */     return (EmployeeTimeOffPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IEmployeeTimeOffProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IEmployeeTimeOffProperty.SET_EMPLOYEEID, argEmployeeId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     if (getDAO_().getTimeOffSeq() != null) {
/* 126 */       return getDAO_().getTimeOffSeq().longValue();
/*     */     }
/*     */     
/* 129 */     return 0L;
/*     */   }
...
/* 138 */     if (setTimeOffSeq_noev(argTimeOffSeq) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IEmployeeTimeOffProperty.SET_TIMEOFFSEQ, Long.valueOf(argTimeOffSeq));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getTimeOffSeq() == null && Long.valueOf(argTimeOffSeq) != null) || (
/* 151 */       getDAO_().getTimeOffSeq() != null && !getDAO_().getTimeOffSeq().equals(Long.valueOf(argTimeOffSeq)))) {
/* 152 */       getDAO_().setTimeOffSeq(Long.valueOf(argTimeOffSeq));
...
/* 175 */       this._events.post(IEmployeeTimeOffProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(IEmployeeTimeOffProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IEmployeeTimeOffProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IEmployeeTimeOffProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IEmployeeTimeOffProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IEmployeeTimeOffProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IEmployeeTimeOffProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IEmployeeTimeOffProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IEmployeeTimeOffProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 468 */     if ("EmployeeTimeOffPropertyExtension".equals(argFieldId)) {
...
/* 478 */     if ("EmployeeTimeOffPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sch\impl\EmployeeTimeOffPropertyModel.class
