...
/*     */ 
/*     */ 
/*     */ public class TaxRateRulePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITaxRateRuleProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TaxRateRulePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TaxRateRulePropertyDAO getDAO_() {
/*  44 */     return (TaxRateRulePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITaxRateRuleProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getTaxGroupId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setTaxGroupId_noev(argTaxGroupId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ITaxRateRuleProperty.SET_TAXGROUPID, argTaxGroupId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getTaxGroupId() == null && argTaxGroupId != null) || (
/* 112 */       getDAO_().getTaxGroupId() != null && !getDAO_().getTaxGroupId().equals(argTaxGroupId))) {
/* 113 */       getDAO_().setTaxGroupId(argTaxGroupId);
...
/* 125 */     return getDAO_().getTaxLocationId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setTaxLocationId_noev(argTaxLocationId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(ITaxRateRuleProperty.SET_TAXLOCATIONID, argTaxLocationId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getTaxLocationId() == null && argTaxLocationId != null) || (
/* 146 */       getDAO_().getTaxLocationId() != null && !getDAO_().getTaxLocationId().equals(argTaxLocationId))) {
/* 147 */       getDAO_().setTaxLocationId(argTaxLocationId);
...
/* 159 */     if (getDAO_().getTaxRateRuleSequence() != null) {
/* 160 */       return getDAO_().getTaxRateRuleSequence().intValue();
/*     */     }
/*     */     
/* 163 */     return 0;
/*     */   }
...
/* 172 */     if (setTaxRateRuleSequence_noev(argTaxRateRuleSequence) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(ITaxRateRuleProperty.SET_TAXRATERULESEQUENCE, Integer.valueOf(argTaxRateRuleSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getTaxRateRuleSequence() == null && Integer.valueOf(argTaxRateRuleSequence) != null) || (
/* 185 */       getDAO_().getTaxRateRuleSequence() != null && !getDAO_().getTaxRateRuleSequence().equals(Integer.valueOf(argTaxRateRuleSequence)))) {
/* 186 */       getDAO_().setTaxRateRuleSequence(Integer.valueOf(argTaxRateRuleSequence));
...
/* 198 */     if (getDAO_().getTaxRuleSequence() != null) {
/* 199 */       return getDAO_().getTaxRuleSequence().intValue();
/*     */     }
/*     */     
/* 202 */     return 0;
/*     */   }
...
/* 211 */     if (setTaxRuleSequence_noev(argTaxRuleSequence) && 
/* 212 */       this._events != null && 
/* 213 */       postEventsForChanges()) {
/* 214 */       this._events.post(ITaxRateRuleProperty.SET_TAXRULESEQUENCE, Integer.valueOf(argTaxRuleSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 223 */     if ((getDAO_().getTaxRuleSequence() == null && Integer.valueOf(argTaxRuleSequence) != null) || (
/* 224 */       getDAO_().getTaxRuleSequence() != null && !getDAO_().getTaxRuleSequence().equals(Integer.valueOf(argTaxRuleSequence)))) {
/* 225 */       getDAO_().setTaxRuleSequence(Integer.valueOf(argTaxRuleSequence));
...
/* 248 */       this._events.post(ITaxRateRuleProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(ITaxRateRuleProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(ITaxRateRuleProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(ITaxRateRuleProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(ITaxRateRuleProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(ITaxRateRuleProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(ITaxRateRuleProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(ITaxRateRuleProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 520 */       this._events.post(ITaxRateRuleProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 541 */     if ("TaxRateRulePropertyExtension".equals(argFieldId)) {
...
/* 551 */     if ("TaxRateRulePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxRateRulePropertyModel.class
