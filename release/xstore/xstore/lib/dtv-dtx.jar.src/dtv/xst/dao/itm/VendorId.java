...
/*     */   public VendorId() {}
/*     */   
/*     */   public VendorId(String argObjectIdValue) {
...
/*  29 */     return this._vendorId;
/*     */   }
/*     */   
/*     */   public void setVendorId(String argVendorId) {
/*  33 */     this._vendorId = (argVendorId != null && MANAGE_CASE) ? argVendorId.toUpperCase() : argVendorId;
/*     */   }
/*     */   
...
/*  63 */       return true;
/*     */     }
/*  65 */     if (!(ob instanceof VendorId)) {
/*  66 */       return false;
/*     */     }
/*  68 */     VendorId other = (VendorId)ob;
/*  69 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  72 */       .equals(other._organizationId))) && ((this._vendorId == null && other._vendorId == null) || (this._vendorId != null && this._vendorId
/*     */ 
/*     */       
/*  75 */       .equals(other._vendorId))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  82 */       .hashCode()) + ((this._vendorId == null) ? 0 : this._vendorId
/*  83 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
...
/*  97 */       .append("::").append(this._vendorId)
/*  98 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 102 */     if (this._vendorId == null) {
/* 103 */       return false;
/*     */     }
/* 105 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\VendorId.class
