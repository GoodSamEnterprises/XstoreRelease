...
/*     */ 
/*     */ 
/*     */ public class DeviceRegistrationPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM ctl_device_registration_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM ctl_device_registration_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO ctl_device_registration_p(organization_id, rtl_loc_id, wkstn_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._workstationId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE ctl_device_registration_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM ctl_device_registration_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._retailLocationId, this._workstationId, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "ctl_device_registration_p";
/*     */   }
/*     */   
...
/* 116 */     return new DeviceRegistrationPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class DeviceRegistrationPropertyFiller
/*     */     implements IFiller {
/*     */     private DeviceRegistrationPropertyDBA _parent;
/*     */     
/*     */     public DeviceRegistrationPropertyFiller(DeviceRegistrationPropertyDBA argParent) {
...
/* 147 */         this._parent._workstationId = Long.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 189 */     DeviceRegistrationPropertyDAO dao = (DeviceRegistrationPropertyDAO)argDAO;
/* 190 */     dao.setOrganizationId(this._organizationId);
/* 191 */     dao.setRetailLocationId(this._retailLocationId);
/* 192 */     dao.setWorkstationId(this._workstationId);
...
/* 207 */     return loadDAO((IDataAccessObject)new DeviceRegistrationPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 211 */     DeviceRegistrationPropertyDAO dao = (DeviceRegistrationPropertyDAO)argDAO;
/* 212 */     this._organizationId = dao.getOrganizationId();
/* 213 */     this._retailLocationId = dao.getRetailLocationId();
/* 214 */     this._workstationId = dao.getWorkstationId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\DeviceRegistrationPropertyDBA.class
