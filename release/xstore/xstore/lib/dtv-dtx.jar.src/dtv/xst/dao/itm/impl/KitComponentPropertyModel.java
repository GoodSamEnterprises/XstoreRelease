...
/*     */ 
/*     */ 
/*     */ public class KitComponentPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IKitComponentProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new KitComponentPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private KitComponentPropertyDAO getDAO_() {
/*  44 */     return (KitComponentPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IKitComponentProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getKitItemId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setKitItemId_noev(argKitItemId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IKitComponentProperty.SET_KITITEMID, argKitItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getKitItemId() == null && argKitItemId != null) || (
/* 112 */       getDAO_().getKitItemId() != null && !getDAO_().getKitItemId().equals(argKitItemId))) {
/* 113 */       getDAO_().setKitItemId(argKitItemId);
...
/* 125 */     return getDAO_().getComponentItemId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setComponentItemId_noev(argComponentItemId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IKitComponentProperty.SET_COMPONENTITEMID, argComponentItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getComponentItemId() == null && argComponentItemId != null) || (
/* 146 */       getDAO_().getComponentItemId() != null && !getDAO_().getComponentItemId().equals(argComponentItemId))) {
/* 147 */       getDAO_().setComponentItemId(argComponentItemId);
...
/* 159 */     if (getDAO_().getSequenceNumber() != null) {
/* 160 */       return getDAO_().getSequenceNumber().longValue();
/*     */     }
/*     */     
/* 163 */     return 0L;
/*     */   }
...
/* 172 */     if (setSequenceNumber_noev(argSequenceNumber) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IKitComponentProperty.SET_SEQUENCENUMBER, Long.valueOf(argSequenceNumber));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getSequenceNumber() == null && Long.valueOf(argSequenceNumber) != null) || (
/* 185 */       getDAO_().getSequenceNumber() != null && !getDAO_().getSequenceNumber().equals(Long.valueOf(argSequenceNumber)))) {
/* 186 */       getDAO_().setSequenceNumber(Long.valueOf(argSequenceNumber));
...
/* 209 */       this._events.post(IKitComponentProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IKitComponentProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IKitComponentProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IKitComponentProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IKitComponentProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IKitComponentProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IKitComponentProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IKitComponentProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(IKitComponentProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 502 */     if ("KitComponentPropertyExtension".equals(argFieldId)) {
...
/* 512 */     if ("KitComponentPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\KitComponentPropertyModel.class
