...
/*     */ 
/*     */ 
/*     */ public class DealPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1362794879L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DealPropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getDealId() != null) {
/* 159 */       buf.append("dealId").append("=").append(getDealId()).append(" ");
/*     */     }
...
/* 193 */     DealPropertyId id = new DealPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setDealId(getDealId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((DealPropertyId)argObjectId).getOrganizationId());
/* 202 */     setDealId(((DealPropertyId)argObjectId).getDealId());
/* 203 */     setPropertyCode(((DealPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"DealProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._dealId != null) values.put("DealId", DaoUtils.getXmlSafeFieldValue(12, this._dealId)); 
...
/* 256 */             setDealId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setDealId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealPropertyDAO.class
