...
/*     */ 
/*     */ 
/*     */ public class MovementPendingTransactionLineItemId
...
/*     */   
/*     */   public MovementPendingTransactionLineItemId() {}
/*     */   
/*     */   public MovementPendingTransactionLineItemId(String argObjectIdValue) {
...
/*  68 */     return this._lineItemSequence;
/*     */   }
/*     */   
/*     */   public void setLineItemSequence(Integer argLineItemSequence) {
/*  72 */     this._lineItemSequence = argLineItemSequence;
/*     */   }
/*     */   
...
/* 103 */       str = tokens[5];
/*     */       
/* 105 */       setLineItemSequence(Integer.valueOf(str));
/*     */     }
...
/* 115 */       return true;
/*     */     }
/* 117 */     if (!(ob instanceof MovementPendingTransactionLineItemId)) {
/* 118 */       return false;
/*     */     }
/* 120 */     MovementPendingTransactionLineItemId other = (MovementPendingTransactionLineItemId)ob;
...
/*     */ 
/*     */       
/* 136 */       .equals(other._transactionSequence))) && ((this._lineItemSequence == null && other._lineItemSequence == null) || (this._lineItemSequence != null && this._lineItemSequence
/*     */ 
/*     */       
/* 139 */       .equals(other._lineItemSequence))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 150 */       .hashCode()) + ((this._lineItemSequence == null) ? 0 : this._lineItemSequence
/* 151 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getDtxTypeName() {
/* 156 */     return "MovementPendingTransactionLineItem";
/*     */   }
/*     */ 
/*     */   
...
/* 169 */       .append("::").append(String.valueOf(this._lineItemSequence))
/* 170 */       .toString();
/*     */   }
/*     */   
...
/* 184 */       return false;
/*     */     }
/* 186 */     if (this._lineItemSequence == null) {
/* 187 */       return false;
/*     */     }
/* 189 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\MovementPendingTransactionLineItemId.class
