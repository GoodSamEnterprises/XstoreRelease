...
/*     */ 
/*     */ 
/*     */ public class DiscountItemInclusionsPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -403671808L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DiscountItemInclusionsPropertyDAO.class);
/*     */   
...
/* 207 */     DiscountItemInclusionsPropertyId id = new DiscountItemInclusionsPropertyId();
...
/* 216 */     setDiscountCode(((DiscountItemInclusionsPropertyId)argObjectId).getDiscountCode());
/* 217 */     setItemId(((DiscountItemInclusionsPropertyId)argObjectId).getItemId());
/* 218 */     setOrganizationId(((DiscountItemInclusionsPropertyId)argObjectId).getOrganizationId());
/* 219 */     setPropertyCode(((DiscountItemInclusionsPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DiscountItemInclusionsProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountItemInclusionsPropertyDAO.class
