...
/*     */ 
/*     */ 
/*     */ public class TaxTaxGroupMappingPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1947432068L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxTaxGroupMappingPropertyDAO.class);
/*     */   
...
/*  50 */     return this._customerGroup;
/*     */   }
/*     */   
/*     */   public void setCustomerGroup(String argCustomerGroup) {
/*  54 */     if (changed(argCustomerGroup, this._customerGroup, "customerGroup")) {
/*  55 */       this._customerGroup = (argCustomerGroup != null && MANAGE_CASE) ? argCustomerGroup.toUpperCase() : argCustomerGroup;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getTaxGroupId() {
/*  60 */     return this._taxGroupId;
/*     */   }
/*     */   
/*     */   public void setTaxGroupId(String argTaxGroupId) {
/*  64 */     if (changed(argTaxGroupId, this._taxGroupId, "taxGroupId")) {
/*  65 */       this._taxGroupId = (argTaxGroupId != null && MANAGE_CASE) ? argTaxGroupId.toUpperCase() : argTaxGroupId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getRtlLocId() {
/*  70 */     return this._rtlLocId;
/*     */   }
/*     */   
/*     */   public void setRtlLocId(Integer argRtlLocId) {
/*  74 */     if (changed(argRtlLocId, this._rtlLocId, "rtlLocId")) {
/*  75 */       this._rtlLocId = argRtlLocId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getCustomerGroup() != null) {
/* 181 */       buf.append("customerGroup").append("=").append(getCustomerGroup()).append(" ");
/*     */     }
/* 183 */     if (getTaxGroupId() != null) {
/* 184 */       buf.append("taxGroupId").append("=").append(getTaxGroupId()).append(" ");
/*     */     }
/* 186 */     if (getRtlLocId() != null) {
/* 187 */       buf.append("rtlLocId").append("=").append(getRtlLocId()).append(" ");
/*     */     }
...
/* 221 */     TaxTaxGroupMappingPropertyId id = new TaxTaxGroupMappingPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setCustomerGroup(getCustomerGroup());
/* 224 */     id.setTaxGroupId(getTaxGroupId());
/* 225 */     id.setRtlLocId(getRtlLocId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((TaxTaxGroupMappingPropertyId)argObjectId).getOrganizationId());
/* 232 */     setCustomerGroup(((TaxTaxGroupMappingPropertyId)argObjectId).getCustomerGroup());
/* 233 */     setTaxGroupId(((TaxTaxGroupMappingPropertyId)argObjectId).getTaxGroupId());
/* 234 */     setRtlLocId(((TaxTaxGroupMappingPropertyId)argObjectId).getRtlLocId());
/* 235 */     setPropertyCode(((TaxTaxGroupMappingPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"TaxTaxGroupMappingProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._customerGroup != null) values.put("CustomerGroup", DaoUtils.getXmlSafeFieldValue(12, this._customerGroup)); 
/* 255 */     if (this._taxGroupId != null) values.put("TaxGroupId", DaoUtils.getXmlSafeFieldValue(12, this._taxGroupId)); 
/* 256 */     if (this._rtlLocId != null) values.put("RtlLocId", DaoUtils.getXmlSafeFieldValue(4, this._rtlLocId)); 
...
/* 290 */             setCustomerGroup((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setCustomerGroup() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "TaxGroupId":
...
/* 299 */             setTaxGroupId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setTaxGroupId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "RtlLocId":
...
/* 308 */             setRtlLocId((Integer)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setRtlLocId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxTaxGroupMappingPropertyDAO.class
