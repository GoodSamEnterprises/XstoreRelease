...
/*     */ 
/*     */ 
/*     */ public class CategoryServiceLocationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1643466111L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CategoryServiceLocationPropertyDAO.class);
/*     */   
...
/*     */     }
/* 169 */     if (getServiceLocationId() != null) {
/* 170 */       buf.append("serviceLocationId").append("=").append(getServiceLocationId()).append(" ");
/*     */     }
/* 172 */     if (getCategoryId() != null) {
/* 173 */       buf.append("categoryId").append("=").append(getCategoryId()).append(" ");
/*     */     }
...
/* 207 */     CategoryServiceLocationPropertyId id = new CategoryServiceLocationPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setServiceLocationId(getServiceLocationId());
/* 210 */     id.setCategoryId(getCategoryId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((CategoryServiceLocationPropertyId)argObjectId).getOrganizationId());
/* 217 */     setServiceLocationId(((CategoryServiceLocationPropertyId)argObjectId).getServiceLocationId());
/* 218 */     setCategoryId(((CategoryServiceLocationPropertyId)argObjectId).getCategoryId());
/* 219 */     setPropertyCode(((CategoryServiceLocationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CategoryServiceLocationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._serviceLocationId != null) values.put("ServiceLocationId", DaoUtils.getXmlSafeFieldValue(12, this._serviceLocationId)); 
/* 239 */     if (this._categoryId != null) values.put("CategoryId", DaoUtils.getXmlSafeFieldValue(12, this._categoryId)); 
...
/* 273 */             setServiceLocationId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setServiceLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CategoryId":
...
/* 282 */             setCategoryId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setCategoryId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\CategoryServiceLocationPropertyDAO.class
