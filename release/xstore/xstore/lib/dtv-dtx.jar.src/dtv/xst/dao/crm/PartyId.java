...
/*     */   public PartyId() {}
/*     */   
/*     */   public PartyId(String argObjectIdValue) {
...
/*  29 */     return this._partyId;
/*     */   }
/*     */   
/*     */   public void setPartyId(Long argPartyId) {
/*  33 */     this._partyId = argPartyId;
/*     */   }
/*     */   
...
/*  46 */       str = tokens[1];
/*     */       
/*  48 */       setPartyId(Long.valueOf(str));
/*     */     }
...
/*  58 */       return true;
/*     */     }
/*  60 */     if (!(ob instanceof PartyId)) {
/*  61 */       return false;
/*     */     }
/*  63 */     PartyId other = (PartyId)ob;
/*  64 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  67 */       .equals(other._organizationId))) && ((this._partyId == null && other._partyId == null) || (this._partyId != null && this._partyId
/*     */ 
/*     */       
/*  70 */       .equals(other._partyId))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  77 */       .hashCode()) + ((this._partyId == null) ? 0 : this._partyId
/*  78 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
...
/*  92 */       .append("::").append(String.valueOf(this._partyId))
/*  93 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/*  97 */     if (this._partyId == null) {
/*  98 */       return false;
/*     */     }
/* 100 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\PartyId.class
