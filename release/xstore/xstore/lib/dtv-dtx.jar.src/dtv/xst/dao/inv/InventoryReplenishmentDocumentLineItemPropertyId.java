...
/*     */ 
/*     */ 
/*     */ public class InventoryReplenishmentDocumentLineItemPropertyId
...
/*     */   
/*     */   public InventoryReplenishmentDocumentLineItemPropertyId() {}
/*     */   
/*     */   public InventoryReplenishmentDocumentLineItemPropertyId(String argObjectIdValue) {
...
/* 121 */       return true;
/*     */     }
/* 123 */     if (!(ob instanceof InventoryReplenishmentDocumentLineItemPropertyId)) {
/* 124 */       return false;
/*     */     }
/* 126 */     InventoryReplenishmentDocumentLineItemPropertyId other = (InventoryReplenishmentDocumentLineItemPropertyId)ob;
/* 127 */     return (((this._documentId == null && other._documentId == null) || (this._documentId != null && this._documentId
/*     */ 
/*     */       
/* 130 */       .equals(other._documentId))) && ((this._documentTypeCode == null && other._documentTypeCode == null) || (this._documentTypeCode != null && this._documentTypeCode
/*     */ 
/*     */       
/* 133 */       .equals(other._documentTypeCode))) && ((this._inventoryDocumentLineNumber == null && other._inventoryDocumentLineNumber == null) || (this._inventoryDocumentLineNumber != null && this._inventoryDocumentLineNumber
/*     */ 
/*     */       
/* 136 */       .equals(other._inventoryDocumentLineNumber))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/*     */   
/*     */   public int hashCode() {
/* 151 */     return ((this._documentId == null) ? 0 : this._documentId
/* 152 */       .hashCode()) + ((this._documentTypeCode == null) ? 0 : this._documentTypeCode
/* 153 */       .hashCode()) + ((this._inventoryDocumentLineNumber == null) ? 0 : this._inventoryDocumentLineNumber
/* 154 */       .hashCode()) + ((this._organizationId == null) ? 0 : this._organizationId
...
/* 162 */     return "InventoryReplenishmentDocumentLineItemProperty";
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 169 */     return buff.append(this._documentId)
/*     */       
/* 171 */       .append("::").append(this._documentTypeCode)
/* 172 */       .append("::").append(String.valueOf(this._inventoryDocumentLineNumber))
/* 173 */       .append("::").append(String.valueOf(this._organizationId))
...
/* 181 */       return false;
/*     */     }
/* 183 */     if (this._documentTypeCode == null) {
/* 184 */       return false;
/*     */     }
/* 186 */     if (this._inventoryDocumentLineNumber == null) {
/* 187 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\InventoryReplenishmentDocumentLineItemPropertyId.class
