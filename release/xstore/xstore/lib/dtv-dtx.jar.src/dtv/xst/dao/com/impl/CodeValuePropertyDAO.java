...
/*     */ 
/*     */ 
/*     */ public class CodeValuePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -386769575L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CodeValuePropertyDAO.class);
/*     */   
...
/*  49 */     return this._category;
/*     */   }
/*     */   
/*     */   public void setCategory(String argCategory) {
/*  53 */     if (changed(argCategory, this._category, "category")) {
/*  54 */       this._category = (argCategory != null && MANAGE_CASE) ? argCategory.toUpperCase() : argCategory;
/*     */     }
/*     */   }
/*     */   
...
/*  63 */     if (changed(argCode, this._code, "code")) {
/*  64 */       this._code = (argCode != null && MANAGE_CASE) ? argCode.toUpperCase() : argCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getCategory() != null) {
/* 170 */       buf.append("category").append("=").append(getCategory()).append(" ");
/*     */     }
/* 172 */     if (getCode() != null) {
/* 173 */       buf.append("code").append("=").append(getCode()).append(" ");
/*     */     }
...
/* 207 */     CodeValuePropertyId id = new CodeValuePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setCategory(getCategory());
/* 210 */     id.setCode(getCode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((CodeValuePropertyId)argObjectId).getOrganizationId());
/* 217 */     setCategory(((CodeValuePropertyId)argObjectId).getCategory());
/* 218 */     setCode(((CodeValuePropertyId)argObjectId).getCode());
/* 219 */     setPropertyCode(((CodeValuePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CodeValueProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._category != null) values.put("Category", DaoUtils.getXmlSafeFieldValue(12, this._category)); 
/* 239 */     if (this._code != null) values.put("Code", DaoUtils.getXmlSafeFieldValue(12, this._code)); 
...
/* 273 */             setCategory((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setCategory() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "Code":
...
/* 282 */             setCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\CodeValuePropertyDAO.class
