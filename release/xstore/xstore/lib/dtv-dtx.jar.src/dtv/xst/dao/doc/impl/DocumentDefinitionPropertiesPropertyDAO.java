...
/*     */ 
/*     */ 
/*     */ public class DocumentDefinitionPropertiesPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 688964022L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DocumentDefinitionPropertiesPropertyDAO.class);
/*     */   
...
/*  44 */     if (changed(argSeriesId, this._seriesId, "seriesId")) {
/*  45 */       this._seriesId = (argSeriesId != null && MANAGE_CASE) ? argSeriesId.toUpperCase() : argSeriesId;
/*     */     }
/*     */   }
/*     */   
...
/*  74 */     if (changed(argSequence, this._sequence, "sequence")) {
/*  75 */       this._sequence = argSequence;
/*     */     }
/*     */   }
/*     */   
...
/* 177 */     if (getSeriesId() != null) {
/* 178 */       buf.append("seriesId").append("=").append(getSeriesId()).append(" ");
/*     */     }
...
/*     */     }
/* 186 */     if (getSequence() != null) {
/* 187 */       buf.append("sequence").append("=").append(getSequence()).append(" ");
/*     */     }
...
/* 221 */     DocumentDefinitionPropertiesPropertyId id = new DocumentDefinitionPropertiesPropertyId();
/* 222 */     id.setSeriesId(getSeriesId());
/* 223 */     id.setOrganizationId(getOrganizationId());
/* 224 */     id.setDocumentType(getDocumentType());
/* 225 */     id.setSequence(getSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setSeriesId(((DocumentDefinitionPropertiesPropertyId)argObjectId).getSeriesId());
/* 232 */     setOrganizationId(((DocumentDefinitionPropertiesPropertyId)argObjectId).getOrganizationId());
/* 233 */     setDocumentType(((DocumentDefinitionPropertiesPropertyId)argObjectId).getDocumentType());
/* 234 */     setSequence(((DocumentDefinitionPropertiesPropertyId)argObjectId).getSequence());
/* 235 */     setPropertyCode(((DocumentDefinitionPropertiesPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"DocumentDefinitionPropertiesProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 253 */     if (this._seriesId != null) values.put("SeriesId", DaoUtils.getXmlSafeFieldValue(12, this._seriesId)); 
...
/* 256 */     if (this._sequence != null) values.put("Sequence", DaoUtils.getXmlSafeFieldValue(-5, this._sequence)); 
...
/* 281 */             setSeriesId((String)value);
/* 282 */           } catch (Exception ee) {
/* 283 */             throw new DtxException("An exception occurred while calling setSeriesId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 308 */             setSequence((Long)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\doc\impl\DocumentDefinitionPropertiesPropertyDAO.class
