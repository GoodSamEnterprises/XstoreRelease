...
/*     */ 
/*     */ 
/*     */ public class AclAccessTypePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IAclAccessTypeProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new AclAccessTypePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private AclAccessTypePropertyDAO getDAO_() {
/*  44 */     return (AclAccessTypePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  52 */     return getDAO_().getAccessTypeCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     if (setAccessTypeCode_noev(argAccessTypeCode) && 
/*  61 */       this._events != null && 
/*  62 */       postEventsForChanges()) {
/*  63 */       this._events.post(IAclAccessTypeProperty.SET_ACCESSTYPECODE, argAccessTypeCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*  72 */     if ((getDAO_().getAccessTypeCode() == null && argAccessTypeCode != null) || (
/*  73 */       getDAO_().getAccessTypeCode() != null && !getDAO_().getAccessTypeCode().equals(argAccessTypeCode))) {
/*  74 */       getDAO_().setAccessTypeCode(argAccessTypeCode);
/*  75 */       ev_postable = true;
/*     */     } 
/*     */     
...
/* 102 */       this._events.post(IAclAccessTypeProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getSecuredObjectId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setSecuredObjectId_noev(argSecuredObjectId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IAclAccessTypeProperty.SET_SECUREDOBJECTID, argSecuredObjectId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getSecuredObjectId() == null && argSecuredObjectId != null) || (
/* 146 */       getDAO_().getSecuredObjectId() != null && !getDAO_().getSecuredObjectId().equals(argSecuredObjectId))) {
/* 147 */       getDAO_().setSecuredObjectId(argSecuredObjectId);
...
/* 170 */       this._events.post(IAclAccessTypeProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IAclAccessTypeProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IAclAccessTypeProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IAclAccessTypeProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IAclAccessTypeProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IAclAccessTypeProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IAclAccessTypeProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IAclAccessTypeProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IAclAccessTypeProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("AclAccessTypePropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("AclAccessTypePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\AclAccessTypePropertyModel.class
