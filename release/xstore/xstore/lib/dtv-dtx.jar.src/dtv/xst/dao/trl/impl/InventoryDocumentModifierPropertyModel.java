...
/*     */ 
/*     */ 
/*     */ public class InventoryDocumentModifierPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IInventoryDocumentModifierProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new InventoryDocumentModifierPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private InventoryDocumentModifierPropertyDAO getDAO_() {
/*  44 */     return (InventoryDocumentModifierPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(IInventoryDocumentModifierProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  86 */     if (getDAO_().getDocumentModifierSequence() != null) {
/*  87 */       return getDAO_().getDocumentModifierSequence().intValue();
/*     */     }
/*     */     
/*  90 */     return 0;
/*     */   }
...
/*  99 */     if (setDocumentModifierSequence_noev(argDocumentModifierSequence) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IInventoryDocumentModifierProperty.SET_DOCUMENTMODIFIERSEQUENCE, Integer.valueOf(argDocumentModifierSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getDocumentModifierSequence() == null && Integer.valueOf(argDocumentModifierSequence) != null) || (
/* 112 */       getDAO_().getDocumentModifierSequence() != null && !getDAO_().getDocumentModifierSequence().equals(Integer.valueOf(argDocumentModifierSequence)))) {
/* 113 */       getDAO_().setDocumentModifierSequence(Integer.valueOf(argDocumentModifierSequence));
...
/* 141 */       this._events.post(IInventoryDocumentModifierProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(IInventoryDocumentModifierProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(IInventoryDocumentModifierProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(IInventoryDocumentModifierProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 292 */       this._events.post(IInventoryDocumentModifierProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 326 */       this._events.post(IInventoryDocumentModifierProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 360 */       this._events.post(IInventoryDocumentModifierProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 394 */       this._events.post(IInventoryDocumentModifierProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 428 */       this._events.post(IInventoryDocumentModifierProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 462 */       this._events.post(IInventoryDocumentModifierProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 496 */       this._events.post(IInventoryDocumentModifierProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 530 */       this._events.post(IInventoryDocumentModifierProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 564 */       this._events.post(IInventoryDocumentModifierProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 585 */     if ("InventoryDocumentModifierPropertyExtension".equals(argFieldId)) {
...
/* 595 */     if ("InventoryDocumentModifierPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\InventoryDocumentModifierPropertyModel.class
