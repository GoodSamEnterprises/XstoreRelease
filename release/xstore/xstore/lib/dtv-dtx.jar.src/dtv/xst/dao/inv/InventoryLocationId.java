...
/*     */ 
/*     */ 
/*     */ public class InventoryLocationId
...
/*     */   
/*     */   public InventoryLocationId(String argObjectIdValue) {
...
/*  38 */     return this._locationId;
/*     */   }
/*     */   
/*     */   public void setLocationId(String argLocationId) {
/*  42 */     this._locationId = (argLocationId != null && MANAGE_CASE) ? argLocationId.toUpperCase() : argLocationId;
/*     */   }
/*     */   
...
/*  61 */         setLocationId((String)null);
/*     */       } else {
/*     */         
/*  64 */         setLocationId(str);
/*     */       }
/*     */     
...
/*  75 */       return true;
/*     */     }
/*  77 */     if (!(ob instanceof InventoryLocationId)) {
/*  78 */       return false;
/*     */     }
/*  80 */     InventoryLocationId other = (InventoryLocationId)ob;
...
/*     */ 
/*     */       
/*  87 */       .equals(other._retailLocationId))) && ((this._locationId == null && other._locationId == null) || (this._locationId != null && this._locationId
/*     */ 
/*     */       
/*  90 */       .equals(other._locationId))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  98 */       .hashCode()) + ((this._locationId == null) ? 0 : this._locationId
/*  99 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getDtxTypeName() {
/* 104 */     return "InventoryLocation";
/*     */   }
/*     */ 
/*     */   
...
/* 114 */       .append("::").append(this._locationId)
/* 115 */       .toString();
/*     */   }
/*     */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\InventoryLocationId.class
