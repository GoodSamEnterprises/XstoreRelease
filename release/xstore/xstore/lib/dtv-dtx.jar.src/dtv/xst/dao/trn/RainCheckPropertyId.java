...
/*     */ 
/*     */ 
/*     */ public class RainCheckPropertyId
...
/*     */   
/*     */   public RainCheckPropertyId() {}
/*     */   
/*     */   public RainCheckPropertyId(String argObjectIdValue) {
...
/*  30 */     return this._rainCheckId;
/*     */   }
/*     */   
/*     */   public void setRainCheckId(String argRainCheckId) {
/*  34 */     this._rainCheckId = (argRainCheckId != null && MANAGE_CASE) ? argRainCheckId.toUpperCase() : argRainCheckId;
/*     */   }
/*     */   
...
/*  58 */         setRainCheckId((String)null);
/*     */       } else {
/*     */         
/*  61 */         setRainCheckId(str);
/*     */       } 
/*  63 */       str = tokens[2];
/*     */       
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof RainCheckPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     RainCheckPropertyId other = (RainCheckPropertyId)ob;
/*  86 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  89 */       .equals(other._organizationId))) && ((this._rainCheckId == null && other._rainCheckId == null) || (this._rainCheckId != null && this._rainCheckId
/*     */ 
/*     */       
/*  92 */       .equals(other._rainCheckId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 102 */       .hashCode()) + ((this._rainCheckId == null) ? 0 : this._rainCheckId
...
/* 118 */       .append("::").append(this._rainCheckId)
/* 119 */       .append("::").append(this._propertyCode)
/* 120 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 124 */     if (this._rainCheckId == null) {
/* 125 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\RainCheckPropertyId.class
