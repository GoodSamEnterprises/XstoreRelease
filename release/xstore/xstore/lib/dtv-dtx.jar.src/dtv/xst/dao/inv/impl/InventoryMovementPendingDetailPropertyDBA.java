...
/*     */ 
/*     */ 
/*     */ public class InventoryMovementPendingDetailPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.trans_lineitm_seq, t.pending_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_movement_pending_detail_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND business_date = ?  AND wkstn_id = ?  AND trans_seq = ?  AND trans_lineitm_seq = ?  AND pending_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  49 */     return "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.trans_lineitm_seq, t.pending_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_movement_pending_detail_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  55 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND business_date = ?  AND wkstn_id = ?  AND trans_seq = ?  AND trans_lineitm_seq = ?  AND pending_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  58 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO inv_movement_pending_detail_p(organization_id, rtl_loc_id, business_date, wkstn_id, trans_seq, trans_lineitm_seq, pending_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  65 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._businessDate, this._workstationId, this._transactionSequence, this._lineItemSequence, this._pendingSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  66 */     return insertParameterObject;
/*     */   }
/*     */   
/*  69 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, 91, -5, -5, -5, -5, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  72 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  75 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE inv_movement_pending_detail_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  91 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM inv_movement_pending_detail_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND business_date = ?  AND wkstn_id = ?  AND trans_seq = ?  AND trans_lineitm_seq = ?  AND pending_seq = ?  AND property_code = ?  ";
/*     */   
...
/* 100 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND business_date = ?  AND wkstn_id = ?  AND trans_seq = ?  AND trans_lineitm_seq = ?  AND pending_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 103 */     return new Object[] { this._organizationId, this._retailLocationId, this._businessDate, this._workstationId, this._transactionSequence, this._lineItemSequence, this._pendingSequence, this._propertyCode };
/*     */   }
/*     */   
/* 106 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { -5, -5, 91, -5, -5, -5, -5, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 109 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 112 */     return "inv_movement_pending_detail_p";
/*     */   }
/*     */   
...
/* 120 */     return new InventoryMovementPendingDetailPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class InventoryMovementPendingDetailPropertyFiller
/*     */     implements IFiller {
/*     */     private InventoryMovementPendingDetailPropertyDBA _parent;
/*     */     
/*     */     public InventoryMovementPendingDetailPropertyFiller(InventoryMovementPendingDetailPropertyDBA argParent) {
...
/* 176 */         this._parent._lineItemSequence = Long.valueOf(l1);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/* 184 */         this._parent._pendingSequence = Long.valueOf(l1);
/*     */       }
/*     */ 
/*     */       
...
/* 226 */     InventoryMovementPendingDetailPropertyDAO dao = (InventoryMovementPendingDetailPropertyDAO)argDAO;
...
/* 248 */     return loadDAO((IDataAccessObject)new InventoryMovementPendingDetailPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 252 */     InventoryMovementPendingDetailPropertyDAO dao = (InventoryMovementPendingDetailPropertyDAO)argDAO;
...
/* 258 */     this._lineItemSequence = dao.getLineItemSequence();
/* 259 */     this._pendingSequence = dao.getPendingSequence();
...
/* 272 */     InventoryMovementPendingDetailPropertyId id = (InventoryMovementPendingDetailPropertyId)argId;
...
/* 278 */     argStatement.setLong(6, id.getLineItemSequence().longValue());
/* 279 */     argStatement.setLong(7, id.getPendingSequence().longValue());
/* 280 */     argStatement.setString(8, id.getPropertyCode());
/* 281 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 285 */     InventoryMovementPendingDetailPropertyId id = new InventoryMovementPendingDetailPropertyId();
...
/* 289 */     id.setWorkstationId(this._workstationId);
/* 290 */     id.setTransactionSequence(this._transactionSequence);
/* 291 */     id.setLineItemSequence(this._lineItemSequence);
/* 292 */     id.setPendingSequence(this._pendingSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryMovementPendingDetailPropertyDBA.class
