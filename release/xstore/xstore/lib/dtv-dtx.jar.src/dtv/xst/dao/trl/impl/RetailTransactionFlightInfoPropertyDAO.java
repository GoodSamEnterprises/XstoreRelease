...
/*     */ 
/*     */ 
/*     */ public class RetailTransactionFlightInfoPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 864863822L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RetailTransactionFlightInfoPropertyDAO.class);
/*     */   
...
/* 236 */     RetailTransactionFlightInfoPropertyId id = new RetailTransactionFlightInfoPropertyId();
...
/* 247 */     setOrganizationId(((RetailTransactionFlightInfoPropertyId)argObjectId).getOrganizationId());
/* 248 */     setRetailLocationId(((RetailTransactionFlightInfoPropertyId)argObjectId).getRetailLocationId());
/* 249 */     setBusinessDate(((RetailTransactionFlightInfoPropertyId)argObjectId).getBusinessDate());
/* 250 */     setWorkstationId(((RetailTransactionFlightInfoPropertyId)argObjectId).getWorkstationId());
/* 251 */     setTransactionSequence(((RetailTransactionFlightInfoPropertyId)argObjectId).getTransactionSequence());
/* 252 */     setPropertyCode(((RetailTransactionFlightInfoPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 261 */     buf.append("<").append("dao").append(" name=\"RetailTransactionFlightInfoProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailTransactionFlightInfoPropertyDAO.class
