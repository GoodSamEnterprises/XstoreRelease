...
/*     */ 
/*     */ 
/*     */ public class EmployeeFingerprintDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2130044618L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeFingerprintDAO.class);
/*     */   
...
/*  55 */     return this._sequence;
/*     */   }
/*     */   
/*     */   public void setSequence(Integer argSequence) {
/*  59 */     if (changed(argSequence, this._sequence, "sequence")) {
/*  60 */       this._sequence = argSequence;
/*     */     }
/*     */   }
/*     */   
...
/* 107 */     return this._biometricStorage;
/*     */   }
/*     */   
/*     */   public void setBiometricStorage(String argBiometricStorage) {
/* 111 */     if (changed(argBiometricStorage, this._biometricStorage, "biometricStorage")) {
/* 112 */       this._biometricStorage = argBiometricStorage;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 127 */     if (getSequence() != null) {
/* 128 */       buf.append("sequence").append("=").append(getSequence()).append(" ");
/*     */     }
...
/*     */     }
/* 142 */     if (getBiometricStorage() != null) {
/* 143 */       buf.append("biometricStorage").append("=").append(getBiometricStorage()).append(" ");
/*     */     }
/*     */     
...
/* 150 */     EmployeeFingerprintId id = new EmployeeFingerprintId();
/* 151 */     id.setOrganizationId(getOrganizationId());
/* 152 */     id.setEmployeeId(getEmployeeId());
/* 153 */     id.setSequence(getSequence());
/* 154 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 158 */     setOrganizationId(((EmployeeFingerprintId)argObjectId).getOrganizationId());
/* 159 */     setEmployeeId(((EmployeeFingerprintId)argObjectId).getEmployeeId());
/* 160 */     setSequence(((EmployeeFingerprintId)argObjectId).getSequence());
/*     */   }
/*     */   
...
/* 169 */     buf.append("<").append("dao").append(" name=\"EmployeeFingerprint\" cmd=\"" + getObjectStateString() + "\">");
...
/* 180 */     if (this._sequence != null) values.put("Sequence", DaoUtils.getXmlSafeFieldValue(4, this._sequence)); 
...
/* 185 */     if (this._biometricStorage != null) values.put("BiometricStorage", DaoUtils.getXmlSafeFieldValue(2005, this._biometricStorage)); 
/* 186 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/*     */         case "Sequence":
/*     */           try {
/* 218 */             Object value = DaoUtils.getFieldValueForXmlString(4, fieldValue);
/* 219 */             setSequence((Integer)value);
/* 220 */           } catch (Exception ee) {
/* 221 */             throw new DtxException("An exception occurred while calling setSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CreateDate":
...
/*     */ 
/*     */         
/*     */         case "BiometricStorage":
/*     */           try {
/* 263 */             Object value = DaoUtils.getFieldValueForXmlString(2005, fieldValue);
/* 264 */             setBiometricStorage((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setBiometricStorage() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeFingerprintDAO.class
