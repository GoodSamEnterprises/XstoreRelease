...
/*     */ 
/*     */ 
/*     */ public class VoucherPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.serial_nbr, t.voucher_typcode, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM ttr_voucher_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND serial_nbr = ?  AND voucher_typcode = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.serial_nbr, t.voucher_typcode, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM ttr_voucher_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND serial_nbr = ?  AND voucher_typcode = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO ttr_voucher_p(organization_id, serial_nbr, voucher_typcode, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._serialNumber, this._voucherTypeCode, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE ttr_voucher_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM ttr_voucher_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND serial_nbr = ?  AND voucher_typcode = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND serial_nbr = ?  AND voucher_typcode = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._serialNumber, this._voucherTypeCode, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new VoucherPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class VoucherPropertyFiller
/*     */     implements IFiller {
/*     */     private VoucherPropertyDBA _parent;
/*     */     
/*     */     public VoucherPropertyFiller(VoucherPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._serialNumber = argResultSet.getString(2);
/* 136 */       this._parent._voucherTypeCode = argResultSet.getString(3);
...
/* 175 */     VoucherPropertyDAO dao = (VoucherPropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setSerialNumber(this._serialNumber);
/* 178 */     dao.setVoucherTypeCode(this._voucherTypeCode);
...
/* 193 */     return loadDAO((IDataAccessObject)new VoucherPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     VoucherPropertyDAO dao = (VoucherPropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._serialNumber = dao.getSerialNumber();
/* 200 */     this._voucherTypeCode = dao.getVoucherTypeCode();
...
/* 213 */     VoucherPropertyId id = (VoucherPropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getSerialNumber());
/* 216 */     argStatement.setString(3, id.getVoucherTypeCode());
/* 217 */     argStatement.setString(4, id.getPropertyCode());
/* 218 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 222 */     VoucherPropertyId id = new VoucherPropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setSerialNumber(this._serialNumber);
/* 225 */     id.setVoucherTypeCode(this._voucherTypeCode);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\VoucherPropertyDBA.class
