...
/*     */ 
/*     */ 
/*     */ public class QuickItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1979660405L;
/*  23 */   private static final Logger _logger = Logger.getLogger(QuickItemPropertyDAO.class);
/*     */   
...
/* 193 */     QuickItemPropertyId id = new QuickItemPropertyId();
...
/* 201 */     setOrganizationId(((QuickItemPropertyId)argObjectId).getOrganizationId());
/* 202 */     setItemId(((QuickItemPropertyId)argObjectId).getItemId());
/* 203 */     setPropertyCode(((QuickItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"QuickItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\QuickItemPropertyDAO.class
