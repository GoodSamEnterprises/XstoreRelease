...
/*    */ 
/*    */ 
/*    */ public class OrgHierarchyParentElementRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(3);
/*    */   
/* 21 */   OrgHierarchyId _childObjectId = null;
/*    */   
/*    */   public String getSelect() {
/* 24 */     return "SELECT organization_id, org_code, org_value, create_date, create_user_id, update_date, update_user_id, parent_code, parent_value, description, level_mgr, level_order, sort_order, inactive_flag FROM loc_org_hierarchy WHERE organization_id = ? AND org_code = ? AND org_value = ?";
/*    */   }
/*    */ 
/*    */   
/*    */   public void setParent(IDataAccessObject argDAO) {
/* 29 */     OrgHierarchyDAO dao = (OrgHierarchyDAO)argDAO;
/* 30 */     this._childObjectId = new OrgHierarchyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\OrgHierarchyParentElementRelationshipDBA.class
