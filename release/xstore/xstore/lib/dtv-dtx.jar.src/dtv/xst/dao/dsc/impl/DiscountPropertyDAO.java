...
/*     */ 
/*     */ 
/*     */ public class DiscountPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -892327338L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DiscountPropertyDAO.class);
/*     */   
...
/*  42 */     if (changed(argDiscountCode, this._discountCode, "discountCode")) {
...
/* 155 */     if (getDiscountCode() != null) {
/* 156 */       buf.append("discountCode").append("=").append(getDiscountCode()).append(" ");
/*     */     }
...
/* 193 */     DiscountPropertyId id = new DiscountPropertyId();
/* 194 */     id.setDiscountCode(getDiscountCode());
...
/* 201 */     setDiscountCode(((DiscountPropertyId)argObjectId).getDiscountCode());
/* 202 */     setOrganizationId(((DiscountPropertyId)argObjectId).getOrganizationId());
/* 203 */     setPropertyCode(((DiscountPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"DiscountProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 221 */     if (this._discountCode != null) values.put("DiscountCode", DaoUtils.getXmlSafeFieldValue(12, this._discountCode)); 
...
/* 247 */             setDiscountCode((String)value);
/* 248 */           } catch (Exception ee) {
/* 249 */             throw new DtxException("An exception occurred while calling setDiscountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountPropertyDAO.class
