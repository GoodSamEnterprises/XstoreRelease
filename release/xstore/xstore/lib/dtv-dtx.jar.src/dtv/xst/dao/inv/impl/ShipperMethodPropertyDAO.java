...
/*     */ 
/*     */ 
/*     */ public class ShipperMethodPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 2024349047L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ShipperMethodPropertyDAO.class);
/*     */   
...
/*  48 */     return this._shipperMethodId;
/*     */   }
/*     */   
/*     */   public void setShipperMethodId(String argShipperMethodId) {
/*  52 */     if (changed(argShipperMethodId, this._shipperMethodId, "shipperMethodId")) {
/*  53 */       this._shipperMethodId = (argShipperMethodId != null && MANAGE_CASE) ? argShipperMethodId.toUpperCase() : argShipperMethodId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getShipperMethodId() != null) {
/* 159 */       buf.append("shipperMethodId").append("=").append(getShipperMethodId()).append(" ");
/*     */     }
...
/* 193 */     ShipperMethodPropertyId id = new ShipperMethodPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setShipperMethodId(getShipperMethodId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((ShipperMethodPropertyId)argObjectId).getOrganizationId());
/* 202 */     setShipperMethodId(((ShipperMethodPropertyId)argObjectId).getShipperMethodId());
/* 203 */     setPropertyCode(((ShipperMethodPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ShipperMethodProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._shipperMethodId != null) values.put("ShipperMethodId", DaoUtils.getXmlSafeFieldValue(12, this._shipperMethodId)); 
...
/* 256 */             setShipperMethodId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setShipperMethodId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\ShipperMethodPropertyDAO.class
