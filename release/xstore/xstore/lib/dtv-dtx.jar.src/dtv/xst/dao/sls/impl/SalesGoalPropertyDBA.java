...
/*     */ 
/*     */ 
/*     */ public class SalesGoalPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.sales_goal_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM sls_sales_goal_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND sales_goal_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.sales_goal_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM sls_sales_goal_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND sales_goal_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO sls_sales_goal_p(organization_id, sales_goal_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._salesGoalId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE sls_sales_goal_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM sls_sales_goal_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND sales_goal_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND sales_goal_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._salesGoalId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new SalesGoalPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class SalesGoalPropertyFiller
/*     */     implements IFiller {
/*     */     private SalesGoalPropertyDBA _parent;
/*     */     
/*     */     public SalesGoalPropertyFiller(SalesGoalPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._salesGoalId = argResultSet.getString(2);
...
/* 173 */     SalesGoalPropertyDAO dao = (SalesGoalPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setSalesGoalId(this._salesGoalId);
...
/* 190 */     return loadDAO((IDataAccessObject)new SalesGoalPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     SalesGoalPropertyDAO dao = (SalesGoalPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._salesGoalId = dao.getSalesGoalId();
...
/* 209 */     SalesGoalPropertyId id = (SalesGoalPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getSalesGoalId());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     SalesGoalPropertyId id = new SalesGoalPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setSalesGoalId(this._salesGoalId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sls\impl\SalesGoalPropertyDBA.class
