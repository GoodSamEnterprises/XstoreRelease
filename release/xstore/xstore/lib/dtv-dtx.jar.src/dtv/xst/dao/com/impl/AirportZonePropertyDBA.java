...
/*     */ 
/*     */ 
/*     */ public class AirportZonePropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -1800889876L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.zone_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_airport_zone_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND zone_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.zone_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_airport_zone_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND zone_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO com_airport_zone_p(organization_id, zone_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._zoneId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE com_airport_zone_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM com_airport_zone_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND zone_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND zone_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._zoneId, this._propertyCode };
/*     */   }
/*     */   
...
/* 115 */     return new AirportZonePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class AirportZonePropertyFiller
/*     */     implements IFiller {
/*     */     private AirportZonePropertyDBA _parent;
/*     */     
/*     */     public AirportZonePropertyFiller(AirportZonePropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._zoneId = argResultSet.getString(2);
...
/* 173 */     AirportZonePropertyDAO dao = (AirportZonePropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setZoneId(this._zoneId);
...
/* 190 */     return loadDAO((IDataAccessObject)new AirportZonePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     AirportZonePropertyDAO dao = (AirportZonePropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._zoneId = dao.getZoneId();
...
/* 209 */     AirportZonePropertyId id = (AirportZonePropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getZoneId());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     AirportZonePropertyId id = new AirportZonePropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setZoneId(this._zoneId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AirportZonePropertyDBA.class
