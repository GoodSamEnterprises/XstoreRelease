...
/*     */ 
/*     */ 
/*     */ public class InventoryCountSectionDetailPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -960995304L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryCountSectionDetailPropertyDAO.class);
/*     */   
...
/*  61 */     return this._inventoryBucketId;
/*     */   }
/*     */   
/*     */   public void setInventoryBucketId(String argInventoryBucketId) {
/*  65 */     if (changed(argInventoryBucketId, this._inventoryBucketId, "inventoryBucketId")) {
/*  66 */       this._inventoryBucketId = (argInventoryBucketId != null && MANAGE_CASE) ? argInventoryBucketId.toUpperCase() : argInventoryBucketId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getSectionId() {
/*  71 */     return this._sectionId;
/*     */   }
/*     */   
/*     */   public void setSectionId(String argSectionId) {
/*  75 */     if (changed(argSectionId, this._sectionId, "sectionId")) {
/*  76 */       this._sectionId = (argSectionId != null && MANAGE_CASE) ? argSectionId.toUpperCase() : argSectionId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getSectionDetailNumber() {
/*  81 */     return this._sectionDetailNumber;
/*     */   }
/*     */   
/*     */   public void setSectionDetailNumber(Integer argSectionDetailNumber) {
/*  85 */     if (changed(argSectionDetailNumber, this._sectionDetailNumber, "sectionDetailNumber")) {
/*  86 */       this._sectionDetailNumber = argSectionDetailNumber;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 194 */     if (getInventoryBucketId() != null) {
/* 195 */       buf.append("inventoryBucketId").append("=").append(getInventoryBucketId()).append(" ");
/*     */     }
/* 197 */     if (getSectionId() != null) {
/* 198 */       buf.append("sectionId").append("=").append(getSectionId()).append(" ");
/*     */     }
/* 200 */     if (getSectionDetailNumber() != null) {
/* 201 */       buf.append("sectionDetailNumber").append("=").append(getSectionDetailNumber()).append(" ");
/*     */     }
...
/* 235 */     InventoryCountSectionDetailPropertyId id = new InventoryCountSectionDetailPropertyId();
/* 236 */     id.setOrganizationId(getOrganizationId());
/* 237 */     id.setRetailLocationId(getRetailLocationId());
/* 238 */     id.setInventoryBucketId(getInventoryBucketId());
/* 239 */     id.setSectionId(getSectionId());
/* 240 */     id.setSectionDetailNumber(getSectionDetailNumber());
/* 241 */     id.setPropertyCode(getPropertyCode());
/* 242 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 246 */     setOrganizationId(((InventoryCountSectionDetailPropertyId)argObjectId).getOrganizationId());
/* 247 */     setRetailLocationId(((InventoryCountSectionDetailPropertyId)argObjectId).getRetailLocationId());
/* 248 */     setInventoryBucketId(((InventoryCountSectionDetailPropertyId)argObjectId).getInventoryBucketId());
/* 249 */     setSectionId(((InventoryCountSectionDetailPropertyId)argObjectId).getSectionId());
/* 250 */     setSectionDetailNumber(((InventoryCountSectionDetailPropertyId)argObjectId).getSectionDetailNumber());
/* 251 */     setPropertyCode(((InventoryCountSectionDetailPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"InventoryCountSectionDetailProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 271 */     if (this._inventoryBucketId != null) values.put("InventoryBucketId", DaoUtils.getXmlSafeFieldValue(12, this._inventoryBucketId)); 
/* 272 */     if (this._sectionId != null) values.put("SectionId", DaoUtils.getXmlSafeFieldValue(12, this._sectionId)); 
/* 273 */     if (this._sectionDetailNumber != null) values.put("SectionDetailNumber", DaoUtils.getXmlSafeFieldValue(4, this._sectionDetailNumber)); 
...
/* 316 */             setInventoryBucketId((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setInventoryBucketId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "SectionId":
...
/* 325 */             setSectionId((String)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setSectionId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 334 */             setSectionDetailNumber((Integer)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setSectionDetailNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountSectionDetailPropertyDAO.class
