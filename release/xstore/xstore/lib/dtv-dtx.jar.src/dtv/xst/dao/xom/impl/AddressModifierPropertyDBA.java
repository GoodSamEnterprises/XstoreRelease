...
/*     */ 
/*     */ 
/*     */ public class AddressModifierPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.order_id, t.address_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xom_address_mod_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND order_id = ?  AND address_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.order_id, t.address_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xom_address_mod_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND order_id = ?  AND address_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO xom_address_mod_p(organization_id, order_id, address_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE xom_address_mod_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM xom_address_mod_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND order_id = ?  AND address_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND order_id = ?  AND address_seq = ?  AND property_code = ?  ";
/*     */   }
...
/* 116 */     return new AddressModifierPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class AddressModifierPropertyFiller
/*     */     implements IFiller {
/*     */     private AddressModifierPropertyDBA _parent;
/*     */     
/*     */     public AddressModifierPropertyFiller(AddressModifierPropertyDBA argParent) {
...
/* 182 */     AddressModifierPropertyDAO dao = (AddressModifierPropertyDAO)argDAO;
...
/* 200 */     return loadDAO((IDataAccessObject)new AddressModifierPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     AddressModifierPropertyDAO dao = (AddressModifierPropertyDAO)argDAO;
...
/* 220 */     AddressModifierPropertyId id = (AddressModifierPropertyId)argId;
...
/* 229 */     AddressModifierPropertyId id = new AddressModifierPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\AddressModifierPropertyDBA.class
