...
/*     */ 
/*     */ 
/*     */ public class DataLoaderSummaryPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.file_name, t.run_timestamp, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM ctl_dataloader_summary_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND file_name = ?  AND run_timestamp = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.file_name, t.run_timestamp, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM ctl_dataloader_summary_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND file_name = ?  AND run_timestamp = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO ctl_dataloader_summary_p(organization_id, file_name, run_timestamp, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._fileName, this._runTime, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE ctl_dataloader_summary_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM ctl_dataloader_summary_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND file_name = ?  AND run_timestamp = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND file_name = ?  AND run_timestamp = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._fileName, this._runTime, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "ctl_dataloader_summary_p";
/*     */   }
/*     */   
...
/* 116 */     return new DataLoaderSummaryPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class DataLoaderSummaryPropertyFiller
/*     */     implements IFiller {
/*     */     private DataLoaderSummaryPropertyDBA _parent;
/*     */     
/*     */     public DataLoaderSummaryPropertyFiller(DataLoaderSummaryPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._fileName = argResultSet.getString(2);
/*     */ 
/*     */       
/* 138 */       primitiveResult = argResultSet.getLong(3);
/* 139 */       if (primitiveResult != 0L || argResultSet.getObject(3) != null) {
/* 140 */         this._parent._runTime = Long.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 182 */     DataLoaderSummaryPropertyDAO dao = (DataLoaderSummaryPropertyDAO)argDAO;
/* 183 */     dao.setOrganizationId(this._organizationId);
/* 184 */     dao.setFileName(this._fileName);
/* 185 */     dao.setRunTime(this._runTime);
...
/* 200 */     return loadDAO((IDataAccessObject)new DataLoaderSummaryPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     DataLoaderSummaryPropertyDAO dao = (DataLoaderSummaryPropertyDAO)argDAO;
...
/* 220 */     DataLoaderSummaryPropertyId id = (DataLoaderSummaryPropertyId)argId;
/* 221 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 222 */     argStatement.setString(2, id.getFileName());
/* 223 */     argStatement.setLong(3, id.getRunTime().longValue());
/* 224 */     argStatement.setString(4, id.getPropertyCode());
/* 225 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 229 */     DataLoaderSummaryPropertyId id = new DataLoaderSummaryPropertyId();
/* 230 */     id.setOrganizationId(this._organizationId);
/* 231 */     id.setFileName(this._fileName);
/* 232 */     id.setRunTime(this._runTime);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\DataLoaderSummaryPropertyDBA.class
