...
/*     */ 
/*     */ 
/*     */ public class SequencePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 235777238L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SequencePropertyDAO.class);
/*     */   
...
/*  71 */     return this._sequenceId;
/*     */   }
/*     */   
/*     */   public void setSequenceId(String argSequenceId) {
/*  75 */     if (changed(argSequenceId, this._sequenceId, "sequenceId")) {
/*  76 */       this._sequenceId = (argSequenceId != null && MANAGE_CASE) ? argSequenceId.toUpperCase() : argSequenceId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getSequenceMode() {
/*  81 */     return this._sequenceMode;
/*     */   }
/*     */   
/*     */   public void setSequenceMode(String argSequenceMode) {
/*  85 */     if (changed(argSequenceMode, this._sequenceMode, "sequenceMode")) {
/*  86 */       this._sequenceMode = (argSequenceMode != null && MANAGE_CASE) ? argSequenceMode.toUpperCase() : argSequenceMode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 197 */     if (getSequenceId() != null) {
/* 198 */       buf.append("sequenceId").append("=").append(getSequenceId()).append(" ");
/*     */     }
/* 200 */     if (getSequenceMode() != null) {
/* 201 */       buf.append("sequenceMode").append("=").append(getSequenceMode()).append(" ");
/*     */     }
...
/* 235 */     SequencePropertyId id = new SequencePropertyId();
...
/* 239 */     id.setSequenceId(getSequenceId());
/* 240 */     id.setSequenceMode(getSequenceMode());
/* 241 */     id.setPropertyCode(getPropertyCode());
/* 242 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 246 */     setOrganizationId(((SequencePropertyId)argObjectId).getOrganizationId());
/* 247 */     setRetailLocationId(((SequencePropertyId)argObjectId).getRetailLocationId());
/* 248 */     setWorkstationId(((SequencePropertyId)argObjectId).getWorkstationId());
/* 249 */     setSequenceId(((SequencePropertyId)argObjectId).getSequenceId());
/* 250 */     setSequenceMode(((SequencePropertyId)argObjectId).getSequenceMode());
/* 251 */     setPropertyCode(((SequencePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"SequenceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 272 */     if (this._sequenceId != null) values.put("SequenceId", DaoUtils.getXmlSafeFieldValue(12, this._sequenceId)); 
/* 273 */     if (this._sequenceMode != null) values.put("SequenceMode", DaoUtils.getXmlSafeFieldValue(12, this._sequenceMode)); 
...
/* 325 */             setSequenceId((String)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setSequenceId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "SequenceMode":
...
/* 334 */             setSequenceMode((String)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setSequenceMode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\SequencePropertyDAO.class
