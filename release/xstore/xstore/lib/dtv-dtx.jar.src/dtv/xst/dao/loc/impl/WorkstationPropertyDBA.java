...
/*     */ 
/*     */ 
/*     */ public class WorkstationPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1638837208L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_wkstn_p t";
...
/*  45 */     return "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_wkstn_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO loc_wkstn_p(organization_id, rtl_loc_id, wkstn_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE loc_wkstn_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM loc_wkstn_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   
...
/* 116 */     return new WorkstationPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class WorkstationPropertyFiller
/*     */     implements IFiller {
/*     */     private WorkstationPropertyDBA _parent;
/*     */     
/*     */     public WorkstationPropertyFiller(WorkstationPropertyDBA argParent) {
...
/* 189 */     WorkstationPropertyDAO dao = (WorkstationPropertyDAO)argDAO;
...
/* 207 */     return loadDAO((IDataAccessObject)new WorkstationPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 211 */     WorkstationPropertyDAO dao = (WorkstationPropertyDAO)argDAO;
...
/* 227 */     WorkstationPropertyId id = (WorkstationPropertyId)argId;
...
/* 236 */     WorkstationPropertyId id = new WorkstationPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\WorkstationPropertyDBA.class
