...
/*     */ 
/*     */ 
/*     */ public class TaxAuthorityDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1120218104L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxAuthorityDAO.class);
/*     */   
...
/*  49 */     return this._taxAuthorityId;
/*     */   }
/*     */   
/*     */   public void setTaxAuthorityId(String argTaxAuthorityId) {
/*  53 */     if (changed(argTaxAuthorityId, this._taxAuthorityId, "taxAuthorityId")) {
/*  54 */       this._taxAuthorityId = (argTaxAuthorityId != null && MANAGE_CASE) ? argTaxAuthorityId.toUpperCase() : argTaxAuthorityId;
/*     */     }
/*     */   }
/*     */   
...
/* 131 */     return this._roundingCode;
/*     */   }
/*     */   
/*     */   public void setRoundingCode(String argRoundingCode) {
/* 135 */     if (changed(argRoundingCode, this._roundingCode, "roundingCode")) {
/* 136 */       this._roundingCode = argRoundingCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getRoundingDigitsQuantity() {
/* 141 */     return this._roundingDigitsQuantity;
/*     */   }
/*     */   
/*     */   public void setRoundingDigitsQuantity(Integer argRoundingDigitsQuantity) {
/* 145 */     if (changed(argRoundingDigitsQuantity, this._roundingDigitsQuantity, "roundingDigitsQuantity")) {
/* 146 */       this._roundingDigitsQuantity = argRoundingDigitsQuantity;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 168 */     if (getTaxAuthorityId() != null) {
/* 169 */       buf.append("taxAuthorityId").append("=").append(getTaxAuthorityId()).append(" ");
/*     */     }
...
/*     */     }
/* 192 */     if (getRoundingCode() != null) {
/* 193 */       buf.append("roundingCode").append("=").append(getRoundingCode()).append(" ");
/*     */     }
/* 195 */     if (getRoundingDigitsQuantity() != null) {
/* 196 */       buf.append("roundingDigitsQuantity").append("=").append(getRoundingDigitsQuantity()).append(" ");
/*     */     }
...
/* 206 */     TaxAuthorityId id = new TaxAuthorityId();
/* 207 */     id.setOrganizationId(getOrganizationId());
/* 208 */     id.setTaxAuthorityId(getTaxAuthorityId());
/* 209 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 213 */     setOrganizationId(((TaxAuthorityId)argObjectId).getOrganizationId());
/* 214 */     setTaxAuthorityId(((TaxAuthorityId)argObjectId).getTaxAuthorityId());
/*     */   }
/*     */   
...
/* 223 */     buf.append("<").append("dao").append(" name=\"TaxAuthority\" cmd=\"" + getObjectStateString() + "\">");
...
/* 233 */     if (this._taxAuthorityId != null) values.put("TaxAuthorityId", DaoUtils.getXmlSafeFieldValue(12, this._taxAuthorityId)); 
...
/* 240 */     if (this._name != null) values.put("Name", DaoUtils.getXmlSafeFieldValue(12, this._name)); 
/* 241 */     if (this._roundingCode != null) values.put("RoundingCode", DaoUtils.getXmlSafeFieldValue(12, this._roundingCode)); 
/* 242 */     if (this._roundingDigitsQuantity != null) values.put("RoundingDigitsQuantity", DaoUtils.getXmlSafeFieldValue(4, this._roundingDigitsQuantity)); 
...
/* 268 */             setTaxAuthorityId((String)value);
/* 269 */           } catch (Exception ee) {
/* 270 */             throw new DtxException("An exception occurred while calling setTaxAuthorityId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CreateDate":
...
/* 331 */             setName((String)value);
/* 332 */           } catch (Exception ee) {
/* 333 */             throw new DtxException("An exception occurred while calling setName() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "RoundingCode":
...
/* 340 */             setRoundingCode((String)value);
/* 341 */           } catch (Exception ee) {
/* 342 */             throw new DtxException("An exception occurred while calling setRoundingCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "RoundingDigitsQuantity":
/*     */           try {
/* 348 */             Object value = DaoUtils.getFieldValueForXmlString(4, fieldValue);
/* 349 */             setRoundingDigitsQuantity((Integer)value);
/* 350 */           } catch (Exception ee) {
/* 351 */             throw new DtxException("An exception occurred while calling setRoundingDigitsQuantity() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ExternalSystem":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxAuthorityDAO.class
