...
/*     */ 
/*     */ 
/*     */ public class DealFieldTestPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 190421877L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DealFieldTestPropertyDAO.class);
/*     */   
...
/*  51 */     return this._dealId;
/*     */   }
/*     */   
/*     */   public void setDealId(String argDealId) {
/*  55 */     if (changed(argDealId, this._dealId, "dealId")) {
/*  56 */       this._dealId = (argDealId != null && MANAGE_CASE) ? argDealId.toUpperCase() : argDealId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getOrdinal() {
/*  61 */     return this._ordinal;
/*     */   }
/*     */   
/*     */   public void setOrdinal(Integer argOrdinal) {
/*  65 */     if (changed(argOrdinal, this._ordinal, "ordinal")) {
/*  66 */       this._ordinal = argOrdinal;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getItemConditionGroup() {
/*  71 */     return this._itemConditionGroup;
/*     */   }
/*     */   
/*     */   public void setItemConditionGroup(Integer argItemConditionGroup) {
/*  75 */     if (changed(argItemConditionGroup, this._itemConditionGroup, "itemConditionGroup")) {
/*  76 */       this._itemConditionGroup = argItemConditionGroup;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getItemConditionSeq() {
/*  81 */     return this._itemConditionSeq;
/*     */   }
/*     */   
/*     */   public void setItemConditionSeq(Integer argItemConditionSeq) {
/*  85 */     if (changed(argItemConditionSeq, this._itemConditionSeq, "itemConditionSeq")) {
/*  86 */       this._itemConditionSeq = argItemConditionSeq;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 191 */     if (getDealId() != null) {
/* 192 */       buf.append("dealId").append("=").append(getDealId()).append(" ");
/*     */     }
/* 194 */     if (getOrdinal() != null) {
/* 195 */       buf.append("ordinal").append("=").append(getOrdinal()).append(" ");
/*     */     }
/* 197 */     if (getItemConditionGroup() != null) {
/* 198 */       buf.append("itemConditionGroup").append("=").append(getItemConditionGroup()).append(" ");
/*     */     }
/* 200 */     if (getItemConditionSeq() != null) {
/* 201 */       buf.append("itemConditionSeq").append("=").append(getItemConditionSeq()).append(" ");
/*     */     }
...
/* 235 */     DealFieldTestPropertyId id = new DealFieldTestPropertyId();
/* 236 */     id.setOrganizationId(getOrganizationId());
/* 237 */     id.setDealId(getDealId());
/* 238 */     id.setOrdinal(getOrdinal());
/* 239 */     id.setItemConditionGroup(getItemConditionGroup());
/* 240 */     id.setItemConditionSeq(getItemConditionSeq());
/* 241 */     id.setPropertyCode(getPropertyCode());
/* 242 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 246 */     setOrganizationId(((DealFieldTestPropertyId)argObjectId).getOrganizationId());
/* 247 */     setDealId(((DealFieldTestPropertyId)argObjectId).getDealId());
/* 248 */     setOrdinal(((DealFieldTestPropertyId)argObjectId).getOrdinal());
/* 249 */     setItemConditionGroup(((DealFieldTestPropertyId)argObjectId).getItemConditionGroup());
/* 250 */     setItemConditionSeq(((DealFieldTestPropertyId)argObjectId).getItemConditionSeq());
/* 251 */     setPropertyCode(((DealFieldTestPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"DealFieldTestProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 270 */     if (this._dealId != null) values.put("DealId", DaoUtils.getXmlSafeFieldValue(12, this._dealId)); 
/* 271 */     if (this._ordinal != null) values.put("Ordinal", DaoUtils.getXmlSafeFieldValue(4, this._ordinal)); 
/* 272 */     if (this._itemConditionGroup != null) values.put("ItemConditionGroup", DaoUtils.getXmlSafeFieldValue(4, this._itemConditionGroup)); 
/* 273 */     if (this._itemConditionSeq != null) values.put("ItemConditionSeq", DaoUtils.getXmlSafeFieldValue(4, this._itemConditionSeq)); 
...
/* 307 */             setDealId((String)value);
/* 308 */           } catch (Exception ee) {
/* 309 */             throw new DtxException("An exception occurred while calling setDealId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "Ordinal":
...
/* 316 */             setOrdinal((Integer)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setOrdinal() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 325 */             setItemConditionGroup((Integer)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setItemConditionGroup() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 334 */             setItemConditionSeq((Integer)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setItemConditionSeq() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealFieldTestPropertyDAO.class
