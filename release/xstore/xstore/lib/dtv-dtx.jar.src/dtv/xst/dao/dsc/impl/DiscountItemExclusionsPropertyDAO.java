...
/*     */ 
/*     */ 
/*     */ public class DiscountItemExclusionsPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -62154610L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DiscountItemExclusionsPropertyDAO.class);
/*     */   
...
/* 207 */     DiscountItemExclusionsPropertyId id = new DiscountItemExclusionsPropertyId();
...
/* 216 */     setDiscountCode(((DiscountItemExclusionsPropertyId)argObjectId).getDiscountCode());
/* 217 */     setItemId(((DiscountItemExclusionsPropertyId)argObjectId).getItemId());
/* 218 */     setOrganizationId(((DiscountItemExclusionsPropertyId)argObjectId).getOrganizationId());
/* 219 */     setPropertyCode(((DiscountItemExclusionsPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DiscountItemExclusionsProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountItemExclusionsPropertyDAO.class
