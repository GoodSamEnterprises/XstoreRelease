...
/*     */ 
/*     */ 
/*     */ public class IdentityVerificationPropertyId
...
/*     */   
/*     */   public IdentityVerificationPropertyId() {}
/*     */   
/*     */   public IdentityVerificationPropertyId(String argObjectIdValue) {
...
/*  46 */     return this._identityVerificationSequence;
/*     */   }
/*     */   
/*     */   public void setIdentityVerificationSequence(Integer argIdentityVerificationSequence) {
/*  50 */     this._identityVerificationSequence = argIdentityVerificationSequence;
/*     */   }
/*     */   
...
/* 109 */       str = tokens[1];
/*     */       
/* 111 */       setIdentityVerificationSequence(Integer.valueOf(str));
/* 112 */       str = tokens[2];
/*     */       
...
/* 144 */       return true;
/*     */     }
/* 146 */     if (!(ob instanceof IdentityVerificationPropertyId)) {
/* 147 */       return false;
/*     */     }
/* 149 */     IdentityVerificationPropertyId other = (IdentityVerificationPropertyId)ob;
/* 150 */     return (((this._businessDate == null && other._businessDate == null) || (this._businessDate != null && this._businessDate
/*     */ 
/*     */       
/* 153 */       .equals(other._businessDate))) && ((this._identityVerificationSequence == null && other._identityVerificationSequence == null) || (this._identityVerificationSequence != null && this._identityVerificationSequence
/*     */ 
/*     */       
/* 156 */       .equals(other._identityVerificationSequence))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/* 181 */       .hashCode()) + ((this._identityVerificationSequence == null) ? 0 : this._identityVerificationSequence
...
/* 193 */     return "IdentityVerificationProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 202 */       .append("::").append(String.valueOf(this._identityVerificationSequence))
...
/* 214 */       return false;
/*     */     }
/* 216 */     if (this._identityVerificationSequence == null) {
/* 217 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\IdentityVerificationPropertyId.class
