...
/*     */ 
/*     */ 
/*     */ public class SessionControlTransactionDAO
/*     */   extends PosTransactionDAO
/*     */ {
/*     */   private static final long serialVersionUID = 893283927L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SessionControlTransactionDAO.class);
/*     */   
...
/*  75 */     return this._typeCode;
/*     */   }
/*     */   
/*     */   public void setTypeCode(String argTypeCode) {
/*  79 */     if (changed(argTypeCode, this._typeCode, "typeCode")) {
/*  80 */       this._typeCode = argTypeCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getSessionWorkstationSequence() {
/*  85 */     return this._sessionWorkstationSequence;
/*     */   }
/*     */   
/*     */   public void setSessionWorkstationSequence(Integer argSessionWorkstationSequence) {
/*  89 */     if (changed(argSessionWorkstationSequence, this._sessionWorkstationSequence, "sessionWorkstationSequence")) {
/*  90 */       this._sessionWorkstationSequence = argSessionWorkstationSequence;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 111 */     if (getTypeCode() != null) {
/* 112 */       buf.append("typeCode").append("=").append(getTypeCode()).append(" ");
/*     */     }
/* 114 */     if (getSessionWorkstationSequence() != null) {
/* 115 */       buf.append("sessionWorkstationSequence").append("=").append(getSessionWorkstationSequence()).append(" ");
/*     */     }
/*     */     
...
/* 123 */     StringBuilder buf = new StringBuilder(1750);
/* 124 */     buf.append("<").append("dao").append(" name=\"SessionControlTransaction\" cmd=\"" + getObjectStateString() + "\">");
...
/* 137 */     if (this._typeCode != null) values.put("TypeCode", DaoUtils.getXmlSafeFieldValue(12, this._typeCode)); 
/* 138 */     if (this._sessionWorkstationSequence != null) values.put("SessionWorkstationSequence", DaoUtils.getXmlSafeFieldValue(4, this._sessionWorkstationSequence)); 
/* 139 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/* 190 */             setTypeCode((String)value);
/* 191 */           } catch (Exception ee) {
/* 192 */             throw new DtxException("An exception occurred while calling setTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "SessionWorkstationSequence":
/*     */           try {
/* 198 */             Object value = DaoUtils.getFieldValueForXmlString(4, fieldValue);
/* 199 */             setSessionWorkstationSequence((Integer)value);
/* 200 */           } catch (Exception ee) {
/* 201 */             throw new DtxException("An exception occurred while calling setSessionWorkstationSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\SessionControlTransactionDAO.class
