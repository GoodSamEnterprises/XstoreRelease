...
/*     */ 
/*     */ 
/*     */ public class IpCashDrawerDevicePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IIpCashDrawerDeviceProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new IpCashDrawerDevicePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private IpCashDrawerDevicePropertyDAO getDAO_() {
/*  44 */     return (IpCashDrawerDevicePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IIpCashDrawerDeviceProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IIpCashDrawerDeviceProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     return getDAO_().getCashDrawerId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 138 */     if (setCashDrawerId_noev(argCashDrawerId) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IIpCashDrawerDeviceProperty.SET_CASHDRAWERID, argCashDrawerId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getCashDrawerId() == null && argCashDrawerId != null) || (
/* 151 */       getDAO_().getCashDrawerId() != null && !getDAO_().getCashDrawerId().equals(argCashDrawerId))) {
/* 152 */       getDAO_().setCashDrawerId(argCashDrawerId);
...
/* 175 */       this._events.post(IIpCashDrawerDeviceProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(IIpCashDrawerDeviceProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IIpCashDrawerDeviceProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IIpCashDrawerDeviceProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IIpCashDrawerDeviceProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IIpCashDrawerDeviceProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IIpCashDrawerDeviceProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IIpCashDrawerDeviceProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IIpCashDrawerDeviceProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 468 */     if ("IpCashDrawerDevicePropertyExtension".equals(argFieldId)) {
...
/* 478 */     if ("IpCashDrawerDevicePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\IpCashDrawerDevicePropertyModel.class
