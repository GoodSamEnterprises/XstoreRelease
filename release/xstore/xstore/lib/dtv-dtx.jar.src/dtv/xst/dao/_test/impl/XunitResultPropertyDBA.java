...
/*     */ 
/*     */ 
/*     */ public class XunitResultPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.hostname, t.result_timestamp, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xunit_result_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND hostname = ?  AND result_timestamp = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.hostname, t.result_timestamp, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xunit_result_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND hostname = ?  AND result_timestamp = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO xunit_result_p(organization_id, hostname, result_timestamp, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._hostname, this._resultTimestamp, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE xunit_result_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM xunit_result_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND hostname = ?  AND result_timestamp = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND hostname = ?  AND result_timestamp = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._hostname, this._resultTimestamp, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new XunitResultPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class XunitResultPropertyFiller
/*     */     implements IFiller {
/*     */     private XunitResultPropertyDBA _parent;
/*     */     
/*     */     public XunitResultPropertyFiller(XunitResultPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._hostname = argResultSet.getString(2);
/*     */ 
/*     */       
/* 138 */       primitiveResult = argResultSet.getLong(3);
/* 139 */       if (primitiveResult != 0L || argResultSet.getObject(3) != null) {
/* 140 */         this._parent._resultTimestamp = Long.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 182 */     XunitResultPropertyDAO dao = (XunitResultPropertyDAO)argDAO;
/* 183 */     dao.setOrganizationId(this._organizationId);
/* 184 */     dao.setHostname(this._hostname);
/* 185 */     dao.setResultTimestamp(this._resultTimestamp);
...
/* 200 */     return loadDAO((IDataAccessObject)new XunitResultPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     XunitResultPropertyDAO dao = (XunitResultPropertyDAO)argDAO;
/* 205 */     this._organizationId = dao.getOrganizationId();
/* 206 */     this._hostname = dao.getHostname();
/* 207 */     this._resultTimestamp = dao.getResultTimestamp();
...
/* 220 */     XunitResultPropertyId id = (XunitResultPropertyId)argId;
/* 221 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 222 */     argStatement.setString(2, id.getHostname());
/* 223 */     argStatement.setLong(3, id.getResultTimestamp().longValue());
/* 224 */     argStatement.setString(4, id.getPropertyCode());
/* 225 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 229 */     XunitResultPropertyId id = new XunitResultPropertyId();
/* 230 */     id.setOrganizationId(this._organizationId);
/* 231 */     id.setHostname(this._hostname);
/* 232 */     id.setResultTimestamp(this._resultTimestamp);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\_test\impl\XunitResultPropertyDBA.class
