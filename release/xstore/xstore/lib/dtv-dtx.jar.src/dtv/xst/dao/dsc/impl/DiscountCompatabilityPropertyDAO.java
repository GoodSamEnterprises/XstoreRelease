...
/*     */ 
/*     */ 
/*     */ public class DiscountCompatabilityPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -774761860L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DiscountCompatabilityPropertyDAO.class);
/*     */   
...
/*  39 */     return this._compatibleDiscountCode;
/*     */   }
/*     */   
/*     */   public void setCompatibleDiscountCode(String argCompatibleDiscountCode) {
/*  43 */     if (changed(argCompatibleDiscountCode, this._compatibleDiscountCode, "compatibleDiscountCode")) {
/*  44 */       this._compatibleDiscountCode = (argCompatibleDiscountCode != null && MANAGE_CASE) ? argCompatibleDiscountCode.toUpperCase() : argCompatibleDiscountCode;
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     return this._primaryDiscountCode;
/*     */   }
/*     */   
/*     */   public void setPrimaryDiscountCode(String argPrimaryDiscountCode) {
/*  63 */     if (changed(argPrimaryDiscountCode, this._primaryDiscountCode, "primaryDiscountCode")) {
/*  64 */       this._primaryDiscountCode = (argPrimaryDiscountCode != null && MANAGE_CASE) ? argPrimaryDiscountCode.toUpperCase() : argPrimaryDiscountCode;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getCompatibleDiscountCode() != null) {
/* 167 */       buf.append("compatibleDiscountCode").append("=").append(getCompatibleDiscountCode()).append(" ");
/*     */     }
/* 169 */     if (getOrganizationId() != null) {
/* 170 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 172 */     if (getPrimaryDiscountCode() != null) {
/* 173 */       buf.append("primaryDiscountCode").append("=").append(getPrimaryDiscountCode()).append(" ");
/*     */     }
...
/* 207 */     DiscountCompatabilityPropertyId id = new DiscountCompatabilityPropertyId();
/* 208 */     id.setCompatibleDiscountCode(getCompatibleDiscountCode());
/* 209 */     id.setOrganizationId(getOrganizationId());
/* 210 */     id.setPrimaryDiscountCode(getPrimaryDiscountCode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setCompatibleDiscountCode(((DiscountCompatabilityPropertyId)argObjectId).getCompatibleDiscountCode());
/* 217 */     setOrganizationId(((DiscountCompatabilityPropertyId)argObjectId).getOrganizationId());
/* 218 */     setPrimaryDiscountCode(((DiscountCompatabilityPropertyId)argObjectId).getPrimaryDiscountCode());
/* 219 */     setPropertyCode(((DiscountCompatabilityPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DiscountCompatabilityProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._compatibleDiscountCode != null) values.put("CompatibleDiscountCode", DaoUtils.getXmlSafeFieldValue(12, this._compatibleDiscountCode)); 
/* 238 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 239 */     if (this._primaryDiscountCode != null) values.put("PrimaryDiscountCode", DaoUtils.getXmlSafeFieldValue(12, this._primaryDiscountCode)); 
...
/* 264 */             setCompatibleDiscountCode((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setCompatibleDiscountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 282 */             setPrimaryDiscountCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setPrimaryDiscountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\DiscountCompatabilityPropertyDAO.class
