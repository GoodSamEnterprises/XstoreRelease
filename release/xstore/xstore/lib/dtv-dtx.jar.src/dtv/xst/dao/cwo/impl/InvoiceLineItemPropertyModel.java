...
/*     */ 
/*     */ 
/*     */ public class InvoiceLineItemPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IInvoiceLineItemProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new InvoiceLineItemPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private InvoiceLineItemPropertyDAO getDAO_() {
/*  44 */     return (InvoiceLineItemPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IInvoiceLineItemProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getServiceLocationId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setServiceLocationId_noev(argServiceLocationId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IInvoiceLineItemProperty.SET_SERVICELOCATIONID, argServiceLocationId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getServiceLocationId() == null && argServiceLocationId != null) || (
/* 112 */       getDAO_().getServiceLocationId() != null && !getDAO_().getServiceLocationId().equals(argServiceLocationId))) {
/* 113 */       getDAO_().setServiceLocationId(argServiceLocationId);
...
/* 125 */     return getDAO_().getInvoiceNumber();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setInvoiceNumber_noev(argInvoiceNumber) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IInvoiceLineItemProperty.SET_INVOICENUMBER, argInvoiceNumber);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getInvoiceNumber() == null && argInvoiceNumber != null) || (
/* 146 */       getDAO_().getInvoiceNumber() != null && !getDAO_().getInvoiceNumber().equals(argInvoiceNumber))) {
/* 147 */       getDAO_().setInvoiceNumber(argInvoiceNumber);
...
/* 159 */     if (getDAO_().getInvoiceLineItemSequence() != null) {
/* 160 */       return getDAO_().getInvoiceLineItemSequence().intValue();
/*     */     }
/*     */     
/* 163 */     return 0;
/*     */   }
...
/* 172 */     if (setInvoiceLineItemSequence_noev(argInvoiceLineItemSequence) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IInvoiceLineItemProperty.SET_INVOICELINEITEMSEQUENCE, Integer.valueOf(argInvoiceLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getInvoiceLineItemSequence() == null && Integer.valueOf(argInvoiceLineItemSequence) != null) || (
/* 185 */       getDAO_().getInvoiceLineItemSequence() != null && !getDAO_().getInvoiceLineItemSequence().equals(Integer.valueOf(argInvoiceLineItemSequence)))) {
/* 186 */       getDAO_().setInvoiceLineItemSequence(Integer.valueOf(argInvoiceLineItemSequence));
...
/* 209 */       this._events.post(IInvoiceLineItemProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IInvoiceLineItemProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IInvoiceLineItemProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IInvoiceLineItemProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IInvoiceLineItemProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IInvoiceLineItemProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IInvoiceLineItemProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IInvoiceLineItemProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(IInvoiceLineItemProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 502 */     if ("InvoiceLineItemPropertyExtension".equals(argFieldId)) {
...
/* 512 */     if ("InvoiceLineItemPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\InvoiceLineItemPropertyModel.class
