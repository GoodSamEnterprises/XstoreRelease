...
/*     */   public WorkCodesId() {}
/*     */   
/*     */   public WorkCodesId(String argObjectIdValue) {
...
/*  29 */     return this._workCode;
/*     */   }
/*     */   
/*     */   public void setWorkCode(String argWorkCode) {
/*  33 */     this._workCode = (argWorkCode != null && MANAGE_CASE) ? argWorkCode.toUpperCase() : argWorkCode;
/*     */   }
/*     */   
...
/*  63 */       return true;
/*     */     }
/*  65 */     if (!(ob instanceof WorkCodesId)) {
/*  66 */       return false;
/*     */     }
/*  68 */     WorkCodesId other = (WorkCodesId)ob;
/*  69 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  72 */       .equals(other._organizationId))) && ((this._workCode == null && other._workCode == null) || (this._workCode != null && this._workCode
/*     */ 
/*     */       
/*  75 */       .equals(other._workCode))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  82 */       .hashCode()) + ((this._workCode == null) ? 0 : this._workCode
/*  83 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
...
/*  97 */       .append("::").append(this._workCode)
/*  98 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 102 */     if (this._workCode == null) {
/* 103 */       return false;
/*     */     }
/* 105 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\WorkCodesId.class
