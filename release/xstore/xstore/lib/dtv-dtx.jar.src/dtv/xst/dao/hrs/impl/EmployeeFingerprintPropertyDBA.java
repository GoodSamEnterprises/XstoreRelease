...
/*     */ 
/*     */ 
/*     */ public class EmployeeFingerprintPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.employee_id, t.fingerprint_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM hrs_employee_fingerprint_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND employee_id = ?  AND fingerprint_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.employee_id, t.fingerprint_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM hrs_employee_fingerprint_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND employee_id = ?  AND fingerprint_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO hrs_employee_fingerprint_p(organization_id, employee_id, fingerprint_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._employeeId, this._sequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE hrs_employee_fingerprint_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM hrs_employee_fingerprint_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND employee_id = ?  AND fingerprint_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND employee_id = ?  AND fingerprint_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._employeeId, this._sequence, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "hrs_employee_fingerprint_p";
/*     */   }
/*     */   
...
/* 116 */     return new EmployeeFingerprintPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class EmployeeFingerprintPropertyFiller
/*     */     implements IFiller {
/*     */     private EmployeeFingerprintPropertyDBA _parent;
/*     */     
/*     */     public EmployeeFingerprintPropertyFiller(EmployeeFingerprintPropertyDBA argParent) {
...
/* 182 */     EmployeeFingerprintPropertyDAO dao = (EmployeeFingerprintPropertyDAO)argDAO;
/* 183 */     dao.setOrganizationId(this._organizationId);
/* 184 */     dao.setEmployeeId(this._employeeId);
...
/* 200 */     return loadDAO((IDataAccessObject)new EmployeeFingerprintPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     EmployeeFingerprintPropertyDAO dao = (EmployeeFingerprintPropertyDAO)argDAO;
/* 205 */     this._organizationId = dao.getOrganizationId();
/* 206 */     this._employeeId = dao.getEmployeeId();
...
/* 220 */     EmployeeFingerprintPropertyId id = (EmployeeFingerprintPropertyId)argId;
/* 221 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 222 */     argStatement.setString(2, id.getEmployeeId());
/* 223 */     argStatement.setInt(3, id.getSequence().intValue());
/* 224 */     argStatement.setString(4, id.getPropertyCode());
/* 225 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 229 */     EmployeeFingerprintPropertyId id = new EmployeeFingerprintPropertyId();
/* 230 */     id.setOrganizationId(this._organizationId);
/* 231 */     id.setEmployeeId(this._employeeId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeFingerprintPropertyDBA.class
