...
/*     */ 
/*     */ 
/*     */ public class WarrantyJournalPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1206730384L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WarrantyJournalPropertyDAO.class);
/*     */   
...
/*  50 */     return this._warrantyNbr;
/*     */   }
/*     */   
/*     */   public void setWarrantyNbr(String argWarrantyNbr) {
/*  54 */     if (changed(argWarrantyNbr, this._warrantyNbr, "warrantyNbr")) {
/*  55 */       this._warrantyNbr = (argWarrantyNbr != null && MANAGE_CASE) ? argWarrantyNbr.toUpperCase() : argWarrantyNbr;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getWarrantyTypeCode() {
/*  60 */     return this._warrantyTypeCode;
/*     */   }
/*     */   
/*     */   public void setWarrantyTypeCode(String argWarrantyTypeCode) {
/*  64 */     if (changed(argWarrantyTypeCode, this._warrantyTypeCode, "warrantyTypeCode")) {
/*  65 */       this._warrantyTypeCode = (argWarrantyTypeCode != null && MANAGE_CASE) ? argWarrantyTypeCode.toUpperCase() : argWarrantyTypeCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getJournalSequence() {
/*  70 */     return this._journalSequence;
/*     */   }
/*     */   
/*     */   public void setJournalSequence(Long argJournalSequence) {
/*  74 */     if (changed(argJournalSequence, this._journalSequence, "journalSequence")) {
/*  75 */       this._journalSequence = argJournalSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getWarrantyNbr() != null) {
/* 181 */       buf.append("warrantyNbr").append("=").append(getWarrantyNbr()).append(" ");
/*     */     }
/* 183 */     if (getWarrantyTypeCode() != null) {
/* 184 */       buf.append("warrantyTypeCode").append("=").append(getWarrantyTypeCode()).append(" ");
/*     */     }
/* 186 */     if (getJournalSequence() != null) {
/* 187 */       buf.append("journalSequence").append("=").append(getJournalSequence()).append(" ");
/*     */     }
...
/* 221 */     WarrantyJournalPropertyId id = new WarrantyJournalPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setWarrantyNbr(getWarrantyNbr());
/* 224 */     id.setWarrantyTypeCode(getWarrantyTypeCode());
/* 225 */     id.setJournalSequence(getJournalSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((WarrantyJournalPropertyId)argObjectId).getOrganizationId());
/* 232 */     setWarrantyNbr(((WarrantyJournalPropertyId)argObjectId).getWarrantyNbr());
/* 233 */     setWarrantyTypeCode(((WarrantyJournalPropertyId)argObjectId).getWarrantyTypeCode());
/* 234 */     setJournalSequence(((WarrantyJournalPropertyId)argObjectId).getJournalSequence());
/* 235 */     setPropertyCode(((WarrantyJournalPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"WarrantyJournalProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._warrantyNbr != null) values.put("WarrantyNbr", DaoUtils.getXmlSafeFieldValue(12, this._warrantyNbr)); 
/* 255 */     if (this._warrantyTypeCode != null) values.put("WarrantyTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._warrantyTypeCode)); 
/* 256 */     if (this._journalSequence != null) values.put("JournalSequence", DaoUtils.getXmlSafeFieldValue(-5, this._journalSequence)); 
...
/* 290 */             setWarrantyNbr((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setWarrantyNbr() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 299 */             setWarrantyTypeCode((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setWarrantyTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setJournalSequence((Long)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setJournalSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyJournalPropertyDAO.class
