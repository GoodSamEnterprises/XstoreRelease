...
/*     */   public GroupId() {}
/*     */   
/*     */   public GroupId(String argObjectIdValue) {
...
/*  29 */     return this._groupId;
/*     */   }
/*     */   
/*     */   public void setGroupId(String argGroupId) {
/*  33 */     this._groupId = (argGroupId != null && MANAGE_CASE) ? argGroupId.toUpperCase() : argGroupId;
/*     */   }
/*     */   
...
/*  63 */       return true;
/*     */     }
/*  65 */     if (!(ob instanceof GroupId)) {
/*  66 */       return false;
/*     */     }
/*  68 */     GroupId other = (GroupId)ob;
/*  69 */     return (((this._groupId == null && other._groupId == null) || (this._groupId != null && this._groupId
/*     */ 
/*     */       
/*  72 */       .equals(other._groupId))) && ((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
...
/*     */   
/*     */   public int hashCode() {
/*  81 */     return ((this._groupId == null) ? 0 : this._groupId
...
/*     */     
/*  95 */     return buff.append(this._groupId)
/*     */       
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\GroupId.class
