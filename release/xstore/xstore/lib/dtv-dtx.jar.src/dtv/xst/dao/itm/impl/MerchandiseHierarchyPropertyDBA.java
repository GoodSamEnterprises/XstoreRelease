...
/*     */ 
/*     */ 
/*     */ public class MerchandiseHierarchyPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -547099193L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.hierarchy_id, t.organization_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_merch_hierarchy_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE hierarchy_id = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.hierarchy_id, t.organization_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_merch_hierarchy_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE hierarchy_id = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_merch_hierarchy_p(hierarchy_id, organization_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._hierarchyId, this._organizationId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_merch_hierarchy_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_merch_hierarchy_p" }; private static final String WHERE_OBJECT = " WHERE hierarchy_id = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE hierarchy_id = ?  AND organization_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._hierarchyId, this._organizationId, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "itm_merch_hierarchy_p";
/*     */   }
/*     */   
...
/* 115 */     return new MerchandiseHierarchyPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class MerchandiseHierarchyPropertyFiller
/*     */     implements IFiller {
/*     */     private MerchandiseHierarchyPropertyDBA _parent;
/*     */     
/*     */     public MerchandiseHierarchyPropertyFiller(MerchandiseHierarchyPropertyDBA argParent) {
/* 123 */       this._parent = argParent;
/*     */     }
/*     */     public void fill(ResultSet argResultSet) throws SQLException {
/* 126 */       this._parent._hierarchyId = argResultSet.getString(1);
/*     */ 
/*     */       
...
/* 173 */     MerchandiseHierarchyPropertyDAO dao = (MerchandiseHierarchyPropertyDAO)argDAO;
/* 174 */     dao.setHierarchyId(this._hierarchyId);
...
/* 190 */     return loadDAO((IDataAccessObject)new MerchandiseHierarchyPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     MerchandiseHierarchyPropertyDAO dao = (MerchandiseHierarchyPropertyDAO)argDAO;
/* 195 */     this._hierarchyId = dao.getHierarchyId();
...
/* 209 */     MerchandiseHierarchyPropertyId id = (MerchandiseHierarchyPropertyId)argId;
/* 210 */     argStatement.setString(1, id.getHierarchyId());
...
/* 217 */     MerchandiseHierarchyPropertyId id = new MerchandiseHierarchyPropertyId();
/* 218 */     id.setHierarchyId(this._hierarchyId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\MerchandiseHierarchyPropertyDBA.class
