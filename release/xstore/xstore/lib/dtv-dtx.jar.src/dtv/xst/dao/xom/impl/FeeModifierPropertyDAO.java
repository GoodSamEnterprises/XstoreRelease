...
/*     */ 
/*     */ 
/*     */ public class FeeModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -851621550L;
/*  23 */   private static final Logger _logger = Logger.getLogger(FeeModifierPropertyDAO.class);
/*     */   
...
/* 221 */     FeeModifierPropertyId id = new FeeModifierPropertyId();
...
/* 231 */     setOrganizationId(((FeeModifierPropertyId)argObjectId).getOrganizationId());
/* 232 */     setOrderId(((FeeModifierPropertyId)argObjectId).getOrderId());
/* 233 */     setSequence(((FeeModifierPropertyId)argObjectId).getSequence());
/* 234 */     setModSequence(((FeeModifierPropertyId)argObjectId).getModSequence());
/* 235 */     setPropertyCode(((FeeModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"FeeModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\FeeModifierPropertyDAO.class
