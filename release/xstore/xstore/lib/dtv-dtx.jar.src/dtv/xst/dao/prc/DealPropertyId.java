...
/*     */   
/*     */   public DealPropertyId(String argObjectIdValue) {
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof DealPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     DealPropertyId other = (DealPropertyId)ob;
...
/*     */ 
/*     */       
/*  92 */       .equals(other._dealId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\DealPropertyId.class
