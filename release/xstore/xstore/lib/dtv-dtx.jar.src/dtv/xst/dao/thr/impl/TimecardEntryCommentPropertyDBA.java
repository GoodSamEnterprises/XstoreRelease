...
/*     */ 
/*     */ 
/*     */ public class TimecardEntryCommentPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.week_ending_date, t.rtl_loc_id, t.wkstn_id, t.party_id, t.comment_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM thr_timecard_entry_comment_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND week_ending_date = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND party_id = ?  AND comment_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  48 */     return "SELECT t.organization_id, t.week_ending_date, t.rtl_loc_id, t.wkstn_id, t.party_id, t.comment_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM thr_timecard_entry_comment_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  54 */     return " WHERE organization_id = ?  AND week_ending_date = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND party_id = ?  AND comment_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  57 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO thr_timecard_entry_comment_p(organization_id, week_ending_date, rtl_loc_id, wkstn_id, party_id, comment_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  74 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE thr_timecard_entry_comment_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  90 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM thr_timecard_entry_comment_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND week_ending_date = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND party_id = ?  AND comment_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  99 */     return " WHERE organization_id = ?  AND week_ending_date = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND party_id = ?  AND comment_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 102 */     return new Object[] { this._organizationId, this._weekEndingDate, this._retailLocationId, this._workstationId, this._partyId, this._commentSeq, this._propertyCode };
/*     */   }
/*     */   
...
/* 111 */     return "thr_timecard_entry_comment_p";
/*     */   }
/*     */   
...
/* 119 */     return new TimecardEntryCommentPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TimecardEntryCommentPropertyFiller
/*     */     implements IFiller {
/*     */     private TimecardEntryCommentPropertyDBA _parent;
/*     */     
/*     */     public TimecardEntryCommentPropertyFiller(TimecardEntryCommentPropertyDBA argParent) {
...
/* 217 */     TimecardEntryCommentPropertyDAO dao = (TimecardEntryCommentPropertyDAO)argDAO;
/* 218 */     dao.setOrganizationId(this._organizationId);
/* 219 */     dao.setWeekEndingDate(this._weekEndingDate);
/* 220 */     dao.setRetailLocationId(this._retailLocationId);
/* 221 */     dao.setWorkstationId(this._workstationId);
/* 222 */     dao.setPartyId(this._partyId);
/* 223 */     dao.setCommentSeq(this._commentSeq);
...
/* 238 */     return loadDAO((IDataAccessObject)new TimecardEntryCommentPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 242 */     TimecardEntryCommentPropertyDAO dao = (TimecardEntryCommentPropertyDAO)argDAO;
/* 243 */     this._organizationId = dao.getOrganizationId();
/* 244 */     this._weekEndingDate = dao.getWeekEndingDate();
/* 245 */     this._retailLocationId = dao.getRetailLocationId();
/* 246 */     this._workstationId = dao.getWorkstationId();
/* 247 */     this._partyId = dao.getPartyId();
/* 248 */     this._commentSeq = dao.getCommentSeq();
...
/* 261 */     TimecardEntryCommentPropertyId id = (TimecardEntryCommentPropertyId)argId;
/* 262 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 263 */     argStatement.setTimestamp(2, new Timestamp(id.getWeekEndingDate().getTime()));
/* 264 */     argStatement.setLong(3, id.getRetailLocationId().longValue());
/* 265 */     argStatement.setLong(4, id.getWorkstationId().longValue());
/* 266 */     argStatement.setLong(5, id.getPartyId().longValue());
/* 267 */     argStatement.setLong(6, id.getCommentSeq().longValue());
/* 268 */     argStatement.setString(7, id.getPropertyCode());
/* 269 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 273 */     TimecardEntryCommentPropertyId id = new TimecardEntryCommentPropertyId();
/* 274 */     id.setOrganizationId(this._organizationId);
/* 275 */     id.setWeekEndingDate(this._weekEndingDate);
/* 276 */     id.setRetailLocationId(this._retailLocationId);
/* 277 */     id.setWorkstationId(this._workstationId);
/* 278 */     id.setPartyId(this._partyId);
/* 279 */     id.setCommentSeq(this._commentSeq);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\impl\TimecardEntryCommentPropertyDBA.class
