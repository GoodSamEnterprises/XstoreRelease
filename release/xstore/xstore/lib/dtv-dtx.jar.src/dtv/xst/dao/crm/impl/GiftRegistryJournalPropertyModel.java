...
/*     */ 
/*     */ 
/*     */ public class GiftRegistryJournalPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IGiftRegistryJournalProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new GiftRegistryJournalPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private GiftRegistryJournalPropertyDAO getDAO_() {
/*  44 */     return (GiftRegistryJournalPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IGiftRegistryJournalProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     if (getDAO_().getJournalSequence() != null) {
/*  92 */       return getDAO_().getJournalSequence().longValue();
/*     */     }
/*     */     
/*  95 */     return 0L;
/*     */   }
...
/* 104 */     if (setJournalSequence_noev(argJournalSequence) && 
/* 105 */       this._events != null && 
/* 106 */       postEventsForChanges()) {
/* 107 */       this._events.post(IGiftRegistryJournalProperty.SET_JOURNALSEQUENCE, Long.valueOf(argJournalSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 116 */     if ((getDAO_().getJournalSequence() == null && Long.valueOf(argJournalSequence) != null) || (
/* 117 */       getDAO_().getJournalSequence() != null && !getDAO_().getJournalSequence().equals(Long.valueOf(argJournalSequence)))) {
/* 118 */       getDAO_().setJournalSequence(Long.valueOf(argJournalSequence));
...
/* 141 */       this._events.post(IGiftRegistryJournalProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 175 */       this._events.post(IGiftRegistryJournalProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(IGiftRegistryJournalProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IGiftRegistryJournalProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IGiftRegistryJournalProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IGiftRegistryJournalProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IGiftRegistryJournalProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IGiftRegistryJournalProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IGiftRegistryJournalProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 434 */     if ("GiftRegistryJournalPropertyExtension".equals(argFieldId)) {
...
/* 444 */     if ("GiftRegistryJournalPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\GiftRegistryJournalPropertyModel.class
