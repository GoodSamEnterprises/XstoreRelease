...
/*     */ 
/*     */ 
/*     */ public class TaxExemptionPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 2109412467L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.tax_exemption_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tax_tax_exemption_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND tax_exemption_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.tax_exemption_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM tax_tax_exemption_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND tax_exemption_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO tax_tax_exemption_p(organization_id, tax_exemption_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._taxExemptionId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE tax_tax_exemption_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM tax_tax_exemption_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND tax_exemption_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND tax_exemption_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._taxExemptionId, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "tax_tax_exemption_p";
/*     */   }
/*     */   
...
/* 115 */     return new TaxExemptionPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TaxExemptionPropertyFiller
/*     */     implements IFiller {
/*     */     private TaxExemptionPropertyDBA _parent;
/*     */     
/*     */     public TaxExemptionPropertyFiller(TaxExemptionPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._taxExemptionId = argResultSet.getString(2);
...
/* 173 */     TaxExemptionPropertyDAO dao = (TaxExemptionPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setTaxExemptionId(this._taxExemptionId);
...
/* 190 */     return loadDAO((IDataAccessObject)new TaxExemptionPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     TaxExemptionPropertyDAO dao = (TaxExemptionPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._taxExemptionId = dao.getTaxExemptionId();
...
/* 209 */     TaxExemptionPropertyId id = (TaxExemptionPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getTaxExemptionId());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     TaxExemptionPropertyId id = new TaxExemptionPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setTaxExemptionId(this._taxExemptionId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxExemptionPropertyDBA.class
