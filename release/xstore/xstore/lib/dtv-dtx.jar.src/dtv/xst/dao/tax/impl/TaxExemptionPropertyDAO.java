...
/*     */ 
/*     */ 
/*     */ public class TaxExemptionPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 2109412467L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxExemptionPropertyDAO.class);
/*     */   
...
/*  48 */     return this._taxExemptionId;
/*     */   }
/*     */   
/*     */   public void setTaxExemptionId(String argTaxExemptionId) {
/*  52 */     if (changed(argTaxExemptionId, this._taxExemptionId, "taxExemptionId")) {
/*  53 */       this._taxExemptionId = (argTaxExemptionId != null && MANAGE_CASE) ? argTaxExemptionId.toUpperCase() : argTaxExemptionId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getTaxExemptionId() != null) {
/* 159 */       buf.append("taxExemptionId").append("=").append(getTaxExemptionId()).append(" ");
/*     */     }
...
/* 193 */     TaxExemptionPropertyId id = new TaxExemptionPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setTaxExemptionId(getTaxExemptionId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((TaxExemptionPropertyId)argObjectId).getOrganizationId());
/* 202 */     setTaxExemptionId(((TaxExemptionPropertyId)argObjectId).getTaxExemptionId());
/* 203 */     setPropertyCode(((TaxExemptionPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"TaxExemptionProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._taxExemptionId != null) values.put("TaxExemptionId", DaoUtils.getXmlSafeFieldValue(12, this._taxExemptionId)); 
...
/* 256 */             setTaxExemptionId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setTaxExemptionId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxExemptionPropertyDAO.class
