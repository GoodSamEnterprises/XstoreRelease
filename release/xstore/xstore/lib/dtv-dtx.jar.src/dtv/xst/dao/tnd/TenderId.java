...
/*     */   public TenderId() {}
/*     */   
/*     */   public TenderId(String argObjectIdValue) {
...
/*  29 */     return this._tenderId;
/*     */   }
/*     */   
/*     */   public void setTenderId(String argTenderId) {
/*  33 */     this._tenderId = (argTenderId != null && MANAGE_CASE) ? argTenderId.toUpperCase() : argTenderId;
/*     */   }
/*     */   
...
/*  63 */       return true;
/*     */     }
/*  65 */     if (!(ob instanceof TenderId)) {
/*  66 */       return false;
/*     */     }
/*  68 */     TenderId other = (TenderId)ob;
/*  69 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  72 */       .equals(other._organizationId))) && ((this._tenderId == null && other._tenderId == null) || (this._tenderId != null && this._tenderId
/*     */ 
/*     */       
/*  75 */       .equals(other._tenderId))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*  82 */       .hashCode()) + ((this._tenderId == null) ? 0 : this._tenderId
/*  83 */       .hashCode());
/*     */   }
/*     */ 
/*     */   
...
/*  97 */       .append("::").append(this._tenderId)
/*  98 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 102 */     if (this._tenderId == null) {
/* 103 */       return false;
/*     */     }
/* 105 */     return true;
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tnd\TenderId.class
