...
/*     */ 
/*     */ 
/*     */ public class CustomerAffiliationPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ICustomerAffiliationProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new CustomerAffiliationPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private CustomerAffiliationPropertyDAO getDAO_() {
/*  44 */     return (CustomerAffiliationPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ICustomerAffiliationProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(ICustomerAffiliationProperty.SET_PARTYID, Long.valueOf(argPartyId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     return getDAO_().getCustomerGroupId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 138 */     if (setCustomerGroupId_noev(argCustomerGroupId) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(ICustomerAffiliationProperty.SET_CUSTOMERGROUPID, argCustomerGroupId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getCustomerGroupId() == null && argCustomerGroupId != null) || (
/* 151 */       getDAO_().getCustomerGroupId() != null && !getDAO_().getCustomerGroupId().equals(argCustomerGroupId))) {
/* 152 */       getDAO_().setCustomerGroupId(argCustomerGroupId);
...
/* 175 */       this._events.post(ICustomerAffiliationProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(ICustomerAffiliationProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(ICustomerAffiliationProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(ICustomerAffiliationProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(ICustomerAffiliationProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(ICustomerAffiliationProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(ICustomerAffiliationProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(ICustomerAffiliationProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(ICustomerAffiliationProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 468 */     if ("CustomerAffiliationPropertyExtension".equals(argFieldId)) {
...
/* 478 */     if ("CustomerAffiliationPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\CustomerAffiliationPropertyModel.class
