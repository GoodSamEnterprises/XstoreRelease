...
/*    */ 
/*    */ 
/*    */ public class TenderTypeCountTenderSerializedCountsRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(6);
/*    */   
/*    */   public String getSelect() {
/* 22 */     return "SELECT business_date, organization_id, rtl_loc_id, serialized_tndr_count_seq, tndr_typcode, trans_seq, wkstn_id, create_date, create_user_id, update_date, update_user_id, amt, serial_number, tndr_id FROM tsn_serialized_tndr_count WHERE business_date = ? AND organization_id = ? AND rtl_loc_id = ? AND tndr_typcode = ? AND trans_seq = ? AND wkstn_id = ?";
/*    */   }
/*    */ 
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TenderTypeCountTenderSerializedCountsRelationshipDBA.class
