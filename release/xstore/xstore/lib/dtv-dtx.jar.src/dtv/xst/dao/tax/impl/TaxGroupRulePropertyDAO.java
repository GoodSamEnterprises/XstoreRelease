...
/*     */ 
/*     */ 
/*     */ public class TaxGroupRulePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1224753349L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxGroupRulePropertyDAO.class);
/*     */   
...
/*  50 */     return this._taxGroupId;
/*     */   }
/*     */   
/*     */   public void setTaxGroupId(String argTaxGroupId) {
/*  54 */     if (changed(argTaxGroupId, this._taxGroupId, "taxGroupId")) {
/*  55 */       this._taxGroupId = (argTaxGroupId != null && MANAGE_CASE) ? argTaxGroupId.toUpperCase() : argTaxGroupId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getTaxLocationId() {
/*  60 */     return this._taxLocationId;
/*     */   }
/*     */   
/*     */   public void setTaxLocationId(String argTaxLocationId) {
/*  64 */     if (changed(argTaxLocationId, this._taxLocationId, "taxLocationId")) {
/*  65 */       this._taxLocationId = (argTaxLocationId != null && MANAGE_CASE) ? argTaxLocationId.toUpperCase() : argTaxLocationId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getTaxRuleSequence() {
/*  70 */     return this._taxRuleSequence;
/*     */   }
/*     */   
/*     */   public void setTaxRuleSequence(Integer argTaxRuleSequence) {
/*  74 */     if (changed(argTaxRuleSequence, this._taxRuleSequence, "taxRuleSequence")) {
/*  75 */       this._taxRuleSequence = argTaxRuleSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getTaxGroupId() != null) {
/* 181 */       buf.append("taxGroupId").append("=").append(getTaxGroupId()).append(" ");
/*     */     }
/* 183 */     if (getTaxLocationId() != null) {
/* 184 */       buf.append("taxLocationId").append("=").append(getTaxLocationId()).append(" ");
/*     */     }
/* 186 */     if (getTaxRuleSequence() != null) {
/* 187 */       buf.append("taxRuleSequence").append("=").append(getTaxRuleSequence()).append(" ");
/*     */     }
...
/* 221 */     TaxGroupRulePropertyId id = new TaxGroupRulePropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setTaxGroupId(getTaxGroupId());
/* 224 */     id.setTaxLocationId(getTaxLocationId());
/* 225 */     id.setTaxRuleSequence(getTaxRuleSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((TaxGroupRulePropertyId)argObjectId).getOrganizationId());
/* 232 */     setTaxGroupId(((TaxGroupRulePropertyId)argObjectId).getTaxGroupId());
/* 233 */     setTaxLocationId(((TaxGroupRulePropertyId)argObjectId).getTaxLocationId());
/* 234 */     setTaxRuleSequence(((TaxGroupRulePropertyId)argObjectId).getTaxRuleSequence());
/* 235 */     setPropertyCode(((TaxGroupRulePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"TaxGroupRuleProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._taxGroupId != null) values.put("TaxGroupId", DaoUtils.getXmlSafeFieldValue(12, this._taxGroupId)); 
/* 255 */     if (this._taxLocationId != null) values.put("TaxLocationId", DaoUtils.getXmlSafeFieldValue(12, this._taxLocationId)); 
/* 256 */     if (this._taxRuleSequence != null) values.put("TaxRuleSequence", DaoUtils.getXmlSafeFieldValue(4, this._taxRuleSequence)); 
...
/* 290 */             setTaxGroupId((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setTaxGroupId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "TaxLocationId":
...
/* 299 */             setTaxLocationId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setTaxLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setTaxRuleSequence((Integer)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setTaxRuleSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxGroupRulePropertyDAO.class
