...
/*     */ 
/*     */ 
/*     */ public class TransactionNotesPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1876613528L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.business_date, t.note_seq, t.organization_id, t.rtl_loc_id, t.trans_seq, t.wkstn_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_trans_notes_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE business_date = ?  AND note_seq = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND trans_seq = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   
...
/*  48 */     return "SELECT t.business_date, t.note_seq, t.organization_id, t.rtl_loc_id, t.trans_seq, t.wkstn_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_trans_notes_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  54 */     return " WHERE business_date = ?  AND note_seq = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND trans_seq = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  57 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trn_trans_notes_p(business_date, note_seq, organization_id, rtl_loc_id, trans_seq, wkstn_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  64 */     Object[][] insertParameterObject = { { this._businessDate, this._noteSequence, this._organizationId, this._retailLocationId, this._transactionSequence, this._workstationId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  74 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trn_trans_notes_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  90 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trn_trans_notes_p" }; private static final String WHERE_OBJECT = " WHERE business_date = ?  AND note_seq = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND trans_seq = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   
...
/*  99 */     return " WHERE business_date = ?  AND note_seq = ?  AND organization_id = ?  AND rtl_loc_id = ?  AND trans_seq = ?  AND wkstn_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 102 */     return new Object[] { this._businessDate, this._noteSequence, this._organizationId, this._retailLocationId, this._transactionSequence, this._workstationId, this._propertyCode };
/*     */   }
/*     */   
...
/* 119 */     return new TransactionNotesPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class TransactionNotesPropertyFiller
/*     */     implements IFiller {
/*     */     private TransactionNotesPropertyDBA _parent;
/*     */     
/*     */     public TransactionNotesPropertyFiller(TransactionNotesPropertyDBA argParent) {
...
/* 143 */         this._parent._noteSequence = Integer.valueOf(i);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/* 217 */     TransactionNotesPropertyDAO dao = (TransactionNotesPropertyDAO)argDAO;
/* 218 */     dao.setBusinessDate(this._businessDate);
/* 219 */     dao.setNoteSequence(this._noteSequence);
...
/* 238 */     return loadDAO((IDataAccessObject)new TransactionNotesPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 242 */     TransactionNotesPropertyDAO dao = (TransactionNotesPropertyDAO)argDAO;
/* 243 */     this._businessDate = dao.getBusinessDate();
/* 244 */     this._noteSequence = dao.getNoteSequence();
...
/* 261 */     TransactionNotesPropertyId id = (TransactionNotesPropertyId)argId;
/* 262 */     argStatement.setTimestamp(1, new Timestamp(id.getBusinessDate().getTime()));
/* 263 */     argStatement.setInt(2, id.getNoteSequence().intValue());
...
/* 273 */     TransactionNotesPropertyId id = new TransactionNotesPropertyId();
/* 274 */     id.setBusinessDate(this._businessDate);
/* 275 */     id.setNoteSequence(this._noteSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\TransactionNotesPropertyDBA.class
