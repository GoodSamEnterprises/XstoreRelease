...
/*     */ 
/*     */ 
/*     */ public class ShipperMethodPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.shipper_method_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_shipper_method_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND shipper_method_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.shipper_method_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_shipper_method_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND shipper_method_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO inv_shipper_method_p(organization_id, shipper_method_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._shipperMethodId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE inv_shipper_method_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM inv_shipper_method_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND shipper_method_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND shipper_method_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._shipperMethodId, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "inv_shipper_method_p";
/*     */   }
/*     */   
...
/* 115 */     return new ShipperMethodPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ShipperMethodPropertyFiller
/*     */     implements IFiller {
/*     */     private ShipperMethodPropertyDBA _parent;
/*     */     
/*     */     public ShipperMethodPropertyFiller(ShipperMethodPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 134 */       this._parent._shipperMethodId = argResultSet.getString(2);
...
/* 173 */     ShipperMethodPropertyDAO dao = (ShipperMethodPropertyDAO)argDAO;
/* 174 */     dao.setOrganizationId(this._organizationId);
/* 175 */     dao.setShipperMethodId(this._shipperMethodId);
...
/* 190 */     return loadDAO((IDataAccessObject)new ShipperMethodPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     ShipperMethodPropertyDAO dao = (ShipperMethodPropertyDAO)argDAO;
/* 195 */     this._organizationId = dao.getOrganizationId();
/* 196 */     this._shipperMethodId = dao.getShipperMethodId();
...
/* 209 */     ShipperMethodPropertyId id = (ShipperMethodPropertyId)argId;
/* 210 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 211 */     argStatement.setString(2, id.getShipperMethodId());
/* 212 */     argStatement.setString(3, id.getPropertyCode());
/* 213 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 217 */     ShipperMethodPropertyId id = new ShipperMethodPropertyId();
/* 218 */     id.setOrganizationId(this._organizationId);
/* 219 */     id.setShipperMethodId(this._shipperMethodId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\ShipperMethodPropertyDBA.class
