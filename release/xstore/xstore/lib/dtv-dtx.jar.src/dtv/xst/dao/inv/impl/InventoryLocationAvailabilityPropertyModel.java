...
/*     */ 
/*     */ 
/*     */ public class InventoryLocationAvailabilityPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IInventoryLocationAvailabilityProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new InventoryLocationAvailabilityPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private InventoryLocationAvailabilityPropertyDAO getDAO_() {
/*  44 */     return (InventoryLocationAvailabilityPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     return getDAO_().getLocationId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 138 */     if (setLocationId_noev(argLocationId) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_LOCATIONID, argLocationId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getLocationId() == null && argLocationId != null) || (
/* 151 */       getDAO_().getLocationId() != null && !getDAO_().getLocationId().equals(argLocationId))) {
/* 152 */       getDAO_().setLocationId(argLocationId);
...
/* 164 */     return getDAO_().getAvailabilityCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */     if (setAvailabilityCode_noev(argAvailabilityCode) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_AVAILABILITYCODE, argAvailabilityCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getAvailabilityCode() == null && argAvailabilityCode != null) || (
/* 185 */       getDAO_().getAvailabilityCode() != null && !getDAO_().getAvailabilityCode().equals(argAvailabilityCode))) {
/* 186 */       getDAO_().setAvailabilityCode(argAvailabilityCode);
...
/* 209 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(IInventoryLocationAvailabilityProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 502 */     if ("InventoryLocationAvailabilityPropertyExtension".equals(argFieldId)) {
...
/* 512 */     if ("InventoryLocationAvailabilityPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryLocationAvailabilityPropertyModel.class
