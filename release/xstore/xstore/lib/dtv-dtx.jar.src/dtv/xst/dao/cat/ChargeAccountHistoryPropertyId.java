...
/*     */ 
/*     */ 
/*     */ public class ChargeAccountHistoryPropertyId
...
/*     */   
/*     */   public ChargeAccountHistoryPropertyId() {}
/*     */   
/*     */   public ChargeAccountHistoryPropertyId(String argObjectIdValue) {
...
/*  48 */     return this._historySeq;
/*     */   }
/*     */   
/*     */   public void setHistorySeq(Long argHistorySeq) {
/*  52 */     this._historySeq = argHistorySeq;
/*     */   }
/*     */   
...
/*  89 */       str = tokens[3];
/*     */       
/*  91 */       setHistorySeq(Long.valueOf(str));
/*  92 */       str = tokens[4];
/*     */       
...
/* 109 */       return true;
/*     */     }
/* 111 */     if (!(ob instanceof ChargeAccountHistoryPropertyId)) {
/* 112 */       return false;
/*     */     }
/* 114 */     ChargeAccountHistoryPropertyId other = (ChargeAccountHistoryPropertyId)ob;
...
/*     */ 
/*     */       
/* 124 */       .equals(other._custAccountCode))) && ((this._historySeq == null && other._historySeq == null) || (this._historySeq != null && this._historySeq
/*     */ 
/*     */       
/* 127 */       .equals(other._historySeq))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 139 */       .hashCode()) + ((this._historySeq == null) ? 0 : this._historySeq
...
/* 146 */     return "ChargeAccountHistoryProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 157 */       .append("::").append(String.valueOf(this._historySeq))
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\ChargeAccountHistoryPropertyId.class
