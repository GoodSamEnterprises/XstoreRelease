...
/*     */ 
/*     */ 
/*     */ public class ChargeAccountHistoryPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -940874608L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ChargeAccountHistoryPropertyDAO.class);
/*     */   
...
/*  70 */     return this._historySeq;
/*     */   }
/*     */   
/*     */   public void setHistorySeq(Long argHistorySeq) {
/*  74 */     if (changed(argHistorySeq, this._historySeq, "historySeq")) {
/*  75 */       this._historySeq = argHistorySeq;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 186 */     if (getHistorySeq() != null) {
/* 187 */       buf.append("historySeq").append("=").append(getHistorySeq()).append(" ");
/*     */     }
...
/* 221 */     ChargeAccountHistoryPropertyId id = new ChargeAccountHistoryPropertyId();
...
/* 225 */     id.setHistorySeq(getHistorySeq());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((ChargeAccountHistoryPropertyId)argObjectId).getOrganizationId());
/* 232 */     setCustAccountId(((ChargeAccountHistoryPropertyId)argObjectId).getCustAccountId());
/* 233 */     setCustAccountCode(((ChargeAccountHistoryPropertyId)argObjectId).getCustAccountCode());
/* 234 */     setHistorySeq(((ChargeAccountHistoryPropertyId)argObjectId).getHistorySeq());
/* 235 */     setPropertyCode(((ChargeAccountHistoryPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"ChargeAccountHistoryProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 256 */     if (this._historySeq != null) values.put("HistorySeq", DaoUtils.getXmlSafeFieldValue(-5, this._historySeq)); 
...
/* 308 */             setHistorySeq((Long)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setHistorySeq() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\ChargeAccountHistoryPropertyDAO.class
