...
/*     */ 
/*     */ 
/*     */ public class RetailLocationPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 933353453L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_rtl_loc_p t";
...
/*  44 */     return "SELECT t.organization_id, t.rtl_loc_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_rtl_loc_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO loc_rtl_loc_p(organization_id, rtl_loc_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE loc_rtl_loc_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM loc_rtl_loc_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND property_code = ?  ";
/*     */   
...
/* 115 */     return new RetailLocationPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class RetailLocationPropertyFiller
/*     */     implements IFiller {
/*     */     private RetailLocationPropertyDBA _parent;
/*     */     
/*     */     public RetailLocationPropertyFiller(RetailLocationPropertyDBA argParent) {
...
/* 180 */     RetailLocationPropertyDAO dao = (RetailLocationPropertyDAO)argDAO;
...
/* 197 */     return loadDAO((IDataAccessObject)new RetailLocationPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 201 */     RetailLocationPropertyDAO dao = (RetailLocationPropertyDAO)argDAO;
...
/* 216 */     RetailLocationPropertyId id = (RetailLocationPropertyId)argId;
...
/* 224 */     RetailLocationPropertyId id = new RetailLocationPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\RetailLocationPropertyDBA.class
