...
/*     */ 
/*     */ 
/*     */ public class OrderLinePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1571836983L;
/*  23 */   private static final Logger _logger = Logger.getLogger(OrderLinePropertyDAO.class);
/*     */   
...
/* 207 */     OrderLinePropertyId id = new OrderLinePropertyId();
...
/* 216 */     setOrganizationId(((OrderLinePropertyId)argObjectId).getOrganizationId());
/* 217 */     setOrderId(((OrderLinePropertyId)argObjectId).getOrderId());
/* 218 */     setSequence(((OrderLinePropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((OrderLinePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"OrderLineProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderLinePropertyDAO.class
