...
/*     */ 
/*     */ 
/*     */ public class WarrantyPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.warranty_nbr, t.warranty_typcode, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_warranty_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND warranty_nbr = ?  AND warranty_typcode = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.warranty_nbr, t.warranty_typcode, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_warranty_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND warranty_nbr = ?  AND warranty_typcode = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_warranty_p(organization_id, warranty_nbr, warranty_typcode, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._warrantyNbr, this._warrantyTypeCode, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_warranty_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_warranty_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND warranty_nbr = ?  AND warranty_typcode = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND warranty_nbr = ?  AND warranty_typcode = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._warrantyNbr, this._warrantyTypeCode, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new WarrantyPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class WarrantyPropertyFiller
/*     */     implements IFiller {
/*     */     private WarrantyPropertyDBA _parent;
/*     */     
/*     */     public WarrantyPropertyFiller(WarrantyPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._warrantyNbr = argResultSet.getString(2);
/* 136 */       this._parent._warrantyTypeCode = argResultSet.getString(3);
...
/* 175 */     WarrantyPropertyDAO dao = (WarrantyPropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setWarrantyNbr(this._warrantyNbr);
/* 178 */     dao.setWarrantyTypeCode(this._warrantyTypeCode);
...
/* 193 */     return loadDAO((IDataAccessObject)new WarrantyPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     WarrantyPropertyDAO dao = (WarrantyPropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._warrantyNbr = dao.getWarrantyNbr();
/* 200 */     this._warrantyTypeCode = dao.getWarrantyTypeCode();
...
/* 213 */     WarrantyPropertyId id = (WarrantyPropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getWarrantyNbr());
/* 216 */     argStatement.setString(3, id.getWarrantyTypeCode());
/* 217 */     argStatement.setString(4, id.getPropertyCode());
/* 218 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 222 */     WarrantyPropertyId id = new WarrantyPropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setWarrantyNbr(this._warrantyNbr);
/* 225 */     id.setWarrantyTypeCode(this._warrantyTypeCode);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyPropertyDBA.class
