...
/*     */ 
/*     */ 
/*     */ public class EmployeePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -573776189L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeePropertyDAO.class);
/*     */   
...
/* 193 */     EmployeePropertyId id = new EmployeePropertyId();
...
/* 201 */     setOrganizationId(((EmployeePropertyId)argObjectId).getOrganizationId());
/* 202 */     setEmployeeId(((EmployeePropertyId)argObjectId).getEmployeeId());
/* 203 */     setPropertyCode(((EmployeePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"EmployeeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeePropertyDAO.class
