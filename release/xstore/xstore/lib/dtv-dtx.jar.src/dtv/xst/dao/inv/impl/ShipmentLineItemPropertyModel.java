...
/*     */ 
/*     */ 
/*     */ public class ShipmentLineItemPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IShipmentLineItemProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ShipmentLineItemPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ShipmentLineItemPropertyDAO getDAO_() {
/*  44 */     return (ShipmentLineItemPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IShipmentLineItemProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IShipmentLineItemProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 141 */       this._events.post(IShipmentLineItemProperty.SET_DOCUMENTID, argDocumentId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 175 */       this._events.post(IShipmentLineItemProperty.SET_DOCUMENTTYPECODE, argDocumentTypeCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 198 */     if (getDAO_().getShipmentSequence() != null) {
/* 199 */       return getDAO_().getShipmentSequence().intValue();
/*     */     }
/*     */     
/* 202 */     return 0;
/*     */   }
...
/* 211 */     if (setShipmentSequence_noev(argShipmentSequence) && 
/* 212 */       this._events != null && 
/* 213 */       postEventsForChanges()) {
/* 214 */       this._events.post(IShipmentLineItemProperty.SET_SHIPMENTSEQUENCE, Integer.valueOf(argShipmentSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 223 */     if ((getDAO_().getShipmentSequence() == null && Integer.valueOf(argShipmentSequence) != null) || (
/* 224 */       getDAO_().getShipmentSequence() != null && !getDAO_().getShipmentSequence().equals(Integer.valueOf(argShipmentSequence)))) {
/* 225 */       getDAO_().setShipmentSequence(Integer.valueOf(argShipmentSequence));
...
/* 237 */     if (getDAO_().getLineItemSequence() != null) {
/* 238 */       return getDAO_().getLineItemSequence().intValue();
/*     */     }
/*     */     
/* 241 */     return 0;
/*     */   }
...
/* 250 */     if (setLineItemSequence_noev(argLineItemSequence) && 
/* 251 */       this._events != null && 
/* 252 */       postEventsForChanges()) {
/* 253 */       this._events.post(IShipmentLineItemProperty.SET_LINEITEMSEQUENCE, Integer.valueOf(argLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 262 */     if ((getDAO_().getLineItemSequence() == null && Integer.valueOf(argLineItemSequence) != null) || (
/* 263 */       getDAO_().getLineItemSequence() != null && !getDAO_().getLineItemSequence().equals(Integer.valueOf(argLineItemSequence)))) {
/* 264 */       getDAO_().setLineItemSequence(Integer.valueOf(argLineItemSequence));
...
/* 287 */       this._events.post(IShipmentLineItemProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 321 */       this._events.post(IShipmentLineItemProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 355 */       this._events.post(IShipmentLineItemProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 389 */       this._events.post(IShipmentLineItemProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 423 */       this._events.post(IShipmentLineItemProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 457 */       this._events.post(IShipmentLineItemProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 491 */       this._events.post(IShipmentLineItemProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 525 */       this._events.post(IShipmentLineItemProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 559 */       this._events.post(IShipmentLineItemProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 580 */     if ("ShipmentLineItemPropertyExtension".equals(argFieldId)) {
...
/* 590 */     if ("ShipmentLineItemPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\ShipmentLineItemPropertyModel.class
