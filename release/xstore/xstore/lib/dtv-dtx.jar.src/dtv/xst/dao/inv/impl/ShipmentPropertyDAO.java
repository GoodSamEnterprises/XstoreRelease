...
/*     */ 
/*     */ 
/*     */ public class ShipmentPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1798324817L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ShipmentPropertyDAO.class);
/*     */   
...
/* 235 */     ShipmentPropertyId id = new ShipmentPropertyId();
...
/* 246 */     setOrganizationId(((ShipmentPropertyId)argObjectId).getOrganizationId());
/* 247 */     setRetailLocationId(((ShipmentPropertyId)argObjectId).getRetailLocationId());
/* 248 */     setDocumentId(((ShipmentPropertyId)argObjectId).getDocumentId());
/* 249 */     setDocumentTypeCode(((ShipmentPropertyId)argObjectId).getDocumentTypeCode());
/* 250 */     setShipmentSequence(((ShipmentPropertyId)argObjectId).getShipmentSequence());
/* 251 */     setPropertyCode(((ShipmentPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"ShipmentProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\ShipmentPropertyDAO.class
