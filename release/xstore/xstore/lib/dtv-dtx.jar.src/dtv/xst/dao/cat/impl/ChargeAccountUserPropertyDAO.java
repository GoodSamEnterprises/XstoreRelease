...
/*     */ 
/*     */ 
/*     */ public class ChargeAccountUserPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2123975143L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ChargeAccountUserPropertyDAO.class);
/*     */   
...
/*  70 */     return this._accountUserId;
/*     */   }
/*     */   
/*     */   public void setAccountUserId(String argAccountUserId) {
/*  74 */     if (changed(argAccountUserId, this._accountUserId, "accountUserId")) {
/*  75 */       this._accountUserId = (argAccountUserId != null && MANAGE_CASE) ? argAccountUserId.toUpperCase() : argAccountUserId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 186 */     if (getAccountUserId() != null) {
/* 187 */       buf.append("accountUserId").append("=").append(getAccountUserId()).append(" ");
/*     */     }
...
/* 221 */     ChargeAccountUserPropertyId id = new ChargeAccountUserPropertyId();
...
/* 225 */     id.setAccountUserId(getAccountUserId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((ChargeAccountUserPropertyId)argObjectId).getOrganizationId());
/* 232 */     setCustAccountId(((ChargeAccountUserPropertyId)argObjectId).getCustAccountId());
/* 233 */     setCustAccountCode(((ChargeAccountUserPropertyId)argObjectId).getCustAccountCode());
/* 234 */     setAccountUserId(((ChargeAccountUserPropertyId)argObjectId).getAccountUserId());
/* 235 */     setPropertyCode(((ChargeAccountUserPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"ChargeAccountUserProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 256 */     if (this._accountUserId != null) values.put("AccountUserId", DaoUtils.getXmlSafeFieldValue(12, this._accountUserId)); 
...
/* 308 */             setAccountUserId((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setAccountUserId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\ChargeAccountUserPropertyDAO.class
