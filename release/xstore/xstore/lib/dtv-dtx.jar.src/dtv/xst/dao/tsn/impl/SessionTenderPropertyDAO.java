...
/*     */ 
/*     */ 
/*     */ public class SessionTenderPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2014019361L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SessionTenderPropertyDAO.class);
/*     */   
...
/*  70 */     return this._tenderId;
/*     */   }
/*     */   
/*     */   public void setTenderId(String argTenderId) {
/*  74 */     if (changed(argTenderId, this._tenderId, "tenderId")) {
/*  75 */       this._tenderId = (argTenderId != null && MANAGE_CASE) ? argTenderId.toUpperCase() : argTenderId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 186 */     if (getTenderId() != null) {
/* 187 */       buf.append("tenderId").append("=").append(getTenderId()).append(" ");
/*     */     }
...
/* 221 */     SessionTenderPropertyId id = new SessionTenderPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setRetailLocationId(getRetailLocationId());
/* 224 */     id.setSessionId(getSessionId());
/* 225 */     id.setTenderId(getTenderId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((SessionTenderPropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((SessionTenderPropertyId)argObjectId).getRetailLocationId());
/* 233 */     setSessionId(((SessionTenderPropertyId)argObjectId).getSessionId());
/* 234 */     setTenderId(((SessionTenderPropertyId)argObjectId).getTenderId());
/* 235 */     setPropertyCode(((SessionTenderPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"SessionTenderProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 256 */     if (this._tenderId != null) values.put("TenderId", DaoUtils.getXmlSafeFieldValue(12, this._tenderId)); 
...
/* 308 */             setTenderId((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setTenderId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\SessionTenderPropertyDAO.class
