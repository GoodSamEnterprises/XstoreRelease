...
/*    */ 
/*    */ 
/*    */ public class RetailPriceModifierPropertiesRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(7);
/*    */   
/*    */   public String getSelect() {
/* 22 */     return "SELECT business_date, organization_id, rtl_loc_id, rtl_price_mod_seq_nbr, rtrans_lineitm_seq, trans_seq, wkstn_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id FROM trl_rtl_price_mod_p WHERE business_date = ? AND organization_id = ? AND rtl_loc_id = ? AND rtl_price_mod_seq_nbr = ? AND rtrans_lineitm_seq = ? AND trans_seq = ? AND wkstn_id = ?";
/*    */   }
/*    */ 
/*    */   
/*    */   public void setParent(IDataAccessObject argDAO) {
/* 27 */     RetailPriceModifierDAO dao = (RetailPriceModifierDAO)argDAO;
...
/* 31 */     this._parameterList.add(dao.getRetailPriceModifierSequenceNbr());
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailPriceModifierPropertiesRelationshipDBA.class
