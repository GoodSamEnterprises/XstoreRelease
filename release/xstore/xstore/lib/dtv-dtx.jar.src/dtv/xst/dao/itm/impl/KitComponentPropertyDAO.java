...
/*     */ 
/*     */ 
/*     */ public class KitComponentPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1373131300L;
/*  23 */   private static final Logger _logger = Logger.getLogger(KitComponentPropertyDAO.class);
/*     */   
...
/*  50 */     return this._kitItemId;
/*     */   }
/*     */   
/*     */   public void setKitItemId(String argKitItemId) {
/*  54 */     if (changed(argKitItemId, this._kitItemId, "kitItemId")) {
/*  55 */       this._kitItemId = (argKitItemId != null && MANAGE_CASE) ? argKitItemId.toUpperCase() : argKitItemId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getComponentItemId() {
/*  60 */     return this._componentItemId;
/*     */   }
/*     */   
/*     */   public void setComponentItemId(String argComponentItemId) {
/*  64 */     if (changed(argComponentItemId, this._componentItemId, "componentItemId")) {
/*  65 */       this._componentItemId = (argComponentItemId != null && MANAGE_CASE) ? argComponentItemId.toUpperCase() : argComponentItemId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getSequenceNumber() {
/*  70 */     return this._sequenceNumber;
/*     */   }
/*     */   
/*     */   public void setSequenceNumber(Long argSequenceNumber) {
/*  74 */     if (changed(argSequenceNumber, this._sequenceNumber, "sequenceNumber")) {
/*  75 */       this._sequenceNumber = argSequenceNumber;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getKitItemId() != null) {
/* 181 */       buf.append("kitItemId").append("=").append(getKitItemId()).append(" ");
/*     */     }
/* 183 */     if (getComponentItemId() != null) {
/* 184 */       buf.append("componentItemId").append("=").append(getComponentItemId()).append(" ");
/*     */     }
/* 186 */     if (getSequenceNumber() != null) {
/* 187 */       buf.append("sequenceNumber").append("=").append(getSequenceNumber()).append(" ");
/*     */     }
...
/* 221 */     KitComponentPropertyId id = new KitComponentPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setKitItemId(getKitItemId());
/* 224 */     id.setComponentItemId(getComponentItemId());
/* 225 */     id.setSequenceNumber(getSequenceNumber());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((KitComponentPropertyId)argObjectId).getOrganizationId());
/* 232 */     setKitItemId(((KitComponentPropertyId)argObjectId).getKitItemId());
/* 233 */     setComponentItemId(((KitComponentPropertyId)argObjectId).getComponentItemId());
/* 234 */     setSequenceNumber(((KitComponentPropertyId)argObjectId).getSequenceNumber());
/* 235 */     setPropertyCode(((KitComponentPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"KitComponentProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._kitItemId != null) values.put("KitItemId", DaoUtils.getXmlSafeFieldValue(12, this._kitItemId)); 
/* 255 */     if (this._componentItemId != null) values.put("ComponentItemId", DaoUtils.getXmlSafeFieldValue(12, this._componentItemId)); 
/* 256 */     if (this._sequenceNumber != null) values.put("SequenceNumber", DaoUtils.getXmlSafeFieldValue(-5, this._sequenceNumber)); 
...
/* 290 */             setKitItemId((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setKitItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 299 */             setComponentItemId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setComponentItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "SequenceNumber":
...
/* 308 */             setSequenceNumber((Long)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setSequenceNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\KitComponentPropertyDAO.class
