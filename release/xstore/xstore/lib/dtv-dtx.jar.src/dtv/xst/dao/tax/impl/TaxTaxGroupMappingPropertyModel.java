...
/*     */ 
/*     */ 
/*     */ public class TaxTaxGroupMappingPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITaxTaxGroupMappingProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TaxTaxGroupMappingPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TaxTaxGroupMappingPropertyDAO getDAO_() {
/*  44 */     return (TaxTaxGroupMappingPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITaxTaxGroupMappingProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getCustomerGroup();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setCustomerGroup_noev(argCustomerGroup) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ITaxTaxGroupMappingProperty.SET_CUSTOMERGROUP, argCustomerGroup);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getCustomerGroup() == null && argCustomerGroup != null) || (
/* 112 */       getDAO_().getCustomerGroup() != null && !getDAO_().getCustomerGroup().equals(argCustomerGroup))) {
/* 113 */       getDAO_().setCustomerGroup(argCustomerGroup);
...
/* 136 */       this._events.post(ITaxTaxGroupMappingProperty.SET_TAXGROUPID, argTaxGroupId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 159 */     if (getDAO_().getRtlLocId() != null) {
/* 160 */       return getDAO_().getRtlLocId().intValue();
/*     */     }
/*     */     
/* 163 */     return 0;
/*     */   }
...
/* 172 */     if (setRtlLocId_noev(argRtlLocId) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(ITaxTaxGroupMappingProperty.SET_RTLLOCID, Integer.valueOf(argRtlLocId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getRtlLocId() == null && Integer.valueOf(argRtlLocId) != null) || (
/* 185 */       getDAO_().getRtlLocId() != null && !getDAO_().getRtlLocId().equals(Integer.valueOf(argRtlLocId)))) {
/* 186 */       getDAO_().setRtlLocId(Integer.valueOf(argRtlLocId));
...
/* 209 */       this._events.post(ITaxTaxGroupMappingProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(ITaxTaxGroupMappingProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(ITaxTaxGroupMappingProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(ITaxTaxGroupMappingProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(ITaxTaxGroupMappingProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(ITaxTaxGroupMappingProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(ITaxTaxGroupMappingProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(ITaxTaxGroupMappingProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(ITaxTaxGroupMappingProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 502 */     if ("TaxTaxGroupMappingPropertyExtension".equals(argFieldId)) {
...
/* 512 */     if ("TaxTaxGroupMappingPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxTaxGroupMappingPropertyModel.class
