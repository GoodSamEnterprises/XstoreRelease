...
/*     */ 
/*     */ 
/*     */ public class WorkOrderPriceCodePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1316909650L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WorkOrderPriceCodePropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getPriceCode() != null) {
/* 159 */       buf.append("priceCode").append("=").append(getPriceCode()).append(" ");
/*     */     }
...
/* 193 */     WorkOrderPriceCodePropertyId id = new WorkOrderPriceCodePropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setPriceCode(getPriceCode());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((WorkOrderPriceCodePropertyId)argObjectId).getOrganizationId());
/* 202 */     setPriceCode(((WorkOrderPriceCodePropertyId)argObjectId).getPriceCode());
/* 203 */     setPropertyCode(((WorkOrderPriceCodePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"WorkOrderPriceCodeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._priceCode != null) values.put("PriceCode", DaoUtils.getXmlSafeFieldValue(12, this._priceCode)); 
...
/* 256 */             setPriceCode((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setPriceCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkOrderPriceCodePropertyDAO.class
