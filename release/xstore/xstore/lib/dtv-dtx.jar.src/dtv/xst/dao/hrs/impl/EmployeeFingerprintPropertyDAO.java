...
/*     */ 
/*     */ 
/*     */ public class EmployeeFingerprintPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1795635925L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeFingerprintPropertyDAO.class);
/*     */   
...
/* 207 */     EmployeeFingerprintPropertyId id = new EmployeeFingerprintPropertyId();
...
/* 216 */     setOrganizationId(((EmployeeFingerprintPropertyId)argObjectId).getOrganizationId());
/* 217 */     setEmployeeId(((EmployeeFingerprintPropertyId)argObjectId).getEmployeeId());
/* 218 */     setSequence(((EmployeeFingerprintPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((EmployeeFingerprintPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"EmployeeFingerprintProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeFingerprintPropertyDAO.class
