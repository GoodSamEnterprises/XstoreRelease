...
/*     */ 
/*     */ 
/*     */ public class InventoryDocumentLineItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -299525965L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryDocumentLineItemPropertyDAO.class);
/*     */   
...
/* 235 */     InventoryDocumentLineItemPropertyId id = new InventoryDocumentLineItemPropertyId();
...
/* 246 */     setDocumentId(((InventoryDocumentLineItemPropertyId)argObjectId).getDocumentId());
/* 247 */     setDocumentTypeCode(((InventoryDocumentLineItemPropertyId)argObjectId).getDocumentTypeCode());
/* 248 */     setInventoryDocumentLineNumber(((InventoryDocumentLineItemPropertyId)argObjectId).getInventoryDocumentLineNumber());
/* 249 */     setOrganizationId(((InventoryDocumentLineItemPropertyId)argObjectId).getOrganizationId());
/* 250 */     setRetailLocationId(((InventoryDocumentLineItemPropertyId)argObjectId).getRetailLocationId());
/* 251 */     setPropertyCode(((InventoryDocumentLineItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"InventoryDocumentLineItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryDocumentLineItemPropertyDAO.class
