...
/*     */ 
/*     */ 
/*     */ public class RetailPriceModifierPropertyId
...
/*     */   
/*     */   public RetailPriceModifierPropertyId() {}
/*     */   
/*     */   public RetailPriceModifierPropertyId(String argObjectIdValue) {
...
/*  54 */     return this._retailPriceModifierSequenceNbr;
/*     */   }
/*     */   
/*     */   public void setRetailPriceModifierSequenceNbr(Integer argRetailPriceModifierSequenceNbr) {
/*  58 */     this._retailPriceModifierSequenceNbr = argRetailPriceModifierSequenceNbr;
/*     */   }
/*     */   
...
/* 115 */       str = tokens[3];
/*     */       
/* 117 */       setRetailPriceModifierSequenceNbr(Integer.valueOf(str));
/* 118 */       str = tokens[4];
/*     */       
...
/* 144 */       return true;
/*     */     }
/* 146 */     if (!(ob instanceof RetailPriceModifierPropertyId)) {
/* 147 */       return false;
/*     */     }
/* 149 */     RetailPriceModifierPropertyId other = (RetailPriceModifierPropertyId)ob;
...
/*     */ 
/*     */       
/* 159 */       .equals(other._retailLocationId))) && ((this._retailPriceModifierSequenceNbr == null && other._retailPriceModifierSequenceNbr == null) || (this._retailPriceModifierSequenceNbr != null && this._retailPriceModifierSequenceNbr
/*     */ 
/*     */       
/* 162 */       .equals(other._retailPriceModifierSequenceNbr))) && ((this._retailTransactionLineItemSequence == null && other._retailTransactionLineItemSequence == null) || (this._retailTransactionLineItemSequence != null && this._retailTransactionLineItemSequence
/*     */ 
/*     */       
...
/* 183 */       .hashCode()) + ((this._retailPriceModifierSequenceNbr == null) ? 0 : this._retailPriceModifierSequenceNbr
...
/* 193 */     return "RetailPriceModifierProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 204 */       .append("::").append(String.valueOf(this._retailPriceModifierSequenceNbr))
...
/* 217 */       return false;
/*     */     }
/* 219 */     if (this._retailPriceModifierSequenceNbr == null) {
/* 220 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\RetailPriceModifierPropertyId.class
