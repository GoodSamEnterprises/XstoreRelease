...
/*     */ 
/*     */ 
/*     */ public class TenderAuthLogPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ITenderAuthLogProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new TenderAuthLogPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private TenderAuthLogPropertyDAO getDAO_() {
/*  44 */     return (TenderAuthLogPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ITenderAuthLogProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(ITenderAuthLogProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 146 */       this._events.post(ITenderAuthLogProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(ITenderAuthLogProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(ITenderAuthLogProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(ITenderAuthLogProperty.SET_RETAILTRANSACTIONLINEITEMSEQUENCE, Integer.valueOf(argRetailTransactionLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 281 */     if (getDAO_().getAttemptSequence() != null) {
/* 282 */       return getDAO_().getAttemptSequence().intValue();
/*     */     }
/*     */     
/* 285 */     return 0;
/*     */   }
...
/* 294 */     if (setAttemptSequence_noev(argAttemptSequence) && 
/* 295 */       this._events != null && 
/* 296 */       postEventsForChanges()) {
/* 297 */       this._events.post(ITenderAuthLogProperty.SET_ATTEMPTSEQUENCE, Integer.valueOf(argAttemptSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 306 */     if ((getDAO_().getAttemptSequence() == null && Integer.valueOf(argAttemptSequence) != null) || (
/* 307 */       getDAO_().getAttemptSequence() != null && !getDAO_().getAttemptSequence().equals(Integer.valueOf(argAttemptSequence)))) {
/* 308 */       getDAO_().setAttemptSequence(Integer.valueOf(argAttemptSequence));
...
/* 331 */       this._events.post(ITenderAuthLogProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(ITenderAuthLogProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(ITenderAuthLogProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(ITenderAuthLogProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(ITenderAuthLogProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(ITenderAuthLogProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(ITenderAuthLogProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(ITenderAuthLogProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(ITenderAuthLogProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("TenderAuthLogPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("TenderAuthLogPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\TenderAuthLogPropertyModel.class
