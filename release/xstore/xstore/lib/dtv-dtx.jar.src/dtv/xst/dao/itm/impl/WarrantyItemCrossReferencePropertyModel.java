...
/*     */ 
/*     */ 
/*     */ public class WarrantyItemCrossReferencePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IWarrantyItemCrossReferenceProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new WarrantyItemCrossReferencePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private WarrantyItemCrossReferencePropertyDAO getDAO_() {
/*  44 */     return (WarrantyItemCrossReferencePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getWarrantyItemId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setWarrantyItemId_noev(argWarrantyItemId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_WARRANTYITEMID, argWarrantyItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getWarrantyItemId() == null && argWarrantyItemId != null) || (
/* 146 */       getDAO_().getWarrantyItemId() != null && !getDAO_().getWarrantyItemId().equals(argWarrantyItemId))) {
/* 147 */       getDAO_().setWarrantyItemId(argWarrantyItemId);
...
/* 170 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IWarrantyItemCrossReferenceProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("WarrantyItemCrossReferencePropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("WarrantyItemCrossReferencePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyItemCrossReferencePropertyModel.class
