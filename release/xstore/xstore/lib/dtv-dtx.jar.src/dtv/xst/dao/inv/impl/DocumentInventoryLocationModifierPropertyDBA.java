...
/*     */ 
/*     */ 
/*     */ public class DocumentInventoryLocationModifierPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.document_id, t.document_typcode, t.document_line_nbr, t.mod_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_inventory_loc_mod_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND document_id = ?  AND document_typcode = ?  AND document_line_nbr = ?  AND mod_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  48 */     return "SELECT t.organization_id, t.rtl_loc_id, t.document_id, t.document_typcode, t.document_line_nbr, t.mod_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_inventory_loc_mod_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  54 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND document_id = ?  AND document_typcode = ?  AND document_line_nbr = ?  AND mod_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  57 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO inv_inventory_loc_mod_p(organization_id, rtl_loc_id, document_id, document_typcode, document_line_nbr, mod_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  64 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._documentId, this._documentTypeCode, this._documentLineNumber, this._modifierSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  65 */     return insertParameterObject;
/*     */   }
/*     */   
/*  68 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, 12, 12, -5, -5, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  71 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  74 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE inv_inventory_loc_mod_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  90 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM inv_inventory_loc_mod_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND document_id = ?  AND document_typcode = ?  AND document_line_nbr = ?  AND mod_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  99 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND document_id = ?  AND document_typcode = ?  AND document_line_nbr = ?  AND mod_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 102 */     return new Object[] { this._organizationId, this._retailLocationId, this._documentId, this._documentTypeCode, this._documentLineNumber, this._modifierSequence, this._propertyCode };
/*     */   }
/*     */   
/* 105 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { -5, -5, 12, 12, -5, -5, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 108 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 111 */     return "inv_inventory_loc_mod_p";
/*     */   }
/*     */   
...
/* 119 */     return new DocumentInventoryLocationModifierPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class DocumentInventoryLocationModifierPropertyFiller
/*     */     implements IFiller {
/*     */     private DocumentInventoryLocationModifierPropertyDBA _parent;
/*     */     
/*     */     public DocumentInventoryLocationModifierPropertyFiller(DocumentInventoryLocationModifierPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 150 */       primitiveResult = argResultSet.getLong(5);
/* 151 */       if (primitiveResult != 0L || argResultSet.getObject(5) != null) {
/* 152 */         this._parent._documentLineNumber = Long.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 158 */       primitiveResult = argResultSet.getLong(6);
/* 159 */       if (primitiveResult != 0L || argResultSet.getObject(6) != null) {
/* 160 */         this._parent._modifierSequence = Long.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 202 */     DocumentInventoryLocationModifierPropertyDAO dao = (DocumentInventoryLocationModifierPropertyDAO)argDAO;
...
/* 223 */     return loadDAO((IDataAccessObject)new DocumentInventoryLocationModifierPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 227 */     DocumentInventoryLocationModifierPropertyDAO dao = (DocumentInventoryLocationModifierPropertyDAO)argDAO;
...
/* 232 */     this._documentLineNumber = dao.getDocumentLineNumber();
/* 233 */     this._modifierSequence = dao.getModifierSequence();
...
/* 246 */     DocumentInventoryLocationModifierPropertyId id = (DocumentInventoryLocationModifierPropertyId)argId;
...
/* 251 */     argStatement.setLong(5, id.getDocumentLineNumber().longValue());
/* 252 */     argStatement.setLong(6, id.getModifierSequence().longValue());
/* 253 */     argStatement.setString(7, id.getPropertyCode());
/* 254 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 258 */     DocumentInventoryLocationModifierPropertyId id = new DocumentInventoryLocationModifierPropertyId();
...
/* 263 */     id.setDocumentLineNumber(this._documentLineNumber);
/* 264 */     id.setModifierSequence(this._modifierSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\DocumentInventoryLocationModifierPropertyDBA.class
