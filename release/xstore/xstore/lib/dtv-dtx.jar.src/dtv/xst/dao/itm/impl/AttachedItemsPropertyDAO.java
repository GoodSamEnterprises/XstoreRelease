...
/*     */ 
/*     */ 
/*     */ public class AttachedItemsPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -57756079L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AttachedItemsPropertyDAO.class);
/*     */   
...
/*  41 */     return this._attachedItemId;
/*     */   }
/*     */   
/*     */   public void setAttachedItemId(String argAttachedItemId) {
/*  45 */     if (changed(argAttachedItemId, this._attachedItemId, "attachedItemId")) {
/*  46 */       this._attachedItemId = (argAttachedItemId != null && MANAGE_CASE) ? argAttachedItemId.toUpperCase() : argAttachedItemId;
/*     */     }
/*     */   }
/*     */   
...
/*  61 */     return this._soldItemId;
/*     */   }
/*     */   
/*     */   public void setSoldItemId(String argSoldItemId) {
/*  65 */     if (changed(argSoldItemId, this._soldItemId, "soldItemId")) {
/*  66 */       this._soldItemId = (argSoldItemId != null && MANAGE_CASE) ? argSoldItemId.toUpperCase() : argSoldItemId;
/*     */     }
/*     */   }
/*     */   
...
/* 188 */     if (getAttachedItemId() != null) {
/* 189 */       buf.append("attachedItemId").append("=").append(getAttachedItemId()).append(" ");
/*     */     }
/* 191 */     if (getOrganizationId() != null) {
/* 192 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 194 */     if (getSoldItemId() != null) {
/* 195 */       buf.append("soldItemId").append("=").append(getSoldItemId()).append(" ");
/*     */     }
...
/* 235 */     AttachedItemsPropertyId id = new AttachedItemsPropertyId();
/* 236 */     id.setAttachedItemId(getAttachedItemId());
/* 237 */     id.setOrganizationId(getOrganizationId());
/* 238 */     id.setSoldItemId(getSoldItemId());
...
/* 246 */     setAttachedItemId(((AttachedItemsPropertyId)argObjectId).getAttachedItemId());
/* 247 */     setOrganizationId(((AttachedItemsPropertyId)argObjectId).getOrganizationId());
/* 248 */     setSoldItemId(((AttachedItemsPropertyId)argObjectId).getSoldItemId());
/* 249 */     setLevelCode(((AttachedItemsPropertyId)argObjectId).getLevelCode());
/* 250 */     setLevelValue(((AttachedItemsPropertyId)argObjectId).getLevelValue());
/* 251 */     setPropertyCode(((AttachedItemsPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"AttachedItemsProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 269 */     if (this._attachedItemId != null) values.put("AttachedItemId", DaoUtils.getXmlSafeFieldValue(12, this._attachedItemId)); 
/* 270 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 271 */     if (this._soldItemId != null) values.put("SoldItemId", DaoUtils.getXmlSafeFieldValue(12, this._soldItemId)); 
...
/* 298 */             setAttachedItemId((String)value);
/* 299 */           } catch (Exception ee) {
/* 300 */             throw new DtxException("An exception occurred while calling setAttachedItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 316 */             setSoldItemId((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setSoldItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "LevelCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\AttachedItemsPropertyDAO.class
