...
/*     */ 
/*     */ 
/*     */ public class VoucherPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -948372861L;
/*  23 */   private static final Logger _logger = Logger.getLogger(VoucherPropertyDAO.class);
/*     */   
...
/*  49 */     return this._serialNumber;
/*     */   }
/*     */   
/*     */   public void setSerialNumber(String argSerialNumber) {
/*  53 */     if (changed(argSerialNumber, this._serialNumber, "serialNumber")) {
/*  54 */       this._serialNumber = (argSerialNumber != null && MANAGE_CASE) ? argSerialNumber.toUpperCase() : argSerialNumber;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getVoucherTypeCode() {
/*  59 */     return this._voucherTypeCode;
/*     */   }
/*     */   
/*     */   public void setVoucherTypeCode(String argVoucherTypeCode) {
/*  63 */     if (changed(argVoucherTypeCode, this._voucherTypeCode, "voucherTypeCode")) {
/*  64 */       this._voucherTypeCode = (argVoucherTypeCode != null && MANAGE_CASE) ? argVoucherTypeCode.toUpperCase() : argVoucherTypeCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getSerialNumber() != null) {
/* 170 */       buf.append("serialNumber").append("=").append(getSerialNumber()).append(" ");
/*     */     }
/* 172 */     if (getVoucherTypeCode() != null) {
/* 173 */       buf.append("voucherTypeCode").append("=").append(getVoucherTypeCode()).append(" ");
/*     */     }
...
/* 207 */     VoucherPropertyId id = new VoucherPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setSerialNumber(getSerialNumber());
/* 210 */     id.setVoucherTypeCode(getVoucherTypeCode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((VoucherPropertyId)argObjectId).getOrganizationId());
/* 217 */     setSerialNumber(((VoucherPropertyId)argObjectId).getSerialNumber());
/* 218 */     setVoucherTypeCode(((VoucherPropertyId)argObjectId).getVoucherTypeCode());
/* 219 */     setPropertyCode(((VoucherPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"VoucherProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._serialNumber != null) values.put("SerialNumber", DaoUtils.getXmlSafeFieldValue(12, this._serialNumber)); 
/* 239 */     if (this._voucherTypeCode != null) values.put("VoucherTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._voucherTypeCode)); 
...
/* 282 */             setVoucherTypeCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setVoucherTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\VoucherPropertyDAO.class
