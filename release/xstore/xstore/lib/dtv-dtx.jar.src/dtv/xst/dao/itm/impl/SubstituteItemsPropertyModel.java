...
/*     */ 
/*     */ 
/*     */ public class SubstituteItemsPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ISubstituteItemsProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new SubstituteItemsPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private SubstituteItemsPropertyDAO getDAO_() {
/*  44 */     return (SubstituteItemsPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ISubstituteItemsProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getPrimaryItemId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setPrimaryItemId_noev(argPrimaryItemId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ISubstituteItemsProperty.SET_PRIMARYITEMID, argPrimaryItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getPrimaryItemId() == null && argPrimaryItemId != null) || (
/* 112 */       getDAO_().getPrimaryItemId() != null && !getDAO_().getPrimaryItemId().equals(argPrimaryItemId))) {
/* 113 */       getDAO_().setPrimaryItemId(argPrimaryItemId);
...
/* 125 */     return getDAO_().getSubstituteItemId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setSubstituteItemId_noev(argSubstituteItemId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(ISubstituteItemsProperty.SET_SUBSTITUTEITEMID, argSubstituteItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getSubstituteItemId() == null && argSubstituteItemId != null) || (
/* 146 */       getDAO_().getSubstituteItemId() != null && !getDAO_().getSubstituteItemId().equals(argSubstituteItemId))) {
/* 147 */       getDAO_().setSubstituteItemId(argSubstituteItemId);
...
/* 170 */       this._events.post(ISubstituteItemsProperty.SET_LEVELCODE, argLevelCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(ISubstituteItemsProperty.SET_LEVELVALUE, argLevelValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(ISubstituteItemsProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(ISubstituteItemsProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(ISubstituteItemsProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(ISubstituteItemsProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(ISubstituteItemsProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(ISubstituteItemsProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(ISubstituteItemsProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(ISubstituteItemsProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 510 */       this._events.post(ISubstituteItemsProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 531 */     if ("SubstituteItemsPropertyExtension".equals(argFieldId)) {
...
/* 541 */     if ("SubstituteItemsPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\SubstituteItemsPropertyModel.class
