...
/*     */ 
/*     */ 
/*     */ public class RetailTransactionLineItemNotesPropertyId
...
/*     */   
/*     */   public RetailTransactionLineItemNotesPropertyId() {}
/*     */   
/*     */   public RetailTransactionLineItemNotesPropertyId(String argObjectIdValue) {
...
/*  78 */     return this._noteSeq;
/*     */   }
/*     */   
/*     */   public void setNoteSeq(Long argNoteSeq) {
/*  82 */     this._noteSeq = argNoteSeq;
/*     */   }
/*     */   
...
/* 124 */       str = tokens[6];
/*     */       
/* 126 */       setNoteSeq(Long.valueOf(str));
/* 127 */       str = tokens[7];
/*     */       
...
/* 144 */       return true;
/*     */     }
/* 146 */     if (!(ob instanceof RetailTransactionLineItemNotesPropertyId)) {
/* 147 */       return false;
/*     */     }
/* 149 */     RetailTransactionLineItemNotesPropertyId other = (RetailTransactionLineItemNotesPropertyId)ob;
...
/*     */ 
/*     */       
/* 168 */       .equals(other._workstationId))) && ((this._noteSeq == null && other._noteSeq == null) || (this._noteSeq != null && this._noteSeq
/*     */ 
/*     */       
/* 171 */       .equals(other._noteSeq))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 186 */       .hashCode()) + ((this._noteSeq == null) ? 0 : this._noteSeq
...
/* 193 */     return "RetailTransactionLineItemNotesProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 207 */       .append("::").append(String.valueOf(this._noteSeq))
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\RetailTransactionLineItemNotesPropertyId.class
