...
/*     */ 
/*     */ 
/*     */ public class WarrantyItemPricePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IWarrantyItemPriceProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new WarrantyItemPricePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private WarrantyItemPricePropertyDAO getDAO_() {
/*  44 */     return (WarrantyItemPricePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IWarrantyItemPriceProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IWarrantyItemPriceProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     if (getDAO_().getWarrantyPriceSeq() != null) {
/* 126 */       return getDAO_().getWarrantyPriceSeq().longValue();
/*     */     }
/*     */     
/* 129 */     return 0L;
/*     */   }
...
/* 138 */     if (setWarrantyPriceSeq_noev(argWarrantyPriceSeq) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IWarrantyItemPriceProperty.SET_WARRANTYPRICESEQ, Long.valueOf(argWarrantyPriceSeq));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getWarrantyPriceSeq() == null && Long.valueOf(argWarrantyPriceSeq) != null) || (
/* 151 */       getDAO_().getWarrantyPriceSeq() != null && !getDAO_().getWarrantyPriceSeq().equals(Long.valueOf(argWarrantyPriceSeq)))) {
/* 152 */       getDAO_().setWarrantyPriceSeq(Long.valueOf(argWarrantyPriceSeq));
...
/* 175 */       this._events.post(IWarrantyItemPriceProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(IWarrantyItemPriceProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IWarrantyItemPriceProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IWarrantyItemPriceProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IWarrantyItemPriceProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IWarrantyItemPriceProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IWarrantyItemPriceProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IWarrantyItemPriceProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IWarrantyItemPriceProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 468 */     if ("WarrantyItemPricePropertyExtension".equals(argFieldId)) {
...
/* 478 */     if ("WarrantyItemPricePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyItemPricePropertyModel.class
