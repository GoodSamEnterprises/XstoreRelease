...
/*     */ 
/*     */ 
/*     */ public class ItemLabelPropertiesPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1208200823L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemLabelPropertiesPropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getItemId() != null) {
/* 159 */       buf.append("itemId").append("=").append(getItemId()).append(" ");
/*     */     }
...
/* 193 */     ItemLabelPropertiesPropertyId id = new ItemLabelPropertiesPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setItemId(getItemId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((ItemLabelPropertiesPropertyId)argObjectId).getOrganizationId());
/* 202 */     setItemId(((ItemLabelPropertiesPropertyId)argObjectId).getItemId());
/* 203 */     setPropertyCode(((ItemLabelPropertiesPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ItemLabelPropertiesProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._itemId != null) values.put("ItemId", DaoUtils.getXmlSafeFieldValue(12, this._itemId)); 
...
/* 256 */             setItemId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setItemId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemLabelPropertiesPropertyDAO.class
