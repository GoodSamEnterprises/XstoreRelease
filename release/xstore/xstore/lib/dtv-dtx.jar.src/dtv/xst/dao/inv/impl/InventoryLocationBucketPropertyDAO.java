...
/*     */ 
/*     */ 
/*     */ public class InventoryLocationBucketPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1531486896L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryLocationBucketPropertyDAO.class);
/*     */   
...
/*  70 */     return this._bucketId;
/*     */   }
/*     */   
/*     */   public void setBucketId(String argBucketId) {
/*  74 */     if (changed(argBucketId, this._bucketId, "bucketId")) {
/*  75 */       this._bucketId = (argBucketId != null && MANAGE_CASE) ? argBucketId.toUpperCase() : argBucketId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 186 */     if (getBucketId() != null) {
/* 187 */       buf.append("bucketId").append("=").append(getBucketId()).append(" ");
/*     */     }
...
/* 221 */     InventoryLocationBucketPropertyId id = new InventoryLocationBucketPropertyId();
...
/* 225 */     id.setBucketId(getBucketId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((InventoryLocationBucketPropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((InventoryLocationBucketPropertyId)argObjectId).getRetailLocationId());
/* 233 */     setLocationId(((InventoryLocationBucketPropertyId)argObjectId).getLocationId());
/* 234 */     setBucketId(((InventoryLocationBucketPropertyId)argObjectId).getBucketId());
/* 235 */     setPropertyCode(((InventoryLocationBucketPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"InventoryLocationBucketProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 256 */     if (this._bucketId != null) values.put("BucketId", DaoUtils.getXmlSafeFieldValue(12, this._bucketId)); 
...
/* 308 */             setBucketId((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setBucketId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryLocationBucketPropertyDAO.class
