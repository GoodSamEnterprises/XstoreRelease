...
/*     */ 
/*     */ 
/*     */ public class FulfillmentModifierPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 681803690L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.order_id, t.detail_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xom_fulfillment_mod_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND order_id = ?  AND detail_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.order_id, t.detail_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xom_fulfillment_mod_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND order_id = ?  AND detail_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO xom_fulfillment_mod_p(organization_id, order_id, detail_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._orderId, this._sequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE xom_fulfillment_mod_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM xom_fulfillment_mod_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND order_id = ?  AND detail_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND order_id = ?  AND detail_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._orderId, this._sequence, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "xom_fulfillment_mod_p";
/*     */   }
/*     */   
...
/* 116 */     return new FulfillmentModifierPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class FulfillmentModifierPropertyFiller
/*     */     implements IFiller {
/*     */     private FulfillmentModifierPropertyDBA _parent;
/*     */     
/*     */     public FulfillmentModifierPropertyFiller(FulfillmentModifierPropertyDBA argParent) {
...
/* 182 */     FulfillmentModifierPropertyDAO dao = (FulfillmentModifierPropertyDAO)argDAO;
/* 183 */     dao.setOrganizationId(this._organizationId);
/* 184 */     dao.setOrderId(this._orderId);
...
/* 200 */     return loadDAO((IDataAccessObject)new FulfillmentModifierPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     FulfillmentModifierPropertyDAO dao = (FulfillmentModifierPropertyDAO)argDAO;
/* 205 */     this._organizationId = dao.getOrganizationId();
/* 206 */     this._orderId = dao.getOrderId();
...
/* 220 */     FulfillmentModifierPropertyId id = (FulfillmentModifierPropertyId)argId;
/* 221 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 222 */     argStatement.setString(2, id.getOrderId());
...
/* 229 */     FulfillmentModifierPropertyId id = new FulfillmentModifierPropertyId();
/* 230 */     id.setOrganizationId(this._organizationId);
/* 231 */     id.setOrderId(this._orderId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\FulfillmentModifierPropertyDBA.class
