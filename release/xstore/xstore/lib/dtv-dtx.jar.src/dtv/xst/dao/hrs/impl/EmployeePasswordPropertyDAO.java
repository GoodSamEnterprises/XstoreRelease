...
/*     */ 
/*     */ 
/*     */ public class EmployeePasswordPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 2011522174L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeePasswordPropertyDAO.class);
/*     */   
...
/* 207 */     EmployeePasswordPropertyId id = new EmployeePasswordPropertyId();
...
/* 216 */     setOrganizationId(((EmployeePasswordPropertyId)argObjectId).getOrganizationId());
/* 217 */     setEmployeeId(((EmployeePasswordPropertyId)argObjectId).getEmployeeId());
/* 218 */     setSequence(((EmployeePasswordPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((EmployeePasswordPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"EmployeePasswordProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeePasswordPropertyDAO.class
