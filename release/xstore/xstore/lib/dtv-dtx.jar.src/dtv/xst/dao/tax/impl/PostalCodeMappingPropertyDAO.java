...
/*     */ 
/*     */ 
/*     */ public class PostalCodeMappingPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1220466645L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PostalCodeMappingPropertyDAO.class);
/*     */   
...
/*  40 */     return this._city;
/*     */   }
/*     */   
/*     */   public void setCity(String argCity) {
/*  44 */     if (changed(argCity, this._city, "city")) {
/*  45 */       this._city = (argCity != null && MANAGE_CASE) ? argCity.toUpperCase() : argCity;
/*     */     }
/*     */   }
/*     */   
...
/*  60 */     return this._postalCode;
/*     */   }
/*     */   
/*     */   public void setPostalCode(String argPostalCode) {
/*  64 */     if (changed(argPostalCode, this._postalCode, "postalCode")) {
/*  65 */       this._postalCode = (argPostalCode != null && MANAGE_CASE) ? argPostalCode.toUpperCase() : argPostalCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getTaxLocationId() {
/*  70 */     return this._taxLocationId;
/*     */   }
/*     */   
/*     */   public void setTaxLocationId(String argTaxLocationId) {
/*  74 */     if (changed(argTaxLocationId, this._taxLocationId, "taxLocationId")) {
/*  75 */       this._taxLocationId = (argTaxLocationId != null && MANAGE_CASE) ? argTaxLocationId.toUpperCase() : argTaxLocationId;
/*     */     }
/*     */   }
/*     */   
...
/* 177 */     if (getCity() != null) {
/* 178 */       buf.append("city").append("=").append(getCity()).append(" ");
/*     */     }
/* 180 */     if (getOrganizationId() != null) {
/* 181 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 183 */     if (getPostalCode() != null) {
/* 184 */       buf.append("postalCode").append("=").append(getPostalCode()).append(" ");
/*     */     }
/* 186 */     if (getTaxLocationId() != null) {
/* 187 */       buf.append("taxLocationId").append("=").append(getTaxLocationId()).append(" ");
/*     */     }
...
/* 221 */     PostalCodeMappingPropertyId id = new PostalCodeMappingPropertyId();
/* 222 */     id.setCity(getCity());
/* 223 */     id.setOrganizationId(getOrganizationId());
/* 224 */     id.setPostalCode(getPostalCode());
/* 225 */     id.setTaxLocationId(getTaxLocationId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setCity(((PostalCodeMappingPropertyId)argObjectId).getCity());
/* 232 */     setOrganizationId(((PostalCodeMappingPropertyId)argObjectId).getOrganizationId());
/* 233 */     setPostalCode(((PostalCodeMappingPropertyId)argObjectId).getPostalCode());
/* 234 */     setTaxLocationId(((PostalCodeMappingPropertyId)argObjectId).getTaxLocationId());
/* 235 */     setPropertyCode(((PostalCodeMappingPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"PostalCodeMappingProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 253 */     if (this._city != null) values.put("City", DaoUtils.getXmlSafeFieldValue(12, this._city)); 
/* 254 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 255 */     if (this._postalCode != null) values.put("PostalCode", DaoUtils.getXmlSafeFieldValue(12, this._postalCode)); 
/* 256 */     if (this._taxLocationId != null) values.put("TaxLocationId", DaoUtils.getXmlSafeFieldValue(12, this._taxLocationId)); 
...
/* 281 */             setCity((String)value);
/* 282 */           } catch (Exception ee) {
/* 283 */             throw new DtxException("An exception occurred while calling setCity() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 299 */             setPostalCode((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setPostalCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "TaxLocationId":
...
/* 308 */             setTaxLocationId((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setTaxLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\PostalCodeMappingPropertyDAO.class
