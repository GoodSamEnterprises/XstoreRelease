...
/*     */ 
/*     */ 
/*     */ public class WarrantyJournalPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IWarrantyJournalProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new WarrantyJournalPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private WarrantyJournalPropertyDAO getDAO_() {
/*  44 */     return (WarrantyJournalPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IWarrantyJournalProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getWarrantyNbr();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setWarrantyNbr_noev(argWarrantyNbr) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IWarrantyJournalProperty.SET_WARRANTYNBR, argWarrantyNbr);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getWarrantyNbr() == null && argWarrantyNbr != null) || (
/* 112 */       getDAO_().getWarrantyNbr() != null && !getDAO_().getWarrantyNbr().equals(argWarrantyNbr))) {
/* 113 */       getDAO_().setWarrantyNbr(argWarrantyNbr);
...
/* 125 */     return getDAO_().getWarrantyTypeCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setWarrantyTypeCode_noev(argWarrantyTypeCode) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IWarrantyJournalProperty.SET_WARRANTYTYPECODE, argWarrantyTypeCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getWarrantyTypeCode() == null && argWarrantyTypeCode != null) || (
/* 146 */       getDAO_().getWarrantyTypeCode() != null && !getDAO_().getWarrantyTypeCode().equals(argWarrantyTypeCode))) {
/* 147 */       getDAO_().setWarrantyTypeCode(argWarrantyTypeCode);
...
/* 159 */     if (getDAO_().getJournalSequence() != null) {
/* 160 */       return getDAO_().getJournalSequence().longValue();
/*     */     }
/*     */     
/* 163 */     return 0L;
/*     */   }
...
/* 172 */     if (setJournalSequence_noev(argJournalSequence) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IWarrantyJournalProperty.SET_JOURNALSEQUENCE, Long.valueOf(argJournalSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getJournalSequence() == null && Long.valueOf(argJournalSequence) != null) || (
/* 185 */       getDAO_().getJournalSequence() != null && !getDAO_().getJournalSequence().equals(Long.valueOf(argJournalSequence)))) {
/* 186 */       getDAO_().setJournalSequence(Long.valueOf(argJournalSequence));
...
/* 209 */       this._events.post(IWarrantyJournalProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IWarrantyJournalProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IWarrantyJournalProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IWarrantyJournalProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IWarrantyJournalProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IWarrantyJournalProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IWarrantyJournalProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IWarrantyJournalProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(IWarrantyJournalProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 502 */     if ("WarrantyJournalPropertyExtension".equals(argFieldId)) {
...
/* 512 */     if ("WarrantyJournalPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyJournalPropertyModel.class
