...
/*     */ 
/*     */ 
/*     */ public class ItemCrossReferenceDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1694348542L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemCrossReferenceDAO.class);
/*     */   
...
/*  35 */   private Boolean _primaryFlag = Boolean.FALSE;
/*     */   
/*     */   public String getManufacturerUpc() {
/*  38 */     return this._manufacturerUpc;
/*     */   }
/*     */   
/*     */   public void setManufacturerUpc(String argManufacturerUpc) {
/*  42 */     if (changed(argManufacturerUpc, this._manufacturerUpc, "manufacturerUpc")) {
/*  43 */       this._manufacturerUpc = (argManufacturerUpc != null && MANAGE_CASE) ? argManufacturerUpc.toUpperCase() : argManufacturerUpc;
/*     */     }
/*     */   }
/*     */   
...
/* 120 */     return this._manufacturer;
/*     */   }
/*     */   
/*     */   public void setManufacturer(String argManufacturer) {
/* 124 */     if (changed(argManufacturer, this._manufacturer, "manufacturer")) {
/* 125 */       this._manufacturer = argManufacturer;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getItemId() {
/* 130 */     return this._itemId;
/*     */   }
/*     */   
/*     */   public void setItemId(String argItemId) {
/* 134 */     if (changed(argItemId, this._itemId, "itemId")) {
/* 135 */       this._itemId = argItemId;
/*     */     }
/*     */   }
/*     */   
/*     */   public Boolean getPrimaryFlag() {
/* 140 */     return this._primaryFlag;
/*     */   }
/*     */   
/*     */   public void setPrimaryFlag(Boolean argPrimaryFlag) {
/* 144 */     if (changed(argPrimaryFlag, this._primaryFlag, "primaryFlag")) {
/* 145 */       this._primaryFlag = argPrimaryFlag;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 154 */     if (getManufacturerUpc() != null) {
/* 155 */       buf.append("manufacturerUpc").append("=").append(getManufacturerUpc()).append(" ");
/*     */     }
/* 157 */     if (getOrganizationId() != null) {
/* 158 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
...
/*     */     }
/* 178 */     if (getManufacturer() != null) {
/* 179 */       buf.append("manufacturer").append("=").append(getManufacturer()).append(" ");
/*     */     }
/* 181 */     if (getItemId() != null) {
/* 182 */       buf.append("itemId").append("=").append(getItemId()).append(" ");
/*     */     }
/* 184 */     if (getPrimaryFlag() != null && getPrimaryFlag().booleanValue()) {
/* 185 */       buf.append("primaryFlag").append("=").append(getPrimaryFlag()).append(" ");
/*     */     }
/*     */     
...
/* 192 */     ItemCrossReferenceId id = new ItemCrossReferenceId();
/* 193 */     id.setManufacturerUpc(getManufacturerUpc());
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 199 */     setManufacturerUpc(((ItemCrossReferenceId)argObjectId).getManufacturerUpc());
/* 200 */     setOrganizationId(((ItemCrossReferenceId)argObjectId).getOrganizationId());
/*     */   }
/*     */   
...
/* 209 */     buf.append("<").append("dao").append(" name=\"ItemCrossReference\" cmd=\"" + getObjectStateString() + "\">");
...
/* 218 */     if (this._manufacturerUpc != null) values.put("ManufacturerUpc", DaoUtils.getXmlSafeFieldValue(12, this._manufacturerUpc)); 
...
/* 226 */     if (this._manufacturer != null) values.put("Manufacturer", DaoUtils.getXmlSafeFieldValue(12, this._manufacturer)); 
/* 227 */     if (this._itemId != null) values.put("ItemId", DaoUtils.getXmlSafeFieldValue(12, this._itemId)); 
/* 228 */     if (this._primaryFlag != null) values.put("PrimaryFlag", DaoUtils.getXmlSafeFieldValue(-7, this._primaryFlag)); 
/* 229 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/*     */         
/*     */         case "ManufacturerUpc":
/*     */           try {
/* 243 */             Object value = DaoUtils.getFieldValueForXmlString(12, fieldValue);
/* 244 */             setManufacturerUpc((String)value);
/* 245 */           } catch (Exception ee) {
/* 246 */             throw new DtxException("An exception occurred while calling setManufacturerUpc() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 316 */             setManufacturer((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setManufacturer() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ItemId":
...
/* 334 */             setPrimaryFlag((Boolean)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setPrimaryFlag() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemCrossReferenceDAO.class
