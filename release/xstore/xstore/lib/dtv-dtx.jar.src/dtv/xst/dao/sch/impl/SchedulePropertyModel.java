...
/*     */ 
/*     */ 
/*     */ public class SchedulePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IScheduleProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new SchedulePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private SchedulePropertyDAO getDAO_() {
/*  44 */     return (SchedulePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IScheduleProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IScheduleProperty.SET_EMPLOYEEID, argEmployeeId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getBusinessDate();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setBusinessDate_noev(argBusinessDate) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IScheduleProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getBusinessDate() == null && argBusinessDate != null) || (
/* 146 */       getDAO_().getBusinessDate() != null && !getDAO_().getBusinessDate().equals(argBusinessDate))) {
/* 147 */       getDAO_().setBusinessDate(argBusinessDate);
...
/* 159 */     if (getDAO_().getScheduleSeq() != null) {
/* 160 */       return getDAO_().getScheduleSeq().longValue();
/*     */     }
/*     */     
/* 163 */     return 0L;
/*     */   }
...
/* 172 */     if (setScheduleSeq_noev(argScheduleSeq) && 
/* 173 */       this._events != null && 
/* 174 */       postEventsForChanges()) {
/* 175 */       this._events.post(IScheduleProperty.SET_SCHEDULESEQ, Long.valueOf(argScheduleSeq));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 184 */     if ((getDAO_().getScheduleSeq() == null && Long.valueOf(argScheduleSeq) != null) || (
/* 185 */       getDAO_().getScheduleSeq() != null && !getDAO_().getScheduleSeq().equals(Long.valueOf(argScheduleSeq)))) {
/* 186 */       getDAO_().setScheduleSeq(Long.valueOf(argScheduleSeq));
...
/* 209 */       this._events.post(IScheduleProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IScheduleProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IScheduleProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IScheduleProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IScheduleProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IScheduleProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IScheduleProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IScheduleProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 481 */       this._events.post(IScheduleProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 502 */     if ("SchedulePropertyExtension".equals(argFieldId)) {
...
/* 512 */     if ("SchedulePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sch\impl\SchedulePropertyModel.class
