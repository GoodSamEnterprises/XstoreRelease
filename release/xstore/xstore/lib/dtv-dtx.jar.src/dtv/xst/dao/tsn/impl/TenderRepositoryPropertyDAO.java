...
/*     */ 
/*     */ 
/*     */ public class TenderRepositoryPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 326334803L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderRepositoryPropertyDAO.class);
/*     */   
...
/* 207 */     TenderRepositoryPropertyId id = new TenderRepositoryPropertyId();
...
/* 216 */     setOrganizationId(((TenderRepositoryPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((TenderRepositoryPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setTenderRepositoryId(((TenderRepositoryPropertyId)argObjectId).getTenderRepositoryId());
/* 219 */     setPropertyCode(((TenderRepositoryPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"TenderRepositoryProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TenderRepositoryPropertyDAO.class
