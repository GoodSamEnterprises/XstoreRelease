...
/*     */ 
/*     */ 
/*     */ public class InvoiceLineItemPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1391596873L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InvoiceLineItemPropertyDAO.class);
/*     */   
...
/*  50 */     return this._serviceLocationId;
/*     */   }
/*     */   
/*     */   public void setServiceLocationId(String argServiceLocationId) {
/*  54 */     if (changed(argServiceLocationId, this._serviceLocationId, "serviceLocationId")) {
/*  55 */       this._serviceLocationId = (argServiceLocationId != null && MANAGE_CASE) ? argServiceLocationId.toUpperCase() : argServiceLocationId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getInvoiceNumber() {
/*  60 */     return this._invoiceNumber;
/*     */   }
/*     */   
/*     */   public void setInvoiceNumber(String argInvoiceNumber) {
/*  64 */     if (changed(argInvoiceNumber, this._invoiceNumber, "invoiceNumber")) {
/*  65 */       this._invoiceNumber = (argInvoiceNumber != null && MANAGE_CASE) ? argInvoiceNumber.toUpperCase() : argInvoiceNumber;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getInvoiceLineItemSequence() {
/*  70 */     return this._invoiceLineItemSequence;
/*     */   }
/*     */   
/*     */   public void setInvoiceLineItemSequence(Integer argInvoiceLineItemSequence) {
/*  74 */     if (changed(argInvoiceLineItemSequence, this._invoiceLineItemSequence, "invoiceLineItemSequence")) {
/*  75 */       this._invoiceLineItemSequence = argInvoiceLineItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getServiceLocationId() != null) {
/* 181 */       buf.append("serviceLocationId").append("=").append(getServiceLocationId()).append(" ");
/*     */     }
/* 183 */     if (getInvoiceNumber() != null) {
/* 184 */       buf.append("invoiceNumber").append("=").append(getInvoiceNumber()).append(" ");
/*     */     }
/* 186 */     if (getInvoiceLineItemSequence() != null) {
/* 187 */       buf.append("invoiceLineItemSequence").append("=").append(getInvoiceLineItemSequence()).append(" ");
/*     */     }
...
/* 221 */     InvoiceLineItemPropertyId id = new InvoiceLineItemPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setServiceLocationId(getServiceLocationId());
/* 224 */     id.setInvoiceNumber(getInvoiceNumber());
/* 225 */     id.setInvoiceLineItemSequence(getInvoiceLineItemSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((InvoiceLineItemPropertyId)argObjectId).getOrganizationId());
/* 232 */     setServiceLocationId(((InvoiceLineItemPropertyId)argObjectId).getServiceLocationId());
/* 233 */     setInvoiceNumber(((InvoiceLineItemPropertyId)argObjectId).getInvoiceNumber());
/* 234 */     setInvoiceLineItemSequence(((InvoiceLineItemPropertyId)argObjectId).getInvoiceLineItemSequence());
/* 235 */     setPropertyCode(((InvoiceLineItemPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"InvoiceLineItemProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._serviceLocationId != null) values.put("ServiceLocationId", DaoUtils.getXmlSafeFieldValue(12, this._serviceLocationId)); 
/* 255 */     if (this._invoiceNumber != null) values.put("InvoiceNumber", DaoUtils.getXmlSafeFieldValue(12, this._invoiceNumber)); 
/* 256 */     if (this._invoiceLineItemSequence != null) values.put("InvoiceLineItemSequence", DaoUtils.getXmlSafeFieldValue(4, this._invoiceLineItemSequence)); 
...
/* 290 */             setServiceLocationId((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setServiceLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "InvoiceNumber":
...
/* 299 */             setInvoiceNumber((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setInvoiceNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setInvoiceLineItemSequence((Integer)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setInvoiceLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\InvoiceLineItemPropertyDAO.class
