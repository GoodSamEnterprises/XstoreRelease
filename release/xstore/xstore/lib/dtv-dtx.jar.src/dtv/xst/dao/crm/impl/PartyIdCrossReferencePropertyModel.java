...
/*     */ 
/*     */ 
/*     */ public class PartyIdCrossReferencePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IPartyIdCrossReferenceProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new PartyIdCrossReferencePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private PartyIdCrossReferencePropertyDAO getDAO_() {
/*  44 */     return (PartyIdCrossReferencePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IPartyIdCrossReferenceProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IPartyIdCrossReferenceProperty.SET_PARTYID, Long.valueOf(argPartyId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 130 */     return getDAO_().getAlternateIdOwner();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 138 */     if (setAlternateIdOwner_noev(argAlternateIdOwner) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(IPartyIdCrossReferenceProperty.SET_ALTERNATEIDOWNER, argAlternateIdOwner);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getAlternateIdOwner() == null && argAlternateIdOwner != null) || (
/* 151 */       getDAO_().getAlternateIdOwner() != null && !getDAO_().getAlternateIdOwner().equals(argAlternateIdOwner))) {
/* 152 */       getDAO_().setAlternateIdOwner(argAlternateIdOwner);
...
/* 175 */       this._events.post(IPartyIdCrossReferenceProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 209 */       this._events.post(IPartyIdCrossReferenceProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 243 */       this._events.post(IPartyIdCrossReferenceProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 277 */       this._events.post(IPartyIdCrossReferenceProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 311 */       this._events.post(IPartyIdCrossReferenceProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 345 */       this._events.post(IPartyIdCrossReferenceProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 379 */       this._events.post(IPartyIdCrossReferenceProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 413 */       this._events.post(IPartyIdCrossReferenceProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 447 */       this._events.post(IPartyIdCrossReferenceProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 468 */     if ("PartyIdCrossReferencePropertyExtension".equals(argFieldId)) {
...
/* 478 */     if ("PartyIdCrossReferencePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\PartyIdCrossReferencePropertyModel.class
