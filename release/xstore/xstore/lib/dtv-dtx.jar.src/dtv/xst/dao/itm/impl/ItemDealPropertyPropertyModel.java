...
/*     */ 
/*     */ 
/*     */ public class ItemDealPropertyPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IItemDealPropertyProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ItemDealPropertyPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ItemDealPropertyPropertyDAO getDAO_() {
/*  44 */     return (ItemDealPropertyPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IItemDealPropertyProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IItemDealPropertyProperty.SET_ITEMID, argItemId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getItemDealPropertyCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setItemDealPropertyCode_noev(argItemDealPropertyCode) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IItemDealPropertyProperty.SET_ITEMDEALPROPERTYCODE, argItemDealPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getItemDealPropertyCode() == null && argItemDealPropertyCode != null) || (
/* 146 */       getDAO_().getItemDealPropertyCode() != null && !getDAO_().getItemDealPropertyCode().equals(argItemDealPropertyCode))) {
/* 147 */       getDAO_().setItemDealPropertyCode(argItemDealPropertyCode);
...
/* 170 */       this._events.post(IItemDealPropertyProperty.SET_EFFECTIVEDATE, argEffectiveDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IItemDealPropertyProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IItemDealPropertyProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IItemDealPropertyProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IItemDealPropertyProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IItemDealPropertyProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IItemDealPropertyProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IItemDealPropertyProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IItemDealPropertyProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IItemDealPropertyProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("ItemDealPropertyPropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("ItemDealPropertyPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemDealPropertyPropertyModel.class
