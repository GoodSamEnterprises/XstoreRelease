...
/*     */ 
/*     */ 
/*     */ public class VoucherHistoryPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -297912805L;
/*  23 */   private static final Logger _logger = Logger.getLogger(VoucherHistoryPropertyDAO.class);
/*     */   
...
/*  50 */     return this._serialNumber;
/*     */   }
/*     */   
/*     */   public void setSerialNumber(String argSerialNumber) {
/*  54 */     if (changed(argSerialNumber, this._serialNumber, "serialNumber")) {
/*  55 */       this._serialNumber = (argSerialNumber != null && MANAGE_CASE) ? argSerialNumber.toUpperCase() : argSerialNumber;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getVoucherTypeCode() {
/*  60 */     return this._voucherTypeCode;
/*     */   }
/*     */   
/*     */   public void setVoucherTypeCode(String argVoucherTypeCode) {
/*  64 */     if (changed(argVoucherTypeCode, this._voucherTypeCode, "voucherTypeCode")) {
/*  65 */       this._voucherTypeCode = (argVoucherTypeCode != null && MANAGE_CASE) ? argVoucherTypeCode.toUpperCase() : argVoucherTypeCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getHistorySequence() {
/*  70 */     return this._historySequence;
/*     */   }
/*     */   
/*     */   public void setHistorySequence(Long argHistorySequence) {
/*  74 */     if (changed(argHistorySequence, this._historySequence, "historySequence")) {
/*  75 */       this._historySequence = argHistorySequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getSerialNumber() != null) {
/* 181 */       buf.append("serialNumber").append("=").append(getSerialNumber()).append(" ");
/*     */     }
/* 183 */     if (getVoucherTypeCode() != null) {
/* 184 */       buf.append("voucherTypeCode").append("=").append(getVoucherTypeCode()).append(" ");
/*     */     }
/* 186 */     if (getHistorySequence() != null) {
/* 187 */       buf.append("historySequence").append("=").append(getHistorySequence()).append(" ");
/*     */     }
...
/* 221 */     VoucherHistoryPropertyId id = new VoucherHistoryPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setSerialNumber(getSerialNumber());
/* 224 */     id.setVoucherTypeCode(getVoucherTypeCode());
/* 225 */     id.setHistorySequence(getHistorySequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((VoucherHistoryPropertyId)argObjectId).getOrganizationId());
/* 232 */     setSerialNumber(((VoucherHistoryPropertyId)argObjectId).getSerialNumber());
/* 233 */     setVoucherTypeCode(((VoucherHistoryPropertyId)argObjectId).getVoucherTypeCode());
/* 234 */     setHistorySequence(((VoucherHistoryPropertyId)argObjectId).getHistorySequence());
/* 235 */     setPropertyCode(((VoucherHistoryPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"VoucherHistoryProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._serialNumber != null) values.put("SerialNumber", DaoUtils.getXmlSafeFieldValue(12, this._serialNumber)); 
/* 255 */     if (this._voucherTypeCode != null) values.put("VoucherTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._voucherTypeCode)); 
/* 256 */     if (this._historySequence != null) values.put("HistorySequence", DaoUtils.getXmlSafeFieldValue(-5, this._historySequence)); 
...
/* 290 */             setSerialNumber((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setSerialNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 299 */             setVoucherTypeCode((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setVoucherTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setHistorySequence((Long)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setHistorySequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\VoucherHistoryPropertyDAO.class
