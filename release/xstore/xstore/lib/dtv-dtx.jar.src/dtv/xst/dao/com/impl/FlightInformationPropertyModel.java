...
/*     */ 
/*     */ 
/*     */ public class FlightInformationPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IFlightInformationProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new FlightInformationPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private FlightInformationPropertyDAO getDAO_() {
/*  44 */     return (FlightInformationPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IFlightInformationProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getScheduledDateTime();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setScheduledDateTime_noev(argScheduledDateTime) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IFlightInformationProperty.SET_SCHEDULEDDATETIME, argScheduledDateTime);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getScheduledDateTime() == null && argScheduledDateTime != null) || (
/* 112 */       getDAO_().getScheduledDateTime() != null && !getDAO_().getScheduledDateTime().equals(argScheduledDateTime))) {
/* 113 */       getDAO_().setScheduledDateTime(argScheduledDateTime);
...
/* 125 */     return getDAO_().getFlightNumber();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setFlightNumber_noev(argFlightNumber) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IFlightInformationProperty.SET_FLIGHTNUMBER, argFlightNumber);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getFlightNumber() == null && argFlightNumber != null) || (
/* 146 */       getDAO_().getFlightNumber() != null && !getDAO_().getFlightNumber().equals(argFlightNumber))) {
/* 147 */       getDAO_().setFlightNumber(argFlightNumber);
...
/* 159 */     return getDAO_().getOriginAirport();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setOriginAirport_noev(argOriginAirport) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IFlightInformationProperty.SET_ORIGINAIRPORT, argOriginAirport);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getOriginAirport() == null && argOriginAirport != null) || (
/* 180 */       getDAO_().getOriginAirport() != null && !getDAO_().getOriginAirport().equals(argOriginAirport))) {
/* 181 */       getDAO_().setOriginAirport(argOriginAirport);
...
/* 204 */       this._events.post(IFlightInformationProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IFlightInformationProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IFlightInformationProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IFlightInformationProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IFlightInformationProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IFlightInformationProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IFlightInformationProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IFlightInformationProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IFlightInformationProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("FlightInformationPropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("FlightInformationPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\FlightInformationPropertyModel.class
