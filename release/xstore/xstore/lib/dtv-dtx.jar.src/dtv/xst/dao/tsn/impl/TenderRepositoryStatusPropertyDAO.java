...
/*     */ 
/*     */ 
/*     */ public class TenderRepositoryStatusPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1660847333L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderRepositoryStatusPropertyDAO.class);
/*     */   
...
/*     */     }
/* 172 */     if (getTenderRepositoryId() != null) {
/* 173 */       buf.append("tenderRepositoryId").append("=").append(getTenderRepositoryId()).append(" ");
/*     */     }
...
/* 207 */     TenderRepositoryStatusPropertyId id = new TenderRepositoryStatusPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setTenderRepositoryId(getTenderRepositoryId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((TenderRepositoryStatusPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((TenderRepositoryStatusPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setTenderRepositoryId(((TenderRepositoryStatusPropertyId)argObjectId).getTenderRepositoryId());
/* 219 */     setPropertyCode(((TenderRepositoryStatusPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"TenderRepositoryStatusProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._tenderRepositoryId != null) values.put("TenderRepositoryId", DaoUtils.getXmlSafeFieldValue(12, this._tenderRepositoryId)); 
...
/* 282 */             setTenderRepositoryId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setTenderRepositoryId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TenderRepositoryStatusPropertyDAO.class
