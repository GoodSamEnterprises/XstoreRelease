...
/*     */ 
/*     */ 
/*     */ public class ClosingMessageDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.create_date, t.create_user_id, t.update_date, t.update_user_id, t.closing_message FROM loc_closing_message t";
...
/*  40 */     return "SELECT t.organization_id, t.rtl_loc_id, t.create_date, t.create_user_id, t.update_date, t.update_user_id, t.closing_message FROM loc_closing_message t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  49 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO loc_closing_message(organization_id, rtl_loc_id, create_date, create_user_id, update_date, update_user_id, closing_message) VALUES (?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  56 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._createDate, this._createUserId, this._updateDate, this._updateUserId, this._closingMessage } };
...
/*     */   }
/*     */   
/*  66 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE loc_closing_message SET update_date = ?, update_user_id = ?, closing_message = ?" };
/*     */   
...
/*  73 */     Object[][] updateParameterObject = { { this._updateDate, this._updateUserId, this._closingMessage } };
...
/*     */   }
/*     */   
/*  82 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM loc_closing_message" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  ";
/*     */   
...
/* 103 */     return "loc_closing_message";
/*     */   }
/*     */   
...
/* 111 */     return new ClosingMessageFiller(this);
/*     */   }
/*     */   
/*     */   private static class ClosingMessageFiller
/*     */     implements IFiller {
/*     */     private ClosingMessageDBA _parent;
/*     */     
/*     */     public ClosingMessageFiller(ClosingMessageDBA argParent) {
...
/* 158 */       this._parent._closingMessage = argResultSet.getString(7);
/*     */     }
/*     */   }
/*     */   
/*     */   public IDataAccessObject loadDAO(IDataAccessObject argDAO) {
/* 163 */     argDAO.suppressStateChanges(true);
/* 164 */     ClosingMessageDAO dao = (ClosingMessageDAO)argDAO;
...
/* 171 */     dao.setClosingMessage(this._closingMessage);
/* 172 */     argDAO.suppressStateChanges(false);
/* 173 */     return (IDataAccessObject)dao;
/*     */   }
/*     */   
/*     */   public IDataAccessObject loadDefaultDAO() {
/* 177 */     return loadDAO((IDataAccessObject)new ClosingMessageDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 181 */     ClosingMessageDAO dao = (ClosingMessageDAO)argDAO;
...
/* 188 */     this._closingMessage = dao.getClosingMessage();
/*     */   }
/*     */   
/*     */   public PreparedStatement writeObjectId(IObjectId argId, PreparedStatement argStatement) throws SQLException {
/* 192 */     ClosingMessageId id = (ClosingMessageId)argId;
...
/* 199 */     ClosingMessageId id = new ClosingMessageId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\ClosingMessageDBA.class
