...
/*     */ 
/*     */ 
/*     */ public class ShipperPropertyId
...
/*     */   
/*     */   public ShipperPropertyId() {}
/*     */   
/*     */   public ShipperPropertyId(String argObjectIdValue) {
...
/*  30 */     return this._shipperId;
/*     */   }
/*     */   
/*     */   public void setShipperId(String argShipperId) {
/*  34 */     this._shipperId = (argShipperId != null && MANAGE_CASE) ? argShipperId.toUpperCase() : argShipperId;
/*     */   }
/*     */   
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof ShipperPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     ShipperPropertyId other = (ShipperPropertyId)ob;
/*  86 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  89 */       .equals(other._organizationId))) && ((this._shipperId == null && other._shipperId == null) || (this._shipperId != null && this._shipperId
/*     */ 
/*     */       
/*  92 */       .equals(other._shipperId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 102 */       .hashCode()) + ((this._shipperId == null) ? 0 : this._shipperId
...
/* 118 */       .append("::").append(this._shipperId)
/* 119 */       .append("::").append(this._propertyCode)
/* 120 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 124 */     if (this._shipperId == null) {
/* 125 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\ShipperPropertyId.class
