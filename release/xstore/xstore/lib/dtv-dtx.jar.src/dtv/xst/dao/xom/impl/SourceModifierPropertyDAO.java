...
/*     */ 
/*     */ 
/*     */ public class SourceModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1912127449L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SourceModifierPropertyDAO.class);
/*     */   
...
/* 207 */     SourceModifierPropertyId id = new SourceModifierPropertyId();
...
/* 216 */     setOrganizationId(((SourceModifierPropertyId)argObjectId).getOrganizationId());
/* 217 */     setOrderId(((SourceModifierPropertyId)argObjectId).getOrderId());
/* 218 */     setSequence(((SourceModifierPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((SourceModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"SourceModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\SourceModifierPropertyDAO.class
