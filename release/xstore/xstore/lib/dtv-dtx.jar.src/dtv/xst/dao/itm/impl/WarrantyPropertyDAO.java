...
/*     */ 
/*     */ 
/*     */ public class WarrantyPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -223425775L;
/*  23 */   private static final Logger _logger = Logger.getLogger(WarrantyPropertyDAO.class);
/*     */   
...
/*  49 */     return this._warrantyNbr;
/*     */   }
/*     */   
/*     */   public void setWarrantyNbr(String argWarrantyNbr) {
/*  53 */     if (changed(argWarrantyNbr, this._warrantyNbr, "warrantyNbr")) {
/*  54 */       this._warrantyNbr = (argWarrantyNbr != null && MANAGE_CASE) ? argWarrantyNbr.toUpperCase() : argWarrantyNbr;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getWarrantyTypeCode() {
/*  59 */     return this._warrantyTypeCode;
/*     */   }
/*     */   
/*     */   public void setWarrantyTypeCode(String argWarrantyTypeCode) {
/*  63 */     if (changed(argWarrantyTypeCode, this._warrantyTypeCode, "warrantyTypeCode")) {
/*  64 */       this._warrantyTypeCode = (argWarrantyTypeCode != null && MANAGE_CASE) ? argWarrantyTypeCode.toUpperCase() : argWarrantyTypeCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getWarrantyNbr() != null) {
/* 170 */       buf.append("warrantyNbr").append("=").append(getWarrantyNbr()).append(" ");
/*     */     }
/* 172 */     if (getWarrantyTypeCode() != null) {
/* 173 */       buf.append("warrantyTypeCode").append("=").append(getWarrantyTypeCode()).append(" ");
/*     */     }
...
/* 207 */     WarrantyPropertyId id = new WarrantyPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setWarrantyNbr(getWarrantyNbr());
/* 210 */     id.setWarrantyTypeCode(getWarrantyTypeCode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((WarrantyPropertyId)argObjectId).getOrganizationId());
/* 217 */     setWarrantyNbr(((WarrantyPropertyId)argObjectId).getWarrantyNbr());
/* 218 */     setWarrantyTypeCode(((WarrantyPropertyId)argObjectId).getWarrantyTypeCode());
/* 219 */     setPropertyCode(((WarrantyPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"WarrantyProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._warrantyNbr != null) values.put("WarrantyNbr", DaoUtils.getXmlSafeFieldValue(12, this._warrantyNbr)); 
/* 239 */     if (this._warrantyTypeCode != null) values.put("WarrantyTypeCode", DaoUtils.getXmlSafeFieldValue(12, this._warrantyTypeCode)); 
...
/* 273 */             setWarrantyNbr((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setWarrantyNbr() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 282 */             setWarrantyTypeCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setWarrantyTypeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\WarrantyPropertyDAO.class
