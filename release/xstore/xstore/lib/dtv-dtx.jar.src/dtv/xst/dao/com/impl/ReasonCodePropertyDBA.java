...
/*     */ 
/*     */ 
/*     */ public class ReasonCodePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.reason_typcode, t.reason_code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_reason_code_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND reason_typcode = ?  AND reason_code = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.reason_typcode, t.reason_code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_reason_code_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND reason_typcode = ?  AND reason_code = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO com_reason_code_p(organization_id, reason_typcode, reason_code, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._reasonTypeCode, this._reasonCode, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE com_reason_code_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM com_reason_code_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND reason_typcode = ?  AND reason_code = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND reason_typcode = ?  AND reason_code = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._reasonTypeCode, this._reasonCode, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new ReasonCodePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ReasonCodePropertyFiller
/*     */     implements IFiller {
/*     */     private ReasonCodePropertyDBA _parent;
/*     */     
/*     */     public ReasonCodePropertyFiller(ReasonCodePropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._reasonTypeCode = argResultSet.getString(2);
/* 136 */       this._parent._reasonCode = argResultSet.getString(3);
...
/* 175 */     ReasonCodePropertyDAO dao = (ReasonCodePropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setReasonTypeCode(this._reasonTypeCode);
/* 178 */     dao.setReasonCode(this._reasonCode);
...
/* 193 */     return loadDAO((IDataAccessObject)new ReasonCodePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     ReasonCodePropertyDAO dao = (ReasonCodePropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._reasonTypeCode = dao.getReasonTypeCode();
...
/* 213 */     ReasonCodePropertyId id = (ReasonCodePropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getReasonTypeCode());
/* 216 */     argStatement.setString(3, id.getReasonCode());
/* 217 */     argStatement.setString(4, id.getPropertyCode());
/* 218 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 222 */     ReasonCodePropertyId id = new ReasonCodePropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setReasonTypeCode(this._reasonTypeCode);
/* 225 */     id.setReasonCode(this._reasonCode);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\ReasonCodePropertyDBA.class
