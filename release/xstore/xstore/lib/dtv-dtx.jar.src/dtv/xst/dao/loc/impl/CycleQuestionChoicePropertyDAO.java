...
/*     */ 
/*     */ 
/*     */ public class CycleQuestionChoicePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1776912514L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CycleQuestionChoicePropertyDAO.class);
/*     */   
...
/*  39 */     return this._answerId;
/*     */   }
/*     */   
/*     */   public void setAnswerId(String argAnswerId) {
/*  43 */     if (changed(argAnswerId, this._answerId, "answerId")) {
/*  44 */       this._answerId = (argAnswerId != null && MANAGE_CASE) ? argAnswerId.toUpperCase() : argAnswerId;
/*     */     }
/*     */   }
/*     */   
...
/*  59 */     return this._questionId;
/*     */   }
/*     */   
/*     */   public void setQuestionId(String argQuestionId) {
/*  63 */     if (changed(argQuestionId, this._questionId, "questionId")) {
/*  64 */       this._questionId = (argQuestionId != null && MANAGE_CASE) ? argQuestionId.toUpperCase() : argQuestionId;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getAnswerId() != null) {
/* 167 */       buf.append("answerId").append("=").append(getAnswerId()).append(" ");
/*     */     }
/* 169 */     if (getOrganizationId() != null) {
/* 170 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 172 */     if (getQuestionId() != null) {
/* 173 */       buf.append("questionId").append("=").append(getQuestionId()).append(" ");
/*     */     }
...
/* 207 */     CycleQuestionChoicePropertyId id = new CycleQuestionChoicePropertyId();
/* 208 */     id.setAnswerId(getAnswerId());
/* 209 */     id.setOrganizationId(getOrganizationId());
/* 210 */     id.setQuestionId(getQuestionId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setAnswerId(((CycleQuestionChoicePropertyId)argObjectId).getAnswerId());
/* 217 */     setOrganizationId(((CycleQuestionChoicePropertyId)argObjectId).getOrganizationId());
/* 218 */     setQuestionId(((CycleQuestionChoicePropertyId)argObjectId).getQuestionId());
/* 219 */     setPropertyCode(((CycleQuestionChoicePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CycleQuestionChoiceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._answerId != null) values.put("AnswerId", DaoUtils.getXmlSafeFieldValue(12, this._answerId)); 
/* 238 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 239 */     if (this._questionId != null) values.put("QuestionId", DaoUtils.getXmlSafeFieldValue(12, this._questionId)); 
...
/* 264 */             setAnswerId((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setAnswerId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 282 */             setQuestionId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setQuestionId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\CycleQuestionChoicePropertyDAO.class
