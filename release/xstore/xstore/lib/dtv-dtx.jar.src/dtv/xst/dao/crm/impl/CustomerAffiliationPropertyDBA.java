...
/*     */ 
/*     */ 
/*     */ public class CustomerAffiliationPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 320179207L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.party_id, t.cust_group_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM crm_customer_affiliation_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND party_id = ?  AND cust_group_id = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.party_id, t.cust_group_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM crm_customer_affiliation_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND party_id = ?  AND cust_group_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO crm_customer_affiliation_p(organization_id, party_id, cust_group_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._partyId, this._customerGroupId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE crm_customer_affiliation_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM crm_customer_affiliation_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND party_id = ?  AND cust_group_id = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND party_id = ?  AND cust_group_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._partyId, this._customerGroupId, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "crm_customer_affiliation_p";
/*     */   }
/*     */   
...
/* 116 */     return new CustomerAffiliationPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class CustomerAffiliationPropertyFiller
/*     */     implements IFiller {
/*     */     private CustomerAffiliationPropertyDBA _parent;
/*     */     
/*     */     public CustomerAffiliationPropertyFiller(CustomerAffiliationPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 143 */       this._parent._customerGroupId = argResultSet.getString(3);
...
/* 182 */     CustomerAffiliationPropertyDAO dao = (CustomerAffiliationPropertyDAO)argDAO;
/* 183 */     dao.setOrganizationId(this._organizationId);
/* 184 */     dao.setPartyId(this._partyId);
/* 185 */     dao.setCustomerGroupId(this._customerGroupId);
...
/* 200 */     return loadDAO((IDataAccessObject)new CustomerAffiliationPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 204 */     CustomerAffiliationPropertyDAO dao = (CustomerAffiliationPropertyDAO)argDAO;
/* 205 */     this._organizationId = dao.getOrganizationId();
/* 206 */     this._partyId = dao.getPartyId();
/* 207 */     this._customerGroupId = dao.getCustomerGroupId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\CustomerAffiliationPropertyDBA.class
