...
/*     */ 
/*     */ 
/*     */ public class RainCheckTransactionDAO
/*     */   extends PosTransactionDAO
/*     */ {
/*     */   private static final long serialVersionUID = 1711258762L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RainCheckTransactionDAO.class);
/*     */   
...
/*  74 */     return this._rainCheckId;
/*     */   }
/*     */   
/*     */   public void setRainCheckId(String argRainCheckId) {
/*  78 */     if (changed(argRainCheckId, this._rainCheckId, "rainCheckId")) {
/*  79 */       this._rainCheckId = argRainCheckId;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 100 */     if (getRainCheckId() != null) {
/* 101 */       buf.append("rainCheckId").append("=").append(getRainCheckId()).append(" ");
/*     */     }
/*     */     
...
/* 110 */     buf.append("<").append("dao").append(" name=\"RainCheckTransaction\" cmd=\"" + getObjectStateString() + "\">");
...
/* 123 */     if (this._rainCheckId != null) values.put("RainCheckId", DaoUtils.getXmlSafeFieldValue(12, this._rainCheckId)); 
/* 124 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/* 175 */             setRainCheckId((String)value);
/* 176 */           } catch (Exception ee) {
/* 177 */             throw new DtxException("An exception occurred while calling setRainCheckId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\RainCheckTransactionDAO.class
