...
/*     */ 
/*     */ 
/*     */ public class InventoryItemAccountModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1427393878L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryItemAccountModifierPropertyDAO.class);
/*     */   
...
/* 235 */     InventoryItemAccountModifierPropertyId id = new InventoryItemAccountModifierPropertyId();
...
/* 246 */     setOrganizationId(((InventoryItemAccountModifierPropertyId)argObjectId).getOrganizationId());
/* 247 */     setDocumentId(((InventoryItemAccountModifierPropertyId)argObjectId).getDocumentId());
/* 248 */     setInventoryDocumentLineNumber(((InventoryItemAccountModifierPropertyId)argObjectId).getInventoryDocumentLineNumber());
/* 249 */     setDocumentTypeCode(((InventoryItemAccountModifierPropertyId)argObjectId).getDocumentTypeCode());
/* 250 */     setRetailLocationId(((InventoryItemAccountModifierPropertyId)argObjectId).getRetailLocationId());
/* 251 */     setPropertyCode(((InventoryItemAccountModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"InventoryItemAccountModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryItemAccountModifierPropertyDAO.class
