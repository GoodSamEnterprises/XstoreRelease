...
/*     */ 
/*     */ 
/*     */ public class InventoryMovementPendingPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1532189951L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryMovementPendingPropertyDAO.class);
/*     */   
...
/* 250 */     InventoryMovementPendingPropertyId id = new InventoryMovementPendingPropertyId();
...
/* 262 */     setOrganizationId(((InventoryMovementPendingPropertyId)argObjectId).getOrganizationId());
/* 263 */     setRetailLocationId(((InventoryMovementPendingPropertyId)argObjectId).getRetailLocationId());
/* 264 */     setBusinessDate(((InventoryMovementPendingPropertyId)argObjectId).getBusinessDate());
/* 265 */     setWorkstationId(((InventoryMovementPendingPropertyId)argObjectId).getWorkstationId());
/* 266 */     setTransactionSequence(((InventoryMovementPendingPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setLineItemSequence(((InventoryMovementPendingPropertyId)argObjectId).getLineItemSequence());
/* 268 */     setPropertyCode(((InventoryMovementPendingPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"InventoryMovementPendingProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryMovementPendingPropertyDAO.class
