...
/*     */ 
/*     */ 
/*     */ public class AwardAccountPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1508041947L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AwardAccountPropertyDAO.class);
/*     */   
...
/* 207 */     AwardAccountPropertyId id = new AwardAccountPropertyId();
...
/* 216 */     setOrganizationId(((AwardAccountPropertyId)argObjectId).getOrganizationId());
/* 217 */     setCardNumber(((AwardAccountPropertyId)argObjectId).getCardNumber());
/* 218 */     setAccountId(((AwardAccountPropertyId)argObjectId).getAccountId());
/* 219 */     setPropertyCode(((AwardAccountPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"AwardAccountProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\AwardAccountPropertyDAO.class
