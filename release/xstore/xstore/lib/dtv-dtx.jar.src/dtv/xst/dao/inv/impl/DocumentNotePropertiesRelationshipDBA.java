...
/*    */ 
/*    */ 
/*    */ public class DocumentNotePropertiesRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(5);
/*    */   
/*    */   public String getSelect() {
/* 22 */     return "SELECT organization_id, rtl_loc_id, invctl_document_id, document_typcode, note_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id FROM inv_document_notes_p WHERE organization_id = ? AND rtl_loc_id = ? AND invctl_document_id = ? AND document_typcode = ? AND note_id = ?";
/*    */   }
/*    */ 
/*    */   
/*    */   public void setParent(IDataAccessObject argDAO) {
/* 27 */     DocumentNoteDAO dao = (DocumentNoteDAO)argDAO;
...
/* 32 */     this._parameterList.add(dao.getNoteId());
/*    */   }
/*    */ 
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\DocumentNotePropertiesRelationshipDBA.class
