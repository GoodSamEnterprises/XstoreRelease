...
/*     */ 
/*     */ 
/*     */ public class OrganizerPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IOrganizerProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new OrganizerPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private OrganizerPropertyDAO getDAO_() {
/*  44 */     return (OrganizerPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IOrganizerProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getReportName();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setReportName_noev(argReportName) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IOrganizerProperty.SET_REPORTNAME, argReportName);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getReportName() == null && argReportName != null) || (
/* 112 */       getDAO_().getReportName() != null && !getDAO_().getReportName().equals(argReportName))) {
/* 113 */       getDAO_().setReportName(argReportName);
...
/* 125 */     return getDAO_().getReportGroup();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setReportGroup_noev(argReportGroup) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IOrganizerProperty.SET_REPORTGROUP, argReportGroup);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getReportGroup() == null && argReportGroup != null) || (
/* 146 */       getDAO_().getReportGroup() != null && !getDAO_().getReportGroup().equals(argReportGroup))) {
/* 147 */       getDAO_().setReportGroup(argReportGroup);
...
/* 159 */     return getDAO_().getReportElement();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setReportElement_noev(argReportElement) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IOrganizerProperty.SET_REPORTELEMENT, argReportElement);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getReportElement() == null && argReportElement != null) || (
/* 180 */       getDAO_().getReportElement() != null && !getDAO_().getReportElement().equals(argReportElement))) {
/* 181 */       getDAO_().setReportElement(argReportElement);
...
/* 204 */       this._events.post(IOrganizerProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IOrganizerProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IOrganizerProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IOrganizerProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IOrganizerProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IOrganizerProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IOrganizerProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IOrganizerProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IOrganizerProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("OrganizerPropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("OrganizerPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\rpt\impl\OrganizerPropertyModel.class
