...
/*     */ 
/*     */ 
/*     */ public class AddressPropertyId
...
/*     */   
/*     */   public AddressPropertyId() {}
/*     */   
/*     */   public AddressPropertyId(String argObjectIdValue) {
...
/*  30 */     return this._addressId;
/*     */   }
/*     */   
/*     */   public void setAddressId(String argAddressId) {
/*  34 */     this._addressId = (argAddressId != null && MANAGE_CASE) ? argAddressId.toUpperCase() : argAddressId;
/*     */   }
/*     */   
...
/*  80 */       return true;
/*     */     }
/*  82 */     if (!(ob instanceof AddressPropertyId)) {
/*  83 */       return false;
/*     */     }
/*  85 */     AddressPropertyId other = (AddressPropertyId)ob;
/*  86 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  89 */       .equals(other._organizationId))) && ((this._addressId == null && other._addressId == null) || (this._addressId != null && this._addressId
/*     */ 
/*     */       
/*  92 */       .equals(other._addressId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 102 */       .hashCode()) + ((this._addressId == null) ? 0 : this._addressId
...
/* 118 */       .append("::").append(this._addressId)
/* 119 */       .append("::").append(this._propertyCode)
/* 120 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 124 */     if (this._addressId == null) {
/* 125 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\AddressPropertyId.class
