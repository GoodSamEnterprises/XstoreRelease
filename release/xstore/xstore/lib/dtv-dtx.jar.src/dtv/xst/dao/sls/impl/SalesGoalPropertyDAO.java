...
/*     */ 
/*     */ 
/*     */ public class SalesGoalPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1611573524L;
/*  23 */   private static final Logger _logger = Logger.getLogger(SalesGoalPropertyDAO.class);
/*     */   
...
/*  48 */     return this._salesGoalId;
/*     */   }
/*     */   
/*     */   public void setSalesGoalId(String argSalesGoalId) {
/*  52 */     if (changed(argSalesGoalId, this._salesGoalId, "salesGoalId")) {
/*  53 */       this._salesGoalId = (argSalesGoalId != null && MANAGE_CASE) ? argSalesGoalId.toUpperCase() : argSalesGoalId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getSalesGoalId() != null) {
/* 159 */       buf.append("salesGoalId").append("=").append(getSalesGoalId()).append(" ");
/*     */     }
...
/* 193 */     SalesGoalPropertyId id = new SalesGoalPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setSalesGoalId(getSalesGoalId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((SalesGoalPropertyId)argObjectId).getOrganizationId());
/* 202 */     setSalesGoalId(((SalesGoalPropertyId)argObjectId).getSalesGoalId());
/* 203 */     setPropertyCode(((SalesGoalPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"SalesGoalProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._salesGoalId != null) values.put("SalesGoalId", DaoUtils.getXmlSafeFieldValue(12, this._salesGoalId)); 
...
/* 256 */             setSalesGoalId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setSalesGoalId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sls\impl\SalesGoalPropertyDAO.class
