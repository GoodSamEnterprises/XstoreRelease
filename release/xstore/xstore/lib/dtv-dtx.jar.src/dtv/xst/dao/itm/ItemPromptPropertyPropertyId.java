...
/*     */ 
/*     */ 
/*     */ public class ItemPromptPropertyPropertyId
...
/*     */   
/*     */   public ItemPromptPropertyPropertyId() {}
/*     */   
/*     */   public ItemPromptPropertyPropertyId(String argObjectIdValue) {
...
/*  39 */     return this._promptPropertyCode;
/*     */   }
/*     */   
/*     */   public void setPromptPropertyCode(String argPromptPropertyCode) {
/*  43 */     this._promptPropertyCode = (argPromptPropertyCode != null && MANAGE_CASE) ? argPromptPropertyCode.toUpperCase() : argPromptPropertyCode;
/*     */   }
/*     */   
...
/*  75 */         setPromptPropertyCode((String)null);
/*     */       } else {
/*     */         
/*  78 */         setPromptPropertyCode(str);
/*     */       } 
/*  80 */       str = tokens[3];
/*     */       
...
/*  97 */       return true;
/*     */     }
/*  99 */     if (!(ob instanceof ItemPromptPropertyPropertyId)) {
/* 100 */       return false;
/*     */     }
/* 102 */     ItemPromptPropertyPropertyId other = (ItemPromptPropertyPropertyId)ob;
...
/*     */ 
/*     */       
/* 109 */       .equals(other._itemId))) && ((this._promptPropertyCode == null && other._promptPropertyCode == null) || (this._promptPropertyCode != null && this._promptPropertyCode
/*     */ 
/*     */       
/* 112 */       .equals(other._promptPropertyCode))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 123 */       .hashCode()) + ((this._promptPropertyCode == null) ? 0 : this._promptPropertyCode
...
/* 130 */     return "ItemPromptPropertyProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 140 */       .append("::").append(this._promptPropertyCode)
...
/* 147 */       return false;
/*     */     }
/* 149 */     if (this._promptPropertyCode == null) {
/* 150 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\ItemPromptPropertyPropertyId.class
