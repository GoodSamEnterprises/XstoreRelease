...
/*     */ 
/*     */ 
/*     */ public class TaxAuthorityPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1755449875L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxAuthorityPropertyDAO.class);
/*     */   
...
/*  48 */     return this._taxAuthorityId;
/*     */   }
/*     */   
/*     */   public void setTaxAuthorityId(String argTaxAuthorityId) {
/*  52 */     if (changed(argTaxAuthorityId, this._taxAuthorityId, "taxAuthorityId")) {
/*  53 */       this._taxAuthorityId = (argTaxAuthorityId != null && MANAGE_CASE) ? argTaxAuthorityId.toUpperCase() : argTaxAuthorityId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getTaxAuthorityId() != null) {
/* 159 */       buf.append("taxAuthorityId").append("=").append(getTaxAuthorityId()).append(" ");
/*     */     }
...
/* 193 */     TaxAuthorityPropertyId id = new TaxAuthorityPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setTaxAuthorityId(getTaxAuthorityId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((TaxAuthorityPropertyId)argObjectId).getOrganizationId());
/* 202 */     setTaxAuthorityId(((TaxAuthorityPropertyId)argObjectId).getTaxAuthorityId());
/* 203 */     setPropertyCode(((TaxAuthorityPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"TaxAuthorityProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._taxAuthorityId != null) values.put("TaxAuthorityId", DaoUtils.getXmlSafeFieldValue(12, this._taxAuthorityId)); 
...
/* 256 */             setTaxAuthorityId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setTaxAuthorityId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxAuthorityPropertyDAO.class
