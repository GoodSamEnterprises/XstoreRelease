...
/*     */ 
/*     */ 
/*     */ public class InventoryCountBucketPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -67516942L;
/*  23 */   private static final Logger _logger = Logger.getLogger(InventoryCountBucketPropertyDAO.class);
/*     */   
...
/*  60 */     return this._inventoryCountId;
/*     */   }
/*     */   
/*     */   public void setInventoryCountId(String argInventoryCountId) {
/*  64 */     if (changed(argInventoryCountId, this._inventoryCountId, "inventoryCountId")) {
/*  65 */       this._inventoryCountId = (argInventoryCountId != null && MANAGE_CASE) ? argInventoryCountId.toUpperCase() : argInventoryCountId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getInventoryBucketId() {
/*  70 */     return this._inventoryBucketId;
/*     */   }
/*     */   
/*     */   public void setInventoryBucketId(String argInventoryBucketId) {
/*  74 */     if (changed(argInventoryBucketId, this._inventoryBucketId, "inventoryBucketId")) {
/*  75 */       this._inventoryBucketId = (argInventoryBucketId != null && MANAGE_CASE) ? argInventoryBucketId.toUpperCase() : argInventoryBucketId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 183 */     if (getInventoryCountId() != null) {
/* 184 */       buf.append("inventoryCountId").append("=").append(getInventoryCountId()).append(" ");
/*     */     }
/* 186 */     if (getInventoryBucketId() != null) {
/* 187 */       buf.append("inventoryBucketId").append("=").append(getInventoryBucketId()).append(" ");
/*     */     }
...
/* 221 */     InventoryCountBucketPropertyId id = new InventoryCountBucketPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setRetailLocationId(getRetailLocationId());
/* 224 */     id.setInventoryCountId(getInventoryCountId());
/* 225 */     id.setInventoryBucketId(getInventoryBucketId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((InventoryCountBucketPropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((InventoryCountBucketPropertyId)argObjectId).getRetailLocationId());
/* 233 */     setInventoryCountId(((InventoryCountBucketPropertyId)argObjectId).getInventoryCountId());
/* 234 */     setInventoryBucketId(((InventoryCountBucketPropertyId)argObjectId).getInventoryBucketId());
/* 235 */     setPropertyCode(((InventoryCountBucketPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"InventoryCountBucketProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._inventoryCountId != null) values.put("InventoryCountId", DaoUtils.getXmlSafeFieldValue(12, this._inventoryCountId)); 
/* 256 */     if (this._inventoryBucketId != null) values.put("InventoryBucketId", DaoUtils.getXmlSafeFieldValue(12, this._inventoryBucketId)); 
...
/* 299 */             setInventoryCountId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setInventoryCountId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setInventoryBucketId((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setInventoryBucketId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\InventoryCountBucketPropertyDAO.class
