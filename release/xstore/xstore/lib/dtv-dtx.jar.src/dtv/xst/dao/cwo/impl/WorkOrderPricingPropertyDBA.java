...
/*     */ 
/*     */ 
/*     */ public class WorkOrderPricingPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.price_code, t.item_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_work_order_pricing_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND price_code = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.price_code, t.item_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM cwo_work_order_pricing_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND price_code = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO cwo_work_order_pricing_p(organization_id, price_code, item_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._priceCode, this._itemId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE cwo_work_order_pricing_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM cwo_work_order_pricing_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND price_code = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND price_code = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._priceCode, this._itemId, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "cwo_work_order_pricing_p";
/*     */   }
/*     */   
...
/* 116 */     return new WorkOrderPricingPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class WorkOrderPricingPropertyFiller
/*     */     implements IFiller {
/*     */     private WorkOrderPricingPropertyDBA _parent;
/*     */     
/*     */     public WorkOrderPricingPropertyFiller(WorkOrderPricingPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._priceCode = argResultSet.getString(2);
...
/* 175 */     WorkOrderPricingPropertyDAO dao = (WorkOrderPricingPropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setPriceCode(this._priceCode);
...
/* 193 */     return loadDAO((IDataAccessObject)new WorkOrderPricingPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     WorkOrderPricingPropertyDAO dao = (WorkOrderPricingPropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._priceCode = dao.getPriceCode();
...
/* 213 */     WorkOrderPricingPropertyId id = (WorkOrderPricingPropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getPriceCode());
...
/* 222 */     WorkOrderPricingPropertyId id = new WorkOrderPricingPropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setPriceCode(this._priceCode);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cwo\impl\WorkOrderPricingPropertyDBA.class
