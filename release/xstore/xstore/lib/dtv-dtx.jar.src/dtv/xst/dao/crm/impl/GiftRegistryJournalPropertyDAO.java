...
/*     */ 
/*     */ 
/*     */ public class GiftRegistryJournalPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1550634817L;
/*  23 */   private static final Logger _logger = Logger.getLogger(GiftRegistryJournalPropertyDAO.class);
/*     */   
...
/*  52 */     if (changed(argJournalSequence, this._journalSequence, "journalSequence")) {
/*  53 */       this._journalSequence = argJournalSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getJournalSequence() != null) {
/* 159 */       buf.append("journalSequence").append("=").append(getJournalSequence()).append(" ");
/*     */     }
...
/* 193 */     GiftRegistryJournalPropertyId id = new GiftRegistryJournalPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setJournalSequence(getJournalSequence());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((GiftRegistryJournalPropertyId)argObjectId).getOrganizationId());
/* 202 */     setJournalSequence(((GiftRegistryJournalPropertyId)argObjectId).getJournalSequence());
/* 203 */     setPropertyCode(((GiftRegistryJournalPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"GiftRegistryJournalProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._journalSequence != null) values.put("JournalSequence", DaoUtils.getXmlSafeFieldValue(-5, this._journalSequence)); 
...
/* 256 */             setJournalSequence((Long)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setJournalSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\GiftRegistryJournalPropertyDAO.class
