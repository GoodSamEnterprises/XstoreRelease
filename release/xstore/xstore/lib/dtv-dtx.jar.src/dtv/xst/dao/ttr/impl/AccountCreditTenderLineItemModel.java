...
/*     */ 
/*     */ 
/*     */ public class AccountCreditTenderLineItemModel
/*     */   extends TenderLineItemModel
/*     */   implements IAccountCreditTenderLineItem
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  30 */     setDAO((IDataAccessObject)new AccountCreditTenderLineItemDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private AccountCreditTenderLineItemDAO getDAO_() {
/*  38 */     return (AccountCreditTenderLineItemDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  57 */       this._events.post(IAccountCreditTenderLineItem.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */       this._events.post(IAccountCreditTenderLineItem.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */       this._events.post(IAccountCreditTenderLineItem.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 159 */       this._events.post(IAccountCreditTenderLineItem.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 182 */     return getDAO_().getCustAccountId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 190 */     if (setCustAccountId_noev(argCustAccountId) && 
/* 191 */       this._events != null && 
/* 192 */       postEventsForChanges()) {
/* 193 */       this._events.post(IAccountCreditTenderLineItem.SET_CUSTACCOUNTID, argCustAccountId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 202 */     if ((getDAO_().getCustAccountId() == null && argCustAccountId != null) || (
/* 203 */       getDAO_().getCustAccountId() != null && !getDAO_().getCustAccountId().equals(argCustAccountId))) {
/* 204 */       getDAO_().setCustAccountId(argCustAccountId);
...
/* 216 */     return getDAO_().getCustAccountCode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 224 */     if (setCustAccountCode_noev(argCustAccountCode) && 
/* 225 */       this._events != null && 
/* 226 */       postEventsForChanges()) {
/* 227 */       this._events.post(IAccountCreditTenderLineItem.SET_CUSTACCOUNTCODE, argCustAccountCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 236 */     if ((getDAO_().getCustAccountCode() == null && argCustAccountCode != null) || (
/* 237 */       getDAO_().getCustAccountCode() != null && !getDAO_().getCustAccountCode().equals(argCustAccountCode))) {
/* 238 */       getDAO_().setCustAccountCode(argCustAccountCode);
...
/* 248 */     if ("AccountCreditTenderLineItemExtension".equals(argFieldId)) {
...
/* 258 */     if ("AccountCreditTenderLineItemExtension".equals(argFieldId)) {
...
/*     */   }
/*     */   
/*     */   public IDataModel getAccountCreditTenderLineItemExt() {
/* 272 */     return this._myExtension;
/*     */   }
/*     */   
/*     */   public void setAccountCreditTenderLineItemExt(IDataModel argExt) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\AccountCreditTenderLineItemModel.class
