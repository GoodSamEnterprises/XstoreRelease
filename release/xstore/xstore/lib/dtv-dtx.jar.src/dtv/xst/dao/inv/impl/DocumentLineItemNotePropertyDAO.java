...
/*     */ 
/*     */ 
/*     */ public class DocumentLineItemNotePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 83145865L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DocumentLineItemNotePropertyDAO.class);
/*     */   
...
/* 249 */     DocumentLineItemNotePropertyId id = new DocumentLineItemNotePropertyId();
...
/* 261 */     setOrganizationId(((DocumentLineItemNotePropertyId)argObjectId).getOrganizationId());
/* 262 */     setRetailLocationId(((DocumentLineItemNotePropertyId)argObjectId).getRetailLocationId());
/* 263 */     setDocumentId(((DocumentLineItemNotePropertyId)argObjectId).getDocumentId());
/* 264 */     setDocumentTypeCode(((DocumentLineItemNotePropertyId)argObjectId).getDocumentTypeCode());
/* 265 */     setInventoryDocumentLineNumber(((DocumentLineItemNotePropertyId)argObjectId).getInventoryDocumentLineNumber());
/* 266 */     setNoteId(((DocumentLineItemNotePropertyId)argObjectId).getNoteId());
/* 267 */     setPropertyCode(((DocumentLineItemNotePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 276 */     buf.append("<").append("dao").append(" name=\"DocumentLineItemNoteProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 289 */     if (this._inventoryDocumentLineNumber != null) values.put("InventoryDocumentLineNumber", DaoUtils.getXmlSafeFieldValue(4, this._inventoryDocumentLineNumber)); 
/* 290 */     if (this._noteId != null) values.put("NoteId", DaoUtils.getXmlSafeFieldValue(-5, this._noteId)); 
...
/* 351 */             setInventoryDocumentLineNumber((Integer)value);
/* 352 */           } catch (Exception ee) {
/* 353 */             throw new DtxException("An exception occurred while calling setInventoryDocumentLineNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "NoteId":
...
/* 360 */             setNoteId((Long)value);
/* 361 */           } catch (Exception ee) {
/* 362 */             throw new DtxException("An exception occurred while calling setNoteId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\DocumentLineItemNotePropertyDAO.class
