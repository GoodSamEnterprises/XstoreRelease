...
/*     */ 
/*     */ 
/*     */ public class PayrollNotesPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1661946545L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PayrollNotesPropertyDAO.class);
/*     */   
...
/*  60 */     return (Date)this._weekEndingDate;
/*     */   }
/*     */   
/*     */   public void setWeekEndingDate(Date argWeekEndingDate) {
/*  64 */     if (changed(argWeekEndingDate, this._weekEndingDate, "weekEndingDate")) {
/*  65 */       this._weekEndingDate = (argWeekEndingDate == null || argWeekEndingDate instanceof DtvDate) ? (DtvDate)argWeekEndingDate : new DtvDate(argWeekEndingDate);
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   public Long getNoteSeq() {
/*  71 */     return this._noteSeq;
/*     */   }
/*     */   
/*     */   public void setNoteSeq(Long argNoteSeq) {
/*  75 */     if (changed(argNoteSeq, this._noteSeq, "noteSeq")) {
/*  76 */       this._noteSeq = argNoteSeq;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 184 */     if (getWeekEndingDate() != null) {
/* 185 */       buf.append("weekEndingDate").append("=").append(getWeekEndingDate()).append(" ");
/*     */     }
/* 187 */     if (getNoteSeq() != null) {
/* 188 */       buf.append("noteSeq").append("=").append(getNoteSeq()).append(" ");
/*     */     }
...
/* 222 */     PayrollNotesPropertyId id = new PayrollNotesPropertyId();
/* 223 */     id.setOrganizationId(getOrganizationId());
/* 224 */     id.setPartyId(getPartyId());
/* 225 */     id.setWeekEndingDate(getWeekEndingDate());
/* 226 */     id.setNoteSeq(getNoteSeq());
/* 227 */     id.setPropertyCode(getPropertyCode());
/* 228 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 232 */     setOrganizationId(((PayrollNotesPropertyId)argObjectId).getOrganizationId());
/* 233 */     setPartyId(((PayrollNotesPropertyId)argObjectId).getPartyId());
/* 234 */     setWeekEndingDate(((PayrollNotesPropertyId)argObjectId).getWeekEndingDate());
/* 235 */     setNoteSeq(((PayrollNotesPropertyId)argObjectId).getNoteSeq());
/* 236 */     setPropertyCode(((PayrollNotesPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 245 */     buf.append("<").append("dao").append(" name=\"PayrollNotesProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 256 */     if (this._weekEndingDate != null) values.put("WeekEndingDate", DaoUtils.getXmlSafeFieldValue(91, this._weekEndingDate)); 
/* 257 */     if (this._noteSeq != null) values.put("NoteSeq", DaoUtils.getXmlSafeFieldValue(-5, this._noteSeq)); 
...
/* 300 */             setWeekEndingDate((Date)value);
/* 301 */           } catch (Exception ee) {
/* 302 */             throw new DtxException("An exception occurred while calling setWeekEndingDate() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "NoteSeq":
...
/* 309 */             setNoteSeq((Long)value);
/* 310 */           } catch (Exception ee) {
/* 311 */             throw new DtxException("An exception occurred while calling setNoteSeq() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\impl\PayrollNotesPropertyDAO.class
