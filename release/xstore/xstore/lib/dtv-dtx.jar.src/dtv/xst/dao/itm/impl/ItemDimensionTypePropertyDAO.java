...
/*     */ 
/*     */ 
/*     */ public class ItemDimensionTypePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 977190466L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemDimensionTypePropertyDAO.class);
/*     */   
...
/*     */     }
/* 169 */     if (getDimensionSystem() != null) {
/* 170 */       buf.append("dimensionSystem").append("=").append(getDimensionSystem()).append(" ");
/*     */     }
/* 172 */     if (getDimension() != null) {
/* 173 */       buf.append("dimension").append("=").append(getDimension()).append(" ");
/*     */     }
...
/* 207 */     ItemDimensionTypePropertyId id = new ItemDimensionTypePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setDimensionSystem(getDimensionSystem());
/* 210 */     id.setDimension(getDimension());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((ItemDimensionTypePropertyId)argObjectId).getOrganizationId());
/* 217 */     setDimensionSystem(((ItemDimensionTypePropertyId)argObjectId).getDimensionSystem());
/* 218 */     setDimension(((ItemDimensionTypePropertyId)argObjectId).getDimension());
/* 219 */     setPropertyCode(((ItemDimensionTypePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"ItemDimensionTypeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._dimensionSystem != null) values.put("DimensionSystem", DaoUtils.getXmlSafeFieldValue(12, this._dimensionSystem)); 
/* 239 */     if (this._dimension != null) values.put("Dimension", DaoUtils.getXmlSafeFieldValue(12, this._dimension)); 
...
/* 273 */             setDimensionSystem((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setDimensionSystem() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "Dimension":
...
/* 282 */             setDimension((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setDimension() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemDimensionTypePropertyDAO.class
