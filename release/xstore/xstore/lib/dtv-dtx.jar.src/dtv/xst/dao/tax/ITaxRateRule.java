...
/*    */ 
/*    */ public interface ITaxRateRule extends IDataModel, ITaxRateRuleModel, IHasDataProperty<ITaxRateRuleProperty> {
...
/* 12 */   public static final EventEnum SET_TAXRATERULESEQUENCE = new EventEnum("set taxRateRuleSequence");
/* 13 */   public static final EventEnum SET_TAXRULESEQUENCE = new EventEnum("set taxRuleSequence");
...
/* 21 */   public static final EventEnum SET_BREAKPOINTTYPECODE = new EventEnum("set breakPointTypeCode");
/* 22 */   public static final EventEnum SET_DAILYENDTIMEDAO = new EventEnum("set dailyEndTimeDao");
/* 23 */   public static final EventEnum SET_DAILYSTARTTIMEDAO = new EventEnum("set dailyStartTimeDao");
/* 24 */   public static final EventEnum SET_EFFECTIVEDATETIMESTAMP = new EventEnum("set effectiveDatetimestamp");
/* 25 */   public static final EventEnum SET_EXPIRATIONDATETIMESTAMP = new EventEnum("set expirationDatetimestamp");
...
/* 30 */   public static final EventEnum SET_EXTERNALSYSTEM = new EventEnum("set externalSystem");
...
/*    */   
/*    */   IDataModel getTaxRateRuleExt();
/*    */   
/*    */   void setTaxRateRuleExt(IDataModel paramIDataModel);
/*    */   
/*    */   List<ITaxRateRuleProperty> getProperties();
/*    */   
/*    */   void setProperties(List<ITaxRateRuleProperty> paramList);
/*    */   
/*    */   void addTaxRateRuleProperty(ITaxRateRuleProperty paramITaxRateRuleProperty);
/*    */   
/*    */   void removeTaxRateRuleProperty(ITaxRateRuleProperty paramITaxRateRuleProperty);
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\ITaxRateRule.class
