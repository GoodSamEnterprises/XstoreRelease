...
/*     */ 
/*     */ 
/*     */ public class CouponPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1711120325L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CouponPropertyDAO.class);
/*     */   
...
/*  38 */     return this._couponSerialNumber;
/*     */   }
/*     */   
/*     */   public void setCouponSerialNumber(String argCouponSerialNumber) {
/*  42 */     if (changed(argCouponSerialNumber, this._couponSerialNumber, "couponSerialNumber")) {
/*  43 */       this._couponSerialNumber = (argCouponSerialNumber != null && MANAGE_CASE) ? argCouponSerialNumber.toUpperCase() : argCouponSerialNumber;
/*     */     }
/*     */   }
/*     */   
...
/* 155 */     if (getCouponSerialNumber() != null) {
/* 156 */       buf.append("couponSerialNumber").append("=").append(getCouponSerialNumber()).append(" ");
/*     */     }
...
/* 193 */     CouponPropertyId id = new CouponPropertyId();
/* 194 */     id.setCouponSerialNumber(getCouponSerialNumber());
...
/* 201 */     setCouponSerialNumber(((CouponPropertyId)argObjectId).getCouponSerialNumber());
/* 202 */     setOrganizationId(((CouponPropertyId)argObjectId).getOrganizationId());
/* 203 */     setPropertyCode(((CouponPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"CouponProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 221 */     if (this._couponSerialNumber != null) values.put("CouponSerialNumber", DaoUtils.getXmlSafeFieldValue(12, this._couponSerialNumber)); 
...
/* 247 */             setCouponSerialNumber((String)value);
/* 248 */           } catch (Exception ee) {
/* 249 */             throw new DtxException("An exception occurred while calling setCouponSerialNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\dsc\impl\CouponPropertyDAO.class
