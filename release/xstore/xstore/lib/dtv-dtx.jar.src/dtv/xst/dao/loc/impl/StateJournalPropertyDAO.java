...
/*     */ 
/*     */ 
/*     */ public class StateJournalPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2001920645L;
/*  23 */   private static final Logger _logger = Logger.getLogger(StateJournalPropertyDAO.class);
/*     */   
...
/*  71 */     return this._statusTypcode;
/*     */   }
/*     */   
/*     */   public void setStatusTypcode(String argStatusTypcode) {
/*  75 */     if (changed(argStatusTypcode, this._statusTypcode, "statusTypcode")) {
/*  76 */       this._statusTypcode = (argStatusTypcode != null && MANAGE_CASE) ? argStatusTypcode.toUpperCase() : argStatusTypcode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getStateJournalId() {
/*  81 */     return this._stateJournalId;
/*     */   }
/*     */   
/*     */   public void setStateJournalId(String argStateJournalId) {
/*  85 */     if (changed(argStateJournalId, this._stateJournalId, "stateJournalId")) {
/*  86 */       this._stateJournalId = (argStateJournalId != null && MANAGE_CASE) ? argStateJournalId.toUpperCase() : argStateJournalId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 197 */     if (getStatusTypcode() != null) {
/* 198 */       buf.append("statusTypcode").append("=").append(getStatusTypcode()).append(" ");
/*     */     }
/* 200 */     if (getStateJournalId() != null) {
/* 201 */       buf.append("stateJournalId").append("=").append(getStateJournalId()).append(" ");
/*     */     }
...
/* 235 */     StateJournalPropertyId id = new StateJournalPropertyId();
...
/* 239 */     id.setStatusTypcode(getStatusTypcode());
/* 240 */     id.setStateJournalId(getStateJournalId());
/* 241 */     id.setPropertyCode(getPropertyCode());
/* 242 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 246 */     setOrganizationId(((StateJournalPropertyId)argObjectId).getOrganizationId());
/* 247 */     setRetailLocationId(((StateJournalPropertyId)argObjectId).getRetailLocationId());
/* 248 */     setWorkstationId(((StateJournalPropertyId)argObjectId).getWorkstationId());
/* 249 */     setStatusTypcode(((StateJournalPropertyId)argObjectId).getStatusTypcode());
/* 250 */     setStateJournalId(((StateJournalPropertyId)argObjectId).getStateJournalId());
/* 251 */     setPropertyCode(((StateJournalPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"StateJournalProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 272 */     if (this._statusTypcode != null) values.put("StatusTypcode", DaoUtils.getXmlSafeFieldValue(12, this._statusTypcode)); 
/* 273 */     if (this._stateJournalId != null) values.put("StateJournalId", DaoUtils.getXmlSafeFieldValue(12, this._stateJournalId)); 
...
/* 325 */             setStatusTypcode((String)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setStatusTypcode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "StateJournalId":
...
/* 334 */             setStateJournalId((String)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setStateJournalId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\StateJournalPropertyDAO.class
