...
/*     */ 
/*     */ 
/*     */ public class CustomerAffiliationPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 320179207L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerAffiliationPropertyDAO.class);
/*     */   
...
/* 207 */     CustomerAffiliationPropertyId id = new CustomerAffiliationPropertyId();
...
/* 216 */     setOrganizationId(((CustomerAffiliationPropertyId)argObjectId).getOrganizationId());
/* 217 */     setPartyId(((CustomerAffiliationPropertyId)argObjectId).getPartyId());
/* 218 */     setCustomerGroupId(((CustomerAffiliationPropertyId)argObjectId).getCustomerGroupId());
/* 219 */     setPropertyCode(((CustomerAffiliationPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CustomerAffiliationProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\CustomerAffiliationPropertyDAO.class
