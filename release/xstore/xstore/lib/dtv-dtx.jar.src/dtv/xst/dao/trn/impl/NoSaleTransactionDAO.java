...
/*     */ 
/*     */ 
/*     */ public class NoSaleTransactionDAO
/*     */   extends PosTransactionDAO
/*     */ {
/*     */   private static final long serialVersionUID = -1533728778L;
/*  23 */   private static final Logger _logger = Logger.getLogger(NoSaleTransactionDAO.class);
/*     */   
...
/*  74 */     return this._noSaleReasonCode;
/*     */   }
/*     */   
/*     */   public void setNoSaleReasonCode(String argNoSaleReasonCode) {
/*  78 */     if (changed(argNoSaleReasonCode, this._noSaleReasonCode, "noSaleReasonCode")) {
/*  79 */       this._noSaleReasonCode = argNoSaleReasonCode;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     }
/* 100 */     if (getNoSaleReasonCode() != null) {
/* 101 */       buf.append("noSaleReasonCode").append("=").append(getNoSaleReasonCode()).append(" ");
/*     */     }
/*     */     
...
/* 110 */     buf.append("<").append("dao").append(" name=\"NoSaleTransaction\" cmd=\"" + getObjectStateString() + "\">");
...
/* 123 */     if (this._noSaleReasonCode != null) values.put("NoSaleReasonCode", DaoUtils.getXmlSafeFieldValue(12, this._noSaleReasonCode)); 
/* 124 */     return values;
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */         
/*     */         case "NoSaleReasonCode":
/*     */           try {
/* 174 */             Object value = DaoUtils.getFieldValueForXmlString(12, fieldValue);
/* 175 */             setNoSaleReasonCode((String)value);
/* 176 */           } catch (Exception ee) {
/* 177 */             throw new DtxException("An exception occurred while calling setNoSaleReasonCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */       } 
/*     */     } 
/*     */   }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\NoSaleTransactionDAO.class
