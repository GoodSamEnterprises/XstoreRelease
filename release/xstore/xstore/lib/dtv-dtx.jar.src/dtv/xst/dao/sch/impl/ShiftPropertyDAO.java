...
/*     */ 
/*     */ 
/*     */ public class ShiftPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -748602281L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ShiftPropertyDAO.class);
/*     */   
...
/*  48 */     return this._shiftId;
/*     */   }
/*     */   
/*     */   public void setShiftId(Long argShiftId) {
/*  52 */     if (changed(argShiftId, this._shiftId, "shiftId")) {
/*  53 */       this._shiftId = argShiftId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getShiftId() != null) {
/* 159 */       buf.append("shiftId").append("=").append(getShiftId()).append(" ");
/*     */     }
...
/* 193 */     ShiftPropertyId id = new ShiftPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setShiftId(getShiftId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((ShiftPropertyId)argObjectId).getOrganizationId());
/* 202 */     setShiftId(((ShiftPropertyId)argObjectId).getShiftId());
/* 203 */     setPropertyCode(((ShiftPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ShiftProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._shiftId != null) values.put("ShiftId", DaoUtils.getXmlSafeFieldValue(-5, this._shiftId)); 
...
/* 256 */             setShiftId((Long)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setShiftId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sch\impl\ShiftPropertyDAO.class
