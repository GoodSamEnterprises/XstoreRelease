...
/*     */ 
/*     */ 
/*     */ public class CustomerAccountPlanPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1337897459L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerAccountPlanPropertyDAO.class);
/*     */   
...
/*  49 */     return this._custAccountCode;
/*     */   }
/*     */   
/*     */   public void setCustAccountCode(String argCustAccountCode) {
/*  53 */     if (changed(argCustAccountCode, this._custAccountCode, "custAccountCode")) {
/*  54 */       this._custAccountCode = (argCustAccountCode != null && MANAGE_CASE) ? argCustAccountCode.toUpperCase() : argCustAccountCode;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getPlanId() {
/*  59 */     return this._planId;
/*     */   }
/*     */   
/*     */   public void setPlanId(String argPlanId) {
/*  63 */     if (changed(argPlanId, this._planId, "planId")) {
/*  64 */       this._planId = (argPlanId != null && MANAGE_CASE) ? argPlanId.toUpperCase() : argPlanId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getCustAccountCode() != null) {
/* 170 */       buf.append("custAccountCode").append("=").append(getCustAccountCode()).append(" ");
/*     */     }
/* 172 */     if (getPlanId() != null) {
/* 173 */       buf.append("planId").append("=").append(getPlanId()).append(" ");
/*     */     }
...
/* 207 */     CustomerAccountPlanPropertyId id = new CustomerAccountPlanPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setCustAccountCode(getCustAccountCode());
/* 210 */     id.setPlanId(getPlanId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((CustomerAccountPlanPropertyId)argObjectId).getOrganizationId());
/* 217 */     setCustAccountCode(((CustomerAccountPlanPropertyId)argObjectId).getCustAccountCode());
/* 218 */     setPlanId(((CustomerAccountPlanPropertyId)argObjectId).getPlanId());
/* 219 */     setPropertyCode(((CustomerAccountPlanPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"CustomerAccountPlanProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._custAccountCode != null) values.put("CustAccountCode", DaoUtils.getXmlSafeFieldValue(12, this._custAccountCode)); 
/* 239 */     if (this._planId != null) values.put("PlanId", DaoUtils.getXmlSafeFieldValue(12, this._planId)); 
...
/* 273 */             setCustAccountCode((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setCustAccountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PlanId":
...
/* 282 */             setPlanId((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setPlanId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerAccountPlanPropertyDAO.class
