...
/*     */ 
/*     */ 
/*     */ public class OrgHierarchyPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -528828218L;
/*  23 */   private static final Logger _logger = Logger.getLogger(OrgHierarchyPropertyDAO.class);
/*     */   
...
/*     */     }
/* 169 */     if (getLevelCode() != null) {
/* 170 */       buf.append("levelCode").append("=").append(getLevelCode()).append(" ");
/*     */     }
/* 172 */     if (getLevelValue() != null) {
/* 173 */       buf.append("levelValue").append("=").append(getLevelValue()).append(" ");
/*     */     }
...
/* 207 */     OrgHierarchyPropertyId id = new OrgHierarchyPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setLevelCode(getLevelCode());
/* 210 */     id.setLevelValue(getLevelValue());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((OrgHierarchyPropertyId)argObjectId).getOrganizationId());
/* 217 */     setLevelCode(((OrgHierarchyPropertyId)argObjectId).getLevelCode());
/* 218 */     setLevelValue(((OrgHierarchyPropertyId)argObjectId).getLevelValue());
/* 219 */     setPropertyCode(((OrgHierarchyPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"OrgHierarchyProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._levelCode != null) values.put("LevelCode", DaoUtils.getXmlSafeFieldValue(12, this._levelCode)); 
/* 239 */     if (this._levelValue != null) values.put("LevelValue", DaoUtils.getXmlSafeFieldValue(12, this._levelValue)); 
...
/* 273 */             setLevelCode((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setLevelCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "LevelValue":
...
/* 282 */             setLevelValue((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setLevelValue() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\OrgHierarchyPropertyDAO.class
