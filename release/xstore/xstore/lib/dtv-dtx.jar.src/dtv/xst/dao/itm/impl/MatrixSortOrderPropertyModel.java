...
/*     */ 
/*     */ 
/*     */ public class MatrixSortOrderPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IMatrixSortOrderProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new MatrixSortOrderPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private MatrixSortOrderPropertyDAO getDAO_() {
/*  44 */     return (MatrixSortOrderPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IMatrixSortOrderProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getMatrixSortType();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setMatrixSortType_noev(argMatrixSortType) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IMatrixSortOrderProperty.SET_MATRIXSORTTYPE, argMatrixSortType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getMatrixSortType() == null && argMatrixSortType != null) || (
/* 112 */       getDAO_().getMatrixSortType() != null && !getDAO_().getMatrixSortType().equals(argMatrixSortType))) {
/* 113 */       getDAO_().setMatrixSortType(argMatrixSortType);
...
/* 125 */     return getDAO_().getMatrixSortId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setMatrixSortId_noev(argMatrixSortId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IMatrixSortOrderProperty.SET_MATRIXSORTID, argMatrixSortId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getMatrixSortId() == null && argMatrixSortId != null) || (
/* 146 */       getDAO_().getMatrixSortId() != null && !getDAO_().getMatrixSortId().equals(argMatrixSortId))) {
/* 147 */       getDAO_().setMatrixSortId(argMatrixSortId);
...
/* 170 */       this._events.post(IMatrixSortOrderProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IMatrixSortOrderProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IMatrixSortOrderProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IMatrixSortOrderProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IMatrixSortOrderProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IMatrixSortOrderProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IMatrixSortOrderProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IMatrixSortOrderProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IMatrixSortOrderProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("MatrixSortOrderPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("MatrixSortOrderPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\MatrixSortOrderPropertyModel.class
