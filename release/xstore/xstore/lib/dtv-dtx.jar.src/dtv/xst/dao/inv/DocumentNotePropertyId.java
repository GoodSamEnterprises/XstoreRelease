...
/*     */ 
/*     */ 
/*     */ public class DocumentNotePropertyId
...
/*     */   
/*     */   public DocumentNotePropertyId() {}
/*     */   
/*     */   public DocumentNotePropertyId(String argObjectIdValue) {
...
/*  57 */     return this._noteId;
/*     */   }
/*     */   
/*     */   public void setNoteId(Long argNoteId) {
/*  61 */     this._noteId = argNoteId;
/*     */   }
/*     */   
...
/* 101 */       str = tokens[4];
/*     */       
/* 103 */       setNoteId(Long.valueOf(str));
/* 104 */       str = tokens[5];
/*     */       
...
/* 121 */       return true;
/*     */     }
/* 123 */     if (!(ob instanceof DocumentNotePropertyId)) {
/* 124 */       return false;
/*     */     }
/* 126 */     DocumentNotePropertyId other = (DocumentNotePropertyId)ob;
...
/*     */ 
/*     */       
/* 139 */       .equals(other._documentTypeCode))) && ((this._noteId == null && other._noteId == null) || (this._noteId != null && this._noteId
/*     */ 
/*     */       
/* 142 */       .equals(other._noteId))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/* 155 */       .hashCode()) + ((this._noteId == null) ? 0 : this._noteId
...
/* 162 */     return "DocumentNoteProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 174 */       .append("::").append(String.valueOf(this._noteId))
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\DocumentNotePropertyId.class
