...
/*     */ 
/*     */ 
/*     */ public class EmployeeTimeOffPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1132415657L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeTimeOffPropertyDAO.class);
/*     */   
...
/*     */     }
/* 172 */     if (getTimeOffSeq() != null) {
/* 173 */       buf.append("timeOffSeq").append("=").append(getTimeOffSeq()).append(" ");
/*     */     }
...
/* 207 */     EmployeeTimeOffPropertyId id = new EmployeeTimeOffPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setEmployeeId(getEmployeeId());
/* 210 */     id.setTimeOffSeq(getTimeOffSeq());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((EmployeeTimeOffPropertyId)argObjectId).getOrganizationId());
/* 217 */     setEmployeeId(((EmployeeTimeOffPropertyId)argObjectId).getEmployeeId());
/* 218 */     setTimeOffSeq(((EmployeeTimeOffPropertyId)argObjectId).getTimeOffSeq());
/* 219 */     setPropertyCode(((EmployeeTimeOffPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"EmployeeTimeOffProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._timeOffSeq != null) values.put("TimeOffSeq", DaoUtils.getXmlSafeFieldValue(-5, this._timeOffSeq)); 
...
/* 282 */             setTimeOffSeq((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setTimeOffSeq() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sch\impl\EmployeeTimeOffPropertyDAO.class
