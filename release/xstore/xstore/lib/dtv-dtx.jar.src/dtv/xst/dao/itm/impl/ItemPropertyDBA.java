...
/*     */ 
/*     */ 
/*     */ public class ItemPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -200389080L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.item_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_p t";
...
/*  44 */     return "SELECT t.organization_id, t.item_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_item_p(organization_id, item_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_item_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_item_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   
...
/* 115 */     return new ItemPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ItemPropertyFiller
/*     */     implements IFiller {
/*     */     private ItemPropertyDBA _parent;
/*     */     
/*     */     public ItemPropertyFiller(ItemPropertyDBA argParent) {
...
/* 173 */     ItemPropertyDAO dao = (ItemPropertyDAO)argDAO;
...
/* 190 */     return loadDAO((IDataAccessObject)new ItemPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     ItemPropertyDAO dao = (ItemPropertyDAO)argDAO;
...
/* 209 */     ItemPropertyId id = (ItemPropertyId)argId;
...
/* 217 */     ItemPropertyId id = new ItemPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemPropertyDBA.class
