...
/*     */ 
/*     */ 
/*     */ public class StateJournalPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IStateJournalProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new StateJournalPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private StateJournalPropertyDAO getDAO_() {
/*  44 */     return (StateJournalPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IStateJournalProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(IStateJournalProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 146 */       this._events.post(IStateJournalProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 169 */     return getDAO_().getStatusTypcode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 177 */     if (setStatusTypcode_noev(argStatusTypcode) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(IStateJournalProperty.SET_STATUSTYPCODE, argStatusTypcode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getStatusTypcode() == null && argStatusTypcode != null) || (
/* 190 */       getDAO_().getStatusTypcode() != null && !getDAO_().getStatusTypcode().equals(argStatusTypcode))) {
/* 191 */       getDAO_().setStatusTypcode(argStatusTypcode);
...
/* 203 */     return getDAO_().getStateJournalId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 211 */     if (setStateJournalId_noev(argStateJournalId) && 
/* 212 */       this._events != null && 
/* 213 */       postEventsForChanges()) {
/* 214 */       this._events.post(IStateJournalProperty.SET_STATEJOURNALID, argStateJournalId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 223 */     if ((getDAO_().getStateJournalId() == null && argStateJournalId != null) || (
/* 224 */       getDAO_().getStateJournalId() != null && !getDAO_().getStateJournalId().equals(argStateJournalId))) {
/* 225 */       getDAO_().setStateJournalId(argStateJournalId);
...
/* 248 */       this._events.post(IStateJournalProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(IStateJournalProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(IStateJournalProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(IStateJournalProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(IStateJournalProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(IStateJournalProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(IStateJournalProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(IStateJournalProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 520 */       this._events.post(IStateJournalProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 541 */     if ("StateJournalPropertyExtension".equals(argFieldId)) {
...
/* 551 */     if ("StateJournalPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\StateJournalPropertyModel.class
