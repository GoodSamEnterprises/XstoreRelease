...
/*     */ 
/*     */ 
/*     */ public class AddressPostalCodePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IAddressPostalCodeProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new AddressPostalCodePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private AddressPostalCodePropertyDAO getDAO_() {
/*  44 */     return (AddressPostalCodePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(IAddressPostalCodeProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  91 */     return getDAO_().getCountryId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (setCountryId_noev(argCountryId) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IAddressPostalCodeProperty.SET_COUNTRYID, argCountryId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getCountryId() == null && argCountryId != null) || (
/* 112 */       getDAO_().getCountryId() != null && !getDAO_().getCountryId().equals(argCountryId))) {
/* 113 */       getDAO_().setCountryId(argCountryId);
...
/* 125 */     return getDAO_().getPostalCodeId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setPostalCodeId_noev(argPostalCodeId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IAddressPostalCodeProperty.SET_POSTALCODEID, argPostalCodeId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getPostalCodeId() == null && argPostalCodeId != null) || (
/* 146 */       getDAO_().getPostalCodeId() != null && !getDAO_().getPostalCodeId().equals(argPostalCodeId))) {
/* 147 */       getDAO_().setPostalCodeId(argPostalCodeId);
...
/* 159 */     return getDAO_().getAddressMode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 167 */     if (setAddressMode_noev(argAddressMode) && 
/* 168 */       this._events != null && 
/* 169 */       postEventsForChanges()) {
/* 170 */       this._events.post(IAddressPostalCodeProperty.SET_ADDRESSMODE, argAddressMode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 179 */     if ((getDAO_().getAddressMode() == null && argAddressMode != null) || (
/* 180 */       getDAO_().getAddressMode() != null && !getDAO_().getAddressMode().equals(argAddressMode))) {
/* 181 */       getDAO_().setAddressMode(argAddressMode);
...
/* 204 */       this._events.post(IAddressPostalCodeProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IAddressPostalCodeProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IAddressPostalCodeProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IAddressPostalCodeProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IAddressPostalCodeProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IAddressPostalCodeProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IAddressPostalCodeProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IAddressPostalCodeProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 476 */       this._events.post(IAddressPostalCodeProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 497 */     if ("AddressPostalCodePropertyExtension".equals(argFieldId)) {
...
/* 507 */     if ("AddressPostalCodePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AddressPostalCodePropertyModel.class
