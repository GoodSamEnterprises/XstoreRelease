...
/*     */ 
/*     */ 
/*     */ public class PartyPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1331775163L;
/*  23 */   private static final Logger _logger = Logger.getLogger(PartyPropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getPartyId() != null) {
/* 159 */       buf.append("partyId").append("=").append(getPartyId()).append(" ");
/*     */     }
...
/* 193 */     PartyPropertyId id = new PartyPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setPartyId(getPartyId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((PartyPropertyId)argObjectId).getOrganizationId());
/* 202 */     setPartyId(((PartyPropertyId)argObjectId).getPartyId());
/* 203 */     setPropertyCode(((PartyPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"PartyProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._partyId != null) values.put("PartyId", DaoUtils.getXmlSafeFieldValue(-5, this._partyId)); 
...
/* 256 */             setPartyId((Long)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setPartyId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\impl\PartyPropertyDAO.class
