...
/*     */ 
/*     */ 
/*     */ public class CustomerItemAccountActivityPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 698586848L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerItemAccountActivityPropertyDAO.class);
/*     */   
...
/*  71 */     return this._custAccountDetailNum;
/*     */   }
/*     */   
/*     */   public void setCustAccountDetailNum(Long argCustAccountDetailNum) {
/*  75 */     if (changed(argCustAccountDetailNum, this._custAccountDetailNum, "custAccountDetailNum")) {
/*  76 */       this._custAccountDetailNum = argCustAccountDetailNum;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getSequenceNumber() {
/*  81 */     return this._sequenceNumber;
/*     */   }
/*     */   
/*     */   public void setSequenceNumber(Long argSequenceNumber) {
/*  85 */     if (changed(argSequenceNumber, this._sequenceNumber, "sequenceNumber")) {
/*  86 */       this._sequenceNumber = argSequenceNumber;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 191 */     if (getCustAccountId() != null) {
/* 192 */       buf.append("custAccountId").append("=").append(getCustAccountId()).append(" ");
/*     */     }
/* 194 */     if (getCustAccountCode() != null) {
/* 195 */       buf.append("custAccountCode").append("=").append(getCustAccountCode()).append(" ");
/*     */     }
/* 197 */     if (getCustAccountDetailNum() != null) {
/* 198 */       buf.append("custAccountDetailNum").append("=").append(getCustAccountDetailNum()).append(" ");
/*     */     }
/* 200 */     if (getSequenceNumber() != null) {
/* 201 */       buf.append("sequenceNumber").append("=").append(getSequenceNumber()).append(" ");
/*     */     }
...
/* 235 */     CustomerItemAccountActivityPropertyId id = new CustomerItemAccountActivityPropertyId();
/* 236 */     id.setOrganizationId(getOrganizationId());
/* 237 */     id.setCustAccountId(getCustAccountId());
/* 238 */     id.setCustAccountCode(getCustAccountCode());
/* 239 */     id.setCustAccountDetailNum(getCustAccountDetailNum());
...
/* 246 */     setOrganizationId(((CustomerItemAccountActivityPropertyId)argObjectId).getOrganizationId());
/* 247 */     setCustAccountId(((CustomerItemAccountActivityPropertyId)argObjectId).getCustAccountId());
/* 248 */     setCustAccountCode(((CustomerItemAccountActivityPropertyId)argObjectId).getCustAccountCode());
/* 249 */     setCustAccountDetailNum(((CustomerItemAccountActivityPropertyId)argObjectId).getCustAccountDetailNum());
/* 250 */     setSequenceNumber(((CustomerItemAccountActivityPropertyId)argObjectId).getSequenceNumber());
/* 251 */     setPropertyCode(((CustomerItemAccountActivityPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 260 */     buf.append("<").append("dao").append(" name=\"CustomerItemAccountActivityProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 270 */     if (this._custAccountId != null) values.put("CustAccountId", DaoUtils.getXmlSafeFieldValue(12, this._custAccountId)); 
/* 271 */     if (this._custAccountCode != null) values.put("CustAccountCode", DaoUtils.getXmlSafeFieldValue(12, this._custAccountCode)); 
/* 272 */     if (this._custAccountDetailNum != null) values.put("CustAccountDetailNum", DaoUtils.getXmlSafeFieldValue(-5, this._custAccountDetailNum)); 
/* 273 */     if (this._sequenceNumber != null) values.put("SequenceNumber", DaoUtils.getXmlSafeFieldValue(-5, this._sequenceNumber)); 
...
/* 307 */             setCustAccountId((String)value);
/* 308 */           } catch (Exception ee) {
/* 309 */             throw new DtxException("An exception occurred while calling setCustAccountId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 316 */             setCustAccountCode((String)value);
/* 317 */           } catch (Exception ee) {
/* 318 */             throw new DtxException("An exception occurred while calling setCustAccountCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 325 */             setCustAccountDetailNum((Long)value);
/* 326 */           } catch (Exception ee) {
/* 327 */             throw new DtxException("An exception occurred while calling setCustAccountDetailNum() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "SequenceNumber":
...
/* 334 */             setSequenceNumber((Long)value);
/* 335 */           } catch (Exception ee) {
/* 336 */             throw new DtxException("An exception occurred while calling setSequenceNumber() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerItemAccountActivityPropertyDAO.class
