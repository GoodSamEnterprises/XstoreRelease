...
/*     */ 
/*     */ 
/*     */ public class CustomerAccountJournalPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1985877469L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerAccountJournalPropertyDAO.class);
/*     */   
...
/* 221 */     CustomerAccountJournalPropertyId id = new CustomerAccountJournalPropertyId();
...
/* 231 */     setOrganizationId(((CustomerAccountJournalPropertyId)argObjectId).getOrganizationId());
/* 232 */     setCustAccountId(((CustomerAccountJournalPropertyId)argObjectId).getCustAccountId());
/* 233 */     setCustAccountCode(((CustomerAccountJournalPropertyId)argObjectId).getCustAccountCode());
/* 234 */     setJournalSequence(((CustomerAccountJournalPropertyId)argObjectId).getJournalSequence());
/* 235 */     setPropertyCode(((CustomerAccountJournalPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"CustomerAccountJournalProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\CustomerAccountJournalPropertyDAO.class
