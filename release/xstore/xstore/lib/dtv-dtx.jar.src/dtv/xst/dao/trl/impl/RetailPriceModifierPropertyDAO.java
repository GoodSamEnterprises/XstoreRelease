...
/*     */ 
/*     */ 
/*     */ public class RetailPriceModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 540334034L;
/*  23 */   private static final Logger _logger = Logger.getLogger(RetailPriceModifierPropertyDAO.class);
/*     */   
...
/*  74 */     return this._retailPriceModifierSequenceNbr;
/*     */   }
/*     */   
/*     */   public void setRetailPriceModifierSequenceNbr(Integer argRetailPriceModifierSequenceNbr) {
/*  78 */     if (changed(argRetailPriceModifierSequenceNbr, this._retailPriceModifierSequenceNbr, "retailPriceModifierSequenceNbr")) {
/*  79 */       this._retailPriceModifierSequenceNbr = argRetailPriceModifierSequenceNbr;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 220 */     if (getRetailPriceModifierSequenceNbr() != null) {
/* 221 */       buf.append("retailPriceModifierSequenceNbr").append("=").append(getRetailPriceModifierSequenceNbr()).append(" ");
/*     */     }
...
/* 264 */     RetailPriceModifierPropertyId id = new RetailPriceModifierPropertyId();
...
/* 268 */     id.setRetailPriceModifierSequenceNbr(getRetailPriceModifierSequenceNbr());
...
/* 277 */     setBusinessDate(((RetailPriceModifierPropertyId)argObjectId).getBusinessDate());
/* 278 */     setOrganizationId(((RetailPriceModifierPropertyId)argObjectId).getOrganizationId());
/* 279 */     setRetailLocationId(((RetailPriceModifierPropertyId)argObjectId).getRetailLocationId());
/* 280 */     setRetailPriceModifierSequenceNbr(((RetailPriceModifierPropertyId)argObjectId).getRetailPriceModifierSequenceNbr());
/* 281 */     setRetailTransactionLineItemSequence(((RetailPriceModifierPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 282 */     setTransactionSequence(((RetailPriceModifierPropertyId)argObjectId).getTransactionSequence());
/* 283 */     setWorkstationId(((RetailPriceModifierPropertyId)argObjectId).getWorkstationId());
/* 284 */     setPropertyCode(((RetailPriceModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"RetailPriceModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 305 */     if (this._retailPriceModifierSequenceNbr != null) values.put("RetailPriceModifierSequenceNbr", DaoUtils.getXmlSafeFieldValue(4, this._retailPriceModifierSequenceNbr)); 
...
/* 360 */             setRetailPriceModifierSequenceNbr((Integer)value);
/* 361 */           } catch (Exception ee) {
/* 362 */             throw new DtxException("An exception occurred while calling setRetailPriceModifierSequenceNbr() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\RetailPriceModifierPropertyDAO.class
