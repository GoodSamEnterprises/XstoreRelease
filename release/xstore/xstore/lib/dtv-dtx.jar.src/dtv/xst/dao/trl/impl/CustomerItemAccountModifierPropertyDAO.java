...
/*     */ 
/*     */ 
/*     */ public class CustomerItemAccountModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -73441624L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerItemAccountModifierPropertyDAO.class);
/*     */   
...
/*  73 */     return this._retailTransactionLineItemSequence;
/*     */   }
/*     */   
/*     */   public void setRetailTransactionLineItemSequence(Integer argRetailTransactionLineItemSequence) {
/*  77 */     if (changed(argRetailTransactionLineItemSequence, this._retailTransactionLineItemSequence, "retailTransactionLineItemSequence")) {
/*  78 */       this._retailTransactionLineItemSequence = argRetailTransactionLineItemSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 209 */     if (getRetailTransactionLineItemSequence() != null) {
/* 210 */       buf.append("retailTransactionLineItemSequence").append("=").append(getRetailTransactionLineItemSequence()).append(" ");
/*     */     }
...
/* 250 */     CustomerItemAccountModifierPropertyId id = new CustomerItemAccountModifierPropertyId();
...
/* 254 */     id.setRetailTransactionLineItemSequence(getRetailTransactionLineItemSequence());
...
/* 262 */     setBusinessDate(((CustomerItemAccountModifierPropertyId)argObjectId).getBusinessDate());
/* 263 */     setOrganizationId(((CustomerItemAccountModifierPropertyId)argObjectId).getOrganizationId());
/* 264 */     setRetailLocationId(((CustomerItemAccountModifierPropertyId)argObjectId).getRetailLocationId());
/* 265 */     setRetailTransactionLineItemSequence(((CustomerItemAccountModifierPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 266 */     setTransactionSequence(((CustomerItemAccountModifierPropertyId)argObjectId).getTransactionSequence());
/* 267 */     setWorkstationId(((CustomerItemAccountModifierPropertyId)argObjectId).getWorkstationId());
/* 268 */     setPropertyCode(((CustomerItemAccountModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 277 */     buf.append("<").append("dao").append(" name=\"CustomerItemAccountModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 343 */             setRetailTransactionLineItemSequence((Integer)value);
/* 344 */           } catch (Exception ee) {
/* 345 */             throw new DtxException("An exception occurred while calling setRetailTransactionLineItemSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\CustomerItemAccountModifierPropertyDAO.class
