...
/*     */ 
/*     */ 
/*     */ public class TenderLineItemDBA
...
/*     */   private Boolean _hostValidation;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.rtrans_lineitm_seq, t.create_date, t.create_user_id, t.update_date, t.update_user_id, t.amt, t.change_flag, t.host_validation_flag, t.serial_nbr, t.tndr_id, t.tndr_statcode, t.exchange_rate, t.foreign_amt FROM ttr_tndr_lineitm t";
...
/*  52 */     return "SELECT t.organization_id, t.rtl_loc_id, t.business_date, t.wkstn_id, t.trans_seq, t.rtrans_lineitm_seq, t.create_date, t.create_user_id, t.update_date, t.update_user_id, t.amt, t.change_flag, t.host_validation_flag, t.serial_nbr, t.tndr_id, t.tndr_statcode, t.exchange_rate, t.foreign_amt FROM ttr_tndr_lineitm t";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/*  62 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO ttr_tndr_lineitm(organization_id, rtl_loc_id, business_date, wkstn_id, trans_seq, rtrans_lineitm_seq, create_date, create_user_id, update_date, update_user_id, amt, change_flag, host_validation_flag, serial_nbr, tndr_id, tndr_statcode, exchange_rate, foreign_amt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */ 
/*     */   
...
/*  71 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._businessDate, this._workstationId, this._transactionSequence, this._retailTransactionLineItemSequence, this._createDate, this._createUserId, this._updateDate, this._updateUserId, this._amount, this._change, this._hostValidation, this._serialNumber, this._tenderId, this._tenderStatusCode, this._exchangeRate, this._foreignAmount } };
/*  72 */     return (Object[][])ArrayUtils.combine((Object[])super.getInsertParameters(), (Object[])insertParameterObject);
/*     */   }
/*     */   
/*  75 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, 91, -5, -5, 4, 91, 12, 91, 12, 3, -7, -7, 12, 12, 12, 3, 3 } };
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  82 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE ttr_tndr_lineitm SET update_date = ?, update_user_id = ?, amt = ?, change_flag = ?, host_validation_flag = ?, serial_nbr = ?, tndr_id = ?, tndr_statcode = ?, exchange_rate = ?, foreign_amt = ?" };
/*     */ 
/*     */   
...
/*  91 */     Object[][] updateParameterObject = { { this._updateDate, this._updateUserId, this._amount, this._change, this._hostValidation, this._serialNumber, this._tenderId, this._tenderStatusCode, this._exchangeRate, this._foreignAmount } };
/*  92 */     return (Object[][])ArrayUtils.combine((Object[])super.getUpdateParameters(), (Object[])updateParameterObject);
/*     */   }
/*     */   
/*  95 */   private static final int[][] UPDATE_PARAMETER_TYPE_OBJECT = new int[][] { { 91, 12, 3, -7, -7, 12, 12, 12, 3, 3 } };
/*     */   
/*     */   public int[][] getUpdateParameterTypes() {
/*  98 */     return (int[][])ArrayUtils.combine((Object[])super.getUpdateParameterTypes(), (Object[])UPDATE_PARAMETER_TYPE_OBJECT);
/*     */   }
/*     */   
/* 101 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM ttr_tndr_lineitm" };
...
/* 136 */     return new TenderLineItemFiller(this);
/*     */   }
/*     */   
/*     */   private static class TenderLineItemFiller
/*     */     implements IFiller {
/*     */     private TenderLineItemDBA _parent;
/*     */     
/*     */     public TenderLineItemFiller(TenderLineItemDBA argParent) {
...
/* 217 */       this._parent._change = Boolean.valueOf(argResultSet.getBoolean(12));
/* 218 */       this._parent._hostValidation = Boolean.valueOf(argResultSet.getBoolean(13));
/* 219 */       this._parent._serialNumber = argResultSet.getString(14);
/* 220 */       this._parent._tenderId = argResultSet.getString(15);
/* 221 */       this._parent._tenderStatusCode = argResultSet.getString(16);
/* 222 */       this._parent._exchangeRate = argResultSet.getBigDecimal(17);
/* 223 */       this._parent._foreignAmount = argResultSet.getBigDecimal(18);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 231 */     TenderLineItemDAO dao = (TenderLineItemDAO)argDAO;
...
/* 243 */     dao.setChange(this._change);
/* 244 */     dao.setHostValidation(this._hostValidation);
/* 245 */     dao.setSerialNumber(this._serialNumber);
/* 246 */     dao.setTenderId(this._tenderId);
/* 247 */     dao.setTenderStatusCode(this._tenderStatusCode);
/* 248 */     dao.setExchangeRate(this._exchangeRate);
/* 249 */     dao.setForeignAmount(this._foreignAmount);
...
/* 256 */     return loadDAO((IDataAccessObject)new TenderLineItemDAO());
/*     */   }
/*     */ 
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 261 */     TenderLineItemDAO dao = (TenderLineItemDAO)argDAO;
...
/* 274 */     this._change = (dao.getChange() != null) ? dao.getChange() : Boolean.valueOf(false);
/* 275 */     this._hostValidation = (dao.getHostValidation() != null) ? dao.getHostValidation() : Boolean.valueOf(false);
/* 276 */     this._serialNumber = dao.getSerialNumber();
/* 277 */     this._tenderId = dao.getTenderId();
/* 278 */     this._tenderStatusCode = dao.getTenderStatusCode();
/* 279 */     this._exchangeRate = dao.getExchangeRate();
/* 280 */     this._foreignAmount = dao.getForeignAmount();
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\TenderLineItemDBA.class
