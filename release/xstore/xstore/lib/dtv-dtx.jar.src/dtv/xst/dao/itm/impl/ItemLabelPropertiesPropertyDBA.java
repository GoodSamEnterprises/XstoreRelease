...
/*     */ 
/*     */ 
/*     */ public class ItemLabelPropertiesPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -1208200823L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.item_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_label_properties_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.item_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM itm_item_label_properties_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO itm_item_label_properties_p(organization_id, item_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._itemId, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE itm_item_label_properties_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM itm_item_label_properties_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND item_id = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._itemId, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "itm_item_label_properties_p";
/*     */   }
/*     */   
...
/* 115 */     return new ItemLabelPropertiesPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ItemLabelPropertiesPropertyFiller
/*     */     implements IFiller {
/*     */     private ItemLabelPropertiesPropertyDBA _parent;
/*     */     
/*     */     public ItemLabelPropertiesPropertyFiller(ItemLabelPropertiesPropertyDBA argParent) {
...
/* 173 */     ItemLabelPropertiesPropertyDAO dao = (ItemLabelPropertiesPropertyDAO)argDAO;
...
/* 190 */     return loadDAO((IDataAccessObject)new ItemLabelPropertiesPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     ItemLabelPropertiesPropertyDAO dao = (ItemLabelPropertiesPropertyDAO)argDAO;
...
/* 209 */     ItemLabelPropertiesPropertyId id = (ItemLabelPropertiesPropertyId)argId;
...
/* 217 */     ItemLabelPropertiesPropertyId id = new ItemLabelPropertiesPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemLabelPropertiesPropertyDBA.class
