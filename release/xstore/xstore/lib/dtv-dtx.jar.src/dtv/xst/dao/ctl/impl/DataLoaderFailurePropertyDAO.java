...
/*     */ 
/*     */ 
/*     */ public class DataLoaderFailurePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1337698494L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DataLoaderFailurePropertyDAO.class);
/*     */   
...
/*  54 */     if (changed(argFileName, this._fileName, "fileName")) {
/*  55 */       this._fileName = (argFileName != null && MANAGE_CASE) ? argFileName.toUpperCase() : argFileName;
/*     */     }
/*     */   }
/*     */   
/*     */   public Long getRunTime() {
/*  60 */     return this._runTime;
/*     */   }
/*     */   
/*     */   public void setRunTime(Long argRunTime) {
/*  64 */     if (changed(argRunTime, this._runTime, "runTime")) {
/*  65 */       this._runTime = argRunTime;
/*     */     }
/*     */   }
/*     */   
/*     */   public Integer getFailureSequence() {
/*  70 */     return this._failureSequence;
/*     */   }
/*     */   
/*     */   public void setFailureSequence(Integer argFailureSequence) {
/*  74 */     if (changed(argFailureSequence, this._failureSequence, "failureSequence")) {
/*  75 */       this._failureSequence = argFailureSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getFileName() != null) {
/* 181 */       buf.append("fileName").append("=").append(getFileName()).append(" ");
/*     */     }
/* 183 */     if (getRunTime() != null) {
/* 184 */       buf.append("runTime").append("=").append(getRunTime()).append(" ");
/*     */     }
/* 186 */     if (getFailureSequence() != null) {
/* 187 */       buf.append("failureSequence").append("=").append(getFailureSequence()).append(" ");
/*     */     }
...
/* 221 */     DataLoaderFailurePropertyId id = new DataLoaderFailurePropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setFileName(getFileName());
/* 224 */     id.setRunTime(getRunTime());
/* 225 */     id.setFailureSequence(getFailureSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((DataLoaderFailurePropertyId)argObjectId).getOrganizationId());
/* 232 */     setFileName(((DataLoaderFailurePropertyId)argObjectId).getFileName());
/* 233 */     setRunTime(((DataLoaderFailurePropertyId)argObjectId).getRunTime());
/* 234 */     setFailureSequence(((DataLoaderFailurePropertyId)argObjectId).getFailureSequence());
/* 235 */     setPropertyCode(((DataLoaderFailurePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"DataLoaderFailureProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._fileName != null) values.put("FileName", DaoUtils.getXmlSafeFieldValue(12, this._fileName)); 
/* 255 */     if (this._runTime != null) values.put("RunTime", DaoUtils.getXmlSafeFieldValue(-5, this._runTime)); 
/* 256 */     if (this._failureSequence != null) values.put("FailureSequence", DaoUtils.getXmlSafeFieldValue(4, this._failureSequence)); 
...
/* 290 */             setFileName((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setFileName() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "RunTime":
...
/* 299 */             setRunTime((Long)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setRunTime() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setFailureSequence((Integer)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setFailureSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\impl\DataLoaderFailurePropertyDAO.class
