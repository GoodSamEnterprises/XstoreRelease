...
/*     */ 
/*     */ 
/*     */ public class LineItemAssociationModifierPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ILineItemAssociationModifierProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new LineItemAssociationModifierPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private LineItemAssociationModifierPropertyDAO getDAO_() {
/*  44 */     return (LineItemAssociationModifierPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(ILineItemAssociationModifierProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  86 */     if (getDAO_().getLineItemAssociationModifierSequence() != null) {
/*  87 */       return getDAO_().getLineItemAssociationModifierSequence().intValue();
/*     */     }
/*     */     
/*  90 */     return 0;
/*     */   }
...
/*  99 */     if (setLineItemAssociationModifierSequence_noev(argLineItemAssociationModifierSequence) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(ILineItemAssociationModifierProperty.SET_LINEITEMASSOCIATIONMODIFIERSEQUENCE, Integer.valueOf(argLineItemAssociationModifierSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getLineItemAssociationModifierSequence() == null && Integer.valueOf(argLineItemAssociationModifierSequence) != null) || (
/* 112 */       getDAO_().getLineItemAssociationModifierSequence() != null && !getDAO_().getLineItemAssociationModifierSequence().equals(Integer.valueOf(argLineItemAssociationModifierSequence)))) {
/* 113 */       getDAO_().setLineItemAssociationModifierSequence(Integer.valueOf(argLineItemAssociationModifierSequence));
...
/* 125 */     if (getDAO_().getOrganizationId() != null) {
/* 126 */       return getDAO_().getOrganizationId().longValue();
/*     */     }
/*     */     
/* 129 */     return 0L;
/*     */   }
...
/* 138 */     if (setOrganizationId_noev(argOrganizationId) && 
/* 139 */       this._events != null && 
/* 140 */       postEventsForChanges()) {
/* 141 */       this._events.post(ILineItemAssociationModifierProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 150 */     if ((getDAO_().getOrganizationId() == null && Long.valueOf(argOrganizationId) != null) || (
/* 151 */       getDAO_().getOrganizationId() != null && !getDAO_().getOrganizationId().equals(Long.valueOf(argOrganizationId)))) {
/* 152 */       getDAO_().setOrganizationId(Long.valueOf(argOrganizationId));
...
/* 164 */     if (getDAO_().getRetailLocationId() != null) {
/* 165 */       return getDAO_().getRetailLocationId().longValue();
/*     */     }
/*     */     
/* 168 */     return 0L;
/*     */   }
...
/* 177 */     if (setRetailLocationId_noev(argRetailLocationId) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(ILineItemAssociationModifierProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getRetailLocationId() == null && Long.valueOf(argRetailLocationId) != null) || (
/* 190 */       getDAO_().getRetailLocationId() != null && !getDAO_().getRetailLocationId().equals(Long.valueOf(argRetailLocationId)))) {
/* 191 */       getDAO_().setRetailLocationId(Long.valueOf(argRetailLocationId));
...
/* 203 */     if (getDAO_().getRetailTransactionLineItemSequence() != null) {
/* 204 */       return getDAO_().getRetailTransactionLineItemSequence().intValue();
/*     */     }
/*     */     
/* 207 */     return 0;
/*     */   }
...
/* 216 */     if (setRetailTransactionLineItemSequence_noev(argRetailTransactionLineItemSequence) && 
/* 217 */       this._events != null && 
/* 218 */       postEventsForChanges()) {
/* 219 */       this._events.post(ILineItemAssociationModifierProperty.SET_RETAILTRANSACTIONLINEITEMSEQUENCE, Integer.valueOf(argRetailTransactionLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 228 */     if ((getDAO_().getRetailTransactionLineItemSequence() == null && Integer.valueOf(argRetailTransactionLineItemSequence) != null) || (
/* 229 */       getDAO_().getRetailTransactionLineItemSequence() != null && !getDAO_().getRetailTransactionLineItemSequence().equals(Integer.valueOf(argRetailTransactionLineItemSequence)))) {
/* 230 */       getDAO_().setRetailTransactionLineItemSequence(Integer.valueOf(argRetailTransactionLineItemSequence));
...
/* 258 */       this._events.post(ILineItemAssociationModifierProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 297 */       this._events.post(ILineItemAssociationModifierProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 331 */       this._events.post(ILineItemAssociationModifierProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(ILineItemAssociationModifierProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(ILineItemAssociationModifierProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(ILineItemAssociationModifierProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(ILineItemAssociationModifierProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(ILineItemAssociationModifierProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(ILineItemAssociationModifierProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(ILineItemAssociationModifierProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(ILineItemAssociationModifierProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("LineItemAssociationModifierPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("LineItemAssociationModifierPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\LineItemAssociationModifierPropertyModel.class
