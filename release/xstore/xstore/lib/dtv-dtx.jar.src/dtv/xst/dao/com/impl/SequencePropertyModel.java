...
/*     */ 
/*     */ 
/*     */ public class SequencePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ISequenceProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new SequencePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private SequencePropertyDAO getDAO_() {
/*  44 */     return (SequencePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  68 */       this._events.post(ISequenceProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 107 */       this._events.post(ISequenceProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 146 */       this._events.post(ISequenceProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 169 */     return getDAO_().getSequenceId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 177 */     if (setSequenceId_noev(argSequenceId) && 
/* 178 */       this._events != null && 
/* 179 */       postEventsForChanges()) {
/* 180 */       this._events.post(ISequenceProperty.SET_SEQUENCEID, argSequenceId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 189 */     if ((getDAO_().getSequenceId() == null && argSequenceId != null) || (
/* 190 */       getDAO_().getSequenceId() != null && !getDAO_().getSequenceId().equals(argSequenceId))) {
/* 191 */       getDAO_().setSequenceId(argSequenceId);
...
/* 203 */     return getDAO_().getSequenceMode();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 211 */     if (setSequenceMode_noev(argSequenceMode) && 
/* 212 */       this._events != null && 
/* 213 */       postEventsForChanges()) {
/* 214 */       this._events.post(ISequenceProperty.SET_SEQUENCEMODE, argSequenceMode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 223 */     if ((getDAO_().getSequenceMode() == null && argSequenceMode != null) || (
/* 224 */       getDAO_().getSequenceMode() != null && !getDAO_().getSequenceMode().equals(argSequenceMode))) {
/* 225 */       getDAO_().setSequenceMode(argSequenceMode);
...
/* 248 */       this._events.post(ISequenceProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 282 */       this._events.post(ISequenceProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 316 */       this._events.post(ISequenceProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 350 */       this._events.post(ISequenceProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 384 */       this._events.post(ISequenceProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 418 */       this._events.post(ISequenceProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 452 */       this._events.post(ISequenceProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 486 */       this._events.post(ISequenceProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 520 */       this._events.post(ISequenceProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 541 */     if ("SequencePropertyExtension".equals(argFieldId)) {
...
/* 551 */     if ("SequencePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\SequencePropertyModel.class
