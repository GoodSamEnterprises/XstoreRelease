...
/*     */ 
/*     */ 
/*     */ public class EmployeeAnswersPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -374510404L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeAnswersPropertyDAO.class);
/*     */   
...
/*  59 */     return this._challengeCode;
/*     */   }
/*     */   
/*     */   public void setChallengeCode(String argChallengeCode) {
/*  63 */     if (changed(argChallengeCode, this._challengeCode, "challengeCode")) {
/*  64 */       this._challengeCode = (argChallengeCode != null && MANAGE_CASE) ? argChallengeCode.toUpperCase() : argChallengeCode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getEmployeeId() != null) {
/* 170 */       buf.append("employeeId").append("=").append(getEmployeeId()).append(" ");
/*     */     }
/* 172 */     if (getChallengeCode() != null) {
/* 173 */       buf.append("challengeCode").append("=").append(getChallengeCode()).append(" ");
/*     */     }
...
/* 207 */     EmployeeAnswersPropertyId id = new EmployeeAnswersPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setEmployeeId(getEmployeeId());
/* 210 */     id.setChallengeCode(getChallengeCode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((EmployeeAnswersPropertyId)argObjectId).getOrganizationId());
/* 217 */     setEmployeeId(((EmployeeAnswersPropertyId)argObjectId).getEmployeeId());
/* 218 */     setChallengeCode(((EmployeeAnswersPropertyId)argObjectId).getChallengeCode());
/* 219 */     setPropertyCode(((EmployeeAnswersPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"EmployeeAnswersProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._employeeId != null) values.put("EmployeeId", DaoUtils.getXmlSafeFieldValue(12, this._employeeId)); 
/* 239 */     if (this._challengeCode != null) values.put("ChallengeCode", DaoUtils.getXmlSafeFieldValue(12, this._challengeCode)); 
...
/* 273 */             setEmployeeId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setEmployeeId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "ChallengeCode":
...
/* 282 */             setChallengeCode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setChallengeCode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeAnswersPropertyDAO.class
