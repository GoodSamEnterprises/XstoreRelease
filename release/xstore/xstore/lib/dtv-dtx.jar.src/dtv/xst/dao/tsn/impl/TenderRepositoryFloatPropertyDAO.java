...
/*     */ 
/*     */ 
/*     */ public class TenderRepositoryFloatPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -999019629L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TenderRepositoryFloatPropertyDAO.class);
/*     */   
...
/*  60 */     return this._tenderRepositoryId;
/*     */   }
/*     */   
/*     */   public void setTenderRepositoryId(String argTenderRepositoryId) {
/*  64 */     if (changed(argTenderRepositoryId, this._tenderRepositoryId, "tenderRepositoryId")) {
/*  65 */       this._tenderRepositoryId = (argTenderRepositoryId != null && MANAGE_CASE) ? argTenderRepositoryId.toUpperCase() : argTenderRepositoryId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getCurrencyId() {
/*  70 */     return this._currencyId;
/*     */   }
/*     */   
/*     */   public void setCurrencyId(String argCurrencyId) {
/*  74 */     if (changed(argCurrencyId, this._currencyId, "currencyId")) {
/*  75 */       this._currencyId = (argCurrencyId != null && MANAGE_CASE) ? argCurrencyId.toUpperCase() : argCurrencyId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 183 */     if (getTenderRepositoryId() != null) {
/* 184 */       buf.append("tenderRepositoryId").append("=").append(getTenderRepositoryId()).append(" ");
/*     */     }
/* 186 */     if (getCurrencyId() != null) {
/* 187 */       buf.append("currencyId").append("=").append(getCurrencyId()).append(" ");
/*     */     }
...
/* 221 */     TenderRepositoryFloatPropertyId id = new TenderRepositoryFloatPropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setRetailLocationId(getRetailLocationId());
/* 224 */     id.setTenderRepositoryId(getTenderRepositoryId());
/* 225 */     id.setCurrencyId(getCurrencyId());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((TenderRepositoryFloatPropertyId)argObjectId).getOrganizationId());
/* 232 */     setRetailLocationId(((TenderRepositoryFloatPropertyId)argObjectId).getRetailLocationId());
/* 233 */     setTenderRepositoryId(((TenderRepositoryFloatPropertyId)argObjectId).getTenderRepositoryId());
/* 234 */     setCurrencyId(((TenderRepositoryFloatPropertyId)argObjectId).getCurrencyId());
/* 235 */     setPropertyCode(((TenderRepositoryFloatPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"TenderRepositoryFloatProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 255 */     if (this._tenderRepositoryId != null) values.put("TenderRepositoryId", DaoUtils.getXmlSafeFieldValue(12, this._tenderRepositoryId)); 
/* 256 */     if (this._currencyId != null) values.put("CurrencyId", DaoUtils.getXmlSafeFieldValue(12, this._currencyId)); 
...
/* 299 */             setTenderRepositoryId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setTenderRepositoryId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "CurrencyId":
...
/* 308 */             setCurrencyId((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setCurrencyId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tsn\impl\TenderRepositoryFloatPropertyDAO.class
