...
/*     */ 
/*     */ 
/*     */ public class AddressStatePropertyId
...
/*     */   
/*     */   public AddressStatePropertyId() {}
/*     */   
/*     */   public AddressStatePropertyId(String argObjectIdValue) {
...
/*  40 */     return this._stateId;
/*     */   }
/*     */   
/*     */   public void setStateId(String argStateId) {
/*  44 */     this._stateId = (argStateId != null && MANAGE_CASE) ? argStateId.toUpperCase() : argStateId;
/*     */   }
/*     */   
...
/* 114 */       return true;
/*     */     }
/* 116 */     if (!(ob instanceof AddressStatePropertyId)) {
/* 117 */       return false;
/*     */     }
/* 119 */     AddressStatePropertyId other = (AddressStatePropertyId)ob;
...
/*     */ 
/*     */       
/* 126 */       .equals(other._countryId))) && ((this._stateId == null && other._stateId == null) || (this._stateId != null && this._stateId
/*     */ 
/*     */       
/* 129 */       .equals(other._stateId))) && ((this._addressMode == null && other._addressMode == null) || (this._addressMode != null && this._addressMode
/*     */ 
/*     */       
...
/* 143 */       .hashCode()) + ((this._stateId == null) ? 0 : this._stateId
...
/* 151 */     return "AddressStateProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 161 */       .append("::").append(this._stateId)
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\AddressStatePropertyId.class
