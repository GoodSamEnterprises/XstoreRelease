...
/*    */ 
/*    */ public interface IVersionProperty extends IDataModel, IDataProperty {
/*  9 */   public static final EventEnum SET_ORGANIZATIONID = new EventEnum("set organizationId");
/* 10 */   public static final EventEnum SET_PROPERTYCODE = new EventEnum("set propertyCode");
/* 11 */   public static final EventEnum SET_TYPE = new EventEnum("set type");
/* 12 */   public static final EventEnum SET_STRINGVALUE = new EventEnum("set stringValue");
/* 13 */   public static final EventEnum SET_DATEVALUE = new EventEnum("set dateValue");
/* 14 */   public static final EventEnum SET_DECIMALVALUE = new EventEnum("set decimalValue");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ctl\IVersionProperty.class
