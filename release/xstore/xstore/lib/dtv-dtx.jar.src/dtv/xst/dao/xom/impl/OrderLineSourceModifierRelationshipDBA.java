...
/*    */ 
/*    */ 
/*    */ public class OrderLineSourceModifierRelationshipDBA
/*    */   implements IJDBCRelationshipAdapter
/*    */ {
/* 19 */   private List<Object> _parameterList = new ArrayList(3);
/*    */   
/* 21 */   SourceModifierId _childObjectId = null;
/*    */   
/*    */   public String getSelect() {
/* 24 */     return "SELECT organization_id, order_id, detail_seq, create_date, create_user_id, update_date, update_user_id, loc_id, loc_type, loc_name1, loc_name2, telephone, email_address, address_seq FROM xom_source_mod WHERE organization_id = ? AND order_id = ? AND detail_seq = ?";
/*    */   }
/*    */ 
/*    */   
/*    */   public void setParent(IDataAccessObject argDAO) {
/* 29 */     OrderLineDAO dao = (OrderLineDAO)argDAO;
/* 30 */     this._childObjectId = new SourceModifierId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderLineSourceModifierRelationshipDBA.class
