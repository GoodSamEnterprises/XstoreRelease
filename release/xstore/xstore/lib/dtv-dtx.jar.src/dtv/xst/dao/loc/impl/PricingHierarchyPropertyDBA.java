...
/*     */ 
/*     */ 
/*     */ public class PricingHierarchyPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.level_code, t.level_value, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_pricing_hierarchy_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND level_code = ?  AND level_value = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.level_code, t.level_value, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM loc_pricing_hierarchy_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND level_code = ?  AND level_value = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO loc_pricing_hierarchy_p(organization_id, level_code, level_value, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._levelCode, this._levelValue, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE loc_pricing_hierarchy_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM loc_pricing_hierarchy_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND level_code = ?  AND level_value = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND level_code = ?  AND level_value = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._levelCode, this._levelValue, this._propertyCode };
/*     */   }
/*     */   
...
/* 108 */     return "loc_pricing_hierarchy_p";
/*     */   }
/*     */   
...
/* 116 */     return new PricingHierarchyPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class PricingHierarchyPropertyFiller
/*     */     implements IFiller {
/*     */     private PricingHierarchyPropertyDBA _parent;
/*     */     
/*     */     public PricingHierarchyPropertyFiller(PricingHierarchyPropertyDBA argParent) {
...
/* 175 */     PricingHierarchyPropertyDAO dao = (PricingHierarchyPropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setLevelCode(this._levelCode);
/* 178 */     dao.setLevelValue(this._levelValue);
...
/* 193 */     return loadDAO((IDataAccessObject)new PricingHierarchyPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     PricingHierarchyPropertyDAO dao = (PricingHierarchyPropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._levelCode = dao.getLevelCode();
/* 200 */     this._levelValue = dao.getLevelValue();
...
/* 213 */     PricingHierarchyPropertyId id = (PricingHierarchyPropertyId)argId;
/* 214 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 215 */     argStatement.setString(2, id.getLevelCode());
/* 216 */     argStatement.setString(3, id.getLevelValue());
/* 217 */     argStatement.setString(4, id.getPropertyCode());
/* 218 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 222 */     PricingHierarchyPropertyId id = new PricingHierarchyPropertyId();
/* 223 */     id.setOrganizationId(this._organizationId);
/* 224 */     id.setLevelCode(this._levelCode);
/* 225 */     id.setLevelValue(this._levelValue);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\PricingHierarchyPropertyDBA.class
