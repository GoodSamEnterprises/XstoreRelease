...
/*    */ 
/*    */ public interface ITimecardEntry extends IDataModel, ITimecardEntryModel, IHasDataProperty<ITimecardEntryProperty> {
...
/* 19 */   public static final EventEnum SET_CLOCKINDATETIME = new EventEnum("set clockInDateTime");
/* 20 */   public static final EventEnum SET_CLOCKOUTDATETIME = new EventEnum("set clockOutDateTime");
/* 21 */   public static final EventEnum SET_ENTRYTYPE = new EventEnum("set entryType");
/* 22 */   public static final EventEnum SET_DELETE = new EventEnum("set delete");
/* 23 */   public static final EventEnum SET_OPENRECORD = new EventEnum("set openRecord");
/* 24 */   public static final EventEnum SET_DURATION = new EventEnum("set duration");
/* 25 */   public static final EventEnum SET_PAYROLLUPDATEREQUIRED = new EventEnum("set payrollUpdateRequired");
/* 26 */   public static final EventEnum SET_WORKCODESTRING = new EventEnum("set workCodeString");
/* 27 */   public static final EventEnum SET_WORKCODE = new EventEnum("set WorkCode");
...
/*    */   
/*    */   boolean getOpenRecord();
/*    */   
/*    */   void setOpenRecord(boolean paramBoolean);
/*    */   
/*    */   long getDuration();
/*    */   
/*    */   void setDuration(long paramLong);
/*    */   
/*    */   boolean getPayrollUpdateRequired();
/*    */   
/*    */   void setPayrollUpdateRequired(boolean paramBoolean);
/*    */   
/*    */   IDataModel getTimecardEntryExt();
/*    */   
/*    */   void setTimecardEntryExt(IDataModel paramIDataModel);
/*    */   
/*    */   IWorkCodes getWorkCode();
/*    */   
/*    */   void setWorkCode(IWorkCodes paramIWorkCodes);
/*    */   
/*    */   List<ITimecardEntryProperty> getProperties();
/*    */   
/*    */   void setProperties(List<ITimecardEntryProperty> paramList);
/*    */   
/*    */   void addTimecardEntryProperty(ITimecardEntryProperty paramITimecardEntryProperty);
/*    */   
/*    */   void removeTimecardEntryProperty(ITimecardEntryProperty paramITimecardEntryProperty);
/*    */   
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\thr\ITimecardEntry.class
