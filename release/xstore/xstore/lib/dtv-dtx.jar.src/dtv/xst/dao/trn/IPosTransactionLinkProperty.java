...
/*    */ 
/*    */ public interface IPosTransactionLinkProperty extends IDataModel, IDataProperty {
...
/* 18 */   public static final EventEnum SET_PROPERTYCODE = new EventEnum("set propertyCode");
/* 19 */   public static final EventEnum SET_TYPE = new EventEnum("set type");
/* 20 */   public static final EventEnum SET_STRINGVALUE = new EventEnum("set stringValue");
/* 21 */   public static final EventEnum SET_DATEVALUE = new EventEnum("set dateValue");
/* 22 */   public static final EventEnum SET_DECIMALVALUE = new EventEnum("set decimalValue");
/* 23 */   public static final EventEnum SET_CREATEDATE = new EventEnum("set createDate");
/* 24 */   public static final EventEnum SET_CREATEUSERID = new EventEnum("set createUserId");
/* 25 */   public static final EventEnum SET_UPDATEDATE = new EventEnum("set updateDate");
/* 26 */   public static final EventEnum SET_UPDATEUSERID = new EventEnum("set updateUserId");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\IPosTransactionLinkProperty.class
