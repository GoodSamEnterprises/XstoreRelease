...
/*     */ 
/*     */ 
/*     */ public class AddressPostalCodePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1004752449L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AddressPostalCodePropertyDAO.class);
/*     */   
...
/*  50 */     return this._countryId;
/*     */   }
/*     */   
/*     */   public void setCountryId(String argCountryId) {
/*  54 */     if (changed(argCountryId, this._countryId, "countryId")) {
/*  55 */       this._countryId = (argCountryId != null && MANAGE_CASE) ? argCountryId.toUpperCase() : argCountryId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getPostalCodeId() {
/*  60 */     return this._postalCodeId;
/*     */   }
/*     */   
/*     */   public void setPostalCodeId(String argPostalCodeId) {
/*  64 */     if (changed(argPostalCodeId, this._postalCodeId, "postalCodeId")) {
/*  65 */       this._postalCodeId = (argPostalCodeId != null && MANAGE_CASE) ? argPostalCodeId.toUpperCase() : argPostalCodeId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getAddressMode() {
/*  70 */     return this._addressMode;
/*     */   }
/*     */   
/*     */   public void setAddressMode(String argAddressMode) {
/*  74 */     if (changed(argAddressMode, this._addressMode, "addressMode")) {
/*  75 */       this._addressMode = (argAddressMode != null && MANAGE_CASE) ? argAddressMode.toUpperCase() : argAddressMode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getCountryId() != null) {
/* 181 */       buf.append("countryId").append("=").append(getCountryId()).append(" ");
/*     */     }
/* 183 */     if (getPostalCodeId() != null) {
/* 184 */       buf.append("postalCodeId").append("=").append(getPostalCodeId()).append(" ");
/*     */     }
/* 186 */     if (getAddressMode() != null) {
/* 187 */       buf.append("addressMode").append("=").append(getAddressMode()).append(" ");
/*     */     }
...
/* 221 */     AddressPostalCodePropertyId id = new AddressPostalCodePropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setCountryId(getCountryId());
/* 224 */     id.setPostalCodeId(getPostalCodeId());
/* 225 */     id.setAddressMode(getAddressMode());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((AddressPostalCodePropertyId)argObjectId).getOrganizationId());
/* 232 */     setCountryId(((AddressPostalCodePropertyId)argObjectId).getCountryId());
/* 233 */     setPostalCodeId(((AddressPostalCodePropertyId)argObjectId).getPostalCodeId());
/* 234 */     setAddressMode(((AddressPostalCodePropertyId)argObjectId).getAddressMode());
/* 235 */     setPropertyCode(((AddressPostalCodePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"AddressPostalCodeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._countryId != null) values.put("CountryId", DaoUtils.getXmlSafeFieldValue(12, this._countryId)); 
/* 255 */     if (this._postalCodeId != null) values.put("PostalCodeId", DaoUtils.getXmlSafeFieldValue(12, this._postalCodeId)); 
/* 256 */     if (this._addressMode != null) values.put("AddressMode", DaoUtils.getXmlSafeFieldValue(12, this._addressMode)); 
...
/* 290 */             setCountryId((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setCountryId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PostalCodeId":
...
/* 299 */             setPostalCodeId((String)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setPostalCodeId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "AddressMode":
...
/* 308 */             setAddressMode((String)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setAddressMode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AddressPostalCodePropertyDAO.class
