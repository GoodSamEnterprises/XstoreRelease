...
/*     */ 
/*     */ 
/*     */ public class ItemCrossReferencePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 446175475L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemCrossReferencePropertyDAO.class);
/*     */   
...
/* 155 */     if (getManufacturerUpc() != null) {
/* 156 */       buf.append("manufacturerUpc").append("=").append(getManufacturerUpc()).append(" ");
/*     */     }
...
/* 193 */     ItemCrossReferencePropertyId id = new ItemCrossReferencePropertyId();
/* 194 */     id.setManufacturerUpc(getManufacturerUpc());
...
/* 201 */     setManufacturerUpc(((ItemCrossReferencePropertyId)argObjectId).getManufacturerUpc());
/* 202 */     setOrganizationId(((ItemCrossReferencePropertyId)argObjectId).getOrganizationId());
/* 203 */     setPropertyCode(((ItemCrossReferencePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"ItemCrossReferenceProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 221 */     if (this._manufacturerUpc != null) values.put("ManufacturerUpc", DaoUtils.getXmlSafeFieldValue(12, this._manufacturerUpc)); 
...
/* 247 */             setManufacturerUpc((String)value);
/* 248 */           } catch (Exception ee) {
/* 249 */             throw new DtxException("An exception occurred while calling setManufacturerUpc() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemCrossReferencePropertyDAO.class
