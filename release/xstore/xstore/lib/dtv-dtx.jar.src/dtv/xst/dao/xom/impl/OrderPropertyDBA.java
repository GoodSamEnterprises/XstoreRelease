...
/*     */ 
/*     */ 
/*     */ public class OrderPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1627114275L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.order_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xom_order_p t";
...
/*  44 */     return "SELECT t.organization_id, t.order_id, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM xom_order_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO xom_order_p(organization_id, order_id, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE xom_order_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM xom_order_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND order_id = ?  AND property_code = ?  ";
/*     */   
...
/* 115 */     return new OrderPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class OrderPropertyFiller
/*     */     implements IFiller {
/*     */     private OrderPropertyDBA _parent;
/*     */     
/*     */     public OrderPropertyFiller(OrderPropertyDBA argParent) {
...
/* 173 */     OrderPropertyDAO dao = (OrderPropertyDAO)argDAO;
...
/* 190 */     return loadDAO((IDataAccessObject)new OrderPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 194 */     OrderPropertyDAO dao = (OrderPropertyDAO)argDAO;
...
/* 209 */     OrderPropertyId id = (OrderPropertyId)argId;
...
/* 217 */     OrderPropertyId id = new OrderPropertyId();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\OrderPropertyDBA.class
