...
/*     */ 
/*     */ 
/*     */ public class TaxGroupPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1589382057L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxGroupPropertyDAO.class);
/*     */   
...
/*  48 */     return this._taxGroupId;
/*     */   }
/*     */   
/*     */   public void setTaxGroupId(String argTaxGroupId) {
/*  52 */     if (changed(argTaxGroupId, this._taxGroupId, "taxGroupId")) {
/*  53 */       this._taxGroupId = (argTaxGroupId != null && MANAGE_CASE) ? argTaxGroupId.toUpperCase() : argTaxGroupId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getTaxGroupId() != null) {
/* 159 */       buf.append("taxGroupId").append("=").append(getTaxGroupId()).append(" ");
/*     */     }
...
/* 193 */     TaxGroupPropertyId id = new TaxGroupPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setTaxGroupId(getTaxGroupId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((TaxGroupPropertyId)argObjectId).getOrganizationId());
/* 202 */     setTaxGroupId(((TaxGroupPropertyId)argObjectId).getTaxGroupId());
/* 203 */     setPropertyCode(((TaxGroupPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"TaxGroupProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._taxGroupId != null) values.put("TaxGroupId", DaoUtils.getXmlSafeFieldValue(12, this._taxGroupId)); 
...
/* 256 */             setTaxGroupId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setTaxGroupId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxGroupPropertyDAO.class
