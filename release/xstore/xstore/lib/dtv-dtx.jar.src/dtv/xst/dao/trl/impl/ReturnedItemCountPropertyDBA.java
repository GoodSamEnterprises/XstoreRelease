...
/*     */ 
/*     */ 
/*     */ public class ReturnedItemCountPropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.rtrans_lineitm_seq, t.trans_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trl_returned_item_count_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  48 */     return "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.rtrans_lineitm_seq, t.trans_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trl_returned_item_count_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  54 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  57 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trl_returned_item_count_p(organization_id, rtl_loc_id, wkstn_id, business_date, rtrans_lineitm_seq, trans_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  64 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._retailTransactionLineItemSequence, this._transactionSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  65 */     return insertParameterObject;
/*     */   }
/*     */   
/*  68 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, -5, 91, 4, -5, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  71 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  74 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trl_returned_item_count_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  90 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trl_returned_item_count_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  99 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 102 */     return new Object[] { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._retailTransactionLineItemSequence, this._transactionSequence, this._propertyCode };
/*     */   }
/*     */   
/* 105 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { -5, -5, -5, 91, 4, -5, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 108 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 111 */     return "trl_returned_item_count_p";
/*     */   }
/*     */   
...
/* 119 */     return new ReturnedItemCountPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ReturnedItemCountPropertyFiller
/*     */     implements IFiller {
/*     */     private ReturnedItemCountPropertyDBA _parent;
/*     */     
/*     */     public ReturnedItemCountPropertyFiller(ReturnedItemCountPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 165 */       int i = argResultSet.getInt(5);
/* 166 */       if (i != 0 || argResultSet.getObject(5) != null) {
/* 167 */         this._parent._retailTransactionLineItemSequence = Integer.valueOf(i);
/*     */       }
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 173 */       long l1 = argResultSet.getLong(6);
...
/* 217 */     ReturnedItemCountPropertyDAO dao = (ReturnedItemCountPropertyDAO)argDAO;
...
/* 238 */     return loadDAO((IDataAccessObject)new ReturnedItemCountPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 242 */     ReturnedItemCountPropertyDAO dao = (ReturnedItemCountPropertyDAO)argDAO;
...
/* 261 */     ReturnedItemCountPropertyId id = (ReturnedItemCountPropertyId)argId;
...
/* 266 */     argStatement.setInt(5, id.getRetailTransactionLineItemSequence().intValue());
...
/* 273 */     ReturnedItemCountPropertyId id = new ReturnedItemCountPropertyId();
...
/* 278 */     id.setRetailTransactionLineItemSequence(this._retailTransactionLineItemSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\ReturnedItemCountPropertyDBA.class
