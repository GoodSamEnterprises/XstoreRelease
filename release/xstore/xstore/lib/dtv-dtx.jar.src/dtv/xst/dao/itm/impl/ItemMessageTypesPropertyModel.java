...
/*     */ 
/*     */ 
/*     */ public class ItemMessageTypesPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IItemMessageTypesProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new ItemMessageTypesPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private ItemMessageTypesPropertyDAO getDAO_() {
/*  44 */     return (ItemMessageTypesPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(IItemMessageTypesProperty.SET_MESSAGEID, argMessageId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(IItemMessageTypesProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getLineItemType();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setLineItemType_noev(argLineItemType) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(IItemMessageTypesProperty.SET_LINEITEMTYPE, argLineItemType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getLineItemType() == null && argLineItemType != null) || (
/* 146 */       getDAO_().getLineItemType() != null && !getDAO_().getLineItemType().equals(argLineItemType))) {
/* 147 */       getDAO_().setLineItemType(argLineItemType);
...
/* 170 */       this._events.post(IItemMessageTypesProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(IItemMessageTypesProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(IItemMessageTypesProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(IItemMessageTypesProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(IItemMessageTypesProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(IItemMessageTypesProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(IItemMessageTypesProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(IItemMessageTypesProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(IItemMessageTypesProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("ItemMessageTypesPropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("ItemMessageTypesPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemMessageTypesPropertyModel.class
