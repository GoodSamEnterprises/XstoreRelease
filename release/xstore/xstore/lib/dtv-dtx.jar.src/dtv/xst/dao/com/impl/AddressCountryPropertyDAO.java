...
/*     */ 
/*     */ 
/*     */ public class AddressCountryPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 609453335L;
/*  23 */   private static final Logger _logger = Logger.getLogger(AddressCountryPropertyDAO.class);
/*     */   
...
/*  49 */     return this._countryId;
/*     */   }
/*     */   
/*     */   public void setCountryId(String argCountryId) {
/*  53 */     if (changed(argCountryId, this._countryId, "countryId")) {
/*  54 */       this._countryId = (argCountryId != null && MANAGE_CASE) ? argCountryId.toUpperCase() : argCountryId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getAddressMode() {
/*  59 */     return this._addressMode;
/*     */   }
/*     */   
/*     */   public void setAddressMode(String argAddressMode) {
/*  63 */     if (changed(argAddressMode, this._addressMode, "addressMode")) {
/*  64 */       this._addressMode = (argAddressMode != null && MANAGE_CASE) ? argAddressMode.toUpperCase() : argAddressMode;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getCountryId() != null) {
/* 170 */       buf.append("countryId").append("=").append(getCountryId()).append(" ");
/*     */     }
/* 172 */     if (getAddressMode() != null) {
/* 173 */       buf.append("addressMode").append("=").append(getAddressMode()).append(" ");
/*     */     }
...
/* 207 */     AddressCountryPropertyId id = new AddressCountryPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setCountryId(getCountryId());
/* 210 */     id.setAddressMode(getAddressMode());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((AddressCountryPropertyId)argObjectId).getOrganizationId());
/* 217 */     setCountryId(((AddressCountryPropertyId)argObjectId).getCountryId());
/* 218 */     setAddressMode(((AddressCountryPropertyId)argObjectId).getAddressMode());
/* 219 */     setPropertyCode(((AddressCountryPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"AddressCountryProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._countryId != null) values.put("CountryId", DaoUtils.getXmlSafeFieldValue(12, this._countryId)); 
/* 239 */     if (this._addressMode != null) values.put("AddressMode", DaoUtils.getXmlSafeFieldValue(12, this._addressMode)); 
...
/* 273 */             setCountryId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setCountryId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "AddressMode":
...
/* 282 */             setAddressMode((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setAddressMode() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\AddressCountryPropertyDAO.class
