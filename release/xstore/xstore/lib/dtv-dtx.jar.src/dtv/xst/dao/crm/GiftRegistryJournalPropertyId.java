...
/*     */ 
/*     */ 
/*     */ public class GiftRegistryJournalPropertyId
...
/*     */   
/*     */   public GiftRegistryJournalPropertyId() {}
/*     */   
/*     */   public GiftRegistryJournalPropertyId(String argObjectIdValue) {
...
/*  30 */     return this._journalSequence;
/*     */   }
/*     */   
/*     */   public void setJournalSequence(Long argJournalSequence) {
/*  34 */     this._journalSequence = argJournalSequence;
/*     */   }
/*     */   
...
/*  55 */       str = tokens[1];
/*     */       
/*  57 */       setJournalSequence(Long.valueOf(str));
/*  58 */       str = tokens[2];
/*     */       
...
/*  75 */       return true;
/*     */     }
/*  77 */     if (!(ob instanceof GiftRegistryJournalPropertyId)) {
/*  78 */       return false;
/*     */     }
/*  80 */     GiftRegistryJournalPropertyId other = (GiftRegistryJournalPropertyId)ob;
/*  81 */     return (((this._organizationId == null && other._organizationId == null) || (this._organizationId != null && this._organizationId
/*     */ 
/*     */       
/*  84 */       .equals(other._organizationId))) && ((this._journalSequence == null && other._journalSequence == null) || (this._journalSequence != null && this._journalSequence
/*     */ 
/*     */       
/*  87 */       .equals(other._journalSequence))) && ((this._propertyCode == null && other._propertyCode == null) || (this._propertyCode != null && this._propertyCode
/*     */ 
/*     */       
...
/*  97 */       .hashCode()) + ((this._journalSequence == null) ? 0 : this._journalSequence
...
/* 104 */     return "GiftRegistryJournalProperty";
/*     */   }
/*     */ 
/*     */   
...
/* 113 */       .append("::").append(String.valueOf(this._journalSequence))
/* 114 */       .append("::").append(this._propertyCode)
/* 115 */       .toString();
/*     */   }
/*     */   
/*     */   public boolean validate() {
/* 119 */     if (this._journalSequence == null) {
/* 120 */       return false;
/*     */     }
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\crm\GiftRegistryJournalPropertyId.class
