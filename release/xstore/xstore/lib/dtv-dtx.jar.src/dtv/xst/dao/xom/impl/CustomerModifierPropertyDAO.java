...
/*     */ 
/*     */ 
/*     */ public class CustomerModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1435244054L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CustomerModifierPropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getOrderId() != null) {
/* 159 */       buf.append("orderId").append("=").append(getOrderId()).append(" ");
/*     */     }
...
/* 193 */     CustomerModifierPropertyId id = new CustomerModifierPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setOrderId(getOrderId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((CustomerModifierPropertyId)argObjectId).getOrganizationId());
/* 202 */     setOrderId(((CustomerModifierPropertyId)argObjectId).getOrderId());
/* 203 */     setPropertyCode(((CustomerModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"CustomerModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._orderId != null) values.put("OrderId", DaoUtils.getXmlSafeFieldValue(12, this._orderId)); 
...
/* 256 */             setOrderId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setOrderId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\xom\impl\CustomerModifierPropertyDAO.class
