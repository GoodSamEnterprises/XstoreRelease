...
/*     */ 
/*     */ 
/*     */ public class FiscalYearPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = -399287760L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.fiscal_year, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_stock_fiscal_year_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND fiscal_year = ?  AND property_code = ?  ";
/*     */   
...
/*  44 */     return "SELECT t.organization_id, t.fiscal_year, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM inv_stock_fiscal_year_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  50 */     return " WHERE organization_id = ?  AND fiscal_year = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  53 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO inv_stock_fiscal_year_p(organization_id, fiscal_year, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  60 */     Object[][] insertParameterObject = { { this._organizationId, this._fiscalYear, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  70 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE inv_stock_fiscal_year_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  86 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM inv_stock_fiscal_year_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND fiscal_year = ?  AND property_code = ?  ";
/*     */   
...
/*  95 */     return " WHERE organization_id = ?  AND fiscal_year = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  98 */     return new Object[] { this._organizationId, this._fiscalYear, this._propertyCode };
/*     */   }
/*     */   
...
/* 107 */     return "inv_stock_fiscal_year_p";
/*     */   }
/*     */   
...
/* 115 */     return new FiscalYearPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class FiscalYearPropertyFiller
/*     */     implements IFiller {
/*     */     private FiscalYearPropertyDBA _parent;
/*     */     
/*     */     public FiscalYearPropertyFiller(FiscalYearPropertyDBA argParent) {
...
/* 138 */         this._parent._fiscalYear = Integer.valueOf(primitiveResult);
/*     */       }
/*     */ 
/*     */       
...
/* 180 */     FiscalYearPropertyDAO dao = (FiscalYearPropertyDAO)argDAO;
/* 181 */     dao.setOrganizationId(this._organizationId);
/* 182 */     dao.setFiscalYear(this._fiscalYear);
...
/* 197 */     return loadDAO((IDataAccessObject)new FiscalYearPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 201 */     FiscalYearPropertyDAO dao = (FiscalYearPropertyDAO)argDAO;
/* 202 */     this._organizationId = dao.getOrganizationId();
/* 203 */     this._fiscalYear = dao.getFiscalYear();
...
/* 216 */     FiscalYearPropertyId id = (FiscalYearPropertyId)argId;
/* 217 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 218 */     argStatement.setInt(2, id.getFiscalYear().intValue());
/* 219 */     argStatement.setString(3, id.getPropertyCode());
/* 220 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 224 */     FiscalYearPropertyId id = new FiscalYearPropertyId();
/* 225 */     id.setOrganizationId(this._organizationId);
/* 226 */     id.setFiscalYear(this._fiscalYear);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\inv\impl\FiscalYearPropertyDBA.class
