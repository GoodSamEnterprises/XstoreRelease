...
/*     */ 
/*     */ 
/*     */ public class CommissionModifierPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 51487991L;
/*  23 */   private static final Logger _logger = Logger.getLogger(CommissionModifierPropertyDAO.class);
/*     */   
...
/*  54 */     return this._commissionModifierSequenceNbr;
/*     */   }
/*     */   
/*     */   public void setCommissionModifierSequenceNbr(Integer argCommissionModifierSequenceNbr) {
/*  58 */     if (changed(argCommissionModifierSequenceNbr, this._commissionModifierSequenceNbr, "commissionModifierSequenceNbr")) {
/*  59 */       this._commissionModifierSequenceNbr = argCommissionModifierSequenceNbr;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 214 */     if (getCommissionModifierSequenceNbr() != null) {
/* 215 */       buf.append("commissionModifierSequenceNbr").append("=").append(getCommissionModifierSequenceNbr()).append(" ");
/*     */     }
...
/* 264 */     CommissionModifierPropertyId id = new CommissionModifierPropertyId();
/* 265 */     id.setBusinessDate(getBusinessDate());
/* 266 */     id.setCommissionModifierSequenceNbr(getCommissionModifierSequenceNbr());
...
/* 277 */     setBusinessDate(((CommissionModifierPropertyId)argObjectId).getBusinessDate());
/* 278 */     setCommissionModifierSequenceNbr(((CommissionModifierPropertyId)argObjectId).getCommissionModifierSequenceNbr());
/* 279 */     setOrganizationId(((CommissionModifierPropertyId)argObjectId).getOrganizationId());
/* 280 */     setRetailLocationId(((CommissionModifierPropertyId)argObjectId).getRetailLocationId());
/* 281 */     setRetailTransactionLineItemSequence(((CommissionModifierPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 282 */     setTransactionSequence(((CommissionModifierPropertyId)argObjectId).getTransactionSequence());
/* 283 */     setWorkstationId(((CommissionModifierPropertyId)argObjectId).getWorkstationId());
/* 284 */     setPropertyCode(((CommissionModifierPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"CommissionModifierProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 303 */     if (this._commissionModifierSequenceNbr != null) values.put("CommissionModifierSequenceNbr", DaoUtils.getXmlSafeFieldValue(4, this._commissionModifierSequenceNbr)); 
...
/* 342 */             setCommissionModifierSequenceNbr((Integer)value);
/* 343 */           } catch (Exception ee) {
/* 344 */             throw new DtxException("An exception occurred while calling setCommissionModifierSequenceNbr() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\CommissionModifierPropertyDAO.class
