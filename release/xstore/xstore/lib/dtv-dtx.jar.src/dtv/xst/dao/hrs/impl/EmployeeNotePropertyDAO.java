...
/*     */ 
/*     */ 
/*     */ public class EmployeeNotePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1694939605L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeNotePropertyDAO.class);
/*     */   
...
/*  59 */     return this._noteSequence;
/*     */   }
/*     */   
/*     */   public void setNoteSequence(Long argNoteSequence) {
/*  63 */     if (changed(argNoteSequence, this._noteSequence, "noteSequence")) {
/*  64 */       this._noteSequence = argNoteSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getNoteSequence() != null) {
/* 173 */       buf.append("noteSequence").append("=").append(getNoteSequence()).append(" ");
/*     */     }
...
/* 207 */     EmployeeNotePropertyId id = new EmployeeNotePropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setEmployeeId(getEmployeeId());
/* 210 */     id.setNoteSequence(getNoteSequence());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((EmployeeNotePropertyId)argObjectId).getOrganizationId());
/* 217 */     setEmployeeId(((EmployeeNotePropertyId)argObjectId).getEmployeeId());
/* 218 */     setNoteSequence(((EmployeeNotePropertyId)argObjectId).getNoteSequence());
/* 219 */     setPropertyCode(((EmployeeNotePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"EmployeeNoteProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._noteSequence != null) values.put("NoteSequence", DaoUtils.getXmlSafeFieldValue(-5, this._noteSequence)); 
...
/* 282 */             setNoteSequence((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setNoteSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeNotePropertyDAO.class
