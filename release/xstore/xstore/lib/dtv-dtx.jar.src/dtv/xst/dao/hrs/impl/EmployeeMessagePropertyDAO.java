...
/*     */ 
/*     */ 
/*     */ public class EmployeeMessagePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 569049678L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeMessagePropertyDAO.class);
/*     */   
...
/*  48 */     return this._messageId;
/*     */   }
/*     */   
/*     */   public void setMessageId(Long argMessageId) {
/*  52 */     if (changed(argMessageId, this._messageId, "messageId")) {
/*  53 */       this._messageId = argMessageId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getMessageId() != null) {
/* 159 */       buf.append("messageId").append("=").append(getMessageId()).append(" ");
/*     */     }
...
/* 193 */     EmployeeMessagePropertyId id = new EmployeeMessagePropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setMessageId(getMessageId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((EmployeeMessagePropertyId)argObjectId).getOrganizationId());
/* 202 */     setMessageId(((EmployeeMessagePropertyId)argObjectId).getMessageId());
/* 203 */     setPropertyCode(((EmployeeMessagePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"EmployeeMessageProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._messageId != null) values.put("MessageId", DaoUtils.getXmlSafeFieldValue(-5, this._messageId)); 
...
/* 256 */             setMessageId((Long)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setMessageId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeMessagePropertyDAO.class
