...
/*     */ 
/*     */ 
/*     */ public class PosLogDataPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1820289071L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.trans_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_poslog_data_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  47 */     return "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.trans_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trn_poslog_data_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  53 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  56 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trn_poslog_data_p(organization_id, rtl_loc_id, wkstn_id, business_date, trans_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  63 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._transactionSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  64 */     return insertParameterObject;
/*     */   }
/*     */   
/*  67 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, -5, 91, -5, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  70 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  73 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trn_poslog_data_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  89 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trn_poslog_data_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  98 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND trans_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 101 */     return new Object[] { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._transactionSequence, this._propertyCode };
/*     */   }
/*     */   
/* 104 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { -5, -5, -5, 91, -5, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 107 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 110 */     return "trn_poslog_data_p";
/*     */   }
/*     */   
...
/* 118 */     return new PosLogDataPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class PosLogDataPropertyFiller
/*     */     implements IFiller {
/*     */     private PosLogDataPropertyDBA _parent;
/*     */     
/*     */     public PosLogDataPropertyFiller(PosLogDataPropertyDBA argParent) {
...
/* 208 */     PosLogDataPropertyDAO dao = (PosLogDataPropertyDAO)argDAO;
...
/* 228 */     return loadDAO((IDataAccessObject)new PosLogDataPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 232 */     PosLogDataPropertyDAO dao = (PosLogDataPropertyDAO)argDAO;
...
/* 250 */     PosLogDataPropertyId id = (PosLogDataPropertyId)argId;
/* 251 */     argStatement.setLong(1, id.getOrganizationId().longValue());
/* 252 */     argStatement.setLong(2, id.getRetailLocationId().longValue());
/* 253 */     argStatement.setLong(3, id.getWorkstationId().longValue());
/* 254 */     argStatement.setTimestamp(4, new Timestamp(id.getBusinessDate().getTime()));
...
/* 261 */     PosLogDataPropertyId id = new PosLogDataPropertyId();
/* 262 */     id.setOrganizationId(this._organizationId);
/* 263 */     id.setRetailLocationId(this._retailLocationId);
/* 264 */     id.setWorkstationId(this._workstationId);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trn\impl\PosLogDataPropertyDBA.class
