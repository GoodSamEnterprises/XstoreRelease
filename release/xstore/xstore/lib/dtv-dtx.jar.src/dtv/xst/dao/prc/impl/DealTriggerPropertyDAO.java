...
/*     */ 
/*     */ 
/*     */ public class DealTriggerPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -36700799L;
/*  23 */   private static final Logger _logger = Logger.getLogger(DealTriggerPropertyDAO.class);
/*     */   
...
/*  49 */     return this._dealId;
/*     */   }
/*     */   
/*     */   public void setDealId(String argDealId) {
/*  53 */     if (changed(argDealId, this._dealId, "dealId")) {
/*  54 */       this._dealId = (argDealId != null && MANAGE_CASE) ? argDealId.toUpperCase() : argDealId;
/*     */     }
/*     */   }
/*     */   
/*     */   public String getTrigger() {
/*  59 */     return this._trigger;
/*     */   }
/*     */   
/*     */   public void setTrigger(String argTrigger) {
/*  63 */     if (changed(argTrigger, this._trigger, "trigger")) {
/*  64 */       this._trigger = (argTrigger != null && MANAGE_CASE) ? argTrigger.toUpperCase() : argTrigger;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getDealId() != null) {
/* 170 */       buf.append("dealId").append("=").append(getDealId()).append(" ");
/*     */     }
/* 172 */     if (getTrigger() != null) {
/* 173 */       buf.append("trigger").append("=").append(getTrigger()).append(" ");
/*     */     }
...
/* 207 */     DealTriggerPropertyId id = new DealTriggerPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setDealId(getDealId());
/* 210 */     id.setTrigger(getTrigger());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((DealTriggerPropertyId)argObjectId).getOrganizationId());
/* 217 */     setDealId(((DealTriggerPropertyId)argObjectId).getDealId());
/* 218 */     setTrigger(((DealTriggerPropertyId)argObjectId).getTrigger());
/* 219 */     setPropertyCode(((DealTriggerPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"DealTriggerProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._dealId != null) values.put("DealId", DaoUtils.getXmlSafeFieldValue(12, this._dealId)); 
/* 239 */     if (this._trigger != null) values.put("Trigger", DaoUtils.getXmlSafeFieldValue(12, this._trigger)); 
...
/* 273 */             setDealId((String)value);
/* 274 */           } catch (Exception ee) {
/* 275 */             throw new DtxException("An exception occurred while calling setDealId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "Trigger":
...
/* 282 */             setTrigger((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setTrigger() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\prc\impl\DealTriggerPropertyDAO.class
