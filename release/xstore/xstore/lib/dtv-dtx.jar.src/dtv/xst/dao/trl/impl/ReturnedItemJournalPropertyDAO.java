...
/*     */ 
/*     */ 
/*     */ public class ReturnedItemJournalPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 1097877546L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ReturnedItemJournalPropertyDAO.class);
/*     */   
...
/* 264 */     ReturnedItemJournalPropertyId id = new ReturnedItemJournalPropertyId();
...
/* 277 */     setOrganizationId(((ReturnedItemJournalPropertyId)argObjectId).getOrganizationId());
/* 278 */     setRetailLocationId(((ReturnedItemJournalPropertyId)argObjectId).getRetailLocationId());
/* 279 */     setWorkstationId(((ReturnedItemJournalPropertyId)argObjectId).getWorkstationId());
/* 280 */     setBusinessDate(((ReturnedItemJournalPropertyId)argObjectId).getBusinessDate());
/* 281 */     setRetailTransactionLineItemSequence(((ReturnedItemJournalPropertyId)argObjectId).getRetailTransactionLineItemSequence());
/* 282 */     setTransactionSequence(((ReturnedItemJournalPropertyId)argObjectId).getTransactionSequence());
/* 283 */     setJournalSequence(((ReturnedItemJournalPropertyId)argObjectId).getJournalSequence());
/* 284 */     setPropertyCode(((ReturnedItemJournalPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 293 */     buf.append("<").append("dao").append(" name=\"ReturnedItemJournalProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\ReturnedItemJournalPropertyDAO.class
