...
/*     */ 
/*     */ 
/*     */ public class TaxCodePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 628315661L;
/*  23 */   private static final Logger _logger = Logger.getLogger(TaxCodePropertyDAO.class);
/*     */   
...
/*  48 */     return this._taxCodeId;
/*     */   }
/*     */   
/*     */   public void setTaxCodeId(String argTaxCodeId) {
/*  52 */     if (changed(argTaxCodeId, this._taxCodeId, "taxCodeId")) {
/*  53 */       this._taxCodeId = (argTaxCodeId != null && MANAGE_CASE) ? argTaxCodeId.toUpperCase() : argTaxCodeId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 158 */     if (getTaxCodeId() != null) {
/* 159 */       buf.append("taxCodeId").append("=").append(getTaxCodeId()).append(" ");
/*     */     }
...
/* 193 */     TaxCodePropertyId id = new TaxCodePropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setTaxCodeId(getTaxCodeId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((TaxCodePropertyId)argObjectId).getOrganizationId());
/* 202 */     setTaxCodeId(((TaxCodePropertyId)argObjectId).getTaxCodeId());
/* 203 */     setPropertyCode(((TaxCodePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"TaxCodeProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._taxCodeId != null) values.put("TaxCodeId", DaoUtils.getXmlSafeFieldValue(12, this._taxCodeId)); 
...
/* 256 */             setTaxCodeId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setTaxCodeId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\tax\impl\TaxCodePropertyDAO.class
