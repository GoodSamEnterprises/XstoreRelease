...
/*     */ 
/*     */ 
/*     */ public class CycleQuestionChoicePropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements ICycleQuestionChoiceProperty
/*     */ {
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new CycleQuestionChoicePropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private CycleQuestionChoicePropertyDAO getDAO_() {
/*  44 */     return (CycleQuestionChoicePropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(ICycleQuestionChoiceProperty.SET_ANSWERID, argAnswerId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 102 */       this._events.post(ICycleQuestionChoiceProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 125 */     return getDAO_().getQuestionId();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 133 */     if (setQuestionId_noev(argQuestionId) && 
/* 134 */       this._events != null && 
/* 135 */       postEventsForChanges()) {
/* 136 */       this._events.post(ICycleQuestionChoiceProperty.SET_QUESTIONID, argQuestionId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if ((getDAO_().getQuestionId() == null && argQuestionId != null) || (
/* 146 */       getDAO_().getQuestionId() != null && !getDAO_().getQuestionId().equals(argQuestionId))) {
/* 147 */       getDAO_().setQuestionId(argQuestionId);
...
/* 170 */       this._events.post(ICycleQuestionChoiceProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 204 */       this._events.post(ICycleQuestionChoiceProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 238 */       this._events.post(ICycleQuestionChoiceProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 272 */       this._events.post(ICycleQuestionChoiceProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 306 */       this._events.post(ICycleQuestionChoiceProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 340 */       this._events.post(ICycleQuestionChoiceProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 374 */       this._events.post(ICycleQuestionChoiceProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 408 */       this._events.post(ICycleQuestionChoiceProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 442 */       this._events.post(ICycleQuestionChoiceProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 463 */     if ("CycleQuestionChoicePropertyExtension".equals(argFieldId)) {
...
/* 473 */     if ("CycleQuestionChoicePropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\loc\impl\CycleQuestionChoicePropertyModel.class
