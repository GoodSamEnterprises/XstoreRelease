...
/*     */ 
/*     */ 
/*     */ public class CodeValuePropertyDBA
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.category, t.code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_code_value_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND category = ?  AND code = ?  AND property_code = ?  ";
/*     */   
...
/*  45 */     return "SELECT t.organization_id, t.category, t.code, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM com_code_value_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  51 */     return " WHERE organization_id = ?  AND category = ?  AND code = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  54 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO com_code_value_p(organization_id, category, code, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  61 */     Object[][] insertParameterObject = { { this._organizationId, this._category, this._code, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
...
/*     */   }
/*     */   
/*  71 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE com_code_value_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  87 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM com_code_value_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND category = ?  AND code = ?  AND property_code = ?  ";
/*     */   
...
/*  96 */     return " WHERE organization_id = ?  AND category = ?  AND code = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/*  99 */     return new Object[] { this._organizationId, this._category, this._code, this._propertyCode };
/*     */   }
/*     */   
...
/* 116 */     return new CodeValuePropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class CodeValuePropertyFiller
/*     */     implements IFiller {
/*     */     private CodeValuePropertyDBA _parent;
/*     */     
/*     */     public CodeValuePropertyFiller(CodeValuePropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 135 */       this._parent._category = argResultSet.getString(2);
/* 136 */       this._parent._code = argResultSet.getString(3);
...
/* 175 */     CodeValuePropertyDAO dao = (CodeValuePropertyDAO)argDAO;
/* 176 */     dao.setOrganizationId(this._organizationId);
/* 177 */     dao.setCategory(this._category);
/* 178 */     dao.setCode(this._code);
...
/* 193 */     return loadDAO((IDataAccessObject)new CodeValuePropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 197 */     CodeValuePropertyDAO dao = (CodeValuePropertyDAO)argDAO;
/* 198 */     this._organizationId = dao.getOrganizationId();
/* 199 */     this._category = dao.getCategory();
/* 200 */     this._code = dao.getCode();
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\com\impl\CodeValuePropertyDBA.class
