...
/*     */ 
/*     */ 
/*     */ public class ItemMessageTypesPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -822325126L;
/*  23 */   private static final Logger _logger = Logger.getLogger(ItemMessageTypesPropertyDAO.class);
/*     */   
...
/*  59 */     return this._lineItemType;
/*     */   }
/*     */   
/*     */   public void setLineItemType(String argLineItemType) {
/*  63 */     if (changed(argLineItemType, this._lineItemType, "lineItemType")) {
/*  64 */       this._lineItemType = (argLineItemType != null && MANAGE_CASE) ? argLineItemType.toUpperCase() : argLineItemType;
/*     */     }
/*     */   }
/*     */   
...
/* 166 */     if (getMessageId() != null) {
/* 167 */       buf.append("messageId").append("=").append(getMessageId()).append(" ");
/*     */     }
/* 169 */     if (getOrganizationId() != null) {
/* 170 */       buf.append("organizationId").append("=").append(getOrganizationId()).append(" ");
/*     */     }
/* 172 */     if (getLineItemType() != null) {
/* 173 */       buf.append("lineItemType").append("=").append(getLineItemType()).append(" ");
/*     */     }
...
/* 207 */     ItemMessageTypesPropertyId id = new ItemMessageTypesPropertyId();
/* 208 */     id.setMessageId(getMessageId());
/* 209 */     id.setOrganizationId(getOrganizationId());
/* 210 */     id.setLineItemType(getLineItemType());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setMessageId(((ItemMessageTypesPropertyId)argObjectId).getMessageId());
/* 217 */     setOrganizationId(((ItemMessageTypesPropertyId)argObjectId).getOrganizationId());
/* 218 */     setLineItemType(((ItemMessageTypesPropertyId)argObjectId).getLineItemType());
/* 219 */     setPropertyCode(((ItemMessageTypesPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"ItemMessageTypesProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 237 */     if (this._messageId != null) values.put("MessageId", DaoUtils.getXmlSafeFieldValue(12, this._messageId)); 
/* 238 */     if (this._organizationId != null) values.put("OrganizationId", DaoUtils.getXmlSafeFieldValue(-5, this._organizationId)); 
/* 239 */     if (this._lineItemType != null) values.put("LineItemType", DaoUtils.getXmlSafeFieldValue(12, this._lineItemType)); 
...
/* 264 */             setMessageId((String)value);
/* 265 */           } catch (Exception ee) {
/* 266 */             throw new DtxException("An exception occurred while calling setMessageId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "OrganizationId":
...
/* 282 */             setLineItemType((String)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setLineItemType() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\itm\impl\ItemMessageTypesPropertyDAO.class
