...
/*     */ 
/*     */ 
/*     */ public class EmployeeStorePropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -2057097816L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeStorePropertyDAO.class);
/*     */   
...
/*  70 */     return this._employeeStoreSequence;
/*     */   }
/*     */   
/*     */   public void setEmployeeStoreSequence(Integer argEmployeeStoreSequence) {
/*  74 */     if (changed(argEmployeeStoreSequence, this._employeeStoreSequence, "employeeStoreSequence")) {
/*  75 */       this._employeeStoreSequence = argEmployeeStoreSequence;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 180 */     if (getEmployeeId() != null) {
/* 181 */       buf.append("employeeId").append("=").append(getEmployeeId()).append(" ");
/*     */     }
/* 183 */     if (getRetailLocationId() != null) {
/* 184 */       buf.append("retailLocationId").append("=").append(getRetailLocationId()).append(" ");
/*     */     }
/* 186 */     if (getEmployeeStoreSequence() != null) {
/* 187 */       buf.append("employeeStoreSequence").append("=").append(getEmployeeStoreSequence()).append(" ");
/*     */     }
...
/* 221 */     EmployeeStorePropertyId id = new EmployeeStorePropertyId();
/* 222 */     id.setOrganizationId(getOrganizationId());
/* 223 */     id.setEmployeeId(getEmployeeId());
/* 224 */     id.setRetailLocationId(getRetailLocationId());
/* 225 */     id.setEmployeeStoreSequence(getEmployeeStoreSequence());
/* 226 */     id.setPropertyCode(getPropertyCode());
/* 227 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 231 */     setOrganizationId(((EmployeeStorePropertyId)argObjectId).getOrganizationId());
/* 232 */     setEmployeeId(((EmployeeStorePropertyId)argObjectId).getEmployeeId());
/* 233 */     setRetailLocationId(((EmployeeStorePropertyId)argObjectId).getRetailLocationId());
/* 234 */     setEmployeeStoreSequence(((EmployeeStorePropertyId)argObjectId).getEmployeeStoreSequence());
/* 235 */     setPropertyCode(((EmployeeStorePropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 244 */     buf.append("<").append("dao").append(" name=\"EmployeeStoreProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 254 */     if (this._employeeId != null) values.put("EmployeeId", DaoUtils.getXmlSafeFieldValue(12, this._employeeId)); 
/* 255 */     if (this._retailLocationId != null) values.put("RetailLocationId", DaoUtils.getXmlSafeFieldValue(-5, this._retailLocationId)); 
/* 256 */     if (this._employeeStoreSequence != null) values.put("EmployeeStoreSequence", DaoUtils.getXmlSafeFieldValue(4, this._employeeStoreSequence)); 
...
/* 290 */             setEmployeeId((String)value);
/* 291 */           } catch (Exception ee) {
/* 292 */             throw new DtxException("An exception occurred while calling setEmployeeId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 299 */             setRetailLocationId((Long)value);
/* 300 */           } catch (Exception ee) {
/* 301 */             throw new DtxException("An exception occurred while calling setRetailLocationId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
...
/* 308 */             setEmployeeStoreSequence((Integer)value);
/* 309 */           } catch (Exception ee) {
/* 310 */             throw new DtxException("An exception occurred while calling setEmployeeStoreSequence() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeStorePropertyDAO.class
