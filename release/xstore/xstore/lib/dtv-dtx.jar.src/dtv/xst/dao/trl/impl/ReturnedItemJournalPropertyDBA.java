...
/*     */ 
/*     */ 
/*     */ public class ReturnedItemJournalPropertyDBA
/*     */   implements IJDBCTableAdapter
/*     */ {
/*     */   private static final long serialVersionUID = 1097877546L;
...
/*     */   private static final String SELECT_OBJECT = "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.rtrans_lineitm_seq, t.trans_seq, t.journal_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trl_returned_item_journal_p t";
/*     */   private static final String SELECT_WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND journal_seq = ?  AND property_code = ?  ";
/*     */   
...
/*  49 */     return "SELECT t.organization_id, t.rtl_loc_id, t.wkstn_id, t.business_date, t.rtrans_lineitm_seq, t.trans_seq, t.journal_seq, t.property_code, t.type, t.string_value, t.date_value, t.decimal_value, t.create_date, t.create_user_id, t.update_date, t.update_user_id FROM trl_returned_item_journal_p t";
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   public String getSelectWhere() {
/*  55 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND journal_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   
/*  58 */   private static final String[] INSERT_OBJECT = new String[] { "INSERT INTO trl_returned_item_journal_p(organization_id, rtl_loc_id, wkstn_id, business_date, rtrans_lineitm_seq, trans_seq, journal_seq, property_code, type, string_value, date_value, decimal_value, create_date, create_user_id, update_date, update_user_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" };
/*     */   
...
/*  65 */     Object[][] insertParameterObject = { { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._retailTransactionLineItemSequence, this._transactionSequence, this._journalSequence, this._propertyCode, this._type, this._stringValue, this._dateValue, this._decimalValue, this._createDate, this._createUserId, this._updateDate, this._updateUserId } };
/*  66 */     return insertParameterObject;
/*     */   }
/*     */   
/*  69 */   private static final int[][] INSERT_PARAMETER_TYPES_OBJECT = new int[][] { { -5, -5, -5, 91, 4, -5, -5, 12, 12, 12, 91, 3, 91, 12, 91, 12 } };
/*     */   
/*     */   public int[][] getInsertParameterTypes() {
/*  72 */     return INSERT_PARAMETER_TYPES_OBJECT;
/*     */   }
/*     */   
/*  75 */   private static final String[] UPDATE_OBJECT = new String[] { "UPDATE trl_returned_item_journal_p SET type = ?, string_value = ?, date_value = ?, decimal_value = ?, update_date = ?, update_user_id = ?" };
/*     */   
...
/*     */   }
/*     */   
/*  91 */   private static final String[] DELETE_OBJECT = new String[] { "DELETE FROM trl_returned_item_journal_p" }; private static final String WHERE_OBJECT = " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND journal_seq = ?  AND property_code = ?  ";
/*     */   
...
/* 100 */     return " WHERE organization_id = ?  AND rtl_loc_id = ?  AND wkstn_id = ?  AND business_date = ?  AND rtrans_lineitm_seq = ?  AND trans_seq = ?  AND journal_seq = ?  AND property_code = ?  ";
/*     */   }
/*     */   public Object[] getWhereParameters() {
/* 103 */     return new Object[] { this._organizationId, this._retailLocationId, this._workstationId, this._businessDate, this._retailTransactionLineItemSequence, this._transactionSequence, this._journalSequence, this._propertyCode };
/*     */   }
/*     */   
/* 106 */   private static final int[] WHERE_PARAMETER_OBJECT = new int[] { -5, -5, -5, 91, 4, -5, -5, 12 };
/*     */   
/*     */   public int[] getWhereParameterTypes() {
/* 109 */     return WHERE_PARAMETER_OBJECT;
/*     */   }
/*     */   public String getTableName() {
/* 112 */     return "trl_returned_item_journal_p";
/*     */   }
/*     */   
...
/* 120 */     return new ReturnedItemJournalPropertyFiller(this);
/*     */   }
/*     */   
/*     */   private static class ReturnedItemJournalPropertyFiller
/*     */     implements IFiller {
/*     */     private ReturnedItemJournalPropertyDBA _parent;
/*     */     
/*     */     public ReturnedItemJournalPropertyFiller(ReturnedItemJournalPropertyDBA argParent) {
...
/*     */ 
/*     */       
/* 174 */       long l1 = argResultSet.getLong(6);
...
/* 184 */         this._parent._journalSequence = Long.valueOf(l1);
/*     */       }
/*     */ 
/*     */       
...
/* 226 */     ReturnedItemJournalPropertyDAO dao = (ReturnedItemJournalPropertyDAO)argDAO;
...
/* 233 */     dao.setJournalSequence(this._journalSequence);
...
/* 248 */     return loadDAO((IDataAccessObject)new ReturnedItemJournalPropertyDAO());
/*     */   }
/*     */   
/*     */   public void fill(IDataAccessObject argDAO) {
/* 252 */     ReturnedItemJournalPropertyDAO dao = (ReturnedItemJournalPropertyDAO)argDAO;
...
/* 259 */     this._journalSequence = dao.getJournalSequence();
...
/* 272 */     ReturnedItemJournalPropertyId id = (ReturnedItemJournalPropertyId)argId;
...
/* 279 */     argStatement.setLong(7, id.getJournalSequence().longValue());
/* 280 */     argStatement.setString(8, id.getPropertyCode());
/* 281 */     return argStatement;
/*     */   }
/*     */   
/*     */   public IObjectId getObjectId() {
/* 285 */     ReturnedItemJournalPropertyId id = new ReturnedItemJournalPropertyId();
...
/* 292 */     id.setJournalSequence(this._journalSequence);
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\trl\impl\ReturnedItemJournalPropertyDBA.class
