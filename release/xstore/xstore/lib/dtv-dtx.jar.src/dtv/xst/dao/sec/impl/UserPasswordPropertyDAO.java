...
/*     */ 
/*     */ 
/*     */ public class UserPasswordPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -1987797093L;
/*  23 */   private static final Logger _logger = Logger.getLogger(UserPasswordPropertyDAO.class);
/*     */   
...
/*  53 */     if (changed(argUser, this._user, "user")) {
/*  54 */       this._user = (argUser != null && MANAGE_CASE) ? argUser.toUpperCase() : argUser;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 169 */     if (getUser() != null) {
/* 170 */       buf.append("user").append("=").append(getUser()).append(" ");
/*     */     }
...
/* 207 */     UserPasswordPropertyId id = new UserPasswordPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setUser(getUser());
...
/* 216 */     setOrganizationId(((UserPasswordPropertyId)argObjectId).getOrganizationId());
/* 217 */     setUser(((UserPasswordPropertyId)argObjectId).getUser());
/* 218 */     setSequence(((UserPasswordPropertyId)argObjectId).getSequence());
/* 219 */     setPropertyCode(((UserPasswordPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"UserPasswordProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 238 */     if (this._user != null) values.put("User", DaoUtils.getXmlSafeFieldValue(12, this._user)); 
...
/* 275 */             throw new DtxException("An exception occurred while calling setUser() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "Sequence":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\sec\impl\UserPasswordPropertyDAO.class
