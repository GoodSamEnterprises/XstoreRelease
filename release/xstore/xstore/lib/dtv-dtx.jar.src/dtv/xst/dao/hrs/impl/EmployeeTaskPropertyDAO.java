...
/*     */ 
/*     */ 
/*     */ public class EmployeeTaskPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = -201327512L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EmployeeTaskPropertyDAO.class);
/*     */   
...
/*  59 */     return this._taskId;
/*     */   }
/*     */   
/*     */   public void setTaskId(Long argTaskId) {
/*  63 */     if (changed(argTaskId, this._taskId, "taskId")) {
/*  64 */       this._taskId = argTaskId;
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 172 */     if (getTaskId() != null) {
/* 173 */       buf.append("taskId").append("=").append(getTaskId()).append(" ");
/*     */     }
...
/* 207 */     EmployeeTaskPropertyId id = new EmployeeTaskPropertyId();
/* 208 */     id.setOrganizationId(getOrganizationId());
/* 209 */     id.setRetailLocationId(getRetailLocationId());
/* 210 */     id.setTaskId(getTaskId());
/* 211 */     id.setPropertyCode(getPropertyCode());
/* 212 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 216 */     setOrganizationId(((EmployeeTaskPropertyId)argObjectId).getOrganizationId());
/* 217 */     setRetailLocationId(((EmployeeTaskPropertyId)argObjectId).getRetailLocationId());
/* 218 */     setTaskId(((EmployeeTaskPropertyId)argObjectId).getTaskId());
/* 219 */     setPropertyCode(((EmployeeTaskPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 228 */     buf.append("<").append("dao").append(" name=\"EmployeeTaskProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 239 */     if (this._taskId != null) values.put("TaskId", DaoUtils.getXmlSafeFieldValue(-5, this._taskId)); 
...
/* 282 */             setTaskId((Long)value);
/* 283 */           } catch (Exception ee) {
/* 284 */             throw new DtxException("An exception occurred while calling setTaskId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\hrs\impl\EmployeeTaskPropertyDAO.class
