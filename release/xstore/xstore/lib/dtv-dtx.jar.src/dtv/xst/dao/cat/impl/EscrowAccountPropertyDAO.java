...
/*     */ 
/*     */ 
/*     */ public class EscrowAccountPropertyDAO
/*     */   extends AbstractDAOImpl
/*     */ {
/*     */   private static final long serialVersionUID = 287925245L;
/*  23 */   private static final Logger _logger = Logger.getLogger(EscrowAccountPropertyDAO.class);
/*     */   
...
/*     */     }
/* 158 */     if (getCustAccountId() != null) {
/* 159 */       buf.append("custAccountId").append("=").append(getCustAccountId()).append(" ");
/*     */     }
...
/* 193 */     EscrowAccountPropertyId id = new EscrowAccountPropertyId();
/* 194 */     id.setOrganizationId(getOrganizationId());
/* 195 */     id.setCustAccountId(getCustAccountId());
/* 196 */     id.setPropertyCode(getPropertyCode());
/* 197 */     return (IObjectId)id;
/*     */   }
/*     */   
/*     */   public void setObjectId(IObjectId argObjectId) {
/* 201 */     setOrganizationId(((EscrowAccountPropertyId)argObjectId).getOrganizationId());
/* 202 */     setCustAccountId(((EscrowAccountPropertyId)argObjectId).getCustAccountId());
/* 203 */     setPropertyCode(((EscrowAccountPropertyId)argObjectId).getPropertyCode());
/*     */   }
/*     */   
...
/* 212 */     buf.append("<").append("dao").append(" name=\"EscrowAccountProperty\" cmd=\"" + getObjectStateString() + "\">");
...
/* 222 */     if (this._custAccountId != null) values.put("CustAccountId", DaoUtils.getXmlSafeFieldValue(12, this._custAccountId)); 
...
/* 256 */             setCustAccountId((String)value);
/* 257 */           } catch (Exception ee) {
/* 258 */             throw new DtxException("An exception occurred while calling setCustAccountId() with " + fieldValue + " on: " + this + " " + ee.toString(), ee);
/*     */           } 
/*     */ 
/*     */         
/*     */         case "PropertyCode":
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\cat\impl\EscrowAccountPropertyDAO.class
