...
/*     */ 
/*     */ 
/*     */ public class IdentityVerificationPropertyModel
/*     */   extends AbstractDataModelPropertiesImpl
/*     */   implements IIdentityVerificationProperty
/*     */ {
/*     */   private static final long serialVersionUID = 497728270L;
...
/*     */   
/*     */   public void initDAO() {
/*  36 */     setDAO((IDataAccessObject)new IdentityVerificationPropertyDAO());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   private IdentityVerificationPropertyDAO getDAO_() {
/*  44 */     return (IdentityVerificationPropertyDAO)this._daoImpl;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  63 */       this._events.post(IIdentityVerificationProperty.SET_BUSINESSDATE, argBusinessDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*  86 */     if (getDAO_().getIdentityVerificationSequence() != null) {
/*  87 */       return getDAO_().getIdentityVerificationSequence().intValue();
/*     */     }
/*     */     
/*  90 */     return 0;
/*     */   }
...
/*  99 */     if (setIdentityVerificationSequence_noev(argIdentityVerificationSequence) && 
/* 100 */       this._events != null && 
/* 101 */       postEventsForChanges()) {
/* 102 */       this._events.post(IIdentityVerificationProperty.SET_IDENTITYVERIFICATIONSEQUENCE, Integer.valueOf(argIdentityVerificationSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 111 */     if ((getDAO_().getIdentityVerificationSequence() == null && Integer.valueOf(argIdentityVerificationSequence) != null) || (
/* 112 */       getDAO_().getIdentityVerificationSequence() != null && !getDAO_().getIdentityVerificationSequence().equals(Integer.valueOf(argIdentityVerificationSequence)))) {
/* 113 */       getDAO_().setIdentityVerificationSequence(Integer.valueOf(argIdentityVerificationSequence));
...
/* 141 */       this._events.post(IIdentityVerificationProperty.SET_ORGANIZATIONID, Long.valueOf(argOrganizationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 180 */       this._events.post(IIdentityVerificationProperty.SET_RETAILLOCATIONID, Long.valueOf(argRetailLocationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */       this._events.post(IIdentityVerificationProperty.SET_RETAILTRANSACTIONLINEITEMSEQUENCE, Integer.valueOf(argRetailTransactionLineItemSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 258 */       this._events.post(IIdentityVerificationProperty.SET_TRANSACTIONSEQUENCE, Long.valueOf(argTransactionSequence));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 297 */       this._events.post(IIdentityVerificationProperty.SET_WORKSTATIONID, Long.valueOf(argWorkstationId));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 331 */       this._events.post(IIdentityVerificationProperty.SET_PROPERTYCODE, argPropertyCode);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 365 */       this._events.post(IIdentityVerificationProperty.SET_TYPE, argType);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 399 */       this._events.post(IIdentityVerificationProperty.SET_STRINGVALUE, argStringValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 433 */       this._events.post(IIdentityVerificationProperty.SET_DATEVALUE, argDateValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 467 */       this._events.post(IIdentityVerificationProperty.SET_DECIMALVALUE, argDecimalValue);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 501 */       this._events.post(IIdentityVerificationProperty.SET_CREATEDATE, argCreateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 535 */       this._events.post(IIdentityVerificationProperty.SET_CREATEUSERID, argCreateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 569 */       this._events.post(IIdentityVerificationProperty.SET_UPDATEDATE, argUpdateDate);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 603 */       this._events.post(IIdentityVerificationProperty.SET_UPDATEUSERID, argUpdateUserId);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 624 */     if ("IdentityVerificationPropertyExtension".equals(argFieldId)) {
...
/* 634 */     if ("IdentityVerificationPropertyExtension".equals(argFieldId)) {
...
/* Location:              C:\WIP-Xstore_Delta-main\release\xstore\xstore\lib\dtv-dtx.jar!\dtv\xst\dao\ttr\impl\IdentityVerificationPropertyModel.class
