...
# Application
APP_NAME="formdesigner"
APP_LONG_NAME="Xstore Form Designer"
...
# description: Xstore Form Designer
...
WRAPPER_CONF=$REALPATH/wrapper/conf/formdesigner.conf
export PLATFORM=linux_64
export _WRAPPED_APP=formdesigner
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/formdesigner
...
WRAPPER_CMD=$PLATFORMPATH/bin/formdesigner-wrapper
