...
# Application
APP_NAME="paylog"
APP_LONG_NAME="Xstore Payroll Log Generator"
...
# description: Xstore Payroll Log Generator
...
WRAPPER_CONF=$REALPATH/wrapper/conf/paylog.conf
export PLATFORM=linux_64
export _WRAPPED_APP=paylog
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/paylog
...
WRAPPER_CMD=$PLATFORMPATH/bin/paylog-wrapper
