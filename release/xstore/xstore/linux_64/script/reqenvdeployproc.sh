...
# Application
APP_NAME="reqenvdeployproc"
APP_LONG_NAME="Xstore Immediate Deployment Processing Requestor"
...
# description: Xstore Immediate Deployment Processing Requestor
...
WRAPPER_CONF=$REALPATH/wrapper/conf/reqenvdeployproc.conf
export PLATFORM=linux_64
export _WRAPPED_APP=reqenvdeployproc
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/reqenvdeployproc
...
WRAPPER_CMD=$PLATFORMPATH/bin/reqenvdeployproc-wrapper
