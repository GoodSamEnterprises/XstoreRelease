...
# Application
APP_NAME="encrypt"
APP_LONG_NAME="Xstore Config String Encrypter"
...
# description: Xstore Config String Encrypter
...
WRAPPER_CONF=$REALPATH/wrapper/conf/encrypt.conf
export PLATFORM=linux_64
export _WRAPPED_APP=encrypt
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/encrypt
...
WRAPPER_CMD=$PLATFORMPATH/bin/encrypt-wrapper
