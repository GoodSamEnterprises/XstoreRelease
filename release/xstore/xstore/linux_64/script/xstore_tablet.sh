...
# Application
APP_NAME="xstore_tablet"
APP_LONG_NAME="Xstore Tablet POS"
...
WRAPPER_CONF=$REALPATH/wrapper/conf/xstore_tablet.conf
export PLATFORM=linux_64
export _WRAPPED_APP=xstore_tablet
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/xstore_tablet
...
WRAPPER_CMD=$PLATFORMPATH/bin/xstore_tablet-wrapper
