...
# Application
APP_NAME="xfg-loganalyzer"
APP_LONG_NAME="Xstore Grocery Client Log Analyzer"
...
# description: Xstore Grocery Client Log Analyzer
...
WRAPPER_CONF=$REALPATH/wrapper/conf/xfg-loganalyzer.conf
export PLATFORM=linux_64
export _WRAPPED_APP=xfg-loganalyzer
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/xfg-loganalyzer
...
WRAPPER_CMD=$PLATFORMPATH/bin/xfg-loganalyzer-wrapper
