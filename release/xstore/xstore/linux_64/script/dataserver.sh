...
# Application
APP_NAME="dataserver"
APP_LONG_NAME="Xstore Dataserver"
...
WRAPPER_CONF=$REALPATH/wrapper/conf/dataserver.conf
export PLATFORM=linux_64
export _WRAPPED_APP=dataserver
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/dataserver
...
WRAPPER_CMD=$PLATFORMPATH/bin/dataserver-wrapper
