...
# Application
APP_NAME="xstore_debug"
APP_LONG_NAME="Xstore POS with Open Debug Port"
...
# description: Xstore POS with Open Debug Port
...
WRAPPER_CONF=$REALPATH/wrapper/conf/xstore_debug.conf
export PLATFORM=linux_64
export _WRAPPED_APP=xstore_debug
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/xstore_debug
...
WRAPPER_CMD=$PLATFORMPATH/bin/xstore_debug-wrapper
