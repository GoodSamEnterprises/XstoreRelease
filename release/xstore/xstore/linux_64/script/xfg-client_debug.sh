...
# Application
APP_NAME="xfg-client_debug"
APP_LONG_NAME="Xstore Grocery Client POS with Open Debug Port"
...
# description: Xstore Grocery Client POS with Open Debug Port
...
WRAPPER_CONF=$REALPATH/wrapper/conf/xfg-client_debug.conf
export PLATFORM=linux_64
export _WRAPPED_APP=xfg-client_debug
...
WRAPPER_CMD=$PLATFORMPATH/bin/xfg-client_debug-wrapper
