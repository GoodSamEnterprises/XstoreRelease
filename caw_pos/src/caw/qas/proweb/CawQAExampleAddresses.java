 ...
 *       &lt;sequence>
 *         &lt;element name="ExampleAddress" type="{http://www.qas.com/web-2013-12}QAExampleAddress" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "exampleAddress" })
@XmlRootElement(name = "QAExampleAddresses")
public class CawQAExampleAddresses {

    @XmlElement(name = "ExampleAddress")
    protected List<CawQAExampleAddress> exampleAddress;
     ...
     * 
     */
    public List<CawQAExampleAddress> getExampleAddress() {

        if (exampleAddress == null) {
            exampleAddress = new ArrayList<CawQAExampleAddress>();
        }
