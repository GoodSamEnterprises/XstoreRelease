...
import dtv.pos.register.sale.CheckItemNotOnFileOp;


public class CawCheckItemNotOnFileOp extends CheckItemNotOnFileOp implements IXstEventObserver {
    ...
    public IOpResponse handleOpExec(IXstEvent argArg0) {
        ...
        if (argArg0 !=null && !(argArg0 instanceof IXstAction) ) {
