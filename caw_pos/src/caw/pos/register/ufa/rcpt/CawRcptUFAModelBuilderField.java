 ...
 *
 */
public class CawRcptUFAModelBuilderField extends AbstractDocBuilderField {

    private static final Logger _logger = LogManager
            .getLogger(CawRcptUFAModelBuilderField.class);

    public CawRcptUFAModelBuilderField(String argContents, String argStyle,
                ...
                if (mObj instanceof IRetailTransactionLineItemProperty) {
                    ...
                    try {
                        ...
                        if (!objects.isNull("model")) {
                            result = objects.get("model").toString();
                        }

                    } catch (JSONException ex) {
                        _logger.debug("getContents-model", ex);
                    }
