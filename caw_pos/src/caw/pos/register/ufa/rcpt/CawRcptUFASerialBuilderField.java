 ...
 *
 */
public class CawRcptUFASerialBuilderField extends AbstractDocBuilderField {

    private static final Logger _logger = LogManager
            .getLogger(CawRcptUFASerialBuilderField.class);

    public CawRcptUFASerialBuilderField(String argContents, String argStyle,
                ...
                if (mObj instanceof IRetailTransactionLineItemProperty) {
                    ...
                    try {
                        ...
                        if (!objects.isNull("serialNumber")) {
                            result = objects.get("serialNumber").toString();
                        }
                    } catch (JSONException ex) {
                        _logger.error("getContents-serialNumber", ex);
                    }
