 ...
 *
 */
public class CawAgisRoadsideQRBarcodeBuilderField extends AbstractDocBuilderField {
    private static Logger _logger = Logger.getLogger(CawAgisMembershipQRBarcodeBuilderField.class);
    private static final String CAW_AGIS_TEMP_ROAD_QR_LINK = "CAW_AGIS_TEMP_ROAD_QR_LINK";
    private static final String CAW_SUBCODE_DEFAULT   = "DEFAULT";
    private static final String CAW_QR_LINK_DEFAULT   = "https://www.goodsam.com/rewards/benefits";
    
    public CawAgisRoadsideQRBarcodeBuilderField(String argContents, String argStyle,
    ...
    public String getContents(Object argVar1, IDocElementFactory argVar2,
        ...
        try {
            IReceiptText  iReceiptText = CawCustomerUtil.getReceiptText(
                    ConfigurationMgr
                    .getOrganizationId(), CAW_AGIS_TEMP_ROAD_QR_LINK, CAW_SUBCODE_DEFAULT);
