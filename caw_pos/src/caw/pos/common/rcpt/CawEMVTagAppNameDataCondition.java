...
public class CawEMVTagAppNameDataCondition extends AbstractInvertableCondition {
     ...
     * 
     */
    public CawEMVTagAppNameDataCondition() {
    ...
    protected boolean conditionMetImpl(Object argValue) {
        ...
        if (argValue instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null
                        && StringUtils.isNotEmpty(emvInfo.getAppNameTag())) {
                    return true;
                }
            }
        }
