...
public class CawEMVTagAppNameMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagAppNameMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getAppNameTag() != null) {
                    result = emvInfo.getAppNameTag();
                }
            }
        }
        return result;
