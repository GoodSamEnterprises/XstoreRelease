 ...
 *
 */
public class CawTemporaryRoadsideFooterDocBuilderField extends AbstractDocBuilderField {
    private static Logger _logger = Logger.getLogger(CawAgisMembershipQRBarcodeBuilderField.class);
    private static final String CAW_AGIS_TEMP_ROAD_QR_FOOTER_1 = "CAW_AGIS_TEMP_ROAD_QR_FOOTER_1";
    private static final String CAW_AGIS_TEMP_ROAD_QR_FOOTER_2 = "CAW_AGIS_TEMP_ROAD_QR_FOOTER_2";
    private static final String CAW_AGIS_TEMP_ROAD_QR_FOOTER_3 = "CAW_AGIS_TEMP_ROAD_QR_FOOTER_3";
    private static final String CAW_SUBCODE_DEFAULT   = "DEFAULT";
    
    public CawTemporaryRoadsideFooterDocBuilderField(String argContents, String argStyle,
    ...
    public String getContents(Object argVar1, IDocElementFactory argVar2, Locale argVar3) {
        try {
            ...
            /* Receipt Text with CAWO Phone Number */
            IReceiptText  iReceiptTextForPhoneNumber = CawCustomerUtil.getReceiptText(
                    ConfigurationMgr
                    .getOrganizationId(), CAW_AGIS_TEMP_ROAD_QR_FOOTER_1, CAW_SUBCODE_DEFAULT);
            if (iReceiptTextForPhoneNumber != null) {
                if(!iReceiptTextForPhoneNumber.getReceiptText().contains("\\n")) {
                    String temp =iReceiptTextForPhoneNumber.getReceiptText().trim() + "  ";
                    temporaryFooter =  temporaryFooter + temp;
                }else {
                    temporaryFooter =  temporaryFooter + iReceiptTextForPhoneNumber.getReceiptText();
                }
            }
            ...
            IReceiptText  iReceiptText = CawCustomerUtil.getReceiptText(
                    ConfigurationMgr
                    .getOrganizationId(), CAW_AGIS_TEMP_ROAD_QR_FOOTER_2, CAW_SUBCODE_DEFAULT);
                    ...
                    if (argVar1 instanceof RetailTransactionModel) {
                        ...
                        if (phone != StringUtils.EMPTY) {
                            if(!iReceiptText.getReceiptText().startsWith("\\n")) {
                                ...
                                temporaryFooter =  temporaryFooter + iReceiptText.getReceiptText();
                            }
            ...
            IReceiptText  iReceiptTextForSubscriberID = CawCustomerUtil.getReceiptText(
                    ConfigurationMgr
                    .getOrganizationId(), CAW_AGIS_TEMP_ROAD_QR_FOOTER_3, CAW_SUBCODE_DEFAULT);
