...
public class CawEMVTagAIDMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagAIDMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getAidTag() != null) {
                    result = emvInfo.getAidTag();
                }
            }
        }
        return result;
