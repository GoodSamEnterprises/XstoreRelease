...
public class CawEMVTagTraNumDataCondition extends AbstractInvertableCondition {
     ...
     * 
     */
    public CawEMVTagTraNumDataCondition() {
    ...
    protected boolean conditionMetImpl(Object argValue) {
        ...
        if (argValue instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null
                        && StringUtils.isNotEmpty(emvInfo.getTraceNumber())) {
                    return true;
                }
            }
        }
