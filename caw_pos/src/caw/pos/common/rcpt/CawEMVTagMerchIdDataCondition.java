...
public class CawEMVTagMerchIdDataCondition extends AbstractInvertableCondition {
     ...
     * 
     */
    public CawEMVTagMerchIdDataCondition() {
    ...
    protected boolean conditionMetImpl(Object argValue) {
        ...
        if (argValue instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null
                        && StringUtils.isNotEmpty(emvInfo.getMerchId())) {
                    return true;
                }
            }
        }
