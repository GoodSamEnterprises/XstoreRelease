...
public class CawEMVTagISOResCodeMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagISOResCodeMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getIsoResCode() != null) {
                    result = emvInfo.getIsoResCode();
                }
            }
        }
        return result;
