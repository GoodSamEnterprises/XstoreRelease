...
public class CawEMVTagMerchIdMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagMerchIdMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getMerchId() != null) {
                    result = emvInfo.getMerchId();
                }
            }
        }
        return result;
