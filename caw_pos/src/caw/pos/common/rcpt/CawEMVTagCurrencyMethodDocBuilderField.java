...
public class CawEMVTagCurrencyMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagCurrencyMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getCurrency() != null) {
                    result = emvInfo.getCurrency();
                }
            }
        }
        return result;
