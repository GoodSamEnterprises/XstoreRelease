...
public class CawEMVTagTVRMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagTVRMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getTvrTag() != null) {
                    result = emvInfo.getTvrTag();
                }
            }
        }
        return result;
