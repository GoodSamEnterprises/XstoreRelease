...
public class CawEMVTagSeqNumMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagSeqNumMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getSeqNumber() != null) {
                    result = emvInfo.getSeqNumber();
                }
            }
        }
        return result;
