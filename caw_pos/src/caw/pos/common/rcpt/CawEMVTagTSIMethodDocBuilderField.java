...
public class CawEMVTagTSIMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagTSIMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getTsiTag() != null) {
                    result = emvInfo.getTsiTag();
                }
            }
        }
        return result;
