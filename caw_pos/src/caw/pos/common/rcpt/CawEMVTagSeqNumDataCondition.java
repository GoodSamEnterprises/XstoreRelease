...
public class CawEMVTagSeqNumDataCondition extends AbstractInvertableCondition {
     ...
     * 
     */
    public CawEMVTagSeqNumDataCondition() {
    ...
    protected boolean conditionMetImpl(Object argValue) {
        ...
        if (argValue instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null
                        && StringUtils.isNotEmpty(emvInfo.getSeqNumber())) {
                    return true;
                }
            }
        }
