 ...
 *
 */
public class CawPONumberSecondLineDocBuilderField
     ...
     * @param argFormatter
     */
    public CawPONumberSecondLineDocBuilderField(String argContents,
            ...
            if (lineItem.getParentTransaction() != null) {
                ...
                if (lineItem.getPoNumber().length() > 30) {
                    result = lineItem.getPoNumber()
                            .substring(31, lineItem.getPoNumber().length());
                } else {
                    result = "";
                }
            }
