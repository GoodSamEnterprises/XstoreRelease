...
public class CawEMVTagACMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagACMethodDocBuilderField(String argContents, String argStyle,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getAcTag() != null) {
                    result = emvInfo.getAcTag();
                }
            }
        }
        return result;
