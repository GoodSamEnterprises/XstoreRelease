...
public class CawEMVTagDeviceIdMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagDeviceIdMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getDeviceId() != null) {
                    result = emvInfo.getDeviceId();
                }
            }
        }
        return result;
