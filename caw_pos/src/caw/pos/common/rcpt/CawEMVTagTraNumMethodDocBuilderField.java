...
public class CawEMVTagTraNumMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagTraNumMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getTraceNumber() != null) {
                    result = emvInfo.getTraceNumber();
                }
            }
        }
        return result;
