...
public class CawEMVTagTerinalNumMethodDocBuilderField
     ...
     * @param argFormatter
     */
    public CawEMVTagTerinalNumMethodDocBuilderField(String argContents,
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        if (argSource instanceof ICreditDebitTenderLineItem) {
            ...
            if (mapEMVInfo != null && mapEMVInfo.size() > 0) {
                ...
                if (emvInfo != null && emvInfo.getTerminalNumber() != null) {
                    result = emvInfo.getTerminalNumber();
                }
            }
        }
        return result;
