 ...
 * BZ37621          140920    [Internal] Receipt messages on the "Order Copy" of Emailed receipt does not match Camping World
 *===================================================================
 */
 ...
 *
 */
public class CawOrderNotClubPriceInTransCondition extends AbstractInvertableCondition {
    /**
    ...
    protected boolean conditionMetImpl(Object argSoure) {
        ...
        if (_transactionScope.getTransaction(RETAIL_SALE) != null) {
            ...
            if (trans.getCustomerParty() != null) {
                ...
                if (CawCustomerUtil.isClubCustomerXstore(party) || CawCustomerUtil.isWhslCustomer(party) //BZ31523: changed condition.
                        || CawCustomerUtil.isCrewCustomerFromEBS(party)) { //BZ31523: changed condition (Crew type from EBS)
                    return false;
                }
            }
        }
