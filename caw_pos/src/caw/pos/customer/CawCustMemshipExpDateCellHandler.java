...
public class CawCustMemshipExpDateCellHandler extends DefaultCellDataHandler {

    private static final String JSON_EXPIRE_DATE = "expireDate";
            ...
            try {
                ...
                if (lstMemberships != null && lstMemberships.size() > 0) {
                    for (JSONObject jsonMembership : lstMemberships) {
                        if (jsonMembership
                                .getString(JSON_EXPIRE_DATE) != null) {
                            strMembership
                                    .append(jsonMembership
                                            .getString(JSON_EXPIRE_DATE))
                                    .append("\n");
                        }
                    }
                }
