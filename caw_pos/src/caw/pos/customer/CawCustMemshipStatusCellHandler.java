...
public class CawCustMemshipStatusCellHandler extends DefaultCellDataHandler {

    private static final Logger _logger                 = LogManager
            .getLogger(CawEditCustomerOp.class);

    private static final String JSON_STATUS_DESCRIPTION = "statusDescription";
            ...
            try {
                ...
                if (lstMemberships != null && lstMemberships.size() > 0) {
                    for (JSONObject jsonMembership : lstMemberships) {
                        if (jsonMembership
                                .getString(JSON_STATUS_DESCRIPTION) != null) {
                            strMembership
                                    .append(jsonMembership
                                            .getString(JSON_STATUS_DESCRIPTION))
                                    .append("\n");
                        }
                    }
                }
