...
public class CawCustMemshipNameCellHandler extends DefaultCellDataHandler {

    private static final Logger _logger               = LogManager
            .getLogger(CawEditCustomerOp.class);

    private static final String JSON_TYPE_DESCRIPTION = "typeDescription";
            ...
            try {
                ...
                if (lstMemberships != null && lstMemberships.size() > 0) {
                    for (JSONObject jsonMembership : lstMemberships) {
                        if (jsonMembership
                                .getString(JSON_TYPE_DESCRIPTION) != null) {
                            strMembership
                                    .append(jsonMembership
                                            .getString(JSON_TYPE_DESCRIPTION))
                                    .append("\n");
                        }
                    }
                }
