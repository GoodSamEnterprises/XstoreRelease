 ...
 *
 */
public class CawPromptCustomerEditAddressOp extends AbstractChangeCountryOp<MultipleAddressFormModel> {
    
    private static final Logger        _logger               = LogManager.getLogger(CawPromptCustomerEditAddressOp.class);
    ...
    protected MultipleAddressFormModel createModel() {
        ...
        IQualifiedAddress selectedAddress = this
                .getScopedValue(ValueKeys.SELECTED_ADDRESS);
        this.setSelectedCountry(selectedAddress.getCountry());
        return new MultipleAddressFormModel(selectedAddress);
    }
    ...
    protected IOpResponse handleDisplayAgain() {
        ...
        MultipleAddressFormModel cm = this.getModel();
    ...
    protected IOpResponse handleFormResponse(IXstEvent argEvent) {
        ...
        MultipleAddressFormModel model = this.getModel();
        model.commitChanges();
        IQualifiedAddress address = model.getAddress();
        if (address.getPrimary()) {
            Eventor eventor = new DefaultEventor(
                    CustomerUtil.ADDRESS_CHANGED_EVENT_DESCRIPTOR);
            eventor.post(CustomerUtil.CUSTOMER_PRIMARY_ADDRESS_CHANGED, address);
        }
    ...
    protected IOpResponse handleInitialState() {
        ...
        this.setSelectedCountry((String) null);
    ...
    protected void setSelectedCountry(String argCountry) {
        ...
        if (argCountry != null) {
            this.setScopedValue(ValueKeys.ADDRESS_LOOKUP_COUNTRY, argCountry);
        }
    }
    ...
    private IOpResponse getPromptAddressLookup(IXstDataAction argAction) {
        ...
        _transactionScope
                .setValue(CawValueKeys.MULTI_ADDRESS_FORM_ADD_OR_EDIT, "EDIT");
