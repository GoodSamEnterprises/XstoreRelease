 ...
 */
public class CawCustomerMembershipsTotalPointsCellHandler extends DefaultCellDataHandler {
            ...
            if (custMemViews != null && custMemViews.size() > 0) {
                ...
                for (CawCustomerMembershipView cawCustMemView : custMemViews) {
                    ...
                    if (!StringUtils.isEmpty(cardNumber)
                        ...
                        if(cawCustMemView.getTotalPoints() != null) {
                            return buildCellColumn(cawCustMemView
                                    .getTotalPoints(), null, argArgDefaultRowTextColor, argArgDefaultRowFont, argArgColConfig);
                        }
