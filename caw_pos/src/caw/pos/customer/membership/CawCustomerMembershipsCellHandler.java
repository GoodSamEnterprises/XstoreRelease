 ...
 */
public class CawCustomerMembershipsCellHandler extends DefaultCellDataHandler {
    ...
    public CellColumn buildCellColumn(ListViewColumnConfig argArgColConfig,
        ...
        if (argArgModel instanceof CustomerLoyaltyCardModel) {
            ...
            /* BEGIN BZ53459 */
            if (model.getProperty(CawConstants.LOYALTY_MEMBERSHIP) != null) {
                String loyaltyMembership = model.getProperty(CawConstants.LOYALTY_MEMBERSHIP).getStringValue();
                if (loyaltyMembership != null && loyaltyMembership.length() > 0) {
                    return buildCellColumn(loyaltyMembership, null
