 ...
 *
 */
public class CawCustomerMembershipsPointsBalanceCellHandler extends DefaultCellDataHandler{
    @Override
    public CellColumn buildCellColumn(ListViewColumnConfig argArgColConfig,
        ...
        if (argArgModel instanceof CustomerLoyaltyCardModel) {
            ...
            /* BEGIN BZ53459 */
            if (model.getProperty(CawConstants.LOYALTY_MEMBERSHIP_POINTS_BALANCE) != null) {
                String pointsBalance = model.getProperty(CawConstants.LOYALTY_MEMBERSHIP_POINTS_BALANCE).getStringValue();
                if (pointsBalance != null && !pointsBalance.isEmpty()) {
                    NumberFormat numberFormat = NumberFormat.getNumberInstance();
                    return buildCellColumn(numberFormat.format(new BigDecimal(pointsBalance)), null
                            , argArgDefaultRowTextColor, argArgDefaultRowFont, argArgColConfig);
                }
            }
            /* END BZ53459 */
        }
