...
public class CawGetRegisterNumberDocBuilder extends AbstractDocBuilderField {

    private static final String STORE_NUMBER = System
            .getProperty("dtv.location.terminalNumber") != null
                    ? System.getProperty("dtv.location.terminalNumber")
                    : "";

    public CawGetRegisterNumberDocBuilder(String argArgContents,
