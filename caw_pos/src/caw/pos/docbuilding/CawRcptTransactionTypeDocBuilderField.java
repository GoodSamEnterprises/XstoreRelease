...
/**
 * This class is used to print out receipt on line item
 */
public class CawRcptTransactionTypeDocBuilderField
    ...
    private static final String             REFUND  = "_transTypeRefund";
    ...
    public String getContents(Object argSource, IDocElementFactory argFactory,
        ...
        String result = "";
        if (argSource instanceof IVoucherSaleLineItem) {
            IVoucherSaleLineItem voucherSaleLineItem = (IVoucherSaleLineItem) argSource;
            if (voucherSaleLineItem.getReturn()) {
                result = FF.getTranslatable(REFUND)
