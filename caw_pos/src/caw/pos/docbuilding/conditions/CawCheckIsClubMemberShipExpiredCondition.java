 ...
 *
 */
public class CawCheckIsClubMemberShipExpiredCondition  extends AbstractInvertableCondition{
    ...
    protected boolean conditionMetImpl(Object argArg0) {
        ...
        if (argArg0 instanceof IRetailTransaction) {
            ...
            if (trans.getCustomerParty() != null) {
                ...
                if(CawCheetahHelper.getInstance().isClubMembershipExpired(lookupData)) {
                    return false;
                } 
            }
        }
