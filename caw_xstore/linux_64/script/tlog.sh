...
# Application
APP_NAME="tlog"
APP_LONG_NAME="Xstore Tlog Generation"
...
# description: Xstore Tlog Generation
...
WRAPPER_CONF=$REALPATH/wrapper/conf/tlog.conf
export PLATFORM=linux_64
export _WRAPPED_APP=tlog
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/tlog
...
WRAPPER_CMD=$PLATFORMPATH/bin/tlog-wrapper
