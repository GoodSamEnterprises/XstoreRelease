...
# Application
APP_NAME="dataloader2-trickle"
APP_LONG_NAME="Xstore Trickle Dataloader"
...
# description: Xstore Trickle Dataloader
...
WRAPPER_CONF=$REALPATH/wrapper/conf/dataloader2-trickle.conf
export PLATFORM=linux_64
export _WRAPPED_APP=dataloader2-trickle
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/dataloader2-trickle
...
WRAPPER_CMD=$PLATFORMPATH/bin/dataloader2-trickle-wrapper
