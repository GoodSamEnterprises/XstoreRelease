...
# Application
APP_NAME="dataloader2"
APP_LONG_NAME="Xstore Dataloader"
...
WRAPPER_CONF=$REALPATH/wrapper/conf/dataloader2.conf
export PLATFORM=linux_64
export _WRAPPED_APP=dataloader2
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/dataloader2
...
WRAPPER_CMD=$PLATFORMPATH/bin/dataloader2-wrapper
