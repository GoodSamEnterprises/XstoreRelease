...
# Application
APP_NAME="datapurger"
APP_LONG_NAME="Xstore Datapurger"
...
WRAPPER_CONF=$REALPATH/wrapper/conf/datapurger.conf
export PLATFORM=linux_64
export _WRAPPED_APP=datapurger
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/datapurger
...
WRAPPER_CMD=$PLATFORMPATH/bin/datapurger-wrapper
