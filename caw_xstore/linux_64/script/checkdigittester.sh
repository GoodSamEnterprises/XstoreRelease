...
# Application
APP_NAME="checkdigittester"
APP_LONG_NAME="Xstore Check Digit Tester"
...
# description: Xstore Check Digit Tester
...
WRAPPER_CONF=$REALPATH/wrapper/conf/checkdigittester.conf
export PLATFORM=linux_64
export _WRAPPED_APP=checkdigittester
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/checkdigittester
...
WRAPPER_CMD=$PLATFORMPATH/bin/checkdigittester-wrapper
