...
# Application
APP_NAME="xfg-client"
APP_LONG_NAME="Xstore Grocery Client POS"
...
# description: Xstore Grocery Client POS
...
WRAPPER_CONF=$REALPATH/wrapper/conf/xfg-client.conf
export PLATFORM=linux_64
export _WRAPPED_APP=xfg-client
...
WRAPPER_CMD=$PLATFORMPATH/bin/xfg-client-wrapper
