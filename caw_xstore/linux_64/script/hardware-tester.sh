...
# Application
APP_NAME="hardware-tester"
APP_LONG_NAME="Xstore Hardware Tester"
...
# description: Xstore Hardware Tester
...
WRAPPER_CONF=$REALPATH/wrapper/conf/hardware-tester.conf
export PLATFORM=linux_64
export _WRAPPED_APP=hardware-tester
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/hardware-tester
...
WRAPPER_CMD=$PLATFORMPATH/bin/hardware-tester-wrapper
