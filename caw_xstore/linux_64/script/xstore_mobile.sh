...
# Application
APP_NAME="xstore_mobile"
APP_LONG_NAME="Xstore Mobile POS"
...
WRAPPER_CONF=$REALPATH/wrapper/conf/xstore_mobile.conf
export PLATFORM=linux_64
export _WRAPPED_APP=xstore_mobile
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/xstore_mobile
...
WRAPPER_CMD=$PLATFORMPATH/bin/xstore_mobile-wrapper
