...
WRAPPER_CONF=$REALPATH/wrapper/conf/xstore.conf
export PLATFORM=linux_64
export _WRAPPED_APP=xstore
export JAVA_HOME=/opt/jre
export JAVA=$JAVA_HOME/bin/xstore
...
WRAPPER_CMD=$PLATFORMPATH/bin/xstore-wrapper
